...
(async () => {
  ...
  const namespace = {
    ...
    description: "TypeScript SDK example tag namespace"
  };
  const namespaceReq = {
  ...
  const tagOneName = {
    ...
    description: "TypeScript SDK example tag one"
  };
  ...
  const tagTwoName = {
    ...
    description: "TypeScript SDK example tag two"
  };
  ...
  const virtualNetwork = new core.VirtualNetworkClient({
    authenticationDetailsProvider: provider
  });
  /*
  ...
  */
  ...
  while (true) {
    try {
      const createVCNDetails = {
        ...
        compartmentId: compartmentId,
        displayName: "TypeScript SDK tagging example VCN",
  ...
  let updateTagNamespaceDetails = {
    isRetired: true
  };
  let updateTagNameSpaceReq = {
    tagNamespaceId: tagNamespaceId,
