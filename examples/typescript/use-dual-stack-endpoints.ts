...
/**
 * This script provides an example on how to enable Dual Stack endpoints for the service. This example uses
...
// Dual stack endpoints can be enabled at the client level as shown, or globally through the
// environment variable OCI_DUAL_STACK_ENDPOINT_ENABLED
// client.enableDualstackEndpoint = true;
// console.log("Dual stack endpoint enabled on the client");
