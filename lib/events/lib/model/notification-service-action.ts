...
export namespace NotificationServiceAction {
  export function getJsonObj(obj: NotificationServiceAction, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj ? obj : (model.Action.getJsonObj(obj) as NotificationServiceAction)),
      ...{}
    };
