...
export namespace SourceBackupDetails {
  export function getJsonObj(obj: SourceBackupDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: SourceBackupDetails): object {
    const jsonObj = { ...obj, ...{} };
