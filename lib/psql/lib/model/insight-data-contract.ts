 ...
 */
export interface InsightDataContract {
  /**
   * Indicates the structure of the insight data payload.
   */
  "kind": InsightDataContract.Kind;
  /**
...
export namespace InsightDataContract {
  export enum Kind {
  ...
  export function getJsonObj(obj: InsightDataContract): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: InsightDataContract): object {
    const jsonObj = { ...obj, ...{} };
