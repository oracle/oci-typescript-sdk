 ...
 */
export interface SortingDefault {
  /**
   ...
   * Default sort order.
   */
  "order"?: SortingDefault.Order;
}

export namespace SortingDefault {
  export enum Order {
    Asc = "ASC",
    Desc = "DESC",
    /**
  ...
  export function getJsonObj(obj: SortingDefault): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: SortingDefault): object {
    const jsonObj = { ...obj, ...{} };
