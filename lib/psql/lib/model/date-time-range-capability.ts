 ...
 */
export interface DateTimeRangeCapability {
  /**
...
export namespace DateTimeRangeCapability {
  export function getJsonObj(obj: DateTimeRangeCapability): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: DateTimeRangeCapability): object {
    const jsonObj = { ...obj, ...{} };
