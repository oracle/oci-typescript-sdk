 ...
 */
export interface ChangeRoleToReplicaDetails {
  /**
...
export namespace ChangeRoleToReplicaDetails {
  export function getJsonObj(obj: ChangeRoleToReplicaDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: ChangeRoleToReplicaDetails): object {
    const jsonObj = { ...obj, ...{} };
