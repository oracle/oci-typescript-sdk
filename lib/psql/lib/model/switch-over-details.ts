 ...
 */
export interface SwitchOverDetails {
  /**
   * The OCID of the replica database system that will get the primary role after switchover.
   *
   */
  "replicaDbSystemId": string;
}

export namespace SwitchOverDetails {
  export function getJsonObj(obj: SwitchOverDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: SwitchOverDetails): object {
    const jsonObj = { ...obj, ...{} };
