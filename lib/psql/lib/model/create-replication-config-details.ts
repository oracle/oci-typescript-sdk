...
* 
*/
export interface CreateReplicationConfigDetails {
  /**
...
export namespace CreateReplicationConfigDetails {
  export function getJsonObj(obj: CreateReplicationConfigDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: CreateReplicationConfigDetails): object {
    const jsonObj = { ...obj, ...{} };
