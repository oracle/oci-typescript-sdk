 ...
 */
export interface StartDbSystemDetails {
  /**
...
export namespace StartDbSystemDetails {
  export function getJsonObj(obj: StartDbSystemDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: StartDbSystemDetails): object {
    const jsonObj = { ...obj, ...{} };
