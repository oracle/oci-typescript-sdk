 ...
 */
export interface InsightFilterCapability {
  /**
...
export namespace InsightFilterCapability {
  export function getJsonObj(obj: InsightFilterCapability): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: InsightFilterCapability): object {
    const jsonObj = { ...obj, ...{} };
