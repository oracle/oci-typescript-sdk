...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/psql/ChangeRoleToStandalone.ts.html |here} to see how to use ChangeRoleToStandaloneRequest.
 */
export interface ChangeRoleToStandaloneRequest extends common.BaseRequest {
  /**
   * Change a replica database system's role to standalone parameters.
   */
  "changeRoleToStandaloneDetails": model.ChangeRoleToStandaloneDetails;
  /**
