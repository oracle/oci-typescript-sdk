...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/psql/StartDbSystem.ts.html |here} to see how to use StartDbSystemRequest.
 */
export interface StartDbSystemRequest extends common.BaseRequest {
   ...
   */
  "startDbSystemDetails": model.StartDbSystemDetails;
  /**
