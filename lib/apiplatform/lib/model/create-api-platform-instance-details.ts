...
export namespace CreateApiPlatformInstanceDetails {
  export function getJsonObj(obj: CreateApiPlatformInstanceDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: CreateApiPlatformInstanceDetails): object {
    const jsonObj = { ...obj, ...{} };
