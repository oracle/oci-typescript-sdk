...
export namespace UpdateApiPlatformInstanceDetails {
  export function getJsonObj(obj: UpdateApiPlatformInstanceDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: UpdateApiPlatformInstanceDetails): object {
    const jsonObj = { ...obj, ...{} };
