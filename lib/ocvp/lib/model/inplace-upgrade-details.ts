...
export namespace InplaceUpgradeDetails {
  export function getJsonObj(obj: InplaceUpgradeDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: InplaceUpgradeDetails): object {
    const jsonObj = { ...obj, ...{} };
