...
export namespace ClusterByolAllocationDetails {
  export function getJsonObj(obj: ClusterByolAllocationDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: ClusterByolAllocationDetails): object {
    const jsonObj = { ...obj, ...{} };
