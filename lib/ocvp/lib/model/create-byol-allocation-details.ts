...
export namespace CreateByolAllocationDetails {
  export function getJsonObj(obj: CreateByolAllocationDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: CreateByolAllocationDetails): object {
    const jsonObj = { ...obj, ...{} };
