...
export namespace DatastoreTypes {
  export function getJsonObj(obj: DatastoreTypes): DatastoreTypes {
    return obj;
  }
  export function getDeserializedJsonObj(obj: DatastoreTypes): DatastoreTypes {
    return obj;
  }
}
