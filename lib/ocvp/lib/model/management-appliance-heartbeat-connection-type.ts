 ...
 **/
export enum ManagementApplianceHeartbeatConnectionType {
  Vcenter = "VCENTER",
...
export namespace ManagementApplianceHeartbeatConnectionType {
  export function getJsonObj(
    obj: ManagementApplianceHeartbeatConnectionType
