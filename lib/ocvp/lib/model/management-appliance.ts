...
export namespace ManagementAppliance {
  export function getJsonObj(obj: ManagementAppliance): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: ManagementAppliance): object {
    const jsonObj = {
      ...obj,
      ...{
        "configuration": obj.configuration
