...
export namespace CreateDatastoreClusterDetails {
  export function getJsonObj(obj: CreateDatastoreClusterDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: CreateDatastoreClusterDetails): object {
    const jsonObj = { ...obj, ...{} };
