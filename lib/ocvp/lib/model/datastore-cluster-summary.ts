...
export namespace DatastoreClusterSummary {
  export function getJsonObj(obj: DatastoreClusterSummary): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: DatastoreClusterSummary): object {
    const jsonObj = { ...obj, ...{} };
