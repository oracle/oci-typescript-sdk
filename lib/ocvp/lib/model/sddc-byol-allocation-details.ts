...
export namespace SddcByolAllocationDetails {
  export function getJsonObj(obj: SddcByolAllocationDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: SddcByolAllocationDetails): object {
    const jsonObj = { ...obj, ...{} };
