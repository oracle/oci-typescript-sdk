...
export namespace UpdateByolAllocationDetails {
  export function getJsonObj(obj: UpdateByolAllocationDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: UpdateByolAllocationDetails): object {
    const jsonObj = { ...obj, ...{} };
