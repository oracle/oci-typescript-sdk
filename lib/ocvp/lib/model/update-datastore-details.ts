...
export namespace UpdateDatastoreDetails {
  export function getJsonObj(obj: UpdateDatastoreDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: UpdateDatastoreDetails): object {
    const jsonObj = { ...obj, ...{} };
