...
export namespace DatastoreCollection {
  export function getJsonObj(obj: DatastoreCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
  ...
  export function getDeserializedJsonObj(obj: DatastoreCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
