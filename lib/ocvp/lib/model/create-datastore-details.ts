...
export namespace CreateDatastoreDetails {
  export function getJsonObj(obj: CreateDatastoreDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: CreateDatastoreDetails): object {
    const jsonObj = { ...obj, ...{} };
