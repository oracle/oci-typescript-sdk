...
export interface SupportedSkuSummaryCollection {
   ...
   */
  "items": Array<model.SupportedSkuSummary>;
}

export namespace SupportedSkuSummaryCollection {
  export function getJsonObj(obj: SupportedSkuSummaryCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
          ? obj.items.map(item => {
              return model.SupportedSkuSummary.getJsonObj(item);
            })
          : undefined
      }
    };
