...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/distributeddatabasev26/ListDistributedDatabases.ts.html |here} to see how to use ListDistributedDatabasesRequest.
 */
...
export namespace ListDistributedDatabasesRequest {
  export enum SortBy {
