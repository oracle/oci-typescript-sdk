 ...
 */
export interface DistributedDatabaseShardDatabaseWithExadbXd
   ...
   */
  "status": DistributedDatabaseShardDatabaseWithExadbXd.Status;
  /**
...
export namespace DistributedDatabaseShardDatabaseWithExadbXd {
  export enum Status {
    Failed = "FAILED",
    Deleting = "DELETING",
    Deleted = "DELETED",
  ...
  export function getJsonObj(
    obj: DistributedDatabaseShardDatabaseWithExadbXd,
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ...
        : (model.DistributedDatabaseShardDatabase.getJsonObj(
            obj
          ) as DistributedDatabaseShardDatabaseWithExadbXd)),
      ...{}
    };
