 ...
 */
export interface DistributedDatabaseCatalogDatabaseWithExadbXd
   ...
   */
  "status": DistributedDatabaseCatalogDatabaseWithExadbXd.Status;
  /**
...
export namespace DistributedDatabaseCatalogDatabaseWithExadbXd {
  export enum Status {
    Failed = "FAILED",
    Deleting = "DELETING",
    Deleted = "DELETED",
  ...
  export function getJsonObj(
    obj: DistributedDatabaseCatalogDatabaseWithExadbXd,
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ...
        : (model.DistributedDatabaseCatalogDatabase.getJsonObj(
            obj
          ) as DistributedDatabaseCatalogDatabaseWithExadbXd)),
      ...{}
    };
