...
export namespace DistributedAutonomousDatabaseGsm {
  export enum Status {
    Failed = "FAILED",
    Deleting = "DELETING",
    Deleted = "DELETED",
  ...
  export function getJsonObj(obj: DistributedAutonomousDatabaseGsm): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: DistributedAutonomousDatabaseGsm): object {
    const jsonObj = {
      ...obj,
      ...{
        "gsmImageDetails": obj.gsmImageDetails
