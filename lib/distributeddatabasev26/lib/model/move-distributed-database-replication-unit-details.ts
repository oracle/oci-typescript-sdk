...
export namespace MoveDistributedDatabaseReplicationUnitDetails {
  export function getJsonObj(obj: MoveDistributedDatabaseReplicationUnitDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(
    obj: MoveDistributedDatabaseReplicationUnitDetails
  ): object {
    const jsonObj = { ...obj, ...{} };
