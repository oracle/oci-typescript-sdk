...
export namespace UpdateDistributedDatabaseDetails {
  export function getJsonObj(obj: UpdateDistributedDatabaseDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: UpdateDistributedDatabaseDetails): object {
    const jsonObj = { ...obj, ...{} };
