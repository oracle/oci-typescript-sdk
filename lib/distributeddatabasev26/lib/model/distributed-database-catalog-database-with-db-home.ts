 ...
 */
export interface DistributedDatabaseCatalogDatabaseWithDbHome
   ...
   */
  "status": DistributedDatabaseCatalogDatabaseWithDbHome.Status;
  /**
...
export namespace DistributedDatabaseCatalogDatabaseWithDbHome {
  export enum Status {
    Failed = "FAILED",
    Deleting = "DELETING",
    Deleted = "DELETED",
  ...
  export function getJsonObj(
    obj: DistributedDatabaseCatalogDatabaseWithDbHome,
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ...
        : (model.DistributedDatabaseCatalogDatabase.getJsonObj(
            obj
          ) as DistributedDatabaseCatalogDatabaseWithDbHome)),
      ...{}
    };
