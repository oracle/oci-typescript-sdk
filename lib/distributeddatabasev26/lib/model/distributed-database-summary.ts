...
export interface DistributedDatabaseSummary {
   ...
   */
  "shardingMethod": DistributedDatabaseSummary.ShardingMethod;
  /**
   ...
   *
   */
  "replicationMethod"?: DistributedDatabaseSummary.ReplicationMethod;
  /**
...
export namespace DistributedDatabaseSummary {
  ...
  export function getJsonObj(obj: DistributedDatabaseSummary): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: DistributedDatabaseSummary): object {
    const jsonObj = {
      ...obj,
      ...{
        "autoResourceManagementConfig": obj.autoResourceManagementConfig
