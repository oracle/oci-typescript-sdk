 ...
 */
export interface DistributedDatabaseCatalogDatabaseWithExadbXs
   ...
   */
  "status": DistributedDatabaseCatalogDatabaseWithExadbXs.Status;
  /**
...
export namespace DistributedDatabaseCatalogDatabaseWithExadbXs {
  export enum Status {
    Failed = "FAILED",
    Deleting = "DELETING",
    Deleted = "DELETED",
  ...
  export function getJsonObj(
    obj: DistributedDatabaseCatalogDatabaseWithExadbXs,
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ...
        : (model.DistributedDatabaseCatalogDatabase.getJsonObj(
            obj
          ) as DistributedDatabaseCatalogDatabaseWithExadbXs)),
      ...{}
    };
