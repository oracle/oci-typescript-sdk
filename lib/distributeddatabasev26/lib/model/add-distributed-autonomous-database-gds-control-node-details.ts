...
export namespace AddDistributedAutonomousDatabaseGdsControlNodeDetails {
  export function getJsonObj(obj: AddDistributedAutonomousDatabaseGdsControlNodeDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(
    obj: AddDistributedAutonomousDatabaseGdsControlNodeDetails
  ): object {
    const jsonObj = { ...obj, ...{} };
