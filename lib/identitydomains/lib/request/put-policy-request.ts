...
/**
 * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/identitydomains/PutPolicy.ts.html |here} to see how to use PutPolicyRequest.
 */
