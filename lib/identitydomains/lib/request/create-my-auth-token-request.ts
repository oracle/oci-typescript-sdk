...
/**
 * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/identitydomains/CreateMyAuthToken.ts.html |here} to see how to use CreateMyAuthTokenRequest.
 */
