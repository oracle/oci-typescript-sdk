...
export namespace SettingsSearchRequest {
  ...
  export function getJsonObj(obj: SettingsSearchRequest): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: SettingsSearchRequest): object {
    const jsonObj = { ...obj, ...{} };
