...
export namespace SelfRegistrationProfileConsentText {
  export function getJsonObj(obj: SelfRegistrationProfileConsentText): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: SelfRegistrationProfileConsentText): object {
    const jsonObj = { ...obj, ...{} };
