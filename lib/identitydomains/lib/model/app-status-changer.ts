...
export namespace AppStatusChanger {
  ...
  export function getJsonObj(obj: AppStatusChanger): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: AppStatusChanger): object {
    const jsonObj = {
      ...obj,
      ...{
