...
export namespace IdentitySettingsSearchRequest {
  ...
  export function getJsonObj(obj: IdentitySettingsSearchRequest): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: IdentitySettingsSearchRequest): object {
    const jsonObj = { ...obj, ...{} };
