...
export namespace MappedAttributes {
  export function getJsonObj(obj: MappedAttributes): object {
    const jsonObj = {
      ...obj,
      ...{
    ...
    delete (jsonObj as Partial<MappedAttributes>).resources;

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: MappedAttributes): object {
    const jsonObj = {
      ...obj,
      ...{
