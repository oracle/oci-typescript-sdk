...
export namespace MyTrustedUserAgents {
  export function getJsonObj(obj: MyTrustedUserAgents): object {
    const jsonObj = {
      ...obj,
      ...{
    ...
    delete (jsonObj as Partial<MyTrustedUserAgents>).resources;

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: MyTrustedUserAgents): object {
    const jsonObj = {
      ...obj,
      ...{
