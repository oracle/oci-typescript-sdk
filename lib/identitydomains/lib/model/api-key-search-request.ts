...
export namespace ApiKeySearchRequest {
  ...
  export function getJsonObj(obj: ApiKeySearchRequest): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: ApiKeySearchRequest): object {
    const jsonObj = { ...obj, ...{} };
