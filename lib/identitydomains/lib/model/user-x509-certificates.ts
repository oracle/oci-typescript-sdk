...
export namespace UserX509Certificates {
  export function getJsonObj(obj: UserX509Certificates): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: UserX509Certificates): object {
    const jsonObj = { ...obj, ...{} };
