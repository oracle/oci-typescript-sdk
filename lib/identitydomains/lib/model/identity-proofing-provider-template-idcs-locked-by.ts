...
export namespace IdentityProofingProviderTemplateIdcsLockedBy {
  export enum Type {
    User = "User",
    App = "App",
    /**
  ...
  export function getJsonObj(obj: IdentityProofingProviderTemplateIdcsLockedBy): object {
    const jsonObj = {
      ...obj,
      ...{
        "$ref": obj.ref
    ...
    delete (jsonObj as Partial<IdentityProofingProviderTemplateIdcsLockedBy>).ref;

    return jsonObj;
  }
  export function getDeserializedJsonObj(
    obj: IdentityProofingProviderTemplateIdcsLockedBy
  ): object {
    const jsonObj = {
      ...obj,
      ...{
