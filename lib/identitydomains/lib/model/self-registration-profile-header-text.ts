...
export namespace SelfRegistrationProfileHeaderText {
  export function getJsonObj(obj: SelfRegistrationProfileHeaderText): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: SelfRegistrationProfileHeaderText): object {
    const jsonObj = { ...obj, ...{} };
