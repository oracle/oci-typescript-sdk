...
export namespace PasswordPolicies {
  export function getJsonObj(obj: PasswordPolicies): object {
    const jsonObj = {
      ...obj,
      ...{
    ...
    delete (jsonObj as Partial<PasswordPolicies>).resources;

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: PasswordPolicies): object {
    const jsonObj = {
      ...obj,
      ...{
