...
export namespace BrandingSettingsDefaultImages {
  export function getJsonObj(obj: BrandingSettingsDefaultImages): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: BrandingSettingsDefaultImages): object {
    const jsonObj = { ...obj, ...{} };
