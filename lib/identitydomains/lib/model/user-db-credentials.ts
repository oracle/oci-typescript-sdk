...
export namespace UserDbCredentials {
  export function getJsonObj(obj: UserDbCredentials): object {
    const jsonObj = {
      ...obj,
      ...{
    ...
    delete (jsonObj as Partial<UserDbCredentials>).resources;

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: UserDbCredentials): object {
    const jsonObj = {
      ...obj,
      ...{
