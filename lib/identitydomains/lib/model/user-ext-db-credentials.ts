...
export namespace UserExtDbCredentials {
  export function getJsonObj(obj: UserExtDbCredentials): object {
    const jsonObj = {
      ...obj,
      ...{
        "$ref": obj.ref
    ...
    delete (jsonObj as Partial<UserExtDbCredentials>).ref;

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: UserExtDbCredentials): object {
    const jsonObj = {
      ...obj,
      ...{
        "ref": (obj as any)["$ref"]
