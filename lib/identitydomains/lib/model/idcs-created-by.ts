...
export namespace IdcsCreatedBy {
  export enum Type {
    User = "User",
    App = "App",
    /**
  ...
  export function getJsonObj(obj: IdcsCreatedBy): object {
    const jsonObj = {
      ...obj,
      ...{
        "$ref": obj.ref
    ...
    delete (jsonObj as Partial<IdcsCreatedBy>).ref;

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: IdcsCreatedBy): object {
    const jsonObj = {
      ...obj,
      ...{
        "ref": (obj as any)["$ref"]
