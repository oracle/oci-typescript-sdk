...
export namespace MyUserDbCredentials {
  export function getJsonObj(obj: MyUserDbCredentials): object {
    const jsonObj = {
      ...obj,
      ...{
    ...
    delete (jsonObj as Partial<MyUserDbCredentials>).resources;

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: MyUserDbCredentials): object {
    const jsonObj = {
      ...obj,
      ...{
