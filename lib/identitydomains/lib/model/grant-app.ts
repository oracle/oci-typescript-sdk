...
export namespace GrantApp {
  export function getJsonObj(obj: GrantApp): object {
    const jsonObj = {
      ...obj,
      ...{
        "$ref": obj.ref
    ...
    delete (jsonObj as Partial<GrantApp>).ref;

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: GrantApp): object {
    const jsonObj = {
      ...obj,
      ...{
        "ref": (obj as any)["$ref"]
