...
export namespace MyApiKeys {
  export function getJsonObj(obj: MyApiKeys): object {
    const jsonObj = {
      ...obj,
      ...{
    ...
    delete (jsonObj as Partial<MyApiKeys>).resources;

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: MyApiKeys): object {
    const jsonObj = {
      ...obj,
      ...{
