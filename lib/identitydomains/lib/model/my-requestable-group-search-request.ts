...
export namespace MyRequestableGroupSearchRequest {
  ...
  export function getJsonObj(obj: MyRequestableGroupSearchRequest): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: MyRequestableGroupSearchRequest): object {
    const jsonObj = { ...obj, ...{} };
