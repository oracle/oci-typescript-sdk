...
export namespace MyCustomerSecretKeys {
  export function getJsonObj(obj: MyCustomerSecretKeys): object {
    const jsonObj = {
      ...obj,
      ...{
    ...
    delete (jsonObj as Partial<MyCustomerSecretKeys>).resources;

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: MyCustomerSecretKeys): object {
    const jsonObj = {
      ...obj,
      ...{
