...
export namespace IdentityProofingProviderClaimMapping {
  export function getJsonObj(obj: IdentityProofingProviderClaimMapping): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: IdentityProofingProviderClaimMapping): object {
    const jsonObj = { ...obj, ...{} };
