...
export namespace IdentityProviders {
  export function getJsonObj(obj: IdentityProviders): object {
    const jsonObj = {
      ...obj,
      ...{
    ...
    delete (jsonObj as Partial<IdentityProviders>).resources;

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: IdentityProviders): object {
    const jsonObj = {
      ...obj,
      ...{
