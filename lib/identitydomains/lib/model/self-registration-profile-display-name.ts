...
export namespace SelfRegistrationProfileDisplayName {
  export function getJsonObj(obj: SelfRegistrationProfileDisplayName): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: SelfRegistrationProfileDisplayName): object {
    const jsonObj = { ...obj, ...{} };
