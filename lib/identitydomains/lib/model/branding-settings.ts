...
export namespace BrandingSettings {
  export function getJsonObj(obj: BrandingSettings): object {
    const jsonObj = {
      ...obj,
      ...{
    ...
    delete (jsonObj as Partial<BrandingSettings>).resources;

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: BrandingSettings): object {
    const jsonObj = {
      ...obj,
      ...{
