...
export namespace AppSamlServiceProvider {
  export function getJsonObj(obj: AppSamlServiceProvider): object {
    const jsonObj = {
      ...obj,
      ...{
        "$ref": obj.ref
    ...
    delete (jsonObj as Partial<AppSamlServiceProvider>).ref;

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: AppSamlServiceProvider): object {
    const jsonObj = {
      ...obj,
      ...{
        "ref": (obj as any)["$ref"]
