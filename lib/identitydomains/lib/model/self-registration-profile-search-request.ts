...
export namespace SelfRegistrationProfileSearchRequest {
  ...
  export function getJsonObj(obj: SelfRegistrationProfileSearchRequest): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: SelfRegistrationProfileSearchRequest): object {
    const jsonObj = { ...obj, ...{} };
