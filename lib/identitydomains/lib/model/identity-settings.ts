...
export namespace IdentitySettings {
  export function getJsonObj(obj: IdentitySettings): object {
    const jsonObj = {
      ...obj,
      ...{
    ...
    delete (jsonObj as Partial<IdentitySettings>).resources;

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: IdentitySettings): object {
    const jsonObj = {
      ...obj,
      ...{
