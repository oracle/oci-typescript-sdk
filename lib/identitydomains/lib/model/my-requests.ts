...
export namespace MyRequests {
  export function getJsonObj(obj: MyRequests): object {
    const jsonObj = {
      ...obj,
      ...{
    ...
    delete (jsonObj as Partial<MyRequests>).resources;

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: MyRequests): object {
    const jsonObj = {
      ...obj,
      ...{
