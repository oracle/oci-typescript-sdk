...
export namespace NotificationSettings {
  export function getJsonObj(obj: NotificationSettings): object {
    const jsonObj = {
      ...obj,
      ...{
    ...
    delete (jsonObj as Partial<NotificationSettings>).resources;

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: NotificationSettings): object {
    const jsonObj = {
      ...obj,
      ...{
