...
export namespace GroupExtGrants {
  ...
  export function getJsonObj(obj: GroupExtGrants): object {
    const jsonObj = {
      ...obj,
      ...{
        "$ref": obj.ref
    ...
    delete (jsonObj as Partial<GroupExtGrants>).ref;

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: GroupExtGrants): object {
    const jsonObj = {
      ...obj,
      ...{
        "ref": (obj as any)["$ref"]
