...
export namespace AccountRecoverySettings {
  export function getJsonObj(obj: AccountRecoverySettings): object {
    const jsonObj = {
      ...obj,
      ...{
    ...
    delete (jsonObj as Partial<AccountRecoverySettings>).resources;

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: AccountRecoverySettings): object {
    const jsonObj = {
      ...obj,
      ...{
