...
export namespace OAuthPartnerCertificateSearchRequest {
  ...
  export function getJsonObj(obj: OAuthPartnerCertificateSearchRequest): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: OAuthPartnerCertificateSearchRequest): object {
    const jsonObj = { ...obj, ...{} };
