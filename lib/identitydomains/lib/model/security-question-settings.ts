...
export namespace SecurityQuestionSettings {
  export function getJsonObj(obj: SecurityQuestionSettings): object {
    const jsonObj = {
      ...obj,
      ...{
    ...
    delete (jsonObj as Partial<SecurityQuestionSettings>).resources;

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: SecurityQuestionSettings): object {
    const jsonObj = {
      ...obj,
      ...{
