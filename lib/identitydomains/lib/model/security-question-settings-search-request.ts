...
export namespace SecurityQuestionSettingsSearchRequest {
  ...
  export function getJsonObj(obj: SecurityQuestionSettingsSearchRequest): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: SecurityQuestionSettingsSearchRequest): object {
    const jsonObj = { ...obj, ...{} };
