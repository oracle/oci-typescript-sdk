...
export namespace PolicyExtensionOciconsolesignonpolicyconsentPolicy {
  export function getJsonObj(obj: PolicyExtensionOciconsolesignonpolicyconsentPolicy): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(
    obj: PolicyExtensionOciconsolesignonpolicyconsentPolicy
  ): object {
    const jsonObj = { ...obj, ...{} };
