...
export namespace OAuthClientCertificateSearchRequest {
  ...
  export function getJsonObj(obj: OAuthClientCertificateSearchRequest): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: OAuthClientCertificateSearchRequest): object {
    const jsonObj = { ...obj, ...{} };
