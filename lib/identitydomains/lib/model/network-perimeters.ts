...
export namespace NetworkPerimeters {
  export function getJsonObj(obj: NetworkPerimeters): object {
    const jsonObj = {
      ...obj,
      ...{
    ...
    delete (jsonObj as Partial<NetworkPerimeters>).resources;

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: NetworkPerimeters): object {
    const jsonObj = {
      ...obj,
      ...{
