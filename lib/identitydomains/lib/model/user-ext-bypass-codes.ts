...
export namespace UserExtBypassCodes {
  export function getJsonObj(obj: UserExtBypassCodes): object {
    const jsonObj = {
      ...obj,
      ...{
        "$ref": obj.ref
    ...
    delete (jsonObj as Partial<UserExtBypassCodes>).ref;

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: UserExtBypassCodes): object {
    const jsonObj = {
      ...obj,
      ...{
        "ref": (obj as any)["$ref"]
