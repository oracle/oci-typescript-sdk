...
export namespace MyRequestableGroupMembers {
  export enum Type {
    User = "User",
    /**
  ...
  export function getJsonObj(obj: MyRequestableGroupMembers): object {
    const jsonObj = {
      ...obj,
      ...{
        "$ref": obj.ref
    ...
    delete (jsonObj as Partial<MyRequestableGroupMembers>).ref;

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: MyRequestableGroupMembers): object {
    const jsonObj = {
      ...obj,
      ...{
        "ref": (obj as any)["$ref"]
