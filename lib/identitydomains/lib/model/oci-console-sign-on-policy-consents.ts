...
export namespace OciConsoleSignOnPolicyConsents {
  export function getJsonObj(obj: OciConsoleSignOnPolicyConsents): object {
    const jsonObj = {
      ...obj,
      ...{
    ...
    delete (jsonObj as Partial<OciConsoleSignOnPolicyConsents>).resources;

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: OciConsoleSignOnPolicyConsents): object {
    const jsonObj = {
      ...obj,
      ...{
