...
export namespace MePasswordChanger {
  ...
  export function getJsonObj(obj: MePasswordChanger): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: MePasswordChanger): object {
    const jsonObj = {
      ...obj,
      ...{
