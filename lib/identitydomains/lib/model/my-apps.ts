...
export namespace MyApps {
  export function getJsonObj(obj: MyApps): object {
    const jsonObj = {
      ...obj,
      ...{
    ...
    delete (jsonObj as Partial<MyApps>).resources;

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: MyApps): object {
    const jsonObj = {
      ...obj,
      ...{
