...
export namespace CloudGateSearchRequest {
  ...
  export function getJsonObj(obj: CloudGateSearchRequest): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: CloudGateSearchRequest): object {
    const jsonObj = { ...obj, ...{} };
