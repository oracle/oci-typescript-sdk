 ...
 *  - uniqueness: none
 */
export interface IdentityPropagationTrustCaCertChain {
  /**
   ...
   *  - uniqueness: none
   */
  "intermediateCAs"?: Array<string>;
}

export namespace IdentityPropagationTrustCaCertChain {
  export function getJsonObj(obj: IdentityPropagationTrustCaCertChain): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: IdentityPropagationTrustCaCertChain): object {
    const jsonObj = { ...obj, ...{} };
