...
export namespace MyAuthenticationFactorsRemover {
  ...
  export function getJsonObj(obj: MyAuthenticationFactorsRemover): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: MyAuthenticationFactorsRemover): object {
    const jsonObj = {
      ...obj,
      ...{
