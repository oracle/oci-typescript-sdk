...
export namespace SchemaSearchRequest {
  ...
  export function getJsonObj(obj: SchemaSearchRequest): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: SchemaSearchRequest): object {
    const jsonObj = { ...obj, ...{} };
