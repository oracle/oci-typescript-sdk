...
export namespace CloudGateServerSearchRequest {
  ...
  export function getJsonObj(obj: CloudGateServerSearchRequest): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: CloudGateServerSearchRequest): object {
    const jsonObj = { ...obj, ...{} };
