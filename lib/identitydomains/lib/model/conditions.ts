...
export namespace Conditions {
  export function getJsonObj(obj: Conditions): object {
    const jsonObj = {
      ...obj,
      ...{
    ...
    delete (jsonObj as Partial<Conditions>).resources;

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: Conditions): object {
    const jsonObj = {
      ...obj,
      ...{
