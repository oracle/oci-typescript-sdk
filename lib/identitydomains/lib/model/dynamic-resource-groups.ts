...
export namespace DynamicResourceGroups {
  export function getJsonObj(obj: DynamicResourceGroups): object {
    const jsonObj = {
      ...obj,
      ...{
    ...
    delete (jsonObj as Partial<DynamicResourceGroups>).resources;

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: DynamicResourceGroups): object {
    const jsonObj = {
      ...obj,
      ...{
