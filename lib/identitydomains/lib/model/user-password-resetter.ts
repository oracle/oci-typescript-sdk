...
export namespace UserPasswordResetter {
  ...
  export function getJsonObj(obj: UserPasswordResetter): object {
    ...
    delete (jsonObj as Partial<UserPasswordResetter>)
      .urnIetfParamsScimSchemasOracleIdcsExtensionSelfChangeUser;

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: UserPasswordResetter): object {
    const jsonObj = {
      ...obj,
      ...{
