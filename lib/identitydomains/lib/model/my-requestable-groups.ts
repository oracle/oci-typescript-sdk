...
export namespace MyRequestableGroups {
  export function getJsonObj(obj: MyRequestableGroups): object {
    const jsonObj = {
      ...obj,
      ...{
    ...
    delete (jsonObj as Partial<MyRequestableGroups>).resources;

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: MyRequestableGroups): object {
    const jsonObj = {
      ...obj,
      ...{
