...
export namespace UserExtFactorIdentifier {
  export function getJsonObj(obj: UserExtFactorIdentifier): object {
    const jsonObj = {
      ...obj,
      ...{
        "$ref": obj.ref
    ...
    delete (jsonObj as Partial<UserExtFactorIdentifier>).ref;

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: UserExtFactorIdentifier): object {
    const jsonObj = {
      ...obj,
      ...{
        "ref": (obj as any)["$ref"]
