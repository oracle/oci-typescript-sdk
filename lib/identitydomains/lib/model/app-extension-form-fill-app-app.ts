...
export namespace AppExtensionFormFillAppApp {
  ...
  export function getJsonObj(obj: AppExtensionFormFillAppApp): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: AppExtensionFormFillAppApp): object {
    const jsonObj = {
      ...obj,
      ...{
        "formFillUrlMatch": obj.formFillUrlMatch
