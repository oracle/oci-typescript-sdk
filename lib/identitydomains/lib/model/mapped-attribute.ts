...
export namespace MappedAttribute {
  ...
  export function getJsonObj(obj: MappedAttribute): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: MappedAttribute): object {
    const jsonObj = {
      ...obj,
      ...{
