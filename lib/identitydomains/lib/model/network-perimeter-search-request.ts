...
export namespace NetworkPerimeterSearchRequest {
  ...
  export function getJsonObj(obj: NetworkPerimeterSearchRequest): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: NetworkPerimeterSearchRequest): object {
    const jsonObj = { ...obj, ...{} };
