...
export namespace AccountMgmtInfos {
  export function getJsonObj(obj: AccountMgmtInfos): object {
    const jsonObj = {
      ...obj,
      ...{
    ...
    delete (jsonObj as Partial<AccountMgmtInfos>).resources;

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: AccountMgmtInfos): object {
    const jsonObj = {
      ...obj,
      ...{
