...
export namespace UserAttributesSettingsSearchRequest {
  ...
  export function getJsonObj(obj: UserAttributesSettingsSearchRequest): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: UserAttributesSettingsSearchRequest): object {
    const jsonObj = { ...obj, ...{} };
