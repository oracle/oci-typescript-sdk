...
export namespace OAuthClientCertificates {
  export function getJsonObj(obj: OAuthClientCertificates): object {
    const jsonObj = {
      ...obj,
      ...{
    ...
    delete (jsonObj as Partial<OAuthClientCertificates>).resources;

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: OAuthClientCertificates): object {
    const jsonObj = {
      ...obj,
      ...{
