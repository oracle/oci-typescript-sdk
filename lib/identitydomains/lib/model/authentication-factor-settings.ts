...
export namespace AuthenticationFactorSettings {
  export function getJsonObj(obj: AuthenticationFactorSettings): object {
    const jsonObj = {
      ...obj,
      ...{
    ...
    delete (jsonObj as Partial<AuthenticationFactorSettings>).resources;

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: AuthenticationFactorSettings): object {
    const jsonObj = {
      ...obj,
      ...{
