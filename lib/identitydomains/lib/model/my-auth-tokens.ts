...
export namespace MyAuthTokens {
  export function getJsonObj(obj: MyAuthTokens): object {
    const jsonObj = {
      ...obj,
      ...{
    ...
    delete (jsonObj as Partial<MyAuthTokens>).resources;

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: MyAuthTokens): object {
    const jsonObj = {
      ...obj,
      ...{
