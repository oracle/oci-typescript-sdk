...
export namespace BrandingSettingsLoginTexts {
  export function getJsonObj(obj: BrandingSettingsLoginTexts): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: BrandingSettingsLoginTexts): object {
    const jsonObj = { ...obj, ...{} };
