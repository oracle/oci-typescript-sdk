...
export namespace MySupportAccounts {
  export function getJsonObj(obj: MySupportAccounts): object {
    const jsonObj = {
      ...obj,
      ...{
    ...
    delete (jsonObj as Partial<MySupportAccounts>).resources;

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: MySupportAccounts): object {
    const jsonObj = {
      ...obj,
      ...{
