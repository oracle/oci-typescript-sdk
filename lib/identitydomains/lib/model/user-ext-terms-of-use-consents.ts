...
export namespace UserExtTermsOfUseConsents {
  export function getJsonObj(obj: UserExtTermsOfUseConsents): object {
    const jsonObj = {
      ...obj,
      ...{
        "$ref": obj.ref
    ...
    delete (jsonObj as Partial<UserExtTermsOfUseConsents>).ref;

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: UserExtTermsOfUseConsents): object {
    const jsonObj = {
      ...obj,
      ...{
        "ref": (obj as any)["$ref"]
