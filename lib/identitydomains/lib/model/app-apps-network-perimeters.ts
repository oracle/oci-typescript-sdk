...
export namespace AppAppsNetworkPerimeters {
  export function getJsonObj(obj: AppAppsNetworkPerimeters): object {
    const jsonObj = {
      ...obj,
      ...{
        "$ref": obj.ref
    ...
    delete (jsonObj as Partial<AppAppsNetworkPerimeters>).ref;

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: AppAppsNetworkPerimeters): object {
    const jsonObj = {
      ...obj,
      ...{
        "ref": (obj as any)["$ref"]
