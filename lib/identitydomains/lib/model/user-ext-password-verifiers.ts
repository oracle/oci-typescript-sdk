...
export namespace UserExtPasswordVerifiers {
  export function getJsonObj(obj: UserExtPasswordVerifiers): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: UserExtPasswordVerifiers): object {
    const jsonObj = { ...obj, ...{} };
