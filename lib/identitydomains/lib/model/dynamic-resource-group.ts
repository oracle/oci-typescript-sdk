...
export namespace DynamicResourceGroup {
  ...
  export function getJsonObj(obj: DynamicResourceGroup): object {
    const jsonObj = {
      ...obj,
      ...{
    ...
    delete (jsonObj as Partial<DynamicResourceGroup>)
      .urnIetfParamsScimSchemasOracleIdcsExtensionOciTags;

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: DynamicResourceGroup): object {
    const jsonObj = {
      ...obj,
      ...{
