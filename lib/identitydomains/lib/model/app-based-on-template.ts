...
export namespace AppBasedOnTemplate {
  export function getJsonObj(obj: AppBasedOnTemplate): object {
    const jsonObj = {
      ...obj,
      ...{
        "$ref": obj.ref
    ...
    delete (jsonObj as Partial<AppBasedOnTemplate>).ref;

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: AppBasedOnTemplate): object {
    const jsonObj = {
      ...obj,
      ...{
        "ref": (obj as any)["$ref"]
