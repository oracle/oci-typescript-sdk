...
export namespace CloudGates {
  export function getJsonObj(obj: CloudGates): object {
    const jsonObj = {
      ...obj,
      ...{
    ...
    delete (jsonObj as Partial<CloudGates>).resources;

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: CloudGates): object {
    const jsonObj = {
      ...obj,
      ...{
