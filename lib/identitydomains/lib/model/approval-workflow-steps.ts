...
export namespace ApprovalWorkflowSteps {
  export function getJsonObj(obj: ApprovalWorkflowSteps): object {
    const jsonObj = {
      ...obj,
      ...{
    ...
    delete (jsonObj as Partial<ApprovalWorkflowSteps>).resources;

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: ApprovalWorkflowSteps): object {
    const jsonObj = {
      ...obj,
      ...{
