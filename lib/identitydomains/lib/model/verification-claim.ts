...
export namespace VerificationClaim {
  ...
  export function getJsonObj(obj: VerificationClaim): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: VerificationClaim): object {
    const jsonObj = {
      ...obj,
      ...{
