...
export namespace MyAppSearchRequest {
  ...
  export function getJsonObj(obj: MyAppSearchRequest): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: MyAppSearchRequest): object {
    const jsonObj = { ...obj, ...{} };
