...
export namespace AppRoleSearchRequest {
  ...
  export function getJsonObj(obj: AppRoleSearchRequest): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: AppRoleSearchRequest): object {
    const jsonObj = { ...obj, ...{} };
