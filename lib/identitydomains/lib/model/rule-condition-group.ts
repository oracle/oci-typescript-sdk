...
export namespace RuleConditionGroup {
  export enum Type {
    Condition = "Condition",
  ...
  export function getJsonObj(obj: RuleConditionGroup): object {
    const jsonObj = {
      ...obj,
      ...{
        "$ref": obj.ref
    ...
    delete (jsonObj as Partial<RuleConditionGroup>).ref;

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: RuleConditionGroup): object {
    const jsonObj = {
      ...obj,
      ...{
        "ref": (obj as any)["$ref"]
