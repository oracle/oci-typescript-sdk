...
export namespace UserExtTrustedUserAgents {
  export function getJsonObj(obj: UserExtTrustedUserAgents): object {
    const jsonObj = {
      ...obj,
      ...{
        "$ref": obj.ref
    ...
    delete (jsonObj as Partial<UserExtTrustedUserAgents>).ref;

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: UserExtTrustedUserAgents): object {
    const jsonObj = {
      ...obj,
      ...{
        "ref": (obj as any)["$ref"]
