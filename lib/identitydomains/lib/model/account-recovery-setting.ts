...
export namespace AccountRecoverySetting {
  ...
  export function getJsonObj(obj: AccountRecoverySetting): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: AccountRecoverySetting): object {
    const jsonObj = {
      ...obj,
      ...{
