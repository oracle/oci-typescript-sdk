...
export namespace IdentityProofingProviderTemplates {
  export function getJsonObj(obj: IdentityProofingProviderTemplates): object {
    const jsonObj = {
      ...obj,
      ...{
    ...
    delete (jsonObj as Partial<IdentityProofingProviderTemplates>).resources;

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: IdentityProofingProviderTemplates): object {
    const jsonObj = {
      ...obj,
      ...{
