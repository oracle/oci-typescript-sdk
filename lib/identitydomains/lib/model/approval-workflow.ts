...
export namespace ApprovalWorkflow {
  ...
  export function getJsonObj(obj: ApprovalWorkflow): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: ApprovalWorkflow): object {
    const jsonObj = {
      ...obj,
      ...{
