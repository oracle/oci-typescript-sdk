...
export namespace CloudGateServer {
  ...
  export function getJsonObj(obj: CloudGateServer): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: CloudGateServer): object {
    const jsonObj = {
      ...obj,
      ...{
