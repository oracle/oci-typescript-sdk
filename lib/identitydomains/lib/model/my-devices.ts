...
export namespace MyDevices {
  export function getJsonObj(obj: MyDevices): object {
    const jsonObj = {
      ...obj,
      ...{
    ...
    delete (jsonObj as Partial<MyDevices>).resources;

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: MyDevices): object {
    const jsonObj = {
      ...obj,
      ...{
