...
export namespace OAuth2ClientCredentialSearchRequest {
  ...
  export function getJsonObj(obj: OAuth2ClientCredentialSearchRequest): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: OAuth2ClientCredentialSearchRequest): object {
    const jsonObj = { ...obj, ...{} };
