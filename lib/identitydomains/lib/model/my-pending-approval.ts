...
export namespace MyPendingApproval {
  ...
  export function getJsonObj(obj: MyPendingApproval): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: MyPendingApproval): object {
    const jsonObj = {
      ...obj,
      ...{
