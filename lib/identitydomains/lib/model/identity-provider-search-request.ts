...
export namespace IdentityProviderSearchRequest {
  ...
  export function getJsonObj(obj: IdentityProviderSearchRequest): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: IdentityProviderSearchRequest): object {
    const jsonObj = { ...obj, ...{} };
