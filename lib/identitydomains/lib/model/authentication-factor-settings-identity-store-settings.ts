...
export namespace AuthenticationFactorSettingsIdentityStoreSettings {
  export function getJsonObj(obj: AuthenticationFactorSettingsIdentityStoreSettings): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(
    obj: AuthenticationFactorSettingsIdentityStoreSettings
  ): object {
    const jsonObj = { ...obj, ...{} };
