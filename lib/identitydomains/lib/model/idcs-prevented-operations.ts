...
export namespace IdcsPreventedOperations {
  export function getJsonObj(obj: IdcsPreventedOperations): IdcsPreventedOperations {
    return obj;
  }
  export function getDeserializedJsonObj(obj: IdcsPreventedOperations): IdcsPreventedOperations {
    return obj;
  }
}
