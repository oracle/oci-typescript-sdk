...
export namespace UserExtCustomerSecretKeys {
  export function getJsonObj(obj: UserExtCustomerSecretKeys): object {
    const jsonObj = {
      ...obj,
      ...{
        "$ref": obj.ref
    ...
    delete (jsonObj as Partial<UserExtCustomerSecretKeys>).ref;

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: UserExtCustomerSecretKeys): object {
    const jsonObj = {
      ...obj,
      ...{
        "ref": (obj as any)["$ref"]
