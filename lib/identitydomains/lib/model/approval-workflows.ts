...
export namespace ApprovalWorkflows {
  export function getJsonObj(obj: ApprovalWorkflows): object {
    const jsonObj = {
      ...obj,
      ...{
    ...
    delete (jsonObj as Partial<ApprovalWorkflows>).resources;

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: ApprovalWorkflows): object {
    const jsonObj = {
      ...obj,
      ...{
