...
export namespace SocialIdentityProviderRelayIdpParamMappings {
  export function getJsonObj(obj: SocialIdentityProviderRelayIdpParamMappings): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: SocialIdentityProviderRelayIdpParamMappings): object {
    const jsonObj = { ...obj, ...{} };
