...
export namespace MyCustomerSecretKeyUser {
  export function getJsonObj(obj: MyCustomerSecretKeyUser): object {
    const jsonObj = {
      ...obj,
      ...{
        "$ref": obj.ref
    ...
    delete (jsonObj as Partial<MyCustomerSecretKeyUser>).ref;

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: MyCustomerSecretKeyUser): object {
    const jsonObj = {
      ...obj,
      ...{
        "ref": (obj as any)["$ref"]
