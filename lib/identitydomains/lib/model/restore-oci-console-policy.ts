...
export namespace RestoreOciConsolePolicy {
  ...
  export function getJsonObj(obj: RestoreOciConsolePolicy): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: RestoreOciConsolePolicy): object {
    const jsonObj = {
      ...obj,
      ...{
