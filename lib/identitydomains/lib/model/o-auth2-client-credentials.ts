...
export namespace OAuth2ClientCredentials {
  export function getJsonObj(obj: OAuth2ClientCredentials): object {
    const jsonObj = {
      ...obj,
      ...{
    ...
    delete (jsonObj as Partial<OAuth2ClientCredentials>).resources;

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: OAuth2ClientCredentials): object {
    const jsonObj = {
      ...obj,
      ...{
