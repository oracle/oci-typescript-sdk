...
export namespace MySmtpCredential {
  ...
  export function getJsonObj(obj: MySmtpCredential): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: MySmtpCredential): object {
    const jsonObj = {
      ...obj,
      ...{
