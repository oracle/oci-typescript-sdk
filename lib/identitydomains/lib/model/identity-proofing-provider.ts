...
export namespace IdentityProofingProvider {
  ...
  export function getJsonObj(obj: IdentityProofingProvider): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: IdentityProofingProvider): object {
    const jsonObj = {
      ...obj,
      ...{
