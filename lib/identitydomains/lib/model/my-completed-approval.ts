...
export namespace MyCompletedApproval {
  ...
  export function getJsonObj(obj: MyCompletedApproval): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: MyCompletedApproval): object {
    const jsonObj = {
      ...obj,
      ...{
