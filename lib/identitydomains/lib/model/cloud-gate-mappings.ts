...
export namespace CloudGateMappings {
  export function getJsonObj(obj: CloudGateMappings): object {
    const jsonObj = {
      ...obj,
      ...{
    ...
    delete (jsonObj as Partial<CloudGateMappings>).resources;

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: CloudGateMappings): object {
    const jsonObj = {
      ...obj,
      ...{
