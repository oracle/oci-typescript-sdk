...
export namespace AttributeSets {
  export function getJsonObj(obj: AttributeSets): AttributeSets {
    return obj;
  }
  export function getDeserializedJsonObj(obj: AttributeSets): AttributeSets {
    return obj;
  }
}
