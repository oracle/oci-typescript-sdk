...
export namespace SecurityQuestions {
  export function getJsonObj(obj: SecurityQuestions): object {
    const jsonObj = {
      ...obj,
      ...{
    ...
    delete (jsonObj as Partial<SecurityQuestions>).resources;

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: SecurityQuestions): object {
    const jsonObj = {
      ...obj,
      ...{
