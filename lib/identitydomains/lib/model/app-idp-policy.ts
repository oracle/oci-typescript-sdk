...
export namespace AppIdpPolicy {
  export function getJsonObj(obj: AppIdpPolicy): object {
    const jsonObj = {
      ...obj,
      ...{
        "$ref": obj.ref
    ...
    delete (jsonObj as Partial<AppIdpPolicy>).ref;

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: AppIdpPolicy): object {
    const jsonObj = {
      ...obj,
      ...{
        "ref": (obj as any)["$ref"]
