...
export namespace IdentityPropagationTrusts {
  export function getJsonObj(obj: IdentityPropagationTrusts): object {
    const jsonObj = {
      ...obj,
      ...{
    ...
    delete (jsonObj as Partial<IdentityPropagationTrusts>).resources;

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: IdentityPropagationTrusts): object {
    const jsonObj = {
      ...obj,
      ...{
