...
export namespace OciConsoleSignOnPolicyConsentSearchRequest {
  ...
  export function getJsonObj(obj: OciConsoleSignOnPolicyConsentSearchRequest): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: OciConsoleSignOnPolicyConsentSearchRequest): object {
    const jsonObj = { ...obj, ...{} };
