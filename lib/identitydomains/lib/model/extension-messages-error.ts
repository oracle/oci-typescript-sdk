...
export namespace ExtensionMessagesError {
  export function getJsonObj(obj: ExtensionMessagesError): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: ExtensionMessagesError): object {
    const jsonObj = { ...obj, ...{} };
