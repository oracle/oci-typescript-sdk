...
export namespace KmsiSettings {
  export function getJsonObj(obj: KmsiSettings): object {
    const jsonObj = {
      ...obj,
      ...{
    ...
    delete (jsonObj as Partial<KmsiSettings>).resources;

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: KmsiSettings): object {
    const jsonObj = {
      ...obj,
      ...{
