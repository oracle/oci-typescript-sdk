...
export namespace NotificationSettingsSearchRequest {
  ...
  export function getJsonObj(obj: NotificationSettingsSearchRequest): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: NotificationSettingsSearchRequest): object {
    const jsonObj = { ...obj, ...{} };
