...
export namespace ApprovalWorkflowStep {
  ...
  export function getJsonObj(obj: ApprovalWorkflowStep): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: ApprovalWorkflowStep): object {
    const jsonObj = {
      ...obj,
      ...{
