...
export namespace OAuthPartnerCertificates {
  export function getJsonObj(obj: OAuthPartnerCertificates): object {
    const jsonObj = {
      ...obj,
      ...{
    ...
    delete (jsonObj as Partial<OAuthPartnerCertificates>).resources;

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: OAuthPartnerCertificates): object {
    const jsonObj = {
      ...obj,
      ...{
