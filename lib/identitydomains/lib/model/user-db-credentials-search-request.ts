...
export namespace UserDbCredentialsSearchRequest {
  ...
  export function getJsonObj(obj: UserDbCredentialsSearchRequest): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: UserDbCredentialsSearchRequest): object {
    const jsonObj = { ...obj, ...{} };
