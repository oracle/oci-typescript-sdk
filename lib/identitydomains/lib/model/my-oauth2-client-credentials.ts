...
export namespace MyOAuth2ClientCredentials {
  export function getJsonObj(obj: MyOAuth2ClientCredentials): object {
    const jsonObj = {
      ...obj,
      ...{
    ...
    delete (jsonObj as Partial<MyOAuth2ClientCredentials>).resources;

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: MyOAuth2ClientCredentials): object {
    const jsonObj = {
      ...obj,
      ...{
