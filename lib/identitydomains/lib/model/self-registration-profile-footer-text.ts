...
export namespace SelfRegistrationProfileFooterText {
  export function getJsonObj(obj: SelfRegistrationProfileFooterText): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: SelfRegistrationProfileFooterText): object {
    const jsonObj = { ...obj, ...{} };
