...
export namespace SocialIdentityProviderSearchRequest {
  ...
  export function getJsonObj(obj: SocialIdentityProviderSearchRequest): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: SocialIdentityProviderSearchRequest): object {
    const jsonObj = { ...obj, ...{} };
