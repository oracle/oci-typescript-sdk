...
export namespace ApprovalWorkflowAssignment {
  ...
  export function getJsonObj(obj: ApprovalWorkflowAssignment): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: ApprovalWorkflowAssignment): object {
    const jsonObj = {
      ...obj,
      ...{
        ...
        "approvalWorkflow": obj.approvalWorkflow
          ? model.ApprovalWorkflowAssignmentApprovalWorkflow.getDeserializedJsonObj(
