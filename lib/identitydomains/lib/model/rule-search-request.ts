...
export namespace RuleSearchRequest {
  ...
  export function getJsonObj(obj: RuleSearchRequest): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: RuleSearchRequest): object {
    const jsonObj = { ...obj, ...{} };
