...
export namespace RuleExtensionOciconsolesignonpolicyconsentPolicy {
  export function getJsonObj(obj: RuleExtensionOciconsolesignonpolicyconsentPolicy): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(
    obj: RuleExtensionOciconsolesignonpolicyconsentPolicy
  ): object {
    const jsonObj = { ...obj, ...{} };
