...
export namespace CloudGateMappingServer {
  export function getJsonObj(obj: CloudGateMappingServer): object {
    const jsonObj = {
      ...obj,
      ...{
        "$ref": obj.ref
    ...
    delete (jsonObj as Partial<CloudGateMappingServer>).ref;

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: CloudGateMappingServer): object {
    const jsonObj = {
      ...obj,
      ...{
        "ref": (obj as any)["$ref"]
