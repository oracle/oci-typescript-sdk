...
export namespace DynamicResourceGroupDynamicGroupAppRoles {
  export function getJsonObj(obj: DynamicResourceGroupDynamicGroupAppRoles): object {
    const jsonObj = {
      ...obj,
      ...{
        "$ref": obj.ref
    ...
    delete (jsonObj as Partial<DynamicResourceGroupDynamicGroupAppRoles>).ref;

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: DynamicResourceGroupDynamicGroupAppRoles): object {
    const jsonObj = {
      ...obj,
      ...{
        "ref": (obj as any)["$ref"]
