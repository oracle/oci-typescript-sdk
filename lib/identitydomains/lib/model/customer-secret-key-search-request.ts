...
export namespace CustomerSecretKeySearchRequest {
  ...
  export function getJsonObj(obj: CustomerSecretKeySearchRequest): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: CustomerSecretKeySearchRequest): object {
    const jsonObj = { ...obj, ...{} };
