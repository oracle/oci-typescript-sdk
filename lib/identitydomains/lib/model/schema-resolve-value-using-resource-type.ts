...
export namespace SchemaResolveValueUsingResourceType {
  export function getJsonObj(obj: SchemaResolveValueUsingResourceType): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: SchemaResolveValueUsingResourceType): object {
    const jsonObj = { ...obj, ...{} };
