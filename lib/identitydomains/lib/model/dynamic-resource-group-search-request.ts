...
export namespace DynamicResourceGroupSearchRequest {
  ...
  export function getJsonObj(obj: DynamicResourceGroupSearchRequest): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: DynamicResourceGroupSearchRequest): object {
    const jsonObj = { ...obj, ...{} };
