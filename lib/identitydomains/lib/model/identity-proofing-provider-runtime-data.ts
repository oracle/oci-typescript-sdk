...
export namespace IdentityProofingProviderRuntimeData {
  export function getJsonObj(obj: IdentityProofingProviderRuntimeData): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: IdentityProofingProviderRuntimeData): object {
    const jsonObj = { ...obj, ...{} };
