...
export namespace MyOAuth2ClientCredential {
  ...
  export function getJsonObj(obj: MyOAuth2ClientCredential): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: MyOAuth2ClientCredential): object {
    const jsonObj = {
      ...obj,
      ...{
