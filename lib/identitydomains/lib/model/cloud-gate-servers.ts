...
export namespace CloudGateServers {
  export function getJsonObj(obj: CloudGateServers): object {
    const jsonObj = {
      ...obj,
      ...{
    ...
    delete (jsonObj as Partial<CloudGateServers>).resources;

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: CloudGateServers): object {
    const jsonObj = {
      ...obj,
      ...{
