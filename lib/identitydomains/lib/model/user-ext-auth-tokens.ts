...
export namespace UserExtAuthTokens {
  export function getJsonObj(obj: UserExtAuthTokens): object {
    const jsonObj = {
      ...obj,
      ...{
        "$ref": obj.ref
    ...
    delete (jsonObj as Partial<UserExtAuthTokens>).ref;

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: UserExtAuthTokens): object {
    const jsonObj = {
      ...obj,
      ...{
        "ref": (obj as any)["$ref"]
