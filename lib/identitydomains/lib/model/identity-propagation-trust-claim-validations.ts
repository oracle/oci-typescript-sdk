 ...
 */
export interface IdentityPropagationTrustClaimValidations {
  /**
   * Claim Name
   * <p>
   **Added In:** 2509172316
...
export namespace IdentityPropagationTrustClaimValidations {
  export function getJsonObj(obj: IdentityPropagationTrustClaimValidations): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: IdentityPropagationTrustClaimValidations): object {
    const jsonObj = { ...obj, ...{} };
