...
export namespace MyAuthenticationFactorInitiatorAdditionalAttributes {
  export function getJsonObj(obj: MyAuthenticationFactorInitiatorAdditionalAttributes): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(
    obj: MyAuthenticationFactorInitiatorAdditionalAttributes
  ): object {
    const jsonObj = { ...obj, ...{} };
