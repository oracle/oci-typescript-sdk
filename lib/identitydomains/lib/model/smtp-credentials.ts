...
export namespace SmtpCredentials {
  export function getJsonObj(obj: SmtpCredentials): object {
    const jsonObj = {
      ...obj,
      ...{
    ...
    delete (jsonObj as Partial<SmtpCredentials>).resources;

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: SmtpCredentials): object {
    const jsonObj = {
      ...obj,
      ...{
