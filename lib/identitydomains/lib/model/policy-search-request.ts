...
export namespace PolicySearchRequest {
  ...
  export function getJsonObj(obj: PolicySearchRequest): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: PolicySearchRequest): object {
    const jsonObj = { ...obj, ...{} };
