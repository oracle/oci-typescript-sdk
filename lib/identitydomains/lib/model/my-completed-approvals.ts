...
export namespace MyCompletedApprovals {
  export function getJsonObj(obj: MyCompletedApprovals): object {
    const jsonObj = {
      ...obj,
      ...{
    ...
    delete (jsonObj as Partial<MyCompletedApprovals>).resources;

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: MyCompletedApprovals): object {
    const jsonObj = {
      ...obj,
      ...{
