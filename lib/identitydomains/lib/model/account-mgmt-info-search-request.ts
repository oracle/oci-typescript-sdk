...
export namespace AccountMgmtInfoSearchRequest {
  ...
  export function getJsonObj(obj: AccountMgmtInfoSearchRequest): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: AccountMgmtInfoSearchRequest): object {
    const jsonObj = { ...obj, ...{} };
