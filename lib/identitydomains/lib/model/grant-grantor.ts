...
export namespace GrantGrantor {
  ...
  export function getJsonObj(obj: GrantGrantor): object {
    const jsonObj = {
      ...obj,
      ...{
        "$ref": obj.ref
    ...
    delete (jsonObj as Partial<GrantGrantor>).ref;

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: GrantGrantor): object {
    const jsonObj = {
      ...obj,
      ...{
        "ref": (obj as any)["$ref"]
