...
export namespace AppSearchRequest {
  ...
  export function getJsonObj(obj: AppSearchRequest): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: AppSearchRequest): object {
    const jsonObj = { ...obj, ...{} };
