...
export namespace ExtensionSffUser {
  export function getJsonObj(obj: ExtensionSffUser): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: ExtensionSffUser): object {
    const jsonObj = { ...obj, ...{} };
