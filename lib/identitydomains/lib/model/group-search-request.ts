...
export namespace GroupSearchRequest {
  ...
  export function getJsonObj(obj: GroupSearchRequest): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: GroupSearchRequest): object {
    const jsonObj = { ...obj, ...{} };
