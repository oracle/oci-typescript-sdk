...
export namespace OAuthPartnerCertificate {
  ...
  export function getJsonObj(obj: OAuthPartnerCertificate): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: OAuthPartnerCertificate): object {
    const jsonObj = {
      ...obj,
      ...{
