...
export namespace AppIdentityProviders {
  export function getJsonObj(obj: AppIdentityProviders): object {
    const jsonObj = {
      ...obj,
      ...{
        "$ref": obj.ref
    ...
    delete (jsonObj as Partial<AppIdentityProviders>).ref;

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: AppIdentityProviders): object {
    const jsonObj = {
      ...obj,
      ...{
        "ref": (obj as any)["$ref"]
