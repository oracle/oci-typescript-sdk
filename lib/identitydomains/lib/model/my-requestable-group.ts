...
export namespace MyRequestableGroup {
  ...
  export function getJsonObj(obj: MyRequestableGroup): object {
    const jsonObj = {
      ...obj,
      ...{
    ...
    delete (jsonObj as Partial<MyRequestableGroup>)
  ...
  export function getDeserializedJsonObj(obj: MyRequestableGroup): object {
    const jsonObj = {
      ...obj,
      ...{
