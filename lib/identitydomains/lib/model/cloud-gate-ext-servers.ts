...
export namespace CloudGateExtServers {
  export function getJsonObj(obj: CloudGateExtServers): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: CloudGateExtServers): object {
    const jsonObj = { ...obj, ...{} };
