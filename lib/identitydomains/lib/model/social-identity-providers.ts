...
export namespace SocialIdentityProviders {
  export function getJsonObj(obj: SocialIdentityProviders): object {
    const jsonObj = {
      ...obj,
      ...{
    ...
    delete (jsonObj as Partial<SocialIdentityProviders>).resources;

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: SocialIdentityProviders): object {
    const jsonObj = {
      ...obj,
      ...{
