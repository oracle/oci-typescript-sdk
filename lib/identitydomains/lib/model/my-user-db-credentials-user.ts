...
export namespace MyUserDbCredentialsUser {
  export function getJsonObj(obj: MyUserDbCredentialsUser): object {
    const jsonObj = {
      ...obj,
      ...{
        "$ref": obj.ref
    ...
    delete (jsonObj as Partial<MyUserDbCredentialsUser>).ref;

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: MyUserDbCredentialsUser): object {
    const jsonObj = {
      ...obj,
      ...{
        "ref": (obj as any)["$ref"]
