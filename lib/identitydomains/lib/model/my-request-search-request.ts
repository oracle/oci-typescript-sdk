...
export namespace MyRequestSearchRequest {
  ...
  export function getJsonObj(obj: MyRequestSearchRequest): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: MyRequestSearchRequest): object {
    const jsonObj = { ...obj, ...{} };
