...
export namespace VerificationClaimIdcsLockedBy {
  export enum Type {
    User = "User",
    App = "App",
    /**
  ...
  export function getJsonObj(obj: VerificationClaimIdcsLockedBy): object {
    const jsonObj = {
      ...obj,
      ...{
        "$ref": obj.ref
    ...
    delete (jsonObj as Partial<VerificationClaimIdcsLockedBy>).ref;

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: VerificationClaimIdcsLockedBy): object {
    const jsonObj = {
      ...obj,
      ...{
        "ref": (obj as any)["$ref"]
