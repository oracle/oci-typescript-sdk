...
export namespace MyUserDbCredential {
  ...
  export function getJsonObj(obj: MyUserDbCredential): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: MyUserDbCredential): object {
    const jsonObj = {
      ...obj,
      ...{
