...
export namespace ExtensionSelfChangeUser {
  export function getJsonObj(obj: ExtensionSelfChangeUser): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: ExtensionSelfChangeUser): object {
    const jsonObj = { ...obj, ...{} };
