...
export namespace IdentityProofingProviders {
  export function getJsonObj(obj: IdentityProofingProviders): object {
    const jsonObj = {
      ...obj,
      ...{
    ...
    delete (jsonObj as Partial<IdentityProofingProviders>).resources;

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: IdentityProofingProviders): object {
    const jsonObj = {
      ...obj,
      ...{
