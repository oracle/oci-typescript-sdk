...
export namespace MyCustomerSecretKey {
  ...
  export function getJsonObj(obj: MyCustomerSecretKey): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: MyCustomerSecretKey): object {
    const jsonObj = {
      ...obj,
      ...{
