...
export namespace MyRequestRequestor {
  export function getJsonObj(obj: MyRequestRequestor): object {
    const jsonObj = {
      ...obj,
      ...{
        "$ref": obj.ref
    ...
    delete (jsonObj as Partial<MyRequestRequestor>).ref;

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: MyRequestRequestor): object {
    const jsonObj = {
      ...obj,
      ...{
        "ref": (obj as any)["$ref"]
