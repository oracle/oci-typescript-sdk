...
export namespace MappedAttributeSearchRequest {
  ...
  export function getJsonObj(obj: MappedAttributeSearchRequest): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: MappedAttributeSearchRequest): object {
    const jsonObj = { ...obj, ...{} };
