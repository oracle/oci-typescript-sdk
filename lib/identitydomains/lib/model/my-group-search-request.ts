...
export namespace MyGroupSearchRequest {
  ...
  export function getJsonObj(obj: MyGroupSearchRequest): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: MyGroupSearchRequest): object {
    const jsonObj = { ...obj, ...{} };
