...
export namespace ResourceTypeSchemaAttributeSearchRequest {
  ...
  export function getJsonObj(obj: ResourceTypeSchemaAttributeSearchRequest): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: ResourceTypeSchemaAttributeSearchRequest): object {
    const jsonObj = { ...obj, ...{} };
