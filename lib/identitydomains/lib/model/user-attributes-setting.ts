...
export namespace UserAttributesSetting {
  ...
  export function getJsonObj(obj: UserAttributesSetting): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: UserAttributesSetting): object {
    const jsonObj = {
      ...obj,
      ...{
