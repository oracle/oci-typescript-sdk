...
export namespace ResourceTypeSchemaAttributes {
  export function getJsonObj(obj: ResourceTypeSchemaAttributes): object {
    const jsonObj = {
      ...obj,
      ...{
    ...
    delete (jsonObj as Partial<ResourceTypeSchemaAttributes>).resources;

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: ResourceTypeSchemaAttributes): object {
    const jsonObj = {
      ...obj,
      ...{
