...
export namespace CloudGateOauthClient {
  export function getJsonObj(obj: CloudGateOauthClient): object {
    const jsonObj = {
      ...obj,
      ...{
        "$ref": obj.ref
    ...
    delete (jsonObj as Partial<CloudGateOauthClient>).ref;

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: CloudGateOauthClient): object {
    const jsonObj = {
      ...obj,
      ...{
        "ref": (obj as any)["$ref"]
