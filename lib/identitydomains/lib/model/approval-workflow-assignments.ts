...
export namespace ApprovalWorkflowAssignments {
  export function getJsonObj(obj: ApprovalWorkflowAssignments): object {
    const jsonObj = {
      ...obj,
      ...{
    ...
    delete (jsonObj as Partial<ApprovalWorkflowAssignments>).resources;

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: ApprovalWorkflowAssignments): object {
    const jsonObj = {
      ...obj,
      ...{
