...
export namespace CustomerSecretKeys {
  export function getJsonObj(obj: CustomerSecretKeys): object {
    const jsonObj = {
      ...obj,
      ...{
    ...
    delete (jsonObj as Partial<CustomerSecretKeys>).resources;

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: CustomerSecretKeys): object {
    const jsonObj = {
      ...obj,
      ...{
