...
export namespace MyAuthTokenUser {
  export function getJsonObj(obj: MyAuthTokenUser): object {
    const jsonObj = {
      ...obj,
      ...{
        "$ref": obj.ref
    ...
    delete (jsonObj as Partial<MyAuthTokenUser>).ref;

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: MyAuthTokenUser): object {
    const jsonObj = {
      ...obj,
      ...{
        "ref": (obj as any)["$ref"]
