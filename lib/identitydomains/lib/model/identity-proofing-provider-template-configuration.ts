...
export namespace IdentityProofingProviderTemplateConfiguration {
  export function getJsonObj(obj: IdentityProofingProviderTemplateConfiguration): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(
    obj: IdentityProofingProviderTemplateConfiguration
  ): object {
    const jsonObj = { ...obj, ...{} };
