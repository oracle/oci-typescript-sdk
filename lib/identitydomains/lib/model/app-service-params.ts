...
export namespace AppServiceParams {
  export function getJsonObj(obj: AppServiceParams): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: AppServiceParams): object {
    const jsonObj = { ...obj, ...{} };
