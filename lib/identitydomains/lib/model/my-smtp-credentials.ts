...
export namespace MySmtpCredentials {
  export function getJsonObj(obj: MySmtpCredentials): object {
    const jsonObj = {
      ...obj,
      ...{
    ...
    delete (jsonObj as Partial<MySmtpCredentials>).resources;

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: MySmtpCredentials): object {
    const jsonObj = {
      ...obj,
      ...{
