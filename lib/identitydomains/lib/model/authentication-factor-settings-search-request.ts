...
export namespace AuthenticationFactorSettingsSearchRequest {
  ...
  export function getJsonObj(obj: AuthenticationFactorSettingsSearchRequest): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: AuthenticationFactorSettingsSearchRequest): object {
    const jsonObj = { ...obj, ...{} };
