...
export namespace SmtpCredentialSearchRequest {
  ...
  export function getJsonObj(obj: SmtpCredentialSearchRequest): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: SmtpCredentialSearchRequest): object {
    const jsonObj = { ...obj, ...{} };
