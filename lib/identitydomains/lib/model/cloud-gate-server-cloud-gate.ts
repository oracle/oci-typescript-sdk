...
export namespace CloudGateServerCloudGate {
  export function getJsonObj(obj: CloudGateServerCloudGate): object {
    const jsonObj = {
      ...obj,
      ...{
        "$ref": obj.ref
    ...
    delete (jsonObj as Partial<CloudGateServerCloudGate>).ref;

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: CloudGateServerCloudGate): object {
    const jsonObj = {
      ...obj,
      ...{
        "ref": (obj as any)["$ref"]
