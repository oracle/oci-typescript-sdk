...
export namespace IdentitySettingsMyProfile {
  export function getJsonObj(obj: IdentitySettingsMyProfile): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: IdentitySettingsMyProfile): object {
    const jsonObj = { ...obj, ...{} };
