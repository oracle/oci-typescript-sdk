...
export namespace ApprovalWorkflowApprovalWorkflowSteps {
  export function getJsonObj(obj: ApprovalWorkflowApprovalWorkflowSteps): object {
    const jsonObj = {
      ...obj,
      ...{
        "$ref": obj.ref
    ...
    delete (jsonObj as Partial<ApprovalWorkflowApprovalWorkflowSteps>).ref;

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: ApprovalWorkflowApprovalWorkflowSteps): object {
    const jsonObj = {
      ...obj,
      ...{
        "ref": (obj as any)["$ref"]
