...
export namespace NetworkPerimeter {
  ...
  export function getJsonObj(obj: NetworkPerimeter): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: NetworkPerimeter): object {
    const jsonObj = {
      ...obj,
      ...{
