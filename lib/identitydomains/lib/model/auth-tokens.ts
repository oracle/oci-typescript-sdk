...
export namespace AuthTokens {
  export function getJsonObj(obj: AuthTokens): object {
    const jsonObj = {
      ...obj,
      ...{
    ...
    delete (jsonObj as Partial<AuthTokens>).resources;

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: AuthTokens): object {
    const jsonObj = {
      ...obj,
      ...{
