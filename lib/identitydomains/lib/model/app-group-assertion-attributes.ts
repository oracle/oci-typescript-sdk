...
export namespace AppGroupAssertionAttributes {
  export function getJsonObj(obj: AppGroupAssertionAttributes): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: AppGroupAssertionAttributes): object {
    const jsonObj = { ...obj, ...{} };
