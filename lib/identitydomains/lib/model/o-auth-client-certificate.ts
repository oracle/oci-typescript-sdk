...
export namespace OAuthClientCertificate {
  ...
  export function getJsonObj(obj: OAuthClientCertificate): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: OAuthClientCertificate): object {
    const jsonObj = {
      ...obj,
      ...{
