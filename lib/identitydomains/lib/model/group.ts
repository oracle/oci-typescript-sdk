...
export namespace Group {
  ...
  export function getJsonObj(obj: Group): object {
    const jsonObj = {
      ...
      ...{
        ...
        "urn:ietf:params:scim:schemas:oracle:idcs:extension:requestable:Group": obj.urnIetfParamsScimSchemasOracleIdcsExtensionRequestableGroup
          ? model.ExtensionRequestableGroup.getJsonObj(
        ...
        "urn:ietf:params:scim:schemas:oracle:idcs:extension:dbcs:Group": obj.urnIetfParamsScimSchemasOracleIdcsExtensionDbcsGroup
          ? model.ExtensionDbcsGroup.getJsonObj(
              obj.urnIetfParamsScimSchemasOracleIdcsExtensionDbcsGroup
            )
          : undefined,
        "urn:ietf:params:scim:schemas:oracle:idcs:extension:dynamic:Group": obj.urnIetfParamsScimSchemasOracleIdcsExtensionDynamicGroup
          ? model.ExtensionDynamicGroup.getJsonObj(
              obj.urnIetfParamsScimSchemasOracleIdcsExtensionDynamicGroup
            )
          : undefined,
    ...
    delete (jsonObj as Partial<Group>).urnIetfParamsScimSchemasOracleIdcsExtensionGroupGroup;
    delete (jsonObj as Partial<Group>).urnIetfParamsScimSchemasOracleIdcsExtensionPosixGroup;
    delete (jsonObj as Partial<Group>).urnIetfParamsScimSchemasOracleIdcsExtensionRequestableGroup;
    delete (jsonObj as Partial<Group>).urnIetfParamsScimSchemasOracleIdcsExtensionDbcsGroup;
    delete (jsonObj as Partial<Group>).urnIetfParamsScimSchemasOracleIdcsExtensionDynamicGroup;
    delete (jsonObj as Partial<Group>).urnIetfParamsScimSchemasOracleIdcsExtensionOciTags;
  ...
  export function getDeserializedJsonObj(obj: Group): object {
    const jsonObj = {
      ...
      ...{
        ...
        "urnIetfParamsScimSchemasOracleIdcsExtensionPosixGroup": (obj as any)[
          ...
          : undefined,
        "urnIetfParamsScimSchemasOracleIdcsExtensionRequestableGroup": (obj as any)[
          "urn:ietf:params:scim:schemas:oracle:idcs:extension:requestable:Group"
        ]
          ? model.ExtensionRequestableGroup.getDeserializedJsonObj(
              (obj as any)["urn:ietf:params:scim:schemas:oracle:idcs:extension:requestable:Group"]
            )
          : undefined,
        "urnIetfParamsScimSchemasOracleIdcsExtensionDbcsGroup": (obj as any)[
          "urn:ietf:params:scim:schemas:oracle:idcs:extension:dbcs:Group"
        ]
          ? model.ExtensionDbcsGroup.getDeserializedJsonObj(
              (obj as any)["urn:ietf:params:scim:schemas:oracle:idcs:extension:dbcs:Group"]
            )
          : undefined,
        "urnIetfParamsScimSchemasOracleIdcsExtensionDynamicGroup": (obj as any)[
          "urn:ietf:params:scim:schemas:oracle:idcs:extension:dynamic:Group"
        ]
          ? model.ExtensionDynamicGroup.getDeserializedJsonObj(
              (obj as any)["urn:ietf:params:scim:schemas:oracle:idcs:extension:dynamic:Group"]
            )
          : undefined,
    ...
    delete (jsonObj as any)["urn:ietf:params:scim:schemas:oracle:idcs:extension:requestable:Group"];
    delete (jsonObj as any)["urn:ietf:params:scim:schemas:oracle:idcs:extension:dbcs:Group"];
    delete (jsonObj as any)["urn:ietf:params:scim:schemas:oracle:idcs:extension:dynamic:Group"];
