...
export namespace IdentityProofingProviderSearchRequest {
  ...
  export function getJsonObj(obj: IdentityProofingProviderSearchRequest): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: IdentityProofingProviderSearchRequest): object {
    const jsonObj = { ...obj, ...{} };
