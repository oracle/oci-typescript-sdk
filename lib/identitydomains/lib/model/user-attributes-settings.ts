...
export namespace UserAttributesSettings {
  export function getJsonObj(obj: UserAttributesSettings): object {
    const jsonObj = {
      ...obj,
      ...{
    ...
    delete (jsonObj as Partial<UserAttributesSettings>).resources;

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: UserAttributesSettings): object {
    const jsonObj = {
      ...obj,
      ...{
