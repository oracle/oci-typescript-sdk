...
export namespace MyPendingApprovals {
  export function getJsonObj(obj: MyPendingApprovals): object {
    const jsonObj = {
      ...obj,
      ...{
    ...
    delete (jsonObj as Partial<MyPendingApprovals>).resources;

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: MyPendingApprovals): object {
    const jsonObj = {
      ...obj,
      ...{
