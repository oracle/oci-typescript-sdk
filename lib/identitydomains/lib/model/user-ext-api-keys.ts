...
export namespace UserExtApiKeys {
  export function getJsonObj(obj: UserExtApiKeys): object {
    const jsonObj = {
      ...obj,
      ...{
        "$ref": obj.ref
    ...
    delete (jsonObj as Partial<UserExtApiKeys>).ref;

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: UserExtApiKeys): object {
    const jsonObj = {
      ...obj,
      ...{
        "ref": (obj as any)["$ref"]
