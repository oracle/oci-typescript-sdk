...
export namespace AppAppSignonPolicy {
  export function getJsonObj(obj: AppAppSignonPolicy): object {
    const jsonObj = {
      ...obj,
      ...{
        "$ref": obj.ref
    ...
    delete (jsonObj as Partial<AppAppSignonPolicy>).ref;

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: AppAppSignonPolicy): object {
    const jsonObj = {
      ...obj,
      ...{
        "ref": (obj as any)["$ref"]
