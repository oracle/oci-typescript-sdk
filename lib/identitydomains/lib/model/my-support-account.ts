...
export namespace MySupportAccount {
  ...
  export function getJsonObj(obj: MySupportAccount): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: MySupportAccount): object {
    const jsonObj = {
      ...obj,
      ...{
