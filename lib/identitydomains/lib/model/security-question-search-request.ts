...
export namespace SecurityQuestionSearchRequest {
  ...
  export function getJsonObj(obj: SecurityQuestionSearchRequest): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: SecurityQuestionSearchRequest): object {
    const jsonObj = { ...obj, ...{} };
