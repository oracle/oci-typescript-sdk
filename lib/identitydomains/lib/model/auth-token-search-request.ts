...
export namespace AuthTokenSearchRequest {
  ...
  export function getJsonObj(obj: AuthTokenSearchRequest): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: AuthTokenSearchRequest): object {
    const jsonObj = { ...obj, ...{} };
