...
export namespace IdentityProofingProviderIdcsLockedBy {
  export enum Type {
    User = "User",
    App = "App",
    /**
  ...
  export function getJsonObj(obj: IdentityProofingProviderIdcsLockedBy): object {
    const jsonObj = {
      ...obj,
      ...{
        "$ref": obj.ref
    ...
    delete (jsonObj as Partial<IdentityProofingProviderIdcsLockedBy>).ref;

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: IdentityProofingProviderIdcsLockedBy): object {
    const jsonObj = {
      ...obj,
      ...{
        "ref": (obj as any)["$ref"]
