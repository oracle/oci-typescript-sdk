...
export namespace ChangeOccDemandSignalCompartmentDetails {
  export function getJsonObj(obj: ChangeOccDemandSignalCompartmentDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: ChangeOccDemandSignalCompartmentDetails): object {
    const jsonObj = { ...obj, ...{} };
