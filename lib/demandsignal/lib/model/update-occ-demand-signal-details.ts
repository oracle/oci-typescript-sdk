...
export namespace UpdateOccDemandSignalDetails {
  export function getJsonObj(obj: UpdateOccDemandSignalDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: UpdateOccDemandSignalDetails): object {
    const jsonObj = { ...obj, ...{} };
