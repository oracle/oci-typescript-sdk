...
export namespace OccDemandSignalSummary {
  export function getJsonObj(obj: OccDemandSignalSummary): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: OccDemandSignalSummary): object {
    const jsonObj = { ...obj, ...{} };
