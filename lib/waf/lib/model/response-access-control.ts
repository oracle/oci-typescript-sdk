...
export namespace ResponseAccessControl {
  export function getJsonObj(obj: ResponseAccessControl): object {
    const jsonObj = {
      ...obj,
      ...{
        "rules": obj.rules
  ...
  export function getDeserializedJsonObj(obj: ResponseAccessControl): object {
    const jsonObj = {
      ...obj,
      ...{
        "rules": obj.rules
