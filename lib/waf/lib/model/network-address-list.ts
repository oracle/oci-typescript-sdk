...
export namespace NetworkAddressList {
      ...
      switch (obj.type) {
        case "ADDRESSES":
          return model.NetworkAddressListAddresses.getJsonObj(
            <model.NetworkAddressListAddresses>(<object>jsonObj),
            true
          );
        case "VCN_ADDRESSES":
          return model.NetworkAddressListVcnAddresses.getJsonObj(
            <model.NetworkAddressListVcnAddresses>(<object>jsonObj),
            true
          );
        default:
  ...
  export function getDeserializedJsonObj(obj: NetworkAddressList): object {
    ...
    if (obj && "type" in obj && obj.type) {
      switch (obj.type) {
        ...
        case "VCN_ADDRESSES":
          return model.NetworkAddressListVcnAddresses.getDeserializedJsonObj(
            <model.NetworkAddressListVcnAddresses>(<object>jsonObj),
            true
          );
        default:
