...
export namespace UpdateWebAppFirewallDetails {
  export function getJsonObj(obj: UpdateWebAppFirewallDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: UpdateWebAppFirewallDetails): object {
    const jsonObj = { ...obj, ...{} };
