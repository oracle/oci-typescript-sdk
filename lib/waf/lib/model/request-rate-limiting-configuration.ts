...
export namespace RequestRateLimitingConfiguration {
  export function getJsonObj(obj: RequestRateLimitingConfiguration): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: RequestRateLimitingConfiguration): object {
    const jsonObj = { ...obj, ...{} };
