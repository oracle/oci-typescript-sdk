...
export namespace CreateNetworkAddressListDetails {
      ...
      switch (obj.type) {
        case "VCN_ADDRESSES":
          return model.CreateNetworkAddressListVcnAddressesDetails.getJsonObj(
            <model.CreateNetworkAddressListVcnAddressesDetails>(<object>jsonObj),
            true
          );
        case "ADDRESSES":
          return model.CreateNetworkAddressListAddressesDetails.getJsonObj(
            <model.CreateNetworkAddressListAddressesDetails>(<object>jsonObj),
            true
          );
        default:
  ...
  export function getDeserializedJsonObj(obj: CreateNetworkAddressListDetails): object {
    ...
    if (obj && "type" in obj && obj.type) {
      switch (obj.type) {
        ...
        case "ADDRESSES":
          return model.CreateNetworkAddressListAddressesDetails.getDeserializedJsonObj(
            <model.CreateNetworkAddressListAddressesDetails>(<object>jsonObj),
            true
          );
        default:
