...
export namespace UpdateScheduledQueryDetails {
  export function getJsonObj(obj: UpdateScheduledQueryDetails): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: UpdateScheduledQueryDetails): object {
    const jsonObj = {
      ...obj,
      ...{
        "scheduledQueryProcessingConfiguration": obj.scheduledQueryProcessingConfiguration
