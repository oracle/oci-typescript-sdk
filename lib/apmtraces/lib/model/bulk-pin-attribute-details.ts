...
export namespace BulkPinAttributeDetails {
  export function getJsonObj(obj: BulkPinAttributeDetails): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: BulkPinAttributeDetails): object {
    const jsonObj = {
      ...obj,
      ...{
        "attributeDetails": obj.attributeDetails
