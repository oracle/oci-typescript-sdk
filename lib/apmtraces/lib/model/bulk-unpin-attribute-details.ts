...
export namespace BulkUnpinAttributeDetails {
  export function getJsonObj(obj: BulkUnpinAttributeDetails): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: BulkUnpinAttributeDetails): object {
    const jsonObj = {
      ...obj,
      ...{
        "attributeDetails": obj.attributeDetails
