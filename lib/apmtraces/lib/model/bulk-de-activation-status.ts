...
export namespace BulkDeActivationStatus {
  export function getJsonObj(obj: BulkDeActivationStatus): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: BulkDeActivationStatus): object {
    const jsonObj = {
      ...obj,
      ...{
        "attributeStatuses": obj.attributeStatuses
