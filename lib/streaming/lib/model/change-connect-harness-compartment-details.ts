...
export namespace ChangeConnectHarnessCompartmentDetails {
  export function getJsonObj(obj: ChangeConnectHarnessCompartmentDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: ChangeConnectHarnessCompartmentDetails): object {
    const jsonObj = { ...obj, ...{} };
