...
export namespace ChangeStreamCompartmentDetails {
  export function getJsonObj(obj: ChangeStreamCompartmentDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: ChangeStreamCompartmentDetails): object {
    const jsonObj = { ...obj, ...{} };
