...
export namespace QueueCapability {
  export function getJsonObj(obj: QueueCapability): QueueCapability {
    return obj;
  }
  export function getDeserializedJsonObj(obj: QueueCapability): QueueCapability {
    return obj;
  }
}
