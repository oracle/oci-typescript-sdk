...
export namespace UpdateConsumerGroupDetails {
  export function getJsonObj(obj: UpdateConsumerGroupDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: UpdateConsumerGroupDetails): object {
    const jsonObj = { ...obj, ...{} };
