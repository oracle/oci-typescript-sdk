...
export namespace ConsumerGroupSummary {
  export function getJsonObj(obj: ConsumerGroupSummary): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: ConsumerGroupSummary): object {
    const jsonObj = { ...obj, ...{} };
