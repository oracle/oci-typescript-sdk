...
/**
 * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/opensearch/ListOpensearchClusters.ts.html |here} to see how to use ListOpensearchClustersRequest.
 */
...
export namespace ListOpensearchClustersRequest {
  export enum SortBy {
