...
export namespace OpensearchClusterCollection {
  export function getJsonObj(obj: OpensearchClusterCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
  ...
  export function getDeserializedJsonObj(obj: OpensearchClusterCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
