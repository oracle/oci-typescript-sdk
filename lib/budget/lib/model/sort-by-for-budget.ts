 ...
 *
 **/
export enum SortByForBudget {
  TimeCreated = "timeCreated",
  DisplayName = "displayName"
}

export namespace SortByForBudget {
  export function getJsonObj(obj: SortByForBudget): SortByForBudget {
    return obj;
  }
  export function getDeserializedJsonObj(obj: SortByForBudget): SortByForBudget {
    return obj;
  }
}
