...
export namespace PipelineProperties {
  export function getJsonObj(obj: PipelineProperties): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: PipelineProperties): object {
    const jsonObj = { ...obj, ...{} };
