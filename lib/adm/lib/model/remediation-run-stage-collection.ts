...
export namespace RemediationRunStageCollection {
  export function getJsonObj(obj: RemediationRunStageCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
  ...
  export function getDeserializedJsonObj(obj: RemediationRunStageCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
