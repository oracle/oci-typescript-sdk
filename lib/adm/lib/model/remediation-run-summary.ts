...
export namespace RemediationRunSummary {
  export function getJsonObj(obj: RemediationRunSummary): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: RemediationRunSummary): object {
    const jsonObj = { ...obj, ...{} };
