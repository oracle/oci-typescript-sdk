...
export namespace RemediationRunCollection {
  export function getJsonObj(obj: RemediationRunCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
  ...
  export function getDeserializedJsonObj(obj: RemediationRunCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
