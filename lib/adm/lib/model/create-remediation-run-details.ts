...
export namespace CreateRemediationRunDetails {
  export function getJsonObj(obj: CreateRemediationRunDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: CreateRemediationRunDetails): object {
    const jsonObj = { ...obj, ...{} };
