...
export namespace PullRequestProperties {
  export function getJsonObj(obj: PullRequestProperties): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: PullRequestProperties): object {
    const jsonObj = { ...obj, ...{} };
