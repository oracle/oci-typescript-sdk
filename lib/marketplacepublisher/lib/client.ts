...
export enum AdministratorArtifactApiKeys {}
/**
 * This service client uses {@link common.CircuitBreaker.DefaultConfiguration} for all the operations by default if no circuit breaker configuration is defined by the user.
 */
export class AdministratorArtifactClient {
  ...
  public targetService = "AdministratorArtifact";
  ...
  public set endpoint(endpoint: string) {
    ...
    if (this.logger)
      this.logger.info(`AdministratorArtifactClient endpoint set to ${this._endpoint}`);
  }
  ...
  public set useRealmSpecificEndpointTemplate(realmSpecificEndpointTemplateEnabled: boolean) {
    ...
    if (this._lastSetRegionOrRegionId === common.Region.REGION_STRING) {
      this.endpoint = common.EndpointBuilder.createEndpointFromRegion(
        AdministratorArtifactClient.serviceEndpointTemplate,
        this._region,
        AdministratorArtifactClient.endpointServiceName
      );
   ...
   * @param UpdateAdminArtifactStatusRequest
   * @return UpdateAdminArtifactStatusResponse
   * @throws OciError when an error occurs
   * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/marketplacepublisher/UpdateAdminArtifactStatus.ts.html |here} to see how to use UpdateAdminArtifactStatus API.
   */
  public async updateAdminArtifactStatus(
    updateAdminArtifactStatusRequest: requests.UpdateAdminArtifactStatusRequest
  ): Promise<responses.UpdateAdminArtifactStatusResponse> {
    if (this.logger)
      this.logger.debug("Calling operation AdministratorArtifactClient#updateAdminArtifactStatus.");
    const operationName = "updateAdminArtifactStatus";
    const apiReferenceLink = "";
    const pathParams = {
      "{artifactId}": updateAdminArtifactStatusRequest.artifactId
    };
    ...
    let headerParams = {
      ...
      "if-match": updateAdminArtifactStatusRequest.ifMatch,
      "opc-request-id": updateAdminArtifactStatusRequest.opcRequestId
    };

    const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
    const retrier = GenericRetrier.createPreferredRetrier(
      this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined,
      updateAdminArtifactStatusRequest.retryConfiguration,
    ...
    const request = await composeRequest({
      ...
      path: "/adminArtifacts/{artifactId}/status/new",
      method: "PUT",
      bodyContent: common.ObjectSerializer.serialize(
        updateAdminArtifactStatusRequest.updateAdminArtifactStatusDetails,
        "UpdateAdminArtifactStatusDetails",
        model.UpdateAdminArtifactStatusDetails.getJsonObj
      ),
    ...
    try {
      ...
      const sdkResponse = composeResponse({
        responseObject: <responses.UpdateAdminArtifactStatusResponse>{},
...
export enum AdministratorPublisherApiKeys {}
/**
 * This service client uses {@link common.CircuitBreaker.DefaultConfiguration} for all the operations by default if no circuit breaker configuration is defined by the user.
 */
export class AdministratorPublisherClient {
  protected static serviceEndpointTemplate =
    "https://marketplace-publisher.{region}.oci.{secondLevelDomain}";
  protected static endpointServiceName = "";
  protected "_realmSpecificEndpointTemplateEnabled": boolean | undefined = undefined;
  ...
  protected _httpOptions: any = undefined;
  protected _bodyDuplexMode: any = undefined;
  public targetService = "AdministratorPublisher";
  protected _regionId: string = "";
  protected "_region": common.Region;
  protected _lastSetRegionOrRegionId: string = "";
  ...
  public set endpoint(endpoint: string) {
    ...
    this._endpoint = this._endpoint + "/20241201";
    if (this.logger)
      this.logger.info(`AdministratorPublisherClient endpoint set to ${this._endpoint}`);
  }
  ...
  public set useRealmSpecificEndpointTemplate(realmSpecificEndpointTemplateEnabled: boolean) {
    ...
    if (this._lastSetRegionOrRegionId === common.Region.REGION_STRING) {
      this.endpoint = common.EndpointBuilder.createEndpointFromRegion(
        AdministratorPublisherClient.serviceEndpointTemplate,
        this._region,
        AdministratorPublisherClient.endpointServiceName
      );
    } else if (this._lastSetRegionOrRegionId === common.Region.REGION_ID_STRING) {
      this.endpoint = common.EndpointBuilder.createEndpointFromRegionId(
        AdministratorPublisherClient.serviceEndpointTemplate,
   ...
   * This operation uses {@link common.OciSdkDefaultRetryConfiguration} by default if no retry configuration is defined by the user.
   * @param GetAdminPublisherRequest
   * @return GetAdminPublisherResponse
   * @throws OciError when an error occurs
   * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/marketplacepublisher/GetAdminPublisher.ts.html |here} to see how to use GetAdminPublisher API.
   */
  public async getAdminPublisher(
    getAdminPublisherRequest: requests.GetAdminPublisherRequest
  ): Promise<responses.GetAdminPublisherResponse> {
    if (this.logger)
      this.logger.debug("Calling operation AdministratorPublisherClient#getAdminPublisher.");
    const operationName = "getAdminPublisher";
    const apiReferenceLink = "";
    const pathParams = {
      "{publisherId}": getAdminPublisherRequest.publisherId
    };
    ...
    let headerParams = {
      "Content-Type": common.Constants.APPLICATION_JSON,
      "opc-request-id": getAdminPublisherRequest.opcRequestId
    };

    const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
    const retrier = GenericRetrier.createPreferredRetrier(
      this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined,
      getAdminPublisherRequest.retryConfiguration,
      specRetryConfiguration
    );
    if (this.logger) retrier.logger = this.logger;
    const request = await composeRequest({
      baseEndpoint: this._endpoint,
      defaultHeaders: this._defaultHeaders,
      path: "/adminPublishers/{publisherId}",
      method: "GET",
      pathParams: pathParams,
      headerParams: headerParams,
      queryParams: queryParams
    ...
    try {
      ...
      const sdkResponse = composeResponse({
        responseObject: <responses.GetAdminPublisherResponse>{},
        body: await response.json(),
        bodyKey: "adminPublisher",
        bodyModel: model.AdminPublisher,
        type: "model.AdminPublisher",
        responseHeaders: [
          {
            value: response.headers.get("etag"),
            key: "etag",
...
export enum MarketplaceAdministratorApiKeys {}
/**
 * This service client uses {@link common.CircuitBreaker.DefaultConfiguration} for all the operations by default if no circuit breaker configuration is defined by the user.
 */
export class MarketplaceAdministratorClient {
  protected static serviceEndpointTemplate =
    "https://marketplace-publisher.{region}.oci.{secondLevelDomain}";
  protected static endpointServiceName = "";
  protected "_realmSpecificEndpointTemplateEnabled": boolean | undefined = undefined;
  ...
  protected _httpOptions: any = undefined;
  protected _bodyDuplexMode: any = undefined;
  public targetService = "MarketplaceAdministrator";
  protected _regionId: string = "";
  protected "_region": common.Region;
  protected _lastSetRegionOrRegionId: string = "";
  ...
  public set endpoint(endpoint: string) {
    ...
    this._endpoint = this._endpoint + "/20241201";
    if (this.logger)
      this.logger.info(`MarketplaceAdministratorClient endpoint set to ${this._endpoint}`);
  }
  ...
  public set useRealmSpecificEndpointTemplate(realmSpecificEndpointTemplateEnabled: boolean) {
    ...
    if (this._lastSetRegionOrRegionId === common.Region.REGION_STRING) {
      this.endpoint = common.EndpointBuilder.createEndpointFromRegion(
        MarketplaceAdministratorClient.serviceEndpointTemplate,
        this._region,
        MarketplaceAdministratorClient.endpointServiceName
      );
    } else if (this._lastSetRegionOrRegionId === common.Region.REGION_ID_STRING) {
      this.endpoint = common.EndpointBuilder.createEndpointFromRegionId(
        MarketplaceAdministratorClient.serviceEndpointTemplate,
   ...
   * This operation uses {@link common.OciSdkDefaultRetryConfiguration} by default if no retry configuration is defined by the user.
   * @param ChangeListingRevisionStatusToNewRequest
   * @return ChangeListingRevisionStatusToNewResponse
   * @throws OciError when an error occurs
   * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/marketplacepublisher/ChangeListingRevisionStatusToNew.ts.html |here} to see how to use ChangeListingRevisionStatusToNew API.
   */
  public async changeListingRevisionStatusToNew(
    changeListingRevisionStatusToNewRequest: requests.ChangeListingRevisionStatusToNewRequest
  ): Promise<responses.ChangeListingRevisionStatusToNewResponse> {
    if (this.logger)
      this.logger.debug(
        "Calling operation MarketplaceAdministratorClient#changeListingRevisionStatusToNew."
      );
    const operationName = "changeListingRevisionStatusToNew";
    const apiReferenceLink = "";
    const pathParams = {
      "{listingRevisionId}": changeListingRevisionStatusToNewRequest.listingRevisionId
    };
    ...
    let headerParams = {
      "Content-Type": common.Constants.APPLICATION_JSON,
      "if-match": changeListingRevisionStatusToNewRequest.ifMatch,
      "opc-request-id": changeListingRevisionStatusToNewRequest.opcRequestId
    };

    const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
    const retrier = GenericRetrier.createPreferredRetrier(
      this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined,
      changeListingRevisionStatusToNewRequest.retryConfiguration,
      specRetryConfiguration
    );
    if (this.logger) retrier.logger = this.logger;
    const request = await composeRequest({
      baseEndpoint: this._endpoint,
      defaultHeaders: this._defaultHeaders,
      path: "/adminListingRevisions/{listingRevisionId}/status/new",
      method: "POST",
      pathParams: pathParams,
      headerParams: headerParams,
      queryParams: queryParams
    ...
    try {
      ...
      const sdkResponse = composeResponse({
        responseObject: <responses.ChangeListingRevisionStatusToNewResponse>{},
        body: await response.json(),
        bodyKey: "adminListingRevision",
        bodyModel: model.AdminListingRevision,
        type: "model.AdminListingRevision",
        responseHeaders: [
          {
            value: response.headers.get("opc-request-id"),
            key: "opcRequestId",
   ...
   *
   * This operation uses {@link common.OciSdkDefaultRetryConfiguration} by default if no retry configuration is defined by the user.
   * @param CreateMarketRequest
   * @return CreateMarketResponse
   * @throws OciError when an error occurs
   * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/marketplacepublisher/CreateMarket.ts.html |here} to see how to use CreateMarket API.
   */
  public async createMarket(
    createMarketRequest: requests.CreateMarketRequest
  ): Promise<responses.CreateMarketResponse> {
    if (this.logger)
      this.logger.debug("Calling operation MarketplaceAdministratorClient#createMarket.");
    const operationName = "createMarket";
    const apiReferenceLink = "";
    const pathParams = {};
    ...
    let headerParams = {
      "Content-Type": common.Constants.APPLICATION_JSON,
      "opc-retry-token": createMarketRequest.opcRetryToken,
      "opc-request-id": createMarketRequest.opcRequestId
    };

    const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
    const retrier = GenericRetrier.createPreferredRetrier(
      this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined,
      createMarketRequest.retryConfiguration,
      specRetryConfiguration
    );
    if (this.logger) retrier.logger = this.logger;
    const request = await composeRequest({
      ...
      method: "POST",
      bodyContent: common.ObjectSerializer.serialize(
        createMarketRequest.createMarketDetails,
        "CreateMarketDetails",
        model.CreateMarketDetails.getJsonObj
      ),
      pathParams: pathParams,
      headerParams: headerParams,
      queryParams: queryParams
    ...
    try {
      ...
      const sdkResponse = composeResponse({
        responseObject: <responses.CreateMarketResponse>{},
        responseHeaders: [
          {
   ...
   * This operation uses {@link common.OciSdkDefaultRetryConfiguration} by default if no retry configuration is defined by the user.
   * @param GetAdminArtifactRequest
   * @return GetAdminArtifactResponse
   * @throws OciError when an error occurs
   * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/marketplacepublisher/GetAdminArtifact.ts.html |here} to see how to use GetAdminArtifact API.
   */
  public async getAdminArtifact(
    getAdminArtifactRequest: requests.GetAdminArtifactRequest
  ): Promise<responses.GetAdminArtifactResponse> {
    if (this.logger)
      this.logger.debug("Calling operation MarketplaceAdministratorClient#getAdminArtifact.");
    const operationName = "getAdminArtifact";
    const apiReferenceLink = "";
    const pathParams = {
      "{artifactId}": getAdminArtifactRequest.artifactId
    };
    ...
    let headerParams = {
      "Content-Type": common.Constants.APPLICATION_JSON,
      "opc-request-id": getAdminArtifactRequest.opcRequestId
    };

    const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
    const retrier = GenericRetrier.createPreferredRetrier(
      this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined,
      getAdminArtifactRequest.retryConfiguration,
      specRetryConfiguration
    );
    if (this.logger) retrier.logger = this.logger;
    const request = await composeRequest({
      baseEndpoint: this._endpoint,
      defaultHeaders: this._defaultHeaders,
      path: "/adminArtifacts/{artifactId}",
      method: "GET",
      pathParams: pathParams,
      headerParams: headerParams,
      queryParams: queryParams
    ...
    try {
      ...
      const sdkResponse = composeResponse({
        responseObject: <responses.GetAdminArtifactResponse>{},
        body: await response.json(),
        bodyKey: "adminArtifact",
        bodyModel: model.AdminArtifact,
        type: "model.AdminArtifact",
        responseHeaders: [
          {
            value: response.headers.get("etag"),
            key: "etag",
   ...
   *
   * This operation uses {@link common.OciSdkDefaultRetryConfiguration} by default if no retry configuration is defined by the user.
   * @param GetAdminListingRequest
   * @return GetAdminListingResponse
   * @throws OciError when an error occurs
   * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/marketplacepublisher/GetAdminListing.ts.html |here} to see how to use GetAdminListing API.
   */
  public async getAdminListing(
    getAdminListingRequest: requests.GetAdminListingRequest
  ): Promise<responses.GetAdminListingResponse> {
    if (this.logger)
      this.logger.debug("Calling operation MarketplaceAdministratorClient#getAdminListing.");
    const operationName = "getAdminListing";
    const apiReferenceLink = "";
    const pathParams = {
      "{listingId}": getAdminListingRequest.listingId
    };
    ...
    let headerParams = {
      "Content-Type": common.Constants.APPLICATION_JSON,
      "opc-request-id": getAdminListingRequest.opcRequestId
    };

    const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
    const retrier = GenericRetrier.createPreferredRetrier(
      this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined,
      getAdminListingRequest.retryConfiguration,
      specRetryConfiguration
    );
    if (this.logger) retrier.logger = this.logger;
    const request = await composeRequest({
    ...
    try {
      ...
      const sdkResponse = composeResponse({
        responseObject: <responses.GetAdminListingResponse>{},
        body: await response.json(),
        bodyKey: "adminListing",
        bodyModel: model.AdminListing,
        type: "model.AdminListing",
        responseHeaders: [
          {
            value: response.headers.get("opc-request-id"),
            key: "opcRequestId",
   ...
   *
   * This operation uses {@link common.OciSdkDefaultRetryConfiguration} by default if no retry configuration is defined by the user.
   * @param GetAdminListingRevisionRequest
   * @return GetAdminListingRevisionResponse
   * @throws OciError when an error occurs
   * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/marketplacepublisher/GetAdminListingRevision.ts.html |here} to see how to use GetAdminListingRevision API.
   */
  public async getAdminListingRevision(
    getAdminListingRevisionRequest: requests.GetAdminListingRevisionRequest
  ): Promise<responses.GetAdminListingRevisionResponse> {
    if (this.logger)
      this.logger.debug(
        "Calling operation MarketplaceAdministratorClient#getAdminListingRevision."
      );
    const operationName = "getAdminListingRevision";
    const apiReferenceLink = "";
    const pathParams = {
      "{listingRevisionId}": getAdminListingRevisionRequest.listingRevisionId
    };
    ...
    let headerParams = {
      "Content-Type": common.Constants.APPLICATION_JSON,
      "opc-request-id": getAdminListingRevisionRequest.opcRequestId
    };

    const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
    const retrier = GenericRetrier.createPreferredRetrier(
      this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined,
      getAdminListingRevisionRequest.retryConfiguration,
      specRetryConfiguration
    );
    if (this.logger) retrier.logger = this.logger;
    const request = await composeRequest({
      baseEndpoint: this._endpoint,
      defaultHeaders: this._defaultHeaders,
      path: "/adminListingRevisions/{listingRevisionId}",
      method: "GET",
      pathParams: pathParams,
      headerParams: headerParams,
      queryParams: queryParams
    ...
    try {
      ...
      const sdkResponse = composeResponse({
        responseObject: <responses.GetAdminListingRevisionResponse>{},
        body: await response.json(),
        bodyKey: "adminListingRevision",
        bodyModel: model.AdminListingRevision,
        type: "model.AdminListingRevision",
   ...
   *
   * This operation uses {@link common.OciSdkDefaultRetryConfiguration} by default if no retry configuration is defined by the user.
   * @param GetAdminListingRevisionAttachmentRequest
   * @return GetAdminListingRevisionAttachmentResponse
   * @throws OciError when an error occurs
   * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/marketplacepublisher/GetAdminListingRevisionAttachment.ts.html |here} to see how to use GetAdminListingRevisionAttachment API.
   */
  public async getAdminListingRevisionAttachment(
    getAdminListingRevisionAttachmentRequest: requests.GetAdminListingRevisionAttachmentRequest
  ): Promise<responses.GetAdminListingRevisionAttachmentResponse> {
    if (this.logger)
      this.logger.debug(
        "Calling operation MarketplaceAdministratorClient#getAdminListingRevisionAttachment."
      );
    const operationName = "getAdminListingRevisionAttachment";
    const apiReferenceLink = "";
    const pathParams = {
      "{listingRevisionAttachmentId}":
        getAdminListingRevisionAttachmentRequest.listingRevisionAttachmentId
    };
    ...
    let headerParams = {
      "Content-Type": common.Constants.APPLICATION_JSON,
      "opc-request-id": getAdminListingRevisionAttachmentRequest.opcRequestId
    };

    const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
    const retrier = GenericRetrier.createPreferredRetrier(
      this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined,
      getAdminListingRevisionAttachmentRequest.retryConfiguration,
      specRetryConfiguration
    );
    if (this.logger) retrier.logger = this.logger;
    const request = await composeRequest({
      baseEndpoint: this._endpoint,
      defaultHeaders: this._defaultHeaders,
      path: "/adminListingRevisionAttachments/{listingRevisionAttachmentId}",
      method: "GET",
      pathParams: pathParams,
      headerParams: headerParams,
      queryParams: queryParams
    ...
    try {
      ...
      const sdkResponse = composeResponse({
        responseObject: <responses.GetAdminListingRevisionAttachmentResponse>{},
        body: await response.json(),
        bodyKey: "adminListingRevisionAttachment",
        bodyModel: model.AdminListingRevisionAttachment,
        type: "model.AdminListingRevisionAttachment",
        responseHeaders: [
          {
            value: response.headers.get("opc-request-id"),
            key: "opcRequestId",
   ...
   *
   * This operation uses {@link common.OciSdkDefaultRetryConfiguration} by default if no retry configuration is defined by the user.
   * @param GetAdminListingRevisionPackageRequest
   * @return GetAdminListingRevisionPackageResponse
   * @throws OciError when an error occurs
   * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/marketplacepublisher/GetAdminListingRevisionPackage.ts.html |here} to see how to use GetAdminListingRevisionPackage API.
   */
  public async getAdminListingRevisionPackage(
    getAdminListingRevisionPackageRequest: requests.GetAdminListingRevisionPackageRequest
  ): Promise<responses.GetAdminListingRevisionPackageResponse> {
    if (this.logger)
      this.logger.debug(
        "Calling operation MarketplaceAdministratorClient#getAdminListingRevisionPackage."
      );
    const operationName = "getAdminListingRevisionPackage";
    const apiReferenceLink = "";
    const pathParams = {
      "{listingRevisionPackageId}": getAdminListingRevisionPackageRequest.listingRevisionPackageId
    };
    ...
    let headerParams = {
      "Content-Type": common.Constants.APPLICATION_JSON,
      "opc-request-id": getAdminListingRevisionPackageRequest.opcRequestId
    };

    const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
    const retrier = GenericRetrier.createPreferredRetrier(
      this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined,
      getAdminListingRevisionPackageRequest.retryConfiguration,
      specRetryConfiguration
    );
    if (this.logger) retrier.logger = this.logger;
    const request = await composeRequest({
      baseEndpoint: this._endpoint,
      defaultHeaders: this._defaultHeaders,
      path: "/adminListingRevisionPackages/{listingRevisionPackageId}",
      method: "GET",
      pathParams: pathParams,
      headerParams: headerParams,
      queryParams: queryParams
    ...
    try {
      ...
      const sdkResponse = composeResponse({
        responseObject: <responses.GetAdminListingRevisionPackageResponse>{},
        body: await response.json(),
        bodyKey: "adminListingRevisionPackage",
        bodyModel: model.AdminListingRevisionPackage,
        type: "model.AdminListingRevisionPackage",
        responseHeaders: [
          {
            value: response.headers.get("opc-request-id"),
            key: "opcRequestId",
   ...
   * This operation uses {@link common.OciSdkDefaultRetryConfiguration} by default if no retry configuration is defined by the user.
   * @param GetAdminTermRequest
   * @return GetAdminTermResponse
   * @throws OciError when an error occurs
   * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/marketplacepublisher/GetAdminTerm.ts.html |here} to see how to use GetAdminTerm API.
   */
  public async getAdminTerm(
    getAdminTermRequest: requests.GetAdminTermRequest
  ): Promise<responses.GetAdminTermResponse> {
    if (this.logger)
      this.logger.debug("Calling operation MarketplaceAdministratorClient#getAdminTerm.");
    const operationName = "getAdminTerm";
    const apiReferenceLink = "";
    const pathParams = {
      "{termId}": getAdminTermRequest.termId
    };
    ...
    let headerParams = {
      "Content-Type": common.Constants.APPLICATION_JSON,
      "opc-request-id": getAdminTermRequest.opcRequestId
    };

    const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
    const retrier = GenericRetrier.createPreferredRetrier(
      this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined,
      getAdminTermRequest.retryConfiguration,
      specRetryConfiguration
    );
    if (this.logger) retrier.logger = this.logger;
    const request = await composeRequest({
    ...
    try {
      ...
      const sdkResponse = composeResponse({
        responseObject: <responses.GetAdminTermResponse>{},
        body: await response.json(),
        bodyKey: "adminTerm",
        bodyModel: model.AdminTerm,
        type: "model.AdminTerm",
        responseHeaders: [
          {
            value: response.headers.get("etag"),
            key: "etag",
   ...
   * This operation uses {@link common.OciSdkDefaultRetryConfiguration} by default if no retry configuration is defined by the user.
   * @param GetAdminTermVersionRequest
   * @return GetAdminTermVersionResponse
   * @throws OciError when an error occurs
   * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/marketplacepublisher/GetAdminTermVersion.ts.html |here} to see how to use GetAdminTermVersion API.
   */
  public async getAdminTermVersion(
    getAdminTermVersionRequest: requests.GetAdminTermVersionRequest
  ): Promise<responses.GetAdminTermVersionResponse> {
    if (this.logger)
      this.logger.debug("Calling operation MarketplaceAdministratorClient#getAdminTermVersion.");
    const operationName = "getAdminTermVersion";
    const apiReferenceLink = "";
    const pathParams = {
      "{termVersionId}": getAdminTermVersionRequest.termVersionId
    };
    ...
    let headerParams = {
      "Content-Type": common.Constants.APPLICATION_JSON,
      "opc-request-id": getAdminTermVersionRequest.opcRequestId
    };

    const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
    const retrier = GenericRetrier.createPreferredRetrier(
      this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined,
      getAdminTermVersionRequest.retryConfiguration,
      specRetryConfiguration
    );
    if (this.logger) retrier.logger = this.logger;
    const request = await composeRequest({
      baseEndpoint: this._endpoint,
      defaultHeaders: this._defaultHeaders,
      path: "/adminTermVersions/{termVersionId}",
      method: "GET",
      pathParams: pathParams,
      headerParams: headerParams,
      queryParams: queryParams
    ...
    try {
      ...
      const sdkResponse = composeResponse({
        responseObject: <responses.GetAdminTermVersionResponse>{},
        body: await response.json(),
        bodyKey: "adminTermVersion",
        bodyModel: model.AdminTermVersion,
        type: "model.AdminTermVersion",
        responseHeaders: [
          {
            value: response.headers.get("etag"),
            key: "etag",
   ...
   *
   * This operation uses {@link common.OciSdkDefaultRetryConfiguration} by default if no retry configuration is defined by the user.
   * @param ListAdminArtifactsRequest
   * @return ListAdminArtifactsResponse
   * @throws OciError when an error occurs
   * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/marketplacepublisher/ListAdminArtifacts.ts.html |here} to see how to use ListAdminArtifacts API.
   */
  public async listAdminArtifacts(
    listAdminArtifactsRequest: requests.ListAdminArtifactsRequest
  ): Promise<responses.ListAdminArtifactsResponse> {
    if (this.logger)
      this.logger.debug("Calling operation MarketplaceAdministratorClient#listAdminArtifacts.");
    const operationName = "listAdminArtifacts";
    const apiReferenceLink = "";
    const pathParams = {};

    const queryParams = {
      "compartmentId": listAdminArtifactsRequest.compartmentId,
      "publisherId": listAdminArtifactsRequest.publisherId,
      "artifactType": listAdminArtifactsRequest.artifactType,
      "lifecycleState": listAdminArtifactsRequest.lifecycleState,
      "displayName": listAdminArtifactsRequest.displayName,
      "status": listAdminArtifactsRequest.status,
      "limit": listAdminArtifactsRequest.limit,
      "page": listAdminArtifactsRequest.page,
      "sortOrder": listAdminArtifactsRequest.sortOrder,
      "sortBy": listAdminArtifactsRequest.sortBy
    };

    let headerParams = {
      "Content-Type": common.Constants.APPLICATION_JSON,
      "opc-request-id": listAdminArtifactsRequest.opcRequestId
    };

    const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
    const retrier = GenericRetrier.createPreferredRetrier(
      this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined,
      listAdminArtifactsRequest.retryConfiguration,
      specRetryConfiguration
    );
    if (this.logger) retrier.logger = this.logger;
    const request = await composeRequest({
    ...
    try {
      ...
      const sdkResponse = composeResponse({
        responseObject: <responses.ListAdminArtifactsResponse>{},
        body: await response.json(),
        bodyKey: "adminArtifactCollection",
        bodyModel: model.AdminArtifactCollection,
        type: "model.AdminArtifactCollection",
        responseHeaders: [
          {
            value: response.headers.get("opc-request-id"),
            key: "opcRequestId",
   ...
   *
   * This operation uses {@link common.OciSdkDefaultRetryConfiguration} by default if no retry configuration is defined by the user.
   * @param ListAdminListingRevisionAttachmentsRequest
   * @return ListAdminListingRevisionAttachmentsResponse
   * @throws OciError when an error occurs
   * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/marketplacepublisher/ListAdminListingRevisionAttachments.ts.html |here} to see how to use ListAdminListingRevisionAttachments API.
   */
  public async listAdminListingRevisionAttachments(
    listAdminListingRevisionAttachmentsRequest: requests.ListAdminListingRevisionAttachmentsRequest
  ): Promise<responses.ListAdminListingRevisionAttachmentsResponse> {
    if (this.logger)
      this.logger.debug(
        "Calling operation MarketplaceAdministratorClient#listAdminListingRevisionAttachments."
      );
    const operationName = "listAdminListingRevisionAttachments";
    const apiReferenceLink = "";
    const pathParams = {};

    const queryParams = {
      "listingRevisionId": listAdminListingRevisionAttachmentsRequest.listingRevisionId,
      "displayName": listAdminListingRevisionAttachmentsRequest.displayName,
      "lifecycleState": listAdminListingRevisionAttachmentsRequest.lifecycleState,
      "compartmentId": listAdminListingRevisionAttachmentsRequest.compartmentId,
      "limit": listAdminListingRevisionAttachmentsRequest.limit,
      "page": listAdminListingRevisionAttachmentsRequest.page,
      "sortOrder": listAdminListingRevisionAttachmentsRequest.sortOrder,
      "sortBy": listAdminListingRevisionAttachmentsRequest.sortBy
    };

    let headerParams = {
      "Content-Type": common.Constants.APPLICATION_JSON,
      "opc-request-id": listAdminListingRevisionAttachmentsRequest.opcRequestId
    };

    const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
    const retrier = GenericRetrier.createPreferredRetrier(
      this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined,
      listAdminListingRevisionAttachmentsRequest.retryConfiguration,
      specRetryConfiguration
    );
    if (this.logger) retrier.logger = this.logger;
    const request = await composeRequest({
      baseEndpoint: this._endpoint,
      defaultHeaders: this._defaultHeaders,
      path: "/adminListingRevisionAttachments",
      method: "GET",
      pathParams: pathParams,
      headerParams: headerParams,
      queryParams: queryParams
    ...
    try {
      ...
      const sdkResponse = composeResponse({
        responseObject: <responses.ListAdminListingRevisionAttachmentsResponse>{},
        body: await response.json(),
        bodyKey: "adminListingRevisionAttachmentCollection",
        bodyModel: model.AdminListingRevisionAttachmentCollection,
        type: "model.AdminListingRevisionAttachmentCollection",
        responseHeaders: [
          {
            value: response.headers.get("opc-request-id"),
            key: "opcRequestId",
   ...
   *
   * This operation uses {@link common.OciSdkDefaultRetryConfiguration} by default if no retry configuration is defined by the user.
   * @param ListAdminListingRevisionPackagesRequest
   * @return ListAdminListingRevisionPackagesResponse
   * @throws OciError when an error occurs
   * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/marketplacepublisher/ListAdminListingRevisionPackages.ts.html |here} to see how to use ListAdminListingRevisionPackages API.
   */
  public async listAdminListingRevisionPackages(
    listAdminListingRevisionPackagesRequest: requests.ListAdminListingRevisionPackagesRequest
  ): Promise<responses.ListAdminListingRevisionPackagesResponse> {
    if (this.logger)
      this.logger.debug(
        "Calling operation MarketplaceAdministratorClient#listAdminListingRevisionPackages."
      );
    const operationName = "listAdminListingRevisionPackages";
    const apiReferenceLink = "";
    const pathParams = {};

    const queryParams = {
      "compartmentId": listAdminListingRevisionPackagesRequest.compartmentId,
      "listingRevisionId": listAdminListingRevisionPackagesRequest.listingRevisionId,
      "displayName": listAdminListingRevisionPackagesRequest.displayName,
      "lifecycleState": listAdminListingRevisionPackagesRequest.lifecycleState,
      "limit": listAdminListingRevisionPackagesRequest.limit,
      "page": listAdminListingRevisionPackagesRequest.page,
      "sortOrder": listAdminListingRevisionPackagesRequest.sortOrder,
      "sortBy": listAdminListingRevisionPackagesRequest.sortBy
    };

    let headerParams = {
      "Content-Type": common.Constants.APPLICATION_JSON,
      "opc-request-id": listAdminListingRevisionPackagesRequest.opcRequestId
    };

    const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
    const retrier = GenericRetrier.createPreferredRetrier(
      this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined,
      listAdminListingRevisionPackagesRequest.retryConfiguration,
      specRetryConfiguration
    );
    if (this.logger) retrier.logger = this.logger;
    const request = await composeRequest({
      baseEndpoint: this._endpoint,
      defaultHeaders: this._defaultHeaders,
      path: "/adminListingRevisionPackages",
      method: "GET",
      pathParams: pathParams,
      headerParams: headerParams,
      queryParams: queryParams
    ...
    try {
      ...
      const sdkResponse = composeResponse({
        responseObject: <responses.ListAdminListingRevisionPackagesResponse>{},
        body: await response.json(),
        bodyKey: "adminListingRevisionPackageCollection",
        bodyModel: model.AdminListingRevisionPackageCollection,
        type: "model.AdminListingRevisionPackageCollection",
        responseHeaders: [
          {
            value: response.headers.get("opc-request-id"),
            key: "opcRequestId",
   ...
   *
   * This operation uses {@link common.OciSdkDefaultRetryConfiguration} by default if no retry configuration is defined by the user.
   * @param ListAdminListingRevisionsRequest
   * @return ListAdminListingRevisionsResponse
   * @throws OciError when an error occurs
   * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/marketplacepublisher/ListAdminListingRevisions.ts.html |here} to see how to use ListAdminListingRevisions API.
   */
  public async listAdminListingRevisions(
    listAdminListingRevisionsRequest: requests.ListAdminListingRevisionsRequest
  ): Promise<responses.ListAdminListingRevisionsResponse> {
    if (this.logger)
      this.logger.debug(
        "Calling operation MarketplaceAdministratorClient#listAdminListingRevisions."
      );
    const operationName = "listAdminListingRevisions";
    const apiReferenceLink = "";
    const pathParams = {};

    const queryParams = {
      "listingId": listAdminListingRevisionsRequest.listingId,
      "compartmentId": listAdminListingRevisionsRequest.compartmentId,
      "listingType": listAdminListingRevisionsRequest.listingType,
      "displayName": listAdminListingRevisionsRequest.displayName,
      "publisherId": listAdminListingRevisionsRequest.publisherId,
      "lifecycleState": listAdminListingRevisionsRequest.lifecycleState,
      "listingRevisionStatus": listAdminListingRevisionsRequest.listingRevisionStatus,
      "statusCsv": listAdminListingRevisionsRequest.statusCsv,
      "product": listAdminListingRevisionsRequest.product,
      "timeCreatedAfter": listAdminListingRevisionsRequest.timeCreatedAfter,
      "timeUpdatedAfter": listAdminListingRevisionsRequest.timeUpdatedAfter,
      "limit": listAdminListingRevisionsRequest.limit,
      "page": listAdminListingRevisionsRequest.page,
      "sortOrder": listAdminListingRevisionsRequest.sortOrder,
      "sortBy": listAdminListingRevisionsRequest.sortBy,
      "pricingType": listAdminListingRevisionsRequest.pricingType,
      "isPrivateOfferEnabled": listAdminListingRevisionsRequest.isPrivateOfferEnabled,
      "dataSource": listAdminListingRevisionsRequest.dataSource
    };

    let headerParams = {
      "Content-Type": common.Constants.APPLICATION_JSON,
      "opc-request-id": listAdminListingRevisionsRequest.opcRequestId
    };

    const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
    const retrier = GenericRetrier.createPreferredRetrier(
      this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined,
      listAdminListingRevisionsRequest.retryConfiguration,
      specRetryConfiguration
    );
    if (this.logger) retrier.logger = this.logger;
    const request = await composeRequest({
    ...
    try {
      ...
      const sdkResponse = composeResponse({
        responseObject: <responses.ListAdminListingRevisionsResponse>{},
        body: await response.json(),
        bodyKey: "adminListingRevisionCollection",
        bodyModel: model.AdminListingRevisionCollection,
        type: "model.AdminListingRevisionCollection",
        responseHeaders: [
          {
            value: response.headers.get("opc-request-id"),
            key: "opcRequestId",
   ...
   * This operation uses {@link common.OciSdkDefaultRetryConfiguration} by default if no retry configuration is defined by the user.
   * @param ListAdminPublisherSkusRequest
   * @return ListAdminPublisherSkusResponse
   * @throws OciError when an error occurs
   * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/marketplacepublisher/ListAdminPublisherSkus.ts.html |here} to see how to use ListAdminPublisherSkus API.
   */
  public async listAdminPublisherSkus(
    listAdminPublisherSkusRequest: requests.ListAdminPublisherSkusRequest
  ): Promise<responses.ListAdminPublisherSkusResponse> {
    if (this.logger)
      this.logger.debug("Calling operation MarketplaceAdministratorClient#listAdminPublisherSkus.");
    const operationName = "listAdminPublisherSkus";
    const apiReferenceLink = "";
    const pathParams = {};

    const queryParams = {
      "limit": listAdminPublisherSkusRequest.limit,
      "page": listAdminPublisherSkusRequest.page
    };

    let headerParams = {
      "Content-Type": common.Constants.APPLICATION_JSON,
      "opc-request-id": listAdminPublisherSkusRequest.opcRequestId
    };

    const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
    const retrier = GenericRetrier.createPreferredRetrier(
      this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined,
      listAdminPublisherSkusRequest.retryConfiguration,
      specRetryConfiguration
    );
    if (this.logger) retrier.logger = this.logger;
    const request = await composeRequest({
    ...
    try {
      ...
      const sdkResponse = composeResponse({
        responseObject: <responses.ListAdminPublisherSkusResponse>{},
        body: await response.json(),
        bodyKey: "adminPublisherSkuCollection",
        bodyModel: model.AdminPublisherSkuCollection,
        type: "model.AdminPublisherSkuCollection",
        responseHeaders: [
          {
            value: response.headers.get("opc-request-id"),
            key: "opcRequestId",
   ...
   * This operation uses {@link common.OciSdkDefaultRetryConfiguration} by default if no retry configuration is defined by the user.
   * @param ListAdminTermVersionsRequest
   * @return ListAdminTermVersionsResponse
   * @throws OciError when an error occurs
   * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/marketplacepublisher/ListAdminTermVersions.ts.html |here} to see how to use ListAdminTermVersions API.
   */
  public async listAdminTermVersions(
    listAdminTermVersionsRequest: requests.ListAdminTermVersionsRequest
  ): Promise<responses.ListAdminTermVersionsResponse> {
    if (this.logger)
      this.logger.debug("Calling operation MarketplaceAdministratorClient#listAdminTermVersions.");
    const operationName = "listAdminTermVersions";
    const apiReferenceLink = "";
    const pathParams = {};

    const queryParams = {
      "termId": listAdminTermVersionsRequest.termId,
      "compartmentId": listAdminTermVersionsRequest.compartmentId,
      "limit": listAdminTermVersionsRequest.limit,
      "page": listAdminTermVersionsRequest.page,
      "sortOrder": listAdminTermVersionsRequest.sortOrder,
      "sortBy": listAdminTermVersionsRequest.sortBy,
      "displayName": listAdminTermVersionsRequest.displayName
    };

    let headerParams = {
      "Content-Type": common.Constants.APPLICATION_JSON,
      "opc-request-id": listAdminTermVersionsRequest.opcRequestId
    };

    const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
    const retrier = GenericRetrier.createPreferredRetrier(
      this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined,
      listAdminTermVersionsRequest.retryConfiguration,
      specRetryConfiguration
    );
    if (this.logger) retrier.logger = this.logger;
    const request = await composeRequest({
    ...
    try {
      ...
      const sdkResponse = composeResponse({
        responseObject: <responses.ListAdminTermVersionsResponse>{},
        body: await response.json(),
        bodyKey: "adminTermVersionCollection",
        bodyModel: model.AdminTermVersionCollection,
        type: "model.AdminTermVersionCollection",
        responseHeaders: [
          {
            value: response.headers.get("opc-next-page"),
            key: "opcNextPage",
   ...
   * This operation uses {@link common.OciSdkDefaultRetryConfiguration} by default if no retry configuration is defined by the user.
   * @param ListAdminTermsRequest
   * @return ListAdminTermsResponse
   * @throws OciError when an error occurs
   * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/marketplacepublisher/ListAdminTerms.ts.html |here} to see how to use ListAdminTerms API.
   */
  public async listAdminTerms(
    listAdminTermsRequest: requests.ListAdminTermsRequest
  ): Promise<responses.ListAdminTermsResponse> {
    if (this.logger)
      this.logger.debug("Calling operation MarketplaceAdministratorClient#listAdminTerms.");
    const operationName = "listAdminTerms";
    const apiReferenceLink = "";
    const pathParams = {};

    const queryParams = {
      "limit": listAdminTermsRequest.limit,
      "page": listAdminTermsRequest.page,
      "compartmentId": listAdminTermsRequest.compartmentId,
      "sortOrder": listAdminTermsRequest.sortOrder,
      "sortBy": listAdminTermsRequest.sortBy,
      "name": listAdminTermsRequest.name
    };

    let headerParams = {
      "Content-Type": common.Constants.APPLICATION_JSON,
      "opc-request-id": listAdminTermsRequest.opcRequestId
    };

    const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
    const retrier = GenericRetrier.createPreferredRetrier(
      this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined,
      listAdminTermsRequest.retryConfiguration,
      specRetryConfiguration
    );
    if (this.logger) retrier.logger = this.logger;
    const request = await composeRequest({
    ...
    try {
      ...
      const sdkResponse = composeResponse({
        responseObject: <responses.ListAdminTermsResponse>{},
        body: await response.json(),
        bodyKey: "adminTermCollection",
        bodyModel: model.AdminTermCollection,
        type: "model.AdminTermCollection",
        responseHeaders: [
          {
            value: response.headers.get("opc-next-page"),
            key: "opcNextPage",
   ...
   *
   * This operation uses {@link common.OciSdkDefaultRetryConfiguration} by default if no retry configuration is defined by the user.
   * @param ListAdminWorkRequestsRequest
   * @return ListAdminWorkRequestsResponse
   * @throws OciError when an error occurs
   * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/marketplacepublisher/ListAdminWorkRequests.ts.html |here} to see how to use ListAdminWorkRequests API.
   */
  public async listAdminWorkRequests(
    listAdminWorkRequestsRequest: requests.ListAdminWorkRequestsRequest
  ): Promise<responses.ListAdminWorkRequestsResponse> {
    if (this.logger)
      this.logger.debug("Calling operation MarketplaceAdministratorClient#listAdminWorkRequests.");
    const operationName = "listAdminWorkRequests";
    const apiReferenceLink = "";
    const pathParams = {};

    const queryParams = {
      "compartmentId": listAdminWorkRequestsRequest.compartmentId,
      "workRequestId": listAdminWorkRequestsRequest.workRequestId,
      "status": listAdminWorkRequestsRequest.status,
      "resourceId": listAdminWorkRequestsRequest.resourceId,
      "page": listAdminWorkRequestsRequest.page,
      "limit": listAdminWorkRequestsRequest.limit,
      "sortOrder": listAdminWorkRequestsRequest.sortOrder,
      "sortBy": listAdminWorkRequestsRequest.sortBy
    };

    let headerParams = {
      "Content-Type": common.Constants.APPLICATION_JSON,
      "opc-request-id": listAdminWorkRequestsRequest.opcRequestId
    };

    const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
    const retrier = GenericRetrier.createPreferredRetrier(
      this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined,
      listAdminWorkRequestsRequest.retryConfiguration,
      specRetryConfiguration
    );
    if (this.logger) retrier.logger = this.logger;
    const request = await composeRequest({
    ...
    try {
      ...
      const sdkResponse = composeResponse({
        responseObject: <responses.ListAdminWorkRequestsResponse>{},
        body: await response.json(),
        bodyKey: "adminWorkRequestSummaryCollection",
        bodyModel: model.AdminWorkRequestSummaryCollection,
        type: "model.AdminWorkRequestSummaryCollection",
        responseHeaders: [
          {
            value: response.headers.get("opc-request-id"),
            key: "opcRequestId",
...
* 
   ...
   *
   * This operation uses {@link common.OciSdkDefaultRetryConfiguration} by default if no retry configuration is defined by the user.
   * @param CreatePublisherRequest
   * @return CreatePublisherResponse
   * @throws OciError when an error occurs
   * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/marketplacepublisher/CreatePublisher.ts.html |here} to see how to use CreatePublisher API.
   */
  public async createPublisher(
    createPublisherRequest: requests.CreatePublisherRequest
  ): Promise<responses.CreatePublisherResponse> {
    if (this.logger)
      this.logger.debug("Calling operation MarketplacePublisherClient#createPublisher.");
    const operationName = "createPublisher";
    const apiReferenceLink = "";
    const pathParams = {};
    ...
    let headerParams = {
      "Content-Type": common.Constants.APPLICATION_JSON,
      "opc-retry-token": createPublisherRequest.opcRetryToken,
      "opc-request-id": createPublisherRequest.opcRequestId
    };

    const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
    const retrier = GenericRetrier.createPreferredRetrier(
      this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined,
      createPublisherRequest.retryConfiguration,
      specRetryConfiguration
    );
    if (this.logger) retrier.logger = this.logger;
    const request = await composeRequest({
      ...
      method: "POST",
      bodyContent: common.ObjectSerializer.serialize(
        createPublisherRequest.createPublisherDetails,
        "CreatePublisherDetails",
        model.CreatePublisherDetails.getJsonObj
      ),
      pathParams: pathParams,
      headerParams: headerParams,
      queryParams: queryParams
    ...
    try {
      ...
      const sdkResponse = composeResponse({
        responseObject: <responses.CreatePublisherResponse>{},
        body: await response.json(),
        bodyKey: "publisher",
   ...
   * This operation uses {@link common.OciSdkDefaultRetryConfiguration} by default if no retry configuration is defined by the user.
   * @param DeleteCustomerInstanceReportExportRequest
   * @return DeleteCustomerInstanceReportExportResponse
   * @throws OciError when an error occurs
   * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/marketplacepublisher/DeleteCustomerInstanceReportExport.ts.html |here} to see how to use DeleteCustomerInstanceReportExport API.
   */
  public async deleteCustomerInstanceReportExport(
    deleteCustomerInstanceReportExportRequest: requests.DeleteCustomerInstanceReportExportRequest
  ): Promise<responses.DeleteCustomerInstanceReportExportResponse> {
    if (this.logger)
      this.logger.debug(
        "Calling operation MarketplacePublisherClient#deleteCustomerInstanceReportExport."
      );
    const operationName = "deleteCustomerInstanceReportExport";
    const apiReferenceLink = "";
    const pathParams = {
      "{customerInstanceReportExportId}":
        deleteCustomerInstanceReportExportRequest.customerInstanceReportExportId
    };
    ...
    let headerParams = {
      "Content-Type": common.Constants.APPLICATION_JSON,
      "if-match": deleteCustomerInstanceReportExportRequest.ifMatch,
      "opc-request-id": deleteCustomerInstanceReportExportRequest.opcRequestId
    };

    const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
    const retrier = GenericRetrier.createPreferredRetrier(
      this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined,
      deleteCustomerInstanceReportExportRequest.retryConfiguration,
      specRetryConfiguration
    );
    if (this.logger) retrier.logger = this.logger;
    const request = await composeRequest({
      baseEndpoint: this._endpoint,
      defaultHeaders: this._defaultHeaders,
      path: "/customerInstanceReportExports/{customerInstanceReportExportId}",
      method: "DELETE",
      pathParams: pathParams,
      headerParams: headerParams,
      queryParams: queryParams
    ...
    try {
      ...
      const sdkResponse = composeResponse({
        responseObject: <responses.DeleteCustomerInstanceReportExportResponse>{},
        responseHeaders: [
          {
            value: response.headers.get("opc-request-id"),
            key: "opcRequestId",
   ...
   *
   * This operation uses {@link common.OciSdkDefaultRetryConfiguration} by default if no retry configuration is defined by the user.
   * @param GenerateCustomerInstanceReportExportRequest
   * @return GenerateCustomerInstanceReportExportResponse
   * @throws OciError when an error occurs
   * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/marketplacepublisher/GenerateCustomerInstanceReportExport.ts.html |here} to see how to use GenerateCustomerInstanceReportExport API.
   */
  public async generateCustomerInstanceReportExport(
    generateCustomerInstanceReportExportRequest: requests.GenerateCustomerInstanceReportExportRequest
  ): Promise<responses.GenerateCustomerInstanceReportExportResponse> {
    if (this.logger)
      this.logger.debug(
        "Calling operation MarketplacePublisherClient#generateCustomerInstanceReportExport."
      );
    const operationName = "generateCustomerInstanceReportExport";
    const apiReferenceLink = "";
    const pathParams = {};
    ...
    let headerParams = {
      "Content-Type": common.Constants.APPLICATION_JSON,
      "opc-request-id": generateCustomerInstanceReportExportRequest.opcRequestId,
      "opc-retry-token": generateCustomerInstanceReportExportRequest.opcRetryToken
    };

    const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
    const retrier = GenericRetrier.createPreferredRetrier(
      this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined,
      generateCustomerInstanceReportExportRequest.retryConfiguration,
      specRetryConfiguration
    );
    if (this.logger) retrier.logger = this.logger;
    const request = await composeRequest({
      baseEndpoint: this._endpoint,
      defaultHeaders: this._defaultHeaders,
      path: "/customerInstanceReportExports/actions/generate",
      method: "POST",
      bodyContent: common.ObjectSerializer.serialize(
        generateCustomerInstanceReportExportRequest.generateCustomerInstanceReportExportDetails,
        "GenerateCustomerInstanceReportExportDetails",
        model.GenerateCustomerInstanceReportExportDetails.getJsonObj
      ),
      pathParams: pathParams,
      headerParams: headerParams,
      queryParams: queryParams
    ...
    try {
      ...
      const sdkResponse = composeResponse({
        responseObject: <responses.GenerateCustomerInstanceReportExportResponse>{},
        responseHeaders: [
          {
            value: response.headers.get("opc-work-request-id"),
            key: "opcWorkRequestId",
          ...
          {
            value: response.headers.get("exportIdentifier"),
   ...
   * This operation uses {@link common.OciSdkDefaultRetryConfiguration} by default if no retry configuration is defined by the user.
   * @param GetCustomerInstanceReportExportRequest
   * @return GetCustomerInstanceReportExportResponse
   * @throws OciError when an error occurs
   * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/marketplacepublisher/GetCustomerInstanceReportExport.ts.html |here} to see how to use GetCustomerInstanceReportExport API.
   */
  public async getCustomerInstanceReportExport(
    getCustomerInstanceReportExportRequest: requests.GetCustomerInstanceReportExportRequest
  ): Promise<responses.GetCustomerInstanceReportExportResponse> {
    if (this.logger)
      this.logger.debug(
        "Calling operation MarketplacePublisherClient#getCustomerInstanceReportExport."
      );
    const operationName = "getCustomerInstanceReportExport";
    const apiReferenceLink = "";
    const pathParams = {
      "{customerInstanceReportExportId}":
        getCustomerInstanceReportExportRequest.customerInstanceReportExportId
    };
    ...
    let headerParams = {
      "Content-Type": common.Constants.APPLICATION_JSON,
      "opc-request-id": getCustomerInstanceReportExportRequest.opcRequestId
    };

    const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
    const retrier = GenericRetrier.createPreferredRetrier(
      this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined,
      getCustomerInstanceReportExportRequest.retryConfiguration,
      specRetryConfiguration
    );
    if (this.logger) retrier.logger = this.logger;
    const request = await composeRequest({
    ...
    try {
      ...
      const sdkResponse = composeResponse({
        responseObject: <responses.GetCustomerInstanceReportExportResponse>{},
        body: await response.json(),
        bodyKey: "customerInstanceReportExport",
        bodyModel: model.CustomerInstanceReportExport,
        type: "model.CustomerInstanceReportExport",
        responseHeaders: [
          {
            value: response.headers.get("opc-request-id"),
            key: "opcRequestId",
   ...
   * This operation uses {@link common.OciSdkDefaultRetryConfiguration} by default if no retry configuration is defined by the user.
   * @param GetCustomerInstanceReportExportContentRequest
   * @return GetCustomerInstanceReportExportContentResponse
   * @throws OciError when an error occurs
   * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/marketplacepublisher/GetCustomerInstanceReportExportContent.ts.html |here} to see how to use GetCustomerInstanceReportExportContent API.
   */
  public async getCustomerInstanceReportExportContent(
    getCustomerInstanceReportExportContentRequest: requests.GetCustomerInstanceReportExportContentRequest
  ): Promise<responses.GetCustomerInstanceReportExportContentResponse> {
    if (this.logger)
      this.logger.debug(
        "Calling operation MarketplacePublisherClient#getCustomerInstanceReportExportContent."
      );
    const operationName = "getCustomerInstanceReportExportContent";
    const apiReferenceLink = "";
    const pathParams = {
      "{customerInstanceReportExportId}":
        getCustomerInstanceReportExportContentRequest.customerInstanceReportExportId
    };
    ...
    let headerParams = {
      "Content-Type": common.Constants.APPLICATION_JSON,
      "opc-request-id": getCustomerInstanceReportExportContentRequest.opcRequestId
    };

    const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
    const retrier = GenericRetrier.createPreferredRetrier(
      this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined,
      getCustomerInstanceReportExportContentRequest.retryConfiguration,
      specRetryConfiguration
    );
    if (this.logger) retrier.logger = this.logger;
    const request = await composeRequest({
      baseEndpoint: this._endpoint,
      defaultHeaders: this._defaultHeaders,
      path: "/customerInstanceReportExports/{customerInstanceReportExportId}/content",
      method: "GET",
      pathParams: pathParams,
      headerParams: headerParams,
      queryParams: queryParams
    ...
    try {
      ...
      const sdkResponse = composeResponse({
        responseObject: <responses.GetCustomerInstanceReportExportContentResponse>{},
        responseHeaders: [
          {
            value: response.headers.get("opc-request-id"),
            key: "opcRequestId",
  ...
  public async getLead(
    getLeadRequest: requests.GetLeadRequest
  ): Promise<responses.GetLeadResponse> {
    if (this.logger) this.logger.debug("Calling operation MarketplacePublisherClient#getLead.");
    ...
    const retrier = GenericRetrier.createPreferredRetrier(
      this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined,
      getLeadRequest.retryConfiguration,
      specRetryConfiguration
    );
    if (this.logger) retrier.logger = this.logger;
    const request = await composeRequest({
    ...
    try {
      ...
      const sdkResponse = composeResponse({
        responseObject: <responses.GetLeadResponse>{},
        body: await response.json(),
        bodyKey: "lead",
   ...
   */
  public async getListingRevisionAttachmentContent(
    getListingRevisionAttachmentContentRequest: requests.GetListingRevisionAttachmentContentRequest
  ): Promise<responses.GetListingRevisionAttachmentContentResponse> {
    if (this.logger)
      this.logger.debug(
        "Calling operation MarketplacePublisherClient#getListingRevisionAttachmentContent."
      );
    const operationName = "getListingRevisionAttachmentContent";
    const apiReferenceLink = "";
    const pathParams = {
      "{listingRevisionAttachmentId}":
        getListingRevisionAttachmentContentRequest.listingRevisionAttachmentId
    };
    ...
    const retrier = GenericRetrier.createPreferredRetrier(
      this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined,
      getListingRevisionAttachmentContentRequest.retryConfiguration,
      specRetryConfiguration
    );
    if (this.logger) retrier.logger = this.logger;
    const request = await composeRequest({
    ...
    try {
      ...
      const sdkResponse = composeResponse({
        responseObject: <responses.GetListingRevisionAttachmentContentResponse>{},
   ...
   */
  public async getListingRevisionIconContent(
    getListingRevisionIconContentRequest: requests.GetListingRevisionIconContentRequest
  ): Promise<responses.GetListingRevisionIconContentResponse> {
    if (this.logger)
      this.logger.debug(
        "Calling operation MarketplacePublisherClient#getListingRevisionIconContent."
      );
    ...
    const retrier = GenericRetrier.createPreferredRetrier(
      this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined,
      getListingRevisionIconContentRequest.retryConfiguration,
      specRetryConfiguration
    );
    if (this.logger) retrier.logger = this.logger;
    const request = await composeRequest({
    ...
    try {
      ...
      const sdkResponse = composeResponse({
        responseObject: <responses.GetListingRevisionIconContentResponse>{},
   ...
   */
  public async getSupportDoc(
    getSupportDocRequest: requests.GetSupportDocRequest
  ): Promise<responses.GetSupportDocResponse> {
    if (this.logger)
    ...
    const retrier = GenericRetrier.createPreferredRetrier(
      this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined,
      getSupportDocRequest.retryConfiguration,
      specRetryConfiguration
    );
    if (this.logger) retrier.logger = this.logger;
    const request = await composeRequest({
    ...
    try {
      ...
      const sdkResponse = composeResponse({
        responseObject: <responses.GetSupportDocResponse>{},
        body: await response.json(),
        bodyKey: "supportDoc",
   ...
   */
  public async getSupportDocContent(
    getSupportDocContentRequest: requests.GetSupportDocContentRequest
  ): Promise<responses.GetSupportDocContentResponse> {
    if (this.logger)
    ...
    const retrier = GenericRetrier.createPreferredRetrier(
      this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined,
      getSupportDocContentRequest.retryConfiguration,
      specRetryConfiguration
    );
    if (this.logger) retrier.logger = this.logger;
    const request = await composeRequest({
    ...
    try {
      ...
      const sdkResponse = composeResponse({
        responseObject: <responses.GetSupportDocContentResponse>{},
   ...
   */
  public async getTermVersionContent(
    getTermVersionContentRequest: requests.GetTermVersionContentRequest
  ): Promise<responses.GetTermVersionContentResponse> {
    if (this.logger)
    ...
    const retrier = GenericRetrier.createPreferredRetrier(
      this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined,
      getTermVersionContentRequest.retryConfiguration,
      specRetryConfiguration
    );
    if (this.logger) retrier.logger = this.logger;
    const request = await composeRequest({
    ...
    try {
      ...
      const sdkResponse = composeResponse({
        responseObject: <responses.GetTermVersionContentResponse>{},
  ...
  public async listAvailableServices(
    listAvailableServicesRequest: requests.ListAvailableServicesRequest
  ): Promise<responses.ListAvailableServicesResponse> {
    if (this.logger)
    ...
    const retrier = GenericRetrier.createPreferredRetrier(
      this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined,
      listAvailableServicesRequest.retryConfiguration,
      specRetryConfiguration
    );
    if (this.logger) retrier.logger = this.logger;
    const request = await composeRequest({
    ...
    try {
      ...
      const sdkResponse = composeResponse({
        responseObject: <responses.ListAvailableServicesResponse>{},
        body: await response.json(),
   ...
   *
   * This operation uses {@link common.OciSdkDefaultRetryConfiguration} by default if no retry configuration is defined by the user.
   * @param ListCustomerInstanceReportExportsRequest
   * @return ListCustomerInstanceReportExportsResponse
   * @throws OciError when an error occurs
   * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/marketplacepublisher/ListCustomerInstanceReportExports.ts.html |here} to see how to use ListCustomerInstanceReportExports API.
   */
  public async listCustomerInstanceReportExports(
    listCustomerInstanceReportExportsRequest: requests.ListCustomerInstanceReportExportsRequest
  ): Promise<responses.ListCustomerInstanceReportExportsResponse> {
    if (this.logger)
      this.logger.debug(
        "Calling operation MarketplacePublisherClient#listCustomerInstanceReportExports."
      );
    const operationName = "listCustomerInstanceReportExports";
    const apiReferenceLink = "";
    const pathParams = {};

    const queryParams = {
      "compartmentId": listCustomerInstanceReportExportsRequest.compartmentId,
      "limit": listCustomerInstanceReportExportsRequest.limit,
      "page": listCustomerInstanceReportExportsRequest.page,
      "sortOrder": listCustomerInstanceReportExportsRequest.sortOrder,
      "sortBy": listCustomerInstanceReportExportsRequest.sortBy,
      "name": listCustomerInstanceReportExportsRequest.name,
      "listingId": listCustomerInstanceReportExportsRequest.listingId,
      "status": listCustomerInstanceReportExportsRequest.status,
      "shape": listCustomerInstanceReportExportsRequest.shape,
      "region": listCustomerInstanceReportExportsRequest.region,
      "realm": listCustomerInstanceReportExportsRequest.realm,
      "tenantAdminDomain": listCustomerInstanceReportExportsRequest.tenantAdminDomain,
      "packageVersion": listCustomerInstanceReportExportsRequest.packageVersion,
      "instanceOcid": listCustomerInstanceReportExportsRequest.instanceOcid,
      "timeInstanceCreationFromDate":
        listCustomerInstanceReportExportsRequest.timeInstanceCreationFromDate,
      "timeInstanceCreationToDate":
        listCustomerInstanceReportExportsRequest.timeInstanceCreationToDate,
      "timeInstanceTerminationFromDate":
        listCustomerInstanceReportExportsRequest.timeInstanceTerminationFromDate,
      "timeInstanceTerminationToDate":
        listCustomerInstanceReportExportsRequest.timeInstanceTerminationToDate
    };

    let headerParams = {
      "Content-Type": common.Constants.APPLICATION_JSON,
      "opc-request-id": listCustomerInstanceReportExportsRequest.opcRequestId
    };

    const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
    const retrier = GenericRetrier.createPreferredRetrier(
      this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined,
      listCustomerInstanceReportExportsRequest.retryConfiguration,
      specRetryConfiguration
    );
    if (this.logger) retrier.logger = this.logger;
    const request = await composeRequest({
    ...
    try {
      ...
      const sdkResponse = composeResponse({
        responseObject: <responses.ListCustomerInstanceReportExportsResponse>{},
        body: await response.json(),
        bodyKey: "customerInstanceReportExportCollection",
        bodyModel: model.CustomerInstanceReportExportCollection,
        type: "model.CustomerInstanceReportExportCollection",
        responseHeaders: [
          {
            value: response.headers.get("opc-request-id"),
            key: "opcRequestId",
   ...
   */
  public async listCustomerInstanceReportRecords(
    listCustomerInstanceReportRecordsRequest: requests.ListCustomerInstanceReportRecordsRequest
  ): Promise<responses.ListCustomerInstanceReportRecordsResponse> {
    if (this.logger)
      this.logger.debug(
        "Calling operation MarketplacePublisherClient#listCustomerInstanceReportRecords."
      );
    ...
    const queryParams = {
      ...
      "listingId": listCustomerInstanceReportRecordsRequest.listingId,
      "status": listCustomerInstanceReportRecordsRequest.status,
      "shape": listCustomerInstanceReportRecordsRequest.shape,
      "region": listCustomerInstanceReportRecordsRequest.region,
      "realm": listCustomerInstanceReportRecordsRequest.realm,
      "tenantAdminDomain": listCustomerInstanceReportRecordsRequest.tenantAdminDomain,
      "packageVersion": listCustomerInstanceReportRecordsRequest.packageVersion,
      "instanceOcid": listCustomerInstanceReportRecordsRequest.instanceOcid,
      "timeInstanceCreationFromDate":
        listCustomerInstanceReportRecordsRequest.timeInstanceCreationFromDate,
      "timeInstanceCreationToDate":
        listCustomerInstanceReportRecordsRequest.timeInstanceCreationToDate,
      "timeInstanceTerminationFromDate":
        listCustomerInstanceReportRecordsRequest.timeInstanceTerminationFromDate,
      "timeInstanceTerminationToDate":
        listCustomerInstanceReportRecordsRequest.timeInstanceTerminationToDate
    };
    ...
    const retrier = GenericRetrier.createPreferredRetrier(
      this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined,
      listCustomerInstanceReportRecordsRequest.retryConfiguration,
      specRetryConfiguration
    );
    if (this.logger) retrier.logger = this.logger;
    const request = await composeRequest({
    ...
    try {
      ...
      const sdkResponse = composeResponse({
        responseObject: <responses.ListCustomerInstanceReportRecordsResponse>{},
        body: await response.json(),
   ...
   */
  public async listDisbursementReportRecords(
    listDisbursementReportRecordsRequest: requests.ListDisbursementReportRecordsRequest
  ): Promise<responses.ListDisbursementReportRecordsResponse> {
    if (this.logger)
      this.logger.debug(
        "Calling operation MarketplacePublisherClient#listDisbursementReportRecords."
      );
    ...
    const retrier = GenericRetrier.createPreferredRetrier(
      this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined,
      listDisbursementReportRecordsRequest.retryConfiguration,
      specRetryConfiguration
    );
    if (this.logger) retrier.logger = this.logger;
    const request = await composeRequest({
    ...
    try {
      ...
      const sdkResponse = composeResponse({
        responseObject: <responses.ListDisbursementReportRecordsResponse>{},
        body: await response.json(),
  ...
  public async listLeads(
    listLeadsRequest: requests.ListLeadsRequest
  ): Promise<responses.ListLeadsResponse> {
    if (this.logger) this.logger.debug("Calling operation MarketplacePublisherClient#listLeads.");
    ...
    const retrier = GenericRetrier.createPreferredRetrier(
      this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined,
      listLeadsRequest.retryConfiguration,
      specRetryConfiguration
    );
    if (this.logger) retrier.logger = this.logger;
    const request = await composeRequest({
    ...
    try {
      ...
      const sdkResponse = composeResponse({
        responseObject: <responses.ListLeadsResponse>{},
        body: await response.json(),
   ...
   */
  public async listSupportDocs(
    listSupportDocsRequest: requests.ListSupportDocsRequest
  ): Promise<responses.ListSupportDocsResponse> {
    if (this.logger)
    ...
    const retrier = GenericRetrier.createPreferredRetrier(
      this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined,
      listSupportDocsRequest.retryConfiguration,
      specRetryConfiguration
    );
    if (this.logger) retrier.logger = this.logger;
    const request = await composeRequest({
    ...
    try {
      ...
      const sdkResponse = composeResponse({
        responseObject: <responses.ListSupportDocsResponse>{},
        body: await response.json(),
   ...
   */
  public async listSupportedCurrencies(
    listSupportedCurrenciesRequest: requests.ListSupportedCurrenciesRequest
  ): Promise<responses.ListSupportedCurrenciesResponse> {
    if (this.logger)
    ...
    const retrier = GenericRetrier.createPreferredRetrier(
      this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined,
      listSupportedCurrenciesRequest.retryConfiguration,
      specRetryConfiguration
    );
    if (this.logger) retrier.logger = this.logger;
    const request = await composeRequest({
    ...
    try {
      ...
      const sdkResponse = composeResponse({
        responseObject: <responses.ListSupportedCurrenciesResponse>{},
        body: await response.json(),
   ...
   */
  public async listSupportedShapes(
    listSupportedShapesRequest: requests.ListSupportedShapesRequest
  ): Promise<responses.ListSupportedShapesResponse> {
    if (this.logger)
    ...
    const retrier = GenericRetrier.createPreferredRetrier(
      this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined,
      listSupportedShapesRequest.retryConfiguration,
      specRetryConfiguration
    );
    if (this.logger) retrier.logger = this.logger;
    const request = await composeRequest({
    ...
    try {
      ...
      const sdkResponse = composeResponse({
        responseObject: <responses.ListSupportedShapesResponse>{},
        body: await response.json(),
   ...
   * Updates the Listing Revision
   * This operation uses {@link common.OciSdkDefaultRetryConfiguration} by default if no retry configuration is defined by the user.
   * @param UpdateListingRevisionBannerContentRequest
   * @return UpdateListingRevisionBannerContentResponse
   * @throws OciError when an error occurs
   * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/marketplacepublisher/UpdateListingRevisionBannerContent.ts.html |here} to see how to use UpdateListingRevisionBannerContent API.
   */
  public async updateListingRevisionBannerContent(
    updateListingRevisionBannerContentRequest: requests.UpdateListingRevisionBannerContentRequest
  ): Promise<responses.UpdateListingRevisionBannerContentResponse> {
    if (this.logger)
      this.logger.debug(
        "Calling operation MarketplacePublisherClient#updateListingRevisionBannerContent."
      );
    const operationName = "updateListingRevisionBannerContent";
    const apiReferenceLink = "";
    const pathParams = {
      "{listingRevisionId}": updateListingRevisionBannerContentRequest.listingRevisionId
    };

    const queryParams = {
      "bannerName": updateListingRevisionBannerContentRequest.bannerName
    };

    let headerParams = {
      "if-match": updateListingRevisionBannerContentRequest.ifMatch,
      "opc-request-id": updateListingRevisionBannerContentRequest.opcRequestId
    };

    const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
    const retrier = GenericRetrier.createPreferredRetrier(
      this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined,
      updateListingRevisionBannerContentRequest.retryConfiguration,
      specRetryConfiguration
    );
    if (this.logger) retrier.logger = this.logger;
    const request = await composeRequest({
      baseEndpoint: this._endpoint,
      defaultHeaders: this._defaultHeaders,
      path: "/listingRevisions/{listingRevisionId}/banner/content",
      method: "PUT",
      bodyContent: updateListingRevisionBannerContentRequest.updateListingRevisionBannerContent,
      pathParams: pathParams,
      headerParams: headerParams,
      backupBinaryBody: retrier.backUpBinaryBody,
      queryParams: queryParams
    ...
    try {
      ...
      const sdkResponse = composeResponse({
        responseObject: <responses.UpdateListingRevisionBannerContentResponse>{},
        body: await response.json(),
        bodyKey: "listingRevision",
        bodyModel: model.ListingRevision,
        type: "model.ListingRevision",
   ...
   */
  public async updateListingRevisionNote(
    updateListingRevisionNoteRequest: requests.UpdateListingRevisionNoteRequest
  ): Promise<responses.UpdateListingRevisionNoteResponse> {
    if (this.logger)
    ...
    const retrier = GenericRetrier.createPreferredRetrier(
      this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined,
      updateListingRevisionNoteRequest.retryConfiguration,
      specRetryConfiguration
    );
    if (this.logger) retrier.logger = this.logger;
    const request = await composeRequest({
      ...
      method: "PUT",
      bodyContent: common.ObjectSerializer.serialize(
        updateListingRevisionNoteRequest.updateListingRevisionNoteDetails,
        "UpdateListingRevisionNoteDetails",
        model.UpdateListingRevisionNoteDetails.getJsonObj
      ),
      pathParams: pathParams,
      headerParams: headerParams,
      queryParams: queryParams
    ...
    try {
      ...
      const sdkResponse = composeResponse({
        responseObject: <responses.UpdateListingRevisionNoteResponse>{},
        body: await response.json(),
        bodyKey: "listingRevisionNote",
        bodyModel: model.ListingRevisionNote,
        type: "model.ListingRevisionNote",
