...
/**
 * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/marketplacepublisher/ListListingRevisionPackages.ts.html |here} to see how to use ListListingRevisionPackagesRequest.
 */
...
export namespace ListListingRevisionPackagesRequest {
  export enum SortBy {
