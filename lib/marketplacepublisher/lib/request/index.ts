...
import * as UpdateAdminArtifactStatusRequest from "./update-admin-artifact-status-request";
export import UpdateAdminArtifactStatusRequest = UpdateAdminArtifactStatusRequest.UpdateAdminArtifactStatusRequest;
import * as GetAdminPublisherRequest from "./get-admin-publisher-request";
export import GetAdminPublisherRequest = GetAdminPublisherRequest.GetAdminPublisherRequest;
import * as ChangeListingRevisionStatusToNewRequest from "./change-listing-revision-status-to-new-request";
export import ChangeListingRevisionStatusToNewRequest = ChangeListingRevisionStatusToNewRequest.ChangeListingRevisionStatusToNewRequest;
import * as CreateMarketRequest from "./create-market-request";
export import CreateMarketRequest = CreateMarketRequest.CreateMarketRequest;
import * as GetAdminArtifactRequest from "./get-admin-artifact-request";
export import GetAdminArtifactRequest = GetAdminArtifactRequest.GetAdminArtifactRequest;
import * as GetAdminListingRequest from "./get-admin-listing-request";
export import GetAdminListingRequest = GetAdminListingRequest.GetAdminListingRequest;
import * as GetAdminListingRevisionRequest from "./get-admin-listing-revision-request";
export import GetAdminListingRevisionRequest = GetAdminListingRevisionRequest.GetAdminListingRevisionRequest;
import * as GetAdminListingRevisionAttachmentRequest from "./get-admin-listing-revision-attachment-request";
export import GetAdminListingRevisionAttachmentRequest = GetAdminListingRevisionAttachmentRequest.GetAdminListingRevisionAttachmentRequest;
import * as GetAdminListingRevisionPackageRequest from "./get-admin-listing-revision-package-request";
export import GetAdminListingRevisionPackageRequest = GetAdminListingRevisionPackageRequest.GetAdminListingRevisionPackageRequest;
import * as GetAdminTermRequest from "./get-admin-term-request";
export import GetAdminTermRequest = GetAdminTermRequest.GetAdminTermRequest;
import * as GetAdminTermVersionRequest from "./get-admin-term-version-request";
export import GetAdminTermVersionRequest = GetAdminTermVersionRequest.GetAdminTermVersionRequest;
import * as ListAdminArtifactsRequest from "./list-admin-artifacts-request";
export import ListAdminArtifactsRequest = ListAdminArtifactsRequest.ListAdminArtifactsRequest;
import * as ListAdminListingRevisionAttachmentsRequest from "./list-admin-listing-revision-attachments-request";
export import ListAdminListingRevisionAttachmentsRequest = ListAdminListingRevisionAttachmentsRequest.ListAdminListingRevisionAttachmentsRequest;
import * as ListAdminListingRevisionPackagesRequest from "./list-admin-listing-revision-packages-request";
export import ListAdminListingRevisionPackagesRequest = ListAdminListingRevisionPackagesRequest.ListAdminListingRevisionPackagesRequest;
import * as ListAdminListingRevisionsRequest from "./list-admin-listing-revisions-request";
export import ListAdminListingRevisionsRequest = ListAdminListingRevisionsRequest.ListAdminListingRevisionsRequest;
import * as ListAdminPublisherSkusRequest from "./list-admin-publisher-skus-request";
export import ListAdminPublisherSkusRequest = ListAdminPublisherSkusRequest.ListAdminPublisherSkusRequest;
import * as ListAdminTermVersionsRequest from "./list-admin-term-versions-request";
export import ListAdminTermVersionsRequest = ListAdminTermVersionsRequest.ListAdminTermVersionsRequest;
import * as ListAdminTermsRequest from "./list-admin-terms-request";
export import ListAdminTermsRequest = ListAdminTermsRequest.ListAdminTermsRequest;
import * as ListAdminWorkRequestsRequest from "./list-admin-work-requests-request";
export import ListAdminWorkRequestsRequest = ListAdminWorkRequestsRequest.ListAdminWorkRequestsRequest;
...
import * as CreatePublisherRequest from "./create-publisher-request";
export import CreatePublisherRequest = CreatePublisherRequest.CreatePublisherRequest;
...
import * as DeleteCustomerInstanceReportExportRequest from "./delete-customer-instance-report-export-request";
export import DeleteCustomerInstanceReportExportRequest = DeleteCustomerInstanceReportExportRequest.DeleteCustomerInstanceReportExportRequest;
...
import * as GenerateCustomerInstanceReportExportRequest from "./generate-customer-instance-report-export-request";
export import GenerateCustomerInstanceReportExportRequest = GenerateCustomerInstanceReportExportRequest.GenerateCustomerInstanceReportExportRequest;
...
import * as GetCustomerInstanceReportExportRequest from "./get-customer-instance-report-export-request";
export import GetCustomerInstanceReportExportRequest = GetCustomerInstanceReportExportRequest.GetCustomerInstanceReportExportRequest;
import * as GetCustomerInstanceReportExportContentRequest from "./get-customer-instance-report-export-content-request";
export import GetCustomerInstanceReportExportContentRequest = GetCustomerInstanceReportExportContentRequest.GetCustomerInstanceReportExportContentRequest;
...
import * as ListCustomerInstanceReportExportsRequest from "./list-customer-instance-report-exports-request";
export import ListCustomerInstanceReportExportsRequest = ListCustomerInstanceReportExportsRequest.ListCustomerInstanceReportExportsRequest;
...
import * as UpdateListingRevisionBannerContentRequest from "./update-listing-revision-banner-content-request";
export import UpdateListingRevisionBannerContentRequest = UpdateListingRevisionBannerContentRequest.UpdateListingRevisionBannerContentRequest;
