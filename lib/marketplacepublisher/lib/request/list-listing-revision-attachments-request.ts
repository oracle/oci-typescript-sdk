...
/**
 * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/marketplacepublisher/ListListingRevisionAttachments.ts.html |here} to see how to use ListListingRevisionAttachmentsRequest.
 */
...
export namespace ListListingRevisionAttachmentsRequest {
  export enum SortBy {
