...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/marketplacepublisher/ListCustomerInstanceReportExports.ts.html |here} to see how to use ListCustomerInstanceReportExportsRequest.
 */
export interface ListCustomerInstanceReportExportsRequest extends common.BaseRequest {
  /**
...
export namespace ListCustomerInstanceReportExportsRequest {
  export enum SortBy {
