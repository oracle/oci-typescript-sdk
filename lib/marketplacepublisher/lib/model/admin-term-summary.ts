 ...
 */
export interface AdminTermSummary {
  /**
...
export namespace AdminTermSummary {
  export function getJsonObj(obj: AdminTermSummary): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: AdminTermSummary): object {
    const jsonObj = { ...obj, ...{} };
