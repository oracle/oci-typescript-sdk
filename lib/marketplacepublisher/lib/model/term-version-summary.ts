...
export namespace TermVersionSummary {
  export function getJsonObj(obj: TermVersionSummary): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: TermVersionSummary): object {
    const jsonObj = { ...obj, ...{} };
