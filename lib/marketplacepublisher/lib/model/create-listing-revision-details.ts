...
export namespace CreateListingRevisionDetails {
  export function getJsonObj(obj: CreateListingRevisionDetails): object {
    const jsonObj = {
      ...obj,
      ...{
    ...
    if (obj && "listingType" in obj && obj.listingType) {
      switch (obj.listingType) {
        case "OCI_APPLICATION":
          return model.CreateOciListingRevisionDetails.getJsonObj(
            <model.CreateOciListingRevisionDetails>(<object>jsonObj),
            true
          );
        case "SERVICE":
          return model.CreateServiceListingRevisionDetails.getJsonObj(
            <model.CreateServiceListingRevisionDetails>(<object>jsonObj),
            true
          );
        case "LEAD_GENERATION":
          return model.CreateLeadGenListingRevisionDetails.getJsonObj(
            <model.CreateLeadGenListingRevisionDetails>(<object>jsonObj),
            true
          );
        default:
  ...
  export function getDeserializedJsonObj(obj: CreateListingRevisionDetails): object {
    const jsonObj = {
      ...obj,
      ...{
        "contentLanguage": obj.contentLanguage
    ...
    if (obj && "listingType" in obj && obj.listingType) {
      switch (obj.listingType) {
        case "OCI_APPLICATION":
          return model.CreateOciListingRevisionDetails.getDeserializedJsonObj(
            <model.CreateOciListingRevisionDetails>(<object>jsonObj),
            true
          );
        case "SERVICE":
          return model.CreateServiceListingRevisionDetails.getDeserializedJsonObj(
            <model.CreateServiceListingRevisionDetails>(<object>jsonObj),
            true
          );
        case "LEAD_GENERATION":
          return model.CreateLeadGenListingRevisionDetails.getDeserializedJsonObj(
            <model.CreateLeadGenListingRevisionDetails>(<object>jsonObj),
            true
          );
        default:
