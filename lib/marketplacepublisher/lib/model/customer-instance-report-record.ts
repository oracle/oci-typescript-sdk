...
export namespace CustomerInstanceReportRecord {
  export function getJsonObj(obj: CustomerInstanceReportRecord): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: CustomerInstanceReportRecord): object {
    const jsonObj = { ...obj, ...{} };
