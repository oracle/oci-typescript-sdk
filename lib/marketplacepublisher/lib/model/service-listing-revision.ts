...
export namespace ServiceListingRevision {
  export function getJsonObj(obj: ServiceListingRevision, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.ListingRevision.getJsonObj(obj) as ServiceListingRevision)),
      ...{
  ...
  export function getDeserializedJsonObj(
    obj: ServiceListingRevision,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.ListingRevision.getDeserializedJsonObj(obj) as ServiceListingRevision)),
      ...{
        "trainedProfessionals": obj.trainedProfessionals
          ? obj.trainedProfessionals.map(item => {
