    ...
    if (obj && "attachmentType" in obj && obj.attachmentType) {
      switch (obj.attachmentType) {
        ...
        case "REVIEW_SUPPORT_DOCUMENT":
          return model.ReviewSupportDocumentAttachment.getJsonObj(
            <model.ReviewSupportDocumentAttachment>(<object>jsonObj),
            true
          );
        case "SUPPORTED_SERVICES":
          return model.SupportedServiceAttachment.getJsonObj(
            <model.SupportedServiceAttachment>(<object>jsonObj),
            true
          );
        case "VIDEO":
          return model.VideoAttachment.getJsonObj(<model.VideoAttachment>(<object>jsonObj), true);
        case "CUSTOMER_SUCCESS":
          return model.CustomerSuccessAttachment.getJsonObj(
            <model.CustomerSuccessAttachment>(<object>jsonObj),
            true
          );
        default:
  ...
  export function getDeserializedJsonObj(obj: ListingRevisionAttachment): object {
    ...
    if (obj && "attachmentType" in obj && obj.attachmentType) {
      switch (obj.attachmentType) {
        ...
        case "REVIEW_SUPPORT_DOCUMENT":
          return model.ReviewSupportDocumentAttachment.getDeserializedJsonObj(
            <model.ReviewSupportDocumentAttachment>(<object>jsonObj),
            true
          );
        case "SUPPORTED_SERVICES":
          return model.SupportedServiceAttachment.getDeserializedJsonObj(
            <model.SupportedServiceAttachment>(<object>jsonObj),
            true
          );
        case "VIDEO":
        ...
        case "CUSTOMER_SUCCESS":
          return model.CustomerSuccessAttachment.getDeserializedJsonObj(
            <model.CustomerSuccessAttachment>(<object>jsonObj),
            true
          );
        default:
