 ...
 */
export interface CustomerInstanceReportExportSummary {
  /**
   ...
   */
  "sortOrder"?: CustomerInstanceReportExportSummary.SortOrder;
  /**
   * The field to sort by.
   */
  "sortBy"?: CustomerInstanceReportExportSummary.SortBy;
  /**
   ...
   */
  "status"?: CustomerInstanceReportExportSummary.Status;
  /**
...
export namespace CustomerInstanceReportExportSummary {
  ...
  export function getJsonObj(obj: CustomerInstanceReportExportSummary): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: CustomerInstanceReportExportSummary): object {
    const jsonObj = { ...obj, ...{} };
