...
export namespace OfferCollection {
  export function getJsonObj(obj: OfferCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
  ...
  export function getDeserializedJsonObj(obj: OfferCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
