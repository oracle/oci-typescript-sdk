...
export interface AdminTermVersion {
   ...
   */
  "termAuthor"?: AdminTermVersion.TermAuthor;
  /**
   ...
   * Who authored the term. Publisher terms will be defaulted to 'PARTNER'.
   */
  "author"?: AdminTermVersion.Author;
  "attachment": model.AdminTermVersionAttachment;
  /**
...
export namespace AdminTermVersion {
  export enum TermAuthor {
    Oracle = "ORACLE",
    Partner = "PARTNER",
    /**
  ...
  export function getJsonObj(obj: AdminTermVersion): object {
    const jsonObj = {
      ...obj,
      ...{
        "attachment": obj.attachment
          ? model.AdminTermVersionAttachment.getJsonObj(obj.attachment)
          : undefined
      }
    };
  ...
  export function getDeserializedJsonObj(obj: AdminTermVersion): object {
    const jsonObj = {
      ...obj,
      ...{
        "attachment": obj.attachment
          ? model.AdminTermVersionAttachment.getDeserializedJsonObj(obj.attachment)
          : undefined
      }
    };
