 ...
 */
export interface AdminListingRevisionAttachmentSummary {
  /**
...
export namespace AdminListingRevisionAttachmentSummary {
  export function getJsonObj(obj: AdminListingRevisionAttachmentSummary): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: AdminListingRevisionAttachmentSummary): object {
    const jsonObj = { ...obj, ...{} };
