...
export namespace HelmChartImageDetails {
  export function getJsonObj(obj: HelmChartImageDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: HelmChartImageDetails): object {
    const jsonObj = { ...obj, ...{} };
