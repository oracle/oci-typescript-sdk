...
export namespace ListingRevisionNoteSummary {
  export function getJsonObj(obj: ListingRevisionNoteSummary): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: ListingRevisionNoteSummary): object {
    const jsonObj = { ...obj, ...{} };
