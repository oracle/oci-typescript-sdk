...
export namespace AdminPublisher {
  export function getJsonObj(obj: AdminPublisher): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: AdminPublisher): object {
    const jsonObj = {
      ...obj,
      ...{
        "opnMembership": obj.opnMembership
