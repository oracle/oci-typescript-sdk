...
export namespace ListingRevisionAttachmentSummary {
  export function getJsonObj(obj: ListingRevisionAttachmentSummary): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: ListingRevisionAttachmentSummary): object {
    const jsonObj = { ...obj, ...{} };
