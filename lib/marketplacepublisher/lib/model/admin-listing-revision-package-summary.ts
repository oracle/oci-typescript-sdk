 ...
 */
export interface AdminListingRevisionPackageSummary {
  /**
...
export namespace AdminListingRevisionPackageSummary {
  export function getJsonObj(obj: AdminListingRevisionPackageSummary): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: AdminListingRevisionPackageSummary): object {
    const jsonObj = { ...obj, ...{} };
