...
/**
 * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/computeinstanceagent/ListInstanceAgentPlugins.ts.html |here} to see how to use ListInstanceAgentPluginsRequest.
 */
...
export namespace ListInstanceAgentPluginsRequest {
  export enum Status {
    Running = "RUNNING",
    Stopped = "STOPPED",
