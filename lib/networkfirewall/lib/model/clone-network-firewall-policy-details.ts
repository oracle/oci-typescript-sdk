...
export namespace CloneNetworkFirewallPolicyDetails {
  export function getJsonObj(obj: CloneNetworkFirewallPolicyDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: CloneNetworkFirewallPolicyDetails): object {
    const jsonObj = { ...obj, ...{} };
