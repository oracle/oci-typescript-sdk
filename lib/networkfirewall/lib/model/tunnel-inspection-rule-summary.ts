...
export namespace TunnelInspectionRuleSummary {
  export function getJsonObj(obj: TunnelInspectionRuleSummary): object {
    const jsonObj = { ...obj, ...{} };

    if (obj && "protocol" in obj && obj.protocol) {
      switch (obj.protocol) {
        case "VXLAN":
          return model.VxlanInspectionRuleSummary.getJsonObj(
            <model.VxlanInspectionRuleSummary>(<object>jsonObj),
            true
          );
        default:
  ...
  export function getDeserializedJsonObj(obj: TunnelInspectionRuleSummary): object {
    const jsonObj = { ...obj, ...{} };

    if (obj && "protocol" in obj && obj.protocol) {
      switch (obj.protocol) {
        case "VXLAN":
          return model.VxlanInspectionRuleSummary.getDeserializedJsonObj(
            <model.VxlanInspectionRuleSummary>(<object>jsonObj),
            true
          );
        default:
