...
export namespace CreateNetworkFirewallPolicyDetails {
  export function getJsonObj(obj: CreateNetworkFirewallPolicyDetails): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: CreateNetworkFirewallPolicyDetails): object {
    const jsonObj = {
      ...obj,
      ...{
        "mappedSecrets": obj.mappedSecrets
