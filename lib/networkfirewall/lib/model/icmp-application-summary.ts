...
export namespace IcmpApplicationSummary {
  export function getJsonObj(obj: IcmpApplicationSummary, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.ApplicationSummary.getJsonObj(obj) as IcmpApplicationSummary)),
      ...{}
    };
  ...
  export function getDeserializedJsonObj(
    obj: IcmpApplicationSummary,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.ApplicationSummary.getDeserializedJsonObj(obj) as IcmpApplicationSummary)),
      ...{}
    };
