...
export namespace NetworkFirewallHealthStatus {
  export function getJsonObj(obj: NetworkFirewallHealthStatus): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: NetworkFirewallHealthStatus): object {
    const jsonObj = { ...obj, ...{} };
