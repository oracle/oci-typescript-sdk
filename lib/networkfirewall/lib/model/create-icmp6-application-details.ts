...
export namespace CreateIcmp6ApplicationDetails {
  export function getJsonObj(
    obj: CreateIcmp6ApplicationDetails,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.CreateApplicationDetails.getJsonObj(obj) as CreateIcmp6ApplicationDetails)),
      ...{}
    };
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ...
        : (model.CreateApplicationDetails.getDeserializedJsonObj(
            obj
          ) as CreateIcmp6ApplicationDetails)),
      ...{}
    };
