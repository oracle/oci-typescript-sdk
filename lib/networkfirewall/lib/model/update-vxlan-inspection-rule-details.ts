...
export namespace UpdateVxlanInspectionRuleDetails {
  export function getJsonObj(
    obj: UpdateVxlanInspectionRuleDetails,
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ...
        : (model.UpdateTunnelInspectionRuleDetails.getJsonObj(
            obj
          ) as UpdateVxlanInspectionRuleDetails)),
      ...{
  ...
  export function getDeserializedJsonObj(
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.UpdateTunnelInspectionRuleDetails.getDeserializedJsonObj(
            obj
          ) as UpdateVxlanInspectionRuleDetails)),
      ...{
        "condition": obj.condition
