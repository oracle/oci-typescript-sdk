...
export namespace NatRuleMatchCriteria {
  export function getJsonObj(obj: NatRuleMatchCriteria): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: NatRuleMatchCriteria): object {
    const jsonObj = { ...obj, ...{} };
