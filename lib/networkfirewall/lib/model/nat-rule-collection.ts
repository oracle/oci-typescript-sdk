...
export namespace NatRuleCollection {
  export function getJsonObj(obj: NatRuleCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
  ...
  export function getDeserializedJsonObj(obj: NatRuleCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
