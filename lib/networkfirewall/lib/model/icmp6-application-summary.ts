...
export namespace Icmp6ApplicationSummary {
  export function getJsonObj(obj: Icmp6ApplicationSummary, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.ApplicationSummary.getJsonObj(obj) as Icmp6ApplicationSummary)),
      ...{}
    };
  ...
  export function getDeserializedJsonObj(
    obj: Icmp6ApplicationSummary,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.ApplicationSummary.getDeserializedJsonObj(obj) as Icmp6ApplicationSummary)),
      ...{}
    };
