...
export namespace VxlanInspectionRuleSummary {
  export function getJsonObj(obj: VxlanInspectionRuleSummary, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.TunnelInspectionRuleSummary.getJsonObj(obj) as VxlanInspectionRuleSummary)),
      ...{
  ...
  export function getDeserializedJsonObj(
    obj: VxlanInspectionRuleSummary,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.TunnelInspectionRuleSummary.getDeserializedJsonObj(
            obj
          ) as VxlanInspectionRuleSummary)),
      ...{
        "condition": obj.condition
