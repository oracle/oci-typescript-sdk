...
/**
 * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/networkfirewall/ListDecryptionProfiles.ts.html |here} to see how to use ListDecryptionProfilesRequest.
 */
...
export namespace ListDecryptionProfilesRequest {
  export enum SortBy {
