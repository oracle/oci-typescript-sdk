 ...
 */
export interface DiagnosisStoreSummary {
  /**
...
export namespace DiagnosisStoreSummary {
  export function getJsonObj(obj: DiagnosisStoreSummary): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: DiagnosisStoreSummary): object {
    const jsonObj = { ...obj, ...{} };
