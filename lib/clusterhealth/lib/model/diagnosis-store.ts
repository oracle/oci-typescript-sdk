...
export interface DiagnosisStore {
   ...
   */
  "lifecycleState": DiagnosisStore.LifecycleState;
  /**
...
export namespace DiagnosisStore {
  ...
  export function getJsonObj(obj: DiagnosisStore): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: DiagnosisStore): object {
    const jsonObj = { ...obj, ...{} };
