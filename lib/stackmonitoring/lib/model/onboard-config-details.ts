...
export namespace OnboardConfigDetails {
  export function getJsonObj(obj: OnboardConfigDetails, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj ? obj : (model.Config.getJsonObj(obj) as OnboardConfigDetails)),
      ...{
  ...
  export function getDeserializedJsonObj(
    obj: OnboardConfigDetails,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.Config.getDeserializedJsonObj(obj) as OnboardConfigDetails)),
      ...{
        "dynamicGroups": obj.dynamicGroups
          ? obj.dynamicGroups.map(item => {
