...
export namespace ProcessSetCollection {
  export function getJsonObj(obj: ProcessSetCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
  ...
  export function getDeserializedJsonObj(obj: ProcessSetCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
