...
export namespace DynamicGroupDetails {
  export enum StackMonitoringAssignment {
  ...
  export function getJsonObj(obj: DynamicGroupDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: DynamicGroupDetails): object {
    const jsonObj = { ...obj, ...{} };
