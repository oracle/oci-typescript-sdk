...
export namespace AlarmConditionCollection {
  export function getJsonObj(obj: AlarmConditionCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
  ...
  export function getDeserializedJsonObj(obj: AlarmConditionCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
