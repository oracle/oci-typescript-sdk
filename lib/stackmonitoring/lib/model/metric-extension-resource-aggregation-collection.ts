...
export namespace MetricExtensionResourceAggregationCollection {
  export function getJsonObj(obj: MetricExtensionResourceAggregationCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
  ...
  export function getDeserializedJsonObj(
    obj: MetricExtensionResourceAggregationCollection
  ): object {
    const jsonObj = {
      ...obj,
      ...{
