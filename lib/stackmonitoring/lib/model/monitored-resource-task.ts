...
export namespace MonitoredResourceTask {
  export function getJsonObj(obj: MonitoredResourceTask): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: MonitoredResourceTask): object {
    const jsonObj = {
      ...obj,
      ...{
        "taskDetails": obj.taskDetails
