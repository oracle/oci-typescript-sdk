...
export namespace MetricExtensionResourceAggregation {
  export function getJsonObj(obj: MetricExtensionResourceAggregation): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: MetricExtensionResourceAggregation): object {
    const jsonObj = { ...obj, ...{} };
