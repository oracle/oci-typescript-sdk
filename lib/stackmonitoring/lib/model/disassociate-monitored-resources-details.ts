...
export namespace DisassociateMonitoredResourcesDetails {
  export function getJsonObj(obj: DisassociateMonitoredResourcesDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: DisassociateMonitoredResourcesDetails): object {
    const jsonObj = { ...obj, ...{} };
