...
export namespace UpdateOnboardConfigDetails {
  export function getJsonObj(obj: UpdateOnboardConfigDetails, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.UpdateConfigDetails.getJsonObj(obj) as UpdateOnboardConfigDetails)),
      ...{
  ...
  export function getDeserializedJsonObj(
    obj: UpdateOnboardConfigDetails,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.UpdateConfigDetails.getDeserializedJsonObj(obj) as UpdateOnboardConfigDetails)),
      ...{
        "dynamicGroups": obj.dynamicGroups
          ? obj.dynamicGroups.map(item => {
