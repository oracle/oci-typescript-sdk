...
export namespace MonitoredResourceDetails {
  export function getJsonObj(obj: MonitoredResourceDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: MonitoredResourceDetails): object {
    const jsonObj = { ...obj, ...{} };
