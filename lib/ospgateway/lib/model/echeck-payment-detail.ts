...
export namespace EcheckPaymentDetail {
  ...
  export function getJsonObj(obj: EcheckPaymentDetail, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj ? obj : (model.PaymentDetail.getJsonObj(obj) as EcheckPaymentDetail)),
      ...{}
    };

    return jsonObj;
  }
  export const paymentMethod = "ECHECK";
  export function getDeserializedJsonObj(
    obj: EcheckPaymentDetail,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.PaymentDetail.getDeserializedJsonObj(obj) as EcheckPaymentDetail)),
      ...{}
    };
