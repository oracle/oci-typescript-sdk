...
export namespace PaySubscriptionReceipt {
  export function getJsonObj(obj: PaySubscriptionReceipt): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: PaySubscriptionReceipt): object {
    const jsonObj = { ...obj, ...{} };
