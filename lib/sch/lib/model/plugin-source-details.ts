...
export namespace PluginSourceDetails {
  export function getJsonObj(obj: PluginSourceDetails, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj ? obj : (model.SourceDetails.getJsonObj(obj) as PluginSourceDetails)),
      ...{}
    };
  ...
  export function getDeserializedJsonObj(
    obj: PluginSourceDetails,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.SourceDetails.getDeserializedJsonObj(obj) as PluginSourceDetails)),
      ...{}
    };
