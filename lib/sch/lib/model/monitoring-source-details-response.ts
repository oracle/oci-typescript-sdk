...
export namespace MonitoringSourceDetailsResponse {
  export function getJsonObj(
    obj: MonitoringSourceDetailsResponse,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.SourceDetailsResponse.getJsonObj(obj) as MonitoringSourceDetailsResponse)),
      ...{
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ...
        : (model.SourceDetailsResponse.getDeserializedJsonObj(
            obj
          ) as MonitoringSourceDetailsResponse)),
      ...{
        "monitoringSources": obj.monitoringSources
          ? obj.monitoringSources.map(item => {
