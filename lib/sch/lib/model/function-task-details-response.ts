...
export namespace FunctionTaskDetailsResponse {
  export function getJsonObj(obj: FunctionTaskDetailsResponse, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.TaskDetailsResponse.getJsonObj(obj) as FunctionTaskDetailsResponse)),
      ...{}
    };
  ...
  export function getDeserializedJsonObj(
    obj: FunctionTaskDetailsResponse,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.TaskDetailsResponse.getDeserializedJsonObj(obj) as FunctionTaskDetailsResponse)),
      ...{}
    };
