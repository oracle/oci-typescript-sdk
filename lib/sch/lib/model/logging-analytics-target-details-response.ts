...
export namespace LoggingAnalyticsTargetDetailsResponse {
  export function getJsonObj(
    obj: LoggingAnalyticsTargetDetailsResponse,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.TargetDetailsResponse.getJsonObj(obj) as LoggingAnalyticsTargetDetailsResponse)),
      ...{}
    };
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ...
        : (model.TargetDetailsResponse.getDeserializedJsonObj(
            obj
          ) as LoggingAnalyticsTargetDetailsResponse)),
      ...{}
    };
