...
/**
 * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/sch/ListConnectorPlugins.ts.html |here} to see how to use ListConnectorPluginsRequest.
 */
...
export namespace ListConnectorPluginsRequest {
  export enum SortBy {
