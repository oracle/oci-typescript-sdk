...
export namespace RollbackFsuJob {
  export function getJsonObj(obj: RollbackFsuJob, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj ? obj : (model.FsuJob.getJsonObj(obj) as RollbackFsuJob)),
      ...{
  ...
  export function getDeserializedJsonObj(obj: RollbackFsuJob, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj ? obj : (model.FsuJob.getDeserializedJsonObj(obj) as RollbackFsuJob)),
      ...{
