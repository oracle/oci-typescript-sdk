...
export namespace RollbackCycleFsuJob {
  export function getJsonObj(obj: RollbackCycleFsuJob, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj ? obj : (model.FsuJob.getJsonObj(obj) as RollbackCycleFsuJob)),
      ...{
  ...
  export function getDeserializedJsonObj(
    obj: RollbackCycleFsuJob,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.FsuJob.getDeserializedJsonObj(obj) as RollbackCycleFsuJob)),
      ...{
