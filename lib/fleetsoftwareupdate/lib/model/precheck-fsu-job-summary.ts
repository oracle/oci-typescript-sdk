...
export namespace PrecheckFsuJobSummary {
  export function getJsonObj(obj: PrecheckFsuJobSummary, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj ? obj : (model.FsuJobSummary.getJsonObj(obj) as PrecheckFsuJobSummary)),
      ...{
  ...
  export function getDeserializedJsonObj(
    obj: PrecheckFsuJobSummary,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.FsuJobSummary.getDeserializedJsonObj(obj) as PrecheckFsuJobSummary)),
      ...{
