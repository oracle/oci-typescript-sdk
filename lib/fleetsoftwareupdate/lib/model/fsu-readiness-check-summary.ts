...
export namespace FsuReadinessCheckSummary {
  export function getJsonObj(obj: FsuReadinessCheckSummary): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: FsuReadinessCheckSummary): object {
    const jsonObj = { ...obj, ...{} };
