...
export namespace StageFsuJob {
  export function getJsonObj(obj: StageFsuJob, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj ? obj : (model.FsuJob.getJsonObj(obj) as StageFsuJob)),
      ...{
  ...
  export function getDeserializedJsonObj(obj: StageFsuJob, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj ? obj : (model.FsuJob.getDeserializedJsonObj(obj) as StageFsuJob)),
      ...{
