...
export namespace UpdateFsuCollectionDetails {
  export function getJsonObj(obj: UpdateFsuCollectionDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: UpdateFsuCollectionDetails): object {
    const jsonObj = { ...obj, ...{} };
