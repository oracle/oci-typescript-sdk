...
export namespace ApplyActionSummary {
  export function getJsonObj(obj: ApplyActionSummary, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj ? obj : (model.FsuActionSummary.getJsonObj(obj) as ApplyActionSummary)),
      ...{
  ...
  export function getDeserializedJsonObj(
    obj: ApplyActionSummary,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.FsuActionSummary.getDeserializedJsonObj(obj) as ApplyActionSummary)),
      ...{
        "scheduleDetails": obj.scheduleDetails
