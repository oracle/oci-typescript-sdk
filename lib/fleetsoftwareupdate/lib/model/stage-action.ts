...
export namespace StageAction {
  export function getJsonObj(obj: StageAction, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj ? obj : (model.FsuAction.getJsonObj(obj) as StageAction)),
      ...{
  ...
  export function getDeserializedJsonObj(obj: StageAction, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj ? obj : (model.FsuAction.getDeserializedJsonObj(obj) as StageAction)),
      ...{
        "scheduleDetails": obj.scheduleDetails
