...
export namespace CleanupFsuJobSummary {
  export function getJsonObj(obj: CleanupFsuJobSummary, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj ? obj : (model.FsuJobSummary.getJsonObj(obj) as CleanupFsuJobSummary)),
      ...{
  ...
  export function getDeserializedJsonObj(
    obj: CleanupFsuJobSummary,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.FsuJobSummary.getDeserializedJsonObj(obj) as CleanupFsuJobSummary)),
      ...{
