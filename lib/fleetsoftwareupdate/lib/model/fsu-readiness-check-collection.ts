...
export namespace FsuReadinessCheckCollection {
  export function getJsonObj(obj: FsuReadinessCheckCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
  ...
  export function getDeserializedJsonObj(obj: FsuReadinessCheckCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
