 ...
 *
 */
export interface CreateGuestOsSoftwareComponentDetails
  extends model.CreateSoftwareComponentDetails {
  /**
...
export namespace CreateGuestOsSoftwareComponentDetails {
  export function getJsonObj(
    obj: CreateGuestOsSoftwareComponentDetails,
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ...
        : (model.CreateSoftwareComponentDetails.getJsonObj(
            obj
          ) as CreateGuestOsSoftwareComponentDetails)),
      ...{
