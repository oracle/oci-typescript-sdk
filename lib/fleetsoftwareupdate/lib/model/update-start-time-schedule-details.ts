...
export namespace UpdateStartTimeScheduleDetails {
  export function getJsonObj(
    obj: UpdateStartTimeScheduleDetails,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.UpdateScheduleDetails.getJsonObj(obj) as UpdateStartTimeScheduleDetails)),
      ...{}
    };
  ...
  export function getDeserializedJsonObj(
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.UpdateScheduleDetails.getDeserializedJsonObj(
            obj
          ) as UpdateStartTimeScheduleDetails)),
      ...{}
    };
