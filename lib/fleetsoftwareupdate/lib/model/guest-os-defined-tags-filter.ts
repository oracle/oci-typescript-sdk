...
export namespace GuestOsDefinedTagsFilter {
  export function getJsonObj(obj: GuestOsDefinedTagsFilter, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.GuestOsFleetDiscoveryFilter.getJsonObj(obj) as GuestOsDefinedTagsFilter)),
      ...{
        "tags": obj.tags
          ? obj.tags.map(item => {
