...
export namespace FsuCycleSummary {
  export function getJsonObj(obj: FsuCycleSummary): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: FsuCycleSummary): object {
    const jsonObj = {
      ...obj,
      ...{
        "nextActionToExecute": obj.nextActionToExecute
