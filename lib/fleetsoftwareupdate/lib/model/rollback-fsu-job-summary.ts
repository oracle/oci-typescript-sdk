...
export namespace RollbackFsuJobSummary {
  export function getJsonObj(obj: RollbackFsuJobSummary, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj ? obj : (model.FsuJobSummary.getJsonObj(obj) as RollbackFsuJobSummary)),
      ...{
  ...
  export function getDeserializedJsonObj(
    obj: RollbackFsuJobSummary,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.FsuJobSummary.getDeserializedJsonObj(obj) as RollbackFsuJobSummary)),
      ...{
