 ...
 *
 */
export interface UpdateFiftyFiftyBatchingStrategyDetails
...
export namespace UpdateFiftyFiftyBatchingStrategyDetails {
  export function getJsonObj(
    obj: UpdateFiftyFiftyBatchingStrategyDetails,
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ...
        : (model.UpdateBatchingStrategyDetails.getJsonObj(
            obj
          ) as UpdateFiftyFiftyBatchingStrategyDetails)),
      ...{}
    };
