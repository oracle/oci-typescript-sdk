 ...
 *
 */
export interface UpdateSequentialBatchingStrategyDetails
...
export namespace UpdateSequentialBatchingStrategyDetails {
  export function getJsonObj(
    obj: UpdateSequentialBatchingStrategyDetails,
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ...
        : (model.UpdateBatchingStrategyDetails.getJsonObj(
            obj
          ) as UpdateSequentialBatchingStrategyDetails)),
      ...{}
    };
