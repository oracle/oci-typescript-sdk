...
export namespace ApplyAction {
  export function getJsonObj(obj: ApplyAction, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj ? obj : (model.FsuAction.getJsonObj(obj) as ApplyAction)),
      ...{
  ...
  export function getDeserializedJsonObj(obj: ApplyAction, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj ? obj : (model.FsuAction.getDeserializedJsonObj(obj) as ApplyAction)),
      ...{
        "scheduleDetails": obj.scheduleDetails
