...
export namespace CreateTargetFsuReadinessCheckDetails {
  export function getJsonObj(
    obj: CreateTargetFsuReadinessCheckDetails,
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ...
        : (model.CreateFsuReadinessCheckDetails.getJsonObj(
            obj
          ) as CreateTargetFsuReadinessCheckDetails)),
      ...{
        "targets": obj.targets
  ...
  export function getDeserializedJsonObj(
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.CreateFsuReadinessCheckDetails.getDeserializedJsonObj(
            obj
          ) as CreateTargetFsuReadinessCheckDetails)),
      ...{
        "targets": obj.targets
