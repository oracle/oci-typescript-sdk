...
export namespace CleanupFsuJob {
  export function getJsonObj(obj: CleanupFsuJob, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj ? obj : (model.FsuJob.getJsonObj(obj) as CleanupFsuJob)),
      ...{
  ...
  export function getDeserializedJsonObj(obj: CleanupFsuJob, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj ? obj : (model.FsuJob.getDeserializedJsonObj(obj) as CleanupFsuJob)),
      ...{
