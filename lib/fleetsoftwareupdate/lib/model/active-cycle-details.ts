...
export namespace ActiveCycleDetails {
  export function getJsonObj(obj: ActiveCycleDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: ActiveCycleDetails): object {
    const jsonObj = { ...obj, ...{} };
