...
export namespace ExadbStackDiscoveryDetails {
  export function getJsonObj(obj: ExadbStackDiscoveryDetails, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.DiscoveryDetails.getJsonObj(obj) as ExadbStackDiscoveryDetails)),
      ...{
  ...
  export function getDeserializedJsonObj(
    obj: ExadbStackDiscoveryDetails,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.DiscoveryDetails.getDeserializedJsonObj(obj) as ExadbStackDiscoveryDetails)),
      ...{
        "components": obj.components
          ? obj.components.map(item => {
