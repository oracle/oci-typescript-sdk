...
export namespace StageActionSummary {
  export function getJsonObj(obj: StageActionSummary, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj ? obj : (model.FsuActionSummary.getJsonObj(obj) as StageActionSummary)),
      ...{
  ...
  export function getDeserializedJsonObj(
    obj: StageActionSummary,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.FsuActionSummary.getDeserializedJsonObj(obj) as StageActionSummary)),
      ...{
        "scheduleDetails": obj.scheduleDetails
