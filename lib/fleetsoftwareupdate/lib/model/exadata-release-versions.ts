 ...
 *
 **/
export enum ExadataReleaseVersions {
...
export namespace ExadataReleaseVersions {
  export function getJsonObj(obj: ExadataReleaseVersions): ExadataReleaseVersions {
    return obj;
  }
  export function getDeserializedJsonObj(obj: ExadataReleaseVersions): ExadataReleaseVersions {
    return obj;
  }
}
