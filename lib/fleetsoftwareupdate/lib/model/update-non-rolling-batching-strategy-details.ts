 ...
 *
 */
export interface UpdateNonRollingBatchingStrategyDetails
  extends model.UpdateBatchingStrategyDetails {
  "type": string;
}

export namespace UpdateNonRollingBatchingStrategyDetails {
  export function getJsonObj(
    obj: UpdateNonRollingBatchingStrategyDetails,
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ...
        : (model.UpdateBatchingStrategyDetails.getJsonObj(
            obj
          ) as UpdateNonRollingBatchingStrategyDetails)),
      ...{}
    };
