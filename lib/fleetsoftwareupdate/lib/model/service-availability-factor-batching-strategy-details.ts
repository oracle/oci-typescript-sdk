 ...
 *
 */
export interface ServiceAvailabilityFactorBatchingStrategyDetails
  extends model.BatchingStrategyDetails {
  /**
...
export namespace ServiceAvailabilityFactorBatchingStrategyDetails {
  export function getJsonObj(
    obj: ServiceAvailabilityFactorBatchingStrategyDetails,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.BatchingStrategyDetails.getJsonObj(
            obj
          ) as ServiceAvailabilityFactorBatchingStrategyDetails)),
      ...{}
    };
