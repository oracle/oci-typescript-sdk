...
export namespace ApplyFsuJob {
  export function getJsonObj(obj: ApplyFsuJob, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj ? obj : (model.FsuJob.getJsonObj(obj) as ApplyFsuJob)),
      ...{
  ...
  export function getDeserializedJsonObj(obj: ApplyFsuJob, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj ? obj : (model.FsuJob.getDeserializedJsonObj(obj) as ApplyFsuJob)),
      ...{
