...
/**
 * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/fleetsoftwareupdate/UpdateFsuAction.ts.html |here} to see how to use UpdateFsuActionRequest.
 */
export interface UpdateFsuActionRequest extends common.BaseRequest {
  ...
  "updateFsuActionDetails":
    ...
    | model.UpdatePrecheckActionDetails
    | model.UpdateCleanupActionDetails;
  /**
