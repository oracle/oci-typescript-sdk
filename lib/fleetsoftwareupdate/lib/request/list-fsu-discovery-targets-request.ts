...
/**
 * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/fleetsoftwareupdate/ListFsuDiscoveryTargets.ts.html |here} to see how to use ListFsuDiscoveryTargetsRequest.
 */
...
export namespace ListFsuDiscoveryTargetsRequest {
  export enum Status {
    Idle = "IDLE",
