...
/**
 * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/fleetsoftwareupdate/ListFsuCollectionTargets.ts.html |here} to see how to use ListFsuCollectionTargetsRequest.
 */
...
export namespace ListFsuCollectionTargetsRequest {
  export enum Status {
    Idle = "IDLE",
