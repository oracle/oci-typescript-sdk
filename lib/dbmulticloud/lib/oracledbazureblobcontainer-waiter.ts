...
export class OracleDBAzureBlobContainerWaiter {
  public constructor(
   ...
   */
  public async forOracleDbAzureBlobContainer(
    request: serviceRequests.GetOracleDbAzureBlobContainerRequest,
    ...targetStates: models.OracleDbAzureBlobContainer.LifecycleState[]
  ): Promise<serviceResponses.GetOracleDbAzureBlobContainerResponse | null> {
    return genericTerminalConditionWaiter(
      this.config,
      () => this.client.getOracleDbAzureBlobContainer(request),
      response => targetStates.includes(response.oracleDbAzureBlobContainer.lifecycleState!),
      targetStates.includes(models.OracleDbAzureBlobContainer.LifecycleState.Deleted)
    );
  }
}
