...
export class OracleDBAzureConnectorWaiter {
  public constructor(
    private client: OracleDBAzureConnectorClient,
   ...
   */
  public async forOracleDbAzureConnector(
    request: serviceRequests.GetOracleDbAzureConnectorRequest,
    ...targetStates: models.OracleDbAzureConnector.LifecycleState[]
  ): Promise<serviceResponses.GetOracleDbAzureConnectorResponse | null> {
    return genericTerminalConditionWaiter(
      this.config,
      () => this.client.getOracleDbAzureConnector(request),
      response => targetStates.includes(response.oracleDbAzureConnector.lifecycleState!),
      targetStates.includes(models.OracleDbAzureConnector.LifecycleState.Deleted)
    );
  }
}
