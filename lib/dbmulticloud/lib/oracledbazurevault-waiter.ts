...
export class OracleDbAzureVaultWaiter {
  public constructor(
    private client: OracleDbAzureVaultClient,
   ...
   */
  public async forOracleDbAzureVault(
    request: serviceRequests.GetOracleDbAzureVaultRequest,
    ...targetStates: models.OracleDbAzureVault.LifecycleState[]
  ): Promise<serviceResponses.GetOracleDbAzureVaultResponse | null> {
    return genericTerminalConditionWaiter(
      this.config,
      () => this.client.getOracleDbAzureVault(request),
      response => targetStates.includes(response.oracleDbAzureVault.lifecycleState!),
      targetStates.includes(models.OracleDbAzureVault.LifecycleState.Deleted)
    );
  }
}
