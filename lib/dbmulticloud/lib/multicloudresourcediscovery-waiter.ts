...
export class MultiCloudResourceDiscoveryWaiter {
  public constructor(
   ...
   */
  public async forMultiCloudResourceDiscovery(
    request: serviceRequests.GetMultiCloudResourceDiscoveryRequest,
    ...targetStates: models.MultiCloudResourceDiscovery.LifecycleState[]
  ): Promise<serviceResponses.GetMultiCloudResourceDiscoveryResponse> {
    return genericWaiter(
      this.config,
      () => this.client.getMultiCloudResourceDiscovery(request),
      response => targetStates.includes(response.multiCloudResourceDiscovery.lifecycleState!)
    );
  }
}
