...
export namespace OracleDbAzureBlobContainerSummaryCollection {
  export function getJsonObj(obj: OracleDbAzureBlobContainerSummaryCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
  ...
  export function getDeserializedJsonObj(obj: OracleDbAzureBlobContainerSummaryCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
