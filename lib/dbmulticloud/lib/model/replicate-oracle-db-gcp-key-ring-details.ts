 ...
 *
 */
export interface ReplicateOracleDbGcpKeyRingDetails {
  /**
   ...
   */
  "action"?: model.ReplicationActions;
}

export namespace ReplicateOracleDbGcpKeyRingDetails {
  export function getJsonObj(obj: ReplicateOracleDbGcpKeyRingDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: ReplicateOracleDbGcpKeyRingDetails): object {
    const jsonObj = { ...obj, ...{} };
