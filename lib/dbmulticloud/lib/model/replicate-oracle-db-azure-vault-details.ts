 ...
 *
 */
export interface ReplicateOracleDbAzureVaultDetails {
  /**
...
export namespace ReplicateOracleDbAzureVaultDetails {
  export function getJsonObj(obj: ReplicateOracleDbAzureVaultDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: ReplicateOracleDbAzureVaultDetails): object {
    const jsonObj = { ...obj, ...{} };
