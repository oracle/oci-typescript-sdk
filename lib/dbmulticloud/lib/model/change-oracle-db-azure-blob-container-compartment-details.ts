...
export namespace ChangeOracleDbAzureBlobContainerCompartmentDetails {
  export function getJsonObj(obj: ChangeOracleDbAzureBlobContainerCompartmentDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(
    obj: ChangeOracleDbAzureBlobContainerCompartmentDetails
  ): object {
    const jsonObj = { ...obj, ...{} };
