...
export namespace UpdateOracleDbAzureConnectorDetails {
  export function getJsonObj(obj: UpdateOracleDbAzureConnectorDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: UpdateOracleDbAzureConnectorDetails): object {
    const jsonObj = { ...obj, ...{} };
