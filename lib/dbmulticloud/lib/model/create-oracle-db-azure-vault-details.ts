...
export namespace CreateOracleDbAzureVaultDetails {
  export function getJsonObj(obj: CreateOracleDbAzureVaultDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: CreateOracleDbAzureVaultDetails): object {
    const jsonObj = { ...obj, ...{} };
