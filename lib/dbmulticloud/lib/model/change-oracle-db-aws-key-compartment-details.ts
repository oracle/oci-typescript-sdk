...
export namespace ChangeOracleDbAwsKeyCompartmentDetails {
  export function getJsonObj(obj: ChangeOracleDbAwsKeyCompartmentDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: ChangeOracleDbAwsKeyCompartmentDetails): object {
    const jsonObj = { ...obj, ...{} };
