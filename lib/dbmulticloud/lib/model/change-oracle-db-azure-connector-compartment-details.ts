...
export namespace ChangeOracleDbAzureConnectorCompartmentDetails {
  export function getJsonObj(obj: ChangeOracleDbAzureConnectorCompartmentDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(
    obj: ChangeOracleDbAzureConnectorCompartmentDetails
  ): object {
    const jsonObj = { ...obj, ...{} };
