...
export namespace OracleDbAwsKeySummary {
  export function getJsonObj(obj: OracleDbAwsKeySummary): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: OracleDbAwsKeySummary): object {
    const jsonObj = { ...obj, ...{} };
