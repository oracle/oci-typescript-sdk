...
export namespace CreateOracleDbAwsIdentityConnectorDetails {
  export function getJsonObj(obj: CreateOracleDbAwsIdentityConnectorDetails): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: CreateOracleDbAwsIdentityConnectorDetails): object {
    const jsonObj = {
      ...obj,
      ...{
        "serviceRoleDetails": obj.serviceRoleDetails
