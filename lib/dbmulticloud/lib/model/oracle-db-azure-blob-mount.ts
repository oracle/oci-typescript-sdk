...
export namespace OracleDbAzureBlobMount {
  ...
  export function getJsonObj(obj: OracleDbAzureBlobMount): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: OracleDbAzureBlobMount): object {
    const jsonObj = { ...obj, ...{} };
