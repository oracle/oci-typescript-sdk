...
export namespace OracleDbAzureVaultSummaryCollection {
  export function getJsonObj(obj: OracleDbAzureVaultSummaryCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
  ...
  export function getDeserializedJsonObj(obj: OracleDbAzureVaultSummaryCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
