...
export namespace OracleDbAzureKeySummary {
  export function getJsonObj(obj: OracleDbAzureKeySummary): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: OracleDbAzureKeySummary): object {
    const jsonObj = { ...obj, ...{} };
