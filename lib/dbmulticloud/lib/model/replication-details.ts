...
export interface ReplicationDetails {
   ...
   */
  "replicationState"?: ReplicationDetails.ReplicationState;
  /**
...
export namespace ReplicationDetails {
  ...
  export function getJsonObj(obj: ReplicationDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: ReplicationDetails): object {
    const jsonObj = { ...obj, ...{} };
