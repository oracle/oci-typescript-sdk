...
export namespace ChangeOracleDbGcpIdentityConnectorCompartmentDetails {
  export function getJsonObj(obj: ChangeOracleDbGcpIdentityConnectorCompartmentDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(
    obj: ChangeOracleDbGcpIdentityConnectorCompartmentDetails
  ): object {
    const jsonObj = { ...obj, ...{} };
