...
export namespace ChangeMultiCloudResourceDiscoveryCompartmentDetails {
  export function getJsonObj(obj: ChangeMultiCloudResourceDiscoveryCompartmentDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(
    obj: ChangeMultiCloudResourceDiscoveryCompartmentDetails
  ): object {
    const jsonObj = { ...obj, ...{} };
