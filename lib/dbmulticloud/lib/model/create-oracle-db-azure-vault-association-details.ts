...
export namespace CreateOracleDbAzureVaultAssociationDetails {
  export function getJsonObj(obj: CreateOracleDbAzureVaultAssociationDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: CreateOracleDbAzureVaultAssociationDetails): object {
    const jsonObj = { ...obj, ...{} };
