...
export namespace CreateOracleDbGcpIdentityConnectorDetails {
  export function getJsonObj(obj: CreateOracleDbGcpIdentityConnectorDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: CreateOracleDbGcpIdentityConnectorDetails): object {
    const jsonObj = { ...obj, ...{} };
