...
export namespace OracleDbAwsIdentityConnectorSummary {
  export function getJsonObj(obj: OracleDbAwsIdentityConnectorSummary): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: OracleDbAwsIdentityConnectorSummary): object {
    const jsonObj = {
      ...obj,
      ...{
        "serviceRoleDetails": obj.serviceRoleDetails
