...
export namespace OracleDbGcpIdentityConnector {
  ...
  export function getJsonObj(obj: OracleDbGcpIdentityConnector): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: OracleDbGcpIdentityConnector): object {
    const jsonObj = {
      ...obj,
      ...{
        "gcpNodes": obj.gcpNodes
