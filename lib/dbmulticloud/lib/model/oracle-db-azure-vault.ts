...
export namespace OracleDbAzureVault {
  ...
  export function getJsonObj(obj: OracleDbAzureVault): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: OracleDbAzureVault): object {
    const jsonObj = { ...obj, ...{} };
