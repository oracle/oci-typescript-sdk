...
export namespace UpdateOracleDbGcpKeyRingDetails {
  export function getJsonObj(obj: UpdateOracleDbGcpKeyRingDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: UpdateOracleDbGcpKeyRingDetails): object {
    const jsonObj = { ...obj, ...{} };
