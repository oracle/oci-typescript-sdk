...
export namespace CreateOracleDbGcpKeyRingDetails {
  export function getJsonObj(obj: CreateOracleDbGcpKeyRingDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: CreateOracleDbGcpKeyRingDetails): object {
    const jsonObj = { ...obj, ...{} };
