...
export namespace UpdateOracleDbAwsIdentityConnectorDetails {
  export function getJsonObj(obj: UpdateOracleDbAwsIdentityConnectorDetails): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: UpdateOracleDbAwsIdentityConnectorDetails): object {
    const jsonObj = {
      ...obj,
      ...{
        "serviceRoleDetails": obj.serviceRoleDetails
