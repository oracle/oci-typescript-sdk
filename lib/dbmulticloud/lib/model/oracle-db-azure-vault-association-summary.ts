...
export namespace OracleDbAzureVaultAssociationSummary {
  export function getJsonObj(obj: OracleDbAzureVaultAssociationSummary): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: OracleDbAzureVaultAssociationSummary): object {
    const jsonObj = { ...obj, ...{} };
