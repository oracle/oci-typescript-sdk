 ...
 *
 */
export interface ReplicateOracleDbAwsKeyDetails {
  /**
...
export namespace ReplicateOracleDbAwsKeyDetails {
  export function getJsonObj(obj: ReplicateOracleDbAwsKeyDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: ReplicateOracleDbAwsKeyDetails): object {
    const jsonObj = { ...obj, ...{} };
