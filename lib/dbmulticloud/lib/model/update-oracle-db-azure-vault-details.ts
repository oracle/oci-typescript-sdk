...
export namespace UpdateOracleDbAzureVaultDetails {
  export function getJsonObj(obj: UpdateOracleDbAzureVaultDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: UpdateOracleDbAzureVaultDetails): object {
    const jsonObj = { ...obj, ...{} };
