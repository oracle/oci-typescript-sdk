...
export interface ReplicationMetadata {
   ...
   */
  "replicationDetails"?: Array<model.ReplicationDetails>;
}

export namespace ReplicationMetadata {
  export function getJsonObj(obj: ReplicationMetadata): object {
    const jsonObj = {
      ...obj,
      ...{
        "replicationDetails": obj.replicationDetails
          ? obj.replicationDetails.map(item => {
              return model.ReplicationDetails.getJsonObj(item);
            })
          : undefined
      }
    };
  ...
  export function getDeserializedJsonObj(obj: ReplicationMetadata): object {
    const jsonObj = {
      ...obj,
      ...{
        "replicationDetails": obj.replicationDetails
          ? obj.replicationDetails.map(item => {
              return model.ReplicationDetails.getDeserializedJsonObj(item);
            })
          : undefined
      }
    };
