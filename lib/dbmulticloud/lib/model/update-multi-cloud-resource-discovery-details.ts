...
export namespace UpdateMultiCloudResourceDiscoveryDetails {
  export function getJsonObj(obj: UpdateMultiCloudResourceDiscoveryDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: UpdateMultiCloudResourceDiscoveryDetails): object {
    const jsonObj = { ...obj, ...{} };
