...
export namespace CreateMultiCloudResourceDiscoveryDetails {
  export function getJsonObj(obj: CreateMultiCloudResourceDiscoveryDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: CreateMultiCloudResourceDiscoveryDetails): object {
    const jsonObj = { ...obj, ...{} };
