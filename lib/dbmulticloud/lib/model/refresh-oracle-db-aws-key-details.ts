...
export namespace RefreshOracleDbAwsKeyDetails {
  export function getJsonObj(obj: RefreshOracleDbAwsKeyDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: RefreshOracleDbAwsKeyDetails): object {
    const jsonObj = { ...obj, ...{} };
