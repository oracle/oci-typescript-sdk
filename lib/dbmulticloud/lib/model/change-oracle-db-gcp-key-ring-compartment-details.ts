...
export namespace ChangeOracleDbGcpKeyRingCompartmentDetails {
  export function getJsonObj(obj: ChangeOracleDbGcpKeyRingCompartmentDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: ChangeOracleDbGcpKeyRingCompartmentDetails): object {
    const jsonObj = { ...obj, ...{} };
