...
export namespace OracleDbGcpKeySummaryCollection {
  export function getJsonObj(obj: OracleDbGcpKeySummaryCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
  ...
  export function getDeserializedJsonObj(obj: OracleDbGcpKeySummaryCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
