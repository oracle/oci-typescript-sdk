...
export namespace OracleDbGcpKeySummary {
  export function getJsonObj(obj: OracleDbGcpKeySummary): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: OracleDbGcpKeySummary): object {
    const jsonObj = { ...obj, ...{} };
