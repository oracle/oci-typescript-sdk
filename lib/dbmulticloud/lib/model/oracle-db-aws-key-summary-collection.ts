...
export namespace OracleDbAwsKeySummaryCollection {
  export function getJsonObj(obj: OracleDbAwsKeySummaryCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
  ...
  export function getDeserializedJsonObj(obj: OracleDbAwsKeySummaryCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
