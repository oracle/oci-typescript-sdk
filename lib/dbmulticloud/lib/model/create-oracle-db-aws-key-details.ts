...
export namespace CreateOracleDbAwsKeyDetails {
  export function getJsonObj(obj: CreateOracleDbAwsKeyDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: CreateOracleDbAwsKeyDetails): object {
    const jsonObj = { ...obj, ...{} };
