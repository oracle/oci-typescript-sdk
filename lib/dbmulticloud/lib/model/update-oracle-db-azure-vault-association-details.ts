...
export namespace UpdateOracleDbAzureVaultAssociationDetails {
  export function getJsonObj(obj: UpdateOracleDbAzureVaultAssociationDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: UpdateOracleDbAzureVaultAssociationDetails): object {
    const jsonObj = { ...obj, ...{} };
