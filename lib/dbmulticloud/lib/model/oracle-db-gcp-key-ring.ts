...
export namespace OracleDbGcpKeyRing {
  ...
  export function getJsonObj(obj: OracleDbGcpKeyRing): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: OracleDbGcpKeyRing): object {
    const jsonObj = { ...obj, ...{} };
