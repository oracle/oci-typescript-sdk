...
export namespace ServiceRoleDetails {
  ...
  export function getJsonObj(obj: ServiceRoleDetails): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: ServiceRoleDetails): object {
    const jsonObj = {
      ...obj,
      ...{
        "awsNodes": obj.awsNodes
