...
export namespace OracleDbAzureKeySummaryCollection {
  export function getJsonObj(obj: OracleDbAzureKeySummaryCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
  ...
  export function getDeserializedJsonObj(obj: OracleDbAzureKeySummaryCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
