...
export namespace OracleDbAzureBlobMountSummaryCollection {
  export function getJsonObj(obj: OracleDbAzureBlobMountSummaryCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
  ...
  export function getDeserializedJsonObj(obj: OracleDbAzureBlobMountSummaryCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
