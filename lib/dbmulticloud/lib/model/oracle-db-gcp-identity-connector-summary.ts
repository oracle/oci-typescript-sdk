...
export namespace OracleDbGcpIdentityConnectorSummary {
  export function getJsonObj(obj: OracleDbGcpIdentityConnectorSummary): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: OracleDbGcpIdentityConnectorSummary): object {
    const jsonObj = {
      ...obj,
      ...{
        "gcpNodes": obj.gcpNodes
