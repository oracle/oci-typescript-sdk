...
export namespace MultiCloudResourceDiscoverySummary {
  export function getJsonObj(obj: MultiCloudResourceDiscoverySummary): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: MultiCloudResourceDiscoverySummary): object {
    const jsonObj = {
      ...obj,
      ...{
        "resources": obj.resources
