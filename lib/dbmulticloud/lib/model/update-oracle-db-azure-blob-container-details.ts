...
export namespace UpdateOracleDbAzureBlobContainerDetails {
  export function getJsonObj(obj: UpdateOracleDbAzureBlobContainerDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: UpdateOracleDbAzureBlobContainerDetails): object {
    const jsonObj = { ...obj, ...{} };
