...
export namespace CreateOracleDbAzureConnectorDetails {
  export function getJsonObj(obj: CreateOracleDbAzureConnectorDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: CreateOracleDbAzureConnectorDetails): object {
    const jsonObj = { ...obj, ...{} };
