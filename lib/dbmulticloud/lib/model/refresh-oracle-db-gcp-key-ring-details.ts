...
export namespace RefreshOracleDbGcpKeyRingDetails {
  export function getJsonObj(obj: RefreshOracleDbGcpKeyRingDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: RefreshOracleDbGcpKeyRingDetails): object {
    const jsonObj = { ...obj, ...{} };
