...
export namespace OracleDbGcpKeyRingSummary {
  export function getJsonObj(obj: OracleDbGcpKeyRingSummary): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: OracleDbGcpKeyRingSummary): object {
    const jsonObj = { ...obj, ...{} };
