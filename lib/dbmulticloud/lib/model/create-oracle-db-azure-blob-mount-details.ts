...
export namespace CreateOracleDbAzureBlobMountDetails {
  export function getJsonObj(obj: CreateOracleDbAzureBlobMountDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: CreateOracleDbAzureBlobMountDetails): object {
    const jsonObj = { ...obj, ...{} };
