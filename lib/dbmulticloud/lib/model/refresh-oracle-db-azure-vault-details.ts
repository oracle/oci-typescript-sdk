...
export namespace RefreshOracleDbAzureVaultDetails {
  export function getJsonObj(obj: RefreshOracleDbAzureVaultDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: RefreshOracleDbAzureVaultDetails): object {
    const jsonObj = { ...obj, ...{} };
