...
export namespace OracleDbAzureBlobContainerSummary {
  export function getJsonObj(obj: OracleDbAzureBlobContainerSummary): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: OracleDbAzureBlobContainerSummary): object {
    const jsonObj = { ...obj, ...{} };
