...
export namespace OracleDbAzureBlobContainer {
  ...
  export function getJsonObj(obj: OracleDbAzureBlobContainer): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: OracleDbAzureBlobContainer): object {
    const jsonObj = { ...obj, ...{} };
