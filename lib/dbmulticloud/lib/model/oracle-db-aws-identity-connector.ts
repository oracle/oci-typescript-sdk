...
export namespace OracleDbAwsIdentityConnector {
  ...
  export function getJsonObj(obj: OracleDbAwsIdentityConnector): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: OracleDbAwsIdentityConnector): object {
    const jsonObj = {
      ...obj,
      ...{
        "serviceRoleDetails": obj.serviceRoleDetails
