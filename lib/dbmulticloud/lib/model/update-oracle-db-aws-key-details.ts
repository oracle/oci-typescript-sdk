...
export namespace UpdateOracleDbAwsKeyDetails {
  export function getJsonObj(obj: UpdateOracleDbAwsKeyDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: UpdateOracleDbAwsKeyDetails): object {
    const jsonObj = { ...obj, ...{} };
