...
export namespace ServiceRoleDetail {
  export enum ServiceType {
    Kms = "KMS"
  }

  export function getJsonObj(obj: ServiceRoleDetail): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: ServiceRoleDetail): object {
    const jsonObj = { ...obj, ...{} };
