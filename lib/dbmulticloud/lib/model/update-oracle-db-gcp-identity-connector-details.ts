...
export namespace UpdateOracleDbGcpIdentityConnectorDetails {
  export function getJsonObj(obj: UpdateOracleDbGcpIdentityConnectorDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: UpdateOracleDbGcpIdentityConnectorDetails): object {
    const jsonObj = { ...obj, ...{} };
