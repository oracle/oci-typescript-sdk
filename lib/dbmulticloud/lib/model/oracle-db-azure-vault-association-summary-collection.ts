...
export namespace OracleDbAzureVaultAssociationSummaryCollection {
  export function getJsonObj(obj: OracleDbAzureVaultAssociationSummaryCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
  ...
  export function getDeserializedJsonObj(
    obj: OracleDbAzureVaultAssociationSummaryCollection
  ): object {
    const jsonObj = {
      ...obj,
      ...{
