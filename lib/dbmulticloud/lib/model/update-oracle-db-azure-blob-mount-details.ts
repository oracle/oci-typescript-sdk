...
export namespace UpdateOracleDbAzureBlobMountDetails {
  export function getJsonObj(obj: UpdateOracleDbAzureBlobMountDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: UpdateOracleDbAzureBlobMountDetails): object {
    const jsonObj = { ...obj, ...{} };
