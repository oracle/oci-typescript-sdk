...
export namespace ReplicationActions {
  export function getJsonObj(obj: ReplicationActions): ReplicationActions {
    return obj;
  }
  export function getDeserializedJsonObj(obj: ReplicationActions): ReplicationActions {
    return obj;
  }
}
