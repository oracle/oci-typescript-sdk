...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/dbmulticloud/ReplicateOracleDbAwsKey.ts.html |here} to see how to use ReplicateOracleDbAwsKeyRequest.
 */
export interface ReplicateOracleDbAwsKeyRequest extends common.BaseRequest {
  /**
   ...
   */
  "replicateOracleDbAwsKeyDetails": model.ReplicateOracleDbAwsKeyDetails;
  /**
