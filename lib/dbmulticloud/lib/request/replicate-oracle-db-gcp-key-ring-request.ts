...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/dbmulticloud/ReplicateOracleDbGcpKeyRing.ts.html |here} to see how to use ReplicateOracleDbGcpKeyRingRequest.
 */
export interface ReplicateOracleDbGcpKeyRingRequest extends common.BaseRequest {
  /**
   ...
   */
  "replicateOracleDbGcpKeyRingDetails": model.ReplicateOracleDbGcpKeyRingDetails;
  /**
