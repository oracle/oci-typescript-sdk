...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/dbmulticloud/ReplicateOracleDbAzureVault.ts.html |here} to see how to use ReplicateOracleDbAzureVaultRequest.
 */
export interface ReplicateOracleDbAzureVaultRequest extends common.BaseRequest {
  /**
   ...
   */
  "replicateOracleDbAzureVaultDetails": model.ReplicateOracleDbAzureVaultDetails;
  /**
