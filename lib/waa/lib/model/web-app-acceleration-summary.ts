...
export namespace WebAppAccelerationSummary {
  export function getJsonObj(obj: WebAppAccelerationSummary): object {
    const jsonObj = { ...obj, ...{} };

    if (obj && "backendType" in obj && obj.backendType) {
      switch (obj.backendType) {
        case "LOAD_BALANCER":
          return model.WebAppAccelerationLoadBalancerSummary.getJsonObj(
            <model.WebAppAccelerationLoadBalancerSummary>(<object>jsonObj),
            true
          );
        default:
  ...
  export function getDeserializedJsonObj(obj: WebAppAccelerationSummary): object {
    const jsonObj = { ...obj, ...{} };

    if (obj && "backendType" in obj && obj.backendType) {
      switch (obj.backendType) {
        case "LOAD_BALANCER":
          return model.WebAppAccelerationLoadBalancerSummary.getDeserializedJsonObj(
            <model.WebAppAccelerationLoadBalancerSummary>(<object>jsonObj),
            true
          );
        default:
