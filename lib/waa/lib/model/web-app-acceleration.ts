...
export namespace WebAppAcceleration {
  ...
  export function getJsonObj(obj: WebAppAcceleration): object {
    const jsonObj = { ...obj, ...{} };

    if (obj && "backendType" in obj && obj.backendType) {
      switch (obj.backendType) {
        case "LOAD_BALANCER":
          return model.WebAppAccelerationLoadBalancer.getJsonObj(
            <model.WebAppAccelerationLoadBalancer>(<object>jsonObj),
            true
          );
        default:
  ...
  export function getDeserializedJsonObj(obj: WebAppAcceleration): object {
    const jsonObj = { ...obj, ...{} };

    if (obj && "backendType" in obj && obj.backendType) {
      switch (obj.backendType) {
        case "LOAD_BALANCER":
          return model.WebAppAccelerationLoadBalancer.getDeserializedJsonObj(
            <model.WebAppAccelerationLoadBalancer>(<object>jsonObj),
            true
          );
        default:
