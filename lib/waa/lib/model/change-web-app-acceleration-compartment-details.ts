...
export namespace ChangeWebAppAccelerationCompartmentDetails {
  export function getJsonObj(obj: ChangeWebAppAccelerationCompartmentDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: ChangeWebAppAccelerationCompartmentDetails): object {
    const jsonObj = { ...obj, ...{} };
