...
export namespace WebAppAccelerationCollection {
  export function getJsonObj(obj: WebAppAccelerationCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
  ...
  export function getDeserializedJsonObj(obj: WebAppAccelerationCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
