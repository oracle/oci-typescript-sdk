...
export namespace ChangeWebAppAccelerationPolicyCompartmentDetails {
  export function getJsonObj(obj: ChangeWebAppAccelerationPolicyCompartmentDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(
    obj: ChangeWebAppAccelerationPolicyCompartmentDetails
  ): object {
    const jsonObj = { ...obj, ...{} };
