...
export namespace WebAppAccelerationPolicySummary {
  export function getJsonObj(obj: WebAppAccelerationPolicySummary): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: WebAppAccelerationPolicySummary): object {
    const jsonObj = { ...obj, ...{} };
