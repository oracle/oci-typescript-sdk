...
export namespace InitialImportDatasetConfiguration {
  export function getJsonObj(obj: InitialImportDatasetConfiguration): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: InitialImportDatasetConfiguration): object {
    const jsonObj = {
      ...obj,
      ...{
        "importFormat": obj.importFormat
