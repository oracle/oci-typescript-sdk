...
export namespace AnnotationAggregationDimensions {
  export function getJsonObj(obj: AnnotationAggregationDimensions): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: AnnotationAggregationDimensions): object {
    const jsonObj = {
      ...obj,
      ...{
