    ...
    if (obj && "entityType" in obj && obj.entityType) {
      switch (obj.entityType) {
        ...
        case "KEYVALUESELECTION":
          return model.KeyValueSelectionEntity.getJsonObj(
            <model.KeyValueSelectionEntity>(<object>jsonObj),
            true
          );
        case "TEXTSELECTION":
  ...
  export function getDeserializedJsonObj(obj: Entity): object {
    ...
    if (obj && "entityType" in obj && obj.entityType) {
      switch (obj.entityType) {
        ...
        case "KEYVALUESELECTION":
          return model.KeyValueSelectionEntity.getDeserializedJsonObj(
            <model.KeyValueSelectionEntity>(<object>jsonObj),
            true
          );
        case "TEXTSELECTION":
