 ...
 */
export interface ResellerInformation {
...
export namespace ResellerInformation {
  export function getJsonObj(obj: ResellerInformation): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: ResellerInformation): object {
    const jsonObj = {
      ...obj,
      ...{
        "primaryContact": obj.primaryContact
