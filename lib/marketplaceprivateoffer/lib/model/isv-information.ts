 ...
 */
export interface IsvInformation {
...
export namespace IsvInformation {
  export function getJsonObj(obj: IsvInformation): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: IsvInformation): object {
    const jsonObj = {
      ...obj,
      ...{
        "primaryContact": obj.primaryContact
