...
export namespace ChangeVbInstanceCompartmentDetails {
  export function getJsonObj(obj: ChangeVbInstanceCompartmentDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: ChangeVbInstanceCompartmentDetails): object {
    const jsonObj = { ...obj, ...{} };
