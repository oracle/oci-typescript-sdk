...
export namespace VbInstanceSummaryCollection {
  export function getJsonObj(obj: VbInstanceSummaryCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
  ...
  export function getDeserializedJsonObj(obj: VbInstanceSummaryCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
