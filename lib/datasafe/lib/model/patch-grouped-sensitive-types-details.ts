...
export namespace PatchGroupedSensitiveTypesDetails {
  export function getJsonObj(obj: PatchGroupedSensitiveTypesDetails): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
  ...
  export function getDeserializedJsonObj(obj: PatchGroupedSensitiveTypesDetails): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
