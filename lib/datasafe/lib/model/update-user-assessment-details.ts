...
export namespace UpdateUserAssessmentDetails {
  export function getJsonObj(obj: UpdateUserAssessmentDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: UpdateUserAssessmentDetails): object {
    const jsonObj = { ...obj, ...{} };
