...
export namespace CreateSensitiveTypePatternDetails {
  export function getJsonObj(
    obj: CreateSensitiveTypePatternDetails,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.CreateSensitiveTypeDetails.getJsonObj(obj) as CreateSensitiveTypePatternDetails)),
      ...{}
    };
  ...
  export function getDeserializedJsonObj(
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.CreateSensitiveTypeDetails.getDeserializedJsonObj(
            obj
          ) as CreateSensitiveTypePatternDetails)),
      ...{}
    };
