...
export namespace ChangeTargetAlertPolicyAssociationCompartmentDetails {
  export function getJsonObj(obj: ChangeTargetAlertPolicyAssociationCompartmentDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(
    obj: ChangeTargetAlertPolicyAssociationCompartmentDetails
  ): object {
    const jsonObj = { ...obj, ...{} };
