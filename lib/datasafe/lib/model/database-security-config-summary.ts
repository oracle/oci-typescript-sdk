...
export namespace DatabaseSecurityConfigSummary {
  export function getJsonObj(obj: DatabaseSecurityConfigSummary): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: DatabaseSecurityConfigSummary): object {
    const jsonObj = {
      ...obj,
      ...{
        "sqlFirewallConfig": obj.sqlFirewallConfig
