...
export namespace SensitiveTypesExportSummary {
  export function getJsonObj(obj: SensitiveTypesExportSummary): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: SensitiveTypesExportSummary): object {
    const jsonObj = { ...obj, ...{} };
