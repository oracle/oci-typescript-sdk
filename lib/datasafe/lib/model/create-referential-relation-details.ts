...
export namespace CreateReferentialRelationDetails {
  export enum RelationType {
    AppDefined = "APP_DEFINED",
    DbDefined = "DB_DEFINED"
  }

  export function getJsonObj(obj: CreateReferentialRelationDetails): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: CreateReferentialRelationDetails): object {
    const jsonObj = {
      ...obj,
      ...{
