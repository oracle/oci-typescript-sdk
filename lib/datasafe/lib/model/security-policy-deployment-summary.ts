...
export namespace SecurityPolicyDeploymentSummary {
  export function getJsonObj(obj: SecurityPolicyDeploymentSummary): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: SecurityPolicyDeploymentSummary): object {
    const jsonObj = { ...obj, ...{} };
