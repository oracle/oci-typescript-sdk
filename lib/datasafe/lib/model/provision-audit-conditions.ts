...
export namespace ProvisionAuditConditions {
  export function getJsonObj(obj: ProvisionAuditConditions): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: ProvisionAuditConditions): object {
    const jsonObj = {
      ...obj,
      ...{
        "enableConditions": obj.enableConditions
