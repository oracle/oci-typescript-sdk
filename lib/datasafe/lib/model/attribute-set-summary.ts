...
export namespace AttributeSetSummary {
  export enum InUse {
    Yes = "YES",
    No = "NO",
    /**
  ...
  export function getJsonObj(obj: AttributeSetSummary): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: AttributeSetSummary): object {
    const jsonObj = { ...obj, ...{} };
