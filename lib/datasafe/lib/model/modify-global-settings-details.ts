...
export namespace ModifyGlobalSettingsDetails {
  export function getJsonObj(obj: ModifyGlobalSettingsDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: ModifyGlobalSettingsDetails): object {
    const jsonObj = { ...obj, ...{} };
