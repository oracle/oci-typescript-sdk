...
export namespace CreateSecurityPolicyDeploymentDetails {
  export function getJsonObj(obj: CreateSecurityPolicyDeploymentDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: CreateSecurityPolicyDeploymentDetails): object {
    const jsonObj = { ...obj, ...{} };
