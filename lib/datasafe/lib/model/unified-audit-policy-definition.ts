...
export namespace UnifiedAuditPolicyDefinition {
  ...
  export function getJsonObj(obj: UnifiedAuditPolicyDefinition): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: UnifiedAuditPolicyDefinition): object {
    const jsonObj = { ...obj, ...{} };
