...
export namespace UpdateSecurityAssessmentDetails {
  export function getJsonObj(obj: UpdateSecurityAssessmentDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: UpdateSecurityAssessmentDetails): object {
    const jsonObj = { ...obj, ...{} };
