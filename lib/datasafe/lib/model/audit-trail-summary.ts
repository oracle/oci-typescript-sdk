...
export namespace AuditTrailSummary {
  export function getJsonObj(obj: AuditTrailSummary): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: AuditTrailSummary): object {
    const jsonObj = { ...obj, ...{} };
