 ...
 */
export interface TargetAlertPolicyUnassociatedSummary {
  /**
...
export namespace TargetAlertPolicyUnassociatedSummary {
  export function getJsonObj(obj: TargetAlertPolicyUnassociatedSummary): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: TargetAlertPolicyUnassociatedSummary): object {
    const jsonObj = { ...obj, ...{} };
