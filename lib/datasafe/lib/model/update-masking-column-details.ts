...
export namespace UpdateMaskingColumnDetails {
  export function getJsonObj(obj: UpdateMaskingColumnDetails): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: UpdateMaskingColumnDetails): object {
    const jsonObj = {
      ...obj,
      ...{
        "maskingFormats": obj.maskingFormats
