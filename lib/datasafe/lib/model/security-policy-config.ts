...
export namespace SecurityPolicyConfig {
  export function getJsonObj(obj: SecurityPolicyConfig): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: SecurityPolicyConfig): object {
    const jsonObj = {
      ...obj,
      ...{
        "firewallConfig": obj.firewallConfig
