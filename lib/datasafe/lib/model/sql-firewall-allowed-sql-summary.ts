...
export namespace SqlFirewallAllowedSqlSummary {
  ...
  export function getJsonObj(obj: SqlFirewallAllowedSqlSummary): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: SqlFirewallAllowedSqlSummary): object {
    const jsonObj = { ...obj, ...{} };
