...
export namespace SensitiveTypeGroup {
  export function getJsonObj(obj: SensitiveTypeGroup): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: SensitiveTypeGroup): object {
    const jsonObj = { ...obj, ...{} };
