...
export namespace AuditConditions {
  export function getJsonObj(obj: AuditConditions): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: AuditConditions): object {
    const jsonObj = {
      ...obj,
      ...{
        "enableConditions": obj.enableConditions
