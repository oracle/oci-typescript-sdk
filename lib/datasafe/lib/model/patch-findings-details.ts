...
export namespace PatchFindingsDetails {
  export function getJsonObj(obj: PatchFindingsDetails): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
  ...
  export function getDeserializedJsonObj(obj: PatchFindingsDetails): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
