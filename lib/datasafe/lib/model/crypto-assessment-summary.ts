 ...
 */
export interface CryptoAssessmentSummary {
  /**
...
export namespace CryptoAssessmentSummary {
  export function getJsonObj(obj: CryptoAssessmentSummary): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: CryptoAssessmentSummary): object {
    const jsonObj = { ...obj, ...{} };
