...
export namespace SecurityPolicyReportSummary {
  export function getJsonObj(obj: SecurityPolicyReportSummary): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: SecurityPolicyReportSummary): object {
    const jsonObj = { ...obj, ...{} };
