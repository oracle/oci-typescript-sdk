...
export namespace AuditPolicySummary {
  export function getJsonObj(obj: AuditPolicySummary): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: AuditPolicySummary): object {
    const jsonObj = {
      ...obj,
      ...{
        "auditSpecifications": obj.auditSpecifications
