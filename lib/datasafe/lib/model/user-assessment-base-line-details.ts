...
export namespace UserAssessmentBaseLineDetails {
  export function getJsonObj(obj: UserAssessmentBaseLineDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: UserAssessmentBaseLineDetails): object {
    const jsonObj = { ...obj, ...{} };
