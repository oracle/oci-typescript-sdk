...
export namespace CreateMaskingColumnDetails {
  export function getJsonObj(obj: CreateMaskingColumnDetails): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: CreateMaskingColumnDetails): object {
    const jsonObj = {
      ...obj,
      ...{
        "maskingFormats": obj.maskingFormats
