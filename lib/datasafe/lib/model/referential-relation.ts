...
export namespace ReferentialRelation {
  ...
  export function getJsonObj(obj: ReferentialRelation): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: ReferentialRelation): object {
    const jsonObj = {
      ...obj,
      ...{
