...
export namespace AssociatedResourceCollection {
  export function getJsonObj(obj: AssociatedResourceCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
  ...
  export function getDeserializedJsonObj(obj: AssociatedResourceCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
