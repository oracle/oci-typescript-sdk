...
export namespace RandomDecimalNumberFormatEntry {
  export function getJsonObj(
    obj: RandomDecimalNumberFormatEntry,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.FormatEntry.getJsonObj(obj) as RandomDecimalNumberFormatEntry)),
      ...{}
    };

    return jsonObj;
  }
  export const type = "RANDOM_DECIMAL_NUMBER";
  export function getDeserializedJsonObj(
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.FormatEntry.getDeserializedJsonObj(obj) as RandomDecimalNumberFormatEntry)),
      ...{}
    };
