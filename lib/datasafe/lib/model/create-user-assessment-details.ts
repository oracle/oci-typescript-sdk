...
export namespace CreateUserAssessmentDetails {
  export function getJsonObj(obj: CreateUserAssessmentDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: CreateUserAssessmentDetails): object {
    const jsonObj = { ...obj, ...{} };
