...
export namespace UpdateSensitiveColumnDetails {
  export enum Status {
    Valid = "VALID",
    Invalid = "INVALID"
  }
  ...
  export function getJsonObj(obj: UpdateSensitiveColumnDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: UpdateSensitiveColumnDetails): object {
    const jsonObj = { ...obj, ...{} };
