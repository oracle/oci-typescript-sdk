...
export namespace CalculateAuditVolumeCollectedDetails {
  export function getJsonObj(obj: CalculateAuditVolumeCollectedDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: CalculateAuditVolumeCollectedDetails): object {
    const jsonObj = { ...obj, ...{} };
