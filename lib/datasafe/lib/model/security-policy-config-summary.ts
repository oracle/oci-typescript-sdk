...
export namespace SecurityPolicyConfigSummary {
  export function getJsonObj(obj: SecurityPolicyConfigSummary): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: SecurityPolicyConfigSummary): object {
    const jsonObj = {
      ...obj,
      ...{
        "firewallConfig": obj.firewallConfig
