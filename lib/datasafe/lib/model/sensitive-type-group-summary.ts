...
export namespace SensitiveTypeGroupSummary {
  export function getJsonObj(obj: SensitiveTypeGroupSummary): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: SensitiveTypeGroupSummary): object {
    const jsonObj = { ...obj, ...{} };
