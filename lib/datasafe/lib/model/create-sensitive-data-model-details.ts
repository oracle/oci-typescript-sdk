...
export namespace CreateSensitiveDataModelDetails {
  export function getJsonObj(obj: CreateSensitiveDataModelDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: CreateSensitiveDataModelDetails): object {
    const jsonObj = { ...obj, ...{} };
