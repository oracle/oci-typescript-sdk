...
export namespace ProfileAggregation {
  export function getJsonObj(obj: ProfileAggregation): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: ProfileAggregation): object {
    const jsonObj = { ...obj, ...{} };
