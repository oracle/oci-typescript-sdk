...
export namespace SecurityPolicyReport {
  export function getJsonObj(obj: SecurityPolicyReport): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: SecurityPolicyReport): object {
    const jsonObj = { ...obj, ...{} };
