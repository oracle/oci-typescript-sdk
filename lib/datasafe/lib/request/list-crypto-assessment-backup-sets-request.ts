...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/datasafe/ListCryptoAssessmentBackupSets.ts.html |here} to see how to use ListCryptoAssessmentBackupSetsRequest.
 */
export interface ListCryptoAssessmentBackupSetsRequest extends common.BaseRequest {
  /**
...
export namespace ListCryptoAssessmentBackupSetsRequest {
