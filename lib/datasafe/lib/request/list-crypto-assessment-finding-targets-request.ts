...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/datasafe/ListCryptoAssessmentFindingTargets.ts.html |here} to see how to use ListCryptoAssessmentFindingTargetsRequest.
 */
export interface ListCryptoAssessmentFindingTargetsRequest extends common.BaseRequest {
  /**
...
export namespace ListCryptoAssessmentFindingTargetsRequest {
  export enum SortBy {
    TargetId = "targetId",
