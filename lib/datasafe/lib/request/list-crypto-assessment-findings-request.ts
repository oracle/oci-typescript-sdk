...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/datasafe/ListCryptoAssessmentFindings.ts.html |here} to see how to use ListCryptoAssessmentFindingsRequest.
 */
export interface ListCryptoAssessmentFindingsRequest extends common.BaseRequest {
  /**
