...
export namespace CreateCategoryDetails {
  export function getJsonObj(obj: CreateCategoryDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: CreateCategoryDetails): object {
    const jsonObj = { ...obj, ...{} };
