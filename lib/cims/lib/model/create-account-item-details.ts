...
export namespace CreateAccountItemDetails {
  export function getJsonObj(obj: CreateAccountItemDetails, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.CreateItemDetails.getJsonObj(obj) as CreateAccountItemDetails)),
      ...{}
    };
  ...
  export function getDeserializedJsonObj(
    obj: CreateAccountItemDetails,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.CreateItemDetails.getDeserializedJsonObj(obj) as CreateAccountItemDetails)),
      ...{}
    };
