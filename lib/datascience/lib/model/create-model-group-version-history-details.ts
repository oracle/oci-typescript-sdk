...
export namespace CreateModelGroupVersionHistoryDetails {
  export function getJsonObj(obj: CreateModelGroupVersionHistoryDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: CreateModelGroupVersionHistoryDetails): object {
    const jsonObj = { ...obj, ...{} };
