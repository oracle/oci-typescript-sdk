...
export namespace PipelineRunSummary {
  export function getJsonObj(obj: PipelineRunSummary): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: PipelineRunSummary): object {
    const jsonObj = { ...obj, ...{} };
