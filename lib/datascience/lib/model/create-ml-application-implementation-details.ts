...
export namespace CreateMlApplicationImplementationDetails {
  export function getJsonObj(obj: CreateMlApplicationImplementationDetails): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: CreateMlApplicationImplementationDetails): object {
    const jsonObj = {
      ...obj,
      ...{
        "logging": obj.logging
