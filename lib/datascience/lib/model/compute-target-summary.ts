...
export namespace ComputeTargetSummary {
  export function getJsonObj(obj: ComputeTargetSummary): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: ComputeTargetSummary): object {
    const jsonObj = { ...obj, ...{} };
