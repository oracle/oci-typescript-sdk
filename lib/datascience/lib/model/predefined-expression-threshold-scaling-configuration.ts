 ...
 *
 */
export interface PredefinedExpressionThresholdScalingConfiguration
  extends model.ScalingConfiguration {
  /**
...
export namespace PredefinedExpressionThresholdScalingConfiguration {
  export function getJsonObj(
    obj: PredefinedExpressionThresholdScalingConfiguration,
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ...
        : (model.ScalingConfiguration.getJsonObj(
            obj
          ) as PredefinedExpressionThresholdScalingConfiguration)),
      ...{}
    };
