...
export namespace PatchInstruction {
  export function getJsonObj(obj: PatchInstruction): object {
    ...
    if (obj && "operation" in obj && obj.operation) {
      switch (obj.operation) {
        case "REMOVE":
          return model.PatchRemoveMemberModels.getJsonObj(
            <model.PatchRemoveMemberModels>(<object>jsonObj),
            true
          );
        case "INSERT":
          return model.PatchInsertNewMemberModels.getJsonObj(
            <model.PatchInsertNewMemberModels>(<object>jsonObj),
            true
          );
        default:
  ...
  export function getDeserializedJsonObj(obj: PatchInstruction): object {
    ...
    if (obj && "operation" in obj && obj.operation) {
      switch (obj.operation) {
        case "REMOVE":
          return model.PatchRemoveMemberModels.getDeserializedJsonObj(
            <model.PatchRemoveMemberModels>(<object>jsonObj),
            true
          );
        case "INSERT":
          return model.PatchInsertNewMemberModels.getDeserializedJsonObj(
            <model.PatchInsertNewMemberModels>(<object>jsonObj),
            true
          );
        default:
