 ...
 */
export interface FileStorageMountConfigurationDetails
...
export namespace FileStorageMountConfigurationDetails {
  export function getJsonObj(
    obj: FileStorageMountConfigurationDetails,
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ...
        : (model.StorageMountConfigurationDetails.getJsonObj(
            obj
          ) as FileStorageMountConfigurationDetails)),
      ...{}
    };

    return jsonObj;
  }
  export const storageType = "FILE_STORAGE";
