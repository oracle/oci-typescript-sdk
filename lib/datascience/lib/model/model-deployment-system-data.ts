...
export namespace ModelDeploymentSystemData {
  export function getJsonObj(obj: ModelDeploymentSystemData): object {
    const jsonObj = { ...obj, ...{} };
  ...
  export function getDeserializedJsonObj(obj: ModelDeploymentSystemData): object {
    const jsonObj = { ...obj, ...{} };
