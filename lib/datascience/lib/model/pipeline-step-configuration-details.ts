...
export namespace PipelineStepConfigurationDetails {
  export function getJsonObj(obj: PipelineStepConfigurationDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: PipelineStepConfigurationDetails): object {
    const jsonObj = { ...obj, ...{} };
