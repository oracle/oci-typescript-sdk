...
export namespace MlApplicationInstanceViewCollection {
  export function getJsonObj(obj: MlApplicationInstanceViewCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
  ...
  export function getDeserializedJsonObj(obj: MlApplicationInstanceViewCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
