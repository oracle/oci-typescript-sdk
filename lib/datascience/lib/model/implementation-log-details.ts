...
export namespace ImplementationLogDetails {
  export function getJsonObj(obj: ImplementationLogDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: ImplementationLogDetails): object {
    const jsonObj = { ...obj, ...{} };
