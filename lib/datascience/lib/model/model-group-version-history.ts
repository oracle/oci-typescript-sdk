...
export namespace ModelGroupVersionHistory {
  export function getJsonObj(obj: ModelGroupVersionHistory): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: ModelGroupVersionHistory): object {
    const jsonObj = { ...obj, ...{} };
