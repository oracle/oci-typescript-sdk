...
export namespace ScheduleLogDetails {
  export function getJsonObj(obj: ScheduleLogDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: ScheduleLogDetails): object {
    const jsonObj = { ...obj, ...{} };
