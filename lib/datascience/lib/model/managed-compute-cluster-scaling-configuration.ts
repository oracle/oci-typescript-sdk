...
export namespace ManagedComputeClusterScalingConfiguration {
  export function getJsonObj(obj: ManagedComputeClusterScalingConfiguration): object {
    const jsonObj = { ...obj, ...{} };

    if (obj && "scalingConfigurationType" in obj && obj.scalingConfigurationType) {
      switch (obj.scalingConfigurationType) {
        case "QUERY":
          return model.ManagedComputeClusterCustomExpressionQueryScalingConfiguration.getJsonObj(
            <model.ManagedComputeClusterCustomExpressionQueryScalingConfiguration>(<object>jsonObj),
            true
          );
        case "THRESHOLD":
          return model.ManagedComputeClusterPredefinedExpressionThresholdScalingConfiguration.getJsonObj(
  ...
  export function getDeserializedJsonObj(obj: ManagedComputeClusterScalingConfiguration): object {
    const jsonObj = { ...obj, ...{} };

    if (obj && "scalingConfigurationType" in obj && obj.scalingConfigurationType) {
      switch (obj.scalingConfigurationType) {
        case "QUERY":
          return model.ManagedComputeClusterCustomExpressionQueryScalingConfiguration.getDeserializedJsonObj(
            <model.ManagedComputeClusterCustomExpressionQueryScalingConfiguration>(<object>jsonObj),
            true
          );
        case "THRESHOLD":
          return model.ManagedComputeClusterPredefinedExpressionThresholdScalingConfiguration.getDeserializedJsonObj(
            <model.ManagedComputeClusterPredefinedExpressionThresholdScalingConfiguration>(
              (<object>jsonObj)
            ),
            true
