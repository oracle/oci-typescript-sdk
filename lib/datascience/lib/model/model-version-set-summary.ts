...
export namespace ModelVersionSetSummary {
  export function getJsonObj(obj: ModelVersionSetSummary): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: ModelVersionSetSummary): object {
    const jsonObj = { ...obj, ...{} };
