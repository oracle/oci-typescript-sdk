...
export namespace ModelGroupSummary {
  export function getJsonObj(obj: ModelGroupSummary): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: ModelGroupSummary): object {
    const jsonObj = {
      ...obj,
      ...{
        "modelGroupDetails": obj.modelGroupDetails
