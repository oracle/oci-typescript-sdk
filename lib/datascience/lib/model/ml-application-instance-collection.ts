...
export namespace MlApplicationInstanceCollection {
  export function getJsonObj(obj: MlApplicationInstanceCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
  ...
  export function getDeserializedJsonObj(obj: MlApplicationInstanceCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
