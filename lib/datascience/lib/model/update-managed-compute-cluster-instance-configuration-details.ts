...
export namespace UpdateManagedComputeClusterInstanceConfigurationDetails {
  export function getJsonObj(obj: UpdateManagedComputeClusterInstanceConfigurationDetails): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(
    obj: UpdateManagedComputeClusterInstanceConfigurationDetails
  ): object {
    const jsonObj = {
      ...obj,
      ...{
