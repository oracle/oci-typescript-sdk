...
export namespace MlApplicationImplementationVersion {
  ...
  export function getJsonObj(obj: MlApplicationImplementationVersion): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: MlApplicationImplementationVersion): object {
    const jsonObj = {
      ...obj,
      ...{
        "applicationComponents": obj.applicationComponents
