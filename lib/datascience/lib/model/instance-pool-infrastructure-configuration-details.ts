 ...
 */
export interface InstancePoolInfrastructureConfigurationDetails
  extends model.InfrastructureConfigurationDetails {
...
export namespace InstancePoolInfrastructureConfigurationDetails {
  export function getJsonObj(
    obj: InstancePoolInfrastructureConfigurationDetails,
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ...
        : (model.InfrastructureConfigurationDetails.getJsonObj(
            obj
          ) as InstancePoolInfrastructureConfigurationDetails)),
      ...{
