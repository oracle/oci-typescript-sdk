...
export namespace MlApplicationImplementationSummary {
  export function getJsonObj(obj: MlApplicationImplementationSummary): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: MlApplicationImplementationSummary): object {
    const jsonObj = {
      ...obj,
      ...{
        "configurationSchema": obj.configurationSchema
