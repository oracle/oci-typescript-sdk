...
export namespace MlApplicationInstance {
  ...
  export function getJsonObj(obj: MlApplicationInstance): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: MlApplicationInstance): object {
    const jsonObj = {
      ...obj,
      ...{
        "authConfiguration": obj.authConfiguration
