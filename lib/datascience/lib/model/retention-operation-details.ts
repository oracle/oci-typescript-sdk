...
export namespace RetentionOperationDetails {
  export function getJsonObj(obj: RetentionOperationDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: RetentionOperationDetails): object {
    const jsonObj = { ...obj, ...{} };
