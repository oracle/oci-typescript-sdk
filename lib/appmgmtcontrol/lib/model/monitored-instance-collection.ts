...
export namespace MonitoredInstanceCollection {
  export function getJsonObj(obj: MonitoredInstanceCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
  ...
  export function getDeserializedJsonObj(obj: MonitoredInstanceCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
