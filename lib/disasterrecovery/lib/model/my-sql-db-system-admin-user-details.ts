...
export namespace MySqlDbSystemAdminUserDetails {
  export function getJsonObj(obj: MySqlDbSystemAdminUserDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: MySqlDbSystemAdminUserDetails): object {
    const jsonObj = { ...obj, ...{} };
