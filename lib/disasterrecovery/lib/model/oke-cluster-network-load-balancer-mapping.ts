...
export namespace OkeClusterNetworkLoadBalancerMapping {
  export function getJsonObj(obj: OkeClusterNetworkLoadBalancerMapping): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: OkeClusterNetworkLoadBalancerMapping): object {
    const jsonObj = { ...obj, ...{} };
