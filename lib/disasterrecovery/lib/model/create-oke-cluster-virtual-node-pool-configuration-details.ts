...
export namespace CreateOkeClusterVirtualNodePoolConfigurationDetails {
  export function getJsonObj(obj: CreateOkeClusterVirtualNodePoolConfigurationDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(
    obj: CreateOkeClusterVirtualNodePoolConfigurationDetails
  ): object {
    const jsonObj = { ...obj, ...{} };
