 ...
 */
export interface AutomaticDrConfigurationMemberDatabase
...
export namespace AutomaticDrConfigurationMemberDatabase {
  export function getJsonObj(
    obj: AutomaticDrConfigurationMemberDatabase,
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ...
        : (model.AutomaticDrConfigurationMember.getJsonObj(
            obj
          ) as AutomaticDrConfigurationMemberDatabase)),
      ...{}
    };
