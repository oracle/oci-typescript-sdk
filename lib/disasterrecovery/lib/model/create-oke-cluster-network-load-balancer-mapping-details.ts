...
export namespace CreateOkeClusterNetworkLoadBalancerMappingDetails {
  export function getJsonObj(obj: CreateOkeClusterNetworkLoadBalancerMappingDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(
    obj: CreateOkeClusterNetworkLoadBalancerMappingDetails
  ): object {
    const jsonObj = { ...obj, ...{} };
