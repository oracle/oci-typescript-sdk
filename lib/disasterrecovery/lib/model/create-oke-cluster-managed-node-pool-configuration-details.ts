...
export namespace CreateOkeClusterManagedNodePoolConfigurationDetails {
  export function getJsonObj(obj: CreateOkeClusterManagedNodePoolConfigurationDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(
    obj: CreateOkeClusterManagedNodePoolConfigurationDetails
  ): object {
    const jsonObj = { ...obj, ...{} };
