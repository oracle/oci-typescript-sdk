...
export namespace FailoverPrecheckExecutionOptions {
  export function getJsonObj(
    obj: FailoverPrecheckExecutionOptions,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.DrPlanExecutionOptions.getJsonObj(obj) as FailoverPrecheckExecutionOptions)),
      ...{}
    };

    return jsonObj;
  }
  export const planExecutionType = "FAILOVER_PRECHECK";
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ...
        : (model.DrPlanExecutionOptions.getDeserializedJsonObj(
            obj
          ) as FailoverPrecheckExecutionOptions)),
      ...{}
    };
