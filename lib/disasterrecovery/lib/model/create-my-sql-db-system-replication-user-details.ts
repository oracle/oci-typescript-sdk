...
export namespace CreateMySqlDbSystemReplicationUserDetails {
  export function getJsonObj(obj: CreateMySqlDbSystemReplicationUserDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: CreateMySqlDbSystemReplicationUserDetails): object {
    const jsonObj = { ...obj, ...{} };
