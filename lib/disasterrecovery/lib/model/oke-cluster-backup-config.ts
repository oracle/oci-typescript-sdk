...
export namespace OkeClusterBackupConfig {
  export function getJsonObj(obj: OkeClusterBackupConfig): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: OkeClusterBackupConfig): object {
    const jsonObj = { ...obj, ...{} };
