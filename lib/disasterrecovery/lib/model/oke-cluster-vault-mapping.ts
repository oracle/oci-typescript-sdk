...
export namespace OkeClusterVaultMapping {
  export function getJsonObj(obj: OkeClusterVaultMapping): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: OkeClusterVaultMapping): object {
    const jsonObj = { ...obj, ...{} };
