...
export namespace UpdateMySqlDbSystemAdminUserDetails {
  export function getJsonObj(obj: UpdateMySqlDbSystemAdminUserDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: UpdateMySqlDbSystemAdminUserDetails): object {
    const jsonObj = { ...obj, ...{} };
