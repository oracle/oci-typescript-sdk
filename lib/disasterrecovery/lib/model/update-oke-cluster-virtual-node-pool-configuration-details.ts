...
export namespace UpdateOkeClusterVirtualNodePoolConfigurationDetails {
  export function getJsonObj(obj: UpdateOkeClusterVirtualNodePoolConfigurationDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(
    obj: UpdateOkeClusterVirtualNodePoolConfigurationDetails
  ): object {
    const jsonObj = { ...obj, ...{} };
