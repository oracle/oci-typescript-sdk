...
export namespace ObjectStorageScriptLocation {
  export function getJsonObj(obj: ObjectStorageScriptLocation): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: ObjectStorageScriptLocation): object {
    const jsonObj = { ...obj, ...{} };
