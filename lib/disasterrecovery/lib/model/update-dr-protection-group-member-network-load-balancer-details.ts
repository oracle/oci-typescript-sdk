 ...
 */
export interface UpdateDrProtectionGroupMemberNetworkLoadBalancerDetails
...
export namespace UpdateDrProtectionGroupMemberNetworkLoadBalancerDetails {
  export function getJsonObj(
    obj: UpdateDrProtectionGroupMemberNetworkLoadBalancerDetails,
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ...
        : (model.UpdateDrProtectionGroupMemberDetails.getJsonObj(
            obj
          ) as UpdateDrProtectionGroupMemberNetworkLoadBalancerDetails)),
      ...{
