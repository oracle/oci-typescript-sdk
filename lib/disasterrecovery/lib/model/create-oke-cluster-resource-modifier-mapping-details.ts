...
export namespace CreateOkeClusterResourceModifierMappingDetails {
  export function getJsonObj(obj: CreateOkeClusterResourceModifierMappingDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(
    obj: CreateOkeClusterResourceModifierMappingDetails
  ): object {
    const jsonObj = { ...obj, ...{} };
