...
export namespace AutomaticExecutionDetails {
  export function getJsonObj(obj: AutomaticExecutionDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: AutomaticExecutionDetails): object {
    const jsonObj = { ...obj, ...{} };
