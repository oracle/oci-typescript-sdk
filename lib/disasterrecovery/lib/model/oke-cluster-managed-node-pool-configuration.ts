...
export namespace OkeClusterManagedNodePoolConfiguration {
  export function getJsonObj(obj: OkeClusterManagedNodePoolConfiguration): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: OkeClusterManagedNodePoolConfiguration): object {
    const jsonObj = { ...obj, ...{} };
