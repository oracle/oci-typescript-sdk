...
export namespace DrPlanExecutionSuccessfulStepStatusCounts {
  export function getJsonObj(obj: DrPlanExecutionSuccessfulStepStatusCounts): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: DrPlanExecutionSuccessfulStepStatusCounts): object {
    const jsonObj = { ...obj, ...{} };
