...
export namespace ComputeInstanceMovableFileSystemOperation {
  export function getJsonObj(obj: ComputeInstanceMovableFileSystemOperation): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: ComputeInstanceMovableFileSystemOperation): object {
    const jsonObj = {
      ...obj,
      ...{
        "mountDetails": obj.mountDetails
