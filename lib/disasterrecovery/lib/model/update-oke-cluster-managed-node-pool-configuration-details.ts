...
export namespace UpdateOkeClusterManagedNodePoolConfigurationDetails {
  export function getJsonObj(obj: UpdateOkeClusterManagedNodePoolConfigurationDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(
    obj: UpdateOkeClusterManagedNodePoolConfigurationDetails
  ): object {
    const jsonObj = { ...obj, ...{} };
