...
export namespace AutomaticDrConfiguration {
  export function getJsonObj(obj: AutomaticDrConfiguration): object {
    const jsonObj = {
      ...obj,
      ...{
        "members": obj.members
  ...
  export function getDeserializedJsonObj(obj: AutomaticDrConfiguration): object {
    const jsonObj = {
      ...obj,
      ...{
        "members": obj.members
