...
export namespace UpdateOkeBackupLocationDetails {
  export function getJsonObj(obj: UpdateOkeBackupLocationDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: UpdateOkeBackupLocationDetails): object {
    const jsonObj = { ...obj, ...{} };
