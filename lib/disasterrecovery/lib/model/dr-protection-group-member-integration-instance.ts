...
export namespace DrProtectionGroupMemberIntegrationInstance {
  export function getJsonObj(
    obj: DrProtectionGroupMemberIntegrationInstance,
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ...
        : (model.DrProtectionGroupMember.getJsonObj(
            obj
          ) as DrProtectionGroupMemberIntegrationInstance)),
      ...{}
    };
