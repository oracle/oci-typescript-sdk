...
export namespace DrPlanExecutionWarningStepStatusCounts {
  export function getJsonObj(obj: DrPlanExecutionWarningStepStatusCounts): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: DrPlanExecutionWarningStepStatusCounts): object {
    const jsonObj = { ...obj, ...{} };
