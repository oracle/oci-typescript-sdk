...
export namespace CreateMySqlDbSystemAdminUserDetails {
  export function getJsonObj(obj: CreateMySqlDbSystemAdminUserDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: CreateMySqlDbSystemAdminUserDetails): object {
    const jsonObj = { ...obj, ...{} };
