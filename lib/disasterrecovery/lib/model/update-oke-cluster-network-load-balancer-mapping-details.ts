...
export namespace UpdateOkeClusterNetworkLoadBalancerMappingDetails {
  export function getJsonObj(obj: UpdateOkeClusterNetworkLoadBalancerMappingDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(
    obj: UpdateOkeClusterNetworkLoadBalancerMappingDetails
  ): object {
    const jsonObj = { ...obj, ...{} };
