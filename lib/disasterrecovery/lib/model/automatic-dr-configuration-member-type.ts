 ...
 *
 **/
export enum AutomaticDrConfigurationMemberType {
  Database = "DATABASE",
...
export namespace AutomaticDrConfigurationMemberType {
  export function getJsonObj(
    obj: AutomaticDrConfigurationMemberType
  ): AutomaticDrConfigurationMemberType {
    return obj;
  }
