...
export namespace UpdateDrProtectionGroupMemberDatabaseDetails {
  export function getJsonObj(
    obj: UpdateDrProtectionGroupMemberDatabaseDetails,
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ...
        : (model.UpdateDrProtectionGroupMemberDetails.getJsonObj(
            obj
          ) as UpdateDrProtectionGroupMemberDatabaseDetails)),
      ...{}
    };
