 ...
 */
export interface UpdateDrProtectionGroupMemberAutonomousDatabaseDetails
  extends model.UpdateDrProtectionGroupMemberDetails {
  "memberType": string;
}

export namespace UpdateDrProtectionGroupMemberAutonomousDatabaseDetails {
  export function getJsonObj(
    obj: UpdateDrProtectionGroupMemberAutonomousDatabaseDetails,
