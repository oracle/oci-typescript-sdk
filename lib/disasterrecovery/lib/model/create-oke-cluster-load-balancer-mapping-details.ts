...
export namespace CreateOkeClusterLoadBalancerMappingDetails {
  export function getJsonObj(obj: CreateOkeClusterLoadBalancerMappingDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: CreateOkeClusterLoadBalancerMappingDetails): object {
    const jsonObj = { ...obj, ...{} };
