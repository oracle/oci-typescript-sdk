 ...
 *
 */
export interface UpdateRunLocalScriptUserDefinedCustomPrecheckStepDetails
...
export namespace UpdateRunLocalScriptUserDefinedCustomPrecheckStepDetails {
  export function getJsonObj(
    obj: UpdateRunLocalScriptUserDefinedCustomPrecheckStepDetails,
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ...
        : (model.UpdateDrPlanUserDefinedStepDetails.getJsonObj(
            obj
          ) as UpdateRunLocalScriptUserDefinedCustomPrecheckStepDetails)),
      ...{}
    };

    return jsonObj;
  }
  export const stepType = "RUN_LOCAL_SCRIPT_USER_DEFINED_CUSTOM_PRECHECK";
