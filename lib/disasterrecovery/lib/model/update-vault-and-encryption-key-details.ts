...
export namespace UpdateVaultAndEncryptionKeyDetails {
  export function getJsonObj(obj: UpdateVaultAndEncryptionKeyDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: UpdateVaultAndEncryptionKeyDetails): object {
    const jsonObj = { ...obj, ...{} };
