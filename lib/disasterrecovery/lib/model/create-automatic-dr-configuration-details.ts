...
export namespace CreateAutomaticDrConfigurationDetails {
  export function getJsonObj(obj: CreateAutomaticDrConfigurationDetails): object {
    const jsonObj = {
      ...obj,
      ...{
        "members": obj.members
  ...
  export function getDeserializedJsonObj(obj: CreateAutomaticDrConfigurationDetails): object {
    const jsonObj = {
      ...obj,
      ...{
        "members": obj.members
