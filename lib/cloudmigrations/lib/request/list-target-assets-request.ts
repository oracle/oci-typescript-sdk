...
/**
 * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/cloudmigrations/ListTargetAssets.ts.html |here} to see how to use ListTargetAssetsRequest.
 */
...
export namespace ListTargetAssetsRequest {
  export enum SortBy {
