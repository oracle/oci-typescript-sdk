...
/**
 * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/cloudmigrations/ListMigrationPlans.ts.html |here} to see how to use ListMigrationPlansRequest.
 */
...
export namespace ListMigrationPlansRequest {
  export enum SortBy {
