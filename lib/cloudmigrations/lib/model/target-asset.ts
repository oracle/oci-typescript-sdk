  ...
  export function getJsonObj(obj: TargetAsset): object {
    ...
    if (obj && "type" in obj && obj.type) {
      switch (obj.type) {
        ...
        case "OLVM_INSTANCE":
          return model.OlvmTargetAsset.getJsonObj(<model.OlvmTargetAsset>(<object>jsonObj), true);
        default:
  ...
  export function getDeserializedJsonObj(obj: TargetAsset): object {
    ...
    if (obj && "type" in obj && obj.type) {
      switch (obj.type) {
        ...
        case "OLVM_INSTANCE":
          return model.OlvmTargetAsset.getDeserializedJsonObj(
            <model.OlvmTargetAsset>(<object>jsonObj),
            true
          );
        default:
          if (common.LOG.logger) common.LOG.logger.info(`Unknown value for: ${obj.type}`);
