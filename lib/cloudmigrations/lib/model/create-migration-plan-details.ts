...
export namespace CreateMigrationPlanDetails {
  export function getJsonObj(obj: CreateMigrationPlanDetails): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: CreateMigrationPlanDetails): object {
    const jsonObj = {
      ...obj,
      ...{
        "strategies": obj.strategies
