...
export namespace ChangeDiscoveryScheduleCompartmentDetails {
  export function getJsonObj(obj: ChangeDiscoveryScheduleCompartmentDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: ChangeDiscoveryScheduleCompartmentDetails): object {
    const jsonObj = { ...obj, ...{} };
