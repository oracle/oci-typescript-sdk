...
export namespace CreateReplicationScheduleDetails {
  export function getJsonObj(obj: CreateReplicationScheduleDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: CreateReplicationScheduleDetails): object {
    const jsonObj = { ...obj, ...{} };
