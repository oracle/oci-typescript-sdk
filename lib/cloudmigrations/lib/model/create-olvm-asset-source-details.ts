...
export namespace CreateOlvmAssetSourceDetails {
  export function getJsonObj(obj: CreateOlvmAssetSourceDetails, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.CreateAssetSourceDetails.getJsonObj(obj) as CreateOlvmAssetSourceDetails)),
      ...{
  ...
  export function getDeserializedJsonObj(
    obj: CreateOlvmAssetSourceDetails,
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ...
        : (model.CreateAssetSourceDetails.getDeserializedJsonObj(
            obj
          ) as CreateOlvmAssetSourceDetails)),
      ...{
        "discoveryCredentials": obj.discoveryCredentials
