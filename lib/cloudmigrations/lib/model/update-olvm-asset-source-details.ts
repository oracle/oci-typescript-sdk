...
export namespace UpdateOlvmAssetSourceDetails {
  export function getJsonObj(obj: UpdateOlvmAssetSourceDetails, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.UpdateAssetSourceDetails.getJsonObj(obj) as UpdateOlvmAssetSourceDetails)),
      ...{
  ...
  export function getDeserializedJsonObj(
    obj: UpdateOlvmAssetSourceDetails,
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ...
        : (model.UpdateAssetSourceDetails.getDeserializedJsonObj(
            obj
          ) as UpdateOlvmAssetSourceDetails)),
      ...{
        "discoveryCredentials": obj.discoveryCredentials
