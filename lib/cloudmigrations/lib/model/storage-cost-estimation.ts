...
export namespace StorageCostEstimation {
  export function getJsonObj(obj: StorageCostEstimation): object {
    const jsonObj = {
      ...obj,
      ...{
        "volumes": obj.volumes
  ...
  export function getDeserializedJsonObj(obj: StorageCostEstimation): object {
    const jsonObj = {
      ...obj,
      ...{
        "volumes": obj.volumes
