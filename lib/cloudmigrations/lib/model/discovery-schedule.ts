...
export namespace DiscoverySchedule {
  export function getJsonObj(obj: DiscoverySchedule): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: DiscoverySchedule): object {
    const jsonObj = { ...obj, ...{} };
