...
import * as bluegreendeployments_waiter from "./lib/bluegreendeployments-waiter";
...
export { requests };
export { responses };
export import BlueGreenDeploymentsClient = client.BlueGreenDeploymentsClient;
export import BlueGreenDeploymentsWaiter = bluegreendeployments_waiter.BlueGreenDeploymentsWaiter;
