...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/mysql/ListBlueGreenDeployments.ts.html |here} to see how to use ListBlueGreenDeploymentsRequest.
 */
export interface ListBlueGreenDeploymentsRequest extends common.BaseRequest {
  /**
...
export namespace ListBlueGreenDeploymentsRequest {
  export enum SortBy {
