...
export namespace MaintenanceScheduleType {
  export function getJsonObj(obj: MaintenanceScheduleType): MaintenanceScheduleType {
    return obj;
  }
  export function getDeserializedJsonObj(obj: MaintenanceScheduleType): MaintenanceScheduleType {
    return obj;
  }
}
