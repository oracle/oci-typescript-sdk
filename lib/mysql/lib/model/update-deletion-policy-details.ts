...
export namespace UpdateDeletionPolicyDetails {
  ...
  export function getJsonObj(obj: UpdateDeletionPolicyDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: UpdateDeletionPolicyDetails): object {
    const jsonObj = { ...obj, ...{} };
