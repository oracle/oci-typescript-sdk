...
export namespace MaintenanceDisabledWindow {
  export function getJsonObj(obj: MaintenanceDisabledWindow): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: MaintenanceDisabledWindow): object {
    const jsonObj = { ...obj, ...{} };
