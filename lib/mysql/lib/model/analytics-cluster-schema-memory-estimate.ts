 ...
 *
 */
export interface AnalyticsClusterSchemaMemoryEstimate {
  /**
   ...
   *
   */
  "perTableEstimates": Array<model.AnalyticsClusterTableMemoryEstimate>;
}

export namespace AnalyticsClusterSchemaMemoryEstimate {
  export function getJsonObj(obj: AnalyticsClusterSchemaMemoryEstimate): object {
    const jsonObj = {
      ...obj,
      ...{
        "perTableEstimates": obj.perTableEstimates
          ? obj.perTableEstimates.map(item => {
              return model.AnalyticsClusterTableMemoryEstimate.getJsonObj(item);
            })
          : undefined
      }
    };
