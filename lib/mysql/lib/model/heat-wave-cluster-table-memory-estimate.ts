...
export namespace HeatWaveClusterTableMemoryEstimate {
  export function getJsonObj(obj: HeatWaveClusterTableMemoryEstimate): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: HeatWaveClusterTableMemoryEstimate): object {
    const jsonObj = { ...obj, ...{} };
