 ...
 **/
export enum BlueGreenDeploymentSwitchoverStatus {
  NotStarted = "NOT_STARTED",
  Validating = "VALIDATING",
  ReplicatingData = "REPLICATING_DATA",
...
export namespace BlueGreenDeploymentSwitchoverStatus {
  export function getJsonObj(
    obj: BlueGreenDeploymentSwitchoverStatus
