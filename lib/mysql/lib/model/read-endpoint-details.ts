...
export namespace ReadEndpointDetails {
  export function getJsonObj(obj: ReadEndpointDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: ReadEndpointDetails): object {
    const jsonObj = { ...obj, ...{} };
