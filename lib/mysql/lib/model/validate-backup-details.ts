...
export namespace ValidateBackupDetails {
  export function getJsonObj(obj: ValidateBackupDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: ValidateBackupDetails): object {
    const jsonObj = { ...obj, ...{} };
