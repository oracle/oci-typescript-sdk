...
export namespace DbSystemSourceFromPitr {
  export function getJsonObj(obj: DbSystemSourceFromPitr, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj ? obj : (model.DbSystemSource.getJsonObj(obj) as DbSystemSourceFromPitr)),
      ...{}
    };
  ...
  export function getDeserializedJsonObj(
    obj: DbSystemSourceFromPitr,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.DbSystemSource.getDeserializedJsonObj(obj) as DbSystemSourceFromPitr)),
      ...{}
    };
