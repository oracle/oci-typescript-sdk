...
export namespace CreateRestDetails {
  export function getJsonObj(obj: CreateRestDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: CreateRestDetails): object {
    const jsonObj = { ...obj, ...{} };
