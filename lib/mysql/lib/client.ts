...
import { BlueGreenDeploymentsWaiter } from "./bluegreendeployments-waiter";
...
export class BlueGreenDeploymentsClient {
  ...
  public set endpoint(endpoint: string) {
    ...
    if (this.logger)
      this.logger.info(`BlueGreenDeploymentsClient endpoint set to ${this._endpoint}`);
  }
  ...
  public set useRealmSpecificEndpointTemplate(realmSpecificEndpointTemplateEnabled: boolean) {
    ...
    if (this._lastSetRegionOrRegionId === common.Region.REGION_STRING) {
      this.endpoint = common.EndpointBuilder.createEndpointFromRegion(
        BlueGreenDeploymentsClient.serviceEndpointTemplate,
        this._region,
        BlueGreenDeploymentsClient.endpointServiceName
      );
  ...
  /**
   * Creates a new BlueGreenDeploymentsWaiter for resources for this service.
   *
   * @param config The waiter configuration for termination and delay strategy
   * @return The service waiters.
   */
  public createWaiters(config?: common.WaiterConfiguration): BlueGreenDeploymentsWaiter {
    this._waiters = new BlueGreenDeploymentsWaiter(this, config);
   ...
   * @return The service waiters.
   */
  public getWaiters(): BlueGreenDeploymentsWaiter {
    if (this._waiters) {
      return this._waiters;
    }
   ...
   * @param ChangeBlueGreenDeploymentCompartmentRequest
   * @return ChangeBlueGreenDeploymentCompartmentResponse
   * @throws OciError when an error occurs
   * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/mysql/ChangeBlueGreenDeploymentCompartment.ts.html |here} to see how to use ChangeBlueGreenDeploymentCompartment API.
   */
  public async changeBlueGreenDeploymentCompartment(
    changeBlueGreenDeploymentCompartmentRequest: requests.ChangeBlueGreenDeploymentCompartmentRequest
  ): Promise<responses.ChangeBlueGreenDeploymentCompartmentResponse> {
    if (this.logger)
      this.logger.debug(
        "Calling operation BlueGreenDeploymentsClient#changeBlueGreenDeploymentCompartment."
      );
    const operationName = "changeBlueGreenDeploymentCompartment";
    const apiReferenceLink =
      "https://docs.oracle.com/iaas/api/#/en/mysql/20190415/BlueGreenDeployment/ChangeBlueGreenDeploymentCompartment";
    const pathParams = {
      "{blueGreenDeploymentId}": changeBlueGreenDeploymentCompartmentRequest.blueGreenDeploymentId
    };
    ...
    let headerParams = {
      ...
      "if-match": changeBlueGreenDeploymentCompartmentRequest.ifMatch,
      "opc-request-id": changeBlueGreenDeploymentCompartmentRequest.opcRequestId,
      "opc-retry-token": changeBlueGreenDeploymentCompartmentRequest.opcRetryToken
    };

    const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
    const retrier = GenericRetrier.createPreferredRetrier(
      this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined,
      changeBlueGreenDeploymentCompartmentRequest.retryConfiguration,
    ...
    const request = await composeRequest({
      ...
      path: "/blueGreenDeployments/{blueGreenDeploymentId}/actions/changeCompartment",
      method: "POST",
      bodyContent: common.ObjectSerializer.serialize(
        changeBlueGreenDeploymentCompartmentRequest.changeBlueGreenDeploymentCompartmentDetails,
        "ChangeBlueGreenDeploymentCompartmentDetails",
        model.ChangeBlueGreenDeploymentCompartmentDetails.getJsonObj
      ),
    ...
    try {
      ...
      const sdkResponse = composeResponse({
        responseObject: <responses.ChangeBlueGreenDeploymentCompartmentResponse>{},
        responseHeaders: [
          {
   ...
   * @throws OciError when an error occurs
   * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/mysql/CreateBlueGreenDeployment.ts.html |here} to see how to use CreateBlueGreenDeployment API.
   */
  public async createBlueGreenDeployment(
    createBlueGreenDeploymentRequest: requests.CreateBlueGreenDeploymentRequest
  ): Promise<responses.CreateBlueGreenDeploymentResponse> {
    if (this.logger)
      this.logger.debug("Calling operation BlueGreenDeploymentsClient#createBlueGreenDeployment.");
    const operationName = "createBlueGreenDeployment";
    const apiReferenceLink = "";
    const pathParams = {};
    ...
    let headerParams = {
      "Content-Type": common.Constants.APPLICATION_JSON,
      "opc-request-id": createBlueGreenDeploymentRequest.opcRequestId,
      "opc-retry-token": createBlueGreenDeploymentRequest.opcRetryToken
    };

    const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
    const retrier = GenericRetrier.createPreferredRetrier(
      this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined,
      createBlueGreenDeploymentRequest.retryConfiguration,
      specRetryConfiguration
    );
    if (this.logger) retrier.logger = this.logger;
    const request = await composeRequest({
      ...
      method: "POST",
      bodyContent: common.ObjectSerializer.serialize(
        createBlueGreenDeploymentRequest.createBlueGreenDeploymentDetails,
        "CreateBlueGreenDeploymentDetails",
        model.CreateBlueGreenDeploymentDetails.getJsonObj
      ),
      pathParams: pathParams,
      headerParams: headerParams,
      queryParams: queryParams
    ...
    try {
      ...
      const sdkResponse = composeResponse({
        responseObject: <responses.CreateBlueGreenDeploymentResponse>{},
        body: await response.json(),
        bodyKey: "blueGreenDeployment",
        bodyModel: model.BlueGreenDeployment,
        type: "model.BlueGreenDeployment",
        responseHeaders: [
          {
   ...
   * @throws OciError when an error occurs
   * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/mysql/DeleteBlueGreenDeployment.ts.html |here} to see how to use DeleteBlueGreenDeployment API.
   */
  public async deleteBlueGreenDeployment(
    deleteBlueGreenDeploymentRequest: requests.DeleteBlueGreenDeploymentRequest
  ): Promise<responses.DeleteBlueGreenDeploymentResponse> {
    if (this.logger)
      this.logger.debug("Calling operation BlueGreenDeploymentsClient#deleteBlueGreenDeployment.");
    const operationName = "deleteBlueGreenDeployment";
    const apiReferenceLink =
      "https://docs.oracle.com/iaas/api/#/en/mysql/20190415/BlueGreenDeployment/DeleteBlueGreenDeployment";
    const pathParams = {
      "{blueGreenDeploymentId}": deleteBlueGreenDeploymentRequest.blueGreenDeploymentId
    };
    ...
    let headerParams = {
      "Content-Type": common.Constants.APPLICATION_JSON,
      "if-match": deleteBlueGreenDeploymentRequest.ifMatch,
      "opc-request-id": deleteBlueGreenDeploymentRequest.opcRequestId
    };

    const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
    const retrier = GenericRetrier.createPreferredRetrier(
      this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined,
      deleteBlueGreenDeploymentRequest.retryConfiguration,
      specRetryConfiguration
    );
    if (this.logger) retrier.logger = this.logger;
    const request = await composeRequest({
      baseEndpoint: this._endpoint,
      defaultHeaders: this._defaultHeaders,
      path: "/blueGreenDeployments/{blueGreenDeploymentId}",
      method: "DELETE",
      pathParams: pathParams,
      headerParams: headerParams,
      queryParams: queryParams
    ...
    try {
      ...
      const sdkResponse = composeResponse({
        responseObject: <responses.DeleteBlueGreenDeploymentResponse>{},
        responseHeaders: [
          {
            value: response.headers.get("opc-request-id"),
            key: "opcRequestId",
   ...
   * This operation uses {@link common.OciSdkDefaultRetryConfiguration} by default if no retry configuration is defined by the user.
   * @param GetBlueGreenDeploymentRequest
   * @return GetBlueGreenDeploymentResponse
   * @throws OciError when an error occurs
   * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/mysql/GetBlueGreenDeployment.ts.html |here} to see how to use GetBlueGreenDeployment API.
   */
  public async getBlueGreenDeployment(
    getBlueGreenDeploymentRequest: requests.GetBlueGreenDeploymentRequest
  ): Promise<responses.GetBlueGreenDeploymentResponse> {
    if (this.logger)
      this.logger.debug("Calling operation BlueGreenDeploymentsClient#getBlueGreenDeployment.");
    const operationName = "getBlueGreenDeployment";
    const apiReferenceLink =
      "https://docs.oracle.com/iaas/api/#/en/mysql/20190415/BlueGreenDeployment/GetBlueGreenDeployment";
    const pathParams = {
      "{blueGreenDeploymentId}": getBlueGreenDeploymentRequest.blueGreenDeploymentId
    };
    ...
    let headerParams = {
      "Content-Type": common.Constants.APPLICATION_JSON,
      "opc-request-id": getBlueGreenDeploymentRequest.opcRequestId,
      "if-none-match": getBlueGreenDeploymentRequest.ifNoneMatch
    };

    const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
    const retrier = GenericRetrier.createPreferredRetrier(
      this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined,
      getBlueGreenDeploymentRequest.retryConfiguration,
      specRetryConfiguration
    );
    if (this.logger) retrier.logger = this.logger;
    const request = await composeRequest({
    ...
    try {
      ...
      const sdkResponse = composeResponse({
        responseObject: <responses.GetBlueGreenDeploymentResponse>{},
        body: await response.json(),
        bodyKey: "blueGreenDeployment",
        bodyModel: model.BlueGreenDeployment,
        type: "model.BlueGreenDeployment",
   ...
   * This operation uses {@link common.OciSdkDefaultRetryConfiguration} by default if no retry configuration is defined by the user.
   * @param ListBlueGreenDeploymentsRequest
   * @return ListBlueGreenDeploymentsResponse
   * @throws OciError when an error occurs
   * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/mysql/ListBlueGreenDeployments.ts.html |here} to see how to use ListBlueGreenDeployments API.
   */
  public async listBlueGreenDeployments(
    listBlueGreenDeploymentsRequest: requests.ListBlueGreenDeploymentsRequest
  ): Promise<responses.ListBlueGreenDeploymentsResponse> {
    if (this.logger)
      this.logger.debug("Calling operation BlueGreenDeploymentsClient#listBlueGreenDeployments.");
    const operationName = "listBlueGreenDeployments";
    const apiReferenceLink =
      "https://docs.oracle.com/iaas/api/#/en/mysql/20190415/BlueGreenDeploymentCollection/ListBlueGreenDeployments";
    const pathParams = {};

    const queryParams = {
      "compartmentId": listBlueGreenDeploymentsRequest.compartmentId,
      "limit": listBlueGreenDeploymentsRequest.limit,
      "page": listBlueGreenDeploymentsRequest.page,
      "sourceDbSystemId": listBlueGreenDeploymentsRequest.sourceDbSystemId,
      "targetDbSystemId": listBlueGreenDeploymentsRequest.targetDbSystemId,
      "displayName": listBlueGreenDeploymentsRequest.displayName,
      "lifecycleState": listBlueGreenDeploymentsRequest.lifecycleState,
      "sortBy": listBlueGreenDeploymentsRequest.sortBy,
      "sortOrder": listBlueGreenDeploymentsRequest.sortOrder
    };

    let headerParams = {
      "Content-Type": common.Constants.APPLICATION_JSON,
      "opc-request-id": listBlueGreenDeploymentsRequest.opcRequestId
    };

    const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
    const retrier = GenericRetrier.createPreferredRetrier(
      this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined,
      listBlueGreenDeploymentsRequest.retryConfiguration,
      specRetryConfiguration
    );
    if (this.logger) retrier.logger = this.logger;
    const request = await composeRequest({
    ...
    try {
      ...
      const sdkResponse = composeResponse({
        responseObject: <responses.ListBlueGreenDeploymentsResponse>{},
        body: await response.json(),
        bodyKey: "blueGreenDeploymentCollection",
        bodyModel: model.BlueGreenDeploymentCollection,
        type: "model.BlueGreenDeploymentCollection",
        responseHeaders: [
          {
            value: response.headers.get("opc-request-id"),
            key: "opcRequestId",
...
* 
     ...
     * @throws OciError when an error occurs
     * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/mysql/SwitchoverBlueGreenDeployment.ts.html |here} to see how to use SwitchoverBlueGreenDeployment API.
     */
  public async switchoverBlueGreenDeployment(
    switchoverBlueGreenDeploymentRequest: requests.SwitchoverBlueGreenDeploymentRequest
  ): Promise<responses.SwitchoverBlueGreenDeploymentResponse> {
    if (this.logger)
      this.logger.debug(
        "Calling operation BlueGreenDeploymentsClient#switchoverBlueGreenDeployment."
      );
    const operationName = "switchoverBlueGreenDeployment";
    const apiReferenceLink =
      "https://docs.oracle.com/iaas/api/#/en/mysql/20190415/BlueGreenDeployment/SwitchoverBlueGreenDeployment";
    const pathParams = {
      "{blueGreenDeploymentId}": switchoverBlueGreenDeploymentRequest.blueGreenDeploymentId
    };
    ...
    let headerParams = {
      "Content-Type": common.Constants.APPLICATION_JSON,
      "if-match": switchoverBlueGreenDeploymentRequest.ifMatch,
      "opc-request-id": switchoverBlueGreenDeploymentRequest.opcRequestId,
      "opc-retry-token": switchoverBlueGreenDeploymentRequest.opcRetryToken
    };

    const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
    const retrier = GenericRetrier.createPreferredRetrier(
      this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined,
      switchoverBlueGreenDeploymentRequest.retryConfiguration,
      specRetryConfiguration
    );
    if (this.logger) retrier.logger = this.logger;
    const request = await composeRequest({
      baseEndpoint: this._endpoint,
      defaultHeaders: this._defaultHeaders,
      path: "/blueGreenDeployments/{blueGreenDeploymentId}/actions/switchover",
      method: "POST",
      bodyContent: common.ObjectSerializer.serialize(
        switchoverBlueGreenDeploymentRequest.switchoverBlueGreenDeploymentDetails,
        "SwitchoverBlueGreenDeploymentDetails",
        model.SwitchoverBlueGreenDeploymentDetails.getJsonObj
      ),
      pathParams: pathParams,
      headerParams: headerParams,
      queryParams: queryParams
    ...
    try {
      ...
      const sdkResponse = composeResponse({
        responseObject: <responses.SwitchoverBlueGreenDeploymentResponse>{},
        body: await response.json(),
        bodyKey: "blueGreenDeployment",
        bodyModel: model.BlueGreenDeployment,
        type: "model.BlueGreenDeployment",
   ...
   *
   * This operation uses {@link common.OciSdkDefaultRetryConfiguration} by default if no retry configuration is defined by the user.
   * @param UpdateBlueGreenDeploymentRequest
   * @return UpdateBlueGreenDeploymentResponse
   * @throws OciError when an error occurs
   * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/mysql/UpdateBlueGreenDeployment.ts.html |here} to see how to use UpdateBlueGreenDeployment API.
   */
  public async updateBlueGreenDeployment(
    updateBlueGreenDeploymentRequest: requests.UpdateBlueGreenDeploymentRequest
  ): Promise<responses.UpdateBlueGreenDeploymentResponse> {
    if (this.logger)
      this.logger.debug("Calling operation BlueGreenDeploymentsClient#updateBlueGreenDeployment.");
    const operationName = "updateBlueGreenDeployment";
    const apiReferenceLink =
      "https://docs.oracle.com/iaas/api/#/en/mysql/20190415/BlueGreenDeployment/UpdateBlueGreenDeployment";
    const pathParams = {
      "{blueGreenDeploymentId}": updateBlueGreenDeploymentRequest.blueGreenDeploymentId
    };
    ...
    let headerParams = {
      "Content-Type": common.Constants.APPLICATION_JSON,
      "if-match": updateBlueGreenDeploymentRequest.ifMatch,
      "opc-request-id": updateBlueGreenDeploymentRequest.opcRequestId
    };

    const specRetryConfiguration = common.OciSdkDefaultRetryConfiguration;
    const retrier = GenericRetrier.createPreferredRetrier(
      this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined,
      updateBlueGreenDeploymentRequest.retryConfiguration,
      specRetryConfiguration
    );
    if (this.logger) retrier.logger = this.logger;
    const request = await composeRequest({
      ...
      method: "PUT",
      bodyContent: common.ObjectSerializer.serialize(
        updateBlueGreenDeploymentRequest.updateBlueGreenDeploymentDetails,
        "UpdateBlueGreenDeploymentDetails",
        model.UpdateBlueGreenDeploymentDetails.getJsonObj
      ),
      pathParams: pathParams,
      headerParams: headerParams,
      queryParams: queryParams
    ...
    try {
      ...
      const sdkResponse = composeResponse({
        responseObject: <responses.UpdateBlueGreenDeploymentResponse>{},
        responseHeaders: [
          {
            value: response.headers.get("opc-request-id"),
            key: "opcRequestId",
