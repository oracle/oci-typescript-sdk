...
/**
 * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/governancerulescontrolplane/ListGovernanceRules.ts.html |here} to see how to use ListGovernanceRulesRequest.
 */
...
export namespace ListGovernanceRulesRequest {
  export enum SortBy {
