...
/**
 * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/governancerulescontrolplane/ListTenancyAttachments.ts.html |here} to see how to use ListTenancyAttachmentsRequest.
 */
...
export namespace ListTenancyAttachmentsRequest {
  export enum SortBy {
