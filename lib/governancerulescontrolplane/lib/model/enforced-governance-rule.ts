...
export namespace EnforcedGovernanceRule {
  export function getJsonObj(obj: EnforcedGovernanceRule): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: EnforcedGovernanceRule): object {
    const jsonObj = {
      ...obj,
      ...{
