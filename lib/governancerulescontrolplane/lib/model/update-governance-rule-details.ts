...
export namespace UpdateGovernanceRuleDetails {
  export function getJsonObj(obj: UpdateGovernanceRuleDetails): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: UpdateGovernanceRuleDetails): object {
    const jsonObj = {
      ...obj,
      ...{
