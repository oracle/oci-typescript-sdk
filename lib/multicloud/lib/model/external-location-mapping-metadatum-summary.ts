...
export namespace ExternalLocationMappingMetadatumSummary {
  export function getJsonObj(obj: ExternalLocationMappingMetadatumSummary): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: ExternalLocationMappingMetadatumSummary): object {
    const jsonObj = {
      ...obj,
      ...{
        "externalLocation": obj.externalLocation
