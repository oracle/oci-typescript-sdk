...
export namespace ExternalLocationSummary {
  export function getJsonObj(obj: ExternalLocationSummary): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: ExternalLocationSummary): object {
    const jsonObj = { ...obj, ...{} };
