...
export namespace ExternalLocationSummariesMetadatumSummary {
  export function getJsonObj(obj: ExternalLocationSummariesMetadatumSummary): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: ExternalLocationSummariesMetadatumSummary): object {
    const jsonObj = {
      ...obj,
      ...{
        "externalLocation": obj.externalLocation
