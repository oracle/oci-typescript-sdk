...
export namespace MultiCloudMetadataSummary {
  export function getJsonObj(obj: MultiCloudMetadataSummary): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: MultiCloudMetadataSummary): object {
    const jsonObj = { ...obj, ...{} };
