...
export namespace MultiCloudMetadataCollection {
  export function getJsonObj(obj: MultiCloudMetadataCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
  ...
  export function getDeserializedJsonObj(obj: MultiCloudMetadataCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
