...
* 
   ...
   */
  "lifecycleState"?: MulticloudPolicy.LifecycleState;
}

export namespace MulticloudPolicy {
  ...
  export function getJsonObj(obj: MulticloudPolicy): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: MulticloudPolicy): object {
    const jsonObj = { ...obj, ...{} };
