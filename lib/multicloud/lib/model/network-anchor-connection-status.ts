...
export namespace NetworkAnchorConnectionStatus {
  export function getJsonObj(obj: NetworkAnchorConnectionStatus): NetworkAnchorConnectionStatus {
    return obj;
  }
  export function getDeserializedJsonObj(
    obj: NetworkAnchorConnectionStatus
