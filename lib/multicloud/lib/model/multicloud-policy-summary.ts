 ...
 */
export interface MulticloudPolicySummary {
  /**
   ...
   */
  "policies"?: Array<model.MulticloudPolicy>;
  /**
...
export namespace MulticloudPolicySummary {
  export function getJsonObj(obj: MulticloudPolicySummary): object {
    const jsonObj = {
      ...obj,
      ...{
        "policies": obj.policies
          ? obj.policies.map(item => {
              return model.MulticloudPolicy.getJsonObj(item);
            })
          : undefined
      }
    };
  ...
  export function getDeserializedJsonObj(obj: MulticloudPolicySummary): object {
    const jsonObj = {
      ...obj,
      ...{
        "policies": obj.policies
          ? obj.policies.map(item => {
              return model.MulticloudPolicy.getDeserializedJsonObj(item);
            })
          : undefined
      }
    };
