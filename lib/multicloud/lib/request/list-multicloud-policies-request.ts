...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/multicloud/ListMulticloudPolicies.ts.html |here} to see how to use ListMulticloudPoliciesRequest.
 */
export interface ListMulticloudPoliciesRequest extends common.BaseRequest {
  /**
...
export namespace ListMulticloudPoliciesRequest {
  export enum SortBy {
