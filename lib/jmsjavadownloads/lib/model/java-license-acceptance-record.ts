...
export namespace JavaLicenseAcceptanceRecord {
  export function getJsonObj(obj: JavaLicenseAcceptanceRecord): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: JavaLicenseAcceptanceRecord): object {
    const jsonObj = {
      ...obj,
      ...{
