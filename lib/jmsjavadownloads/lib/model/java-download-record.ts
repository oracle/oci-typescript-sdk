...
export namespace JavaDownloadRecord {
  export function getJsonObj(obj: JavaDownloadRecord): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: JavaDownloadRecord): object {
    const jsonObj = { ...obj, ...{} };
