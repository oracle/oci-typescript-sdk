...
/**
 * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/generativeaiagent/ListAgentEndpoints.ts.html |here} to see how to use ListAgentEndpointsRequest.
 */
...
export namespace ListAgentEndpointsRequest {
  export enum SortBy {
