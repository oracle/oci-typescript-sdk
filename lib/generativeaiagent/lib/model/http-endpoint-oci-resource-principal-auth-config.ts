...
export namespace HttpEndpointOciResourcePrincipalAuthConfig {
  export function getJsonObj(
    obj: HttpEndpointOciResourcePrincipalAuthConfig,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.HttpEndpointAuthConfig.getJsonObj(
            obj
          ) as HttpEndpointOciResourcePrincipalAuthConfig)),
      ...{}
    };

    return jsonObj;
  }
  export const httpEndpointAuthConfigType = "HTTP_ENDPOINT_OCI_RESOURCE_PRINCIPAL_AUTH_CONFIG";
