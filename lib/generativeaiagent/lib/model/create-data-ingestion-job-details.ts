...
export namespace CreateDataIngestionJobDetails {
  export function getJsonObj(obj: CreateDataIngestionJobDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: CreateDataIngestionJobDetails): object {
    const jsonObj = { ...obj, ...{} };
