...
export namespace DatabaseToolConnection {
  export function getJsonObj(obj: DatabaseToolConnection, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.DatabaseConnection.getJsonObj(obj) as DatabaseToolConnection)),
      ...{}
    };

    return jsonObj;
  }
  export const connectionType = "DATABASE_TOOL_CONNECTION";
  export function getDeserializedJsonObj(
    obj: DatabaseToolConnection,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.DatabaseConnection.getDeserializedJsonObj(obj) as DatabaseToolConnection)),
      ...{}
    };
