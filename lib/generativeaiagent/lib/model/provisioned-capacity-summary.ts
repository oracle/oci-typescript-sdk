...
export namespace ProvisionedCapacitySummary {
  export function getJsonObj(obj: ProvisionedCapacitySummary): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: ProvisionedCapacitySummary): object {
    const jsonObj = { ...obj, ...{} };
