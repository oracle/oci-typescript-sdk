...
export namespace DataSourceConfig {
  export function getJsonObj(obj: DataSourceConfig): object {
    const jsonObj = { ...obj, ...{} };

    if (obj && "dataSourceConfigType" in obj && obj.dataSourceConfigType) {
      switch (obj.dataSourceConfigType) {
        case "OCI_OBJECT_STORAGE":
          return model.OciObjectStorageDataSourceConfig.getJsonObj(
            <model.OciObjectStorageDataSourceConfig>(<object>jsonObj),
            true
          );
        default:
  ...
  export function getDeserializedJsonObj(obj: DataSourceConfig): object {
    const jsonObj = { ...obj, ...{} };

    if (obj && "dataSourceConfigType" in obj && obj.dataSourceConfigType) {
      switch (obj.dataSourceConfigType) {
        case "OCI_OBJECT_STORAGE":
          return model.OciObjectStorageDataSourceConfig.getDeserializedJsonObj(
            <model.OciObjectStorageDataSourceConfig>(<object>jsonObj),
            true
          );
        default:
