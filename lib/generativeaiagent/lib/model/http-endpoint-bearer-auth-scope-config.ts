...
export namespace HttpEndpointBearerAuthScopeConfig {
  export function getJsonObj(
    obj: HttpEndpointBearerAuthScopeConfig,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.HttpEndpointAuthScopeConfig.getJsonObj(obj) as HttpEndpointBearerAuthScopeConfig)),
      ...{}
    };

    return jsonObj;
  }
  export const httpEndpointAuthScopeConfigType = "HTTP_ENDPOINT_BEARER_AUTH_SCOPE_CONFIG";
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ...
        : (model.HttpEndpointAuthScopeConfig.getDeserializedJsonObj(
            obj
          ) as HttpEndpointBearerAuthScopeConfig)),
      ...{}
    };
