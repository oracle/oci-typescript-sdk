...
export namespace AgentEndpointSummary {
  export function getJsonObj(obj: AgentEndpointSummary): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: AgentEndpointSummary): object {
    const jsonObj = {
      ...obj,
      ...{
        "contentModerationConfig": obj.contentModerationConfig
