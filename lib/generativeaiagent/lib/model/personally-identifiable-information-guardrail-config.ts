...
export namespace PersonallyIdentifiableInformationGuardrailConfig {
  export function getJsonObj(obj: PersonallyIdentifiableInformationGuardrailConfig): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(
    obj: PersonallyIdentifiableInformationGuardrailConfig
  ): object {
    const jsonObj = { ...obj, ...{} };
