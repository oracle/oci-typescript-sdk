...
export namespace AgentEndpointCollection {
  export function getJsonObj(obj: AgentEndpointCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
  ...
  export function getDeserializedJsonObj(obj: AgentEndpointCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
