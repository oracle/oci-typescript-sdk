...
export namespace ObjectStoragePrefixOutputLocation {
  export function getJsonObj(
    obj: ObjectStoragePrefixOutputLocation,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.OutputLocation.getJsonObj(obj) as ObjectStoragePrefixOutputLocation)),
      ...{}
    };

    return jsonObj;
  }
  export const outputLocationType = "OBJECT_STORAGE_PREFIX";
  export function getDeserializedJsonObj(
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.OutputLocation.getDeserializedJsonObj(obj) as ObjectStoragePrefixOutputLocation)),
      ...{}
    };
