...
export namespace DatabaseConnection {
  export function getJsonObj(obj: DatabaseConnection): object {
    const jsonObj = { ...obj, ...{} };

    if (obj && "connectionType" in obj && obj.connectionType) {
      switch (obj.connectionType) {
        case "DATABASE_TOOL_CONNECTION":
          return model.DatabaseToolConnection.getJsonObj(
            <model.DatabaseToolConnection>(<object>jsonObj),
            true
          );
        default:
  ...
  export function getDeserializedJsonObj(obj: DatabaseConnection): object {
    const jsonObj = { ...obj, ...{} };

    if (obj && "connectionType" in obj && obj.connectionType) {
      switch (obj.connectionType) {
        case "DATABASE_TOOL_CONNECTION":
          return model.DatabaseToolConnection.getDeserializedJsonObj(
            <model.DatabaseToolConnection>(<object>jsonObj),
            true
          );
        default:
