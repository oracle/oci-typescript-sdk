...
export namespace InputLocation {
    ...
    if (obj && "inputLocationType" in obj && obj.inputLocationType) {
      switch (obj.inputLocationType) {
        case "OBJECT_STORAGE_PREFIX":
          return model.ObjectStorageInputLocation.getJsonObj(
            <model.ObjectStorageInputLocation>(<object>jsonObj),
            true
          );
        case "INLINE":
          return model.InlineInputLocation.getJsonObj(
            <model.InlineInputLocation>(<object>jsonObj),
            true
          );
        default:
  ...
  export function getDeserializedJsonObj(obj: InputLocation): object {
    ...
    if (obj && "inputLocationType" in obj && obj.inputLocationType) {
      switch (obj.inputLocationType) {
        case "OBJECT_STORAGE_PREFIX":
          return model.ObjectStorageInputLocation.getDeserializedJsonObj(
            <model.ObjectStorageInputLocation>(<object>jsonObj),
            true
          );
        case "INLINE":
          return model.InlineInputLocation.getDeserializedJsonObj(
            <model.InlineInputLocation>(<object>jsonObj),
            true
          );
        default:
