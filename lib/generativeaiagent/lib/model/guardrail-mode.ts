...
export namespace GuardrailMode {
  export function getJsonObj(obj: GuardrailMode): GuardrailMode {
    return obj;
  }
  export function getDeserializedJsonObj(obj: GuardrailMode): GuardrailMode {
    return obj;
  }
}
