...
export namespace DataIngestionJobCollection {
  export function getJsonObj(obj: DataIngestionJobCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
  ...
  export function getDeserializedJsonObj(obj: DataIngestionJobCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
