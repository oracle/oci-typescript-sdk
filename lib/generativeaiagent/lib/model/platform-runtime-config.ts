...
export namespace PlatformRuntimeConfig {
  export enum PlatformRuntimeConfigType {
  ...
  export function getJsonObj(obj: PlatformRuntimeConfig): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: PlatformRuntimeConfig): object {
    const jsonObj = { ...obj, ...{} };
