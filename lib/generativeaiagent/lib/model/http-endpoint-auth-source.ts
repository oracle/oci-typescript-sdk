...
export interface HttpEndpointAuthSource {
  ...
  "httpEndpointAuthScopeConfig":
    | model.HttpEndpointBearerAuthScopeConfig
    | model.HttpEndpointNoAuthScopeConfig
    | model.HttpEndpointBasicAuthScopeConfig
    | model.HttpEndpointOciAuthScopeConfig
    | model.HttpEndpointIdcsAuthScopeConfig
    | model.HttpEndpointApiKeyAuthScopeConfig;
}

export namespace HttpEndpointAuthSource {
  export enum HttpEndpointAuthScope {
    Agent = "AGENT",
    /**
  ...
  export function getJsonObj(obj: HttpEndpointAuthSource): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: HttpEndpointAuthSource): object {
    const jsonObj = {
      ...obj,
      ...{
        "httpEndpointAuthScopeConfig": obj.httpEndpointAuthScopeConfig
          ? model.HttpEndpointAuthScopeConfig.getDeserializedJsonObj(
              obj.httpEndpointAuthScopeConfig
            )
          : undefined
      }
    };
