...
export namespace DataIngestionJobType {
  export enum Type {
    Cleanup = "CLEANUP",
    Ingestion = "INGESTION",
    /**
  ...
  export function getJsonObj(obj: DataIngestionJobType): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: DataIngestionJobType): object {
    const jsonObj = { ...obj, ...{} };
