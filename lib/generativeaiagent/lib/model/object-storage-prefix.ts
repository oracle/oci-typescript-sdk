...
export namespace ObjectStoragePrefix {
  export function getJsonObj(obj: ObjectStoragePrefix): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: ObjectStoragePrefix): object {
    const jsonObj = { ...obj, ...{} };
