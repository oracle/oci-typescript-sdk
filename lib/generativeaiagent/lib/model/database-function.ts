...
export namespace DatabaseFunction {
  export function getJsonObj(obj: DatabaseFunction): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: DatabaseFunction): object {
    const jsonObj = { ...obj, ...{} };
