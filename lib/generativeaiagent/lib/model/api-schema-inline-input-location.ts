...
export namespace ApiSchemaInlineInputLocation {
  export function getJsonObj(obj: ApiSchemaInlineInputLocation, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.ApiSchemaInputLocation.getJsonObj(obj) as ApiSchemaInlineInputLocation)),
      ...{}
    };

    return jsonObj;
  }
  export const apiSchemaInputLocationType = "INLINE";
  export function getDeserializedJsonObj(
    obj: ApiSchemaInlineInputLocation,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.ApiSchemaInputLocation.getDeserializedJsonObj(
            obj
          ) as ApiSchemaInlineInputLocation)),
      ...{}
    };
