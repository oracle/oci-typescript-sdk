...
export namespace PromptInjectionGuardrailConfig {
  export function getJsonObj(obj: PromptInjectionGuardrailConfig): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: PromptInjectionGuardrailConfig): object {
    const jsonObj = { ...obj, ...{} };
