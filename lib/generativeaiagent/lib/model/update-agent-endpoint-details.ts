...
export namespace UpdateAgentEndpointDetails {
  export function getJsonObj(obj: UpdateAgentEndpointDetails): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: UpdateAgentEndpointDetails): object {
    const jsonObj = {
      ...obj,
      ...{
        "contentModerationConfig": obj.contentModerationConfig
