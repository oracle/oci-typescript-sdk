...
export namespace ApiSchemaInputLocation {
  export function getJsonObj(obj: ApiSchemaInputLocation): object {
    const jsonObj = { ...obj, ...{} };
    ...
    if (obj && "apiSchemaInputLocationType" in obj && obj.apiSchemaInputLocationType) {
      switch (obj.apiSchemaInputLocationType) {
        case "OBJECT_STORAGE_LOCATION":
          return model.ApiSchemaObjectStorageInputLocation.getJsonObj(
            <model.ApiSchemaObjectStorageInputLocation>(<object>jsonObj),
            true
          );
        case "INLINE":
          return model.ApiSchemaInlineInputLocation.getJsonObj(
            <model.ApiSchemaInlineInputLocation>(<object>jsonObj),
            true
          );
        default:
  ...
  export function getDeserializedJsonObj(obj: ApiSchemaInputLocation): object {
    const jsonObj = { ...obj, ...{} };

    if (obj && "apiSchemaInputLocationType" in obj && obj.apiSchemaInputLocationType) {
      switch (obj.apiSchemaInputLocationType) {
        case "OBJECT_STORAGE_LOCATION":
          return model.ApiSchemaObjectStorageInputLocation.getDeserializedJsonObj(
            <model.ApiSchemaObjectStorageInputLocation>(<object>jsonObj),
            true
          );
        case "INLINE":
          return model.ApiSchemaInlineInputLocation.getDeserializedJsonObj(
            <model.ApiSchemaInlineInputLocation>(<object>jsonObj),
            true
          );
        default:
