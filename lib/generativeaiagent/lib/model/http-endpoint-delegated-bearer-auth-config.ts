...
export namespace HttpEndpointDelegatedBearerAuthConfig {
  export function getJsonObj(
    obj: HttpEndpointDelegatedBearerAuthConfig,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.HttpEndpointAuthConfig.getJsonObj(obj) as HttpEndpointDelegatedBearerAuthConfig)),
      ...{}
    };

    return jsonObj;
  }
  export const httpEndpointAuthConfigType = "HTTP_ENDPOINT_DELEGATED_BEARER_AUTH_CONFIG";
  export function getDeserializedJsonObj(
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.HttpEndpointAuthConfig.getDeserializedJsonObj(
            obj
          ) as HttpEndpointDelegatedBearerAuthConfig)),
      ...{}
    };
