...
export namespace InlineInputLocation {
  export function getJsonObj(obj: InlineInputLocation, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj ? obj : (model.InputLocation.getJsonObj(obj) as InlineInputLocation)),
      ...{}
    };

    return jsonObj;
  }
  export const inputLocationType = "INLINE";
  export function getDeserializedJsonObj(
    obj: InlineInputLocation,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.InputLocation.getDeserializedJsonObj(obj) as InlineInputLocation)),
      ...{}
    };
