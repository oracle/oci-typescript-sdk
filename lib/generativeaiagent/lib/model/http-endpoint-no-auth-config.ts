...
export namespace HttpEndpointNoAuthConfig {
  export function getJsonObj(obj: HttpEndpointNoAuthConfig, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.HttpEndpointAuthConfig.getJsonObj(obj) as HttpEndpointNoAuthConfig)),
      ...{}
    };

    return jsonObj;
  }
  export const httpEndpointAuthConfigType = "HTTP_ENDPOINT_NO_AUTH_CONFIG";
  export function getDeserializedJsonObj(
    obj: HttpEndpointNoAuthConfig,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.HttpEndpointAuthConfig.getDeserializedJsonObj(obj) as HttpEndpointNoAuthConfig)),
      ...{}
    };
