...
export namespace HttpEndpointBasicAuthScopeConfig {
  export function getJsonObj(
    obj: HttpEndpointBasicAuthScopeConfig,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.HttpEndpointAuthScopeConfig.getJsonObj(obj) as HttpEndpointBasicAuthScopeConfig)),
      ...{}
    };

    return jsonObj;
  }
  export const httpEndpointAuthScopeConfigType = "HTTP_ENDPOINT_BASIC_AUTH_SCOPE_CONFIG";
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ...
        : (model.HttpEndpointAuthScopeConfig.getDeserializedJsonObj(
            obj
          ) as HttpEndpointBasicAuthScopeConfig)),
      ...{}
    };
