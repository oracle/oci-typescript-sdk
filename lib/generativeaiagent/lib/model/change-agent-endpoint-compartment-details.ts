...
export namespace ChangeAgentEndpointCompartmentDetails {
  export function getJsonObj(obj: ChangeAgentEndpointCompartmentDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: ChangeAgentEndpointCompartmentDetails): object {
    const jsonObj = { ...obj, ...{} };
