...
export namespace GuardrailConfig {
  export function getJsonObj(obj: GuardrailConfig): object {
    const jsonObj = {
      ...obj,
      ...{
        ...
        "personallyIdentifiableInformationConfig": obj.personallyIdentifiableInformationConfig
          ? model.PersonallyIdentifiableInformationGuardrailConfig.getJsonObj(
  ...
  export function getDeserializedJsonObj(obj: GuardrailConfig): object {
    const jsonObj = {
      ...obj,
      ...{
        "contentModerationConfig": obj.contentModerationConfig
          ? model.ContentModerationGuardrailConfig.getDeserializedJsonObj(
              obj.contentModerationConfig
            )
          : undefined,
        "promptInjectionConfig": obj.promptInjectionConfig
          ...
          : undefined,
        "personallyIdentifiableInformationConfig": obj.personallyIdentifiableInformationConfig
          ? model.PersonallyIdentifiableInformationGuardrailConfig.getDeserializedJsonObj(
              obj.personallyIdentifiableInformationConfig
            )
          : undefined
      }
