...
export namespace ObjectStorageInputLocation {
  export function getJsonObj(obj: ObjectStorageInputLocation, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.InputLocation.getJsonObj(obj) as ObjectStorageInputLocation)),
      ...{}
    };

    return jsonObj;
  }
  export const inputLocationType = "OBJECT_STORAGE_PREFIX";
  export function getDeserializedJsonObj(
    obj: ObjectStorageInputLocation,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.InputLocation.getDeserializedJsonObj(obj) as ObjectStorageInputLocation)),
      ...{}
    };
