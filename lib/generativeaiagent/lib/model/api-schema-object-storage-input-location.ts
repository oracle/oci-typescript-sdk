...
export namespace ApiSchemaObjectStorageInputLocation {
  export function getJsonObj(
    obj: ApiSchemaObjectStorageInputLocation,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.ApiSchemaInputLocation.getJsonObj(obj) as ApiSchemaObjectStorageInputLocation)),
      ...{}
    };

    return jsonObj;
  }
  export const apiSchemaInputLocationType = "OBJECT_STORAGE_LOCATION";
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ...
        : (model.ApiSchemaInputLocation.getDeserializedJsonObj(
            obj
          ) as ApiSchemaObjectStorageInputLocation)),
      ...{}
    };
