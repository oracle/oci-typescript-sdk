...
export namespace HttpEndpointIdcsAuthConfig {
  export function getJsonObj(obj: HttpEndpointIdcsAuthConfig, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.HttpEndpointAuthConfig.getJsonObj(obj) as HttpEndpointIdcsAuthConfig)),
      ...{
  ...
  export const httpEndpointAuthConfigType = "HTTP_ENDPOINT_IDCS_AUTH_CONFIG";
  export function getDeserializedJsonObj(
    obj: HttpEndpointIdcsAuthConfig,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.HttpEndpointAuthConfig.getDeserializedJsonObj(obj) as HttpEndpointIdcsAuthConfig)),
      ...{
