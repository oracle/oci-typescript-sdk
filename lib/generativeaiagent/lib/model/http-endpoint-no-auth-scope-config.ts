...
export namespace HttpEndpointNoAuthScopeConfig {
  export function getJsonObj(
    obj: HttpEndpointNoAuthScopeConfig,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.HttpEndpointAuthScopeConfig.getJsonObj(obj) as HttpEndpointNoAuthScopeConfig)),
      ...{}
    };

    return jsonObj;
  }
  export const httpEndpointAuthScopeConfigType = "HTTP_ENDPOINT_NO_AUTH_SCOPE_CONFIG";
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ...
        : (model.HttpEndpointAuthScopeConfig.getDeserializedJsonObj(
            obj
          ) as HttpEndpointNoAuthScopeConfig)),
      ...{}
    };
