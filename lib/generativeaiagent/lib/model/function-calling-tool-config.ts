...
export namespace FunctionCallingToolConfig {
  export function getJsonObj(obj: FunctionCallingToolConfig, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj ? obj : (model.ToolConfig.getJsonObj(obj) as FunctionCallingToolConfig)),
      ...{
  ...
  export const toolConfigType = "FUNCTION_CALLING_TOOL_CONFIG";
  export function getDeserializedJsonObj(
    obj: FunctionCallingToolConfig,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.ToolConfig.getDeserializedJsonObj(obj) as FunctionCallingToolConfig)),
      ...{
