...
export namespace HumanInputConfig {
  export function getJsonObj(obj: HumanInputConfig): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: HumanInputConfig): object {
    const jsonObj = { ...obj, ...{} };
