...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/ddfs/ListWorkRequests.ts.html |here} to see how to use ListWorkRequestsRequest.
 */
