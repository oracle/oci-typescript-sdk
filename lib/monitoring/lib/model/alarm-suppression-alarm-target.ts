...
export namespace AlarmSuppressionAlarmTarget {
  export function getJsonObj(obj: AlarmSuppressionAlarmTarget, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.AlarmSuppressionTarget.getJsonObj(obj) as AlarmSuppressionAlarmTarget)),
      ...{}
    };

    return jsonObj;
  }
  export const targetType = "ALARM";
  export function getDeserializedJsonObj(
    obj: AlarmSuppressionAlarmTarget,
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ...
        : (model.AlarmSuppressionTarget.getDeserializedJsonObj(
            obj
          ) as AlarmSuppressionAlarmTarget)),
      ...{}
    };
