...
export namespace AlarmSuppressionHistoryItemCollection {
  export function getJsonObj(obj: AlarmSuppressionHistoryItemCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
  ...
  export function getDeserializedJsonObj(obj: AlarmSuppressionHistoryItemCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
