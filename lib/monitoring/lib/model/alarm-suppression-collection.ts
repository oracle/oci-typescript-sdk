...
export namespace AlarmSuppressionCollection {
  export function getJsonObj(obj: AlarmSuppressionCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
  ...
  export function getDeserializedJsonObj(obj: AlarmSuppressionCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
