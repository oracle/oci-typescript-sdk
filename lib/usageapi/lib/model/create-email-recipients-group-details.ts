...
export namespace CreateEmailRecipientsGroupDetails {
  export function getJsonObj(obj: CreateEmailRecipientsGroupDetails): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: CreateEmailRecipientsGroupDetails): object {
    const jsonObj = {
      ...obj,
      ...{
        "recipientsList": obj.recipientsList
