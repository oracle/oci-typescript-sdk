...
export namespace CustomTableSummary {
  export function getJsonObj(obj: CustomTableSummary): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: CustomTableSummary): object {
    const jsonObj = {
      ...obj,
      ...{
        "savedCustomTable": obj.savedCustomTable
