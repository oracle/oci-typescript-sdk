...
export namespace CreateUsageCarbonEmissionsQueryDetails {
  export function getJsonObj(obj: CreateUsageCarbonEmissionsQueryDetails): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: CreateUsageCarbonEmissionsQueryDetails): object {
    const jsonObj = {
      ...obj,
      ...{
        "queryDefinition": obj.queryDefinition
