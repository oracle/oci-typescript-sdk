 ...
 */
export interface SavedScheduleReport {
  /**
   ...
   */
  "notificationType"?: SavedScheduleReport.NotificationType;
  /**
...
export namespace SavedScheduleReport {
  export enum NotificationType {
    Email = "EMAIL"
  }

  export function getJsonObj(obj: SavedScheduleReport): object {
    const jsonObj = { ...obj, ...{} };
