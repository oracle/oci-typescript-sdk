...
export namespace UsageCarbonEmissionsQueryDefinition {
  export function getJsonObj(obj: UsageCarbonEmissionsQueryDefinition): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: UsageCarbonEmissionsQueryDefinition): object {
    const jsonObj = {
      ...obj,
      ...{
        "reportQuery": obj.reportQuery
