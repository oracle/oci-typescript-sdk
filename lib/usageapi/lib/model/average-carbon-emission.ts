...
export namespace AverageCarbonEmission {
  export function getJsonObj(obj: AverageCarbonEmission): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: AverageCarbonEmission): object {
    const jsonObj = { ...obj, ...{} };
