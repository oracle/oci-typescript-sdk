...
export namespace EmailRecipientsGroupSummary {
  export function getJsonObj(obj: EmailRecipientsGroupSummary): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: EmailRecipientsGroupSummary): object {
    const jsonObj = {
      ...obj,
      ...{
        "recipientsList": obj.recipientsList
