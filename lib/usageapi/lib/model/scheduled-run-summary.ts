...
export namespace ScheduledRunSummary {
  export function getJsonObj(obj: ScheduledRunSummary): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: ScheduledRunSummary): object {
    const jsonObj = { ...obj, ...{} };
