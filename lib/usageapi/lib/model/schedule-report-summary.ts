...
export namespace ScheduleReportSummary {
  export function getJsonObj(obj: ScheduleReportSummary): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: ScheduleReportSummary): object {
    const jsonObj = {
      ...obj,
      ...{
        "savedScheduleReport": obj.savedScheduleReport
