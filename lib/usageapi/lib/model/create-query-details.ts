...
export namespace CreateQueryDetails {
  export function getJsonObj(obj: CreateQueryDetails): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: CreateQueryDetails): object {
    const jsonObj = {
      ...obj,
      ...{
        "queryDefinition": obj.queryDefinition
