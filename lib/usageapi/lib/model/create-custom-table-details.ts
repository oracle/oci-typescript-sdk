...
export namespace CreateCustomTableDetails {
  export function getJsonObj(obj: CreateCustomTableDetails): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: CreateCustomTableDetails): object {
    const jsonObj = {
      ...obj,
      ...{
        "savedCustomTable": obj.savedCustomTable
