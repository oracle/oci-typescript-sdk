...
export namespace EmailRecipientsGroupCollection {
  export function getJsonObj(obj: EmailRecipientsGroupCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
  ...
  export function getDeserializedJsonObj(obj: EmailRecipientsGroupCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
