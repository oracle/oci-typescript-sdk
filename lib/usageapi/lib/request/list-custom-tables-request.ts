...
/**
 * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/usageapi/ListCustomTables.ts.html |here} to see how to use ListCustomTablesRequest.
 */
...
export namespace ListCustomTablesRequest {
  export enum SortBy {
