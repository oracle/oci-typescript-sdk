...
/**
 * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/usageapi/ListUsageCarbonEmissionsQueries.ts.html |here} to see how to use ListUsageCarbonEmissionsQueriesRequest.
 */
...
export namespace ListUsageCarbonEmissionsQueriesRequest {
  export enum SortBy {
