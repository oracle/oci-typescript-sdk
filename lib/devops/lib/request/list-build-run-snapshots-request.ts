...
/**
 * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/devops/ListBuildRunSnapshots.ts.html |here} to see how to use ListBuildRunSnapshotsRequest.
 */
...
export namespace ListBuildRunSnapshotsRequest {
  export enum SortBy {
