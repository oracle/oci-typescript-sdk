...
/**
 * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/devops/ListDeployArtifacts.ts.html |here} to see how to use ListDeployArtifactsRequest.
 */
...
export namespace ListDeployArtifactsRequest {
  export enum SortBy {
