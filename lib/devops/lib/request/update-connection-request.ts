...
/**
 * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/devops/UpdateConnection.ts.html |here} to see how to use UpdateConnectionRequest.
 */
export interface UpdateConnectionRequest extends common.BaseRequest {
  ...
  "updateConnectionDetails":
    ...
    | model.UpdateGitlabServerAccessTokenConnectionDetails;
  /**
