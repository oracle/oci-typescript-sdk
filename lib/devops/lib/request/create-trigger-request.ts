...
/**
 * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/devops/CreateTrigger.ts.html |here} to see how to use CreateTriggerRequest.
 */
export interface CreateTriggerRequest extends common.BaseRequest {
  ...
  "createTriggerDetails":
    ...
    | model.CreateBitbucketServerTriggerDetails;
  /**
