...
/**
 * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/devops/ListBuildRuns.ts.html |here} to see how to use ListBuildRunsRequest.
 */
...
export namespace ListBuildRunsRequest {
  export enum SortBy {
