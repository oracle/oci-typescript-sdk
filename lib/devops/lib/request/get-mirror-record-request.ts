...
/**
 * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/devops/GetMirrorRecord.ts.html |here} to see how to use GetMirrorRecordRequest.
 */
...
export namespace GetMirrorRecordRequest {
  export enum MirrorRecordType {
    Current = "current",
