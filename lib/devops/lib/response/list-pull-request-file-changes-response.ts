...
export interface ListPullRequestFileChangesResponse {
  /**
  ...
  "opcNextPage": string;
  /**
   * The returned model.PullRequestFileChangeCollection instance.
   */
  "pullRequestFileChangeCollection": model.PullRequestFileChangeCollection;
}
