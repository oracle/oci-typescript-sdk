 ...
 *
 */
export interface UpdateBitbucketServerAccessTokenConnectionDetails
...
export namespace UpdateBitbucketServerAccessTokenConnectionDetails {
  export function getJsonObj(
    obj: UpdateBitbucketServerAccessTokenConnectionDetails,
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ...
        : (model.UpdateConnectionDetails.getJsonObj(
            obj
          ) as UpdateBitbucketServerAccessTokenConnectionDetails)),
      ...{
