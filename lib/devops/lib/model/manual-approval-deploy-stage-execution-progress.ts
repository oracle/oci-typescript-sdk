...
export namespace ManualApprovalDeployStageExecutionProgress {
  export function getJsonObj(
    obj: ManualApprovalDeployStageExecutionProgress,
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ...
        : (model.DeployStageExecutionProgress.getJsonObj(
            obj
          ) as ManualApprovalDeployStageExecutionProgress)),
      ...{
