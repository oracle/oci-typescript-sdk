 ...
 */
export interface ComputeInstanceGroupDeployEnvironmentSummary
  extends model.DeployEnvironmentSummary {
  "computeInstanceGroupSelectors": model.ComputeInstanceGroupSelectorCollection;

  "deployEnvironmentType": string;
}

export namespace ComputeInstanceGroupDeployEnvironmentSummary {
  export function getJsonObj(
    obj: ComputeInstanceGroupDeployEnvironmentSummary,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.DeployEnvironmentSummary.getJsonObj(
            obj
          ) as ComputeInstanceGroupDeployEnvironmentSummary)),
      ...{
