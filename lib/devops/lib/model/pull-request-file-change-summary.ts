...
export namespace PullRequestFileChangeSummary {
  export function getJsonObj(obj: PullRequestFileChangeSummary): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: PullRequestFileChangeSummary): object {
    const jsonObj = { ...obj, ...{} };
