...
export namespace OkeCanaryTrafficShiftDeployStage {
  export function getJsonObj(
    obj: OkeCanaryTrafficShiftDeployStage,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.DeployStage.getJsonObj(obj) as OkeCanaryTrafficShiftDeployStage)),
      ...{
  ...
  export function getDeserializedJsonObj(
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.DeployStage.getDeserializedJsonObj(obj) as OkeCanaryTrafficShiftDeployStage)),
      ...{
        "rolloutPolicy": obj.rolloutPolicy
