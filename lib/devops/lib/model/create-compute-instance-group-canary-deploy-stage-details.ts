 ...
 */
export interface CreateComputeInstanceGroupCanaryDeployStageDetails
...
export namespace CreateComputeInstanceGroupCanaryDeployStageDetails {
  export function getJsonObj(
    obj: CreateComputeInstanceGroupCanaryDeployStageDetails,
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ...
        : (model.CreateDeployStageDetails.getJsonObj(
            obj
          ) as CreateComputeInstanceGroupCanaryDeployStageDetails)),
      ...{
