...
export namespace RepositoryAnalyticsDetails {
  ...
  export function getJsonObj(obj: RepositoryAnalyticsDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: RepositoryAnalyticsDetails): object {
    const jsonObj = { ...obj, ...{} };
