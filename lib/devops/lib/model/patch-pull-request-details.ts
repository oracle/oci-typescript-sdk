...
export namespace PatchPullRequestDetails {
  export function getJsonObj(obj: PatchPullRequestDetails): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
  ...
  export function getDeserializedJsonObj(obj: PatchPullRequestDetails): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
