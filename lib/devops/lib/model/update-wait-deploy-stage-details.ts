...
export namespace UpdateWaitDeployStageDetails {
  export function getJsonObj(obj: UpdateWaitDeployStageDetails, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.UpdateDeployStageDetails.getJsonObj(obj) as UpdateWaitDeployStageDetails)),
      ...{
  ...
  export function getDeserializedJsonObj(
    obj: UpdateWaitDeployStageDetails,
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ...
        : (model.UpdateDeployStageDetails.getDeserializedJsonObj(
            obj
          ) as UpdateWaitDeployStageDetails)),
      ...{
        "waitCriteria": obj.waitCriteria
