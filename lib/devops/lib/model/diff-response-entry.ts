...
export namespace DiffResponseEntry {
  export function getJsonObj(obj: DiffResponseEntry): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: DiffResponseEntry): object {
    const jsonObj = { ...obj, ...{} };
