...
export namespace VaultSecretVerificationKeySource {
  export function getJsonObj(
    obj: VaultSecretVerificationKeySource,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.VerificationKeySource.getJsonObj(obj) as VaultSecretVerificationKeySource)),
      ...{}
    };

    return jsonObj;
  }
  export const verificationKeySourceType = "VAULT_SECRET";
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ...
        : (model.VerificationKeySource.getDeserializedJsonObj(
            obj
          ) as VaultSecretVerificationKeySource)),
      ...{}
    };
