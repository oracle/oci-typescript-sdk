...
export namespace CreatePullRequestDetails {
  export function getJsonObj(obj: CreatePullRequestDetails): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: CreatePullRequestDetails): object {
    const jsonObj = {
      ...obj,
      ...{
        "reviewers": obj.reviewers
