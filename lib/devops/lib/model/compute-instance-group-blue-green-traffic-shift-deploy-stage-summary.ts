 ...
 */
export interface ComputeInstanceGroupBlueGreenTrafficShiftDeployStageSummary
...
export namespace ComputeInstanceGroupBlueGreenTrafficShiftDeployStageSummary {
  export function getJsonObj(
    obj: ComputeInstanceGroupBlueGreenTrafficShiftDeployStageSummary,
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ...
        : (model.DeployStageSummary.getJsonObj(
            obj
          ) as ComputeInstanceGroupBlueGreenTrafficShiftDeployStageSummary)),
      ...{}
    };
