...
export namespace FunctionDeployStage {
  export function getJsonObj(obj: FunctionDeployStage, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj ? obj : (model.DeployStage.getJsonObj(obj) as FunctionDeployStage)),
      ...{}
    };
  ...
  export function getDeserializedJsonObj(
    obj: FunctionDeployStage,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.DeployStage.getDeserializedJsonObj(obj) as FunctionDeployStage)),
      ...{}
    };
