...
export namespace BitbucketServerAccessTokenConnection {
  export function getJsonObj(
    obj: BitbucketServerAccessTokenConnection,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.Connection.getJsonObj(obj) as BitbucketServerAccessTokenConnection)),
      ...{
  ...
  export function getDeserializedJsonObj(
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.Connection.getDeserializedJsonObj(obj) as BitbucketServerAccessTokenConnection)),
      ...{
        "tlsVerifyConfig": obj.tlsVerifyConfig
