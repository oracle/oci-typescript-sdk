...
export namespace PullRequestCommentSummary {
  export function getJsonObj(obj: PullRequestCommentSummary): object {
    const jsonObj = {
      ...obj,
      ...{
        "likes": obj.likes
  ...
  export function getDeserializedJsonObj(obj: PullRequestCommentSummary): object {
    const jsonObj = {
      ...obj,
      ...{
        "likes": obj.likes
