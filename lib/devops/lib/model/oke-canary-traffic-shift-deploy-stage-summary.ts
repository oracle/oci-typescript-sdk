...
export namespace OkeCanaryTrafficShiftDeployStageSummary {
  export function getJsonObj(
    obj: OkeCanaryTrafficShiftDeployStageSummary,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.DeployStageSummary.getJsonObj(obj) as OkeCanaryTrafficShiftDeployStageSummary)),
      ...{
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ...
        : (model.DeployStageSummary.getDeserializedJsonObj(
            obj
          ) as OkeCanaryTrafficShiftDeployStageSummary)),
      ...{
        "rolloutPolicy": obj.rolloutPolicy
