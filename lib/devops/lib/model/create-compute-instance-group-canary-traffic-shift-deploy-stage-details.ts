 ...
 */
export interface CreateComputeInstanceGroupCanaryTrafficShiftDeployStageDetails
...
export namespace CreateComputeInstanceGroupCanaryTrafficShiftDeployStageDetails {
  export function getJsonObj(
    obj: CreateComputeInstanceGroupCanaryTrafficShiftDeployStageDetails,
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ...
        : (model.CreateDeployStageDetails.getJsonObj(
            obj
          ) as CreateComputeInstanceGroupCanaryTrafficShiftDeployStageDetails)),
      ...{
