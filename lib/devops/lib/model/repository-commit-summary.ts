...
export namespace RepositoryCommitSummary {
  export function getJsonObj(obj: RepositoryCommitSummary): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: RepositoryCommitSummary): object {
    const jsonObj = { ...obj, ...{} };
