...
export namespace OkeBlueGreenTrafficShiftDeployStageExecutionProgress {
  export function getJsonObj(
    obj: OkeBlueGreenTrafficShiftDeployStageExecutionProgress,
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ...
        : (model.DeployStageExecutionProgress.getJsonObj(
            obj
          ) as OkeBlueGreenTrafficShiftDeployStageExecutionProgress)),
      ...{}
    };
