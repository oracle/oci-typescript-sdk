...
export namespace VbsFilterExclusionAttributes {
  export function getJsonObj(obj: VbsFilterExclusionAttributes): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: VbsFilterExclusionAttributes): object {
    const jsonObj = {
      ...obj,
      ...{
