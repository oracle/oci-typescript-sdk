...
export namespace OkeCanaryApprovalDeployStage {
  export function getJsonObj(obj: OkeCanaryApprovalDeployStage, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.DeployStage.getJsonObj(obj) as OkeCanaryApprovalDeployStage)),
      ...{
  ...
  export function getDeserializedJsonObj(
    obj: OkeCanaryApprovalDeployStage,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.DeployStage.getDeserializedJsonObj(obj) as OkeCanaryApprovalDeployStage)),
      ...{
        "approvalPolicy": obj.approvalPolicy
