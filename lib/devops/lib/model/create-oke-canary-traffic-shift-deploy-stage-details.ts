 ...
 */
export interface CreateOkeCanaryTrafficShiftDeployStageDetails
...
export namespace CreateOkeCanaryTrafficShiftDeployStageDetails {
  export function getJsonObj(
    obj: CreateOkeCanaryTrafficShiftDeployStageDetails,
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ...
        : (model.CreateDeployStageDetails.getJsonObj(
            obj
          ) as CreateOkeCanaryTrafficShiftDeployStageDetails)),
      ...{
