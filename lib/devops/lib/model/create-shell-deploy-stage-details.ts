...
export namespace CreateShellDeployStageDetails {
  export function getJsonObj(
    obj: CreateShellDeployStageDetails,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.CreateDeployStageDetails.getJsonObj(obj) as CreateShellDeployStageDetails)),
      ...{
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ...
        : (model.CreateDeployStageDetails.getDeserializedJsonObj(
            obj
          ) as CreateShellDeployStageDetails)),
      ...{
        "containerConfig": obj.containerConfig
