...
export namespace GithubFilterExclusionAttributes {
  export function getJsonObj(obj: GithubFilterExclusionAttributes): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: GithubFilterExclusionAttributes): object {
    const jsonObj = {
      ...obj,
      ...{
