...
export namespace ChangeProjectCompartmentDetails {
  export function getJsonObj(obj: ChangeProjectCompartmentDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: ChangeProjectCompartmentDetails): object {
    const jsonObj = { ...obj, ...{} };
