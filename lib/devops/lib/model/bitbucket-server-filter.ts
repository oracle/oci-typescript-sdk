...
export namespace BitbucketServerFilter {
  export enum Events {
    Push = "PUSH",
  ...
  export function getJsonObj(obj: BitbucketServerFilter, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj ? obj : (model.Filter.getJsonObj(obj) as BitbucketServerFilter)),
      ...{
        "include": obj.include
  ...
  export function getDeserializedJsonObj(
    obj: BitbucketServerFilter,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.Filter.getDeserializedJsonObj(obj) as BitbucketServerFilter)),
      ...{
        "include": obj.include
