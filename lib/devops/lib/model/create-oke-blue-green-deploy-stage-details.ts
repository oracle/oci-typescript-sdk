...
export namespace CreateOkeBlueGreenDeployStageDetails {
  export function getJsonObj(
    obj: CreateOkeBlueGreenDeployStageDetails,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.CreateDeployStageDetails.getJsonObj(obj) as CreateOkeBlueGreenDeployStageDetails)),
      ...{
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ...
        : (model.CreateDeployStageDetails.getDeserializedJsonObj(
            obj
          ) as CreateOkeBlueGreenDeployStageDetails)),
      ...{
        "blueGreenStrategy": obj.blueGreenStrategy
