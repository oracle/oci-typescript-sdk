...
export namespace UpdateBuildPipelineDetails {
  export function getJsonObj(obj: UpdateBuildPipelineDetails): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: UpdateBuildPipelineDetails): object {
    const jsonObj = {
      ...obj,
      ...{
        "buildPipelineParameters": obj.buildPipelineParameters
