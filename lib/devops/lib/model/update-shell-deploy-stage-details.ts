...
export namespace UpdateShellDeployStageDetails {
  export function getJsonObj(
    obj: UpdateShellDeployStageDetails,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.UpdateDeployStageDetails.getJsonObj(obj) as UpdateShellDeployStageDetails)),
      ...{
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ...
        : (model.UpdateDeployStageDetails.getDeserializedJsonObj(
            obj
          ) as UpdateShellDeployStageDetails)),
      ...{
        "containerConfig": obj.containerConfig
