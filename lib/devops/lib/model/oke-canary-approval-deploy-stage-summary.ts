...
export namespace OkeCanaryApprovalDeployStageSummary {
  export function getJsonObj(
    obj: OkeCanaryApprovalDeployStageSummary,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.DeployStageSummary.getJsonObj(obj) as OkeCanaryApprovalDeployStageSummary)),
      ...{
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ...
        : (model.DeployStageSummary.getDeserializedJsonObj(
            obj
          ) as OkeCanaryApprovalDeployStageSummary)),
      ...{
        "approvalPolicy": obj.approvalPolicy
