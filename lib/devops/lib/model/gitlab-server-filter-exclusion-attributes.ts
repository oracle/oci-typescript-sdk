...
export namespace GitlabServerFilterExclusionAttributes {
  export function getJsonObj(obj: GitlabServerFilterExclusionAttributes): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: GitlabServerFilterExclusionAttributes): object {
    const jsonObj = {
      ...obj,
      ...{
