...
export namespace BitbucketCloudFilter {
  export enum Events {
    Push = "PUSH",
  ...
  export function getJsonObj(obj: BitbucketCloudFilter, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj ? obj : (model.Filter.getJsonObj(obj) as BitbucketCloudFilter)),
      ...{
        "include": obj.include
  ...
  export function getDeserializedJsonObj(
    obj: BitbucketCloudFilter,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.Filter.getDeserializedJsonObj(obj) as BitbucketCloudFilter)),
      ...{
        "include": obj.include
