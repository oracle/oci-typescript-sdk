...
export namespace BitbucketServerTokenConnectionSummary {
  export function getJsonObj(
    obj: BitbucketServerTokenConnectionSummary,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.ConnectionSummary.getJsonObj(obj) as BitbucketServerTokenConnectionSummary)),
      ...{
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ...
        : (model.ConnectionSummary.getDeserializedJsonObj(
            obj
          ) as BitbucketServerTokenConnectionSummary)),
      ...{
        "tlsVerifyConfig": obj.tlsVerifyConfig
