...
export namespace CreateBuildRunDetails {
  export function getJsonObj(obj: CreateBuildRunDetails): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: CreateBuildRunDetails): object {
    const jsonObj = {
      ...obj,
      ...{
