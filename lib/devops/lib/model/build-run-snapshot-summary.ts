...
export namespace BuildRunSnapshotSummary {
  export function getJsonObj(obj: BuildRunSnapshotSummary): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: BuildRunSnapshotSummary): object {
    const jsonObj = { ...obj, ...{} };
