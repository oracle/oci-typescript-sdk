 ...
 */
export interface ComputeInstanceGroupCanaryTrafficShiftDeployStageSummary
...
export namespace ComputeInstanceGroupCanaryTrafficShiftDeployStageSummary {
  export function getJsonObj(
    obj: ComputeInstanceGroupCanaryTrafficShiftDeployStageSummary,
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ...
        : (model.DeployStageSummary.getJsonObj(
            obj
          ) as ComputeInstanceGroupCanaryTrafficShiftDeployStageSummary)),
      ...{
