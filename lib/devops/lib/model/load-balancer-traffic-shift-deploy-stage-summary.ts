...
export namespace LoadBalancerTrafficShiftDeployStageSummary {
  export function getJsonObj(
    obj: LoadBalancerTrafficShiftDeployStageSummary,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.DeployStageSummary.getJsonObj(obj) as LoadBalancerTrafficShiftDeployStageSummary)),
      ...{
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ...
        : (model.DeployStageSummary.getDeserializedJsonObj(
            obj
          ) as LoadBalancerTrafficShiftDeployStageSummary)),
      ...{
        "blueBackendIps": obj.blueBackendIps
