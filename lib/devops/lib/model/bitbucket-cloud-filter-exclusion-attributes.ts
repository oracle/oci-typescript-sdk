...
export namespace BitbucketCloudFilterExclusionAttributes {
  export function getJsonObj(obj: BitbucketCloudFilterExclusionAttributes): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: BitbucketCloudFilterExclusionAttributes): object {
    const jsonObj = {
      ...obj,
      ...{
