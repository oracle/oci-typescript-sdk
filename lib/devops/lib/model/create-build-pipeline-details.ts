...
export namespace CreateBuildPipelineDetails {
  export function getJsonObj(obj: CreateBuildPipelineDetails): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: CreateBuildPipelineDetails): object {
    const jsonObj = {
      ...obj,
      ...{
        "buildPipelineParameters": obj.buildPipelineParameters
