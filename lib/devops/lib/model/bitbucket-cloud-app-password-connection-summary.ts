...
export namespace BitbucketCloudAppPasswordConnectionSummary {
  export function getJsonObj(
    obj: BitbucketCloudAppPasswordConnectionSummary,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.ConnectionSummary.getJsonObj(obj) as BitbucketCloudAppPasswordConnectionSummary)),
      ...{}
    };
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ...
        : (model.ConnectionSummary.getDeserializedJsonObj(
            obj
          ) as BitbucketCloudAppPasswordConnectionSummary)),
      ...{}
    };
