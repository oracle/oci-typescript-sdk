      ...
      switch (obj.deploymentType) {
        case "PIPELINE_REDEPLOYMENT":
          return model.CreateDeployPipelineRedeploymentDetails.getJsonObj(
            <model.CreateDeployPipelineRedeploymentDetails>(<object>jsonObj),
            true
          );
        case "PIPELINE_DEPLOYMENT":
          return model.CreateDeployPipelineDeploymentDetails.getJsonObj(
            <model.CreateDeployPipelineDeploymentDetails>(<object>jsonObj),
            true
          );
        case "SINGLE_STAGE_DEPLOYMENT":
          return model.CreateSingleDeployStageDeploymentDetails.getJsonObj(
            <model.CreateSingleDeployStageDeploymentDetails>(<object>jsonObj),
            true
          );
        case "SINGLE_STAGE_REDEPLOYMENT":
          return model.CreateSingleDeployStageRedeploymentDetails.getJsonObj(
            <model.CreateSingleDeployStageRedeploymentDetails>(<object>jsonObj),
            true
          );
        default:
  ...
  export function getDeserializedJsonObj(obj: CreateDeploymentDetails): object {
    ...
    if (obj && "deploymentType" in obj && obj.deploymentType) {
      switch (obj.deploymentType) {
        ...
        case "PIPELINE_DEPLOYMENT":
          return model.CreateDeployPipelineDeploymentDetails.getDeserializedJsonObj(
            <model.CreateDeployPipelineDeploymentDetails>(<object>jsonObj),
            true
          );
        case "SINGLE_STAGE_DEPLOYMENT":
          return model.CreateSingleDeployStageDeploymentDetails.getDeserializedJsonObj(
            <model.CreateSingleDeployStageDeploymentDetails>(<object>jsonObj),
            true
          );
        case "SINGLE_STAGE_REDEPLOYMENT":
          return model.CreateSingleDeployStageRedeploymentDetails.getDeserializedJsonObj(
            <model.CreateSingleDeployStageRedeploymentDetails>(<object>jsonObj),
            true
          );
        default:
