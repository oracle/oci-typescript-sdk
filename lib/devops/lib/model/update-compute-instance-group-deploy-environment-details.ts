 ...
 */
export interface UpdateComputeInstanceGroupDeployEnvironmentDetails
...
export namespace UpdateComputeInstanceGroupDeployEnvironmentDetails {
  export function getJsonObj(
    obj: UpdateComputeInstanceGroupDeployEnvironmentDetails,
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ...
        : (model.UpdateDeployEnvironmentDetails.getJsonObj(
            obj
          ) as UpdateComputeInstanceGroupDeployEnvironmentDetails)),
      ...{
