...
export namespace VbsFilterAttributes {
  export function getJsonObj(obj: VbsFilterAttributes): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: VbsFilterAttributes): object {
    const jsonObj = {
      ...obj,
      ...{
