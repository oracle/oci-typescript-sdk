...
export namespace ComputeInstanceGroupBlueGreenDeployStageSummary {
  export function getJsonObj(
    obj: ComputeInstanceGroupBlueGreenDeployStageSummary,
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ...
        : (model.DeployStageSummary.getJsonObj(
            obj
          ) as ComputeInstanceGroupBlueGreenDeployStageSummary)),
      ...{
