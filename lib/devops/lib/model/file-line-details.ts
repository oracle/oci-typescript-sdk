...
export namespace FileLineDetails {
  export function getJsonObj(obj: FileLineDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: FileLineDetails): object {
    const jsonObj = { ...obj, ...{} };
