...
export namespace PullRequestCommentLikeCollection {
  export function getJsonObj(obj: PullRequestCommentLikeCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "users": obj.users
  ...
  export function getDeserializedJsonObj(obj: PullRequestCommentLikeCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "users": obj.users
