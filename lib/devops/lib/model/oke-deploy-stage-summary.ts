...
export namespace OkeDeployStageSummary {
  export function getJsonObj(obj: OkeDeployStageSummary, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.DeployStageSummary.getJsonObj(obj) as OkeDeployStageSummary)),
      ...{
  ...
  export function getDeserializedJsonObj(
    obj: OkeDeployStageSummary,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.DeployStageSummary.getDeserializedJsonObj(obj) as OkeDeployStageSummary)),
      ...{
        "rollbackPolicy": obj.rollbackPolicy
