...
export namespace DeployPipelineStage {
  export function getJsonObj(obj: DeployPipelineStage): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: DeployPipelineStage): object {
    const jsonObj = { ...obj, ...{} };
