...
export namespace BuildPipelineSummary {
  export function getJsonObj(obj: BuildPipelineSummary): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: BuildPipelineSummary): object {
    const jsonObj = {
      ...obj,
      ...{
        "buildPipelineParameters": obj.buildPipelineParameters
