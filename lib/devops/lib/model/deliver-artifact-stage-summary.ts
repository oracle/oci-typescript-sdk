...
export namespace DeliverArtifactStageSummary {
  export function getJsonObj(obj: DeliverArtifactStageSummary, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.BuildPipelineStageSummary.getJsonObj(obj) as DeliverArtifactStageSummary)),
      ...{
  ...
  export function getDeserializedJsonObj(
    obj: DeliverArtifactStageSummary,
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ...
        : (model.BuildPipelineStageSummary.getDeserializedJsonObj(
            obj
          ) as DeliverArtifactStageSummary)),
      ...{
        "deliverArtifactCollection": obj.deliverArtifactCollection
