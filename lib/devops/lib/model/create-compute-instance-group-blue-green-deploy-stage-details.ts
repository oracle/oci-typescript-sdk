 ...
 */
export interface CreateComputeInstanceGroupBlueGreenDeployStageDetails
...
export namespace CreateComputeInstanceGroupBlueGreenDeployStageDetails {
  export function getJsonObj(
    obj: CreateComputeInstanceGroupBlueGreenDeployStageDetails,
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ...
        : (model.CreateDeployStageDetails.getJsonObj(
            obj
          ) as CreateComputeInstanceGroupBlueGreenDeployStageDetails)),
      ...{
