...
export namespace ChangeWlsDomainCompartmentDetails {
  export function getJsonObj(obj: ChangeWlsDomainCompartmentDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: ChangeWlsDomainCompartmentDetails): object {
    const jsonObj = { ...obj, ...{} };
