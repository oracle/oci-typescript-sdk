...
export namespace ScanResultCollection {
  export function getJsonObj(obj: ScanResultCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
  ...
  export function getDeserializedJsonObj(obj: ScanResultCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
