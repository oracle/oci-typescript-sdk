...
export namespace ApplicablePatchSummary {
  ...
  export function getJsonObj(obj: ApplicablePatchSummary): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: ApplicablePatchSummary): object {
    const jsonObj = { ...obj, ...{} };
