...
export namespace WlsDomainCollection {
  export function getJsonObj(obj: WlsDomainCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
  ...
  export function getDeserializedJsonObj(obj: WlsDomainCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
