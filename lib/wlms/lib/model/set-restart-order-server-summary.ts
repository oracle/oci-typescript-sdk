...
export namespace SetRestartOrderServerSummary {
  export function getJsonObj(obj: SetRestartOrderServerSummary): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: SetRestartOrderServerSummary): object {
    const jsonObj = { ...obj, ...{} };
