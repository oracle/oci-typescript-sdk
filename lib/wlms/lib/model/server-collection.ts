...
export namespace ServerCollection {
  export function getJsonObj(obj: ServerCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
  ...
  export function getDeserializedJsonObj(obj: ServerCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
