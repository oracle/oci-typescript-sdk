...
export namespace WlsDomainCredentialSummary {
  export function getJsonObj(obj: WlsDomainCredentialSummary): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: WlsDomainCredentialSummary): object {
    const jsonObj = { ...obj, ...{} };
