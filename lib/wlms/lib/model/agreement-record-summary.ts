...
export namespace AgreementRecordSummary {
  export function getJsonObj(obj: AgreementRecordSummary): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: AgreementRecordSummary): object {
    const jsonObj = { ...obj, ...{} };
