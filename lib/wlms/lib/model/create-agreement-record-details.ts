...
export namespace CreateAgreementRecordDetails {
  export function getJsonObj(obj: CreateAgreementRecordDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: CreateAgreementRecordDetails): object {
    const jsonObj = { ...obj, ...{} };
