...
export namespace UpdateWlsDomainConfigurationDetails {
  export function getJsonObj(obj: UpdateWlsDomainConfigurationDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: UpdateWlsDomainConfigurationDetails): object {
    const jsonObj = { ...obj, ...{} };
