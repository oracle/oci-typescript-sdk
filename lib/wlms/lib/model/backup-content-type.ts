...
export namespace BackupContentType {
  export function getJsonObj(obj: BackupContentType): BackupContentType {
    return obj;
  }
  export function getDeserializedJsonObj(obj: BackupContentType): BackupContentType {
    return obj;
  }
}
