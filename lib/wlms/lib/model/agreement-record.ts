...
export namespace AgreementRecord {
  export function getJsonObj(obj: AgreementRecord): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: AgreementRecord): object {
    const jsonObj = { ...obj, ...{} };
