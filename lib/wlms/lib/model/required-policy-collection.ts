...
export namespace RequiredPolicyCollection {
  export function getJsonObj(obj: RequiredPolicyCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
  ...
  export function getDeserializedJsonObj(obj: RequiredPolicyCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
