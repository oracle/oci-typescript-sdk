...
export namespace InstalledPatchCollection {
  export function getJsonObj(obj: InstalledPatchCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
  ...
  export function getDeserializedJsonObj(obj: InstalledPatchCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
