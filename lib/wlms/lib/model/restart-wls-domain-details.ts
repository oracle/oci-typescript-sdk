...
export namespace RestartWlsDomainDetails {
  export function getJsonObj(obj: RestartWlsDomainDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: RestartWlsDomainDetails): object {
    const jsonObj = { ...obj, ...{} };
