...
export namespace WlsDomainCredentialCollection {
  export function getJsonObj(obj: WlsDomainCredentialCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
  ...
  export function getDeserializedJsonObj(obj: WlsDomainCredentialCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
