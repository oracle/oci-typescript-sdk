...
export namespace AgreementRecordCollection {
  export function getJsonObj(obj: AgreementRecordCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
  ...
  export function getDeserializedJsonObj(obj: AgreementRecordCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
