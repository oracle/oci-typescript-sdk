...
export namespace UpdateWlsDomainCredentialDetails {
  export function getJsonObj(obj: UpdateWlsDomainCredentialDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: UpdateWlsDomainCredentialDetails): object {
    const jsonObj = { ...obj, ...{} };
