...
/**
 * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/datacatalog/GetTermRelationship.ts.html |here} to see how to use GetTermRelationshipRequest.
 */
...
export namespace GetTermRelationshipRequest {
  export enum Fields {
    Key = "key",
