...
export namespace ImportLineageJobResult {
  export function getJsonObj(obj: ImportLineageJobResult): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: ImportLineageJobResult): object {
    const jsonObj = { ...obj, ...{} };
