...
export namespace AsynchronousExportRequestDetails {
  export function getJsonObj(obj: AsynchronousExportRequestDetails): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: AsynchronousExportRequestDetails): object {
    const jsonObj = {
      ...obj,
      ...{
        "objectStorageTarget": obj.objectStorageTarget
