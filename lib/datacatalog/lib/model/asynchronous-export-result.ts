...
export namespace AsynchronousExportResult {
  export function getJsonObj(obj: AsynchronousExportResult): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: AsynchronousExportResult): object {
    const jsonObj = { ...obj, ...{} };
