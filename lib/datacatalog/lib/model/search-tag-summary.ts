...
export namespace SearchTagSummary {
  export function getJsonObj(obj: SearchTagSummary): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: SearchTagSummary): object {
    const jsonObj = { ...obj, ...{} };
