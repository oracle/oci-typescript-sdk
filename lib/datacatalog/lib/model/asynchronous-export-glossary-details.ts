...
export namespace AsynchronousExportGlossaryDetails {
  export function getJsonObj(obj: AsynchronousExportGlossaryDetails): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: AsynchronousExportGlossaryDetails): object {
    const jsonObj = {
      ...obj,
      ...{
        "objectStorageTarget": obj.objectStorageTarget
