...
export namespace UpdatePatternDetails {
  export function getJsonObj(obj: UpdatePatternDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: UpdatePatternDetails): object {
    const jsonObj = { ...obj, ...{} };
