...
export namespace OpsActionUpdateMacDeviceDetails {
  ...
  export function getJsonObj(obj: OpsActionUpdateMacDeviceDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: OpsActionUpdateMacDeviceDetails): object {
    const jsonObj = { ...obj, ...{} };
