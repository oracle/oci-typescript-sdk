...
export namespace MacDeviceCollection {
  export function getJsonObj(obj: MacDeviceCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
  ...
  export function getDeserializedJsonObj(obj: MacDeviceCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
