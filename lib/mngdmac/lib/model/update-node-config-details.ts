...
export namespace UpdateNodeConfigDetails {
  export function getJsonObj(obj: UpdateNodeConfigDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: UpdateNodeConfigDetails): object {
    const jsonObj = { ...obj, ...{} };
