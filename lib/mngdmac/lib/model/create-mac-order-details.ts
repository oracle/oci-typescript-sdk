...
export namespace CreateMacOrderDetails {
  export function getJsonObj(obj: CreateMacOrderDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: CreateMacOrderDetails): object {
    const jsonObj = { ...obj, ...{} };
