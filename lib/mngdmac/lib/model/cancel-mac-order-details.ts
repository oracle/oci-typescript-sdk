...
export namespace CancelMacOrderDetails {
  export function getJsonObj(obj: CancelMacOrderDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: CancelMacOrderDetails): object {
    const jsonObj = { ...obj, ...{} };
