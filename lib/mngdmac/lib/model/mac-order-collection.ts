...
export namespace MacOrderCollection {
  export function getJsonObj(obj: MacOrderCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
  ...
  export function getDeserializedJsonObj(obj: MacOrderCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
