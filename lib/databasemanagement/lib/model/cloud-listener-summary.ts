...
export namespace CloudListenerSummary {
  export function getJsonObj(obj: CloudListenerSummary): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: CloudListenerSummary): object {
    const jsonObj = { ...obj, ...{} };
