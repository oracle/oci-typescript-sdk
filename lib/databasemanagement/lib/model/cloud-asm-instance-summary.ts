...
export namespace CloudAsmInstanceSummary {
  export function getJsonObj(obj: CloudAsmInstanceSummary): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: CloudAsmInstanceSummary): object {
    const jsonObj = { ...obj, ...{} };
