...
export namespace ExternalServicedDatabase {
  export function getJsonObj(obj: ExternalServicedDatabase): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: ExternalServicedDatabase): object {
    const jsonObj = { ...obj, ...{} };
