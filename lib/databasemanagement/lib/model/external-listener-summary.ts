...
export namespace ExternalListenerSummary {
  export function getJsonObj(obj: ExternalListenerSummary): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: ExternalListenerSummary): object {
    const jsonObj = { ...obj, ...{} };
