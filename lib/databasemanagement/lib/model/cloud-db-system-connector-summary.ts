...
export namespace CloudDbSystemConnectorSummary {
  ...
  export function getJsonObj(obj: CloudDbSystemConnectorSummary): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: CloudDbSystemConnectorSummary): object {
    const jsonObj = { ...obj, ...{} };
