...
export namespace MySqlCredType {
  export function getJsonObj(obj: MySqlCredType): MySqlCredType {
    return obj;
  }
  export function getDeserializedJsonObj(obj: MySqlCredType): MySqlCredType {
    return obj;
  }
}
