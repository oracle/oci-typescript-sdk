...
export namespace CloudListenerServicedDatabase {
  export function getJsonObj(obj: CloudListenerServicedDatabase): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: CloudListenerServicedDatabase): object {
    const jsonObj = { ...obj, ...{} };
