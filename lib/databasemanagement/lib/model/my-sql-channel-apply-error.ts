...
export namespace MySqlChannelApplyError {
  export function getJsonObj(obj: MySqlChannelApplyError): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: MySqlChannelApplyError): object {
    const jsonObj = {
      ...obj,
      ...{
