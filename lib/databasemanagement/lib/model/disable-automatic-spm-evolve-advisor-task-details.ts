...
export namespace DisableAutomaticSpmEvolveAdvisorTaskDetails {
  export function getJsonObj(obj: DisableAutomaticSpmEvolveAdvisorTaskDetails): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: DisableAutomaticSpmEvolveAdvisorTaskDetails): object {
    const jsonObj = {
      ...obj,
      ...{
        "credentials": obj.credentials
