...
export namespace EnableHighFrequencyAutomaticSpmEvolveAdvisorTaskDetails {
  export function getJsonObj(obj: EnableHighFrequencyAutomaticSpmEvolveAdvisorTaskDetails): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(
    obj: EnableHighFrequencyAutomaticSpmEvolveAdvisorTaskDetails
  ): object {
    const jsonObj = {
      ...obj,
      ...{
