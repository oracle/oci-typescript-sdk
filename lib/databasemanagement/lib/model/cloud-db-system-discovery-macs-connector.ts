...
export namespace CloudDbSystemDiscoveryMacsConnector {
  export function getJsonObj(
    obj: CloudDbSystemDiscoveryMacsConnector,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.CloudDbSystemDiscoveryConnector.getJsonObj(
            obj
          ) as CloudDbSystemDiscoveryMacsConnector)),
      ...{
  ...
  export function getDeserializedJsonObj(
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.CloudDbSystemDiscoveryConnector.getDeserializedJsonObj(
            obj
          ) as CloudDbSystemDiscoveryMacsConnector)),
      ...{
        "connectionInfo": obj.connectionInfo
