...
export namespace CloudExadataStorageServerSummary {
  export function getJsonObj(
    obj: CloudExadataStorageServerSummary,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.DbmResource.getJsonObj(obj) as CloudExadataStorageServerSummary)),
      ...{}
    };

    return jsonObj;
  }
  export const resourceType = "CLOUD_STORAGE_SERVER_SUMMARY";
  export function getDeserializedJsonObj(
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.DbmResource.getDeserializedJsonObj(obj) as CloudExadataStorageServerSummary)),
      ...{}
    };
