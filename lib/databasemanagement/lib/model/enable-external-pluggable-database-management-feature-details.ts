...
export namespace EnableExternalPluggableDatabaseManagementFeatureDetails {
  export function getJsonObj(obj: EnableExternalPluggableDatabaseManagementFeatureDetails): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(
    obj: EnableExternalPluggableDatabaseManagementFeatureDetails
  ): object {
    const jsonObj = {
      ...obj,
      ...{
