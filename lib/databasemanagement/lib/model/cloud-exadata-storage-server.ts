...
export namespace CloudExadataStorageServer {
  export function getJsonObj(obj: CloudExadataStorageServer, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj ? obj : (model.DbmResource.getJsonObj(obj) as CloudExadataStorageServer)),
      ...{
  ...
  export const resourceType = "CLOUD_STORAGE_SERVER";
  export function getDeserializedJsonObj(
    obj: CloudExadataStorageServer,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.DbmResource.getDeserializedJsonObj(obj) as CloudExadataStorageServer)),
      ...{
        "connector": obj.connector
