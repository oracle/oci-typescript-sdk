...
export namespace UpdateExternalClusterInstanceDetails {
  export function getJsonObj(obj: UpdateExternalClusterInstanceDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: UpdateExternalClusterInstanceDetails): object {
    const jsonObj = { ...obj, ...{} };
