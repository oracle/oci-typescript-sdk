...
export namespace CloudClusterSummary {
  export function getJsonObj(obj: CloudClusterSummary): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: CloudClusterSummary): object {
    const jsonObj = { ...obj, ...{} };
