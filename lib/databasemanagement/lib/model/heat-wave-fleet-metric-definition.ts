...
export namespace HeatWaveFleetMetricDefinition {
  export function getJsonObj(obj: HeatWaveFleetMetricDefinition): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: HeatWaveFleetMetricDefinition): object {
    const jsonObj = {
      ...obj,
      ...{
        "dimensions": obj.dimensions
