...
export namespace MySqlConnectorCollection {
  export function getJsonObj(obj: MySqlConnectorCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
  ...
  export function getDeserializedJsonObj(obj: MySqlConnectorCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
