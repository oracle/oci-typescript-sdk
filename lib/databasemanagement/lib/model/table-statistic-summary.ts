...
export namespace TableStatisticSummary {
  export function getJsonObj(obj: TableStatisticSummary): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: TableStatisticSummary): object {
    const jsonObj = { ...obj, ...{} };
