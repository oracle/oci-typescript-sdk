...
export namespace UpdateExternalMySqlDatabaseConnectorDetails {
  export function getJsonObj(obj: UpdateExternalMySqlDatabaseConnectorDetails): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: UpdateExternalMySqlDatabaseConnectorDetails): object {
    const jsonObj = {
      ...obj,
      ...{
        "connectorDetails": obj.connectorDetails
