...
export namespace MySqlReplicationApplierFilter {
  export function getJsonObj(obj: MySqlReplicationApplierFilter): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: MySqlReplicationApplierFilter): object {
    const jsonObj = { ...obj, ...{} };
