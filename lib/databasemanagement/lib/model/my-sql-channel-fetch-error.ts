...
export namespace MySqlChannelFetchError {
  export function getJsonObj(obj: MySqlChannelFetchError): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: MySqlChannelFetchError): object {
    const jsonObj = {
      ...obj,
      ...{
