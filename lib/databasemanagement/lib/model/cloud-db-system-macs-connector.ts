...
export namespace CloudDbSystemMacsConnector {
  export function getJsonObj(obj: CloudDbSystemMacsConnector, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.CloudDbSystemConnector.getJsonObj(obj) as CloudDbSystemMacsConnector)),
      ...{
  ...
  export function getDeserializedJsonObj(
    obj: CloudDbSystemMacsConnector,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.CloudDbSystemConnector.getDeserializedJsonObj(obj) as CloudDbSystemMacsConnector)),
      ...{
        "connectionInfo": obj.connectionInfo
