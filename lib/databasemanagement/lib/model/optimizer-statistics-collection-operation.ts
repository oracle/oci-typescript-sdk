...
export namespace OptimizerStatisticsCollectionOperation {
  export enum Status {
  ...
  export function getJsonObj(obj: OptimizerStatisticsCollectionOperation): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: OptimizerStatisticsCollectionOperation): object {
    const jsonObj = {
      ...obj,
      ...{
