...
export namespace ExternalExadataStorageServerCollection {
  export function getJsonObj(obj: ExternalExadataStorageServerCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
  ...
  export function getDeserializedJsonObj(obj: ExternalExadataStorageServerCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
