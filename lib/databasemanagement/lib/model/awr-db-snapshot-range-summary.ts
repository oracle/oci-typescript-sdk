...
export namespace AwrDbSnapshotRangeSummary {
  export function getJsonObj(obj: AwrDbSnapshotRangeSummary): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: AwrDbSnapshotRangeSummary): object {
    const jsonObj = { ...obj, ...{} };
