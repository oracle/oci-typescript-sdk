...
export namespace ExternalMySqlDatabaseCollection {
  export function getJsonObj(obj: ExternalMySqlDatabaseCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
  ...
  export function getDeserializedJsonObj(obj: ExternalMySqlDatabaseCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
