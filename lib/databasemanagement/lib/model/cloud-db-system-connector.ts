...
export namespace CloudDbSystemConnector {
  ...
  export function getJsonObj(obj: CloudDbSystemConnector): object {
    const jsonObj = { ...obj, ...{} };

    if (obj && "connectorType" in obj && obj.connectorType) {
      switch (obj.connectorType) {
        case "MACS":
          return model.CloudDbSystemMacsConnector.getJsonObj(
            <model.CloudDbSystemMacsConnector>(<object>jsonObj),
            true
          );
        default:
  ...
  export function getDeserializedJsonObj(obj: CloudDbSystemConnector): object {
    const jsonObj = { ...obj, ...{} };

    if (obj && "connectorType" in obj && obj.connectorType) {
      switch (obj.connectorType) {
        case "MACS":
          return model.CloudDbSystemMacsConnector.getDeserializedJsonObj(
            <model.CloudDbSystemMacsConnector>(<object>jsonObj),
            true
          );
        default:
