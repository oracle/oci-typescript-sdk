...
export namespace AsmConnectionCredentialsByDetails {
  export enum Role {
    Sysasm = "SYSASM",
    Sysdba = "SYSDBA",
    Sysoper = "SYSOPER",
  ...
  export function getJsonObj(
    obj: AsmConnectionCredentialsByDetails,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.AsmConnectionCredentials.getJsonObj(obj) as AsmConnectionCredentialsByDetails)),
      ...{}
    };
  ...
  export function getDeserializedJsonObj(
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.AsmConnectionCredentials.getDeserializedJsonObj(
            obj
          ) as AsmConnectionCredentialsByDetails)),
      ...{}
    };
