...
export namespace TimeSeriesMetricDataPoint {
  export function getJsonObj(obj: TimeSeriesMetricDataPoint): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: TimeSeriesMetricDataPoint): object {
    const jsonObj = {
      ...obj,
      ...{
        "dimensions": obj.dimensions
