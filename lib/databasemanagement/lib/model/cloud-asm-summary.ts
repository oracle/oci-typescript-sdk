...
export namespace CloudAsmSummary {
  export function getJsonObj(obj: CloudAsmSummary): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: CloudAsmSummary): object {
    const jsonObj = { ...obj, ...{} };
