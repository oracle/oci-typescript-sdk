 ...
 *
 **/
export enum TableStatisticsStatusCategory {
  NoStats = "NO_STATS",
  Stale = "STALE",
  NotStale = "NOT_STALE",
...
export namespace TableStatisticsStatusCategory {
  export function getJsonObj(obj: TableStatisticsStatusCategory): TableStatisticsStatusCategory {
    return obj;
  }
  export function getDeserializedJsonObj(
    obj: TableStatisticsStatusCategory
