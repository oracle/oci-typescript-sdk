...
export namespace MySqlFleetMetricSummaryDefinition {
  export function getJsonObj(obj: MySqlFleetMetricSummaryDefinition): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: MySqlFleetMetricSummaryDefinition): object {
    const jsonObj = {
      ...obj,
      ...{
        "dimensions": obj.dimensions
