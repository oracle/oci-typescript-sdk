...
export namespace ExternalAsmDiskGroupSummary {
  ...
  export function getJsonObj(obj: ExternalAsmDiskGroupSummary): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: ExternalAsmDiskGroupSummary): object {
    const jsonObj = { ...obj, ...{} };
