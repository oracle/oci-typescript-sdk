...
export namespace AsmConnectionCredentailsByName {
  export function getJsonObj(
    obj: AsmConnectionCredentailsByName,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.AsmConnectionCredentials.getJsonObj(obj) as AsmConnectionCredentailsByName)),
      ...{}
    };
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ...
        : (model.AsmConnectionCredentials.getDeserializedJsonObj(
            obj
          ) as AsmConnectionCredentailsByName)),
      ...{}
    };
