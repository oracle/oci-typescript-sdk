...
export namespace CloudOpenAlertHistory {
  export function getJsonObj(obj: CloudOpenAlertHistory): object {
    const jsonObj = {
      ...obj,
      ...{
        "alerts": obj.alerts
  ...
  export function getDeserializedJsonObj(obj: CloudOpenAlertHistory): object {
    const jsonObj = {
      ...obj,
      ...{
        "alerts": obj.alerts
