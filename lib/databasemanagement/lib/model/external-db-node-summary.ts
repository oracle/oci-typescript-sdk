...
export namespace ExternalDbNodeSummary {
  export function getJsonObj(obj: ExternalDbNodeSummary): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: ExternalDbNodeSummary): object {
    const jsonObj = { ...obj, ...{} };
