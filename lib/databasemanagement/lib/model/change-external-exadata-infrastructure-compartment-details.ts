...
export namespace ChangeExternalExadataInfrastructureCompartmentDetails {
  export function getJsonObj(obj: ChangeExternalExadataInfrastructureCompartmentDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(
    obj: ChangeExternalExadataInfrastructureCompartmentDetails
  ): object {
    const jsonObj = { ...obj, ...{} };
