...
export namespace DatabaseBackupMetrics {
  export function getJsonObj(obj: DatabaseBackupMetrics): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: DatabaseBackupMetrics): object {
    const jsonObj = {
      ...obj,
      ...{
        "timeSeriesMetrics": obj.timeSeriesMetrics
