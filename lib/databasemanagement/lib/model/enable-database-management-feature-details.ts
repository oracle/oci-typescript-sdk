...
export namespace EnableDatabaseManagementFeatureDetails {
  export function getJsonObj(obj: EnableDatabaseManagementFeatureDetails): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: EnableDatabaseManagementFeatureDetails): object {
    const jsonObj = {
      ...obj,
      ...{
        "featureDetails": obj.featureDetails
