...
export namespace ExternalAsmInstance {
  ...
  export function getJsonObj(obj: ExternalAsmInstance): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: ExternalAsmInstance): object {
    const jsonObj = { ...obj, ...{} };
