...
export namespace CloudAsmServicedDatabase {
  export function getJsonObj(obj: CloudAsmServicedDatabase): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: CloudAsmServicedDatabase): object {
    const jsonObj = { ...obj, ...{} };
