...
export namespace CloudAsmInstanceParameters {
  export function getJsonObj(obj: CloudAsmInstanceParameters): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: CloudAsmInstanceParameters): object {
    const jsonObj = { ...obj, ...{} };
