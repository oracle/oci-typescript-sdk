...
export namespace TablespaceAdminStatus {
  export enum Status {
    Succeeded = "SUCCEEDED",
    Failed = "FAILED",
    /**
  ...
  export function getJsonObj(obj: TablespaceAdminStatus): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: TablespaceAdminStatus): object {
    const jsonObj = { ...obj, ...{} };
