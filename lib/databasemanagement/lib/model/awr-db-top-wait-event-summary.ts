...
export namespace AwrDbTopWaitEventSummary {
  export function getJsonObj(obj: AwrDbTopWaitEventSummary): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: AwrDbTopWaitEventSummary): object {
    const jsonObj = { ...obj, ...{} };
