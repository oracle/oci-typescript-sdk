...
export namespace CloudDbNodeSummary {
  export function getJsonObj(obj: CloudDbNodeSummary): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: CloudDbNodeSummary): object {
    const jsonObj = { ...obj, ...{} };
