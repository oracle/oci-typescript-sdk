...
export namespace EnableSqlPlanBaselinesUsageDetails {
  export function getJsonObj(obj: EnableSqlPlanBaselinesUsageDetails): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: EnableSqlPlanBaselinesUsageDetails): object {
    const jsonObj = {
      ...obj,
      ...{
        "credentials": obj.credentials
