...
export namespace ExternalDbSystemMacsConnector {
  export function getJsonObj(
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.ExternalDbSystemConnector.getJsonObj(obj) as ExternalDbSystemMacsConnector)),
      ...{
  ...
  export function getDeserializedJsonObj(
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.ExternalDbSystemConnector.getDeserializedJsonObj(
            obj
          ) as ExternalDbSystemMacsConnector)),
      ...{
        "connectionInfo": obj.connectionInfo
