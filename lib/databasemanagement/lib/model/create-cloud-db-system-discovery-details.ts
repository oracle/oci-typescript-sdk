...
export namespace CreateCloudDbSystemDiscoveryDetails {
  export function getJsonObj(obj: CreateCloudDbSystemDiscoveryDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: CreateCloudDbSystemDiscoveryDetails): object {
    const jsonObj = { ...obj, ...{} };
