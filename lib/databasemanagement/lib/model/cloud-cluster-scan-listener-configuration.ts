...
export namespace CloudClusterScanListenerConfiguration {
  ...
  export function getJsonObj(obj: CloudClusterScanListenerConfiguration): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: CloudClusterScanListenerConfiguration): object {
    const jsonObj = { ...obj, ...{} };
