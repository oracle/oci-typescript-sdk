...
export namespace CloudExadataStorageConnector {
  export function getJsonObj(obj: CloudExadataStorageConnector, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.DbmResource.getJsonObj(obj) as CloudExadataStorageConnector)),
      ...{}
    };

    return jsonObj;
  }
  export const resourceType = "CLOUD_STORAGE_CONNECTOR";
  export function getDeserializedJsonObj(
    obj: CloudExadataStorageConnector,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.DbmResource.getDeserializedJsonObj(obj) as CloudExadataStorageConnector)),
      ...{}
    };
