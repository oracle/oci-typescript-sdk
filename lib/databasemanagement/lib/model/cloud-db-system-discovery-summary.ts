...
export namespace CloudDbSystemDiscoverySummary {
  export function getJsonObj(obj: CloudDbSystemDiscoverySummary): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: CloudDbSystemDiscoverySummary): object {
    const jsonObj = { ...obj, ...{} };
