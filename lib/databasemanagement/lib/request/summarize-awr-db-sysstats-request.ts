...
/**
 * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/databasemanagement/SummarizeAwrDbSysstats.ts.html |here} to see how to use SummarizeAwrDbSysstatsRequest.
 */
...
export namespace SummarizeAwrDbSysstatsRequest {
  export enum SortBy {
