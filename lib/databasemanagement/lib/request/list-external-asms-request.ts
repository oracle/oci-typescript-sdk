...
/**
 * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/databasemanagement/ListExternalAsms.ts.html |here} to see how to use ListExternalAsmsRequest.
 */
...
export namespace ListExternalAsmsRequest {
  export enum SortBy {
