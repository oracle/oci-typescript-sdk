...
/**
 * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/databasemanagement/ListExternalDbNodes.ts.html |here} to see how to use ListExternalDbNodesRequest.
 */
...
export namespace ListExternalDbNodesRequest {
  export enum SortBy {
