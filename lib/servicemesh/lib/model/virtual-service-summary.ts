...
export namespace VirtualServiceSummary {
  export function getJsonObj(obj: VirtualServiceSummary): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: VirtualServiceSummary): object {
    const jsonObj = { ...obj, ...{} };
