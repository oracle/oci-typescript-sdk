 ...
 */
export interface CreateIngressGatewayRouteTableDetails {
  /**
...
export namespace CreateIngressGatewayRouteTableDetails {
  export function getJsonObj(obj: CreateIngressGatewayRouteTableDetails): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: CreateIngressGatewayRouteTableDetails): object {
    const jsonObj = {
      ...obj,
      ...{
        "routeRules": obj.routeRules
