 ...
 *
 */
export interface CreateIngressGatewayMutualTransportLayerSecurityDetails {
  /**
...
export namespace CreateIngressGatewayMutualTransportLayerSecurityDetails {
  export function getJsonObj(obj: CreateIngressGatewayMutualTransportLayerSecurityDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(
    obj: CreateIngressGatewayMutualTransportLayerSecurityDetails
  ): object {
    const jsonObj = { ...obj, ...{} };
