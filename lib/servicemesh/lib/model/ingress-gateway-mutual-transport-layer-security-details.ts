 ...
 *
 */
export interface IngressGatewayMutualTransportLayerSecurityDetails {
  /**
...
export namespace IngressGatewayMutualTransportLayerSecurityDetails {
  export function getJsonObj(obj: IngressGatewayMutualTransportLayerSecurityDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(
    obj: IngressGatewayMutualTransportLayerSecurityDetails
  ): object {
    const jsonObj = { ...obj, ...{} };
