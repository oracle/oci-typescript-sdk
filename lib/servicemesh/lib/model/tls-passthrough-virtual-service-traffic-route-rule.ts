...
export interface TlsPassthroughVirtualServiceTrafficRouteRule
  extends model.VirtualServiceTrafficRouteRule {
  "type": string;
}

export namespace TlsPassthroughVirtualServiceTrafficRouteRule {
  export function getJsonObj(
    obj: TlsPassthroughVirtualServiceTrafficRouteRule,
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ...
        : (model.VirtualServiceTrafficRouteRule.getJsonObj(
            obj
          ) as TlsPassthroughVirtualServiceTrafficRouteRule)),
      ...{}
    };
