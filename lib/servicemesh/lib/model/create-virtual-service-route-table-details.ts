...
* 
   ...
   */
  "routeRules": Array<model.VirtualServiceTrafficRouteRuleDetails>;
  /**
      ...
      ...{
        "routeRules": obj.routeRules
          ? obj.routeRules.map(item => {
              return model.VirtualServiceTrafficRouteRuleDetails.getJsonObj(item);
            })
          : undefined
      }
    };
  ...
  export function getDeserializedJsonObj(obj: CreateVirtualServiceRouteTableDetails): object {
    const jsonObj = {
      ...
      ...{
        "routeRules": obj.routeRules
          ? obj.routeRules.map(item => {
              return model.VirtualServiceTrafficRouteRuleDetails.getDeserializedJsonObj(item);
            })
          : undefined
      }
    };
