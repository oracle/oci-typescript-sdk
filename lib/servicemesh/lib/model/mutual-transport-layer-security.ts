 ...
 *
 */
export interface MutualTransportLayerSecurity {
  /**
   ...
   *
   */
  "mode": MutualTransportLayerSecurity.Mode;
}

export namespace MutualTransportLayerSecurity {
  export enum Mode {
    Disabled = "DISABLED",
  ...
  export function getJsonObj(obj: MutualTransportLayerSecurity): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: MutualTransportLayerSecurity): object {
    const jsonObj = { ...obj, ...{} };
