 ...
 *
 */
export interface CreateMutualTransportLayerSecurityDetails {
  /**
...
export namespace CreateMutualTransportLayerSecurityDetails {
  export function getJsonObj(obj: CreateMutualTransportLayerSecurityDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: CreateMutualTransportLayerSecurityDetails): object {
    const jsonObj = { ...obj, ...{} };
