 ...
 */
export interface CreateAccessPolicyDetails {
  /**
...
export namespace CreateAccessPolicyDetails {
  export function getJsonObj(obj: CreateAccessPolicyDetails): object {
    const jsonObj = {
      ...obj,
      ...{
        "rules": obj.rules
  ...
  export function getDeserializedJsonObj(obj: CreateAccessPolicyDetails): object {
    const jsonObj = {
      ...obj,
      ...{
        "rules": obj.rules
