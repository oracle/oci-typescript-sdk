 ...
 */
export interface VirtualServiceRouteTable {
  /**
...
* 
   ...
   */
  "lifecycleState": VirtualServiceRouteTable.LifecycleState;
  /**
...
export namespace VirtualServiceRouteTable {
  ...
  export function getJsonObj(obj: VirtualServiceRouteTable): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: VirtualServiceRouteTable): object {
    const jsonObj = {
      ...obj,
      ...{
        "routeRules": obj.routeRules
