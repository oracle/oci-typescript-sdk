 ...
 */
export interface VirtualDeploymentTrafficRuleTargetDetails extends model.TrafficRuleTargetDetails {
  /**
...
export namespace VirtualDeploymentTrafficRuleTargetDetails {
  export function getJsonObj(
    obj: VirtualDeploymentTrafficRuleTargetDetails,
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ...
        : (model.TrafficRuleTargetDetails.getJsonObj(
            obj
          ) as VirtualDeploymentTrafficRuleTargetDetails)),
      ...{}
    };
