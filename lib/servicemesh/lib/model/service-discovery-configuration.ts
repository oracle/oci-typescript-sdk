  ...
  export function getJsonObj(obj: ServiceDiscoveryConfiguration): object {
    ...
    if (obj && "type" in obj && obj.type) {
      switch (obj.type) {
        ...
        case "DISABLED":
          return model.DisabledServiceDiscoveryConfiguration.getJsonObj(
            <model.DisabledServiceDiscoveryConfiguration>(<object>jsonObj),
            true
          );
        default:
  ...
  export function getDeserializedJsonObj(obj: ServiceDiscoveryConfiguration): object {
    ...
    if (obj && "type" in obj && obj.type) {
      switch (obj.type) {
        ...
        case "DISABLED":
          return model.DisabledServiceDiscoveryConfiguration.getDeserializedJsonObj(
            <model.DisabledServiceDiscoveryConfiguration>(<object>jsonObj),
            true
          );
        default:
