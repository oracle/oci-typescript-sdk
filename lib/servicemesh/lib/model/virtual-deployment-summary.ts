 ...
 */
export interface VirtualDeploymentSummary {
  /**
...
export namespace VirtualDeploymentSummary {
  export function getJsonObj(obj: VirtualDeploymentSummary): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: VirtualDeploymentSummary): object {
    const jsonObj = { ...obj, ...{} };
