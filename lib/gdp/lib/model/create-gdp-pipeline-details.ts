...
export namespace CreateGdpPipelineDetails {
  export function getJsonObj(obj: CreateGdpPipelineDetails): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: CreateGdpPipelineDetails): object {
    const jsonObj = {
      ...obj,
      ...{
        "bucketDetails": obj.bucketDetails
