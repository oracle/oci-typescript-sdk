 ...
 */
export interface GdpPipelineCollection {
  /**
   * List of pipelines within a compartment.
   */
  "items": Array<model.GdpPipelineSummary>;
}

export namespace GdpPipelineCollection {
  export function getJsonObj(obj: GdpPipelineCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
  ...
  export function getDeserializedJsonObj(obj: GdpPipelineCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
