...
export namespace UpdateGdpPipelineDetails {
  export function getJsonObj(obj: UpdateGdpPipelineDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: UpdateGdpPipelineDetails): object {
    const jsonObj = { ...obj, ...{} };
