...
export namespace ScheduledPolicy {
  export function getJsonObj(obj: ScheduledPolicy, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj ? obj : (model.AutoScalingPolicy.getJsonObj(obj) as ScheduledPolicy)),
      ...{
  ...
  export function getDeserializedJsonObj(obj: ScheduledPolicy, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.AutoScalingPolicy.getDeserializedJsonObj(obj) as ScheduledPolicy)),
      ...{
        "executionSchedule": obj.executionSchedule
