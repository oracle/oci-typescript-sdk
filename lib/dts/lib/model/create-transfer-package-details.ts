...
export interface CreateTransferPackageDetails {
  "originalPackageDeliveryTrackingNumber"?: string;
  "returnPackageDeliveryTrackingNumber"?: string;
  "packageDeliveryVendor"?: string;
}

export namespace CreateTransferPackageDetails {
  export function getJsonObj(obj: CreateTransferPackageDetails): object {
    const jsonObj = { ...obj, ...{} };
