...
export interface MultipleTransferAppliances {
  /**
   * List of TransferAppliance summary's
   */
  "transferApplianceObjects"?: Array<model.TransferApplianceSummary>;
}

export namespace MultipleTransferAppliances {
  export function getJsonObj(obj: MultipleTransferAppliances): object {
    const jsonObj = {
      ...obj,
      ...{
        "transferApplianceObjects": obj.transferApplianceObjects
          ? obj.transferApplianceObjects.map(item => {
              return model.TransferApplianceSummary.getJsonObj(item);
            })
          : undefined
      }
    };
