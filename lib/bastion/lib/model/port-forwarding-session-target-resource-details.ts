...
export namespace PortForwardingSessionTargetResourceDetails {
  export function getJsonObj(
    obj: PortForwardingSessionTargetResourceDetails,
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ...
        : (model.TargetResourceDetails.getJsonObj(
            obj
          ) as PortForwardingSessionTargetResourceDetails)),
      ...{}
    };
