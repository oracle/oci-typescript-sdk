 ...
 */
export interface DynamicPortForwardingSessionTargetResourceDetails
  extends model.TargetResourceDetails {
  "sessionType": string;
}

export namespace DynamicPortForwardingSessionTargetResourceDetails {
  export function getJsonObj(
    obj: DynamicPortForwardingSessionTargetResourceDetails,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.TargetResourceDetails.getJsonObj(
            obj
          ) as DynamicPortForwardingSessionTargetResourceDetails)),
      ...{}
    };
