 ...
 **/
export enum BastionDnsProxyStatus {
  Disabled = "DISABLED",
  Enabled = "ENABLED",
...
export namespace BastionDnsProxyStatus {
  export function getJsonObj(obj: BastionDnsProxyStatus): BastionDnsProxyStatus {
    return obj;
  }
  export function getDeserializedJsonObj(obj: BastionDnsProxyStatus): BastionDnsProxyStatus {
    return obj;
  }
}
