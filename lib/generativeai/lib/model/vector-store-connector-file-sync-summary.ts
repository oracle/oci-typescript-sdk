...
export namespace VectorStoreConnectorFileSyncSummary {
  ...
  export function getJsonObj(obj: VectorStoreConnectorFileSyncSummary): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: VectorStoreConnectorFileSyncSummary): object {
    const jsonObj = {
      ...obj,
      ...{
        "stats": obj.stats
