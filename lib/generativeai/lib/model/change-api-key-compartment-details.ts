...
export namespace ChangeApiKeyCompartmentDetails {
  export function getJsonObj(obj: ChangeApiKeyCompartmentDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: ChangeApiKeyCompartmentDetails): object {
    const jsonObj = { ...obj, ...{} };
