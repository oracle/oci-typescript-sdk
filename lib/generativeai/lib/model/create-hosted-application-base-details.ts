 ...
 */
export interface CreateHostedApplicationBaseDetails {
  /**
...
export namespace CreateHostedApplicationBaseDetails {
  export function getJsonObj(obj: CreateHostedApplicationBaseDetails): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: CreateHostedApplicationBaseDetails): object {
    const jsonObj = {
      ...obj,
      ...{
        "scalingConfig": obj.scalingConfig
