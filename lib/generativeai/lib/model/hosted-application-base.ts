 ...
 */
export interface HostedApplicationBase {
  /**
   ...
   */
  "lifecycleState": HostedApplicationBase.LifecycleState;
  /**
...
export namespace HostedApplicationBase {
  ...
  export function getJsonObj(obj: HostedApplicationBase): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: HostedApplicationBase): object {
    const jsonObj = {
      ...obj,
      ...{
        "scalingConfig": obj.scalingConfig
