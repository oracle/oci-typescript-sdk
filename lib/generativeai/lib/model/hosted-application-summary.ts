...
export namespace HostedApplicationSummary {
  export function getJsonObj(obj: HostedApplicationSummary): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: HostedApplicationSummary): object {
    const jsonObj = { ...obj, ...{} };
