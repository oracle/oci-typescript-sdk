...
export namespace UpdateImportedModelDetails {
  export function getJsonObj(obj: UpdateImportedModelDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: UpdateImportedModelDetails): object {
    const jsonObj = { ...obj, ...{} };
