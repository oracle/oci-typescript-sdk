...
export namespace ConnectorConfiguration {
  export function getJsonObj(obj: ConnectorConfiguration): object {
    const jsonObj = { ...obj, ...{} };

    if (obj && "type" in obj && obj.type) {
      switch (obj.type) {
        case "OBJECT_STORAGE_FILES":
          return model.OciObjectStorageConfiguration.getJsonObj(
            <model.OciObjectStorageConfiguration>(<object>jsonObj),
            true
          );
        default:
  ...
  export function getDeserializedJsonObj(obj: ConnectorConfiguration): object {
    const jsonObj = { ...obj, ...{} };

    if (obj && "type" in obj && obj.type) {
      switch (obj.type) {
        case "OBJECT_STORAGE_FILES":
          return model.OciObjectStorageConfiguration.getDeserializedJsonObj(
            <model.OciObjectStorageConfiguration>(<object>jsonObj),
            true
          );
        default:
