...
export namespace HostedDeploymentCollection {
  export function getJsonObj(obj: HostedDeploymentCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
  ...
  export function getDeserializedJsonObj(obj: HostedDeploymentCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
