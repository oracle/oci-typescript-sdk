...
export namespace TextGenerationModelMetrics {
  export function getJsonObj(obj: TextGenerationModelMetrics, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.ModelMetrics.getJsonObj(obj) as TextGenerationModelMetrics)),
      ...{}
    };

    return jsonObj;
  }
  export const modelMetricsType = "TEXT_GENERATION_MODEL_METRICS";
  export function getDeserializedJsonObj(
    obj: TextGenerationModelMetrics,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.ModelMetrics.getDeserializedJsonObj(obj) as TextGenerationModelMetrics)),
      ...{}
    };
