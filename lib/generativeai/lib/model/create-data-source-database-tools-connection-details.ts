 ...
 */
export interface CreateDataSourceDatabaseToolsConnectionDetails
  extends model.CreateDataSourceDetails {
  /**
...
export namespace CreateDataSourceDatabaseToolsConnectionDetails {
  export function getJsonObj(
    obj: CreateDataSourceDatabaseToolsConnectionDetails,
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ...
        : (model.CreateDataSourceDetails.getJsonObj(
            obj
          ) as CreateDataSourceDatabaseToolsConnectionDetails)),
      ...{}
    };

    return jsonObj;
  }
  export const connectionType = "DATABASE_TOOLS_CONNECTION";
