...
export namespace CreateDataSourceDetails {
    ...
    if (obj && "connectionType" in obj && obj.connectionType) {
      switch (obj.connectionType) {
        case "DATABASE_TOOLS_CONNECTION":
          return model.CreateDataSourceDatabaseToolsConnectionDetails.getJsonObj(
            <model.CreateDataSourceDatabaseToolsConnectionDetails>(<object>jsonObj),
            true
          );
        default:
  ...
  export function getDeserializedJsonObj(obj: CreateDataSourceDetails): object {
    ...
    if (obj && "connectionType" in obj && obj.connectionType) {
      switch (obj.connectionType) {
        case "DATABASE_TOOLS_CONNECTION":
          return model.CreateDataSourceDatabaseToolsConnectionDetails.getDeserializedJsonObj(
            <model.CreateDataSourceDatabaseToolsConnectionDetails>(<object>jsonObj),
            true
          );
        default:
