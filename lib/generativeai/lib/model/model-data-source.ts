...
export namespace ModelDataSource {
  export function getJsonObj(obj: ModelDataSource): object {
    const jsonObj = { ...obj, ...{} };

    if (obj && "sourceType" in obj && obj.sourceType) {
      switch (obj.sourceType) {
        case "OBJECT_STORAGE_OBJECT":
          return model.ObjectStorageObject.getJsonObj(
            <model.ObjectStorageObject>(<object>jsonObj),
            true
          );
        case "HUGGING_FACE_MODEL":
          return model.HuggingFaceModel.getJsonObj(<model.HuggingFaceModel>(<object>jsonObj), true);
        default:
  ...
  export function getDeserializedJsonObj(obj: ModelDataSource): object {
    const jsonObj = { ...obj, ...{} };

    if (obj && "sourceType" in obj && obj.sourceType) {
      switch (obj.sourceType) {
        case "OBJECT_STORAGE_OBJECT":
          return model.ObjectStorageObject.getDeserializedJsonObj(
            <model.ObjectStorageObject>(<object>jsonObj),
            true
          );
        case "HUGGING_FACE_MODEL":
          return model.HuggingFaceModel.getDeserializedJsonObj(
            <model.HuggingFaceModel>(<object>jsonObj),
            true
          );
        default:
          if (common.LOG.logger) common.LOG.logger.info(`Unknown value for: ${obj.sourceType}`);
