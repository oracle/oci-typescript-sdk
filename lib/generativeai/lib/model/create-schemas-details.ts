...
export namespace CreateSchemasDetails {
  export function getJsonObj(obj: CreateSchemasDetails): object {
    const jsonObj = { ...obj, ...{} };

    if (obj && "connectionType" in obj && obj.connectionType) {
      switch (obj.connectionType) {
        case "DATABASE_TOOLS_CONNECTION":
          return model.CreateSchemasDatabaseToolsConnectionDetails.getJsonObj(
            <model.CreateSchemasDatabaseToolsConnectionDetails>(<object>jsonObj),
            true
          );
        default:
  ...
  export function getDeserializedJsonObj(obj: CreateSchemasDetails): object {
    const jsonObj = { ...obj, ...{} };

    if (obj && "connectionType" in obj && obj.connectionType) {
      switch (obj.connectionType) {
        case "DATABASE_TOOLS_CONNECTION":
          return model.CreateSchemasDatabaseToolsConnectionDetails.getDeserializedJsonObj(
            <model.CreateSchemasDatabaseToolsConnectionDetails>(<object>jsonObj),
            true
          );
        default:
