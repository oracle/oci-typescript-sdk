...
export namespace CreateSchemasDatabaseToolsConnectionDetails {
  export function getJsonObj(
    obj: CreateSchemasDatabaseToolsConnectionDetails,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.CreateSchemasDetails.getJsonObj(
            obj
          ) as CreateSchemasDatabaseToolsConnectionDetails)),
      ...{
        "schemas": obj.schemas
  ...
  export function getDeserializedJsonObj(
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.CreateSchemasDetails.getDeserializedJsonObj(
            obj
          ) as CreateSchemasDatabaseToolsConnectionDetails)),
      ...{
        "schemas": obj.schemas
