...
export namespace GenerativeAiProjectCollection {
  export function getJsonObj(obj: GenerativeAiProjectCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
  ...
  export function getDeserializedJsonObj(obj: GenerativeAiProjectCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
