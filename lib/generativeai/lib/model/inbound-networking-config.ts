...
export namespace InboundNetworkingConfig {
  ...
  export function getJsonObj(obj: InboundNetworkingConfig): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: InboundNetworkingConfig): object {
    const jsonObj = { ...obj, ...{} };
