...
export namespace SchemasDetails {
  export function getJsonObj(obj: SchemasDetails): object {
    const jsonObj = { ...obj, ...{} };

    if (obj && "connectionType" in obj && obj.connectionType) {
      switch (obj.connectionType) {
        case "DATABASE_TOOLS_CONNECTION":
          return model.SchemasDatabaseToolsConnectionDetails.getJsonObj(
            <model.SchemasDatabaseToolsConnectionDetails>(<object>jsonObj),
            true
          );
        default:
  ...
  export function getDeserializedJsonObj(obj: SchemasDetails): object {
    const jsonObj = { ...obj, ...{} };

    if (obj && "connectionType" in obj && obj.connectionType) {
      switch (obj.connectionType) {
        case "DATABASE_TOOLS_CONNECTION":
          return model.SchemasDatabaseToolsConnectionDetails.getDeserializedJsonObj(
            <model.SchemasDatabaseToolsConnectionDetails>(<object>jsonObj),
            true
          );
        default:
