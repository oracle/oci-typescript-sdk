...
export namespace GenerativeAiProject {
  ...
  export function getJsonObj(obj: GenerativeAiProject): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: GenerativeAiProject): object {
    const jsonObj = {
      ...obj,
      ...{
        "conversationConfig": obj.conversationConfig
