...
export namespace HostedApplicationStorageSummary {
  ...
  export function getJsonObj(obj: HostedApplicationStorageSummary): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: HostedApplicationStorageSummary): object {
    const jsonObj = { ...obj, ...{} };
