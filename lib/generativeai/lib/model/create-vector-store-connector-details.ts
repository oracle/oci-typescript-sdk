...
export namespace CreateVectorStoreConnectorDetails {
  export function getJsonObj(obj: CreateVectorStoreConnectorDetails): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: CreateVectorStoreConnectorDetails): object {
    const jsonObj = {
      ...obj,
      ...{
        "scheduleConfig": obj.scheduleConfig
