...
export namespace HostedApplicationStorageCollection {
  export function getJsonObj(obj: HostedApplicationStorageCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
  ...
  export function getDeserializedJsonObj(obj: HostedApplicationStorageCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
