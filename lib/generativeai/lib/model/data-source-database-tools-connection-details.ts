...
export namespace DataSourceDatabaseToolsConnectionDetails {
  export function getJsonObj(
    obj: DataSourceDatabaseToolsConnectionDetails,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.DataSourceDetails.getJsonObj(obj) as DataSourceDatabaseToolsConnectionDetails)),
      ...{}
    };
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ...
        : (model.DataSourceDetails.getDeserializedJsonObj(
            obj
          ) as DataSourceDatabaseToolsConnectionDetails)),
      ...{}
    };
