...
export namespace ChangeSemanticStoreCompartmentDetails {
  export function getJsonObj(obj: ChangeSemanticStoreCompartmentDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: ChangeSemanticStoreCompartmentDetails): object {
    const jsonObj = { ...obj, ...{} };
