...
export namespace EmbeddingConfig {
  export function getJsonObj(obj: EmbeddingConfig, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj ? obj : (model.ModelConfig.getJsonObj(obj) as EmbeddingConfig)),
      ...{}
    };

    return jsonObj;
  }
  export const modelConfigType = "EMBEDDING";
  export function getDeserializedJsonObj(obj: EmbeddingConfig, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.ModelConfig.getDeserializedJsonObj(obj) as EmbeddingConfig)),
      ...{}
    };
