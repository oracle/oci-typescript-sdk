...
export namespace ObjectStorageConfig {
  export function getJsonObj(obj: ObjectStorageConfig): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: ObjectStorageConfig): object {
    const jsonObj = { ...obj, ...{} };
