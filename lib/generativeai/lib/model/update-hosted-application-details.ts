...
export namespace UpdateHostedApplicationDetails {
  export function getJsonObj(obj: UpdateHostedApplicationDetails): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: UpdateHostedApplicationDetails): object {
    const jsonObj = {
      ...obj,
      ...{
        "scalingConfig": obj.scalingConfig
