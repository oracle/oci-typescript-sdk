...
export namespace PromptInjectionConfig {
  export function getJsonObj(obj: PromptInjectionConfig): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: PromptInjectionConfig): object {
    const jsonObj = { ...obj, ...{} };
