...
export namespace ChangeHostedApplicationStorageCompartmentDetails {
  export function getJsonObj(obj: ChangeHostedApplicationStorageCompartmentDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(
    obj: ChangeHostedApplicationStorageCompartmentDetails
  ): object {
    const jsonObj = { ...obj, ...{} };
