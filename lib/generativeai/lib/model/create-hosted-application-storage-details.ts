...
export namespace CreateHostedApplicationStorageDetails {
  export function getJsonObj(obj: CreateHostedApplicationStorageDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: CreateHostedApplicationStorageDetails): object {
    const jsonObj = { ...obj, ...{} };
