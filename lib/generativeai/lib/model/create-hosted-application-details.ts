...
export namespace CreateHostedApplicationDetails {
  export function getJsonObj(obj: CreateHostedApplicationDetails): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: CreateHostedApplicationDetails): object {
    const jsonObj = {
      ...obj,
      ...{
        "scalingConfig": obj.scalingConfig
