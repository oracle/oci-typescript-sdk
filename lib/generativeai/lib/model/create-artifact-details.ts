...
export namespace CreateArtifactDetails {
    ...
    if (obj && "artifactType" in obj && obj.artifactType) {
      switch (obj.artifactType) {
        case "SIMPLE_DOCKER_ARTIFACT":
          return model.CreateSingleDockerArtifactDetails.getJsonObj(
            <model.CreateSingleDockerArtifactDetails>(<object>jsonObj),
            true
          );
        default:
  ...
  export function getDeserializedJsonObj(obj: CreateArtifactDetails): object {
    ...
    if (obj && "artifactType" in obj && obj.artifactType) {
      switch (obj.artifactType) {
        case "SIMPLE_DOCKER_ARTIFACT":
          return model.CreateSingleDockerArtifactDetails.getDeserializedJsonObj(
            <model.CreateSingleDockerArtifactDetails>(<object>jsonObj),
            true
          );
        default:
