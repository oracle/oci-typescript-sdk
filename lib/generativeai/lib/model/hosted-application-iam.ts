...
* 
*/
export interface HostedApplicationIam {
  /**
   ...
   */
  "lifecycleState": HostedApplicationIam.LifecycleState;
  /**
...
export namespace HostedApplicationIam {
  ...
  export function getJsonObj(obj: HostedApplicationIam): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: HostedApplicationIam): object {
    const jsonObj = {
      ...obj,
      ...{
        "scalingConfig": obj.scalingConfig
