...
export interface UpdateSemanticStoreDetails {
  ...
  "refreshSchedule"?:
    ...
    | model.RefreshScheduleIntervalDetails;
...
export namespace UpdateSemanticStoreDetails {
  export function getJsonObj(obj: UpdateSemanticStoreDetails): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: UpdateSemanticStoreDetails): object {
    const jsonObj = {
      ...obj,
      ...{
        "refreshSchedule": obj.refreshSchedule
