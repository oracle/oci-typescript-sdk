...
export namespace DedicatedAiClusterCollection {
  export function getJsonObj(obj: DedicatedAiClusterCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
  ...
  export function getDeserializedJsonObj(obj: DedicatedAiClusterCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
