 ...
 */
export interface UpdateHostedApplicationBaseDetails {
  /**
...
export namespace UpdateHostedApplicationBaseDetails {
  export function getJsonObj(obj: UpdateHostedApplicationBaseDetails): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: UpdateHostedApplicationBaseDetails): object {
    const jsonObj = {
      ...obj,
      ...{
        "scalingConfig": obj.scalingConfig
