...
export namespace PiiDetectionConfig {
  export function getJsonObj(obj: PiiDetectionConfig): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: PiiDetectionConfig): object {
    const jsonObj = { ...obj, ...{} };
