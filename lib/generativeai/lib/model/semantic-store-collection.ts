...
export namespace SemanticStoreCollection {
  export function getJsonObj(obj: SemanticStoreCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
  ...
  export function getDeserializedJsonObj(obj: SemanticStoreCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
