...
export namespace UpdateGenerativeAiPrivateEndpointDetails {
  export function getJsonObj(obj: UpdateGenerativeAiPrivateEndpointDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: UpdateGenerativeAiPrivateEndpointDetails): object {
    const jsonObj = { ...obj, ...{} };
