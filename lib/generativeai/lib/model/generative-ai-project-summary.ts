...
export namespace GenerativeAiProjectSummary {
  export function getJsonObj(obj: GenerativeAiProjectSummary): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: GenerativeAiProjectSummary): object {
    const jsonObj = { ...obj, ...{} };
