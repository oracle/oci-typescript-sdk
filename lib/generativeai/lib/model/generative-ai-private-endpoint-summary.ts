...
export namespace GenerativeAiPrivateEndpointSummary {
  export function getJsonObj(obj: GenerativeAiPrivateEndpointSummary): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: GenerativeAiPrivateEndpointSummary): object {
    const jsonObj = { ...obj, ...{} };
