...
export namespace OutboundNetworkingConfig {
  ...
  export function getJsonObj(obj: OutboundNetworkingConfig): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: OutboundNetworkingConfig): object {
    const jsonObj = { ...obj, ...{} };
