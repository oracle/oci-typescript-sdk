 ...
 */
export interface UpdateHostedApplicationIamDetails {
  /**
...
export namespace UpdateHostedApplicationIamDetails {
  export function getJsonObj(obj: UpdateHostedApplicationIamDetails): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: UpdateHostedApplicationIamDetails): object {
    const jsonObj = {
      ...obj,
      ...{
        "scalingConfig": obj.scalingConfig
