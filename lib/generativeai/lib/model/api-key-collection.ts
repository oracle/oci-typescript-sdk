...
export namespace ApiKeyCollection {
  export function getJsonObj(obj: ApiKeyCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
  ...
  export function getDeserializedJsonObj(obj: ApiKeyCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
