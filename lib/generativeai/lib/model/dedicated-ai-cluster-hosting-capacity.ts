...
export namespace DedicatedAiClusterHostingCapacity {
  export function getJsonObj(
    obj: DedicatedAiClusterHostingCapacity,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.DedicatedAiClusterCapacity.getJsonObj(obj) as DedicatedAiClusterHostingCapacity)),
      ...{}
    };

    return jsonObj;
  }
  export const capacityType = "HOSTING_CAPACITY";
  export function getDeserializedJsonObj(
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.DedicatedAiClusterCapacity.getDeserializedJsonObj(
            obj
          ) as DedicatedAiClusterHostingCapacity)),
      ...{}
    };
