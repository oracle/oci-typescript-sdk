...
export namespace SetApiKeyStateDetails {
  export function getJsonObj(obj: SetApiKeyStateDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: SetApiKeyStateDetails): object {
    const jsonObj = { ...obj, ...{} };
