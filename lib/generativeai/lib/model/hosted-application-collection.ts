...
export namespace HostedApplicationCollection {
  export function getJsonObj(obj: HostedApplicationCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
  ...
  export function getDeserializedJsonObj(obj: HostedApplicationCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
