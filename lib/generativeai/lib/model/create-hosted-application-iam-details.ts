 ...
 */
export interface CreateHostedApplicationIamDetails {
  /**
...
export namespace CreateHostedApplicationIamDetails {
  export function getJsonObj(obj: CreateHostedApplicationIamDetails): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: CreateHostedApplicationIamDetails): object {
    const jsonObj = {
      ...obj,
      ...{
        "scalingConfig": obj.scalingConfig
