...
export namespace HostedApplicationStorage {
  ...
  export function getJsonObj(obj: HostedApplicationStorage): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: HostedApplicationStorage): object {
    const jsonObj = { ...obj, ...{} };
