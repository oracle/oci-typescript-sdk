...
export namespace CreateVectorStoreConnectorFileSyncDetails {
  export function getJsonObj(obj: CreateVectorStoreConnectorFileSyncDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: CreateVectorStoreConnectorFileSyncDetails): object {
    const jsonObj = { ...obj, ...{} };
