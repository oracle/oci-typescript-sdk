...
export namespace VectorStoreConnector {
  ...
  export function getJsonObj(obj: VectorStoreConnector): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: VectorStoreConnector): object {
    const jsonObj = {
      ...obj,
      ...{
        "scheduleConfig": obj.scheduleConfig
