...
export interface FileSyncStatistics {
   ...
   */
  "syncStatsByFileType"?: { [key: string]: number };
}

export namespace FileSyncStatistics {
  export function getJsonObj(obj: FileSyncStatistics): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: FileSyncStatistics): object {
    const jsonObj = { ...obj, ...{} };
