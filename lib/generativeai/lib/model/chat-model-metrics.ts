...
export namespace ChatModelMetrics {
  export function getJsonObj(obj: ChatModelMetrics, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj ? obj : (model.ModelMetrics.getJsonObj(obj) as ChatModelMetrics)),
      ...{}
    };

    return jsonObj;
  }
  export const modelMetricsType = "CHAT_MODEL_METRICS";
  export function getDeserializedJsonObj(obj: ChatModelMetrics, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.ModelMetrics.getDeserializedJsonObj(obj) as ChatModelMetrics)),
      ...{}
    };
