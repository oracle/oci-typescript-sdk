 ...
 *
 */
export interface RegionRoutingPolicy {
  /**
...
export namespace RegionRoutingPolicy {
  export function getJsonObj(obj: RegionRoutingPolicy): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: RegionRoutingPolicy): object {
    const jsonObj = { ...obj, ...{} };
