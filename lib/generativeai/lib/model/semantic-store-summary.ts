...
export namespace SemanticStoreSummary {
  export function getJsonObj(obj: SemanticStoreSummary): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: SemanticStoreSummary): object {
    const jsonObj = {
      ...obj,
      ...{
        "dataSource": obj.dataSource
