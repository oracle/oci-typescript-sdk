 ...
 *
 */
export interface PreviousRoutingProfileState {
  /**
...
export namespace PreviousRoutingProfileState {
  export function getJsonObj(obj: PreviousRoutingProfileState): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: PreviousRoutingProfileState): object {
    const jsonObj = {
      ...obj,
      ...{
        "regionRoutingPolicy": obj.regionRoutingPolicy
