...
export namespace UpdateApiKeyDetails {
  export function getJsonObj(obj: UpdateApiKeyDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: UpdateApiKeyDetails): object {
    const jsonObj = { ...obj, ...{} };
