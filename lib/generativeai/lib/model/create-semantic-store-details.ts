...
export namespace CreateSemanticStoreDetails {
  export function getJsonObj(obj: CreateSemanticStoreDetails): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: CreateSemanticStoreDetails): object {
    const jsonObj = {
      ...obj,
      ...{
        "dataSource": obj.dataSource
