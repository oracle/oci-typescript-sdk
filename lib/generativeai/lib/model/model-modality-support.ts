...
export interface ModelModalitySupport {
   ...
   */
  "input": model.ModelModality;
  /**
   * The target modality produced by the model.
   */
  "output": model.ModelModality;
}

export namespace ModelModalitySupport {
  export function getJsonObj(obj: ModelModalitySupport): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: ModelModalitySupport): object {
    const jsonObj = { ...obj, ...{} };
