...
export namespace ChangeHostedApplicationCompartmentDetails {
  export function getJsonObj(obj: ChangeHostedApplicationCompartmentDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: ChangeHostedApplicationCompartmentDetails): object {
    const jsonObj = { ...obj, ...{} };
