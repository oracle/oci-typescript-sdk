...
export namespace DataSourceDetails {
    ...
    if (obj && "connectionType" in obj && obj.connectionType) {
      switch (obj.connectionType) {
        case "DATABASE_TOOLS_CONNECTION":
          return model.DataSourceDatabaseToolsConnectionDetails.getJsonObj(
            <model.DataSourceDatabaseToolsConnectionDetails>(<object>jsonObj),
            true
          );
        default:
  ...
  export function getDeserializedJsonObj(obj: DataSourceDetails): object {
    ...
    if (obj && "connectionType" in obj && obj.connectionType) {
      switch (obj.connectionType) {
        case "DATABASE_TOOLS_CONNECTION":
          return model.DataSourceDatabaseToolsConnectionDetails.getDeserializedJsonObj(
            <model.DataSourceDatabaseToolsConnectionDetails>(<object>jsonObj),
            true
          );
        default:
