...
export namespace ChangeDedicatedAiClusterCompartmentDetails {
  export function getJsonObj(obj: ChangeDedicatedAiClusterCompartmentDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: ChangeDedicatedAiClusterCompartmentDetails): object {
    const jsonObj = { ...obj, ...{} };
