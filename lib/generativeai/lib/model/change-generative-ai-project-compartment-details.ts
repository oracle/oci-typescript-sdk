...
export namespace ChangeGenerativeAiProjectCompartmentDetails {
  export function getJsonObj(obj: ChangeGenerativeAiProjectCompartmentDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: ChangeGenerativeAiProjectCompartmentDetails): object {
    const jsonObj = { ...obj, ...{} };
