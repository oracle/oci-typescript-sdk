...
export namespace ModelModality {
  export function getJsonObj(obj: ModelModality): ModelModality {
    return obj;
  }
  export function getDeserializedJsonObj(obj: ModelModality): ModelModality {
    return obj;
  }
}
