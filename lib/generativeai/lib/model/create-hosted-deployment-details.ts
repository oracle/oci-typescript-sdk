...
export namespace CreateHostedDeploymentDetails {
  export function getJsonObj(obj: CreateHostedDeploymentDetails): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: CreateHostedDeploymentDetails): object {
    const jsonObj = {
      ...obj,
      ...{
        "activeArtifact": obj.activeArtifact
