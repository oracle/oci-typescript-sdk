...
export namespace ExtractionConfig {
  export function getJsonObj(obj: ExtractionConfig, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj ? obj : (model.ModelConfig.getJsonObj(obj) as ExtractionConfig)),
      ...{}
    };

    return jsonObj;
  }
  export const modelConfigType = "EXTRACTION";
  export function getDeserializedJsonObj(obj: ExtractionConfig, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.ModelConfig.getDeserializedJsonObj(obj) as ExtractionConfig)),
      ...{}
    };
