...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/generativeai/ListHostedApplicationsIam.ts.html |here} to see how to use ListHostedApplicationsIamRequest.
 */
export interface ListHostedApplicationsIamRequest extends common.BaseRequest {
  /**
...
export namespace ListHostedApplicationsIamRequest {
  export enum SortBy {
