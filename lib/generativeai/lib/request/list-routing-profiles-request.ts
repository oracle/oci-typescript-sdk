...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/generativeai/ListRoutingProfiles.ts.html |here} to see how to use ListRoutingProfilesRequest.
 */
export interface ListRoutingProfilesRequest extends common.BaseRequest {
  /**
