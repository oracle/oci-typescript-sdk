...
export namespace CompliancePolicySummary {
  export function getJsonObj(obj: CompliancePolicySummary): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: CompliancePolicySummary): object {
    const jsonObj = { ...obj, ...{} };
