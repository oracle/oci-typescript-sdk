 ...
 *
 **/
export enum CatalogListingVersionCriteriaEnum {
...
export namespace CatalogListingVersionCriteriaEnum {
  export function getJsonObj(
    obj: CatalogListingVersionCriteriaEnum
  ): CatalogListingVersionCriteriaEnum {
    return obj;
  }
