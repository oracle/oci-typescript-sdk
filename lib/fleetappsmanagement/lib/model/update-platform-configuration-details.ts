...
export namespace UpdatePlatformConfigurationDetails {
  export function getJsonObj(obj: UpdatePlatformConfigurationDetails): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: UpdatePlatformConfigurationDetails): object {
    const jsonObj = {
      ...obj,
      ...{
        "configCategoryDetails": obj.configCategoryDetails
