...
export namespace CompliancePolicyRuleSummary {
  ...
  export function getJsonObj(obj: CompliancePolicyRuleSummary): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: CompliancePolicyRuleSummary): object {
    const jsonObj = {
      ...obj,
      ...{
        "productVersion": obj.productVersion
