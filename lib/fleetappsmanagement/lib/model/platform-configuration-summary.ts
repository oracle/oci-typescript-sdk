...
export namespace PlatformConfigurationSummary {
  export function getJsonObj(obj: PlatformConfigurationSummary): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: PlatformConfigurationSummary): object {
    const jsonObj = {
      ...obj,
      ...{
        "configCategoryDetails": obj.configCategoryDetails
