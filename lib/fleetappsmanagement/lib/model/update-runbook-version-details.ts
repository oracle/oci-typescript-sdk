...
export namespace UpdateRunbookVersionDetails {
  export function getJsonObj(obj: UpdateRunbookVersionDetails): object {
    const jsonObj = {
      ...obj,
      ...{
        "tasks": obj.tasks
  ...
  export function getDeserializedJsonObj(obj: UpdateRunbookVersionDetails): object {
    const jsonObj = {
      ...obj,
      ...{
        "tasks": obj.tasks
