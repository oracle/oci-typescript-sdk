...
export namespace UpdateCompliancePolicyRuleDetails {
  ...
  export function getJsonObj(obj: UpdateCompliancePolicyRuleDetails): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: UpdateCompliancePolicyRuleDetails): object {
    const jsonObj = {
      ...obj,
      ...{
        "productVersion": obj.productVersion
