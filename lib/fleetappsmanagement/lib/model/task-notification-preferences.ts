...
export namespace TaskNotificationPreferences {
  export function getJsonObj(obj: TaskNotificationPreferences): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: TaskNotificationPreferences): object {
    const jsonObj = { ...obj, ...{} };
