...
export namespace ReportTimeRange {
  export function getJsonObj(obj: ReportTimeRange): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: ReportTimeRange): object {
    const jsonObj = { ...obj, ...{} };
