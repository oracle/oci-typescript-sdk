...
export namespace SchedulerDefinition {
  ...
  export function getJsonObj(obj: SchedulerDefinition): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: SchedulerDefinition): object {
    const jsonObj = {
      ...obj,
      ...{
