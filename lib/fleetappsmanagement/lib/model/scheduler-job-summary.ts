...
export namespace SchedulerJobSummary {
  export function getJsonObj(obj: SchedulerJobSummary): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: SchedulerJobSummary): object {
    const jsonObj = {
      ...obj,
      ...{
        "actionGroups": obj.actionGroups
