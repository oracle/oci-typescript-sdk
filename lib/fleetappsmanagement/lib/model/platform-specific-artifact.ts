...
export namespace PlatformSpecificArtifact {
  export enum OsType {
    Windows = "WINDOWS",
    Linux = "LINUX",
    /**
  ...
  export function getJsonObj(obj: PlatformSpecificArtifact): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: PlatformSpecificArtifact): object {
    const jsonObj = {
      ...obj,
      ...{
        "content": obj.content
