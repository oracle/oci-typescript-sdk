...
export namespace GenerateComplianceReportDetails {
  export function getJsonObj(obj: GenerateComplianceReportDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: GenerateComplianceReportDetails): object {
    const jsonObj = { ...obj, ...{} };
