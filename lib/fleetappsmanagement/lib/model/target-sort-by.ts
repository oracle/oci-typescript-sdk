...
export namespace TargetSortBy {
  export function getJsonObj(obj: TargetSortBy): TargetSortBy {
    return obj;
  }
  export function getDeserializedJsonObj(obj: TargetSortBy): TargetSortBy {
    return obj;
  }
}
