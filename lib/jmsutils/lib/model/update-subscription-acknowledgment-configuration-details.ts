...
export namespace UpdateSubscriptionAcknowledgmentConfigurationDetails {
  export function getJsonObj(obj: UpdateSubscriptionAcknowledgmentConfigurationDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(
    obj: UpdateSubscriptionAcknowledgmentConfigurationDetails
  ): object {
    const jsonObj = { ...obj, ...{} };
