...
export namespace UpdateAnalyzeApplicationsConfigurationDetails {
  export function getJsonObj(obj: UpdateAnalyzeApplicationsConfigurationDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(
    obj: UpdateAnalyzeApplicationsConfigurationDetails
  ): object {
    const jsonObj = { ...obj, ...{} };
