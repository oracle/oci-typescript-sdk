...
export namespace AuthenticationMechanism {
  export function getJsonObj(obj: AuthenticationMechanism): AuthenticationMechanism {
    return obj;
  }
  export function getDeserializedJsonObj(obj: AuthenticationMechanism): AuthenticationMechanism {
    return obj;
  }
}
