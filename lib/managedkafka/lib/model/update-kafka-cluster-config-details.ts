...
export namespace UpdateKafkaClusterConfigDetails {
  export function getJsonObj(obj: UpdateKafkaClusterConfigDetails): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: UpdateKafkaClusterConfigDetails): object {
    const jsonObj = {
      ...obj,
      ...{
        "latestConfig": obj.latestConfig
