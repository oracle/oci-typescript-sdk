...
export namespace KafkaClusterConfigVersionCollection {
  export function getJsonObj(obj: KafkaClusterConfigVersionCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
  ...
  export function getDeserializedJsonObj(obj: KafkaClusterConfigVersionCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
