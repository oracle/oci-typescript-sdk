...
export namespace ChangeKafkaClusterCompartmentDetails {
  export function getJsonObj(obj: ChangeKafkaClusterCompartmentDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: ChangeKafkaClusterCompartmentDetails): object {
    const jsonObj = { ...obj, ...{} };
