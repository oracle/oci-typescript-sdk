...
export namespace KafkaClusterSummary {
  export function getJsonObj(obj: KafkaClusterSummary): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: KafkaClusterSummary): object {
    const jsonObj = {
      ...obj,
      ...{
        "accessSubnets": obj.accessSubnets
