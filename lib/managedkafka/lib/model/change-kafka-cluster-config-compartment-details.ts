...
export namespace ChangeKafkaClusterConfigCompartmentDetails {
  export function getJsonObj(obj: ChangeKafkaClusterConfigCompartmentDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: ChangeKafkaClusterConfigCompartmentDetails): object {
    const jsonObj = { ...obj, ...{} };
