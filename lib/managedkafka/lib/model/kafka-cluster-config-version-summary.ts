...
export namespace KafkaClusterConfigVersionSummary {
  export function getJsonObj(obj: KafkaClusterConfigVersionSummary): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: KafkaClusterConfigVersionSummary): object {
    const jsonObj = { ...obj, ...{} };
