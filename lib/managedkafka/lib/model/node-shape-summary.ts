...
export namespace NodeShapeSummary {
  export function getJsonObj(obj: NodeShapeSummary): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: NodeShapeSummary): object {
    const jsonObj = { ...obj, ...{} };
