...
export namespace PreTrainedTextClassificationModelDetails {
  export function getJsonObj(
    obj: PreTrainedTextClassificationModelDetails,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.ModelDetails.getJsonObj(obj) as PreTrainedTextClassificationModelDetails)),
      ...{}
    };

    return jsonObj;
  }
  export const modelType = "PRE_TRAINED_TEXT_CLASSIFICATION";
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ...
        : (model.ModelDetails.getDeserializedJsonObj(
            obj
          ) as PreTrainedTextClassificationModelDetails)),
      ...{}
    };
