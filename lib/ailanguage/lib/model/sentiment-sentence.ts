...
export namespace SentimentSentence {
  export function getJsonObj(obj: SentimentSentence): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: SentimentSentence): object {
    const jsonObj = { ...obj, ...{} };
