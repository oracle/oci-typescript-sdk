...
export namespace BatchDetectLanguageSentimentsResult {
  export function getJsonObj(obj: BatchDetectLanguageSentimentsResult): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: BatchDetectLanguageSentimentsResult): object {
    const jsonObj = {
      ...obj,
      ...{
        "documents": obj.documents
