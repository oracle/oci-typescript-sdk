...
export namespace KeyPhraseDocument {
  export function getJsonObj(obj: KeyPhraseDocument): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: KeyPhraseDocument): object {
    const jsonObj = { ...obj, ...{} };
