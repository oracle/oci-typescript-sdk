...
export namespace SentimentsDocument {
  export function getJsonObj(obj: SentimentsDocument): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: SentimentsDocument): object {
    const jsonObj = { ...obj, ...{} };
