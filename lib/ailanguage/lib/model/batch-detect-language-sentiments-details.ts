...
export interface BatchDetectLanguageSentimentsDetails {
   ...
   */
  "documents": Array<model.SentimentsDocument>;
}

export namespace BatchDetectLanguageSentimentsDetails {
  export function getJsonObj(obj: BatchDetectLanguageSentimentsDetails): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: BatchDetectLanguageSentimentsDetails): object {
    const jsonObj = {
      ...obj,
      ...{
        "documents": obj.documents
