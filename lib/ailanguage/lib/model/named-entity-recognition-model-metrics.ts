...
export namespace NamedEntityRecognitionModelMetrics {
  export function getJsonObj(obj: NamedEntityRecognitionModelMetrics): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: NamedEntityRecognitionModelMetrics): object {
    const jsonObj = { ...obj, ...{} };
