...
export namespace ImportStandardTagsDetails {
  export function getJsonObj(obj: ImportStandardTagsDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: ImportStandardTagsDetails): object {
    const jsonObj = { ...obj, ...{} };
