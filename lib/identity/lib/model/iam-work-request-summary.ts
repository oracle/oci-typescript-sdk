...
export namespace IamWorkRequestSummary {
  ...
  export function getJsonObj(obj: IamWorkRequestSummary): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: IamWorkRequestSummary): object {
    const jsonObj = {
      ...obj,
      ...{
        "resources": obj.resources
