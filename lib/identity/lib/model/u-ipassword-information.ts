...
export namespace UIPasswordInformation {
  ...
  export function getJsonObj(obj: UIPasswordInformation): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: UIPasswordInformation): object {
    const jsonObj = { ...obj, ...{} };
