...
export namespace CommonPrincipal {
  export function getJsonObj(obj: CommonPrincipal): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: CommonPrincipal): object {
    const jsonObj = {
      ...obj,
      ...{
