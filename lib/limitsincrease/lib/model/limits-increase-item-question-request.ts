...
export namespace LimitsIncreaseItemQuestionRequest {
  export function getJsonObj(obj: LimitsIncreaseItemQuestionRequest): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: LimitsIncreaseItemQuestionRequest): object {
    const jsonObj = { ...obj, ...{} };
