...
export namespace LimitsIncreaseItemQuestionResponse {
  export function getJsonObj(obj: LimitsIncreaseItemQuestionResponse): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: LimitsIncreaseItemQuestionResponse): object {
    const jsonObj = { ...obj, ...{} };
