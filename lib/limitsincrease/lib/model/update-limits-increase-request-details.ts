...
export namespace UpdateLimitsIncreaseRequestDetails {
  export function getJsonObj(obj: UpdateLimitsIncreaseRequestDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: UpdateLimitsIncreaseRequestDetails): object {
    const jsonObj = { ...obj, ...{} };
