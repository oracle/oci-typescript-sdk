...
export namespace CohereCitationV2 {
  export enum Type {
  ...
  export function getJsonObj(obj: CohereCitationV2): object {
    const jsonObj = {
      ...obj,
      ...{
        "sources": obj.sources
  ...
  export function getDeserializedJsonObj(obj: CohereCitationV2): object {
    const jsonObj = {
      ...obj,
      ...{
        "sources": obj.sources
