...
export namespace PersonallyIdentifiableInformationConfiguration {
  export function getJsonObj(obj: PersonallyIdentifiableInformationConfiguration): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(
    obj: PersonallyIdentifiableInformationConfiguration
  ): object {
    const jsonObj = { ...obj, ...{} };
