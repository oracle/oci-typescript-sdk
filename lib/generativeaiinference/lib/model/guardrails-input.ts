...
export namespace GuardrailsInput {
  export function getJsonObj(obj: GuardrailsInput): object {
    const jsonObj = { ...obj, ...{} };

    if (obj && "type" in obj && obj.type) {
      switch (obj.type) {
        case "TEXT":
          return model.GuardrailsTextInput.getJsonObj(
  ...
  export function getDeserializedJsonObj(obj: GuardrailsInput): object {
    const jsonObj = { ...obj, ...{} };
