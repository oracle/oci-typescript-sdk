...
export namespace CohereSystemMessage {
  export function getJsonObj(obj: CohereSystemMessage, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj ? obj : (model.CohereMessage.getJsonObj(obj) as CohereSystemMessage)),
      ...{}
    };
  ...
  export function getDeserializedJsonObj(
    obj: CohereSystemMessage,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.CohereMessage.getDeserializedJsonObj(obj) as CohereSystemMessage)),
      ...{}
    };
