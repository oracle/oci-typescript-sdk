...
export namespace CitationOptionsV2 {
  export enum Mode {
    Fast = "FAST",
    Accurate = "ACCURATE",
    Off = "OFF"
  ...
  export function getJsonObj(obj: CitationOptionsV2): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: CitationOptionsV2): object {
    const jsonObj = { ...obj, ...{} };
