...
export namespace JsonSchemaResponseFormat {
  export function getJsonObj(obj: JsonSchemaResponseFormat, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.ResponseFormat.getJsonObj(obj) as JsonSchemaResponseFormat)),
      ...{
  ...
  export const type = "JSON_SCHEMA";
  export function getDeserializedJsonObj(
    obj: JsonSchemaResponseFormat,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.ResponseFormat.getDeserializedJsonObj(obj) as JsonSchemaResponseFormat)),
      ...{
        "jsonSchema": obj.jsonSchema
