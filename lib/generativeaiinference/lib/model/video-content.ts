...
export namespace VideoContent {
  export function getJsonObj(obj: VideoContent, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj ? obj : (model.ChatContent.getJsonObj(obj) as VideoContent)),
      ...{
  ...
  export function getDeserializedJsonObj(obj: VideoContent, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj ? obj : (model.ChatContent.getDeserializedJsonObj(obj) as VideoContent)),
      ...{
