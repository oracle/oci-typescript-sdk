...
export namespace CohereUserMessageV2 {
  export function getJsonObj(obj: CohereUserMessageV2, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj ? obj : (model.CohereMessageV2.getJsonObj(obj) as CohereUserMessageV2)),
      ...{}
    };
  ...
  export function getDeserializedJsonObj(
    obj: CohereUserMessageV2,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.CohereMessageV2.getDeserializedJsonObj(obj) as CohereUserMessageV2)),
      ...{}
    };
