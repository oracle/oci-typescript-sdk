...
export namespace LlmInferenceRequest {
  export function getJsonObj(obj: LlmInferenceRequest): object {
    const jsonObj = { ...obj, ...{} };

    if (obj && "runtimeType" in obj && obj.runtimeType) {
      switch (obj.runtimeType) {
        case "LLAMA":
          return model.LlamaLlmInferenceRequest.getJsonObj(
            <model.LlamaLlmInferenceRequest>(<object>jsonObj),
            true
          );
        case "COHERE":
          return model.CohereLlmInferenceRequest.getJsonObj(
            <model.CohereLlmInferenceRequest>(<object>jsonObj),
            true
          );
        default:
  ...
  export function getDeserializedJsonObj(obj: LlmInferenceRequest): object {
    const jsonObj = { ...obj, ...{} };

    if (obj && "runtimeType" in obj && obj.runtimeType) {
      switch (obj.runtimeType) {
        case "LLAMA":
          return model.LlamaLlmInferenceRequest.getDeserializedJsonObj(
            <model.LlamaLlmInferenceRequest>(<object>jsonObj),
            true
          );
        case "COHERE":
          return model.CohereLlmInferenceRequest.getDeserializedJsonObj(
            <model.CohereLlmInferenceRequest>(<object>jsonObj),
            true
          );
        default:
