...
export namespace ToolChoiceRequired {
  export function getJsonObj(obj: ToolChoiceRequired, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj ? obj : (model.ToolChoice.getJsonObj(obj) as ToolChoiceRequired)),
      ...{}
    };
  ...
  export function getDeserializedJsonObj(
    obj: ToolChoiceRequired,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.ToolChoice.getDeserializedJsonObj(obj) as ToolChoiceRequired)),
      ...{}
    };
