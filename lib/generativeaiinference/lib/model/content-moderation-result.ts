...
export interface ContentModerationResult {
   ...
   */
  "categories": Array<model.CategoryScore>;
}

export namespace ContentModerationResult {
  export function getJsonObj(obj: ContentModerationResult): object {
    const jsonObj = {
      ...obj,
      ...{
        "categories": obj.categories
          ? obj.categories.map(item => {
              return model.CategoryScore.getJsonObj(item);
            })
          : undefined
      }
    };
  ...
  export function getDeserializedJsonObj(obj: ContentModerationResult): object {
    const jsonObj = {
      ...obj,
      ...{
        "categories": obj.categories
          ? obj.categories.map(item => {
              return model.CategoryScore.getDeserializedJsonObj(item);
            })
          : undefined
      }
    };
