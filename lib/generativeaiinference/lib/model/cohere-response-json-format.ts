 ...
 */
export interface CohereResponseJsonFormat extends model.CohereResponseFormat {
  /**
...
export namespace CohereResponseJsonFormat {
  export function getJsonObj(obj: CohereResponseJsonFormat, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.CohereResponseFormat.getJsonObj(obj) as CohereResponseJsonFormat)),
      ...{}
    };
  ...
  export function getDeserializedJsonObj(
    obj: CohereResponseJsonFormat,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.CohereResponseFormat.getDeserializedJsonObj(obj) as CohereResponseJsonFormat)),
      ...{}
    };
