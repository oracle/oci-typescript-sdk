 ...
 */
export interface CohereImageContentV2 extends model.CohereContentV2 {
  "imageUrl"?: model.CohereImageUrlV2;

  "type": string;
}

export namespace CohereImageContentV2 {
  export function getJsonObj(obj: CohereImageContentV2, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj ? obj : (model.CohereContentV2.getJsonObj(obj) as CohereImageContentV2)),
      ...{
        "imageUrl": obj.imageUrl ? model.CohereImageUrlV2.getJsonObj(obj.imageUrl) : undefined
      }
    };

    return jsonObj;
  }
  export const type = "IMAGE_URL";
  export function getDeserializedJsonObj(
    obj: CohereImageContentV2,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.CohereContentV2.getDeserializedJsonObj(obj) as CohereImageContentV2)),
      ...{
        "imageUrl": obj.imageUrl
          ? model.CohereImageUrlV2.getDeserializedJsonObj(obj.imageUrl)
          : undefined
      }
    };
