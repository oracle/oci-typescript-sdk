...
export namespace CohereToolMessage {
  export function getJsonObj(obj: CohereToolMessage, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj ? obj : (model.CohereMessage.getJsonObj(obj) as CohereToolMessage)),
      ...{
  ...
  export function getDeserializedJsonObj(
    obj: CohereToolMessage,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.CohereMessage.getDeserializedJsonObj(obj) as CohereToolMessage)),
      ...{
        "toolResults": obj.toolResults
          ? obj.toolResults.map(item => {
