...
export namespace AssistantMessage {
  export function getJsonObj(obj: AssistantMessage, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj ? obj : (model.Message.getJsonObj(obj) as AssistantMessage)),
      ...{}
    };
  ...
  export function getDeserializedJsonObj(obj: AssistantMessage, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj ? obj : (model.Message.getDeserializedJsonObj(obj) as AssistantMessage)),
      ...{}
    };
