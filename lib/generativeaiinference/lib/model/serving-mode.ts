...
export namespace ServingMode {
  export function getJsonObj(obj: ServingMode): object {
    const jsonObj = { ...obj, ...{} };

    if (obj && "servingType" in obj && obj.servingType) {
      switch (obj.servingType) {
        case "DEDICATED":
          return model.DedicatedServingMode.getJsonObj(
            <model.DedicatedServingMode>(<object>jsonObj),
            true
          );
        case "ON_DEMAND":
          return model.OnDemandServingMode.getJsonObj(
            <model.OnDemandServingMode>(<object>jsonObj),
            true
          );
        default:
          if (common.LOG.logger) common.LOG.logger.info(`Unknown value for: ${obj.servingType}`);
      }
    }
    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: ServingMode): object {
    const jsonObj = { ...obj, ...{} };

    if (obj && "servingType" in obj && obj.servingType) {
      switch (obj.servingType) {
        case "DEDICATED":
          return model.DedicatedServingMode.getDeserializedJsonObj(
            <model.DedicatedServingMode>(<object>jsonObj),
            true
          );
        case "ON_DEMAND":
          return model.OnDemandServingMode.getDeserializedJsonObj(
            <model.OnDemandServingMode>(<object>jsonObj),
            true
          );
        default:
