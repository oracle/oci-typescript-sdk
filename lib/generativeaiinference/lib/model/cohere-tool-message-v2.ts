 ...
 */
export interface CohereToolMessageV2 extends model.CohereMessageV2 {
  /**
...
export namespace CohereToolMessageV2 {
  export function getJsonObj(obj: CohereToolMessageV2, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj ? obj : (model.CohereMessageV2.getJsonObj(obj) as CohereToolMessageV2)),
      ...{}
    };
  ...
  export function getDeserializedJsonObj(
    obj: CohereToolMessageV2,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.CohereMessageV2.getDeserializedJsonObj(obj) as CohereToolMessageV2)),
      ...{}
    };
