...
export namespace ToolChoiceNone {
  export function getJsonObj(obj: ToolChoiceNone, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj ? obj : (model.ToolChoice.getJsonObj(obj) as ToolChoiceNone)),
      ...{}
    };
  ...
  export function getDeserializedJsonObj(obj: ToolChoiceNone, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj ? obj : (model.ToolChoice.getDeserializedJsonObj(obj) as ToolChoiceNone)),
      ...{}
    };
