...
export namespace CohereCitationSourceV2 {
  export enum Type {
    Tool = "TOOL",
    Document = "DOCUMENT",
    /**
  ...
  export function getJsonObj(obj: CohereCitationSourceV2): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: CohereCitationSourceV2): object {
    const jsonObj = {
      ...obj,
      ...{
