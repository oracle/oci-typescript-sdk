...
export namespace RerankTextResult {
  export function getJsonObj(obj: RerankTextResult): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: RerankTextResult): object {
    const jsonObj = {
      ...obj,
      ...{
        "documentRanks": obj.documentRanks
