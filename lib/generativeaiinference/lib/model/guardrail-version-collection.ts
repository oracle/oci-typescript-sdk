 ...
 */
export interface GuardrailVersionCollection {
  /**
   * The list of guardrail system versions.
   */
  "items": Array<model.GuardrailVersionSummary>;
}

export namespace GuardrailVersionCollection {
  export function getJsonObj(obj: GuardrailVersionCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
          ? obj.items.map(item => {
              return model.GuardrailVersionSummary.getJsonObj(item);
            })
          : undefined
      }
    };
  ...
  export function getDeserializedJsonObj(obj: GuardrailVersionCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
          ? obj.items.map(item => {
              return model.GuardrailVersionSummary.getDeserializedJsonObj(item);
            })
          : undefined
      }
    };
