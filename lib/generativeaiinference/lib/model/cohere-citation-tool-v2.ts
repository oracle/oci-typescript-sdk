...
export namespace CohereCitationToolV2 {
  export function getJsonObj(obj: CohereCitationToolV2): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: CohereCitationToolV2): object {
    const jsonObj = { ...obj, ...{} };
