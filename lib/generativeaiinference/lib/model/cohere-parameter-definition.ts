...
export namespace CohereParameterDefinition {
  export function getJsonObj(obj: CohereParameterDefinition): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: CohereParameterDefinition): object {
    const jsonObj = { ...obj, ...{} };
