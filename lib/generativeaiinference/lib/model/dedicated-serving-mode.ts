...
export namespace DedicatedServingMode {
  export function getJsonObj(obj: DedicatedServingMode, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj ? obj : (model.ServingMode.getJsonObj(obj) as DedicatedServingMode)),
      ...{}
    };

    return jsonObj;
  }
  export const servingType = "DEDICATED";
  export function getDeserializedJsonObj(
    obj: DedicatedServingMode,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.ServingMode.getDeserializedJsonObj(obj) as DedicatedServingMode)),
      ...{}
    };
