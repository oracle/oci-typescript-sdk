...
export namespace ToolCall {
  export function getJsonObj(obj: ToolCall): object {
    const jsonObj = { ...obj, ...{} };

    if (obj && "type" in obj && obj.type) {
      switch (obj.type) {
        case "FUNCTION":
          return model.FunctionCall.getJsonObj(<model.FunctionCall>(<object>jsonObj), true);
        default:
  ...
  export function getDeserializedJsonObj(obj: ToolCall): object {
    const jsonObj = { ...obj, ...{} };

    if (obj && "type" in obj && obj.type) {
      switch (obj.type) {
        case "FUNCTION":
          return model.FunctionCall.getDeserializedJsonObj(
            <model.FunctionCall>(<object>jsonObj),
            true
          );
        default:
          if (common.LOG.logger) common.LOG.logger.info(`Unknown value for: ${obj.type}`);
