 ...
 */
export interface CohereSystemMessageV2 extends model.CohereMessageV2 {
  "role": string;
}

export namespace CohereSystemMessageV2 {
  export function getJsonObj(obj: CohereSystemMessageV2, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj ? obj : (model.CohereMessageV2.getJsonObj(obj) as CohereSystemMessageV2)),
      ...{}
    };

    return jsonObj;
  }
  export const role = "SYSTEM";
  export function getDeserializedJsonObj(
    obj: CohereSystemMessageV2,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.CohereMessageV2.getDeserializedJsonObj(obj) as CohereSystemMessageV2)),
      ...{}
    };
