...
export namespace GenerateTextResult {
  export function getJsonObj(obj: GenerateTextResult): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: GenerateTextResult): object {
    const jsonObj = {
      ...obj,
      ...{
        "inferenceResponse": obj.inferenceResponse
