 ...
 */
export interface CohereChatBotMessage extends model.CohereMessage {
  /**
...
export namespace CohereChatBotMessage {
  export function getJsonObj(obj: CohereChatBotMessage, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj ? obj : (model.CohereMessage.getJsonObj(obj) as CohereChatBotMessage)),
      ...{
  ...
  export const role = "CHATBOT";
  export function getDeserializedJsonObj(
    obj: CohereChatBotMessage,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.CohereMessage.getDeserializedJsonObj(obj) as CohereChatBotMessage)),
      ...{
        "toolCalls": obj.toolCalls
          ? obj.toolCalls.map(item => {
