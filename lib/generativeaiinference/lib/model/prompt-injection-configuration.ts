...
export namespace PromptInjectionConfiguration {
  export function getJsonObj(obj: PromptInjectionConfiguration): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: PromptInjectionConfiguration): object {
    const jsonObj = { ...obj, ...{} };
