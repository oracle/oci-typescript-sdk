...
export namespace UserMessage {
  export function getJsonObj(obj: UserMessage, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj ? obj : (model.Message.getJsonObj(obj) as UserMessage)),
      ...{}
    };
  ...
  export function getDeserializedJsonObj(obj: UserMessage, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj ? obj : (model.Message.getDeserializedJsonObj(obj) as UserMessage)),
      ...{}
    };
