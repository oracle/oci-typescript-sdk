...
export namespace JsonObjectResponseFormat {
  export function getJsonObj(obj: JsonObjectResponseFormat, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.ResponseFormat.getJsonObj(obj) as JsonObjectResponseFormat)),
      ...{}
    };
  ...
  export function getDeserializedJsonObj(
    obj: JsonObjectResponseFormat,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.ResponseFormat.getDeserializedJsonObj(obj) as JsonObjectResponseFormat)),
      ...{}
    };
