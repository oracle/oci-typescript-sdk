...
export namespace PersonallyIdentifiableInformationResult {
  export function getJsonObj(obj: PersonallyIdentifiableInformationResult): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: PersonallyIdentifiableInformationResult): object {
    const jsonObj = { ...obj, ...{} };
