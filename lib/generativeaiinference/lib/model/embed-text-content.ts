 ...
 */
export interface EmbedTextContent extends model.EmbedContent {
  /**
   * The text content.
   */
  "text"?: string;
...
export namespace EmbedTextContent {
  export function getJsonObj(obj: EmbedTextContent, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj ? obj : (model.EmbedContent.getJsonObj(obj) as EmbedTextContent)),
      ...{}
    };
  ...
  export function getDeserializedJsonObj(obj: EmbedTextContent, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.EmbedContent.getDeserializedJsonObj(obj) as EmbedTextContent)),
      ...{}
    };
