...
export namespace EmbedContent {
  export function getJsonObj(obj: EmbedContent): object {
    const jsonObj = { ...obj, ...{} };

    if (obj && "type" in obj && obj.type) {
      switch (obj.type) {
        case "TEXT":
          return model.EmbedTextContent.getJsonObj(<model.EmbedTextContent>(<object>jsonObj), true);
        case "IMAGE":
          return model.EmbedImageContent.getJsonObj(
            <model.EmbedImageContent>(<object>jsonObj),
            true
          );
        default:
  ...
  export function getDeserializedJsonObj(obj: EmbedContent): object {
    const jsonObj = { ...obj, ...{} };

    if (obj && "type" in obj && obj.type) {
      switch (obj.type) {
        case "TEXT":
          return model.EmbedTextContent.getDeserializedJsonObj(
            <model.EmbedTextContent>(<object>jsonObj),
            true
          );
        case "IMAGE":
          return model.EmbedImageContent.getDeserializedJsonObj(
            <model.EmbedImageContent>(<object>jsonObj),
            true
          );
        default:
