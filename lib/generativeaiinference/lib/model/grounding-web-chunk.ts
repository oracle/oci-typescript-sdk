...
export namespace GroundingWebChunk {
  export function getJsonObj(obj: GroundingWebChunk): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: GroundingWebChunk): object {
    const jsonObj = { ...obj, ...{} };
