...
export namespace ApproximateLocation {
  export function getJsonObj(obj: ApproximateLocation): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: ApproximateLocation): object {
    const jsonObj = { ...obj, ...{} };
