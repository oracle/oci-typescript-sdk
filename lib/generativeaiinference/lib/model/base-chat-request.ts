...
export namespace BaseChatRequest {
  export function getJsonObj(obj: BaseChatRequest): object {
    const jsonObj = { ...obj, ...{} };
    ...
    if (obj && "apiFormat" in obj && obj.apiFormat) {
      switch (obj.apiFormat) {
        ...
        case "COHERE":
          return model.CohereChatRequest.getJsonObj(
            <model.CohereChatRequest>(<object>jsonObj),
            true
          );
        default:
  ...
  export function getDeserializedJsonObj(obj: BaseChatRequest): object {
    const jsonObj = { ...obj, ...{} };
    ...
    if (obj && "apiFormat" in obj && obj.apiFormat) {
      switch (obj.apiFormat) {
        ...
        case "COHERE":
          return model.CohereChatRequest.getDeserializedJsonObj(
            <model.CohereChatRequest>(<object>jsonObj),
            true
          );
        default:
