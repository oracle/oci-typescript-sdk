...
export namespace ChatContent {
  export function getJsonObj(obj: ChatContent): object {
    const jsonObj = { ...obj, ...{} };
  ...
  export function getDeserializedJsonObj(obj: ChatContent): object {
    const jsonObj = { ...obj, ...{} };
    ...
    if (obj && "type" in obj && obj.type) {
      switch (obj.type) {
        ...
        case "TEXT":
          return model.TextContent.getDeserializedJsonObj(
            <model.TextContent>(<object>jsonObj),
            true
          );
        default:
          if (common.LOG.logger) common.LOG.logger.info(`Unknown value for: ${obj.type}`);
