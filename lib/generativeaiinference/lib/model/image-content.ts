 ...
 */
export interface ImageContent extends model.ChatContent {
...
export namespace ImageContent {
  export function getJsonObj(obj: ImageContent, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj ? obj : (model.ChatContent.getJsonObj(obj) as ImageContent)),
      ...{
        "imageUrl": obj.imageUrl ? model.ImageUrl.getJsonObj(obj.imageUrl) : undefined
      }
    };
  ...
  export function getDeserializedJsonObj(obj: ImageContent, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj ? obj : (model.ChatContent.getDeserializedJsonObj(obj) as ImageContent)),
      ...{
        "imageUrl": obj.imageUrl ? model.ImageUrl.getDeserializedJsonObj(obj.imageUrl) : undefined
      }
    };
