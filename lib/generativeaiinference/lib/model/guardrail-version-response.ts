 ...
 */
export interface GuardrailVersionResponse {
  /**
...
export namespace GuardrailVersionResponse {
  export function getJsonObj(obj: GuardrailVersionResponse): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: GuardrailVersionResponse): object {
    const jsonObj = { ...obj, ...{} };
