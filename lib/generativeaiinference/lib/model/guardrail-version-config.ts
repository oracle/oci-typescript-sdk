...
export namespace GuardrailVersionConfig {
  export function getJsonObj(obj: GuardrailVersionConfig): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: GuardrailVersionConfig): object {
    const jsonObj = { ...obj, ...{} };
