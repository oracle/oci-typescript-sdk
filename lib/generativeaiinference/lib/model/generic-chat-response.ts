...
export namespace GenericChatResponse {
  export function getJsonObj(obj: GenericChatResponse, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj ? obj : (model.BaseChatResponse.getJsonObj(obj) as GenericChatResponse)),
      ...{
        "choices": obj.choices
  ...
  export function getDeserializedJsonObj(
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.BaseChatResponse.getDeserializedJsonObj(obj) as GenericChatResponse)),
      ...{
        "choices": obj.choices
          ? obj.choices.map(item => {
