...
export namespace CohereResponseFormat {
  export function getJsonObj(obj: CohereResponseFormat): object {
    const jsonObj = { ...obj, ...{} };

    if (obj && "type" in obj && obj.type) {
      switch (obj.type) {
        case "TEXT":
          return model.CohereResponseTextFormat.getJsonObj(
            <model.CohereResponseTextFormat>(<object>jsonObj),
            true
          );
        case "JSON_OBJECT":
          return model.CohereResponseJsonFormat.getJsonObj(
            <model.CohereResponseJsonFormat>(<object>jsonObj),
            true
          );
        default:
  ...
  export function getDeserializedJsonObj(obj: CohereResponseFormat): object {
    const jsonObj = { ...obj, ...{} };

    if (obj && "type" in obj && obj.type) {
      switch (obj.type) {
        case "TEXT":
          return model.CohereResponseTextFormat.getDeserializedJsonObj(
            <model.CohereResponseTextFormat>(<object>jsonObj),
            true
          );
        case "JSON_OBJECT":
          return model.CohereResponseJsonFormat.getDeserializedJsonObj(
            <model.CohereResponseJsonFormat>(<object>jsonObj),
            true
          );
        default:
