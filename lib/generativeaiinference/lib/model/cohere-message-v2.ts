 ...
 */
export interface CohereMessageV2 {
  /**
   * Contents of the chat message.
   */
  "content": Array<model.CohereContentV2>;

  "role": string;
}

export namespace CohereMessageV2 {
  export function getJsonObj(obj: CohereMessageV2): object {
    const jsonObj = {
      ...obj,
      ...{
        "content": obj.content
          ? obj.content.map(item => {
              return model.CohereContentV2.getJsonObj(item);
            })
          : undefined
      }
    };
    ...
    if (obj && "role" in obj && obj.role) {
      switch (obj.role) {
        case "SYSTEM":
          return model.CohereSystemMessageV2.getJsonObj(
            <model.CohereSystemMessageV2>(<object>jsonObj),
            true
          );
        case "ASSISTANT":
          return model.CohereAssistantMessageV2.getJsonObj(
            <model.CohereAssistantMessageV2>(<object>jsonObj),
            true
          );
        case "USER":
          return model.CohereUserMessageV2.getJsonObj(
            <model.CohereUserMessageV2>(<object>jsonObj),
            true
          );
        case "TOOL":
          return model.CohereToolMessageV2.getJsonObj(
            <model.CohereToolMessageV2>(<object>jsonObj),
            true
          );
        default:
  ...
  export function getDeserializedJsonObj(obj: CohereMessageV2): object {
    const jsonObj = {
      ...obj,
      ...{
        "content": obj.content
          ? obj.content.map(item => {
              return model.CohereContentV2.getDeserializedJsonObj(item);
            })
          : undefined
      }
    };
    ...
    if (obj && "role" in obj && obj.role) {
      switch (obj.role) {
        case "SYSTEM":
          return model.CohereSystemMessageV2.getDeserializedJsonObj(
            <model.CohereSystemMessageV2>(<object>jsonObj),
            true
          );
        case "ASSISTANT":
          return model.CohereAssistantMessageV2.getDeserializedJsonObj(
            <model.CohereAssistantMessageV2>(<object>jsonObj),
            true
          );
        case "USER":
          return model.CohereUserMessageV2.getDeserializedJsonObj(
            <model.CohereUserMessageV2>(<object>jsonObj),
            true
          );
        case "TOOL":
          return model.CohereToolMessageV2.getDeserializedJsonObj(
            <model.CohereToolMessageV2>(<object>jsonObj),
            true
          );
        default:
