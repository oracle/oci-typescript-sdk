...
export namespace DocumentContent {
  export function getJsonObj(obj: DocumentContent, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj ? obj : (model.ChatContent.getJsonObj(obj) as DocumentContent)),
      ...{
  ...
  export function getDeserializedJsonObj(obj: DocumentContent, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.ChatContent.getDeserializedJsonObj(obj) as DocumentContent)),
      ...{
