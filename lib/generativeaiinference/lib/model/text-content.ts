 ...
 */
export interface TextContent extends model.ChatContent {
  /**
   * The text content.
   */
  "text"?: string;
...
export namespace TextContent {
  export function getJsonObj(obj: TextContent, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj ? obj : (model.ChatContent.getJsonObj(obj) as TextContent)),
      ...{}
    };
  ...
  export function getDeserializedJsonObj(obj: TextContent, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj ? obj : (model.ChatContent.getDeserializedJsonObj(obj) as TextContent)),
      ...{}
    };
