...
export namespace ToolDefinition {
  export function getJsonObj(obj: ToolDefinition): object {
    const jsonObj = { ...obj, ...{} };

    if (obj && "type" in obj && obj.type) {
      switch (obj.type) {
        case "FUNCTION":
          return model.FunctionDefinition.getJsonObj(
            <model.FunctionDefinition>(<object>jsonObj),
            true
          );
        default:
  ...
  export function getDeserializedJsonObj(obj: ToolDefinition): object {
    const jsonObj = { ...obj, ...{} };

    if (obj && "type" in obj && obj.type) {
      switch (obj.type) {
        case "FUNCTION":
          return model.FunctionDefinition.getDeserializedJsonObj(
            <model.FunctionDefinition>(<object>jsonObj),
            true
          );
        default:
