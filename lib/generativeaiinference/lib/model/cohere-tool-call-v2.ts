 ...
 */
export interface CohereToolCallV2 {
  /**
   * Id of the tool call.
   */
  "id"?: string;
...
export namespace CohereToolCallV2 {
  export enum Type {
    Function = "FUNCTION",
    /**
  ...
  export function getJsonObj(obj: CohereToolCallV2): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: CohereToolCallV2): object {
    const jsonObj = { ...obj, ...{} };
