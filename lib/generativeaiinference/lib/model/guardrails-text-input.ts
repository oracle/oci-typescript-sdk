 ...
 */
export interface GuardrailsTextInput extends model.GuardrailsInput {
  /**
...
export namespace GuardrailsTextInput {
  export function getJsonObj(obj: GuardrailsTextInput, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj ? obj : (model.GuardrailsInput.getJsonObj(obj) as GuardrailsTextInput)),
      ...{}
    };
  ...
  export function getDeserializedJsonObj(
    obj: GuardrailsTextInput,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.GuardrailsInput.getDeserializedJsonObj(obj) as GuardrailsTextInput)),
      ...{}
    };
