 ...
 */
export interface SystemMessage extends model.Message {
  /**
...
export namespace SystemMessage {
  export function getJsonObj(obj: SystemMessage, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj ? obj : (model.Message.getJsonObj(obj) as SystemMessage)),
      ...{}
    };
  ...
  export function getDeserializedJsonObj(obj: SystemMessage, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj ? obj : (model.Message.getDeserializedJsonObj(obj) as SystemMessage)),
      ...{}
    };
