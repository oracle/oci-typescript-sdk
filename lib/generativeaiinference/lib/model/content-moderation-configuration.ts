 ...
 */
export interface ContentModerationConfiguration {
  /**
...
export namespace ContentModerationConfiguration {
  export function getJsonObj(obj: ContentModerationConfiguration): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: ContentModerationConfiguration): object {
    const jsonObj = { ...obj, ...{} };
