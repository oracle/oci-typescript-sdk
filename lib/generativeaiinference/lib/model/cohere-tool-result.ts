...
export namespace CohereToolResult {
  export function getJsonObj(obj: CohereToolResult): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: CohereToolResult): object {
    const jsonObj = {
      ...obj,
      ...{
