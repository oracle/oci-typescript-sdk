...
export namespace CohereCitationDocument {
  export function getJsonObj(obj: CohereCitationDocument): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: CohereCitationDocument): object {
    const jsonObj = { ...obj, ...{} };
