...
export namespace CohereUserMessage {
  export function getJsonObj(obj: CohereUserMessage, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj ? obj : (model.CohereMessage.getJsonObj(obj) as CohereUserMessage)),
      ...{}
    };
  ...
  export function getDeserializedJsonObj(
    obj: CohereUserMessage,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.CohereMessage.getDeserializedJsonObj(obj) as CohereUserMessage)),
      ...{}
    };
