...
export namespace Usage {
  export function getJsonObj(obj: Usage): object {
    const jsonObj = {
      ...obj,
      ...{
        "completionTokensDetails": obj.completionTokensDetails
          ? model.CompletionTokensDetails.getJsonObj(obj.completionTokensDetails)
          : undefined,
        "promptTokensDetails": obj.promptTokensDetails
          ? model.PromptTokensDetails.getJsonObj(obj.promptTokensDetails)
          : undefined
      }
    };
  ...
  export function getDeserializedJsonObj(obj: Usage): object {
    const jsonObj = {
      ...obj,
      ...{
        "completionTokensDetails": obj.completionTokensDetails
          ? model.CompletionTokensDetails.getDeserializedJsonObj(obj.completionTokensDetails)
          : undefined,
        "promptTokensDetails": obj.promptTokensDetails
          ? model.PromptTokensDetails.getDeserializedJsonObj(obj.promptTokensDetails)
          : undefined
      }
    };
