...
export namespace CohereContentV2 {
  export function getJsonObj(obj: CohereContentV2): object {
    const jsonObj = { ...obj, ...{} };

    if (obj && "type" in obj && obj.type) {
      switch (obj.type) {
        case "THINKING":
          return model.CohereThinkingContentV2.getJsonObj(
            <model.CohereThinkingContentV2>(<object>jsonObj),
            true
          );
        case "TEXT":
          return model.CohereTextContentV2.getJsonObj(
            <model.CohereTextContentV2>(<object>jsonObj),
            true
          );
        case "IMAGE_URL":
          return model.CohereImageContentV2.getJsonObj(
            <model.CohereImageContentV2>(<object>jsonObj),
            true
          );
        case "DOCUMENT":
          return model.CohereDocumentContentV2.getJsonObj(
            <model.CohereDocumentContentV2>(<object>jsonObj),
            true
          );
        default:
  ...
  export function getDeserializedJsonObj(obj: CohereContentV2): object {
    const jsonObj = { ...obj, ...{} };

    if (obj && "type" in obj && obj.type) {
      switch (obj.type) {
        case "THINKING":
          return model.CohereThinkingContentV2.getDeserializedJsonObj(
            <model.CohereThinkingContentV2>(<object>jsonObj),
            true
          );
        case "TEXT":
          return model.CohereTextContentV2.getDeserializedJsonObj(
            <model.CohereTextContentV2>(<object>jsonObj),
            true
          );
        case "IMAGE_URL":
          return model.CohereImageContentV2.getDeserializedJsonObj(
            <model.CohereImageContentV2>(<object>jsonObj),
            true
          );
        case "DOCUMENT":
          return model.CohereDocumentContentV2.getDeserializedJsonObj(
            <model.CohereDocumentContentV2>(<object>jsonObj),
            true
          );
        default:
