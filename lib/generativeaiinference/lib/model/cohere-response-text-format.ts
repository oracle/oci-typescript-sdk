 ...
 */
export interface CohereResponseTextFormat extends model.CohereResponseFormat {
  "type": string;
}

export namespace CohereResponseTextFormat {
  export function getJsonObj(obj: CohereResponseTextFormat, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.CohereResponseFormat.getJsonObj(obj) as CohereResponseTextFormat)),
      ...{}
    };
  ...
  export function getDeserializedJsonObj(
    obj: CohereResponseTextFormat,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.CohereResponseFormat.getDeserializedJsonObj(obj) as CohereResponseTextFormat)),
      ...{}
    };
