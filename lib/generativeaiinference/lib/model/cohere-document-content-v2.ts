...
export namespace CohereDocumentContentV2 {
  export function getJsonObj(obj: CohereDocumentContentV2, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.CohereContentV2.getJsonObj(obj) as CohereDocumentContentV2)),
      ...{}
    };
  ...
  export function getDeserializedJsonObj(
    obj: CohereDocumentContentV2,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.CohereContentV2.getDeserializedJsonObj(obj) as CohereDocumentContentV2)),
      ...{}
    };
