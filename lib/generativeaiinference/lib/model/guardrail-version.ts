...
export namespace GuardrailVersion {
  export enum State {
    Active = "ACTIVE",
    Preview = "PREVIEW",
  ...
  export function getJsonObj(obj: GuardrailVersion): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: GuardrailVersion): object {
    const jsonObj = { ...obj, ...{} };
