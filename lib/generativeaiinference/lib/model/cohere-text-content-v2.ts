 ...
 */
export interface CohereTextContentV2 extends model.CohereContentV2 {
  /**
   * The text content.
   */
  "text"?: string;
...
export namespace CohereTextContentV2 {
  export function getJsonObj(obj: CohereTextContentV2, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj ? obj : (model.CohereContentV2.getJsonObj(obj) as CohereTextContentV2)),
      ...{}
    };
  ...
  export function getDeserializedJsonObj(
    obj: CohereTextContentV2,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.CohereContentV2.getDeserializedJsonObj(obj) as CohereTextContentV2)),
      ...{}
    };
