 ...
 */
export interface GuardrailConfigs {
  "contentModerationConfig"?: model.ContentModerationConfiguration;
  "personallyIdentifiableInformationConfig"?: model.PersonallyIdentifiableInformationConfiguration;
  "promptInjectionConfig"?: model.PromptInjectionConfiguration;
}

export namespace GuardrailConfigs {
  export function getJsonObj(obj: GuardrailConfigs): object {
    const jsonObj = {
      ...obj,
      ...{
        "contentModerationConfig": obj.contentModerationConfig
          ? model.ContentModerationConfiguration.getJsonObj(obj.contentModerationConfig)
          : undefined,
        "personallyIdentifiableInformationConfig": obj.personallyIdentifiableInformationConfig
          ? model.PersonallyIdentifiableInformationConfiguration.getJsonObj(
              obj.personallyIdentifiableInformationConfig
            )
          : undefined,
        "promptInjectionConfig": obj.promptInjectionConfig
          ? model.PromptInjectionConfiguration.getJsonObj(obj.promptInjectionConfig)
          : undefined
      }
    };
  ...
  export function getDeserializedJsonObj(obj: GuardrailConfigs): object {
    const jsonObj = {
      ...obj,
      ...{
        "contentModerationConfig": obj.contentModerationConfig
          ? model.ContentModerationConfiguration.getDeserializedJsonObj(obj.contentModerationConfig)
          : undefined,
        "personallyIdentifiableInformationConfig": obj.personallyIdentifiableInformationConfig
          ? model.PersonallyIdentifiableInformationConfiguration.getDeserializedJsonObj(
              obj.personallyIdentifiableInformationConfig
            )
          : undefined,
        "promptInjectionConfig": obj.promptInjectionConfig
          ? model.PromptInjectionConfiguration.getDeserializedJsonObj(obj.promptInjectionConfig)
          : undefined
      }
    };
