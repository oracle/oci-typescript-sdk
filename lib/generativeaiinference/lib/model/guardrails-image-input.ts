 ...
 */
export interface GuardrailsImageInput extends model.GuardrailsInput {
  "imageUrl"?: model.GuardrailsImageUrl;

  "type": string;
}

export namespace GuardrailsImageInput {
  export function getJsonObj(obj: GuardrailsImageInput, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj ? obj : (model.GuardrailsInput.getJsonObj(obj) as GuardrailsImageInput)),
      ...{
        "imageUrl": obj.imageUrl ? model.GuardrailsImageUrl.getJsonObj(obj.imageUrl) : undefined
      }
    };
  ...
  export function getDeserializedJsonObj(
    obj: GuardrailsImageInput,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.GuardrailsInput.getDeserializedJsonObj(obj) as GuardrailsImageInput)),
      ...{
        "imageUrl": obj.imageUrl
          ? model.GuardrailsImageUrl.getDeserializedJsonObj(obj.imageUrl)
          : undefined
      }
    };
