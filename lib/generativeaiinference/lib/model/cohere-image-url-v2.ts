 ...
 */
export interface CohereImageUrlV2 {
  /**
   ...
   */
  "detail"?: CohereImageUrlV2.Detail;
}

export namespace CohereImageUrlV2 {
  export enum Detail {
    Auto = "AUTO",
    High = "HIGH",
    Low = "LOW",
  ...
  export function getJsonObj(obj: CohereImageUrlV2): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: CohereImageUrlV2): object {
    const jsonObj = { ...obj, ...{} };
