...
export interface CohereTool {
   ...
   */
  "parameterDefinitions"?: { [key: string]: model.CohereParameterDefinition };
}

export namespace CohereTool {
  export function getJsonObj(obj: CohereTool): object {
    const jsonObj = {
      ...obj,
      ...{
        "parameterDefinitions": obj.parameterDefinitions
          ? common.mapContainer(
              ...
              model.CohereParameterDefinition.getJsonObj
            )
          : undefined
      }
    };
  ...
  export function getDeserializedJsonObj(obj: CohereTool): object {
    const jsonObj = {
      ...obj,
      ...{
        "parameterDefinitions": obj.parameterDefinitions
          ? common.mapContainer(
              obj.parameterDefinitions,
              model.CohereParameterDefinition.getDeserializedJsonObj
            )
          : undefined
      }
    };
