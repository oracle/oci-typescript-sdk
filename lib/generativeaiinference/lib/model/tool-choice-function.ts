...
export namespace ToolChoiceFunction {
  export function getJsonObj(obj: ToolChoiceFunction, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj ? obj : (model.ToolChoice.getJsonObj(obj) as ToolChoiceFunction)),
      ...{}
    };
  ...
  export function getDeserializedJsonObj(
    obj: ToolChoiceFunction,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.ToolChoice.getDeserializedJsonObj(obj) as ToolChoiceFunction)),
      ...{}
    };
