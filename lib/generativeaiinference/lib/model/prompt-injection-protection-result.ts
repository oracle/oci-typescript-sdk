...
export interface PromptInjectionProtectionResult {
   ...
   *
   */
  "flaggedModalities"?: Array<PromptInjectionProtectionResult.FlaggedModalities>;
}

export namespace PromptInjectionProtectionResult {
  ...
  export function getJsonObj(obj: PromptInjectionProtectionResult): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: PromptInjectionProtectionResult): object {
    const jsonObj = { ...obj, ...{} };
