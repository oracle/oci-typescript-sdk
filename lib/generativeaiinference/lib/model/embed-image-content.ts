 ...
 */
export interface EmbedImageContent extends model.EmbedContent {
  "imageUrl"?: model.ImageUrl;

  "type": string;
}

export namespace EmbedImageContent {
  export function getJsonObj(obj: EmbedImageContent, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj ? obj : (model.EmbedContent.getJsonObj(obj) as EmbedImageContent)),
      ...{
  ...
  export function getDeserializedJsonObj(
    obj: EmbedImageContent,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.EmbedContent.getDeserializedJsonObj(obj) as EmbedImageContent)),
      ...{
