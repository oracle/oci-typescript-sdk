...
export namespace GroundingSupportSegment {
  export function getJsonObj(obj: GroundingSupportSegment): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: GroundingSupportSegment): object {
    const jsonObj = { ...obj, ...{} };
