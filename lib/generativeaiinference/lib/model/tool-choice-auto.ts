...
export namespace ToolChoiceAuto {
  export function getJsonObj(obj: ToolChoiceAuto, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj ? obj : (model.ToolChoice.getJsonObj(obj) as ToolChoiceAuto)),
      ...{}
    };
  ...
  export function getDeserializedJsonObj(obj: ToolChoiceAuto, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj ? obj : (model.ToolChoice.getDeserializedJsonObj(obj) as ToolChoiceAuto)),
      ...{}
    };
