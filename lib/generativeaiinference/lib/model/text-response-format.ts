...
export namespace TextResponseFormat {
  export function getJsonObj(obj: TextResponseFormat, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj ? obj : (model.ResponseFormat.getJsonObj(obj) as TextResponseFormat)),
      ...{}
    };
  ...
  export function getDeserializedJsonObj(
    obj: TextResponseFormat,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.ResponseFormat.getDeserializedJsonObj(obj) as TextResponseFormat)),
      ...{}
    };
