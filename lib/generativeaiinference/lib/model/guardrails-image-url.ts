 ...
 */
export interface GuardrailsImageUrl {
  /**
...
export namespace GuardrailsImageUrl {
  export function getJsonObj(obj: GuardrailsImageUrl): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: GuardrailsImageUrl): object {
    const jsonObj = { ...obj, ...{} };
