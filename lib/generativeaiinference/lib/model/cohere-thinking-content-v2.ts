 ...
 */
export interface CohereThinkingContentV2 extends model.CohereContentV2 {
  /**
...
export namespace CohereThinkingContentV2 {
  export function getJsonObj(obj: CohereThinkingContentV2, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.CohereContentV2.getJsonObj(obj) as CohereThinkingContentV2)),
      ...{}
    };

    return jsonObj;
  }
  export const type = "THINKING";
  export function getDeserializedJsonObj(
    obj: CohereThinkingContentV2,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.CohereContentV2.getDeserializedJsonObj(obj) as CohereThinkingContentV2)),
      ...{}
    };
