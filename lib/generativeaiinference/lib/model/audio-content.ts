...
export namespace AudioContent {
  export function getJsonObj(obj: AudioContent, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj ? obj : (model.ChatContent.getJsonObj(obj) as AudioContent)),
      ...{
  ...
  export function getDeserializedJsonObj(obj: AudioContent, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj ? obj : (model.ChatContent.getDeserializedJsonObj(obj) as AudioContent)),
      ...{
