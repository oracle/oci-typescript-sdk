...
export namespace GuardrailVersionSummary {
  export function getJsonObj(obj: GuardrailVersionSummary): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: GuardrailVersionSummary): object {
    const jsonObj = { ...obj, ...{} };
