...
export namespace RecoveryServiceSubnet {
  export function getJsonObj(obj: RecoveryServiceSubnet): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: RecoveryServiceSubnet): object {
    const jsonObj = { ...obj, ...{} };
