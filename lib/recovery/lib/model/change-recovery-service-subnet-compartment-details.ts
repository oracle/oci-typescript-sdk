...
export namespace ChangeRecoveryServiceSubnetCompartmentDetails {
  export function getJsonObj(obj: ChangeRecoveryServiceSubnetCompartmentDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(
    obj: ChangeRecoveryServiceSubnetCompartmentDetails
  ): object {
    const jsonObj = { ...obj, ...{} };
