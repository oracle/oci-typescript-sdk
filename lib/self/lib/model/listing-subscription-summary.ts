...
export namespace ListingSubscriptionSummary {
  export function getJsonObj(obj: ListingSubscriptionSummary): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: ListingSubscriptionSummary): object {
    const jsonObj = { ...obj, ...{} };
