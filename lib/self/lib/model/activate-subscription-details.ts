...
export namespace ActivateSubscriptionDetails {
  export function getJsonObj(obj: ActivateSubscriptionDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: ActivateSubscriptionDetails): object {
    const jsonObj = { ...obj, ...{} };
