...
export namespace CancelSubscriptionDetails {
  export function getJsonObj(obj: CancelSubscriptionDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: CancelSubscriptionDetails): object {
    const jsonObj = { ...obj, ...{} };
