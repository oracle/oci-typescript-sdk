...
export namespace SubscriptionToken {
  export function getJsonObj(obj: SubscriptionToken): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: SubscriptionToken): object {
    const jsonObj = { ...obj, ...{} };
