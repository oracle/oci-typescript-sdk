...
export namespace LifecycleStateEnum {
  export function getJsonObj(obj: LifecycleStateEnum): LifecycleStateEnum {
    return obj;
  }
  export function getDeserializedJsonObj(obj: LifecycleStateEnum): LifecycleStateEnum {
    return obj;
  }
}
