...
export interface PartnerCollection {
   ...
   */
  "items": Array<model.PartnerSummary>;
}

export namespace PartnerCollection {
  export function getJsonObj(obj: PartnerCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
          ? obj.items.map(item => {
              return model.PartnerSummary.getJsonObj(item);
            })
          : undefined
      }
    };
  ...
  export function getDeserializedJsonObj(obj: PartnerCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
          ? obj.items.map(item => {
              return model.PartnerSummary.getDeserializedJsonObj(item);
            })
          : undefined
      }
    };
