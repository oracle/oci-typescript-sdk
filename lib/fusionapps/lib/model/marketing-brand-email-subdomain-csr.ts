 ...
 */
export interface MarketingBrandEmailSubdomainCsr {
  /**
...
export namespace MarketingBrandEmailSubdomainCsr {
  export function getJsonObj(obj: MarketingBrandEmailSubdomainCsr): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: MarketingBrandEmailSubdomainCsr): object {
    const jsonObj = { ...obj, ...{} };
