 ...
 */
export interface UpdateMicrositeDetails {
  /**
...
export namespace UpdateMicrositeDetails {
  export function getJsonObj(obj: UpdateMicrositeDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: UpdateMicrositeDetails): object {
    const jsonObj = { ...obj, ...{} };
