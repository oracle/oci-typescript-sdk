...
import * as CertificateInfo from "./certificate-info";
export import CertificateInfo = CertificateInfo.CertificateInfo;
...
import * as CreateEmailSubdomainDetails from "./create-email-subdomain-details";
export import CreateEmailSubdomainDetails = CreateEmailSubdomainDetails.CreateEmailSubdomainDetails;
...
import * as CreateMarketingBrandDetails from "./create-marketing-brand-details";
export import CreateMarketingBrandDetails = CreateMarketingBrandDetails.CreateMarketingBrandDetails;
import * as CreateMicrositeDetails from "./create-microsite-details";
export import CreateMicrositeDetails = CreateMicrositeDetails.CreateMicrositeDetails;
...
import * as CreateVanityDomainActivityDetails from "./create-vanity-domain-activity-details";
export import CreateVanityDomainActivityDetails = CreateVanityDomainActivityDetails.CreateVanityDomainActivityDetails;
import * as CreateVanityDomainDetails from "./create-vanity-domain-details";
export import CreateVanityDomainDetails = CreateVanityDomainDetails.CreateVanityDomainDetails;
...
import * as DnsRecord from "./dns-record";
export import DnsRecord = DnsRecord.DnsRecord;
import * as EmailSubdomain from "./email-subdomain";
export import EmailSubdomain = EmailSubdomain.EmailSubdomain;
import * as EmailSubdomainCollection from "./email-subdomain-collection";
export import EmailSubdomainCollection = EmailSubdomainCollection.EmailSubdomainCollection;
import * as EmailSubdomainSummary from "./email-subdomain-summary";
export import EmailSubdomainSummary = EmailSubdomainSummary.EmailSubdomainSummary;
...
import * as MarketingBrand from "./marketing-brand";
export import MarketingBrand = MarketingBrand.MarketingBrand;
import * as MarketingBrandCollection from "./marketing-brand-collection";
export import MarketingBrandCollection = MarketingBrandCollection.MarketingBrandCollection;
import * as MarketingBrandEmailSubdomainCsr from "./marketing-brand-email-subdomain-csr";
export import MarketingBrandEmailSubdomainCsr = MarketingBrandEmailSubdomainCsr.MarketingBrandEmailSubdomainCsr;
import * as MarketingBrandEmailSubdomainDnsConfig from "./marketing-brand-email-subdomain-dns-config";
export import MarketingBrandEmailSubdomainDnsConfig = MarketingBrandEmailSubdomainDnsConfig.MarketingBrandEmailSubdomainDnsConfig;
import * as MarketingBrandMicrositeDnsConfig from "./marketing-brand-microsite-dns-config";
export import MarketingBrandMicrositeDnsConfig = MarketingBrandMicrositeDnsConfig.MarketingBrandMicrositeDnsConfig;
import * as MarketingBrandSummary from "./marketing-brand-summary";
export import MarketingBrandSummary = MarketingBrandSummary.MarketingBrandSummary;
import * as Microsite from "./microsite";
export import Microsite = Microsite.Microsite;
import * as MicrositeCollection from "./microsite-collection";
export import MicrositeCollection = MicrositeCollection.MicrositeCollection;
import * as MicrositeSummary from "./microsite-summary";
export import MicrositeSummary = MicrositeSummary.MicrositeSummary;
...
import * as RequestEmailSubdomainCsrDetails from "./request-email-subdomain-csr-details";
export import RequestEmailSubdomainCsrDetails = RequestEmailSubdomainCsrDetails.RequestEmailSubdomainCsrDetails;
...
import * as UpdateEmailSubdomainDetails from "./update-email-subdomain-details";
export import UpdateEmailSubdomainDetails = UpdateEmailSubdomainDetails.UpdateEmailSubdomainDetails;
...
import * as UpdateMarketingBrandDetails from "./update-marketing-brand-details";
export import UpdateMarketingBrandDetails = UpdateMarketingBrandDetails.UpdateMarketingBrandDetails;
import * as UpdateMicrositeDetails from "./update-microsite-details";
export import UpdateMicrositeDetails = UpdateMicrositeDetails.UpdateMicrositeDetails;
...
import * as UpdateVanityDomainActivityDetails from "./update-vanity-domain-activity-details";
export import UpdateVanityDomainActivityDetails = UpdateVanityDomainActivityDetails.UpdateVanityDomainActivityDetails;
import * as UpdateVanityDomainDetails from "./update-vanity-domain-details";
export import UpdateVanityDomainDetails = UpdateVanityDomainDetails.UpdateVanityDomainDetails;
import * as UploadEmailSubdomainCertificateDetails from "./upload-email-subdomain-certificate-details";
export import UploadEmailSubdomainCertificateDetails = UploadEmailSubdomainCertificateDetails.UploadEmailSubdomainCertificateDetails;
import * as UploadVanityDomainCertificateDetails from "./upload-vanity-domain-certificate-details";
export import UploadVanityDomainCertificateDetails = UploadVanityDomainCertificateDetails.UploadVanityDomainCertificateDetails;
import * as VanityDnsRecord from "./vanity-dns-record";
export import VanityDnsRecord = VanityDnsRecord.VanityDnsRecord;
import * as VanityDomain from "./vanity-domain";
export import VanityDomain = VanityDomain.VanityDomain;
import * as VanityDomainActivity from "./vanity-domain-activity";
export import VanityDomainActivity = VanityDomainActivity.VanityDomainActivity;
import * as VanityDomainCollection from "./vanity-domain-collection";
export import VanityDomainCollection = VanityDomainCollection.VanityDomainCollection;
import * as VanityDomainSummary from "./vanity-domain-summary";
export import VanityDomainSummary = VanityDomainSummary.VanityDomainSummary;
