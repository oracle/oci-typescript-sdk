 ...
 */
export interface UploadEmailSubdomainCertificateDetails {
  /**
...
export namespace UploadEmailSubdomainCertificateDetails {
  export function getJsonObj(obj: UploadEmailSubdomainCertificateDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: UploadEmailSubdomainCertificateDetails): object {
    const jsonObj = { ...obj, ...{} };
