 ...
 */
export interface UpdateVanityDomainActivityDetails {
  /**
...
export namespace UpdateVanityDomainActivityDetails {
  export function getJsonObj(obj: UpdateVanityDomainActivityDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: UpdateVanityDomainActivityDetails): object {
    const jsonObj = { ...obj, ...{} };
