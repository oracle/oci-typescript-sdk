...
export namespace AdminUserSummary {
  export function getJsonObj(obj: AdminUserSummary): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: AdminUserSummary): object {
    const jsonObj = { ...obj, ...{} };
