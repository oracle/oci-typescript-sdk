...
export namespace MarketingBrandSummary {
  export function getJsonObj(obj: MarketingBrandSummary): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: MarketingBrandSummary): object {
    const jsonObj = { ...obj, ...{} };
