...
export namespace ChangeFusionEnvironmentFamilyCompartmentDetails {
  export function getJsonObj(obj: ChangeFusionEnvironmentFamilyCompartmentDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(
    obj: ChangeFusionEnvironmentFamilyCompartmentDetails
  ): object {
    const jsonObj = { ...obj, ...{} };
