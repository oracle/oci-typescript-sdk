...
export namespace CreateDataMaskingActivityDetails {
  export function getJsonObj(obj: CreateDataMaskingActivityDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: CreateDataMaskingActivityDetails): object {
    const jsonObj = { ...obj, ...{} };
