...
export namespace TimeAvailableForRefresh {
  export function getJsonObj(obj: TimeAvailableForRefresh): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: TimeAvailableForRefresh): object {
    const jsonObj = { ...obj, ...{} };
