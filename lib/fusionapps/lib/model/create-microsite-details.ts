 ...
 */
export interface CreateMicrositeDetails {
  /**
   * microsite name
   */
  "name": string;
...
export namespace CreateMicrositeDetails {
  export function getJsonObj(obj: CreateMicrositeDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: CreateMicrositeDetails): object {
    const jsonObj = { ...obj, ...{} };
