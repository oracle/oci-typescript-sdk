...
export namespace UpdateFamilyMaintenancePolicyDetails {
  export function getJsonObj(obj: UpdateFamilyMaintenancePolicyDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: UpdateFamilyMaintenancePolicyDetails): object {
    const jsonObj = { ...obj, ...{} };
