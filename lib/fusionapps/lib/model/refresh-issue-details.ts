...
export namespace RefreshIssueDetails {
  export function getJsonObj(obj: RefreshIssueDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: RefreshIssueDetails): object {
    const jsonObj = { ...obj, ...{} };
