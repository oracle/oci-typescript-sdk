...
export interface EmailSubdomain {
   ...
   */
  "lifecycleState": EmailSubdomain.LifecycleState;
  /**
   * Email subdomain intermediate states
   */
  "lifecycleDetails"?: EmailSubdomain.LifecycleDetails;
  /**
   * dns management type for email subdomain
   */
  "dnsManagement": EmailSubdomain.DnsManagement;
  /**
   * dns status for email subdomain
   */
  "dnsStatus": EmailSubdomain.DnsStatus;
  /**
   * dns management type for email subdomain
   */
  "certificateManagement": EmailSubdomain.CertificateManagement;
  /**
   * certificate status for email subdomain
   */
  "certificateStatus": EmailSubdomain.CertificateStatus;
  /**
...
export namespace EmailSubdomain {
  ...
  export function getJsonObj(obj: EmailSubdomain): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: EmailSubdomain): object {
    const jsonObj = { ...obj, ...{} };
