 ...
 */
export interface UpdateEmailSubdomainDetails {
  /**
...
export namespace UpdateEmailSubdomainDetails {
  export function getJsonObj(obj: UpdateEmailSubdomainDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: UpdateEmailSubdomainDetails): object {
    const jsonObj = { ...obj, ...{} };
