 ...
 */
export interface CreateVanityDomainActivityDetails {
  /**
   * Vanity domain ID
   */
   ...
   */
  "operationType": CreateVanityDomainActivityDetails.OperationType;
}

export namespace CreateVanityDomainActivityDetails {
  export enum OperationType {
    EnableVanityDomain = "ENABLE_VANITY_DOMAIN",
    DeleteVanityDomain = "DELETE_VANITY_DOMAIN"
  }

  export function getJsonObj(obj: CreateVanityDomainActivityDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: CreateVanityDomainActivityDetails): object {
    const jsonObj = { ...obj, ...{} };
