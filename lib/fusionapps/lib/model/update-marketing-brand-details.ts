 ...
 */
export interface UpdateMarketingBrandDetails {
  /**
...
export namespace UpdateMarketingBrandDetails {
  export function getJsonObj(obj: UpdateMarketingBrandDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: UpdateMarketingBrandDetails): object {
    const jsonObj = { ...obj, ...{} };
