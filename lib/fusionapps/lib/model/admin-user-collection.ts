...
export namespace AdminUserCollection {
  export function getJsonObj(obj: AdminUserCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
  ...
  export function getDeserializedJsonObj(obj: AdminUserCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
