 ...
 */
export interface VanityDnsRecord {
  /**
  ...
  "type": string;
  /**
   * time to live for dns record Note: Numbers greater than Number.MAX_SAFE_INTEGER will result in rounding issues.
   */
  "ttlInSeconds": number;
}

export namespace VanityDnsRecord {
  export function getJsonObj(obj: VanityDnsRecord): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: VanityDnsRecord): object {
    const jsonObj = { ...obj, ...{} };
