...
export namespace ChangeFusionEnvironmentCompartmentDetails {
  export function getJsonObj(obj: ChangeFusionEnvironmentCompartmentDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: ChangeFusionEnvironmentCompartmentDetails): object {
    const jsonObj = { ...obj, ...{} };
