...
export namespace MicrositeSummary {
  export function getJsonObj(obj: MicrositeSummary): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: MicrositeSummary): object {
    const jsonObj = { ...obj, ...{} };
