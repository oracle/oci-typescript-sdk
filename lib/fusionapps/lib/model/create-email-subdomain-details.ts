 ...
 */
export interface CreateEmailSubdomainDetails {
  /**
...
export namespace CreateEmailSubdomainDetails {
  export function getJsonObj(obj: CreateEmailSubdomainDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: CreateEmailSubdomainDetails): object {
    const jsonObj = { ...obj, ...{} };
