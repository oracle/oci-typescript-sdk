...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/fusionapps/ListMicrosites.ts.html |here} to see how to use ListMicrositesRequest.
 */
export interface ListMicrositesRequest extends common.BaseRequest {
  /**
...
export namespace ListMicrositesRequest {
