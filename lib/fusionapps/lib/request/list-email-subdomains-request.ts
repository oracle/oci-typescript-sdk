...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/fusionapps/ListEmailSubdomains.ts.html |here} to see how to use ListEmailSubdomainsRequest.
 */
export interface ListEmailSubdomainsRequest extends common.BaseRequest {
  /**
...
export namespace ListEmailSubdomainsRequest {
