...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/fusionapps/ListMarketingBrands.ts.html |here} to see how to use ListMarketingBrandsRequest.
 */
export interface ListMarketingBrandsRequest extends common.BaseRequest {
  /**
...
export namespace ListMarketingBrandsRequest {
