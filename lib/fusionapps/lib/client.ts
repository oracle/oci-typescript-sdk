...
export enum DataMaskingActivityApiKeys {}
/**
 * This service client uses {@link common.CircuitBreaker.DefaultConfiguration} for all the operations by default if no circuit breaker configuration is defined by the user.
 */
export class DataMaskingActivityClient {
  ...
  public targetService = "DataMaskingActivity";
  ...
  public set region(region: common.Region) {
    this.endpoint = common.EndpointBuilder.createEndpointFromRegion(
      DataMaskingActivityClient.serviceEndpointTemplate,
      region,
   ...
   */
  public createWaiters(config?: common.WaiterConfiguration): DataMaskingActivityWaiter {
    this._waiters = new DataMaskingActivityWaiter(this, config);
   ...
   * @return The service waiters.
   */
  public getWaiters(): DataMaskingActivityWaiter {
    if (this._waiters) {
      return this._waiters;
    }
...
export enum FusionEnvironmentApiKeys {}
/**
 * This service client uses {@link common.CircuitBreaker.DefaultConfiguration} for all the operations by default if no circuit breaker configuration is defined by the user.
 */
export class FusionEnvironmentClient {
  protected static serviceEndpointTemplate = "https://fusionapps.{region}.oci.{secondLevelDomain}";
  protected static endpointServiceName = "";
  protected "_endpoint": string = "";
  protected "_defaultHeaders": any = {};
  ...
  protected _circuitBreaker = null;
  protected _httpOptions: any = undefined;
  public targetService = "FusionEnvironment";
  ...
  public set endpoint(endpoint: string) {
    this._endpoint = endpoint;
    this._endpoint = this._endpoint + "/20211201";
    if (this.logger) this.logger.info(`FusionEnvironmentClient endpoint set to ${this._endpoint}`);
  }
  ...
  public set region(region: common.Region) {
    this.endpoint = common.EndpointBuilder.createEndpointFromRegion(
      FusionEnvironmentClient.serviceEndpointTemplate,
      region,
   ...
   * @return The service waiters.
   */
  public createWaiters(config?: common.WaiterConfiguration): FusionEnvironmentWaiter {
    this._waiters = new FusionEnvironmentWaiter(this, config);
    return this._waiters;
  }
   ...
   * @return The service waiters.
   */
  public getWaiters(): FusionEnvironmentWaiter {
    if (this._waiters) {
      return this._waiters;
    }
    throw Error("Waiters do not exist. Please create waiters.");
  ...
  public async changeFusionEnvironmentCompartment(
    ...
    if (this.logger)
      this.logger.debug(
        "Calling operation FusionEnvironmentClient#changeFusionEnvironmentCompartment."
      );
  ...
  public async createFusionEnvironmentAdminUser(
    ...
    if (this.logger)
      this.logger.debug(
        "Calling operation FusionEnvironmentClient#createFusionEnvironmentAdminUser."
      );
  ...
  public async deleteFusionEnvironmentAdminUser(
    ...
    if (this.logger)
      this.logger.debug(
        "Calling operation FusionEnvironmentClient#deleteFusionEnvironmentAdminUser."
      );
  ...
  public async getWorkRequest(
    ...
    if (this.logger) this.logger.debug("Calling operation FusionEnvironmentClient#getWorkRequest.");
  ...
  public async listAdminUsers(
    ...
    if (this.logger) this.logger.debug("Calling operation FusionEnvironmentClient#listAdminUsers.");
  ...
  public async resetFusionEnvironmentPassword(
    ...
    if (this.logger)
      this.logger.debug(
        "Calling operation FusionEnvironmentClient#resetFusionEnvironmentPassword."
      );
...
export enum FusionEnvironmentFamilyApiKeys {}
/**
 * This service client uses {@link common.CircuitBreaker.DefaultConfiguration} for all the operations by default if no circuit breaker configuration is defined by the user.
 */
export class FusionEnvironmentFamilyClient {
  protected static serviceEndpointTemplate = "https://fusionapps.{region}.oci.{secondLevelDomain}";
  protected static endpointServiceName = "";
  protected "_endpoint": string = "";
  protected "_defaultHeaders": any = {};
  ...
  protected _circuitBreaker = null;
  protected _httpOptions: any = undefined;
  public targetService = "FusionEnvironmentFamily";
  ...
  public set region(region: common.Region) {
    this.endpoint = common.EndpointBuilder.createEndpointFromRegion(
      FusionEnvironmentFamilyClient.serviceEndpointTemplate,
      region,
   ...
   * @return The service waiters.
   */
  public createWaiters(config?: common.WaiterConfiguration): FusionEnvironmentFamilyWaiter {
    this._waiters = new FusionEnvironmentFamilyWaiter(this, config);
    return this._waiters;
  }
   ...
   * @return The service waiters.
   */
  public getWaiters(): FusionEnvironmentFamilyWaiter {
    if (this._waiters) {
      return this._waiters;
    }
    throw Error("Waiters do not exist. Please create waiters.");
  ...
  public async changeFusionEnvironmentFamilyCompartment(
    ...
    if (this.logger)
      this.logger.debug(
        "Calling operation FusionEnvironmentFamilyClient#changeFusionEnvironmentFamilyCompartment."
      );
  ...
  public async createFusionEnvironmentFamily(
    ...
    if (this.logger)
      this.logger.debug(
        "Calling operation FusionEnvironmentFamilyClient#createFusionEnvironmentFamily."
      );
  ...
  public async deleteFusionEnvironmentFamily(
    ...
    if (this.logger)
      this.logger.debug(
        "Calling operation FusionEnvironmentFamilyClient#deleteFusionEnvironmentFamily."
      );
  ...
  public async getFusionEnvironmentFamily(
    ...
    if (this.logger)
      this.logger.debug(
        "Calling operation FusionEnvironmentFamilyClient#getFusionEnvironmentFamily."
      );
  ...
  public async getFusionEnvironmentFamilyLimitsAndUsage(
    ...
    if (this.logger)
      this.logger.debug(
        "Calling operation FusionEnvironmentFamilyClient#getFusionEnvironmentFamilyLimitsAndUsage."
      );
  ...
  public async getFusionEnvironmentFamilySubscriptionDetail(
    ...
    if (this.logger)
      this.logger.debug(
        "Calling operation FusionEnvironmentFamilyClient#getFusionEnvironmentFamilySubscriptionDetail."
      );
  ...
  public async listFusionEnvironmentFamilies(
    ...
    if (this.logger)
      this.logger.debug(
        "Calling operation FusionEnvironmentFamilyClient#listFusionEnvironmentFamilies."
      );
  ...
  public async updateFusionEnvironmentFamily(
    ...
    if (this.logger)
      this.logger.debug(
        "Calling operation FusionEnvironmentFamilyClient#updateFusionEnvironmentFamily."
      );
...
export enum RefreshActivityApiKeys {}
/**
 * This service client uses {@link common.CircuitBreaker.DefaultConfiguration} for all the operations by default if no circuit breaker configuration is defined by the user.
 */
export class RefreshActivityClient {
  protected static serviceEndpointTemplate = "https://fusionapps.{region}.oci.{secondLevelDomain}";
  protected static endpointServiceName = "";
  protected "_endpoint": string = "";
  protected "_defaultHeaders": any = {};
  ...
  protected _circuitBreaker = null;
  protected _httpOptions: any = undefined;
  public targetService = "RefreshActivity";
  ...
  public set endpoint(endpoint: string) {
    this._endpoint = endpoint;
    this._endpoint = this._endpoint + "/20211201";
    if (this.logger) this.logger.info(`RefreshActivityClient endpoint set to ${this._endpoint}`);
  }
  ...
  public set region(region: common.Region) {
    this.endpoint = common.EndpointBuilder.createEndpointFromRegion(
      RefreshActivityClient.serviceEndpointTemplate,
      region,
   ...
   * @return The service waiters.
   */
  public createWaiters(config?: common.WaiterConfiguration): RefreshActivityWaiter {
    this._waiters = new RefreshActivityWaiter(this, config);
    return this._waiters;
  }
   ...
   * @return The service waiters.
   */
  public getWaiters(): RefreshActivityWaiter {
    if (this._waiters) {
      return this._waiters;
    }
    throw Error("Waiters do not exist. Please create waiters.");
...
export enum ScheduledActivityApiKeys {}
/**
 * This service client uses {@link common.CircuitBreaker.DefaultConfiguration} for all the operations by default if no circuit breaker configuration is defined by the user.
 */
export class ScheduledActivityClient {
  protected static serviceEndpointTemplate = "https://fusionapps.{region}.oci.{secondLevelDomain}";
  protected static endpointServiceName = "";
  protected "_endpoint": string = "";
  protected "_defaultHeaders": any = {};
  ...
  protected _circuitBreaker = null;
  protected _httpOptions: any = undefined;
  public targetService = "ScheduledActivity";
  ...
  public set endpoint(endpoint: string) {
    this._endpoint = endpoint;
    this._endpoint = this._endpoint + "/20211201";
    if (this.logger) this.logger.info(`ScheduledActivityClient endpoint set to ${this._endpoint}`);
  }
  ...
  public set region(region: common.Region) {
    this.endpoint = common.EndpointBuilder.createEndpointFromRegion(
      ScheduledActivityClient.serviceEndpointTemplate,
      region,
   ...
   * @return The service waiters.
   */
  public createWaiters(config?: common.WaiterConfiguration): ScheduledActivityWaiter {
    this._waiters = new ScheduledActivityWaiter(this, config);
    return this._waiters;
  }
   ...
   * @return The service waiters.
   */
  public getWaiters(): ScheduledActivityWaiter {
    if (this._waiters) {
      return this._waiters;
    }
    throw Error("Waiters do not exist. Please create waiters.");
...
export enum ServiceAttachmentApiKeys {}
/**
 * This service client uses {@link common.CircuitBreaker.DefaultConfiguration} for all the operations by default if no circuit breaker configuration is defined by the user.
 */
export class ServiceAttachmentClient {
  protected static serviceEndpointTemplate = "https://fusionapps.{region}.oci.{secondLevelDomain}";
  protected static endpointServiceName = "";
  protected "_endpoint": string = "";
  protected "_defaultHeaders": any = {};
  ...
  protected _circuitBreaker = null;
  protected _httpOptions: any = undefined;
  public targetService = "ServiceAttachment";
  ...
  public set endpoint(endpoint: string) {
    this._endpoint = endpoint;
    this._endpoint = this._endpoint + "/20211201";
    if (this.logger) this.logger.info(`ServiceAttachmentClient endpoint set to ${this._endpoint}`);
  }
  ...
  public set region(region: common.Region) {
    this.endpoint = common.EndpointBuilder.createEndpointFromRegion(
      ServiceAttachmentClient.serviceEndpointTemplate,
      region,
   ...
   * @return The service waiters.
   */
  public createWaiters(config?: common.WaiterConfiguration): ServiceAttachmentWaiter {
    this._waiters = new ServiceAttachmentWaiter(this, config);
    return this._waiters;
  }
   ...
   * @return The service waiters.
   */
  public getWaiters(): ServiceAttachmentWaiter {
    if (this._waiters) {
      return this._waiters;
    }
    throw Error("Waiters do not exist. Please create waiters.");
