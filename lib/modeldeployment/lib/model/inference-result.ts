...
export namespace InferenceResult {
  export function getJsonObj(obj: InferenceResult): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: InferenceResult): object {
    const jsonObj = { ...obj, ...{} };
