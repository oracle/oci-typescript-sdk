...
/**
 * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/optimizer/ListEnrollmentStatuses.ts.html |here} to see how to use ListEnrollmentStatusesRequest.
 */
...
export namespace ListEnrollmentStatusesRequest {
  export enum SortBy {
    Name = "NAME",
