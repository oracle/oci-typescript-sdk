...
/**
 * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/optimizer/ListResourceActions.ts.html |here} to see how to use ListResourceActionsRequest.
 */
...
export namespace ListResourceActionsRequest {
  export enum SortBy {
    Name = "NAME",
