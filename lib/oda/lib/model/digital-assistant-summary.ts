...
export namespace DigitalAssistantSummary {
  export function getJsonObj(obj: DigitalAssistantSummary): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: DigitalAssistantSummary): object {
    const jsonObj = { ...obj, ...{} };
