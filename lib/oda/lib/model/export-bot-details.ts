...
export namespace ExportBotDetails {
  export function getJsonObj(obj: ExportBotDetails): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: ExportBotDetails): object {
    const jsonObj = {
      ...obj,
      ...{
