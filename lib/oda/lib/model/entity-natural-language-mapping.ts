...
export namespace EntityNaturalLanguageMapping {
  export function getJsonObj(obj: EntityNaturalLanguageMapping): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: EntityNaturalLanguageMapping): object {
    const jsonObj = {
      ...obj,
      ...{
        "languages": obj.languages
