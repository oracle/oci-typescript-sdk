...
export namespace CreateOdaPrivateEndpointDetails {
  export function getJsonObj(obj: CreateOdaPrivateEndpointDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: CreateOdaPrivateEndpointDetails): object {
    const jsonObj = { ...obj, ...{} };
