...
export namespace ExtendSkillDetails {
  export function getJsonObj(obj: ExtendSkillDetails, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj ? obj : (model.CreateSkillDetails.getJsonObj(obj) as ExtendSkillDetails)),
      ...{}
    };
  ...
  export function getDeserializedJsonObj(
    obj: ExtendSkillDetails,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.CreateSkillDetails.getDeserializedJsonObj(obj) as ExtendSkillDetails)),
      ...{}
    };
