...
export namespace CreateWebhookChannelResult {
  export function getJsonObj(obj: CreateWebhookChannelResult, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.CreateChannelResult.getJsonObj(obj) as CreateWebhookChannelResult)),
      ...{}
    };
  ...
  export function getDeserializedJsonObj(
    obj: CreateWebhookChannelResult,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.CreateChannelResult.getDeserializedJsonObj(obj) as CreateWebhookChannelResult)),
      ...{}
    };
