...
export namespace CreateTestChannelResult {
  export function getJsonObj(obj: CreateTestChannelResult, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.CreateChannelResult.getJsonObj(obj) as CreateTestChannelResult)),
      ...{}
    };
  ...
  export function getDeserializedJsonObj(
    obj: CreateTestChannelResult,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.CreateChannelResult.getDeserializedJsonObj(obj) as CreateTestChannelResult)),
      ...{}
    };
