...
export namespace ExportSkillDetails {
  export function getJsonObj(obj: ExportSkillDetails): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: ExportSkillDetails): object {
    const jsonObj = {
      ...obj,
      ...{
