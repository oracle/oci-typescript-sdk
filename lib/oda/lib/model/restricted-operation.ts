...
export namespace RestrictedOperation {
  export function getJsonObj(obj: RestrictedOperation): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: RestrictedOperation): object {
    const jsonObj = { ...obj, ...{} };
