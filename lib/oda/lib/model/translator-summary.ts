...
export namespace TranslatorSummary {
  export function getJsonObj(obj: TranslatorSummary): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: TranslatorSummary): object {
    const jsonObj = { ...obj, ...{} };
