...
export namespace SkillParameterSummary {
  export function getJsonObj(obj: SkillParameterSummary): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: SkillParameterSummary): object {
    const jsonObj = { ...obj, ...{} };
