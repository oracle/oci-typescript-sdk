...
export namespace OSSChannel {
  export function getJsonObj(obj: OSSChannel, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj ? obj : (model.Channel.getJsonObj(obj) as OSSChannel)),
      ...{}
    };
  ...
  export function getDeserializedJsonObj(obj: OSSChannel, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj ? obj : (model.Channel.getDeserializedJsonObj(obj) as OSSChannel)),
      ...{}
    };
