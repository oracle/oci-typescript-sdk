...
export namespace CreateOSSChannelDetails {
  export function getJsonObj(obj: CreateOSSChannelDetails, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.CreateChannelDetails.getJsonObj(obj) as CreateOSSChannelDetails)),
      ...{}
    };
  ...
  export function getDeserializedJsonObj(
    obj: CreateOSSChannelDetails,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.CreateChannelDetails.getDeserializedJsonObj(obj) as CreateOSSChannelDetails)),
      ...{}
    };
