...
export namespace CreateIosChannelResult {
  export function getJsonObj(obj: CreateIosChannelResult, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.CreateChannelResult.getJsonObj(obj) as CreateIosChannelResult)),
      ...{}
    };
  ...
  export function getDeserializedJsonObj(
    obj: CreateIosChannelResult,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.CreateChannelResult.getDeserializedJsonObj(obj) as CreateIosChannelResult)),
      ...{}
    };
