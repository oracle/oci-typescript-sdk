...
export namespace OdaPrivateEndpointScanProxy {
  export enum ScanListenerType {
    Fqdn = "FQDN",
    Ip = "IP",
    /**
  ...
  export function getJsonObj(obj: OdaPrivateEndpointScanProxy): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: OdaPrivateEndpointScanProxy): object {
    const jsonObj = {
      ...obj,
      ...{
        "scanListenerInfos": obj.scanListenerInfos
