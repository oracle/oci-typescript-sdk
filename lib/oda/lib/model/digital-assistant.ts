...
export namespace DigitalAssistant {
  export function getJsonObj(obj: DigitalAssistant): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: DigitalAssistant): object {
    const jsonObj = { ...obj, ...{} };
