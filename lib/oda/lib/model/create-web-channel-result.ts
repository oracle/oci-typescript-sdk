...
export namespace CreateWebChannelResult {
  export function getJsonObj(obj: CreateWebChannelResult, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.CreateChannelResult.getJsonObj(obj) as CreateWebChannelResult)),
      ...{}
    };
  ...
  export function getDeserializedJsonObj(
    obj: CreateWebChannelResult,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.CreateChannelResult.getDeserializedJsonObj(obj) as CreateWebChannelResult)),
      ...{}
    };
