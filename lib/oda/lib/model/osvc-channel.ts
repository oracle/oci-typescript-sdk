...
export namespace OsvcChannel {
  export function getJsonObj(obj: OsvcChannel, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj ? obj : (model.Channel.getJsonObj(obj) as OsvcChannel)),
      ...{}
    };
  ...
  export function getDeserializedJsonObj(obj: OsvcChannel, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj ? obj : (model.Channel.getDeserializedJsonObj(obj) as OsvcChannel)),
      ...{}
    };
