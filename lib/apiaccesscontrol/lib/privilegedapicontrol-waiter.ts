...
export class PrivilegedApiControlWaiter {
  public constructor(
    private client: PrivilegedApiControlClient,
   ...
   */
  public async forPrivilegedApiControl(
    request: serviceRequests.GetPrivilegedApiControlRequest,
    ...targetStates: models.PrivilegedApiControl.LifecycleState[]
  ): Promise<serviceResponses.GetPrivilegedApiControlResponse | null> {
    return genericTerminalConditionWaiter(
      this.config,
      () => this.client.getPrivilegedApiControl(request),
      response => targetStates.includes(response.privilegedApiControl.lifecycleState!),
      targetStates.includes(models.PrivilegedApiControl.LifecycleState.Deleted)
    );
  }
}
