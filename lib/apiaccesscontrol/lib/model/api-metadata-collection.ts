...
export namespace ApiMetadataCollection {
  export function getJsonObj(obj: ApiMetadataCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
  ...
  export function getDeserializedJsonObj(obj: ApiMetadataCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
