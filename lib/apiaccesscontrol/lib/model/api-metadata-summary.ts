...
export namespace ApiMetadataSummary {
  export function getJsonObj(obj: ApiMetadataSummary): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: ApiMetadataSummary): object {
    const jsonObj = { ...obj, ...{} };
