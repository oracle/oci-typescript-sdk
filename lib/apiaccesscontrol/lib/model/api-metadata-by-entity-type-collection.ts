...
export namespace ApiMetadataByEntityTypeCollection {
  export function getJsonObj(obj: ApiMetadataByEntityTypeCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
  ...
  export function getDeserializedJsonObj(obj: ApiMetadataByEntityTypeCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
