...
export namespace PrivilegedApiControlCollection {
  export function getJsonObj(obj: PrivilegedApiControlCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
  ...
  export function getDeserializedJsonObj(obj: PrivilegedApiControlCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
