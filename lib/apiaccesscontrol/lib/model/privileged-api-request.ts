...
export namespace PrivilegedApiRequest {
  export enum State {
    Created = "CREATED",
  ...
  export function getJsonObj(obj: PrivilegedApiRequest): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: PrivilegedApiRequest): object {
    const jsonObj = {
      ...obj,
      ...{
        "privilegedOperationList": obj.privilegedOperationList
