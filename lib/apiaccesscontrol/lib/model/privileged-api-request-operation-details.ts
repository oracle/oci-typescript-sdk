...
export namespace PrivilegedApiRequestOperationDetails {
  export function getJsonObj(obj: PrivilegedApiRequestOperationDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: PrivilegedApiRequestOperationDetails): object {
    const jsonObj = { ...obj, ...{} };
