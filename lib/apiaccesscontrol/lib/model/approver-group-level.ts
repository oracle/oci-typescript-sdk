 ...
 */
export interface ApproverGroupLevel {
  /**
   * id of the group.
   */
  "groupId": Array<string>;
  /**
   * level of the group. Note: Numbers greater than Number.MAX_SAFE_INTEGER will result in rounding issues.
   */
  "groupLevel": number;
}

export namespace ApproverGroupLevel {
  export function getJsonObj(obj: ApproverGroupLevel): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: ApproverGroupLevel): object {
    const jsonObj = { ...obj, ...{} };
