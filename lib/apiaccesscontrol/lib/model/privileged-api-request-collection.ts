...
export namespace PrivilegedApiRequestCollection {
  export function getJsonObj(obj: PrivilegedApiRequestCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
  ...
  export function getDeserializedJsonObj(obj: PrivilegedApiRequestCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
