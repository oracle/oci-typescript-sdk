...
export namespace RejectPrivilegedApiRequestDetails {
  export function getJsonObj(obj: RejectPrivilegedApiRequestDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: RejectPrivilegedApiRequestDetails): object {
    const jsonObj = { ...obj, ...{} };
