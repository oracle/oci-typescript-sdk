...
export namespace ChangePrivilegedApiControlCompartmentDetails {
  export function getJsonObj(obj: ChangePrivilegedApiControlCompartmentDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(
    obj: ChangePrivilegedApiControlCompartmentDetails
  ): object {
    const jsonObj = { ...obj, ...{} };
