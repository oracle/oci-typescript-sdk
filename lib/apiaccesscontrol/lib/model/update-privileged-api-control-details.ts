...
export namespace UpdatePrivilegedApiControlDetails {
  export function getJsonObj(obj: UpdatePrivilegedApiControlDetails): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: UpdatePrivilegedApiControlDetails): object {
    const jsonObj = {
      ...obj,
      ...{
        "privilegedOperationList": obj.privilegedOperationList
