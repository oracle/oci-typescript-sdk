...
export namespace RevokePrivilegedApiRequestDetails {
  export function getJsonObj(obj: RevokePrivilegedApiRequestDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: RevokePrivilegedApiRequestDetails): object {
    const jsonObj = { ...obj, ...{} };
