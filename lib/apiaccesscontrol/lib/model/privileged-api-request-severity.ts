 ...
 **/
export enum PrivilegedApiRequestSeverity {
  Sev1 = "SEV_1",
  Sev2 = "SEV_2",
  Sev3 = "SEV_3",
  Sev4 = "SEV_4",
...
export namespace PrivilegedApiRequestSeverity {
  export function getJsonObj(obj: PrivilegedApiRequestSeverity): PrivilegedApiRequestSeverity {
    return obj;
  }
  export function getDeserializedJsonObj(
    obj: PrivilegedApiRequestSeverity
