...
export namespace PrivilegedApiControlSummary {
  export function getJsonObj(obj: PrivilegedApiControlSummary): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: PrivilegedApiControlSummary): object {
    const jsonObj = { ...obj, ...{} };
