...
export namespace ClosePrivilegedApiRequestDetails {
  export function getJsonObj(obj: ClosePrivilegedApiRequestDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: ClosePrivilegedApiRequestDetails): object {
    const jsonObj = { ...obj, ...{} };
