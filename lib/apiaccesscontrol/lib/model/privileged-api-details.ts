...
export namespace PrivilegedApiDetails {
  export function getJsonObj(obj: PrivilegedApiDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: PrivilegedApiDetails): object {
    const jsonObj = { ...obj, ...{} };
