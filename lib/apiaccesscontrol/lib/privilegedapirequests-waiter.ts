...
export class PrivilegedApiRequestsWaiter {
  public constructor(
    private client: PrivilegedApiRequestsClient,
   ...
   */
  public async forPrivilegedApiRequest(
    request: serviceRequests.GetPrivilegedApiRequestRequest,
    ...targetStates: models.PrivilegedApiRequest.LifecycleState[]
  ): Promise<serviceResponses.GetPrivilegedApiRequestResponse> {
    return genericWaiter(
      this.config,
      () => this.client.getPrivilegedApiRequest(request),
      response => targetStates.includes(response.privilegedApiRequest.lifecycleState!)
    );
  }
}
