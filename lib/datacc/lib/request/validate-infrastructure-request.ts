...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/datacc/ValidateInfrastructure.ts.html |here} to see how to use ValidateInfrastructureRequest.
 */
export interface ValidateInfrastructureRequest extends common.BaseRequest {
  /**
   * The validation details for the Database Infrastructure.
   */
  "validateInfrastructureDetails": model.ValidateInfrastructureDetails;
  /**
