...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/datacc/MigrateVmInstance.ts.html |here} to see how to use MigrateVmInstanceRequest.
 */
export interface MigrateVmInstanceRequest extends common.BaseRequest {
  /**
