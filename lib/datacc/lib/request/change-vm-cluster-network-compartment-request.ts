...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/datacc/ChangeVmClusterNetworkCompartment.ts.html |here} to see how to use ChangeVmClusterNetworkCompartmentRequest.
 */
export interface ChangeVmClusterNetworkCompartmentRequest extends common.BaseRequest {
  /**
   ...
   */
  "changeVmClusterNetworkCompartmentDetails": model.ChangeVmClusterNetworkCompartmentDetails;
  /**
