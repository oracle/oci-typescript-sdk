...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/datacc/ScaleVmInstance.ts.html |here} to see how to use ScaleVmInstanceRequest.
 */
export interface ScaleVmInstanceRequest extends common.BaseRequest {
  /**
   * Scale the VM instance.
   */
  "scaleVmInstanceDetails": model.ScaleVmInstanceDetails;
  /**
