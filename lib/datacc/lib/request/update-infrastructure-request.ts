...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/datacc/UpdateInfrastructure.ts.html |here} to see how to use UpdateInfrastructureRequest.
 */
export interface UpdateInfrastructureRequest extends common.BaseRequest {
  /**
   * The updated Database Infrastructure details.
   */
  "updateInfrastructureDetails": model.UpdateInfrastructureDetails;
  /**
