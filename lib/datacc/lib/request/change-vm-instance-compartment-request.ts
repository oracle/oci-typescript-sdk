...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/datacc/ChangeVmInstanceCompartment.ts.html |here} to see how to use ChangeVmInstanceCompartmentRequest.
 */
export interface ChangeVmInstanceCompartmentRequest extends common.BaseRequest {
  /**
   ...
   */
  "changeVmInstanceCompartmentDetails": model.ChangeVmInstanceCompartmentDetails;
  /**
