...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/datacc/CreateVmInstance.ts.html |here} to see how to use CreateVmInstanceRequest.
 */
export interface CreateVmInstanceRequest extends common.BaseRequest {
  /**
   * New VM instance details.
   */
  "createVmInstanceDetails": model.CreateVmInstanceDetails;
  /**
