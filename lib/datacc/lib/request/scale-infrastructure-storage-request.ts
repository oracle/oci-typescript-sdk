...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/datacc/ScaleInfrastructureStorage.ts.html |here} to see how to use ScaleInfrastructureStorageRequest.
 */
export interface ScaleInfrastructureStorageRequest extends common.BaseRequest {
  /**
   * The scale storage details for the Database Infrastructure.
   */
  "scaleInfrastructureStorageDetails": model.ScaleInfrastructureStorageDetails;
  /**
