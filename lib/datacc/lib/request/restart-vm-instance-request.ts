...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/datacc/RestartVmInstance.ts.html |here} to see how to use RestartVmInstanceRequest.
 */
export interface RestartVmInstanceRequest extends common.BaseRequest {
  /**
