...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/datacc/ChangeInfrastructureCompartment.ts.html |here} to see how to use ChangeInfrastructureCompartmentRequest.
 */
export interface ChangeInfrastructureCompartmentRequest extends common.BaseRequest {
  /**
   ...
   */
  "changeInfrastructureCompartmentDetails": model.ChangeInfrastructureCompartmentDetails;
  /**
