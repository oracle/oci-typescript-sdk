...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/datacc/ActivateInfrastructure.ts.html |here} to see how to use ActivateInfrastructureRequest.
 */
export interface ActivateInfrastructureRequest extends common.BaseRequest {
  /**
   * The activation details for the Database Infrastructure.
   */
  "activateInfrastructureDetails": model.ActivateInfrastructureDetails;
  /**
