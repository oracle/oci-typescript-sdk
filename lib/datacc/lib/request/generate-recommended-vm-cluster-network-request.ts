...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/datacc/GenerateRecommendedVmClusterNetwork.ts.html |here} to see how to use GenerateRecommendedVmClusterNetworkRequest.
 */
export interface GenerateRecommendedVmClusterNetworkRequest extends common.BaseRequest {
   ...
   */
  "generateRecommendedVmClusterNetworkDetails": model.GenerateRecommendedVmClusterNetworkDetails;
  /**
