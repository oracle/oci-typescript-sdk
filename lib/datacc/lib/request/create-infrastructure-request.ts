...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/datacc/CreateInfrastructure.ts.html |here} to see how to use CreateInfrastructureRequest.
 */
export interface CreateInfrastructureRequest extends common.BaseRequest {
  /**
   * New Database Infrastructure details.
   */
  "createInfrastructureDetails": model.CreateInfrastructureDetails;
  /**
