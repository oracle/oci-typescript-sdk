...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/datacc/RescheduleMaintenanceRun.ts.html |here} to see how to use RescheduleMaintenanceRunRequest.
 */
export interface RescheduleMaintenanceRunRequest extends common.BaseRequest {
  /**
   ...
   */
  "rescheduleMaintenanceRunDetails": model.RescheduleMaintenanceRunDetails;
  /**
