...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/datacc/ListVmClusterNetworks.ts.html |here} to see how to use ListVmClusterNetworksRequest.
 */
export interface ListVmClusterNetworksRequest extends common.BaseRequest {
   ...
   */
  "lifecycleState"?: Array<model.VmClusterNetworkLifecycleState>;
  /**
   ...
   */
  "vmNetworkConsumerType"?: model.VmNetworkConsumerType;
}
