...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/datacc/StopVmInstance.ts.html |here} to see how to use StopVmInstanceRequest.
 */
export interface StopVmInstanceRequest extends common.BaseRequest {
  /**
