...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/datacc/UpdateVmInstance.ts.html |here} to see how to use UpdateVmInstanceRequest.
 */
export interface UpdateVmInstanceRequest extends common.BaseRequest {
  /**
   * The updated VM instance details.
   */
  "updateVmInstanceDetails": model.UpdateVmInstanceDetails;
  /**
