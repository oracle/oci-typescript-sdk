...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/datacc/DeleteInfrastructure.ts.html |here} to see how to use DeleteInfrastructureRequest.
 */
export interface DeleteInfrastructureRequest extends common.BaseRequest {
  /**
   ...
   *
   */
  "isForceDeleteInfrastructure"?: boolean;
}
