...
export namespace BasePatchingMode {
  export function getJsonObj(obj: BasePatchingMode): BasePatchingMode {
    return obj;
  }
  export function getDeserializedJsonObj(obj: BasePatchingMode): BasePatchingMode {
    return obj;
  }
}
