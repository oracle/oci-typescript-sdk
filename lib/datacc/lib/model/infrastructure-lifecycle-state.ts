 ...
 **/
export enum InfrastructureLifecycleState {
  Creating = "CREATING",
...
export namespace InfrastructureLifecycleState {
  export function getJsonObj(obj: InfrastructureLifecycleState): InfrastructureLifecycleState {
    return obj;
  }
  export function getDeserializedJsonObj(
    obj: InfrastructureLifecycleState
