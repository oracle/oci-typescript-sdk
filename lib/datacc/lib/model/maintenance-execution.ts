...
export namespace MaintenanceExecution {
  export function getJsonObj(obj: MaintenanceExecution): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: MaintenanceExecution): object {
    const jsonObj = { ...obj, ...{} };
