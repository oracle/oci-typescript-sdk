 ...
 *
 */
export interface CreateVmClusterNetworkDetails {
  /**
...
export namespace CreateVmClusterNetworkDetails {
  export function getJsonObj(obj: CreateVmClusterNetworkDetails): object {
    const jsonObj = {
      ...obj,
      ...{
        "scans": obj.scans
  ...
  export function getDeserializedJsonObj(obj: CreateVmClusterNetworkDetails): object {
    const jsonObj = {
      ...obj,
      ...{
        "scans": obj.scans
