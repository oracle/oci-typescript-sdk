...
export interface InfrastructureCollection {
   ...
   */
  "items": Array<model.InfrastructureSummary>;
}

export namespace InfrastructureCollection {
  export function getJsonObj(obj: InfrastructureCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
          ? obj.items.map(item => {
              return model.InfrastructureSummary.getJsonObj(item);
            })
          : undefined
      }
    };
  ...
  export function getDeserializedJsonObj(obj: InfrastructureCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
          ? obj.items.map(item => {
              return model.InfrastructureSummary.getDeserializedJsonObj(item);
            })
          : undefined
      }
    };
