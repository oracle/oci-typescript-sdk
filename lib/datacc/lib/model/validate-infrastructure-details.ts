 ...
 *
 */
export interface ValidateInfrastructureDetails {
  /**
   * The validation zip file.
   */
  "validationZipFile": string;
}

export namespace ValidateInfrastructureDetails {
  export function getJsonObj(obj: ValidateInfrastructureDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: ValidateInfrastructureDetails): object {
    const jsonObj = { ...obj, ...{} };
