 ...
 */
export interface ChangeInfrastructureCompartmentDetails {
  /**
...
export namespace ChangeInfrastructureCompartmentDetails {
  export function getJsonObj(obj: ChangeInfrastructureCompartmentDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: ChangeInfrastructureCompartmentDetails): object {
    const jsonObj = { ...obj, ...{} };
