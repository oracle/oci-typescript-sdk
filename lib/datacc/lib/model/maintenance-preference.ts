 ...
 **/
export enum MaintenancePreference {
...
export namespace MaintenancePreference {
  export function getJsonObj(obj: MaintenancePreference): MaintenancePreference {
    return obj;
  }
  export function getDeserializedJsonObj(obj: MaintenancePreference): MaintenancePreference {
    return obj;
  }
}
