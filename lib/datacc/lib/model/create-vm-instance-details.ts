 ...
 */
export interface CreateVmInstanceDetails {
  /**
...
export namespace CreateVmInstanceDetails {
  export function getJsonObj(obj: CreateVmInstanceDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: CreateVmInstanceDetails): object {
    const jsonObj = { ...obj, ...{} };
