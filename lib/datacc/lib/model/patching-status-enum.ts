 ...
 **/
export enum PatchingStatusEnum {
  Creating = "CREATING",
  Patching = "PATCHING",
  Waiting = "WAITING",
  Scheduled = "SCHEDULED",
...
export namespace PatchingStatusEnum {
  export function getJsonObj(obj: PatchingStatusEnum): PatchingStatusEnum {
    return obj;
  }
  export function getDeserializedJsonObj(obj: PatchingStatusEnum): PatchingStatusEnum {
    return obj;
  }
}
