 ...
 **/
export enum VmNetworkConsumerType {
  Instance = "INSTANCE",
  Cluster = "CLUSTER",
...
export namespace VmNetworkConsumerType {
  export function getJsonObj(obj: VmNetworkConsumerType): VmNetworkConsumerType {
    return obj;
  }
  export function getDeserializedJsonObj(obj: VmNetworkConsumerType): VmNetworkConsumerType {
    return obj;
  }
}
