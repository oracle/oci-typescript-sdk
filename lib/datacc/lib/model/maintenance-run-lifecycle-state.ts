 ...
 **/
export enum MaintenanceRunLifecycleState {
  Creating = "CREATING",
  Scheduled = "SCHEDULED",
...
export namespace MaintenanceRunLifecycleState {
  export function getJsonObj(obj: MaintenanceRunLifecycleState): MaintenanceRunLifecycleState {
    return obj;
  }
  export function getDeserializedJsonObj(
    obj: MaintenanceRunLifecycleState
