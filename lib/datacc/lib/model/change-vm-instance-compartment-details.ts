 ...
 */
export interface ChangeVmInstanceCompartmentDetails {
  /**
...
export namespace ChangeVmInstanceCompartmentDetails {
  export function getJsonObj(obj: ChangeVmInstanceCompartmentDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: ChangeVmInstanceCompartmentDetails): object {
    const jsonObj = { ...obj, ...{} };
