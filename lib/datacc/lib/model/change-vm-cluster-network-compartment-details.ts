 ...
 */
export interface ChangeVmClusterNetworkCompartmentDetails {
  /**
...
export namespace ChangeVmClusterNetworkCompartmentDetails {
  export function getJsonObj(obj: ChangeVmClusterNetworkCompartmentDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: ChangeVmClusterNetworkCompartmentDetails): object {
    const jsonObj = { ...obj, ...{} };
