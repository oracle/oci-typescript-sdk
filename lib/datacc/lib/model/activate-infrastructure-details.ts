 ...
 *
 */
export interface ActivateInfrastructureDetails {
  /**
   * The activation zip file.
   */
  "activationZipFile": string;
}

export namespace ActivateInfrastructureDetails {
  export function getJsonObj(obj: ActivateInfrastructureDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: ActivateInfrastructureDetails): object {
    const jsonObj = { ...obj, ...{} };
