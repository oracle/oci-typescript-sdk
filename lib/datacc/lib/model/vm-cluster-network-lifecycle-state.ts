 ...
 **/
export enum VmClusterNetworkLifecycleState {
  Creating = "CREATING",
...
export namespace VmClusterNetworkLifecycleState {
  export function getJsonObj(obj: VmClusterNetworkLifecycleState): VmClusterNetworkLifecycleState {
    return obj;
  }
  export function getDeserializedJsonObj(
    obj: VmClusterNetworkLifecycleState
