...
export namespace InfrastructureSummary {
  export function getJsonObj(obj: InfrastructureSummary): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: InfrastructureSummary): object {
    const jsonObj = {
      ...obj,
      ...{
        "contacts": obj.contacts
