 ...
 *
 */
export interface CreateInfrastructureDetails {
  /**
...
export namespace CreateInfrastructureDetails {
  export function getJsonObj(obj: CreateInfrastructureDetails): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: CreateInfrastructureDetails): object {
    const jsonObj = {
      ...obj,
      ...{
        "contacts": obj.contacts
