...
export interface GetInfrastructureScaleOptionResponse {
  /**
  ...
  "opcRequestId": string;
  /**
   * The returned model.InfrastructureScaleOption instance.
   */
  "infrastructureScaleOption": model.InfrastructureScaleOption;
}
