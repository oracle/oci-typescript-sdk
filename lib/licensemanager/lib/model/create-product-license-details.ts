...
export namespace CreateProductLicenseDetails {
  export function getJsonObj(obj: CreateProductLicenseDetails): object {
    const jsonObj = {
      ...obj,
      ...{
        "images": obj.images
  ...
  export function getDeserializedJsonObj(obj: CreateProductLicenseDetails): object {
    const jsonObj = {
      ...obj,
      ...{
        "images": obj.images
