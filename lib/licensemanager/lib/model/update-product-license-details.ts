...
export namespace UpdateProductLicenseDetails {
  export function getJsonObj(obj: UpdateProductLicenseDetails): object {
    const jsonObj = {
      ...obj,
      ...{
        "images": obj.images
  ...
  export function getDeserializedJsonObj(obj: UpdateProductLicenseDetails): object {
    const jsonObj = {
      ...obj,
      ...{
        "images": obj.images
