...
export namespace LicenseRecordSummary {
  export function getJsonObj(obj: LicenseRecordSummary): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: LicenseRecordSummary): object {
    const jsonObj = { ...obj, ...{} };
