...
export namespace TopUtilizedProductLicenseCollection {
  export function getJsonObj(obj: TopUtilizedProductLicenseCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
  ...
  export function getDeserializedJsonObj(obj: TopUtilizedProductLicenseCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
