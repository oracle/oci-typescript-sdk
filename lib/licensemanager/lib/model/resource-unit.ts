...
export namespace ResourceUnit {
  export function getJsonObj(obj: ResourceUnit): ResourceUnit {
    return obj;
  }
  export function getDeserializedJsonObj(obj: ResourceUnit): ResourceUnit {
    return obj;
  }
}
