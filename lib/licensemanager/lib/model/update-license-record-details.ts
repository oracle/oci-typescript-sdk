...
export namespace UpdateLicenseRecordDetails {
  export function getJsonObj(obj: UpdateLicenseRecordDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: UpdateLicenseRecordDetails): object {
    const jsonObj = { ...obj, ...{} };
