...
export namespace ProductLicenseCollection {
  export function getJsonObj(obj: ProductLicenseCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
  ...
  export function getDeserializedJsonObj(obj: ProductLicenseCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
