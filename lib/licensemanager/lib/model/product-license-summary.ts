...
export namespace ProductLicenseSummary {
  export function getJsonObj(obj: ProductLicenseSummary): object {
    const jsonObj = {
      ...obj,
      ...{
        "images": obj.images
  ...
  export function getDeserializedJsonObj(obj: ProductLicenseSummary): object {
    const jsonObj = {
      ...obj,
      ...{
        "images": obj.images
