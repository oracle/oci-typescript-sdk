 ...
 *
 */
export interface InstanceResourceGroupSummary {
  /**
...
export namespace InstanceResourceGroupSummary {
  export function getJsonObj(obj: InstanceResourceGroupSummary): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: InstanceResourceGroupSummary): object {
    const jsonObj = { ...obj, ...{} };
