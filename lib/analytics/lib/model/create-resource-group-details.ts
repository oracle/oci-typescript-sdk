 ...
 *
 */
export interface CreateResourceGroupDetails {
  /**
...
export namespace CreateResourceGroupDetails {
  export function getJsonObj(obj: CreateResourceGroupDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: CreateResourceGroupDetails): object {
    const jsonObj = { ...obj, ...{} };
