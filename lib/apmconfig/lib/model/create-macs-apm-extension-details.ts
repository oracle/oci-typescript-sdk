...
export namespace CreateMacsApmExtensionDetails {
  export function getJsonObj(
    obj: CreateMacsApmExtensionDetails,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.CreateConfigDetails.getJsonObj(obj) as CreateMacsApmExtensionDetails)),
      ...{}
    };
  ...
  export function getDeserializedJsonObj(
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.CreateConfigDetails.getDeserializedJsonObj(obj) as CreateMacsApmExtensionDetails)),
      ...{}
    };
