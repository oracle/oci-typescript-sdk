...
export namespace UpdateMacsApmExtensionDetails {
  export function getJsonObj(
    obj: UpdateMacsApmExtensionDetails,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.UpdateConfigDetails.getJsonObj(obj) as UpdateMacsApmExtensionDetails)),
      ...{}
    };
  ...
  export function getDeserializedJsonObj(
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.UpdateConfigDetails.getDeserializedJsonObj(obj) as UpdateMacsApmExtensionDetails)),
      ...{}
    };
