...
export namespace AgentConfig {
  export function getJsonObj(obj: AgentConfig, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj ? obj : (model.Config.getJsonObj(obj) as AgentConfig)),
      ...{
  ...
  export function getDeserializedJsonObj(obj: AgentConfig, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj ? obj : (model.Config.getDeserializedJsonObj(obj) as AgentConfig)),
      ...{
