...
export namespace MacsApmExtensionSummary {
  export function getJsonObj(obj: MacsApmExtensionSummary, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj ? obj : (model.ConfigSummary.getJsonObj(obj) as MacsApmExtensionSummary)),
      ...{}
    };
  ...
  export function getDeserializedJsonObj(
    obj: MacsApmExtensionSummary,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.ConfigSummary.getDeserializedJsonObj(obj) as MacsApmExtensionSummary)),
      ...{}
    };
