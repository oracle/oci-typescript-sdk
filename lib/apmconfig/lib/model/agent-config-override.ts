...
export namespace AgentConfigOverride {
  export function getJsonObj(obj: AgentConfigOverride): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: AgentConfigOverride): object {
    const jsonObj = { ...obj, ...{} };
