...
export namespace AgentConfigFile {
  export function getJsonObj(obj: AgentConfigFile): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: AgentConfigFile): object {
    const jsonObj = { ...obj, ...{} };
