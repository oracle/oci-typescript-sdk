...
export namespace ExportConfigurationDetails {
  export function getJsonObj(obj: ExportConfigurationDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: ExportConfigurationDetails): object {
    const jsonObj = { ...obj, ...{} };
