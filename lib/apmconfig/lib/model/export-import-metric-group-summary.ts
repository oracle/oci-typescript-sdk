...
export namespace ExportImportMetricGroupSummary {
  export function getJsonObj(
    obj: ExportImportMetricGroupSummary,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.ExportImportConfigSummary.getJsonObj(obj) as ExportImportMetricGroupSummary)),
      ...{
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ...
        : (model.ExportImportConfigSummary.getDeserializedJsonObj(
            obj
          ) as ExportImportMetricGroupSummary)),
      ...{
        "dimensions": obj.dimensions
          ? obj.dimensions.map(item => {
