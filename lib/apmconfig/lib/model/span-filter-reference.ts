...
export namespace SpanFilterReference {
  export function getJsonObj(obj: SpanFilterReference): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: SpanFilterReference): object {
    const jsonObj = { ...obj, ...{} };
