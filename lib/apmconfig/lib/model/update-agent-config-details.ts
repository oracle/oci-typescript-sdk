...
export namespace UpdateAgentConfigDetails {
  export function getJsonObj(obj: UpdateAgentConfigDetails, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.UpdateConfigDetails.getJsonObj(obj) as UpdateAgentConfigDetails)),
      ...{
  ...
  export function getDeserializedJsonObj(
    obj: UpdateAgentConfigDetails,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.UpdateConfigDetails.getDeserializedJsonObj(obj) as UpdateAgentConfigDetails)),
      ...{
