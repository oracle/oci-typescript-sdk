...
export namespace SecureAccessControlRule {
  export function getJsonObj(obj: SecureAccessControlRule): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: SecureAccessControlRule): object {
    const jsonObj = { ...obj, ...{} };
