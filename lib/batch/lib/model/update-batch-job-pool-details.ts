...
export namespace UpdateBatchJobPoolDetails {
  export function getJsonObj(obj: UpdateBatchJobPoolDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: UpdateBatchJobPoolDetails): object {
    const jsonObj = { ...obj, ...{} };
