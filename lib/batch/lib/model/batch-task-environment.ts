...
export namespace BatchTaskEnvironment {
  ...
  export function getJsonObj(obj: BatchTaskEnvironment): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: BatchTaskEnvironment): object {
    const jsonObj = {
      ...obj,
      ...{
        "securityContext": obj.securityContext
