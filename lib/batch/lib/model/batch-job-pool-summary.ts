...
export namespace BatchJobPoolSummary {
  export function getJsonObj(obj: BatchJobPoolSummary): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: BatchJobPoolSummary): object {
    const jsonObj = { ...obj, ...{} };
