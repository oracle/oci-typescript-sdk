...
export namespace CreateBatchJobPoolDetails {
  export function getJsonObj(obj: CreateBatchJobPoolDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: CreateBatchJobPoolDetails): object {
    const jsonObj = { ...obj, ...{} };
