...
export namespace BatchContextSummary {
  export function getJsonObj(obj: BatchContextSummary): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: BatchContextSummary): object {
    const jsonObj = { ...obj, ...{} };
