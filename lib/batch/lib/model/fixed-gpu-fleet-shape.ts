...
export namespace FixedGpuFleetShape {
  export function getJsonObj(obj: FixedGpuFleetShape, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj ? obj : (model.GpuFleetShape.getJsonObj(obj) as FixedGpuFleetShape)),
      ...{}
    };
  ...
  export function getDeserializedJsonObj(
    obj: FixedGpuFleetShape,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.GpuFleetShape.getDeserializedJsonObj(obj) as FixedGpuFleetShape)),
      ...{}
    };
