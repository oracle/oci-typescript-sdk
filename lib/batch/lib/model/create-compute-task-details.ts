...
export namespace CreateComputeTaskDetails {
  export function getJsonObj(obj: CreateComputeTaskDetails, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.CreateBatchTaskDetails.getJsonObj(obj) as CreateComputeTaskDetails)),
      ...{
  ...
  export function getDeserializedJsonObj(
    obj: CreateComputeTaskDetails,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.CreateBatchTaskDetails.getDeserializedJsonObj(obj) as CreateComputeTaskDetails)),
      ...{
        "fleetAssignmentPolicy": obj.fleetAssignmentPolicy
