 ...
 *
 */
export interface StatefulIngressSecurityListConfiguration
...
export namespace StatefulIngressSecurityListConfiguration {
  export function getJsonObj(
    obj: StatefulIngressSecurityListConfiguration,
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ...
        : (model.AllowedSecurityConfiguration.getJsonObj(
            obj
          ) as StatefulIngressSecurityListConfiguration)),
      ...{
  ...
  export const type = "STATEFUL_INGRESS_SECURITY_LIST";
