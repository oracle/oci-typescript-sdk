...
export namespace TcpProtocolParameters {
  export function getJsonObj(obj: TcpProtocolParameters, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.ProtocolParameters.getJsonObj(obj) as TcpProtocolParameters)),
      ...{}
    };
  ...
  export function getDeserializedJsonObj(
    obj: TcpProtocolParameters,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.ProtocolParameters.getDeserializedJsonObj(obj) as TcpProtocolParameters)),
      ...{}
    };
