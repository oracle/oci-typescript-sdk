...
export namespace CreateRouteTableDetails {
  export function getJsonObj(obj: CreateRouteTableDetails): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: CreateRouteTableDetails): object {
    const jsonObj = {
      ...obj,
      ...{
        "routeRules": obj.routeRules
