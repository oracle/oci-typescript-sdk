...
export namespace CreateFlexTunnelBgpSessionDetails {
  export function getJsonObj(obj: CreateFlexTunnelBgpSessionDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: CreateFlexTunnelBgpSessionDetails): object {
    const jsonObj = { ...obj, ...{} };
