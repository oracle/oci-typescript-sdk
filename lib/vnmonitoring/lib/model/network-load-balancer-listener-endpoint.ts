...
export namespace NetworkLoadBalancerListenerEndpoint {
  export function getJsonObj(
    obj: NetworkLoadBalancerListenerEndpoint,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.Endpoint.getJsonObj(obj) as NetworkLoadBalancerListenerEndpoint)),
      ...{}
    };

    return jsonObj;
  }
  export const type = "NETWORK_LOAD_BALANCER_LISTENER";
  export function getDeserializedJsonObj(
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.Endpoint.getDeserializedJsonObj(obj) as NetworkLoadBalancerListenerEndpoint)),
      ...{}
    };
