...
export namespace CreateDrgRouteDistributionDetails {
  export enum DistributionType {
    Import = "IMPORT"
  }

  export function getJsonObj(obj: CreateDrgRouteDistributionDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: CreateDrgRouteDistributionDetails): object {
    const jsonObj = { ...obj, ...{} };
