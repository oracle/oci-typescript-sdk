...
export namespace CreateDrgRouteTableDetails {
  export function getJsonObj(obj: CreateDrgRouteTableDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: CreateDrgRouteTableDetails): object {
    const jsonObj = { ...obj, ...{} };
