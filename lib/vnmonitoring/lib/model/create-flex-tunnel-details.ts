...
export namespace CreateFlexTunnelDetails {
  export function getJsonObj(obj: CreateFlexTunnelDetails): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: CreateFlexTunnelDetails): object {
    const jsonObj = {
      ...obj,
      ...{
        "flexTunnelConfiguration": obj.flexTunnelConfiguration
