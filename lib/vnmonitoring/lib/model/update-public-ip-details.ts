...
export namespace UpdatePublicIpDetails {
  export function getJsonObj(obj: UpdatePublicIpDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: UpdatePublicIpDetails): object {
    const jsonObj = { ...obj, ...{} };
