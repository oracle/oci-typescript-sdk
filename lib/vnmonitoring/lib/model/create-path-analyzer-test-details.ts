...
export namespace CreatePathAnalyzerTestDetails {
  export function getJsonObj(obj: CreatePathAnalyzerTestDetails): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: CreatePathAnalyzerTestDetails): object {
    const jsonObj = {
      ...obj,
      ...{
        "sourceEndpoint": obj.sourceEndpoint
