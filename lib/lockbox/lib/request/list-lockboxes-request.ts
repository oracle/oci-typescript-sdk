...
/**
 * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/lockbox/ListLockboxes.ts.html |here} to see how to use ListLockboxesRequest.
 */
...
export namespace ListLockboxesRequest {
  export enum SortBy {
