...
/**
 * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/lockbox/ListApprovalTemplates.ts.html |here} to see how to use ListApprovalTemplatesRequest.
 */
...
export namespace ListApprovalTemplatesRequest {
  export enum SortBy {
