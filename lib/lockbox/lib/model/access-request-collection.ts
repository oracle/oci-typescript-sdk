...
export namespace AccessRequestCollection {
  export function getJsonObj(obj: AccessRequestCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
  ...
  export function getDeserializedJsonObj(obj: AccessRequestCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
