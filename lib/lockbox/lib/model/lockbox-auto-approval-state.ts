 ...
 **/
export enum LockboxAutoApprovalState {
  Enabled = "ENABLED",
  Disabled = "DISABLED",
...
export namespace LockboxAutoApprovalState {
  export function getJsonObj(obj: LockboxAutoApprovalState): LockboxAutoApprovalState {
    return obj;
  }
  export function getDeserializedJsonObj(obj: LockboxAutoApprovalState): LockboxAutoApprovalState {
    return obj;
  }
}
