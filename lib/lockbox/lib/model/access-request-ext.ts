...
export namespace AccessRequestExt {
  ...
  export function getJsonObj(obj: AccessRequestExt): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: AccessRequestExt): object {
    const jsonObj = {
      ...obj,
      ...{
        "activityLogs": obj.activityLogs
