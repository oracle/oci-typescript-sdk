...
export namespace LockboxPartner {
  export function getJsonObj(obj: LockboxPartner): LockboxPartner {
    return obj;
  }
  export function getDeserializedJsonObj(obj: LockboxPartner): LockboxPartner {
    return obj;
  }
}
