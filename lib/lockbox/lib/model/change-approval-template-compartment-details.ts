...
export namespace ChangeApprovalTemplateCompartmentDetails {
  export function getJsonObj(obj: ChangeApprovalTemplateCompartmentDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: ChangeApprovalTemplateCompartmentDetails): object {
    const jsonObj = { ...obj, ...{} };
