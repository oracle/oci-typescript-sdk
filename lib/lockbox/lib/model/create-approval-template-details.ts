...
export namespace CreateApprovalTemplateDetails {
  export function getJsonObj(obj: CreateApprovalTemplateDetails): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: CreateApprovalTemplateDetails): object {
    const jsonObj = {
      ...obj,
      ...{
        "approverLevels": obj.approverLevels
