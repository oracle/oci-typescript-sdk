...
export namespace UpdateApprovalTemplateDetails {
  export function getJsonObj(obj: UpdateApprovalTemplateDetails): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: UpdateApprovalTemplateDetails): object {
    const jsonObj = {
      ...obj,
      ...{
        "approverLevels": obj.approverLevels
