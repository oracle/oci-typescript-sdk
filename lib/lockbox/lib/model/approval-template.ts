...
export namespace ApprovalTemplate {
  ...
  export function getJsonObj(obj: ApprovalTemplate): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: ApprovalTemplate): object {
    const jsonObj = {
      ...obj,
      ...{
        "approverLevels": obj.approverLevels
