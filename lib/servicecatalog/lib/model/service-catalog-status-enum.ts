 ...
 **/
export enum ServiceCatalogStatusEnum {
  Active = "ACTIVE",
  Inactive = "INACTIVE",
...
export namespace ServiceCatalogStatusEnum {
  export function getJsonObj(obj: ServiceCatalogStatusEnum): ServiceCatalogStatusEnum {
    return obj;
  }
  export function getDeserializedJsonObj(obj: ServiceCatalogStatusEnum): ServiceCatalogStatusEnum {
    return obj;
  }
}
