...
export namespace ChangeServiceCatalogCompartmentDetails {
  export function getJsonObj(obj: ChangeServiceCatalogCompartmentDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: ChangeServiceCatalogCompartmentDetails): object {
    const jsonObj = { ...obj, ...{} };
