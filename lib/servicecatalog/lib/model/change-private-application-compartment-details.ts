...
export namespace ChangePrivateApplicationCompartmentDetails {
  export function getJsonObj(obj: ChangePrivateApplicationCompartmentDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: ChangePrivateApplicationCompartmentDetails): object {
    const jsonObj = { ...obj, ...{} };
