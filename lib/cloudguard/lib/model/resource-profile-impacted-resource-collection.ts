...
export namespace ResourceProfileImpactedResourceCollection {
  export function getJsonObj(obj: ResourceProfileImpactedResourceCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
  ...
  export function getDeserializedJsonObj(obj: ResourceProfileImpactedResourceCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
