...
export namespace SavedQuerySummary {
  export function getJsonObj(obj: SavedQuerySummary): object {
    const jsonObj = {
      ...obj,
      ...{
        "locks": obj.locks
  ...
  export function getDeserializedJsonObj(obj: SavedQuerySummary): object {
    const jsonObj = {
      ...obj,
      ...{
        "locks": obj.locks
