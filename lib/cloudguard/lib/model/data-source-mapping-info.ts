...
export namespace DataSourceMappingInfo {
  export function getJsonObj(obj: DataSourceMappingInfo): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: DataSourceMappingInfo): object {
    const jsonObj = { ...obj, ...{} };
