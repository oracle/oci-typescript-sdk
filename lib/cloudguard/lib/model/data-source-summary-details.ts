...
export namespace DataSourceSummaryDetails {
  export function getJsonObj(obj: DataSourceSummaryDetails): object {
    const jsonObj = { ...obj, ...{} };
  ...
  export function getDeserializedJsonObj(obj: DataSourceSummaryDetails): object {
    const jsonObj = { ...obj, ...{} };
