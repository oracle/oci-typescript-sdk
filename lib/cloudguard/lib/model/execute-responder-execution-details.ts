...
export namespace ExecuteResponderExecutionDetails {
  export function getJsonObj(obj: ExecuteResponderExecutionDetails): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: ExecuteResponderExecutionDetails): object {
    const jsonObj = {
      ...obj,
      ...{
        "configurations": obj.configurations
