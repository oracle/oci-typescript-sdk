...
export namespace TargetResourceTypesSelected {
  export enum Values {
  ...
  export function getJsonObj(obj: TargetResourceTypesSelected, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.TargetSelected.getJsonObj(obj) as TargetResourceTypesSelected)),
      ...{}
    };
