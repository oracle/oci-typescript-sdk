...
export namespace CreateDetectorRuleDetails {
  export function getJsonObj(obj: CreateDetectorRuleDetails): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: CreateDetectorRuleDetails): object {
    const jsonObj = {
      ...obj,
      ...{
        "configurations": obj.configurations
