...
export namespace UpdateTargetDetails {
  export function getJsonObj(obj: UpdateTargetDetails): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: UpdateTargetDetails): object {
    const jsonObj = {
      ...obj,
      ...{
        "targetDetectorRecipes": obj.targetDetectorRecipes
