...
export namespace ResourceProfileRiskScoreAggregationSummary {
  export function getJsonObj(obj: ResourceProfileRiskScoreAggregationSummary): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
  ...
  export function getDeserializedJsonObj(obj: ResourceProfileRiskScoreAggregationSummary): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
