...
export namespace DetectorRecipeDetectorRuleCollection {
  export function getJsonObj(obj: DetectorRecipeDetectorRuleCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
  ...
  export function getDeserializedJsonObj(obj: DetectorRecipeDetectorRuleCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
