...
export namespace RegionStatusDetail {
  export function getJsonObj(obj: RegionStatusDetail): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: RegionStatusDetail): object {
    const jsonObj = { ...obj, ...{} };
