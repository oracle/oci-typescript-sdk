...
export namespace CreateSecurityRecipeDetails {
  export function getJsonObj(obj: CreateSecurityRecipeDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: CreateSecurityRecipeDetails): object {
    const jsonObj = { ...obj, ...{} };
