...
export namespace ComplianceDocumentSummary {
  export function getJsonObj(obj: ComplianceDocumentSummary): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: ComplianceDocumentSummary): object {
    const jsonObj = { ...obj, ...{} };
