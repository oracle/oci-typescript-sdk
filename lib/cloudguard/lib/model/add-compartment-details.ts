...
export namespace AddCompartmentDetails {
  export function getJsonObj(obj: AddCompartmentDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: AddCompartmentDetails): object {
    const jsonObj = { ...obj, ...{} };
