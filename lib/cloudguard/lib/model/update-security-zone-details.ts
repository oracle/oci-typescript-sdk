...
export namespace UpdateSecurityZoneDetails {
  export function getJsonObj(obj: UpdateSecurityZoneDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: UpdateSecurityZoneDetails): object {
    const jsonObj = { ...obj, ...{} };
