...
export namespace TargetIdsSelected {
  export function getJsonObj(obj: TargetIdsSelected, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj ? obj : (model.TargetSelected.getJsonObj(obj) as TargetIdsSelected)),
      ...{}
    };
