...
/**
 * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/cloudguard/ListManagedListTypes.ts.html |here} to see how to use ListManagedListTypesRequest.
 */
...
export namespace ListManagedListTypesRequest {
  export enum SortBy {
