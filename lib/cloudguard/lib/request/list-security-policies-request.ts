...
/**
 * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/cloudguard/ListSecurityPolicies.ts.html |here} to see how to use ListSecurityPoliciesRequest.
 */
