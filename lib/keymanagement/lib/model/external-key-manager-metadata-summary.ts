...
export namespace ExternalKeyManagerMetadataSummary {
  export function getJsonObj(obj: ExternalKeyManagerMetadataSummary): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: ExternalKeyManagerMetadataSummary): object {
    const jsonObj = {
      ...obj,
      ...{
        "oauthMetadataSummary": obj.oauthMetadataSummary
