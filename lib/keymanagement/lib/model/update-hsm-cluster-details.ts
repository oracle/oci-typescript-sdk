...
export namespace UpdateHsmClusterDetails {
  export function getJsonObj(obj: UpdateHsmClusterDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: UpdateHsmClusterDetails): object {
    const jsonObj = { ...obj, ...{} };
