...
export namespace HsmClusterPendingCreateDynamicGroup {
  export function getJsonObj(obj: HsmClusterPendingCreateDynamicGroup): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: HsmClusterPendingCreateDynamicGroup): object {
    const jsonObj = { ...obj, ...{} };
