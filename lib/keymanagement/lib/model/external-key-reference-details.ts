...
export namespace ExternalKeyReferenceDetails {
  export function getJsonObj(obj: ExternalKeyReferenceDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: ExternalKeyReferenceDetails): object {
    const jsonObj = { ...obj, ...{} };
