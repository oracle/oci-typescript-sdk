...
export namespace HsmPartitionCollection {
  export function getJsonObj(obj: HsmPartitionCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
  ...
  export function getDeserializedJsonObj(obj: HsmPartitionCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
