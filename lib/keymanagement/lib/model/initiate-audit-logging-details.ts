...
export namespace InitiateAuditLoggingDetails {
  export function getJsonObj(obj: InitiateAuditLoggingDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: InitiateAuditLoggingDetails): object {
    const jsonObj = { ...obj, ...{} };
