...
export namespace ExternalKeyReference {
  export function getJsonObj(obj: ExternalKeyReference): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: ExternalKeyReference): object {
    const jsonObj = { ...obj, ...{} };
