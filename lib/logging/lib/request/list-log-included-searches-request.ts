...
/**
 * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/logging/ListLogIncludedSearches.ts.html |here} to see how to use ListLogIncludedSearchesRequest.
 */
...
export namespace ListLogIncludedSearchesRequest {
  export enum SortBy {
