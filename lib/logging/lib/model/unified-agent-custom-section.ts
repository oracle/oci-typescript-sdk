...
export namespace UnifiedAgentCustomSection {
  export function getJsonObj(obj: UnifiedAgentCustomSection): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: UnifiedAgentCustomSection): object {
    const jsonObj = { ...obj, ...{} };
