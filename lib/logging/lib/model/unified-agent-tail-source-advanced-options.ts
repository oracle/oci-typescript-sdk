...
export namespace UnifiedAgentTailSourceAdvancedOptions {
  export function getJsonObj(obj: UnifiedAgentTailSourceAdvancedOptions): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: UnifiedAgentTailSourceAdvancedOptions): object {
    const jsonObj = { ...obj, ...{} };
