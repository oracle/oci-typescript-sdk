...
export namespace UnifiedAgentConfiguration {
  export function getJsonObj(obj: UnifiedAgentConfiguration): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: UnifiedAgentConfiguration): object {
    const jsonObj = {
      ...obj,
      ...{
        "serviceConfiguration": obj.serviceConfiguration
