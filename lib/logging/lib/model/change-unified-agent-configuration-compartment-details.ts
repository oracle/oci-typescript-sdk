...
export namespace ChangeUnifiedAgentConfigurationCompartmentDetails {
  export function getJsonObj(obj: ChangeUnifiedAgentConfigurationCompartmentDetails): object {
    const jsonObj = { ...obj, ...{} };
