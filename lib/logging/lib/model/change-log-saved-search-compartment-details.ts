...
export namespace ChangeLogSavedSearchCompartmentDetails {
  export function getJsonObj(obj: ChangeLogSavedSearchCompartmentDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: ChangeLogSavedSearchCompartmentDetails): object {
    const jsonObj = { ...obj, ...{} };
