...
export namespace UpdateDevOpsConfigSourceDetails {
  export function getJsonObj(
    obj: UpdateDevOpsConfigSourceDetails,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.UpdateConfigSourceDetails.getJsonObj(obj) as UpdateDevOpsConfigSourceDetails)),
      ...{}
    };
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ...
        : (model.UpdateConfigSourceDetails.getDeserializedJsonObj(
            obj
          ) as UpdateDevOpsConfigSourceDetails)),
      ...{}
    };
