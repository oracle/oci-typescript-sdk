...
export namespace CreateTemplateDetails {
  export function getJsonObj(obj: CreateTemplateDetails): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: CreateTemplateDetails): object {
    const jsonObj = {
      ...obj,
      ...{
        "templateConfigSource": obj.templateConfigSource
