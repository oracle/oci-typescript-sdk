...
export namespace UpdateBitbucketServerConfigSourceDetails {
  export function getJsonObj(
    obj: UpdateBitbucketServerConfigSourceDetails,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.UpdateConfigSourceDetails.getJsonObj(
            obj
          ) as UpdateBitbucketServerConfigSourceDetails)),
      ...{}
    };
