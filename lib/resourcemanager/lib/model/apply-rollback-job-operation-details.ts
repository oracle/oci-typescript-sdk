...
export namespace ApplyRollbackJobOperationDetails {
  export enum ExecutionPlanRollbackStrategy {
  ...
  export function getJsonObj(
    obj: ApplyRollbackJobOperationDetails,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.JobOperationDetails.getJsonObj(obj) as ApplyRollbackJobOperationDetails)),
      ...{
  ...
  export function getDeserializedJsonObj(
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.JobOperationDetails.getDeserializedJsonObj(
            obj
          ) as ApplyRollbackJobOperationDetails)),
      ...{
        "terraformAdvancedOptions": obj.terraformAdvancedOptions
