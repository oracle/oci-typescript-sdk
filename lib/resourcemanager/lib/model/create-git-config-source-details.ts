...
export namespace CreateGitConfigSourceDetails {
  export function getJsonObj(obj: CreateGitConfigSourceDetails, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.CreateConfigSourceDetails.getJsonObj(obj) as CreateGitConfigSourceDetails)),
      ...{}
    };
  ...
  export function getDeserializedJsonObj(
    obj: CreateGitConfigSourceDetails,
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ...
        : (model.CreateConfigSourceDetails.getDeserializedJsonObj(
            obj
          ) as CreateGitConfigSourceDetails)),
      ...{}
    };
