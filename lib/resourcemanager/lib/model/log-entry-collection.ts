...
export interface LogEntryCollection {
   ...
   * Collection of log entries.
   */
  "items": Array<model.LogEntry>;
}

export namespace LogEntryCollection {
  export function getJsonObj(obj: LogEntryCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
  ...
  export function getDeserializedJsonObj(obj: LogEntryCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
