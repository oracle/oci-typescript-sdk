...
export namespace InstanceConfigurationSummary {
  export function getJsonObj(obj: InstanceConfigurationSummary): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: InstanceConfigurationSummary): object {
    const jsonObj = { ...obj, ...{} };
