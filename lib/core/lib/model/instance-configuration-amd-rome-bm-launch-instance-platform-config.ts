 ...
 *
 */
export interface InstanceConfigurationAmdRomeBmLaunchInstancePlatformConfig
...
export namespace InstanceConfigurationAmdRomeBmLaunchInstancePlatformConfig {
  ...
  export function getJsonObj(
    obj: InstanceConfigurationAmdRomeBmLaunchInstancePlatformConfig,
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ...
        : (model.InstanceConfigurationLaunchInstancePlatformConfig.getJsonObj(
            obj
          ) as InstanceConfigurationAmdRomeBmLaunchInstancePlatformConfig)),
      ...{}
    };
