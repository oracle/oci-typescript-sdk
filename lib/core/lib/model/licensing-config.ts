...
export namespace LicensingConfig {
  export enum Type {
    Windows = "WINDOWS",
    /**
  ...
  export function getJsonObj(obj: LicensingConfig): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: LicensingConfig): object {
    const jsonObj = { ...obj, ...{} };
