...
export namespace PatchSubnetReplaceInstruction {
  export function getJsonObj(
    obj: PatchSubnetReplaceInstruction,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.PatchSubnetInstruction.getJsonObj(obj) as PatchSubnetReplaceInstruction)),
      ...{}
    };
  ...
  export function getDeserializedJsonObj(
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.PatchSubnetInstruction.getDeserializedJsonObj(
            obj
          ) as PatchSubnetReplaceInstruction)),
      ...{}
    };
