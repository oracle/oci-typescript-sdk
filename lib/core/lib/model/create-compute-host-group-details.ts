...
export namespace CreateComputeHostGroupDetails {
  export function getJsonObj(obj: CreateComputeHostGroupDetails): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: CreateComputeHostGroupDetails): object {
    const jsonObj = {
      ...obj,
      ...{
        "configurations": obj.configurations
