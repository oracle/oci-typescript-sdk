 ...
 */
export interface PatchSubnetInstruction {
  /**
...
export namespace PatchSubnetInstruction {
  export function getJsonObj(obj: PatchSubnetInstruction): object {
    const jsonObj = { ...obj, ...{} };

    if (obj && "operation" in obj && obj.operation) {
      switch (obj.operation) {
        case "REPLACE":
          return model.PatchSubnetReplaceInstruction.getJsonObj(
            <model.PatchSubnetReplaceInstruction>(<object>jsonObj),
            true
          );
        default:
  ...
  export function getDeserializedJsonObj(obj: PatchSubnetInstruction): object {
    const jsonObj = { ...obj, ...{} };

    if (obj && "operation" in obj && obj.operation) {
      switch (obj.operation) {
        case "REPLACE":
          return model.PatchSubnetReplaceInstruction.getDeserializedJsonObj(
            <model.PatchSubnetReplaceInstruction>(<object>jsonObj),
            true
          );
        default:
