...
export namespace CopyVolumeGroupBackupDetails {
  export function getJsonObj(obj: CopyVolumeGroupBackupDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: CopyVolumeGroupBackupDetails): object {
    const jsonObj = { ...obj, ...{} };
