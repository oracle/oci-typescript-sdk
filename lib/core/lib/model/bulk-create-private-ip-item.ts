...
export namespace BulkCreatePrivateIpItem {
  export enum Lifetime {
    Ephemeral = "EPHEMERAL",
    Reserved = "RESERVED"
  }

  export function getJsonObj(obj: BulkCreatePrivateIpItem): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: BulkCreatePrivateIpItem): object {
    const jsonObj = { ...obj, ...{} };
