 ...
 *
 **/
export enum InstanceMaintenanceAlternativeResolutionActions {
...
export namespace InstanceMaintenanceAlternativeResolutionActions {
  export function getJsonObj(
    obj: InstanceMaintenanceAlternativeResolutionActions
