...
export namespace ComputeHpcIsland {
  ...
  export function getJsonObj(obj: ComputeHpcIsland): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: ComputeHpcIsland): object {
    const jsonObj = { ...obj, ...{} };
