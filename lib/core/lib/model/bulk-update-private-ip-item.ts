...
export namespace BulkUpdatePrivateIpItem {
  export enum Lifetime {
    Ephemeral = "EPHEMERAL",
    Reserved = "RESERVED"
  }

  export function getJsonObj(obj: BulkUpdatePrivateIpItem): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: BulkUpdatePrivateIpItem): object {
    const jsonObj = { ...obj, ...{} };
