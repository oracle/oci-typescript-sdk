...
export namespace ComputeHostGroup {
  ...
  export function getJsonObj(obj: ComputeHostGroup): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: ComputeHostGroup): object {
    const jsonObj = {
      ...obj,
      ...{
        "configurations": obj.configurations
