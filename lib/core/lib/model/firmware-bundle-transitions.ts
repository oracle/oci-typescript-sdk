...
export namespace FirmwareBundleTransitions {
  export function getJsonObj(obj: FirmwareBundleTransitions): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: FirmwareBundleTransitions): object {
    const jsonObj = { ...obj, ...{} };
