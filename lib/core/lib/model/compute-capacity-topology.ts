...
export namespace ComputeCapacityTopology {
  ...
  export function getJsonObj(obj: ComputeCapacityTopology): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: ComputeCapacityTopology): object {
    const jsonObj = {
      ...obj,
      ...{
        "capacitySource": obj.capacitySource
