...
export namespace BulkCreateIpv6sItem {
  export enum Lifetime {
    Ephemeral = "EPHEMERAL",
    Reserved = "RESERVED"
  }

  export function getJsonObj(obj: BulkCreateIpv6sItem): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: BulkCreateIpv6sItem): object {
    const jsonObj = { ...obj, ...{} };
