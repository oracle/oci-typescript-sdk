...
export namespace CreateGmcConfigurationDetails {
  export function getJsonObj(
    obj: CreateGmcConfigurationDetails,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.CreateInstanceConfigurationBase.getJsonObj(obj) as CreateGmcConfigurationDetails)),
      ...{
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ...
        : (model.CreateInstanceConfigurationBase.getDeserializedJsonObj(
            obj
          ) as CreateGmcConfigurationDetails)),
      ...{
        "gmcConfigs": obj.gmcConfigs
          ? obj.gmcConfigs.map(item => {
