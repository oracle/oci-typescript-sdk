...
export namespace ComputeBareMetalHostSummary {
  export function getJsonObj(obj: ComputeBareMetalHostSummary): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: ComputeBareMetalHostSummary): object {
    const jsonObj = { ...obj, ...{} };
