...
export namespace ComputeGpuMemoryClusterScaleConfig {
  export function getJsonObj(obj: ComputeGpuMemoryClusterScaleConfig): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: ComputeGpuMemoryClusterScaleConfig): object {
    const jsonObj = { ...obj, ...{} };
