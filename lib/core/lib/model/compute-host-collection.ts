...
export namespace ComputeHostCollection {
  export function getJsonObj(obj: ComputeHostCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
  ...
  export function getDeserializedJsonObj(obj: ComputeHostCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
