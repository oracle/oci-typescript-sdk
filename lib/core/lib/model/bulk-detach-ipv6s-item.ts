...
export namespace BulkDetachIpv6sItem {
  export function getJsonObj(obj: BulkDetachIpv6sItem): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: BulkDetachIpv6sItem): object {
    const jsonObj = { ...obj, ...{} };
