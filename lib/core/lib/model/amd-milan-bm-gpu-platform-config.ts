...
export namespace AmdMilanBmGpuPlatformConfig {
  ...
  export function getJsonObj(obj: AmdMilanBmGpuPlatformConfig, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.PlatformConfig.getJsonObj(obj) as AmdMilanBmGpuPlatformConfig)),
      ...{}
    };

    return jsonObj;
  }
  export const type = "AMD_MILAN_BM_GPU";
  export function getDeserializedJsonObj(
    obj: AmdMilanBmGpuPlatformConfig,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.PlatformConfig.getDeserializedJsonObj(obj) as AmdMilanBmGpuPlatformConfig)),
      ...{}
    };
