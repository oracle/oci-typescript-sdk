...
export namespace UpdateComputeCapacityReservationDetails {
  export function getJsonObj(obj: UpdateComputeCapacityReservationDetails): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: UpdateComputeCapacityReservationDetails): object {
    const jsonObj = {
      ...obj,
      ...{
        "instanceReservationConfigs": obj.instanceReservationConfigs
