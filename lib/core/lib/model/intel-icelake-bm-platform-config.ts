...
export namespace IntelIcelakeBmPlatformConfig {
  ...
  export function getJsonObj(obj: IntelIcelakeBmPlatformConfig, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.PlatformConfig.getJsonObj(obj) as IntelIcelakeBmPlatformConfig)),
      ...{}
    };

    return jsonObj;
  }
  export const type = "INTEL_ICELAKE_BM";
  export function getDeserializedJsonObj(
    obj: IntelIcelakeBmPlatformConfig,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.PlatformConfig.getDeserializedJsonObj(obj) as IntelIcelakeBmPlatformConfig)),
      ...{}
    };
