...
export namespace ComputeHpcIslandSummary {
  export function getJsonObj(obj: ComputeHpcIslandSummary): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: ComputeHpcIslandSummary): object {
    const jsonObj = { ...obj, ...{} };
