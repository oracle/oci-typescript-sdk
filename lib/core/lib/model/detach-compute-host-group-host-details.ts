...
export namespace DetachComputeHostGroupHostDetails {
  export function getJsonObj(obj: DetachComputeHostGroupHostDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: DetachComputeHostGroupHostDetails): object {
    const jsonObj = { ...obj, ...{} };
