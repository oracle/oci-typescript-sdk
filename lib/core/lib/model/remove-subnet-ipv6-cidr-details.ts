...
export namespace RemoveSubnetIpv6CidrDetails {
  export function getJsonObj(obj: RemoveSubnetIpv6CidrDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: RemoveSubnetIpv6CidrDetails): object {
    const jsonObj = { ...obj, ...{} };
