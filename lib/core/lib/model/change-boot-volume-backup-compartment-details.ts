...
export namespace ChangeBootVolumeBackupCompartmentDetails {
  export function getJsonObj(obj: ChangeBootVolumeBackupCompartmentDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: ChangeBootVolumeBackupCompartmentDetails): object {
    const jsonObj = { ...obj, ...{} };
