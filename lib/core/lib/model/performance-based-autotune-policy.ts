...
export namespace PerformanceBasedAutotunePolicy {
  export function getJsonObj(
    obj: PerformanceBasedAutotunePolicy,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.AutotunePolicy.getJsonObj(obj) as PerformanceBasedAutotunePolicy)),
      ...{}
    };
  ...
  export function getDeserializedJsonObj(
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.AutotunePolicy.getDeserializedJsonObj(obj) as PerformanceBasedAutotunePolicy)),
      ...{}
    };
