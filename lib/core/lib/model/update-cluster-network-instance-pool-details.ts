...
export namespace UpdateClusterNetworkInstancePoolDetails {
  export function getJsonObj(obj: UpdateClusterNetworkInstancePoolDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: UpdateClusterNetworkInstancePoolDetails): object {
    const jsonObj = { ...obj, ...{} };
