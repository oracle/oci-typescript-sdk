...
export namespace BulkDetachIpv6sDetails {
  export function getJsonObj(obj: BulkDetachIpv6sDetails): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: BulkDetachIpv6sDetails): object {
    const jsonObj = {
      ...obj,
      ...{
        "bulkDetachIpv6sItem": obj.bulkDetachIpv6sItem
