...
export namespace ChangeCaptureFilterCompartmentDetails {
  export function getJsonObj(obj: ChangeCaptureFilterCompartmentDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: ChangeCaptureFilterCompartmentDetails): object {
    const jsonObj = { ...obj, ...{} };
