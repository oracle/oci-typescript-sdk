...
export namespace BulkUpdatePrivateIpsDetails {
  export function getJsonObj(obj: BulkUpdatePrivateIpsDetails): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: BulkUpdatePrivateIpsDetails): object {
    const jsonObj = {
      ...obj,
      ...{
        "bulkUpdatePrivateIpItem": obj.bulkUpdatePrivateIpItem
