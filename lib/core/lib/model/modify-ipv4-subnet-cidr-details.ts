...
export namespace ModifyIpv4SubnetCidrDetails {
  export function getJsonObj(obj: ModifyIpv4SubnetCidrDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: ModifyIpv4SubnetCidrDetails): object {
    const jsonObj = { ...obj, ...{} };
