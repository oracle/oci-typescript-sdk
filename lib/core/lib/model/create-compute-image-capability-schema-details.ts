...
export namespace CreateComputeImageCapabilitySchemaDetails {
  export function getJsonObj(obj: CreateComputeImageCapabilitySchemaDetails): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: CreateComputeImageCapabilitySchemaDetails): object {
    const jsonObj = {
      ...obj,
      ...{
        "schemaData": obj.schemaData
