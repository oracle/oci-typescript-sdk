...
export namespace CreateByoasnDetails {
  export function getJsonObj(obj: CreateByoasnDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: CreateByoasnDetails): object {
    const jsonObj = { ...obj, ...{} };
