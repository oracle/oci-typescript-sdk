 ...
 *
 **/
export enum ComputeClusterLogicalPlacementConstraint {
...
export namespace ComputeClusterLogicalPlacementConstraint {
  export function getJsonObj(
    obj: ComputeClusterLogicalPlacementConstraint
