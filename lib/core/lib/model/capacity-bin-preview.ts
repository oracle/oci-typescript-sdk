...
export namespace CapacityBinPreview {
  export function getJsonObj(obj: CapacityBinPreview): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: CapacityBinPreview): object {
    const jsonObj = { ...obj, ...{} };
