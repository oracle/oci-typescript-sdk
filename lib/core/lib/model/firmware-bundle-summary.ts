...
export namespace FirmwareBundleSummary {
  export function getJsonObj(obj: FirmwareBundleSummary): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: FirmwareBundleSummary): object {
    const jsonObj = {
      ...obj,
      ...{
        "platforms": obj.platforms
