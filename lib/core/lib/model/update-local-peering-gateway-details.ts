...
export namespace UpdateLocalPeeringGatewayDetails {
  export function getJsonObj(obj: UpdateLocalPeeringGatewayDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: UpdateLocalPeeringGatewayDetails): object {
    const jsonObj = { ...obj, ...{} };
