...
export namespace CreateMacsecKey {
  export function getJsonObj(obj: CreateMacsecKey): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: CreateMacsecKey): object {
    const jsonObj = { ...obj, ...{} };
