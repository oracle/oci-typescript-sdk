...
export namespace ComputeGpuMemoryFabricCollection {
  export function getJsonObj(obj: ComputeGpuMemoryFabricCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
  ...
  export function getDeserializedJsonObj(obj: ComputeGpuMemoryFabricCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
