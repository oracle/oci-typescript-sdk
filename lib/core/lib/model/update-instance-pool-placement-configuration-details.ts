...
export namespace UpdateInstancePoolPlacementConfigurationDetails {
  export function getJsonObj(obj: UpdateInstancePoolPlacementConfigurationDetails): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(
    obj: UpdateInstancePoolPlacementConfigurationDetails
  ): object {
    const jsonObj = {
      ...obj,
      ...{
