...
export namespace BulkDeleteIpv6sItem {
  export function getJsonObj(obj: BulkDeleteIpv6sItem): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: BulkDeleteIpv6sItem): object {
    const jsonObj = { ...obj, ...{} };
