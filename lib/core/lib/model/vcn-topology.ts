...
export namespace VcnTopology {
  export function getJsonObj(obj: VcnTopology, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj ? obj : (model.Topology.getJsonObj(obj) as VcnTopology)),
      ...{}
    };
