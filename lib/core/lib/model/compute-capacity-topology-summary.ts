...
export namespace ComputeCapacityTopologySummary {
  export function getJsonObj(obj: ComputeCapacityTopologySummary): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: ComputeCapacityTopologySummary): object {
    const jsonObj = { ...obj, ...{} };
