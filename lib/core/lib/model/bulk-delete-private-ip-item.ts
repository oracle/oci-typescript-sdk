...
export namespace BulkDeletePrivateIpItem {
  export function getJsonObj(obj: BulkDeletePrivateIpItem): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: BulkDeletePrivateIpItem): object {
    const jsonObj = { ...obj, ...{} };
