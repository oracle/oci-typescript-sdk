...
export namespace PublicIpPoolSummary {
  export function getJsonObj(obj: PublicIpPoolSummary): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: PublicIpPoolSummary): object {
    const jsonObj = { ...obj, ...{} };
