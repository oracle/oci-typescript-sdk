...
export namespace BulkCreateIpv6sDetails {
  export function getJsonObj(obj: BulkCreateIpv6sDetails): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: BulkCreateIpv6sDetails): object {
    const jsonObj = {
      ...obj,
      ...{
        "bulkCreateIpv6sItem": obj.bulkCreateIpv6sItem
