...
export namespace ComputeClusterSummary {
  export function getJsonObj(obj: ComputeClusterSummary): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: ComputeClusterSummary): object {
    const jsonObj = { ...obj, ...{} };
