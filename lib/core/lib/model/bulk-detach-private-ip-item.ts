...
export namespace BulkDetachPrivateIpItem {
  export function getJsonObj(obj: BulkDetachPrivateIpItem): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: BulkDetachPrivateIpItem): object {
    const jsonObj = { ...obj, ...{} };
