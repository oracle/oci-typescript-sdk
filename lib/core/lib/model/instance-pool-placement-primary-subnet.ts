...
export namespace InstancePoolPlacementPrimarySubnet {
  export function getJsonObj(obj: InstancePoolPlacementPrimarySubnet): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: InstancePoolPlacementPrimarySubnet): object {
    const jsonObj = {
      ...obj,
      ...{
        "ipv6AddressIpv6SubnetCidrPairDetails": obj.ipv6AddressIpv6SubnetCidrPairDetails
