...
export namespace CreateComputeGpuMemoryClusterScaleConfig {
  export function getJsonObj(obj: CreateComputeGpuMemoryClusterScaleConfig): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: CreateComputeGpuMemoryClusterScaleConfig): object {
    const jsonObj = { ...obj, ...{} };
