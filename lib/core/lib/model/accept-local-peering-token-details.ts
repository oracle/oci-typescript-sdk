 ...
 *
 */
export interface AcceptLocalPeeringTokenDetails {
  /**
   * An opaque token obtained from a peer.
   */
  "tokenFromPeer": string;
}

export namespace AcceptLocalPeeringTokenDetails {
  export function getJsonObj(obj: AcceptLocalPeeringTokenDetails): object {
    const jsonObj = { ...obj, ...{} };
