...
export namespace UpdateComputeHostGroupDetails {
  export function getJsonObj(obj: UpdateComputeHostGroupDetails): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: UpdateComputeHostGroupDetails): object {
    const jsonObj = {
      ...obj,
      ...{
        "configurations": obj.configurations
