...
export namespace UpdateInstanceMaintenanceEventDetails {
  export function getJsonObj(obj: UpdateInstanceMaintenanceEventDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: UpdateInstanceMaintenanceEventDetails): object {
    const jsonObj = { ...obj, ...{} };
