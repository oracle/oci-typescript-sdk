 ...
 *
 */
export interface AmdMilanBmGpuLaunchInstancePlatformConfig
...
export namespace AmdMilanBmGpuLaunchInstancePlatformConfig {
  ...
  export function getJsonObj(
    obj: AmdMilanBmGpuLaunchInstancePlatformConfig,
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ...
        : (model.LaunchInstancePlatformConfig.getJsonObj(
            obj
          ) as AmdMilanBmGpuLaunchInstancePlatformConfig)),
      ...{}
    };
