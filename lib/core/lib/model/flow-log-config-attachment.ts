 ...
 *
 */
export interface FlowLogConfigAttachment {
  /**
   ...
   */
  "lifecycleState": FlowLogConfigAttachment.LifecycleState;
  /**
   ...
   *
   */
  "targetEntityType": FlowLogConfigAttachment.TargetEntityType;
  /**
