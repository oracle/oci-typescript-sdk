...
export namespace DrgAttachmentMatchAllDrgRouteDistributionMatchCriteria {
  export function getJsonObj(
    obj: DrgAttachmentMatchAllDrgRouteDistributionMatchCriteria,
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ...
        : (model.DrgRouteDistributionMatchCriteria.getJsonObj(
            obj
          ) as DrgAttachmentMatchAllDrgRouteDistributionMatchCriteria)),
      ...{}
    };

    return jsonObj;
  }
  export const matchType = "MATCH_ALL";
