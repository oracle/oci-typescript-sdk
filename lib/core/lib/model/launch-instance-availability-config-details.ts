...
export namespace LaunchInstanceAvailabilityConfigDetails {
  export enum RecoveryAction {
    RestoreInstance = "RESTORE_INSTANCE",
    StopInstance = "STOP_INSTANCE"
  }

  export function getJsonObj(obj: LaunchInstanceAvailabilityConfigDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: LaunchInstanceAvailabilityConfigDetails): object {
    const jsonObj = { ...obj, ...{} };
