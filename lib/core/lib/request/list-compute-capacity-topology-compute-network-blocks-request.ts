...
/**
 * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/core/ListComputeCapacityTopologyComputeNetworkBlocks.ts.html |here} to see how to use ListComputeCapacityTopologyComputeNetworkBlocksRequest.
 */
...
export namespace ListComputeCapacityTopologyComputeNetworkBlocksRequest {
  export enum SortBy {
