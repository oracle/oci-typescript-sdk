...
/**
 * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/core/ListDrgRouteTables.ts.html |here} to see how to use ListDrgRouteTablesRequest.
 */
...
export namespace ListDrgRouteTablesRequest {
  export enum SortBy {
