...
/**
 * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/core/GetSubnetTopology.ts.html |here} to see how to use GetSubnetTopologyRequest.
 */
...
export namespace GetSubnetTopologyRequest {
