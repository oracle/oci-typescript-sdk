...
export interface ConnectLocalPeeringConnectionsRequest {
  /**
   * The OCID of the local peering connection.
   *
   */
  "localPeeringConnectionId": string;
  /**
   * Details regarding the local peering connection to connect.
   */
  "connectLocalPeeringConnectionsDetails": model.ConnectLocalPeeringConnectionsDetails;
  /**
