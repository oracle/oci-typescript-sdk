...
/**
 * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/core/ListVtaps.ts.html |here} to see how to use ListVtapsRequest.
 */
...
export namespace ListVtapsRequest {
  export enum SortBy {
