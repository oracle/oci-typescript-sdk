...
/**
 * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/core/ListComputeCapacityTopologyComputeBareMetalHosts.ts.html |here} to see how to use ListComputeCapacityTopologyComputeBareMetalHostsRequest.
 */
export interface ListComputeCapacityTopologyComputeBareMetalHostsRequest
...
export namespace ListComputeCapacityTopologyComputeBareMetalHostsRequest {
  export enum SortBy {
