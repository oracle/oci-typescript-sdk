...
/**
 * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/core/ListInstanceMaintenanceEvents.ts.html |here} to see how to use ListInstanceMaintenanceEventsRequest.
 */
...
export namespace ListInstanceMaintenanceEventsRequest {
  export enum SortBy {
