...
/**
 * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/core/ListBootVolumeBackups.ts.html |here} to see how to use ListBootVolumeBackupsRequest.
 */
...
export namespace ListBootVolumeBackupsRequest {
  export enum SortBy {
