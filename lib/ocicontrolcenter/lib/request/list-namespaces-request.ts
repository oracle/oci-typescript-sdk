...
/**
 * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/ocicontrolcenter/ListNamespaces.ts.html |here} to see how to use ListNamespacesRequest.
 */
