...
export namespace ZprPolicyCollection {
  export function getJsonObj(obj: ZprPolicyCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
  ...
  export function getDeserializedJsonObj(obj: ZprPolicyCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
