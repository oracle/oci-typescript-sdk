...
/**
 * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/containerengine/ListVirtualNodePools.ts.html |here} to see how to use ListVirtualNodePoolsRequest.
 */
...
export namespace ListVirtualNodePoolsRequest {
  export enum SortBy {
    Id = "ID",
    Name = "NAME",
