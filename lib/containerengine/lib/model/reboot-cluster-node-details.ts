...
export namespace RebootClusterNodeDetails {
  export function getJsonObj(obj: RebootClusterNodeDetails): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: RebootClusterNodeDetails): object {
    const jsonObj = {
      ...obj,
      ...{
        "nodeEvictionSettings": obj.nodeEvictionSettings
