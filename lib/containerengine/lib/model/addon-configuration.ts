...
export namespace AddonConfiguration {
  export function getJsonObj(obj: AddonConfiguration): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: AddonConfiguration): object {
    const jsonObj = { ...obj, ...{} };
