...
export namespace ExtendEndpointDecommissionRollbackDeadlineDetails {
  export function getJsonObj(obj: ExtendEndpointDecommissionRollbackDeadlineDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(
    obj: ExtendEndpointDecommissionRollbackDeadlineDetails
  ): object {
    const jsonObj = { ...obj, ...{} };
