...
export namespace UpdateVirtualNodePoolDetails {
  export function getJsonObj(obj: UpdateVirtualNodePoolDetails): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: UpdateVirtualNodePoolDetails): object {
    const jsonObj = {
      ...obj,
      ...{
        "initialVirtualNodeLabels": obj.initialVirtualNodeLabels
