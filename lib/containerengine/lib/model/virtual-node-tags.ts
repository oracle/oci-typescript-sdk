...
export namespace VirtualNodeTags {
  export function getJsonObj(obj: VirtualNodeTags): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: VirtualNodeTags): object {
    const jsonObj = { ...obj, ...{} };
