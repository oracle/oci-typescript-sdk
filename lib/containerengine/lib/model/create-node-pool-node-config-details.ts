...
export namespace CreateNodePoolNodeConfigDetails {
  export function getJsonObj(obj: CreateNodePoolNodeConfigDetails): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: CreateNodePoolNodeConfigDetails): object {
    const jsonObj = {
      ...obj,
      ...{
        "placementConfigs": obj.placementConfigs
