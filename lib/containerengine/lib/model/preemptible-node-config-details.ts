...
export namespace PreemptibleNodeConfigDetails {
  export function getJsonObj(obj: PreemptibleNodeConfigDetails): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: PreemptibleNodeConfigDetails): object {
    const jsonObj = {
      ...obj,
      ...{
        "preemptionAction": obj.preemptionAction
