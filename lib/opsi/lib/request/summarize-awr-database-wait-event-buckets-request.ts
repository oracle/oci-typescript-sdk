...
/**
 * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/opsi/SummarizeAwrDatabaseWaitEventBuckets.ts.html |here} to see how to use SummarizeAwrDatabaseWaitEventBucketsRequest.
 */
...
export namespace SummarizeAwrDatabaseWaitEventBucketsRequest {
  export enum SortBy {
    Category = "CATEGORY",
