...
/**
 * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/opsi/SummarizeAwrDatabaseSnapshotRanges.ts.html |here} to see how to use SummarizeAwrDatabaseSnapshotRangesRequest.
 */
...
export namespace SummarizeAwrDatabaseSnapshotRangesRequest {
  export enum SortBy {
