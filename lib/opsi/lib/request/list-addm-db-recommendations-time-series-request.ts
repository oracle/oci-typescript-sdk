...
/**
 * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/opsi/ListAddmDbRecommendationsTimeSeries.ts.html |here} to see how to use ListAddmDbRecommendationsTimeSeriesRequest.
 */
...
export namespace ListAddmDbRecommendationsTimeSeriesRequest {
  export enum SortBy {
    Timestamp = "timestamp"
  }
}
