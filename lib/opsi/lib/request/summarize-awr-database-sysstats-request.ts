...
/**
 * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/opsi/SummarizeAwrDatabaseSysstats.ts.html |here} to see how to use SummarizeAwrDatabaseSysstatsRequest.
 */
...
export namespace SummarizeAwrDatabaseSysstatsRequest {
  export enum SortBy {
