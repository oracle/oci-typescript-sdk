...
/**
 * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/opsi/ListAddmDbFindingCategories.ts.html |here} to see how to use ListAddmDbFindingCategoriesRequest.
 */
...
export namespace ListAddmDbFindingCategoriesRequest {
  export enum SortBy {
    Name = "name"
  }
}
