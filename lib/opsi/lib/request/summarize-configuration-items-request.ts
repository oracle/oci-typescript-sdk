...
/**
 * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/opsi/SummarizeConfigurationItems.ts.html |here} to see how to use SummarizeConfigurationItemsRequest.
 */
...
export namespace SummarizeConfigurationItemsRequest {
