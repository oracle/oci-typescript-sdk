...
/**
 * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/opsi/SummarizeAddmDbRecommendations.ts.html |here} to see how to use SummarizeAddmDbRecommendationsRequest.
 */
...
export namespace SummarizeAddmDbRecommendationsRequest {
  export enum SortBy {
