...
/**
 * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/opsi/ListAwrDatabases.ts.html |here} to see how to use ListAwrDatabasesRequest.
 */
...
export namespace ListAwrDatabasesRequest {
  export enum SortBy {
