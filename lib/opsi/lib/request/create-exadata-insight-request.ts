...
/**
 * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/opsi/CreateExadataInsight.ts.html |here} to see how to use CreateExadataInsightRequest.
 */
