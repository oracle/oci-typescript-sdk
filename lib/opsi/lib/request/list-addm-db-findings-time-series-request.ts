...
/**
 * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/opsi/ListAddmDbFindingsTimeSeries.ts.html |here} to see how to use ListAddmDbFindingsTimeSeriesRequest.
 */
...
export namespace ListAddmDbFindingsTimeSeriesRequest {
  export enum SortBy {
    Timestamp = "timestamp"
  }
}
