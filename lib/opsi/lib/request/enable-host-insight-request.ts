...
/**
 * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/opsi/EnableHostInsight.ts.html |here} to see how to use EnableHostInsightRequest.
 */
export interface EnableHostInsightRequest extends common.BaseRequest {
  ...
  "enableHostInsightDetails":
    ...
    | model.EnableMacsManagedCloudHostInsightDetails
