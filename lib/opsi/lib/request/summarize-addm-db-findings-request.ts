...
/**
 * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/opsi/SummarizeAddmDbFindings.ts.html |here} to see how to use SummarizeAddmDbFindingsRequest.
 */
...
export namespace SummarizeAddmDbFindingsRequest {
  export enum SortBy {
