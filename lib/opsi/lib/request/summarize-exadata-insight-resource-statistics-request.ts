...
/**
 * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/opsi/SummarizeExadataInsightResourceStatistics.ts.html |here} to see how to use SummarizeExadataInsightResourceStatisticsRequest.
 */
...
export namespace SummarizeExadataInsightResourceStatisticsRequest {
  export enum SortBy {
