...
/**
 * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/opsi/ListAddmDbs.ts.html |here} to see how to use ListAddmDbsRequest.
 */
...
export namespace ListAddmDbsRequest {
  export enum SortBy {
