...
/**
 * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/opsi/ListAddmDbRecommendationCategories.ts.html |here} to see how to use ListAddmDbRecommendationCategoriesRequest.
 */
...
export namespace ListAddmDbRecommendationCategoriesRequest {
  export enum SortBy {
    Name = "name"
  }
}
