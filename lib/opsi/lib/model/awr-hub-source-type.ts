...
export namespace AwrHubSourceType {
  export function getJsonObj(obj: AwrHubSourceType): AwrHubSourceType {
    return obj;
  }
  export function getDeserializedJsonObj(obj: AwrHubSourceType): AwrHubSourceType {
    return obj;
  }
}
