    ...
    if (obj && "entitySource" in obj && obj.entitySource) {
      switch (obj.entitySource) {
        ...
        case "EXTERNAL_MYSQL_DATABASE_SYSTEM":
          return model.CreateExternalMysqlDatabaseInsightDetails.getJsonObj(
            <model.CreateExternalMysqlDatabaseInsightDetails>(<object>jsonObj),
            true
          );
        ...
        case "MACS_MANAGED_AUTONOMOUS_DATABASE":
          return model.CreateMacsManagedAutonomousDatabaseInsightDetails.getJsonObj(
            <model.CreateMacsManagedAutonomousDatabaseInsightDetails>(<object>jsonObj),
            true
          );
  ...
  export function getDeserializedJsonObj(obj: CreateDatabaseInsightDetails): object {
    ...
    if (obj && "entitySource" in obj && obj.entitySource) {
      switch (obj.entitySource) {
        ...
        case "EXTERNAL_MYSQL_DATABASE_SYSTEM":
          return model.CreateExternalMysqlDatabaseInsightDetails.getDeserializedJsonObj(
            <model.CreateExternalMysqlDatabaseInsightDetails>(<object>jsonObj),
            true
          );
        case "AUTONOMOUS_DATABASE":
