...
export namespace OpsiDataObjectsCollection {
  export function getJsonObj(obj: OpsiDataObjectsCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
  ...
  export function getDeserializedJsonObj(obj: OpsiDataObjectsCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
