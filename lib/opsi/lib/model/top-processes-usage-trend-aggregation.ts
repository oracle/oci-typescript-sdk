...
export namespace TopProcessesUsageTrendAggregation {
  export function getJsonObj(obj: TopProcessesUsageTrendAggregation): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: TopProcessesUsageTrendAggregation): object {
    const jsonObj = {
      ...obj,
      ...{
        "usageData": obj.usageData
