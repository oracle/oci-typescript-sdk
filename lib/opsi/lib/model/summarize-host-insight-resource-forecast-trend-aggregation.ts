...
export namespace SummarizeHostInsightResourceForecastTrendAggregation {
  ...
  export function getJsonObj(obj: SummarizeHostInsightResourceForecastTrendAggregation): object {
    const jsonObj = {
      ...obj,
      ...{
