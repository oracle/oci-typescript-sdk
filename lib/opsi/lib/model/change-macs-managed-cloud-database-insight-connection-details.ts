...
export namespace ChangeMacsManagedCloudDatabaseInsightConnectionDetails {
  export function getJsonObj(obj: ChangeMacsManagedCloudDatabaseInsightConnectionDetails): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(
    obj: ChangeMacsManagedCloudDatabaseInsightConnectionDetails
  ): object {
    const jsonObj = {
      ...obj,
      ...{
