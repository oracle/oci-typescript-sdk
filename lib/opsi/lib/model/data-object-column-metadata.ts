...
export namespace DataObjectColumnMetadata {
  ...
  export function getJsonObj(obj: DataObjectColumnMetadata): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: DataObjectColumnMetadata): object {
    const jsonObj = {
      ...obj,
      ...{
        "unitDetails": obj.unitDetails
