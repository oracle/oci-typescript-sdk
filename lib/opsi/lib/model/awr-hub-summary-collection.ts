...
export namespace AwrHubSummaryCollection {
  export function getJsonObj(obj: AwrHubSummaryCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
  ...
  export function getDeserializedJsonObj(obj: AwrHubSummaryCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
