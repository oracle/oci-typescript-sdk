 ...
 */
export interface UpdateMacsManagedCloudDatabaseInsightDetails
  extends model.UpdateDatabaseInsightDetails {
  "entitySource": string;
}

export namespace UpdateMacsManagedCloudDatabaseInsightDetails {
  export function getJsonObj(
    obj: UpdateMacsManagedCloudDatabaseInsightDetails,
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ...
        : (model.UpdateDatabaseInsightDetails.getJsonObj(
            obj
          ) as UpdateMacsManagedCloudDatabaseInsightDetails)),
      ...{}
    };
