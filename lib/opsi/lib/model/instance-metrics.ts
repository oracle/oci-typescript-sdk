...
export namespace InstanceMetrics {
  export function getJsonObj(obj: InstanceMetrics): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: InstanceMetrics): object {
    const jsonObj = { ...obj, ...{} };
