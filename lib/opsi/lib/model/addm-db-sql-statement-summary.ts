...
export namespace AddmDbSqlStatementSummary {
  export function getJsonObj(obj: AddmDbSqlStatementSummary): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: AddmDbSqlStatementSummary): object {
    const jsonObj = { ...obj, ...{} };
