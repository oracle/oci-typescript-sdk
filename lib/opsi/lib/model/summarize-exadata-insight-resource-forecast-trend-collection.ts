...
export namespace SummarizeExadataInsightResourceForecastTrendCollection {
  ...
  export function getJsonObj(obj: SummarizeExadataInsightResourceForecastTrendCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
  ...
  export function getDeserializedJsonObj(
    obj: SummarizeExadataInsightResourceForecastTrendCollection
  ): object {
    const jsonObj = {
      ...obj,
      ...{
