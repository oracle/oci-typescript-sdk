...
export namespace MdsMySqlDatabaseInsightSummary {
  export function getJsonObj(
    obj: MdsMySqlDatabaseInsightSummary,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.DatabaseInsightSummary.getJsonObj(obj) as MdsMySqlDatabaseInsightSummary)),
      ...{}
    };
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ...
        : (model.DatabaseInsightSummary.getDeserializedJsonObj(
            obj
          ) as MdsMySqlDatabaseInsightSummary)),
      ...{}
    };
