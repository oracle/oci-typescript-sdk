...
export namespace SqlStatisticsTimeSeriesAggregation {
  export function getJsonObj(obj: SqlStatisticsTimeSeriesAggregation): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: SqlStatisticsTimeSeriesAggregation): object {
    const jsonObj = {
      ...obj,
      ...{
        "databaseDetails": obj.databaseDetails
