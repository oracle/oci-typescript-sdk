...
export namespace MacsManagedCloudExadataInsight {
  export function getJsonObj(
    obj: MacsManagedCloudExadataInsight,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.ExadataInsight.getJsonObj(obj) as MacsManagedCloudExadataInsight)),
      ...{}
    };
  ...
  export function getDeserializedJsonObj(
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.ExadataInsight.getDeserializedJsonObj(obj) as MacsManagedCloudExadataInsight)),
      ...{}
    };
