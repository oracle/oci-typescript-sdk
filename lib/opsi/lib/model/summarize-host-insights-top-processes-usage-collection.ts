...
export namespace SummarizeHostInsightsTopProcessesUsageCollection {
  export function getJsonObj(obj: SummarizeHostInsightsTopProcessesUsageCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
  ...
  export function getDeserializedJsonObj(
    obj: SummarizeHostInsightsTopProcessesUsageCollection
  ): object {
    const jsonObj = {
      ...obj,
      ...{
