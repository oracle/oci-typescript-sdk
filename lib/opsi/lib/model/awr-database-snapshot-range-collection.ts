...
export namespace AwrDatabaseSnapshotRangeCollection {
  export function getJsonObj(
    obj: AwrDatabaseSnapshotRangeCollection,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.AwrQueryResult.getJsonObj(obj) as AwrDatabaseSnapshotRangeCollection)),
      ...{
        "items": obj.items
          ? obj.items.map(item => {
  ...
  export function getDeserializedJsonObj(
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.AwrQueryResult.getDeserializedJsonObj(obj) as AwrDatabaseSnapshotRangeCollection)),
      ...{
        "items": obj.items
          ? obj.items.map(item => {
