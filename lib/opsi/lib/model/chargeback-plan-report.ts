...
export namespace ChargebackPlanReport {
  ...
  export function getJsonObj(obj: ChargebackPlanReport): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: ChargebackPlanReport): object {
    const jsonObj = {
      ...obj,
      ...{
        "reportProperties": obj.reportProperties
