    ...
    if (obj && "entitySource" in obj && obj.entitySource) {
      switch (obj.entitySource) {
        ...
        case "MACS_MANAGED_CLOUD_DB_HOST":
          return model.MacsManagedCloudDatabaseHostInsightSummary.getJsonObj(
            <model.MacsManagedCloudDatabaseHostInsightSummary>(<object>jsonObj),
            true
          );
        ...
        case "PE_COMANAGED_HOST":
          return model.PeComanagedHostInsightSummary.getJsonObj(
            <model.PeComanagedHostInsightSummary>(<object>jsonObj),
            true
          );
  ...
  export function getDeserializedJsonObj(obj: HostInsightSummary): object {
    ...
    if (obj && "entitySource" in obj && obj.entitySource) {
      switch (obj.entitySource) {
        ...
        case "MACS_MANAGED_CLOUD_DB_HOST":
          return model.MacsManagedCloudDatabaseHostInsightSummary.getDeserializedJsonObj(
            <model.MacsManagedCloudDatabaseHostInsightSummary>(<object>jsonObj),
            true
          );
        case "EM_MANAGED_EXTERNAL_HOST":
        ...
        case "PE_COMANAGED_HOST":
          return model.PeComanagedHostInsightSummary.getDeserializedJsonObj(
            <model.PeComanagedHostInsightSummary>(<object>jsonObj),
            true
          );
        case "MACS_MANAGED_CLOUD_HOST":
