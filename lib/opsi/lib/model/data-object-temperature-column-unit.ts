...
export namespace DataObjectTemperatureColumnUnit {
  export enum Unit {
    Celsius = "CELSIUS",
  ...
  export function getJsonObj(
    obj: DataObjectTemperatureColumnUnit,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.DataObjectColumnUnit.getJsonObj(obj) as DataObjectTemperatureColumnUnit)),
      ...{}
    };

    return jsonObj;
  }
  export const unitCategory = "TEMPERATURE";
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ...
        : (model.DataObjectColumnUnit.getDeserializedJsonObj(
            obj
          ) as DataObjectTemperatureColumnUnit)),
      ...{}
    };
