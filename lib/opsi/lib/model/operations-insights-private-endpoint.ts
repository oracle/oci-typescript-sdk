...
export namespace OperationsInsightsPrivateEndpoint {
  export function getJsonObj(obj: OperationsInsightsPrivateEndpoint): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: OperationsInsightsPrivateEndpoint): object {
    const jsonObj = { ...obj, ...{} };
