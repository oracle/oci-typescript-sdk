...
export namespace StorageServerDetails {
  export function getJsonObj(obj: StorageServerDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: StorageServerDetails): object {
    const jsonObj = { ...obj, ...{} };
