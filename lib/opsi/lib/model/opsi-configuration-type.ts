 ...
 *
 **/
export enum OpsiConfigurationType {
...
export namespace OpsiConfigurationType {
  export function getJsonObj(obj: OpsiConfigurationType): OpsiConfigurationType {
    return obj;
  }
  export function getDeserializedJsonObj(obj: OpsiConfigurationType): OpsiConfigurationType {
    return obj;
  }
}
