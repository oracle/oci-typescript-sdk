...
export namespace ExadataExaccConfigurationSummary {
  export function getJsonObj(
    obj: ExadataExaccConfigurationSummary,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.ExadataConfigurationSummary.getJsonObj(obj) as ExadataExaccConfigurationSummary)),
      ...{}
    };
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ...
        : (model.ExadataConfigurationSummary.getDeserializedJsonObj(
            obj
          ) as ExadataExaccConfigurationSummary)),
      ...{}
    };
