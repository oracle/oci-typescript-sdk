...
export namespace ChangeExternalMysqlDatabaseInsightConnectionDetails {
  export function getJsonObj(obj: ChangeExternalMysqlDatabaseInsightConnectionDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(
    obj: ChangeExternalMysqlDatabaseInsightConnectionDetails
  ): object {
    const jsonObj = { ...obj, ...{} };
