...
export namespace MacsManagedCloudDatabaseHostInsight {
  ...
  export function getJsonObj(
    obj: MacsManagedCloudDatabaseHostInsight,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.HostInsight.getJsonObj(obj) as MacsManagedCloudDatabaseHostInsight)),
      ...{}
    };
  ...
  export function getDeserializedJsonObj(
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.HostInsight.getDeserializedJsonObj(obj) as MacsManagedCloudDatabaseHostInsight)),
      ...{}
    };
