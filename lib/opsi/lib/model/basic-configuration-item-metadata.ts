...
export interface BasicConfigurationItemMetadata extends model.ConfigurationItemMetadata {
  ...
  "valueInputDetails"?:
    | model.ConfigurationItemFreeTextAllowedValueDetails
    | model.ConfigurationItemPickAllowedValueDetails
    | model.ConfigurationItemLimitAllowedValueDetails;

  "configItemType": string;
}

export namespace BasicConfigurationItemMetadata {
  export function getJsonObj(
    obj: BasicConfigurationItemMetadata,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.ConfigurationItemMetadata.getJsonObj(obj) as BasicConfigurationItemMetadata)),
      ...{
  ...
  export function getDeserializedJsonObj(
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.ConfigurationItemMetadata.getDeserializedJsonObj(
            obj
          ) as BasicConfigurationItemMetadata)),
      ...{
        "unitDetails": obj.unitDetails
