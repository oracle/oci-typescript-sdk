...
export namespace AwrDatabaseCollection {
  export function getJsonObj(obj: AwrDatabaseCollection, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj ? obj : (model.AwrQueryResult.getJsonObj(obj) as AwrDatabaseCollection)),
      ...{
        "items": obj.items
          ? obj.items.map(item => {
  ...
  export function getDeserializedJsonObj(
    obj: AwrDatabaseCollection,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.AwrQueryResult.getDeserializedJsonObj(obj) as AwrDatabaseCollection)),
      ...{
        "items": obj.items
          ? obj.items.map(item => {
