    ...
    if (obj && "entitySource" in obj && obj.entitySource) {
      switch (obj.entitySource) {
        ...
        case "EXTERNAL_MYSQL_DATABASE_SYSTEM":
          return model.ExternalMysqlDatabaseInsight.getJsonObj(
            <model.ExternalMysqlDatabaseInsight>(<object>jsonObj),
            true
          );
        ...
        case "MDS_MYSQL_DATABASE_SYSTEM":
          return model.MdsMySqlDatabaseInsight.getJsonObj(
            <model.MdsMySqlDatabaseInsight>(<object>jsonObj),
            true
          );
        default:
  ...
  export function getDeserializedJsonObj(obj: DatabaseInsight): object {
    ...
    if (obj && "entitySource" in obj && obj.entitySource) {
      switch (obj.entitySource) {
        ...
        case "EXTERNAL_MYSQL_DATABASE_SYSTEM":
          return model.ExternalMysqlDatabaseInsight.getDeserializedJsonObj(
            <model.ExternalMysqlDatabaseInsight>(<object>jsonObj),
            true
          );
        case "AUTONOMOUS_DATABASE":
        ...
        case "MDS_MYSQL_DATABASE_SYSTEM":
          return model.MdsMySqlDatabaseInsight.getDeserializedJsonObj(
            <model.MdsMySqlDatabaseInsight>(<object>jsonObj),
            true
          );
        default:
