...
export namespace MacsManagedCloudDatabaseInsight {
  export function getJsonObj(
    obj: MacsManagedCloudDatabaseInsight,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.DatabaseInsight.getJsonObj(obj) as MacsManagedCloudDatabaseInsight)),
      ...{
  ...
  export function getDeserializedJsonObj(
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.DatabaseInsight.getDeserializedJsonObj(obj) as MacsManagedCloudDatabaseInsight)),
      ...{
        "connectionDetails": obj.connectionDetails
