...
export namespace PeComanagedHostInsight {
  ...
  export function getJsonObj(obj: PeComanagedHostInsight, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj ? obj : (model.HostInsight.getJsonObj(obj) as PeComanagedHostInsight)),
      ...{}
    };
  ...
  export function getDeserializedJsonObj(
    obj: PeComanagedHostInsight,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.HostInsight.getDeserializedJsonObj(obj) as PeComanagedHostInsight)),
      ...{}
    };
