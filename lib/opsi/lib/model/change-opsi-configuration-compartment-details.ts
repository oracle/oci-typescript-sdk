...
export namespace ChangeOpsiConfigurationCompartmentDetails {
  export function getJsonObj(obj: ChangeOpsiConfigurationCompartmentDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: ChangeOpsiConfigurationCompartmentDetails): object {
    const jsonObj = { ...obj, ...{} };
