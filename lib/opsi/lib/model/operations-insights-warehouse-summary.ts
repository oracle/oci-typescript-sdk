...
export namespace OperationsInsightsWarehouseSummary {
  export function getJsonObj(obj: OperationsInsightsWarehouseSummary): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: OperationsInsightsWarehouseSummary): object {
    const jsonObj = { ...obj, ...{} };
