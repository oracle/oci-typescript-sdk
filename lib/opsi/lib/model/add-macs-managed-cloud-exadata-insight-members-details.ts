 ...
 */
export interface AddMacsManagedCloudExadataInsightMembersDetails
...
export namespace AddMacsManagedCloudExadataInsightMembersDetails {
  export function getJsonObj(
    obj: AddMacsManagedCloudExadataInsightMembersDetails,
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ...
        : (model.AddExadataInsightMembersDetails.getJsonObj(
            obj
          ) as AddMacsManagedCloudExadataInsightMembersDetails)),
      ...{
