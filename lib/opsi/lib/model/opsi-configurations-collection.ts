...
export namespace OpsiConfigurationsCollection {
  export function getJsonObj(obj: OpsiConfigurationsCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
  ...
  export function getDeserializedJsonObj(obj: OpsiConfigurationsCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
