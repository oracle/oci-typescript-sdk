...
export namespace ExadataConfigurationCollection {
  export function getJsonObj(obj: ExadataConfigurationCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
  ...
  export function getDeserializedJsonObj(obj: ExadataConfigurationCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
