...
export namespace MacsManagedAutonomousDatabaseInsightSummary {
  export function getJsonObj(
    obj: MacsManagedAutonomousDatabaseInsightSummary,
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ...
        : (model.DatabaseInsightSummary.getJsonObj(
            obj
          ) as MacsManagedAutonomousDatabaseInsightSummary)),
      ...{}
    };
