...
export namespace AwrDatabaseMetricCollection {
  export function getJsonObj(obj: AwrDatabaseMetricCollection, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.AwrQueryResult.getJsonObj(obj) as AwrDatabaseMetricCollection)),
      ...{
        "items": obj.items
          ? obj.items.map(item => {
  ...
  export function getDeserializedJsonObj(
    obj: AwrDatabaseMetricCollection,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.AwrQueryResult.getDeserializedJsonObj(obj) as AwrDatabaseMetricCollection)),
      ...{
        "items": obj.items
          ? obj.items.map(item => {
