...
export namespace TopProcessesUsageTrend {
  export function getJsonObj(obj: TopProcessesUsageTrend): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: TopProcessesUsageTrend): object {
    const jsonObj = { ...obj, ...{} };
