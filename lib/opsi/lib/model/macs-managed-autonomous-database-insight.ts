...
export namespace MacsManagedAutonomousDatabaseInsight {
  export function getJsonObj(
    obj: MacsManagedAutonomousDatabaseInsight,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.DatabaseInsight.getJsonObj(obj) as MacsManagedAutonomousDatabaseInsight)),
      ...{
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ...
        : (model.DatabaseInsight.getDeserializedJsonObj(
            obj
          ) as MacsManagedAutonomousDatabaseInsight)),
      ...{
        "connectionDetails": obj.connectionDetails
