 ...
 */
export interface ExadataDatabaseStatisticsSummary
...
export namespace ExadataDatabaseStatisticsSummary {
  export function getJsonObj(
    obj: ExadataDatabaseStatisticsSummary,
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ...
        : (model.ExadataInsightResourceStatisticsAggregation.getJsonObj(
            obj
          ) as ExadataDatabaseStatisticsSummary)),
      ...{
  ...
  export const exadataResourceType = "DATABASE";
