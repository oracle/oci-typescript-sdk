...
export namespace MacsManagedExternalHostInsightSummary {
  ...
  export function getJsonObj(
    obj: MacsManagedExternalHostInsightSummary,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.HostInsightSummary.getJsonObj(obj) as MacsManagedExternalHostInsightSummary)),
      ...{}
    };
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ...
        : (model.HostInsightSummary.getDeserializedJsonObj(
            obj
          ) as MacsManagedExternalHostInsightSummary)),
      ...{}
    };
