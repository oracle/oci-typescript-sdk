...
export namespace DpEndpoint {
  export function getJsonObj(obj: DpEndpoint): object {
    const jsonObj = {
      ...obj,
      ...{
    ...
    if (obj && "modelType" in obj && obj.modelType) {
      switch (obj.modelType) {
        case "PRIVATE_END_POINT":
          return model.DpEndpointFromPrivate.getJsonObj(
            <model.DpEndpointFromPrivate>(<object>jsonObj),
            true
          );
        case "PUBLIC_END_POINT":
          return model.DpEndpointFromPublic.getJsonObj(
            <model.DpEndpointFromPublic>(<object>jsonObj),
            true
          );
        default:
  ...
  export function getDeserializedJsonObj(obj: DpEndpoint): object {
    const jsonObj = {
      ...obj,
      ...{
    ...
    if (obj && "modelType" in obj && obj.modelType) {
      switch (obj.modelType) {
        case "PRIVATE_END_POINT":
          return model.DpEndpointFromPrivate.getDeserializedJsonObj(
            <model.DpEndpointFromPrivate>(<object>jsonObj),
            true
          );
        case "PUBLIC_END_POINT":
          return model.DpEndpointFromPublic.getDeserializedJsonObj(
            <model.DpEndpointFromPublic>(<object>jsonObj),
            true
          );
        default:
