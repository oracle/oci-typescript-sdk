 ...
 */
export interface DpEndpointDetails {
  /**
...
export namespace DpEndpointDetails {
  export function getJsonObj(obj: DpEndpointDetails): object {
    const jsonObj = {
      ...obj,
      ...{
    ...
    if (obj && "modelType" in obj && obj.modelType) {
      switch (obj.modelType) {
        case "PRIVATE_END_POINT":
          return model.DpEndpointFromPrivateDetails.getJsonObj(
            <model.DpEndpointFromPrivateDetails>(<object>jsonObj),
            true
          );
        case "PUBLIC_END_POINT":
          return model.DpEndpointFromPublicDetails.getJsonObj(
            <model.DpEndpointFromPublicDetails>(<object>jsonObj),
            true
          );
        default:
  ...
  export function getDeserializedJsonObj(obj: DpEndpointDetails): object {
    const jsonObj = {
      ...obj,
      ...{
    ...
    if (obj && "modelType" in obj && obj.modelType) {
      switch (obj.modelType) {
        case "PRIVATE_END_POINT":
          return model.DpEndpointFromPrivateDetails.getDeserializedJsonObj(
            <model.DpEndpointFromPrivateDetails>(<object>jsonObj),
            true
          );
        case "PUBLIC_END_POINT":
          return model.DpEndpointFromPublicDetails.getDeserializedJsonObj(
            <model.DpEndpointFromPublicDetails>(<object>jsonObj),
            true
          );
        default:
