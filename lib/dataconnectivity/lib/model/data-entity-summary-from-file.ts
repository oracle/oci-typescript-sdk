...
export namespace DataEntitySummaryFromFile {
  ...
  export function getJsonObj(obj: DataEntitySummaryFromFile, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.DataEntitySummary.getJsonObj(obj) as DataEntitySummaryFromFile)),
      ...{
