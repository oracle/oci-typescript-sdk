 ...
 */
export interface CreateDataProfileDetails {
...
export namespace CreateDataProfileDetails {
  export function getJsonObj(obj: CreateDataProfileDetails): object {
    const jsonObj = {
      ...obj,
      ...{
        ...
        "profileConfig": obj.profileConfig
          ? model.ProfileConfig.getJsonObj(obj.profileConfig)
          : undefined
      }
    };
  ...
  export function getDeserializedJsonObj(obj: CreateDataProfileDetails): object {
    const jsonObj = {
      ...obj,
      ...{
        "readOperationConfig": obj.readOperationConfig
        ...
        "dataEntity": obj.dataEntity
          ...
          : undefined,
        "profileConfig": obj.profileConfig
          ? model.ProfileConfig.getDeserializedJsonObj(obj.profileConfig)
          : undefined
      }
    };
