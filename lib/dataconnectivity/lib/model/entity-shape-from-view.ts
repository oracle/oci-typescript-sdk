 ...
 */
export interface EntityShapeFromView extends model.EntityShape {
  /**
   * The object key.
   */
  "key"?: string;
   ...
   * The entity type.
   */
  "entityType"?: EntityShapeFromView.EntityType;
  /**
...
export namespace EntityShapeFromView {
  ...
  export function getJsonObj(obj: EntityShapeFromView, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj ? obj : (model.EntityShape.getJsonObj(obj) as EntityShapeFromView)),
      ...{
  ...
  export const modelType = "VIEW_ENTITY";
  export function getDeserializedJsonObj(
    obj: EntityShapeFromView,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.EntityShape.getDeserializedJsonObj(obj) as EntityShapeFromView)),
      ...{
