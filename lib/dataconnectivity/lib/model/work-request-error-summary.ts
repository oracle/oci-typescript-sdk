...
export namespace WorkRequestErrorSummary {
  export function getJsonObj(obj: WorkRequestErrorSummary): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: WorkRequestErrorSummary): object {
    const jsonObj = { ...obj, ...{} };
