...
export interface ReferenceArtifactSummary {
  ...
  /**
   * count of how many times a dcms artifact has been registered by a service. Note: Numbers greater than Number.MAX_SAFE_INTEGER will result in rounding issues.
   */
