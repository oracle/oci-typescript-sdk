 ...
 */
export interface DeReferenceInfo {
  /**
...
export namespace DeReferenceInfo {
  export function getJsonObj(obj: DeReferenceInfo): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: DeReferenceInfo): object {
    const jsonObj = {
      ...obj,
      ...{
        "registryMetadata": obj.registryMetadata
