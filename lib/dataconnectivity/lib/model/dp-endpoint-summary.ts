 ...
 */
export interface DpEndpointSummary {
  /**
...
export namespace DpEndpointSummary {
  export function getJsonObj(obj: DpEndpointSummary): object {
    const jsonObj = {
      ...obj,
      ...{
    ...
    if (obj && "modelType" in obj && obj.modelType) {
      switch (obj.modelType) {
        case "PUBLIC_END_POINT":
          return model.DpEndpointSummaryFromPublic.getJsonObj(
            <model.DpEndpointSummaryFromPublic>(<object>jsonObj),
            true
          );
        case "PRIVATE_END_POINT":
          return model.DpEndpointSummaryFromPrivate.getJsonObj(
            <model.DpEndpointSummaryFromPrivate>(<object>jsonObj),
            true
          );
        default:
  ...
  export function getDeserializedJsonObj(obj: DpEndpointSummary): object {
    const jsonObj = {
      ...obj,
      ...{
    ...
    if (obj && "modelType" in obj && obj.modelType) {
      switch (obj.modelType) {
        case "PUBLIC_END_POINT":
          return model.DpEndpointSummaryFromPublic.getDeserializedJsonObj(
            <model.DpEndpointSummaryFromPublic>(<object>jsonObj),
            true
          );
        case "PRIVATE_END_POINT":
          return model.DpEndpointSummaryFromPrivate.getDeserializedJsonObj(
            <model.DpEndpointSummaryFromPrivate>(<object>jsonObj),
            true
          );
        default:
