...
export namespace CreateDpEndpointDetails {
  export function getJsonObj(obj: CreateDpEndpointDetails): object {
    const jsonObj = {
      ...obj,
      ...{
      ...
      switch (obj.modelType) {
        case "PUBLIC_END_POINT":
          return model.CreateDpEndpointFromPublic.getJsonObj(
            <model.CreateDpEndpointFromPublic>(<object>jsonObj),
            true
          );
        case "PRIVATE_END_POINT":
          return model.CreateDpEndpointFromPrivate.getJsonObj(
            <model.CreateDpEndpointFromPrivate>(<object>jsonObj),
            true
          );
        default:
  ...
  export function getDeserializedJsonObj(obj: CreateDpEndpointDetails): object {
    const jsonObj = {
      ...obj,
      ...{
    ...
    if (obj && "modelType" in obj && obj.modelType) {
      switch (obj.modelType) {
        ...
        case "PRIVATE_END_POINT":
          return model.CreateDpEndpointFromPrivate.getDeserializedJsonObj(
            <model.CreateDpEndpointFromPrivate>(<object>jsonObj),
            true
          );
        default:
