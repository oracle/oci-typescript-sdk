...
export namespace ExecuteOperationJobDetails {
  export enum Status {
    Failed = "FAILED",
    Success = "SUCCESS",
    /**
  ...
  export function getJsonObj(obj: ExecuteOperationJobDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: ExecuteOperationJobDetails): object {
    const jsonObj = { ...obj, ...{} };
