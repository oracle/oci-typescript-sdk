...
/**
 * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/dataconnectivity/CreateRegistry.ts.html |here} to see how to use CreateRegistryRequest.
 */
export interface CreateRegistryRequest extends common.BaseRequest {
  /**
