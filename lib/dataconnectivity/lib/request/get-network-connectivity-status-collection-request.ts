...
/**
 * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/dataconnectivity/GetNetworkConnectivityStatusCollection.ts.html |here} to see how to use GetNetworkConnectivityStatusCollectionRequest.
 */
...
export namespace GetNetworkConnectivityStatusCollectionRequest {
  export enum SortBy {
    Id = "id",
