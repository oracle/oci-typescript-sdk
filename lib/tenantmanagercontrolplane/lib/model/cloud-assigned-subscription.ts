...
export namespace CloudAssignedSubscription {
  export function getJsonObj(obj: CloudAssignedSubscription, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.AssignedSubscription.getJsonObj(obj) as CloudAssignedSubscription)),
      ...{}
    };
  ...
  export function getDeserializedJsonObj(
    obj: CloudAssignedSubscription,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.AssignedSubscription.getDeserializedJsonObj(obj) as CloudAssignedSubscription)),
      ...{}
    };
