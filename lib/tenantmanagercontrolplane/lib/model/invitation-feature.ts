...
export namespace InvitationFeature {
  export function getJsonObj(obj: InvitationFeature): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: InvitationFeature): object {
    const jsonObj = { ...obj, ...{} };
