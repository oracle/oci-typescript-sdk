...
export namespace InvitationSubject {
  export function getJsonObj(obj: InvitationSubject): InvitationSubject {
    return obj;
  }
  export function getDeserializedJsonObj(obj: InvitationSubject): InvitationSubject {
    return obj;
  }
}
