...
export namespace OrganizationTenancyCollection {
  export function getJsonObj(obj: OrganizationTenancyCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
  ...
  export function getDeserializedJsonObj(obj: OrganizationTenancyCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
