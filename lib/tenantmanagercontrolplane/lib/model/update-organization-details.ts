...
export namespace UpdateOrganizationDetails {
  export function getJsonObj(obj: UpdateOrganizationDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: UpdateOrganizationDetails): object {
    const jsonObj = { ...obj, ...{} };
