...
export namespace CreateDatabaseToolsRelatedResourcePostgresqlDetails {
  export function getJsonObj(obj: CreateDatabaseToolsRelatedResourcePostgresqlDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(
    obj: CreateDatabaseToolsRelatedResourcePostgresqlDetails
  ): object {
    const jsonObj = { ...obj, ...{} };
