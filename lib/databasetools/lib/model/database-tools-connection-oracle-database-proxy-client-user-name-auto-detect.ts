 ...
 */
export interface DatabaseToolsConnectionOracleDatabaseProxyClientUserNameAutoDetect
...
export namespace DatabaseToolsConnectionOracleDatabaseProxyClientUserNameAutoDetect {
  export function getJsonObj(
    obj: DatabaseToolsConnectionOracleDatabaseProxyClientUserNameAutoDetect,
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ...
        : (model.DatabaseToolsConnectionOracleDatabaseProxyClient.getJsonObj(
            obj
          ) as DatabaseToolsConnectionOracleDatabaseProxyClientUserNameAutoDetect)),
      ...{}
    };
