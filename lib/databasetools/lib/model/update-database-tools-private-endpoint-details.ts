...
export namespace UpdateDatabaseToolsPrivateEndpointDetails {
  export function getJsonObj(obj: UpdateDatabaseToolsPrivateEndpointDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: UpdateDatabaseToolsPrivateEndpointDetails): object {
    const jsonObj = { ...obj, ...{} };
