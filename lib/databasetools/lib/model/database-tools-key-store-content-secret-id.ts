...
export namespace DatabaseToolsKeyStoreContentSecretId {
  export function getJsonObj(
    obj: DatabaseToolsKeyStoreContentSecretId,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.DatabaseToolsKeyStoreContent.getJsonObj(
            obj
          ) as DatabaseToolsKeyStoreContentSecretId)),
      ...{}
    };
  ...
  export function getDeserializedJsonObj(
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.DatabaseToolsKeyStoreContent.getDeserializedJsonObj(
            obj
          ) as DatabaseToolsKeyStoreContentSecretId)),
      ...{}
    };
