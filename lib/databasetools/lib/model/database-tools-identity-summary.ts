...
export namespace DatabaseToolsIdentitySummary {
  export function getJsonObj(obj: DatabaseToolsIdentitySummary): object {
    const jsonObj = {
      ...obj,
      ...{
        "locks": obj.locks
    ...
    if (obj && "type" in obj && obj.type) {
      switch (obj.type) {
        case "ORACLE_DATABASE_RESOURCE_PRINCIPAL":
          return model.DatabaseToolsIdentityOracleDatabaseResourcePrincipalSummary.getJsonObj(
            <model.DatabaseToolsIdentityOracleDatabaseResourcePrincipalSummary>(<object>jsonObj),
            true
          );
        default:
  ...
  export function getDeserializedJsonObj(obj: DatabaseToolsIdentitySummary): object {
    const jsonObj = {
      ...obj,
      ...{
        "locks": obj.locks
    ...
    if (obj && "type" in obj && obj.type) {
      switch (obj.type) {
        case "ORACLE_DATABASE_RESOURCE_PRINCIPAL":
          return model.DatabaseToolsIdentityOracleDatabaseResourcePrincipalSummary.getDeserializedJsonObj(
            <model.DatabaseToolsIdentityOracleDatabaseResourcePrincipalSummary>(<object>jsonObj),
            true
          );
        default:
