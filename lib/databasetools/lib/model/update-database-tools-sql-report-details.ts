 ...
 */
export interface UpdateDatabaseToolsSqlReportDetails {
  /**
...
export namespace UpdateDatabaseToolsSqlReportDetails {
  export function getJsonObj(obj: UpdateDatabaseToolsSqlReportDetails): object {
    const jsonObj = {
      ...obj,
      ...{
    ...
    if (obj && "type" in obj && obj.type) {
      switch (obj.type) {
        case "ORACLE_DATABASE":
          return model.UpdateDatabaseToolsSqlReportDetailsOracleDatabase.getJsonObj(
            <model.UpdateDatabaseToolsSqlReportDetailsOracleDatabase>(<object>jsonObj),
            true
          );
        default:
  ...
  export function getDeserializedJsonObj(obj: UpdateDatabaseToolsSqlReportDetails): object {
    const jsonObj = {
      ...obj,
      ...{
        "variables": obj.variables
    ...
    if (obj && "type" in obj && obj.type) {
      switch (obj.type) {
        case "ORACLE_DATABASE":
          return model.UpdateDatabaseToolsSqlReportDetailsOracleDatabase.getDeserializedJsonObj(
            <model.UpdateDatabaseToolsSqlReportDetailsOracleDatabase>(<object>jsonObj),
            true
          );
        default:
