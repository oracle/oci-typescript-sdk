 ...
 */
export interface DatabaseToolsConnectionOracleDatabaseProxyClientUserNameAutoDetectDetails
...
export namespace DatabaseToolsConnectionOracleDatabaseProxyClientUserNameAutoDetectDetails {
  export function getJsonObj(
    obj: DatabaseToolsConnectionOracleDatabaseProxyClientUserNameAutoDetectDetails,
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ...
        : (model.DatabaseToolsConnectionOracleDatabaseProxyClientDetails.getJsonObj(
            obj
          ) as DatabaseToolsConnectionOracleDatabaseProxyClientUserNameAutoDetectDetails)),
      ...{}
    };

    return jsonObj;
  }
  export const proxyAuthenticationType = "USER_NAME_AUTO_DETECT";
