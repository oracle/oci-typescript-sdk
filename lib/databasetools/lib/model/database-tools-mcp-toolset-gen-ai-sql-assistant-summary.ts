 ...
 */
export interface DatabaseToolsMcpToolsetGenAiSqlAssistantSummary
...
export namespace DatabaseToolsMcpToolsetGenAiSqlAssistantSummary {
  export function getJsonObj(
    obj: DatabaseToolsMcpToolsetGenAiSqlAssistantSummary,
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ...
        : (model.DatabaseToolsMcpToolsetSummary.getJsonObj(
            obj
          ) as DatabaseToolsMcpToolsetGenAiSqlAssistantSummary)),
      ...{
        "tools": obj.tools
          ? obj.tools.map(item => {
