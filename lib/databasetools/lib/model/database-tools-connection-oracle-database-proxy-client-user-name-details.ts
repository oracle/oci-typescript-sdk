 ...
 */
export interface DatabaseToolsConnectionOracleDatabaseProxyClientUserNameDetails
...
export namespace DatabaseToolsConnectionOracleDatabaseProxyClientUserNameDetails {
  export function getJsonObj(
    obj: DatabaseToolsConnectionOracleDatabaseProxyClientUserNameDetails,
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ...
        : (model.DatabaseToolsConnectionOracleDatabaseProxyClientDetails.getJsonObj(
            obj
          ) as DatabaseToolsConnectionOracleDatabaseProxyClientUserNameDetails)),
      ...{
