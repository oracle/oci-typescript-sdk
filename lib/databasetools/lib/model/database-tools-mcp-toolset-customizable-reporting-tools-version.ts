 ...
 */
export interface DatabaseToolsMcpToolsetCustomizableReportingToolsVersion {
  /**
   ...
   */
  "defaultReportAllowedRoles": Array<string>;
  /**
...
export namespace DatabaseToolsMcpToolsetCustomizableReportingToolsVersion {
  export function getJsonObj(
    obj: DatabaseToolsMcpToolsetCustomizableReportingToolsVersion
  ): object {
    const jsonObj = {
      ...obj,
      ...{
