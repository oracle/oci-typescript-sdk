...
export namespace ChangeDatabaseToolsPrivateEndpointCompartmentDetails {
  export function getJsonObj(obj: ChangeDatabaseToolsPrivateEndpointCompartmentDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(
    obj: ChangeDatabaseToolsPrivateEndpointCompartmentDetails
  ): object {
    const jsonObj = { ...obj, ...{} };
