...
export namespace DatabaseToolsPrivateEndpoint {
  export function getJsonObj(obj: DatabaseToolsPrivateEndpoint): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: DatabaseToolsPrivateEndpoint): object {
    const jsonObj = {
      ...obj,
      ...{
        "reverseConnectionConfiguration": obj.reverseConnectionConfiguration
