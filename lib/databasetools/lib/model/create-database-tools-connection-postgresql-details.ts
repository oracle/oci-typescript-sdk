 ...
 */
export interface CreateDatabaseToolsConnectionPostgresqlDetails
...
export namespace CreateDatabaseToolsConnectionPostgresqlDetails {
  export function getJsonObj(
    obj: CreateDatabaseToolsConnectionPostgresqlDetails,
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ...
        : (model.CreateDatabaseToolsConnectionDetails.getJsonObj(
            obj
          ) as CreateDatabaseToolsConnectionPostgresqlDetails)),
      ...{
        "relatedResource": obj.relatedResource
          ? model.CreateDatabaseToolsRelatedResourcePostgresqlDetails.getJsonObj(
              obj.relatedResource
            )
          : undefined,
  ...
  export function getDeserializedJsonObj(
    ...
    const jsonObj = {
      ...
      ...{
        "relatedResource": obj.relatedResource
          ? model.CreateDatabaseToolsRelatedResourcePostgresqlDetails.getDeserializedJsonObj(
              obj.relatedResource
            )
          : undefined,
