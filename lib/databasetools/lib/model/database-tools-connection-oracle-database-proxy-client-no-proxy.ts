 ...
 */
export interface DatabaseToolsConnectionOracleDatabaseProxyClientNoProxy
  extends model.DatabaseToolsConnectionOracleDatabaseProxyClient {
  "proxyAuthenticationType": string;
}

export namespace DatabaseToolsConnectionOracleDatabaseProxyClientNoProxy {
  export function getJsonObj(
    obj: DatabaseToolsConnectionOracleDatabaseProxyClientNoProxy,
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ...
        : (model.DatabaseToolsConnectionOracleDatabaseProxyClient.getJsonObj(
            obj
          ) as DatabaseToolsConnectionOracleDatabaseProxyClientNoProxy)),
      ...{}
    };
