...
export namespace RelatedResourceEntityType {
  export function getJsonObj(obj: RelatedResourceEntityType): RelatedResourceEntityType {
    return obj;
  }
  export function getDeserializedJsonObj(
    obj: RelatedResourceEntityType
