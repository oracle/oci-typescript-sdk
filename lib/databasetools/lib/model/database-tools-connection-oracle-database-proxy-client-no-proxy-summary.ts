 ...
 */
export interface DatabaseToolsConnectionOracleDatabaseProxyClientNoProxySummary
  extends model.DatabaseToolsConnectionOracleDatabaseProxyClientSummary {
  "proxyAuthenticationType": string;
}

export namespace DatabaseToolsConnectionOracleDatabaseProxyClientNoProxySummary {
  export function getJsonObj(
    obj: DatabaseToolsConnectionOracleDatabaseProxyClientNoProxySummary,
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ...
        : (model.DatabaseToolsConnectionOracleDatabaseProxyClientSummary.getJsonObj(
            obj
          ) as DatabaseToolsConnectionOracleDatabaseProxyClientNoProxySummary)),
      ...{}
    };
