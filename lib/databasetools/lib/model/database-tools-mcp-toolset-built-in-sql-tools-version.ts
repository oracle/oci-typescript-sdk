...
export namespace DatabaseToolsMcpToolsetBuiltInSqlToolsVersion {
  export function getJsonObj(obj: DatabaseToolsMcpToolsetBuiltInSqlToolsVersion): object {
    const jsonObj = {
      ...obj,
      ...{
        "tools": obj.tools
  ...
  export function getDeserializedJsonObj(
    obj: DatabaseToolsMcpToolsetBuiltInSqlToolsVersion
  ): object {
    const jsonObj = {
      ...obj,
      ...{
