 ...
 */
export interface DatabaseToolsConnectionOracleDatabaseProxyClientUserNameAutoDetectSummary
...
export namespace DatabaseToolsConnectionOracleDatabaseProxyClientUserNameAutoDetectSummary {
  export function getJsonObj(
    obj: DatabaseToolsConnectionOracleDatabaseProxyClientUserNameAutoDetectSummary,
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ...
        : (model.DatabaseToolsConnectionOracleDatabaseProxyClientSummary.getJsonObj(
            obj
          ) as DatabaseToolsConnectionOracleDatabaseProxyClientUserNameAutoDetectSummary)),
      ...{}
    };
