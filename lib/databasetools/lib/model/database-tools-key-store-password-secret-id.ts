...
export namespace DatabaseToolsKeyStorePasswordSecretId {
  export function getJsonObj(
    obj: DatabaseToolsKeyStorePasswordSecretId,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.DatabaseToolsKeyStorePassword.getJsonObj(
            obj
          ) as DatabaseToolsKeyStorePasswordSecretId)),
      ...{}
    };
  ...
  export function getDeserializedJsonObj(
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.DatabaseToolsKeyStorePassword.getDeserializedJsonObj(
            obj
          ) as DatabaseToolsKeyStorePasswordSecretId)),
      ...{}
    };
