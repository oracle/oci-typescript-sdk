 ...
 */
export interface DatabaseToolsDatabaseApiGatewayConfigSummary {
  /**
...
export namespace DatabaseToolsDatabaseApiGatewayConfigSummary {
  export function getJsonObj(obj: DatabaseToolsDatabaseApiGatewayConfigSummary): object {
    const jsonObj = {
      ...obj,
      ...{
        "locks": obj.locks
    ...
    if (obj && "type" in obj && obj.type) {
      switch (obj.type) {
        case "DEFAULT":
          return model.DatabaseToolsDatabaseApiGatewayConfigDefaultSummary.getJsonObj(
            <model.DatabaseToolsDatabaseApiGatewayConfigDefaultSummary>(<object>jsonObj),
            true
          );
        default:
  ...
  export function getDeserializedJsonObj(
    obj: DatabaseToolsDatabaseApiGatewayConfigSummary
  ): object {
    const jsonObj = {
      ...obj,
      ...{
    ...
    if (obj && "type" in obj && obj.type) {
      switch (obj.type) {
        case "DEFAULT":
          return model.DatabaseToolsDatabaseApiGatewayConfigDefaultSummary.getDeserializedJsonObj(
            <model.DatabaseToolsDatabaseApiGatewayConfigDefaultSummary>(<object>jsonObj),
            true
          );
        default:
