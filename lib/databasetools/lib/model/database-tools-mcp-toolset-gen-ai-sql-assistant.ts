 ...
 */
export interface DatabaseToolsMcpToolsetGenAiSqlAssistant extends model.DatabaseToolsMcpToolset {
  /**
...
export namespace DatabaseToolsMcpToolsetGenAiSqlAssistant {
  export function getJsonObj(
    obj: DatabaseToolsMcpToolsetGenAiSqlAssistant,
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ...
        : (model.DatabaseToolsMcpToolset.getJsonObj(
            obj
          ) as DatabaseToolsMcpToolsetGenAiSqlAssistant)),
      ...{
        "tools": obj.tools
          ? obj.tools.map(item => {
