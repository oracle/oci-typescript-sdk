...
export namespace DatabaseToolsEndpointService {
  export function getJsonObj(obj: DatabaseToolsEndpointService): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: DatabaseToolsEndpointService): object {
    const jsonObj = { ...obj, ...{} };
