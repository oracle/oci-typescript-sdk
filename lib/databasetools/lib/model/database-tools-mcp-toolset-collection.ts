...
export namespace DatabaseToolsMcpToolsetCollection {
  export function getJsonObj(obj: DatabaseToolsMcpToolsetCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
  ...
  export function getDeserializedJsonObj(obj: DatabaseToolsMcpToolsetCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
