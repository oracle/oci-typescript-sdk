...
export namespace CreateDatabaseToolsRelatedResourceMySqlDetails {
  export function getJsonObj(obj: CreateDatabaseToolsRelatedResourceMySqlDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(
    obj: CreateDatabaseToolsRelatedResourceMySqlDetails
  ): object {
    const jsonObj = { ...obj, ...{} };
