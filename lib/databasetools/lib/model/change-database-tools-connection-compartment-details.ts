...
export namespace ChangeDatabaseToolsConnectionCompartmentDetails {
  export function getJsonObj(obj: ChangeDatabaseToolsConnectionCompartmentDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(
    obj: ChangeDatabaseToolsConnectionCompartmentDetails
  ): object {
    const jsonObj = { ...obj, ...{} };
