...
/**
 * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/applicationmigration/DeleteSource.ts.html |here} to see how to use DeleteSourceRequest.
 */
