...
/**
 * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/applicationmigration/UpdateSource.ts.html |here} to see how to use UpdateSourceRequest.
 */
export interface UpdateSourceRequest extends common.BaseRequest {
   ...
   *
   */
  "updateSourceDetails": model.UpdateSourceDetails;
  /**
