 ...
 *
 */
export interface PcsDiscoveryDetails extends model.DiscoveryDetails {
  /**
...
export namespace PcsDiscoveryDetails {
  export function getJsonObj(obj: PcsDiscoveryDetails, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj ? obj : (model.DiscoveryDetails.getJsonObj(obj) as PcsDiscoveryDetails)),
      ...{}
    };
