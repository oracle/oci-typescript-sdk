 ...
 *
 */
export interface InternalSourceDetails extends model.SourceDetails {
  /**
...
export namespace InternalSourceDetails {
  export function getJsonObj(obj: InternalSourceDetails, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj ? obj : (model.SourceDetails.getJsonObj(obj) as InternalSourceDetails)),
      ...{}
    };
