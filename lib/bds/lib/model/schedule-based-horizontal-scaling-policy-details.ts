...
export namespace ScheduleBasedHorizontalScalingPolicyDetails {
  export function getJsonObj(
    obj: ScheduleBasedHorizontalScalingPolicyDetails,
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ...
        : (model.AutoScalePolicyDetails.getJsonObj(
            obj
          ) as ScheduleBasedHorizontalScalingPolicyDetails)),
      ...{
