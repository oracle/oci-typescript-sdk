...
export namespace SoftwareUpdateSummary {
  export function getJsonObj(obj: SoftwareUpdateSummary): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: SoftwareUpdateSummary): object {
    const jsonObj = { ...obj, ...{} };
