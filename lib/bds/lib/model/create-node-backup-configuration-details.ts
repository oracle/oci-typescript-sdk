...
export namespace CreateNodeBackupConfigurationDetails {
  export function getJsonObj(obj: CreateNodeBackupConfigurationDetails): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: CreateNodeBackupConfigurationDetails): object {
    const jsonObj = {
      ...obj,
      ...{
        "levelTypeDetails": obj.levelTypeDetails
