...
export namespace UpdateResourcePrincipalConfigurationDetails {
  export function getJsonObj(obj: UpdateResourcePrincipalConfigurationDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: UpdateResourcePrincipalConfigurationDetails): object {
    const jsonObj = { ...obj, ...{} };
