 ...
 */
export interface BdsCapacityReservationConfigurationSummary {
  /**
...
export namespace BdsCapacityReservationConfigurationSummary {
  export function getJsonObj(obj: BdsCapacityReservationConfigurationSummary): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: BdsCapacityReservationConfigurationSummary): object {
    const jsonObj = { ...obj, ...{} };
