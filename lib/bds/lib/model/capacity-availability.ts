...
export namespace CapacityAvailability {
  export function getJsonObj(obj: CapacityAvailability): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: CapacityAvailability): object {
    const jsonObj = { ...obj, ...{} };
