...
export namespace SingleAdCapacityReport {
  export function getJsonObj(obj: SingleAdCapacityReport, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.DomainTypeCapacityReport.getJsonObj(obj) as SingleAdCapacityReport)),
      ...{
  ...
  export const domainType = "SINGLE_AD";
  export function getDeserializedJsonObj(
    obj: SingleAdCapacityReport,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.DomainTypeCapacityReport.getDeserializedJsonObj(obj) as SingleAdCapacityReport)),
      ...{
        "capacityAvailability": obj.capacityAvailability
