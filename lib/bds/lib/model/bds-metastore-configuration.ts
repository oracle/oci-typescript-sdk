...
export namespace BdsMetastoreConfiguration {
  export enum MetastoreType {
    Local = "LOCAL",
    External = "EXTERNAL",
    /**
  ...
  export function getJsonObj(obj: BdsMetastoreConfiguration): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: BdsMetastoreConfiguration): object {
    const jsonObj = { ...obj, ...{} };
