...
* 
*/
export interface UpdateScheduleBasedHorizontalScalingPolicyDetails
...
export namespace UpdateScheduleBasedHorizontalScalingPolicyDetails {
  export function getJsonObj(
    obj: UpdateScheduleBasedHorizontalScalingPolicyDetails,
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ...
        : (model.UpdateAutoScalePolicyDetails.getJsonObj(
            obj
          ) as UpdateScheduleBasedHorizontalScalingPolicyDetails)),
      ...{
