...
export namespace MetricBasedHorizontalScaleOutConfig {
  export function getJsonObj(obj: MetricBasedHorizontalScaleOutConfig): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: MetricBasedHorizontalScaleOutConfig): object {
    const jsonObj = {
      ...obj,
      ...{
        "metric": obj.metric
