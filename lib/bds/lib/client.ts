...
export class BdsClient {
   ...
   *
   * @summary Scale out a BDS instance by addition of block storage
  ...
  public async addBlockStorage(
    ...
    if (response.status && response.status >= 200 && response.status <= 299) {
      ...
      throw common.handleErrorResponse(response, body);
    }
  }
   ...
   *
   * @summary Add Cloud SQL capability
   ...
   *
   * @summary Scale out a BDS instance by adding of worker nodes
   ...
   *
   * @summary Moves a BDS instance into a different compartment.
   ...
   *
   * @summary Creates a new BDS instance
   ...
   * @summary Delete a provisioned BDS instance
   ...
   *
   * @summary Gets a list of all BDS instances in a compartment
   ...
   *
   * @summary Remove Cloud SQL capability
