...
/**
 * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/goldengate/ListDeploymentEnvironments.ts.html |here} to see how to use ListDeploymentEnvironmentsRequest.
 */
...
export namespace ListDeploymentEnvironmentsRequest {
  export enum SortBy {
