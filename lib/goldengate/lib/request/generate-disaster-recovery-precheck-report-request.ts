...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/goldengate/GenerateDisasterRecoveryPrecheckReport.ts.html |here} to see how to use GenerateDisasterRecoveryPrecheckReportRequest.
 */
export interface GenerateDisasterRecoveryPrecheckReportRequest extends common.BaseRequest {
  /**
   ...
   *
   */
  "generateDisasterRecoveryPrecheckReportDetails": model.GenerateDisasterRecoveryPrecheckReportDetails;
  /**
