...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/goldengate/ClonePipeline.ts.html |here} to see how to use ClonePipelineRequest.
 */
export interface ClonePipelineRequest extends common.BaseRequest {
  /**
   * Details to clone the pipeline.
   *
   */
  "clonePipelineDetails": model.DefaultClonePipelineDetails;
  /**
