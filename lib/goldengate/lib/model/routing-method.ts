...
export namespace RoutingMethod {
  export function getJsonObj(obj: RoutingMethod): RoutingMethod {
    return obj;
  }
  export function getDeserializedJsonObj(obj: RoutingMethod): RoutingMethod {
    return obj;
  }
}
