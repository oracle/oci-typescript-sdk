    ...
    if (obj && "connectionType" in obj && obj.connectionType) {
      switch (obj.connectionType) {
        ...
        case "ORACLE_AI_DATA_PLATFORM":
          return model.CreateOracleAiDataPlatformConnectionDetails.getJsonObj(
            <model.CreateOracleAiDataPlatformConnectionDetails>(<object>jsonObj),
            true
          );
        case "AMAZON_S3":
        ...
        case "AI_MODEL":
          return model.CreateAiModelConnectionDetails.getJsonObj(
            <model.CreateAiModelConnectionDetails>(<object>jsonObj),
            true
          );
  ...
  export function getDeserializedJsonObj(obj: CreateConnectionDetails): object {
    ...
    if (obj && "connectionType" in obj && obj.connectionType) {
      switch (obj.connectionType) {
        ...
        case "ORACLE_AI_DATA_PLATFORM":
          return model.CreateOracleAiDataPlatformConnectionDetails.getDeserializedJsonObj(
            <model.CreateOracleAiDataPlatformConnectionDetails>(<object>jsonObj),
            true
          );
        case "AMAZON_S3":
        ...
        case "AI_MODEL":
          return model.CreateAiModelConnectionDetails.getDeserializedJsonObj(
            <model.CreateAiModelConnectionDetails>(<object>jsonObj),
            true
          );
        case "AZURE_SYNAPSE_ANALYTICS":
