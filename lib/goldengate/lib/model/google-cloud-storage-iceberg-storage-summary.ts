...
export namespace GoogleCloudStorageIcebergStorageSummary {
  export function getJsonObj(
    obj: GoogleCloudStorageIcebergStorageSummary,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.IcebergStorageSummary.getJsonObj(obj) as GoogleCloudStorageIcebergStorageSummary)),
      ...{}
    };
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ...
        : (model.IcebergStorageSummary.getDeserializedJsonObj(
            obj
          ) as GoogleCloudStorageIcebergStorageSummary)),
      ...{}
    };
