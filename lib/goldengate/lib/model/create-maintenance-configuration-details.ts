...
export namespace CreateMaintenanceConfigurationDetails {
  export function getJsonObj(obj: CreateMaintenanceConfigurationDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: CreateMaintenanceConfigurationDetails): object {
    const jsonObj = { ...obj, ...{} };
