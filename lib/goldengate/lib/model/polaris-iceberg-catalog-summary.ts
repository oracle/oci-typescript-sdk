...
export namespace PolarisIcebergCatalogSummary {
  export function getJsonObj(obj: PolarisIcebergCatalogSummary, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.IcebergCatalogSummary.getJsonObj(obj) as PolarisIcebergCatalogSummary)),
      ...{}
    };
  ...
  export function getDeserializedJsonObj(
    obj: PolarisIcebergCatalogSummary,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.IcebergCatalogSummary.getDeserializedJsonObj(
            obj
          ) as PolarisIcebergCatalogSummary)),
      ...{}
    };
