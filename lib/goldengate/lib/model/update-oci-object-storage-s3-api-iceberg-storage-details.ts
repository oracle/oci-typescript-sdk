 ...
 *
 */
export interface UpdateOciObjectStorageS3ApiIcebergStorageDetails
  extends model.UpdateIcebergStorageDetails {
  /**
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ...
        : (model.UpdateIcebergStorageDetails.getJsonObj(
            obj
          ) as UpdateOciObjectStorageS3ApiIcebergStorageDetails)),
      ...{}
    };
