...
export namespace MicrosoftSqlserverConnectionSummary {
  export function getJsonObj(
    obj: MicrosoftSqlserverConnectionSummary,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.ConnectionSummary.getJsonObj(obj) as MicrosoftSqlserverConnectionSummary)),
      ...{
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ...
        : (model.ConnectionSummary.getDeserializedJsonObj(
            obj
          ) as MicrosoftSqlserverConnectionSummary)),
      ...{
        "additionalAttributes": obj.additionalAttributes
          ? obj.additionalAttributes.map(item => {
