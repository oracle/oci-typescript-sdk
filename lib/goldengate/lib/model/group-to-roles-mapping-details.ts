...
export namespace GroupToRolesMappingDetails {
  export function getJsonObj(obj: GroupToRolesMappingDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: GroupToRolesMappingDetails): object {
    const jsonObj = { ...obj, ...{} };
