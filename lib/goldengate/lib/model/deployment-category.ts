...
export namespace DeploymentCategory {
  export function getJsonObj(obj: DeploymentCategory): DeploymentCategory {
    return obj;
  }
  export function getDeserializedJsonObj(obj: DeploymentCategory): DeploymentCategory {
    return obj;
  }
}
