 ...
 *
 */
export interface CreateOciGenAiModelAuthDetails extends model.CreateAiModelAuthDetails {
  /**
...
export namespace CreateOciGenAiModelAuthDetails {
  export function getJsonObj(
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.CreateAiModelAuthDetails.getJsonObj(obj) as CreateOciGenAiModelAuthDetails)),
      ...{}
    };
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ...
        : (model.CreateAiModelAuthDetails.getDeserializedJsonObj(
            obj
          ) as CreateOciGenAiModelAuthDetails)),
      ...{}
    };
