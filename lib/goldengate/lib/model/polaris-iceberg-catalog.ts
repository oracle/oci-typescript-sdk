...
export namespace PolarisIcebergCatalog {
  export function getJsonObj(obj: PolarisIcebergCatalog, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj ? obj : (model.IcebergCatalog.getJsonObj(obj) as PolarisIcebergCatalog)),
      ...{}
    };
  ...
  export function getDeserializedJsonObj(
    obj: PolarisIcebergCatalog,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.IcebergCatalog.getDeserializedJsonObj(obj) as PolarisIcebergCatalog)),
      ...{}
    };
