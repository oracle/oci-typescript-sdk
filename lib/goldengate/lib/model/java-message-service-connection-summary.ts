...
export namespace JavaMessageServiceConnectionSummary {
  export function getJsonObj(
    obj: JavaMessageServiceConnectionSummary,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.ConnectionSummary.getJsonObj(obj) as JavaMessageServiceConnectionSummary)),
      ...{}
    };
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ...
        : (model.ConnectionSummary.getDeserializedJsonObj(
            obj
          ) as JavaMessageServiceConnectionSummary)),
      ...{}
    };
