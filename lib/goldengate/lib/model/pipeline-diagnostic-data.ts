...
export namespace PipelineDiagnosticData {
  export function getJsonObj(obj: PipelineDiagnosticData): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: PipelineDiagnosticData): object {
    const jsonObj = { ...obj, ...{} };
