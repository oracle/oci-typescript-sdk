 ...
 *
 */
export interface UpdateOciGenAiModelAuthDetails extends model.UpdateAiModelAuthDetails {
  /**
...
export namespace UpdateOciGenAiModelAuthDetails {
  export function getJsonObj(
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.UpdateAiModelAuthDetails.getJsonObj(obj) as UpdateOciGenAiModelAuthDetails)),
      ...{}
    };
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ...
        : (model.UpdateAiModelAuthDetails.getDeserializedJsonObj(
            obj
          ) as UpdateOciGenAiModelAuthDetails)),
      ...{}
    };
