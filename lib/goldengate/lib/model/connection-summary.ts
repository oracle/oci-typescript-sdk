    ...
    if (obj && "connectionType" in obj && obj.connectionType) {
      switch (obj.connectionType) {
        ...
        case "ORACLE_AI_DATA_PLATFORM":
          return model.OracleAiDataPlatformConnectionSummary.getJsonObj(
            <model.OracleAiDataPlatformConnectionSummary>(<object>jsonObj),
            true
          );
        case "MONGODB":
  ...
  export function getDeserializedJsonObj(obj: ConnectionSummary): object {
    ...
    if (obj && "connectionType" in obj && obj.connectionType) {
      switch (obj.connectionType) {
        ...
        case "ORACLE_AI_DATA_PLATFORM":
          return model.OracleAiDataPlatformConnectionSummary.getDeserializedJsonObj(
            <model.OracleAiDataPlatformConnectionSummary>(<object>jsonObj),
            true
          );
        case "MONGODB":
