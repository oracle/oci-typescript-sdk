  ...
  export function getJsonObj(obj: Connection): object {
    ...
    if (obj && "connectionType" in obj && obj.connectionType) {
      switch (obj.connectionType) {
        ...
        case "AI_MODEL":
          return model.AiModelConnection.getJsonObj(
            <model.AiModelConnection>(<object>jsonObj),
            true
          );
        case "AMAZON_S3":
        ...
        case "MICROSOFT_FABRIC":
          return model.MicrosoftFabricConnection.getJsonObj(
            <model.MicrosoftFabricConnection>(<object>jsonObj),
            true
          );
        case "DATABRICKS":
          return model.DatabricksConnection.getJsonObj(
            <model.DatabricksConnection>(<object>jsonObj),
            true
          );
        ...
        case "GOOGLE_PUBSUB":
          return model.GooglePubSubConnection.getJsonObj(
            <model.GooglePubSubConnection>(<object>jsonObj),
            true
          );
        default:
  ...
  export function getDeserializedJsonObj(obj: Connection): object {
    ...
    if (obj && "connectionType" in obj && obj.connectionType) {
      switch (obj.connectionType) {
        ...
        case "AI_MODEL":
          return model.AiModelConnection.getDeserializedJsonObj(
            <model.AiModelConnection>(<object>jsonObj),
            true
          );
        case "AMAZON_S3":
        ...
        case "MICROSOFT_FABRIC":
          return model.MicrosoftFabricConnection.getDeserializedJsonObj(
            <model.MicrosoftFabricConnection>(<object>jsonObj),
            true
          );
        case "DATABRICKS":
          return model.DatabricksConnection.getDeserializedJsonObj(
            <model.DatabricksConnection>(<object>jsonObj),
            true
          );
        case "JAVA_MESSAGE_SERVICE":
        ...
        case "GOOGLE_PUBSUB":
          return model.GooglePubSubConnection.getDeserializedJsonObj(
            <model.GooglePubSubConnection>(<object>jsonObj),
            true
          );
        default:
