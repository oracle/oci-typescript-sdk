...
export namespace AzureDataLakeStorageIcebergStorage {
  export function getJsonObj(
    obj: AzureDataLakeStorageIcebergStorage,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.IcebergStorage.getJsonObj(obj) as AzureDataLakeStorageIcebergStorage)),
      ...{}
    };
  ...
  export function getDeserializedJsonObj(
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.IcebergStorage.getDeserializedJsonObj(obj) as AzureDataLakeStorageIcebergStorage)),
      ...{}
    };
