 ...
 *
 */
export interface ApiKeyAiModelAuthDetails extends model.AiModelAuthDetails {
  /**
...
export namespace ApiKeyAiModelAuthDetails {
  export function getJsonObj(obj: ApiKeyAiModelAuthDetails, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.AiModelAuthDetails.getJsonObj(obj) as ApiKeyAiModelAuthDetails)),
      ...{}
    };
  ...
  export function getDeserializedJsonObj(
    obj: ApiKeyAiModelAuthDetails,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.AiModelAuthDetails.getDeserializedJsonObj(obj) as ApiKeyAiModelAuthDetails)),
      ...{}
    };
