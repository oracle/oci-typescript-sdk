...
export namespace CreateObjectStorageLinkDetails {
  export function getJsonObj(obj: CreateObjectStorageLinkDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: CreateObjectStorageLinkDetails): object {
    const jsonObj = { ...obj, ...{} };
