...
export namespace ChangeObjectStorageLinkCompartmentDetails {
  export function getJsonObj(obj: ChangeObjectStorageLinkCompartmentDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: ChangeObjectStorageLinkCompartmentDetails): object {
    const jsonObj = { ...obj, ...{} };
