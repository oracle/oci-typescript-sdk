...
export namespace LustreFileSystemCollection {
  export function getJsonObj(obj: LustreFileSystemCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
  ...
  export function getDeserializedJsonObj(obj: LustreFileSystemCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
