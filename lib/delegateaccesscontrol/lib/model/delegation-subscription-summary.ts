...
export namespace DelegationSubscriptionSummary {
  export function getJsonObj(obj: DelegationSubscriptionSummary): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: DelegationSubscriptionSummary): object {
    const jsonObj = { ...obj, ...{} };
