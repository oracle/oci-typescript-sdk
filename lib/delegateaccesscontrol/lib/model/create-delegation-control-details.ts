...
export namespace CreateDelegationControlDetails {
  export function getJsonObj(obj: CreateDelegationControlDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: CreateDelegationControlDetails): object {
    const jsonObj = { ...obj, ...{} };
