...
export namespace DedicatedVantagePointSummary {
  export function getJsonObj(obj: DedicatedVantagePointSummary): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: DedicatedVantagePointSummary): object {
    const jsonObj = {
      ...obj,
      ...{
        "dvpStackDetails": obj.dvpStackDetails
