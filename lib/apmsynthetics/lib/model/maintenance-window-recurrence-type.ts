 ...
 **/
export enum MaintenanceWindowRecurrenceType {
  Weekly = "WEEKLY",
  Monthly = "MONTHLY",
...
export namespace MaintenanceWindowRecurrenceType {
  export function getJsonObj(
    obj: MaintenanceWindowRecurrenceType
  ): MaintenanceWindowRecurrenceType {
    return obj;
  }
