...
export namespace UpdateDedicatedVantagePointDetails {
  export function getJsonObj(obj: UpdateDedicatedVantagePointDetails): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: UpdateDedicatedVantagePointDetails): object {
    const jsonObj = {
      ...obj,
      ...{
        "dvpStackDetails": obj.dvpStackDetails
