...
export namespace WorkerMonitorList {
  export function getJsonObj(obj: WorkerMonitorList): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: WorkerMonitorList): object {
    const jsonObj = { ...obj, ...{} };
