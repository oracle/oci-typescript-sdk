...
export namespace UpdateOnPremiseVantagePointDetails {
  export function getJsonObj(obj: UpdateOnPremiseVantagePointDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: UpdateOnPremiseVantagePointDetails): object {
    const jsonObj = { ...obj, ...{} };
