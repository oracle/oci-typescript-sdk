 ...
 **/
export enum MaintenanceWindowScheduleType {
  OneTime = "ONE_TIME",
  Recurring = "RECURRING",
...
export namespace MaintenanceWindowScheduleType {
  export function getJsonObj(obj: MaintenanceWindowScheduleType): MaintenanceWindowScheduleType {
    return obj;
  }
  export function getDeserializedJsonObj(
    obj: MaintenanceWindowScheduleType
  ): MaintenanceWindowScheduleType {
    return obj;
  }
}
