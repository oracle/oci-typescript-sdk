...
export namespace CccScheduleEvent {
  export function getJsonObj(obj: CccScheduleEvent): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: CccScheduleEvent): object {
    const jsonObj = { ...obj, ...{} };
