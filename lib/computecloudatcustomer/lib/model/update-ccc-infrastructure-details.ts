...
export namespace UpdateCccInfrastructureDetails {
  export function getJsonObj(obj: UpdateCccInfrastructureDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: UpdateCccInfrastructureDetails): object {
    const jsonObj = { ...obj, ...{} };
