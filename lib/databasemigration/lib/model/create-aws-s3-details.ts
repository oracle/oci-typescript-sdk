...
export namespace CreateAwsS3Details {
  export function getJsonObj(obj: CreateAwsS3Details): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: CreateAwsS3Details): object {
    const jsonObj = { ...obj, ...{} };
