...
export namespace AwsS3Details {
  export function getJsonObj(obj: AwsS3Details): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: AwsS3Details): object {
    const jsonObj = { ...obj, ...{} };
