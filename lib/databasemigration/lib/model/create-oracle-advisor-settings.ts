...
export namespace CreateOracleAdvisorSettings {
  export function getJsonObj(obj: CreateOracleAdvisorSettings): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: CreateOracleAdvisorSettings): object {
    const jsonObj = { ...obj, ...{} };
