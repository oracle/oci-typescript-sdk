 ...
 *
 */
export interface UpdateNonADBRemapTablespaceDetails
...
export namespace UpdateNonADBRemapTablespaceDetails {
  export function getJsonObj(
    obj: UpdateNonADBRemapTablespaceDetails,
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ...
        : (model.UpdateTargetTypeTablespaceDetails.getJsonObj(
            obj
          ) as UpdateNonADBRemapTablespaceDetails)),
      ...{}
    };
