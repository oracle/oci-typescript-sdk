 ...
 *
 */
export interface CreateNonADBAutoCreateTablespaceDetails
...
export namespace CreateNonADBAutoCreateTablespaceDetails {
  export function getJsonObj(
    obj: CreateNonADBAutoCreateTablespaceDetails,
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ...
        : (model.CreateTargetTypeTablespaceDetails.getJsonObj(
            obj
          ) as CreateNonADBAutoCreateTablespaceDetails)),
      ...{}
    };
