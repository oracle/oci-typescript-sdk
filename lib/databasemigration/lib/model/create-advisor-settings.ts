...
export namespace CreateAdvisorSettings {
  export function getJsonObj(obj: CreateAdvisorSettings): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: CreateAdvisorSettings): object {
    const jsonObj = { ...obj, ...{} };
