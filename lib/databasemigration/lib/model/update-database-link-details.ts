 ...
 *
 */
export interface UpdateDatabaseLinkDetails {
  /**
...
export namespace UpdateDatabaseLinkDetails {
  export function getJsonObj(obj: UpdateDatabaseLinkDetails): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: UpdateDatabaseLinkDetails): object {
    const jsonObj = {
      ...obj,
      ...{
        "walletBucket": obj.walletBucket
