...
export namespace MigrationParameterSummaryCollection {
  export function getJsonObj(obj: MigrationParameterSummaryCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
  ...
  export function getDeserializedJsonObj(obj: MigrationParameterSummaryCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
