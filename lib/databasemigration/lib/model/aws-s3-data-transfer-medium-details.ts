 ...
 *
 */
export interface AwsS3DataTransferMediumDetails extends model.DataTransferMediumDetailsV2 {
  /**
   * S3 bucket name.
   *
   */
...
export namespace AwsS3DataTransferMediumDetails {
  export function getJsonObj(
    obj: AwsS3DataTransferMediumDetails,
