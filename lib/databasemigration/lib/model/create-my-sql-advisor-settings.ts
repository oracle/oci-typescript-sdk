...
export namespace CreateMySqlAdvisorSettings {
  export function getJsonObj(obj: CreateMySqlAdvisorSettings): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: CreateMySqlAdvisorSettings): object {
    const jsonObj = { ...obj, ...{} };
