...
export namespace AdvisorSettings {
  export function getJsonObj(obj: AdvisorSettings): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: AdvisorSettings): object {
    const jsonObj = { ...obj, ...{} };
