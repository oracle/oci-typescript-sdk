...
export interface CreateDatabaseLinkDetails {
   ...
   */
  "name"?: string;
  "walletBucket"?: model.CreateObjectStoreBucket;
}
...
export namespace CreateDatabaseLinkDetails {
    ...
    const jsonObj = {
      ...
      ...{
        "walletBucket": obj.walletBucket
          ? model.CreateObjectStoreBucket.getJsonObj(obj.walletBucket)
          : undefined
      }
    };
  ...
  export function getDeserializedJsonObj(obj: CreateDatabaseLinkDetails): object {
    const jsonObj = {
      ...obj,
      ...{
        "walletBucket": obj.walletBucket
          ? model.CreateObjectStoreBucket.getDeserializedJsonObj(obj.walletBucket)
          : undefined
      }
    };
