 ...
 **/
export enum AcceptableDowntime {
...
export namespace AcceptableDowntime {
  export function getJsonObj(obj: AcceptableDowntime): AcceptableDowntime {
    return obj;
  }
  export function getDeserializedJsonObj(obj: AcceptableDowntime): AcceptableDowntime {
    return obj;
  }
}
