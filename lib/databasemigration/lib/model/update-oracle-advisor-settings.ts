...
export namespace UpdateOracleAdvisorSettings {
  export function getJsonObj(obj: UpdateOracleAdvisorSettings): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: UpdateOracleAdvisorSettings): object {
    const jsonObj = { ...obj, ...{} };
