...
export namespace UpdateMySqlAdvisorSettings {
  export function getJsonObj(obj: UpdateMySqlAdvisorSettings): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: UpdateMySqlAdvisorSettings): object {
    const jsonObj = { ...obj, ...{} };
