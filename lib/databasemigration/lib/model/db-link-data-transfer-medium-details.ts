 ...
 *
 */
export interface DbLinkDataTransferMediumDetails extends model.DataTransferMediumDetailsV2 {
...
export namespace DbLinkDataTransferMediumDetails {
  export function getJsonObj(
    obj: DbLinkDataTransferMediumDetails,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.DataTransferMediumDetailsV2.getJsonObj(obj) as DbLinkDataTransferMediumDetails)),
      ...{
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ...
        : (model.DataTransferMediumDetailsV2.getDeserializedJsonObj(
            obj
          ) as DbLinkDataTransferMediumDetails)),
      ...{
        "objectStorageBucket": obj.objectStorageBucket
