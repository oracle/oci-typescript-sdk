...
export namespace MySqlDatabaseObject {
  export function getJsonObj(obj: MySqlDatabaseObject): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: MySqlDatabaseObject): object {
    const jsonObj = { ...obj, ...{} };
