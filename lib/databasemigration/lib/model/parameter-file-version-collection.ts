...
export namespace ParameterFileVersionCollection {
  export function getJsonObj(obj: ParameterFileVersionCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
  ...
  export function getDeserializedJsonObj(obj: ParameterFileVersionCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
