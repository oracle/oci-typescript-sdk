...
export namespace UpdateMigrationDetails {
  export function getJsonObj(obj: UpdateMigrationDetails): object {
    ...
    if (obj && "databaseCombination" in obj && obj.databaseCombination) {
      switch (obj.databaseCombination) {
        case "MYSQL":
          return model.UpdateMySqlMigrationDetails.getJsonObj(
            <model.UpdateMySqlMigrationDetails>(<object>jsonObj),
            true
          );
        case "ORACLE":
          return model.UpdateOracleMigrationDetails.getJsonObj(
            <model.UpdateOracleMigrationDetails>(<object>jsonObj),
            true
          );
        default:
  ...
  export function getDeserializedJsonObj(obj: UpdateMigrationDetails): object {
    ...
    if (obj && "databaseCombination" in obj && obj.databaseCombination) {
      switch (obj.databaseCombination) {
        case "MYSQL":
          return model.UpdateMySqlMigrationDetails.getDeserializedJsonObj(
            <model.UpdateMySqlMigrationDetails>(<object>jsonObj),
            true
          );
        case "ORACLE":
          return model.UpdateOracleMigrationDetails.getDeserializedJsonObj(
            <model.UpdateOracleMigrationDetails>(<object>jsonObj),
            true
          );
        default:
