 ...
 */
export interface UpdateOracleOnlineStandbyMigrationSettings
  extends model.UpdateOracleMigrationSettings {
...
export namespace UpdateOracleOnlineStandbyMigrationSettings {
  export function getJsonObj(
    obj: UpdateOracleOnlineStandbyMigrationSettings,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.UpdateOracleMigrationSettings.getJsonObj(
            obj
          ) as UpdateOracleOnlineStandbyMigrationSettings)),
      ...{
  ...
  export function getDeserializedJsonObj(
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.UpdateOracleMigrationSettings.getDeserializedJsonObj(
            obj
          ) as UpdateOracleOnlineStandbyMigrationSettings)),
      ...{
        "dataTransferMediumDetails": obj.dataTransferMediumDetails
