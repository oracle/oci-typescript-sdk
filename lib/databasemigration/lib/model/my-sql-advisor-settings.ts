...
export namespace MySqlAdvisorSettings {
  export function getJsonObj(obj: MySqlAdvisorSettings): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: MySqlAdvisorSettings): object {
    const jsonObj = { ...obj, ...{} };
