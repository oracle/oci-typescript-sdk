...
export namespace OracleDatabaseObject {
  export function getJsonObj(obj: OracleDatabaseObject): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: OracleDatabaseObject): object {
    const jsonObj = { ...obj, ...{} };
