...
export namespace OracleAdvisorSettings {
  export function getJsonObj(obj: OracleAdvisorSettings): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: OracleAdvisorSettings): object {
    const jsonObj = { ...obj, ...{} };
