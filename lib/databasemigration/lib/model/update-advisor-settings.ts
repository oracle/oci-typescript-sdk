...
export namespace UpdateAdvisorSettings {
  export function getJsonObj(obj: UpdateAdvisorSettings): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: UpdateAdvisorSettings): object {
    const jsonObj = { ...obj, ...{} };
