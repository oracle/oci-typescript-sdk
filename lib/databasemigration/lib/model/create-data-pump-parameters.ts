...
export namespace CreateDataPumpParameters {
  export function getJsonObj(obj: CreateDataPumpParameters): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: CreateDataPumpParameters): object {
    const jsonObj = {
      ...obj,
      ...{
        "excludeParameters": obj.excludeParameters
