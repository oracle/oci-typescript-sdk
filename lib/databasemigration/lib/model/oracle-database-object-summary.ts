...
export namespace OracleDatabaseObjectSummary {
  export function getJsonObj(obj: OracleDatabaseObjectSummary): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: OracleDatabaseObjectSummary): object {
    const jsonObj = { ...obj, ...{} };
