 ...
 */
export interface OracleOnlineStandbyMigrationSettings extends model.OracleMigrationSettings {
...
export namespace OracleOnlineStandbyMigrationSettings {
  export function getJsonObj(
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.OracleMigrationSettings.getJsonObj(obj) as OracleOnlineStandbyMigrationSettings)),
      ...{
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ...
        : (model.OracleMigrationSettings.getDeserializedJsonObj(
            obj
          ) as OracleOnlineStandbyMigrationSettings)),
      ...{
        "dataTransferMediumDetails": obj.dataTransferMediumDetails
