...
export namespace MySqlDatabaseObjectSummary {
  export function getJsonObj(obj: MySqlDatabaseObjectSummary): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: MySqlDatabaseObjectSummary): object {
    const jsonObj = { ...obj, ...{} };
