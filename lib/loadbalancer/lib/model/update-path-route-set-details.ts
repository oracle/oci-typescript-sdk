...
export namespace UpdatePathRouteSetDetails {
  export function getJsonObj(obj: UpdatePathRouteSetDetails): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: UpdatePathRouteSetDetails): object {
    const jsonObj = {
      ...obj,
      ...{
        "pathRoutes": obj.pathRoutes
