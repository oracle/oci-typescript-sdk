...
export namespace CreateSSLCipherSuiteDetails {
  export function getJsonObj(obj: CreateSSLCipherSuiteDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: CreateSSLCipherSuiteDetails): object {
    const jsonObj = { ...obj, ...{} };
