...
export namespace HostnameDetails {
  export function getJsonObj(obj: HostnameDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: HostnameDetails): object {
    const jsonObj = { ...obj, ...{} };
