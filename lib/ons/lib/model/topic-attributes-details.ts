...
export namespace TopicAttributesDetails {
  export function getJsonObj(obj: TopicAttributesDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: TopicAttributesDetails): object {
    const jsonObj = { ...obj, ...{} };
