...
export namespace PatchRecommendationsDetailsSummary {
  export function getJsonObj(obj: PatchRecommendationsDetailsSummary): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: PatchRecommendationsDetailsSummary): object {
    const jsonObj = { ...obj, ...{} };
