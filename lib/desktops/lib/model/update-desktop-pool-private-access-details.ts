 ...
 *
 */
export interface UpdateDesktopPoolPrivateAccessDetails {
  /**
...
export namespace UpdateDesktopPoolPrivateAccessDetails {
  export function getJsonObj(obj: UpdateDesktopPoolPrivateAccessDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: UpdateDesktopPoolPrivateAccessDetails): object {
    const jsonObj = { ...obj, ...{} };
