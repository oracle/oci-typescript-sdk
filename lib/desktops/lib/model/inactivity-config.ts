...
export namespace InactivityConfig {
  export enum Action {
    None = "NONE",
  ...
  export function getJsonObj(obj: InactivityConfig): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: InactivityConfig): object {
    const jsonObj = { ...obj, ...{} };
