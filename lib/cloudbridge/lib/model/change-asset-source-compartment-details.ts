...
export namespace ChangeAssetSourceCompartmentDetails {
  export function getJsonObj(obj: ChangeAssetSourceCompartmentDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: ChangeAssetSourceCompartmentDetails): object {
    const jsonObj = { ...obj, ...{} };
