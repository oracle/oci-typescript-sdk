...
export namespace MonthlyCostSummary {
  export function getJsonObj(obj: MonthlyCostSummary): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: MonthlyCostSummary): object {
    const jsonObj = { ...obj, ...{} };
