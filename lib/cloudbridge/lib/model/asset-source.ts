...
export namespace AssetSource {
  export function getJsonObj(obj: AssetSource): object {
    const jsonObj = { ...obj, ...{} };

    if (obj && "type" in obj && obj.type) {
      switch (obj.type) {
        case "VMWARE":
          return model.VmWareAssetSource.getJsonObj(
  ...
  export function getDeserializedJsonObj(obj: AssetSource): object {
    const jsonObj = { ...obj, ...{} };
    ...
    if (obj && "type" in obj && obj.type) {
      switch (obj.type) {
        ...
        case "AWS":
          return model.AwsAssetSource.getDeserializedJsonObj(
            <model.AwsAssetSource>(<object>jsonObj),
            true
          );
        default:
          if (common.LOG.logger) common.LOG.logger.info(`Unknown value for: ${obj.type}`);
