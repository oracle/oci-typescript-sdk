...
export namespace CreateAwsAssetSourceDetails {
  export function getJsonObj(obj: CreateAwsAssetSourceDetails, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.CreateAssetSourceDetails.getJsonObj(obj) as CreateAwsAssetSourceDetails)),
      ...{
  ...
  export function getDeserializedJsonObj(
    obj: CreateAwsAssetSourceDetails,
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ...
        : (model.CreateAssetSourceDetails.getDeserializedJsonObj(
            obj
          ) as CreateAwsAssetSourceDetails)),
      ...{
        "discoveryCredentials": obj.discoveryCredentials
