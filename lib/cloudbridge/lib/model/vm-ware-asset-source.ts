...
export namespace VmWareAssetSource {
  export function getJsonObj(obj: VmWareAssetSource, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj ? obj : (model.AssetSource.getJsonObj(obj) as VmWareAssetSource)),
      ...{
  ...
  export function getDeserializedJsonObj(
    obj: VmWareAssetSource,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.AssetSource.getDeserializedJsonObj(obj) as VmWareAssetSource)),
      ...{
        "discoveryCredentials": obj.discoveryCredentials
