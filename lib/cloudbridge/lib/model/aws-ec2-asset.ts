...
export namespace AwsEc2Asset {
  export function getJsonObj(obj: AwsEc2Asset, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj ? obj : (model.Asset.getJsonObj(obj) as AwsEc2Asset)),
      ...{
  ...
  export function getDeserializedJsonObj(obj: AwsEc2Asset, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj ? obj : (model.Asset.getDeserializedJsonObj(obj) as AwsEc2Asset)),
      ...{
        "compute": obj.compute
