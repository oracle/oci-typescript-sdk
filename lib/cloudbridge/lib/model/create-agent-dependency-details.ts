...
export namespace CreateAgentDependencyDetails {
  export function getJsonObj(obj: CreateAgentDependencyDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: CreateAgentDependencyDetails): object {
    const jsonObj = { ...obj, ...{} };
