...
export namespace UpdateVmWareAssetSourceDetails {
  export function getJsonObj(
    obj: UpdateVmWareAssetSourceDetails,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.UpdateAssetSourceDetails.getJsonObj(obj) as UpdateVmWareAssetSourceDetails)),
      ...{
