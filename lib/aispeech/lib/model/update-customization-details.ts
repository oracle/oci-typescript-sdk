 ...
 */
export interface UpdateCustomizationDetails {
  /**
...
export namespace UpdateCustomizationDetails {
  export function getJsonObj(obj: UpdateCustomizationDetails): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: UpdateCustomizationDetails): object {
    const jsonObj = {
      ...obj,
      ...{
        "modelDetails": obj.modelDetails
