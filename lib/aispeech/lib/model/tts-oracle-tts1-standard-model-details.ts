 ...
 */
export interface TtsOracleTts1StandardModelDetails extends model.TtsOracleModelDetails {
  /**
...
export namespace TtsOracleTts1StandardModelDetails {
  export function getJsonObj(
    obj: TtsOracleTts1StandardModelDetails,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.TtsOracleModelDetails.getJsonObj(obj) as TtsOracleTts1StandardModelDetails)),
      ...{}
    };

    return jsonObj;
  }
  export const modelName = "TTS_1_STANDARD";
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ...
        : (model.TtsOracleModelDetails.getDeserializedJsonObj(
            obj
          ) as TtsOracleTts1StandardModelDetails)),
      ...{}
    };
