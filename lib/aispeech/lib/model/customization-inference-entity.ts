...
export namespace CustomizationInferenceEntity {
  export function getJsonObj(obj: CustomizationInferenceEntity): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: CustomizationInferenceEntity): object {
    const jsonObj = { ...obj, ...{} };
