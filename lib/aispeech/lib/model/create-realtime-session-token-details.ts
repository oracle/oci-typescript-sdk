...
export namespace CreateRealtimeSessionTokenDetails {
  export function getJsonObj(obj: CreateRealtimeSessionTokenDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: CreateRealtimeSessionTokenDetails): object {
    const jsonObj = { ...obj, ...{} };
