...
export namespace ModifyPeerDetails {
  export function getJsonObj(obj: ModifyPeerDetails): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: ModifyPeerDetails): object {
    const jsonObj = {
      ...obj,
      ...{
        "ocpuAllocationParam": obj.ocpuAllocationParam
