...
export class DistributedAutonomousDbServiceClient {
   ...
   * @throws OciError when an error occurs
   * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/distributeddatabase/ConfigureDistributedAutonomousDatabaseAutoResourceManagement.ts.html |here} to see how to use ConfigureDistributedAutonomousDatabaseAutoResourceManagement API.
   */
   ...
   * @throws OciError when an error occurs
   * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/distributeddatabase/GetDistributedAutonomousDatabaseRuChangeLog.ts.html |here} to see how to use GetDistributedAutonomousDatabaseRuChangeLog API.
   */
   ...
   * @throws OciError when an error occurs
   * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/distributeddatabase/ScaleDistributedAutonomousDatabaseGsms.ts.html |here} to see how to use ScaleDistributedAutonomousDatabaseGsms API.
   */
...
export class DistributedDbPrivateEndpointServiceClient {
   ...
   * @throws OciError when an error occurs
   * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/distributeddatabase/PatchDistributedDatabasePrivateEndpoint.ts.html |here} to see how to use PatchDistributedDatabasePrivateEndpoint API.
   */
...
export class DistributedDbServiceClient {
   ...
   * @throws OciError when an error occurs
   * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/distributeddatabase/ConfigureDistributedDatabaseAutoResourceManagement.ts.html |here} to see how to use ConfigureDistributedDatabaseAutoResourceManagement API.
   */
   ...
   * @throws OciError when an error occurs
   * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/distributeddatabase/GetDistributedDatabaseRuChangeLog.ts.html |here} to see how to use GetDistributedDatabaseRuChangeLog API.
   */
   ...
   * @throws OciError when an error occurs
   * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/distributeddatabase/ScaleDistributedDatabaseGsms.ts.html |here} to see how to use ScaleDistributedDatabaseGsms API.
   */
