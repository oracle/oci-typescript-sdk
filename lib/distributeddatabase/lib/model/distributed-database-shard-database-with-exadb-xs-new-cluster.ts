 ...
 */
export interface DistributedDatabaseShardDatabaseWithExadbXsNewCluster
   ...
   */
  "status": DistributedDatabaseShardDatabaseWithExadbXsNewCluster.Status;
  /**
...
export namespace DistributedDatabaseShardDatabaseWithExadbXsNewCluster {
  export enum Status {
    Failed = "FAILED",
    Deleting = "DELETING",
    Deleted = "DELETED",
  ...
  export function getJsonObj(
    obj: DistributedDatabaseShardDatabaseWithExadbXsNewCluster,
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ...
        : (model.DistributedDatabaseShardDatabase.getJsonObj(
            obj
          ) as DistributedDatabaseShardDatabaseWithExadbXsNewCluster)),
      ...{
