...
export namespace CreateCatalogPeerWithExadbXsDetails {
  export function getJsonObj(obj: CreateCatalogPeerWithExadbXsDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: CreateCatalogPeerWithExadbXsDetails): object {
    const jsonObj = { ...obj, ...{} };
