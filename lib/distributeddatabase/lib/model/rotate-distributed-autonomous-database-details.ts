 ...
 *
 */
export interface RotateDistributedAutonomousDatabaseDetails {
  /**
...
export namespace RotateDistributedAutonomousDatabaseDetails {
  ...
  export function getDeserializedJsonObj(obj: RotateDistributedAutonomousDatabaseDetails): object {
    const jsonObj = { ...obj, ...{} };
