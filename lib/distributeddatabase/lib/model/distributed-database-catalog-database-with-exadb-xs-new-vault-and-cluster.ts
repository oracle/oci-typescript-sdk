 ...
 */
export interface DistributedDatabaseCatalogDatabaseWithExadbXsNewVaultAndCluster
  extends model.DistributedDatabaseCatalogDatabase {
  /**
   ...
   */
  "status": DistributedDatabaseCatalogDatabaseWithExadbXsNewVaultAndCluster.Status;
  /**
...
export namespace DistributedDatabaseCatalogDatabaseWithExadbXsNewVaultAndCluster {
  export enum Status {
    Failed = "FAILED",
    Deleting = "DELETING",
    Deleted = "DELETED",
  ...
  export function getJsonObj(
    obj: DistributedDatabaseCatalogDatabaseWithExadbXsNewVaultAndCluster,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.DistributedDatabaseCatalogDatabase.getJsonObj(
            obj
          ) as DistributedDatabaseCatalogDatabaseWithExadbXsNewVaultAndCluster)),
      ...{
  ...
  export const source = "XS_NEW_VAULT_AND_CLUSTER";
  export function getDeserializedJsonObj(
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.DistributedDatabaseCatalogDatabase.getDeserializedJsonObj(
            obj
          ) as DistributedDatabaseCatalogDatabaseWithExadbXsNewVaultAndCluster)),
      ...{
        "dbStorageVaultDetails": obj.dbStorageVaultDetails
