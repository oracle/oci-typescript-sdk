...
export interface DistributedAutonomousDatabaseShardWithDedicatedInfra
  extends model.DistributedAutonomousDatabaseShardDatabase {
  /**
...
export namespace DistributedAutonomousDatabaseShardWithDedicatedInfra {
  ...
  export function getJsonObj(
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.DistributedAutonomousDatabaseShardDatabase.getJsonObj(
            obj
  ...
  export function getDeserializedJsonObj(
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.DistributedAutonomousDatabaseShardDatabase.getDeserializedJsonObj(
            obj
          ) as DistributedAutonomousDatabaseShardWithDedicatedInfra)),
      ...{}
    };
