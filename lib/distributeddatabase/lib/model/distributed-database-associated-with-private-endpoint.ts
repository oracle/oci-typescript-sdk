...
export namespace DistributedDatabaseAssociatedWithPrivateEndpoint {
  export function getJsonObj(obj: DistributedDatabaseAssociatedWithPrivateEndpoint): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(
    obj: DistributedDatabaseAssociatedWithPrivateEndpoint
  ): object {
    const jsonObj = { ...obj, ...{} };
