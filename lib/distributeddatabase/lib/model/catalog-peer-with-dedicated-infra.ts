...
export namespace CatalogPeerWithDedicatedInfra {
  export enum Status {
    Failed = "FAILED",
    Deleting = "DELETING",
    Deleted = "DELETED",
  ...
  export function getJsonObj(obj: CatalogPeerWithDedicatedInfra): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: CatalogPeerWithDedicatedInfra): object {
    const jsonObj = {
      ...obj,
      ...{
        "metadata": obj.metadata
