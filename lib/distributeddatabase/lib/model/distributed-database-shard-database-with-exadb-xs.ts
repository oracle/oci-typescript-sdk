 ...
 */
export interface DistributedDatabaseShardDatabaseWithExadbXs
   ...
   */
  "status": DistributedDatabaseShardDatabaseWithExadbXs.Status;
  /**
...
export namespace DistributedDatabaseShardDatabaseWithExadbXs {
  export enum Status {
    Failed = "FAILED",
    Deleting = "DELETING",
    Deleted = "DELETED",
  ...
  export function getJsonObj(
    obj: DistributedDatabaseShardDatabaseWithExadbXs,
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ...
        : (model.DistributedDatabaseShardDatabase.getJsonObj(
            obj
          ) as DistributedDatabaseShardDatabaseWithExadbXs)),
      ...{}
    };
