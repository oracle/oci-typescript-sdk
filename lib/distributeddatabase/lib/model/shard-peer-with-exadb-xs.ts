...
export namespace ShardPeerWithExadbXs {
  export enum Status {
    Failed = "FAILED",
    Deleting = "DELETING",
    Deleted = "DELETED",
  ...
  export function getJsonObj(obj: ShardPeerWithExadbXs): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: ShardPeerWithExadbXs): object {
    const jsonObj = {
      ...obj,
      ...{
