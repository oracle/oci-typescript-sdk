 ...
 */
export interface DistributedDatabaseCatalogDatabaseWithExadbXsNewCluster
   ...
   */
  "status": DistributedDatabaseCatalogDatabaseWithExadbXsNewCluster.Status;
  /**
...
export namespace DistributedDatabaseCatalogDatabaseWithExadbXsNewCluster {
  export enum Status {
    Failed = "FAILED",
    Deleting = "DELETING",
    Deleted = "DELETED",
  ...
  export function getJsonObj(
    obj: DistributedDatabaseCatalogDatabaseWithExadbXsNewCluster,
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ...
        : (model.DistributedDatabaseCatalogDatabase.getJsonObj(
            obj
          ) as DistributedDatabaseCatalogDatabaseWithExadbXsNewCluster)),
      ...{
