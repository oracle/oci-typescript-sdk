 ...
 */
export interface DistributedDatabaseShardDatabaseWithExadbXsNewVaultAndCluster
   ...
   */
  "status": DistributedDatabaseShardDatabaseWithExadbXsNewVaultAndCluster.Status;
  /**
...
export namespace DistributedDatabaseShardDatabaseWithExadbXsNewVaultAndCluster {
  export enum Status {
    Failed = "FAILED",
    Deleting = "DELETING",
    Deleted = "DELETED",
  ...
  export function getJsonObj(
    obj: DistributedDatabaseShardDatabaseWithExadbXsNewVaultAndCluster,
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ...
        : (model.DistributedDatabaseShardDatabase.getJsonObj(
            obj
          ) as DistributedDatabaseShardDatabaseWithExadbXsNewVaultAndCluster)),
      ...{
