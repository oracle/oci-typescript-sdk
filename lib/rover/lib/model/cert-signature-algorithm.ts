...
export namespace CertSignatureAlgorithm {
  export function getJsonObj(obj: CertSignatureAlgorithm): CertSignatureAlgorithm {
    return obj;
  }
  export function getDeserializedJsonObj(obj: CertSignatureAlgorithm): CertSignatureAlgorithm {
    return obj;
  }
}
