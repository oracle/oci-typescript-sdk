...
export namespace ValidationExternalAuthenticationStatus {
  export function getJsonObj(obj: ValidationExternalAuthenticationStatus): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: ValidationExternalAuthenticationStatus): object {
    const jsonObj = { ...obj, ...{} };
