...
/**
 * List of {@code CredentialSummary} items.
 */
export interface CredentialCollection {
  /**
   * Array of {@code CredentialSummary} items.
   */
  ...
  export function getJsonObj(obj: CredentialCollection): object {
    const jsonObj = {
      ...
      ...{
        "items": obj.items
          ? obj.items.map(item => {
              return model.CredentialSummary.getJsonObj(item);
            })
          : undefined
      }
    };
  ...
  export function getDeserializedJsonObj(obj: CredentialCollection): object {
    const jsonObj = {
      ...
      ...{
        "items": obj.items
          ? obj.items.map(item => {
              return model.CredentialSummary.getDeserializedJsonObj(item);
            })
          : undefined
      }
    };
