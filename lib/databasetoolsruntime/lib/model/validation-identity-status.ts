...
export namespace ValidationIdentityStatus {
  export function getJsonObj(obj: ValidationIdentityStatus): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: ValidationIdentityStatus): object {
    const jsonObj = { ...obj, ...{} };
