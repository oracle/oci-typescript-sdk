 ...
 */
export interface DatabaseToolsDatabaseApiGatewayConfigPool {
  /**
   ...
   */
  "databaseActionsStatus"?: DatabaseToolsDatabaseApiGatewayConfigPool.DatabaseActionsStatus;
  /**
   * Specifies whether the REST-Enabled SQL service is active.
   */
  "restEnabledSqlStatus"?: DatabaseToolsDatabaseApiGatewayConfigPool.RestEnabledSqlStatus;
  /**
...
export namespace DatabaseToolsDatabaseApiGatewayConfigPool {
  ...
  export function getJsonObj(obj: DatabaseToolsDatabaseApiGatewayConfigPool): object {
    const jsonObj = { ...obj, ...{} };

    if (obj && "type" in obj && obj.type) {
      switch (obj.type) {
        case "DEFAULT":
          return model.DatabaseToolsDatabaseApiGatewayConfigPoolDefault.getJsonObj(
            <model.DatabaseToolsDatabaseApiGatewayConfigPoolDefault>(<object>jsonObj),
            true
          );
        default:
  ...
  export function getDeserializedJsonObj(obj: DatabaseToolsDatabaseApiGatewayConfigPool): object {
    const jsonObj = { ...obj, ...{} };

    if (obj && "type" in obj && obj.type) {
      switch (obj.type) {
        case "DEFAULT":
          return model.DatabaseToolsDatabaseApiGatewayConfigPoolDefault.getDeserializedJsonObj(
            <model.DatabaseToolsDatabaseApiGatewayConfigPoolDefault>(<object>jsonObj),
            true
          );
        default:
