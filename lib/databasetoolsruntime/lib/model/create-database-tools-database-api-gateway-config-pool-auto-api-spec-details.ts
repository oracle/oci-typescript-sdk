 ...
 */
export interface CreateDatabaseToolsDatabaseApiGatewayConfigPoolAutoApiSpecDetails {
  /**
   ...
   */
  "databaseObjectType": CreateDatabaseToolsDatabaseApiGatewayConfigPoolAutoApiSpecDetails.DatabaseObjectType;
  /**
   ...
   */
  "operations"?: Array<
    CreateDatabaseToolsDatabaseApiGatewayConfigPoolAutoApiSpecDetails.Operations
  >;
  /**
   * The security schemes that can access this resource. If not specified then the resource is public.
   */
  "securitySchemes"?: Array<
    CreateDatabaseToolsDatabaseApiGatewayConfigPoolAutoApiSpecDetails.SecuritySchemes
  >;
  /**
...
export namespace CreateDatabaseToolsDatabaseApiGatewayConfigPoolAutoApiSpecDetails {
  ...
  export function getJsonObj(
    obj: CreateDatabaseToolsDatabaseApiGatewayConfigPoolAutoApiSpecDetails
  ): object {
    const jsonObj = { ...obj, ...{} };
    ...
    if (obj && "type" in obj && obj.type) {
      switch (obj.type) {
        case "DEFAULT":
          return model.CreateDatabaseToolsDatabaseApiGatewayConfigPoolAutoApiSpecDefaultDetails.getJsonObj(
            <model.CreateDatabaseToolsDatabaseApiGatewayConfigPoolAutoApiSpecDefaultDetails>(
              (<object>jsonObj)
            ),
            true
          );
  ...
  export function getDeserializedJsonObj(
    ...
    if (obj && "type" in obj && obj.type) {
      switch (obj.type) {
        case "DEFAULT":
          return model.CreateDatabaseToolsDatabaseApiGatewayConfigPoolAutoApiSpecDefaultDetails.getDeserializedJsonObj(
            <model.CreateDatabaseToolsDatabaseApiGatewayConfigPoolAutoApiSpecDefaultDetails>(
              (<object>jsonObj)
            ),
            true
