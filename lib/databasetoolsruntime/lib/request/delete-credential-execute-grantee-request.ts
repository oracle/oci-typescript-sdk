...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/databasetoolsruntime/DeleteCredentialExecuteGrantee.ts.html |here} to see how to use DeleteCredentialExecuteGranteeRequest.
 */
export interface DeleteCredentialExecuteGranteeRequest extends common.BaseRequest {
  /**
