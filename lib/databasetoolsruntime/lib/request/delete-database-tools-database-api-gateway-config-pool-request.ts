...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/databasetoolsruntime/DeleteDatabaseToolsDatabaseApiGatewayConfigPool.ts.html |here} to see how to use DeleteDatabaseToolsDatabaseApiGatewayConfigPoolRequest.
 */
export interface DeleteDatabaseToolsDatabaseApiGatewayConfigPoolRequest extends common.BaseRequest {
  /**
