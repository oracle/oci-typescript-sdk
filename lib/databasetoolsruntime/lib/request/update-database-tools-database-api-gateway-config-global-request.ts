...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/databasetoolsruntime/UpdateDatabaseToolsDatabaseApiGatewayConfigGlobal.ts.html |here} to see how to use UpdateDatabaseToolsDatabaseApiGatewayConfigGlobalRequest.
 */
export interface UpdateDatabaseToolsDatabaseApiGatewayConfigGlobalRequest
   ...
   */
  "globalKey": model.DatabaseApiGatewayConfigGlobalKey;
  /**
   * The information to be updated.
   */
  "updateDatabaseToolsDatabaseApiGatewayConfigGlobalDetails": model.UpdateDatabaseToolsDatabaseApiGatewayConfigGlobalDefaultDetails;
  /**
