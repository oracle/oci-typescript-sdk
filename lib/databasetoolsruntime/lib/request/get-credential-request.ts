...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/databasetoolsruntime/GetCredential.ts.html |here} to see how to use GetCredentialRequest.
 */
export interface GetCredentialRequest extends common.BaseRequest {
  /**
