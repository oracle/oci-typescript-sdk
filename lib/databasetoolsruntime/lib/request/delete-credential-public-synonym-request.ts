...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/databasetoolsruntime/DeleteCredentialPublicSynonym.ts.html |here} to see how to use DeleteCredentialPublicSynonymRequest.
 */
export interface DeleteCredentialPublicSynonymRequest extends common.BaseRequest {
  /**
