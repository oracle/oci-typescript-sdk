...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/databasetoolsruntime/UpdatePropertySet.ts.html |here} to see how to use UpdatePropertySetRequest.
 */
export interface UpdatePropertySetRequest extends common.BaseRequest {
  /**
   ...
   */
  "propertySetKey": model.PropertySetKey;
  /**
   * The information to be updated.
   */
  "updatePropertySetDetails":
    | model.UpdatePropertySetApexDocumentGeneratorDetails
    | model.UpdatePropertySetOracleDatabaseExternalAuthenticationDetails
    | model.UpdatePropertySetApexFaIntegrationDetails;
  /**
