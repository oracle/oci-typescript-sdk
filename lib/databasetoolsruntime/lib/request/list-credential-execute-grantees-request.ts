...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/databasetoolsruntime/ListCredentialExecuteGrantees.ts.html |here} to see how to use ListCredentialExecuteGranteesRequest.
 */
export interface ListCredentialExecuteGranteesRequest extends common.BaseRequest {
  /**
