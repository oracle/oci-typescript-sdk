...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/databasetoolsruntime/GetUserCredential.ts.html |here} to see how to use GetUserCredentialRequest.
 */
export interface GetUserCredentialRequest extends common.BaseRequest {
  /**
