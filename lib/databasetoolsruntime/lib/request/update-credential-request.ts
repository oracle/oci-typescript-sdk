...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/databasetoolsruntime/UpdateCredential.ts.html |here} to see how to use UpdateCredentialRequest.
 */
export interface UpdateCredentialRequest extends common.BaseRequest {
  /**
   ...
   */
  "updateCredentialDetails": model.UpdateCredentialBasicDetails;
  /**
