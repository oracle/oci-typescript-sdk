...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/databasetoolsruntime/UpdateDatabaseToolsDatabaseApiGatewayConfigPool.ts.html |here} to see how to use UpdateDatabaseToolsDatabaseApiGatewayConfigPoolRequest.
 */
export interface UpdateDatabaseToolsDatabaseApiGatewayConfigPoolRequest extends common.BaseRequest {
  /**
   ...
   */
  "updateDatabaseToolsDatabaseApiGatewayConfigPoolDetails": model.UpdateDatabaseToolsDatabaseApiGatewayConfigPoolDefaultDetails;
  /**
