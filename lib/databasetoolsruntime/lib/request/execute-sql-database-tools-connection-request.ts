...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/databasetoolsruntime/ExecuteSqlDatabaseToolsConnection.ts.html |here} to see how to use ExecuteSqlDatabaseToolsConnectionRequest.
 */
export interface ExecuteSqlDatabaseToolsConnectionRequest extends common.BaseRequest {
  /**
  ...
  "executeSqlDatabaseToolsConnectionDetails":
    | model.ExecuteSqlDatabaseToolsConnectionAsynchronousDetails
    | model.ExecuteSqlDatabaseToolsConnectionSynchronousDetails;
  /**
