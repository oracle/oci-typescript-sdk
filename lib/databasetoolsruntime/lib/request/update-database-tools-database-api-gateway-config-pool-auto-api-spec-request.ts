...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/databasetoolsruntime/UpdateDatabaseToolsDatabaseApiGatewayConfigPoolAutoApiSpec.ts.html |here} to see how to use UpdateDatabaseToolsDatabaseApiGatewayConfigPoolAutoApiSpecRequest.
 */
export interface UpdateDatabaseToolsDatabaseApiGatewayConfigPoolAutoApiSpecRequest
   ...
   */
  "updateDatabaseToolsDatabaseApiGatewayConfigPoolAutoApiSpecDetails": model.UpdateDatabaseToolsDatabaseApiGatewayConfigPoolAutoApiSpecDefaultDetails;
  /**
