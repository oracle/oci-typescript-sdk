...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/databasetoolsruntime/ListCredentials.ts.html |here} to see how to use ListCredentialsRequest.
 */
export interface ListCredentialsRequest extends common.BaseRequest {
  /**
