...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/databasetoolsruntime/GetDatabaseToolsDatabaseApiGatewayConfigPool.ts.html |here} to see how to use GetDatabaseToolsDatabaseApiGatewayConfigPoolRequest.
 */
export interface GetDatabaseToolsDatabaseApiGatewayConfigPoolRequest extends common.BaseRequest {
  /**
