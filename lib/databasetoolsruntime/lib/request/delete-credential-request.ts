...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/databasetoolsruntime/DeleteCredential.ts.html |here} to see how to use DeleteCredentialRequest.
 */
export interface DeleteCredentialRequest extends common.BaseRequest {
  /**
