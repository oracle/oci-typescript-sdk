...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/databasetoolsruntime/GetPropertySet.ts.html |here} to see how to use GetPropertySetRequest.
 */
export interface GetPropertySetRequest extends common.BaseRequest {
  /**
