...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/databasetoolsruntime/CreateCredentialPublicSynonym.ts.html |here} to see how to use CreateCredentialPublicSynonymRequest.
 */
export interface CreateCredentialPublicSynonymRequest extends common.BaseRequest {
  /**
   ...
   */
  "createCredentialPublicSynonymDetails": model.CreateCredentialPublicSynonymDetails;
  /**
