...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/databasetoolsruntime/DeleteDatabaseToolsDatabaseApiGatewayConfigPoolAutoApiSpec.ts.html |here} to see how to use DeleteDatabaseToolsDatabaseApiGatewayConfigPoolAutoApiSpecRequest.
 */
export interface DeleteDatabaseToolsDatabaseApiGatewayConfigPoolAutoApiSpecRequest
