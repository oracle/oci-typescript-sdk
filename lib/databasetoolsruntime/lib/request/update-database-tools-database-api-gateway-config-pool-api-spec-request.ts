...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/databasetoolsruntime/UpdateDatabaseToolsDatabaseApiGatewayConfigPoolApiSpec.ts.html |here} to see how to use UpdateDatabaseToolsDatabaseApiGatewayConfigPoolApiSpecRequest.
 */
export interface UpdateDatabaseToolsDatabaseApiGatewayConfigPoolApiSpecRequest
   ...
   */
  "updateDatabaseToolsDatabaseApiGatewayConfigPoolApiSpecDetails": model.UpdateDatabaseToolsDatabaseApiGatewayConfigPoolApiSpecDefaultDetails;
  /**
