...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/databasetoolsruntime/GetDatabaseToolsDatabaseApiGatewayConfigPoolApiSpec.ts.html |here} to see how to use GetDatabaseToolsDatabaseApiGatewayConfigPoolApiSpecRequest.
 */
export interface GetDatabaseToolsDatabaseApiGatewayConfigPoolApiSpecRequest
