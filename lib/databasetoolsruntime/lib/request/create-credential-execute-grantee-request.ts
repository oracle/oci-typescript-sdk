...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/databasetoolsruntime/CreateCredentialExecuteGrantee.ts.html |here} to see how to use CreateCredentialExecuteGranteeRequest.
 */
export interface CreateCredentialExecuteGranteeRequest extends common.BaseRequest {
  /**
   ...
   */
  "createCredentialExecuteGranteeDetails": model.CreateCredentialExecuteGranteeDetails;
  /**
