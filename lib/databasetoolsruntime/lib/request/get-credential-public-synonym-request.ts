...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/databasetoolsruntime/GetCredentialPublicSynonym.ts.html |here} to see how to use GetCredentialPublicSynonymRequest.
 */
export interface GetCredentialPublicSynonymRequest extends common.BaseRequest {
  /**
