...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/databasetoolsruntime/ListCredentialPublicSynonyms.ts.html |here} to see how to use ListCredentialPublicSynonymsRequest.
 */
export interface ListCredentialPublicSynonymsRequest extends common.BaseRequest {
  /**
