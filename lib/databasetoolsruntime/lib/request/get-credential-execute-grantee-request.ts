...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/databasetoolsruntime/GetCredentialExecuteGrantee.ts.html |here} to see how to use GetCredentialExecuteGranteeRequest.
 */
export interface GetCredentialExecuteGranteeRequest extends common.BaseRequest {
  /**
