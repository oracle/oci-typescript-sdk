...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/databasetoolsruntime/GetDatabaseToolsDatabaseApiGatewayConfigGlobal.ts.html |here} to see how to use GetDatabaseToolsDatabaseApiGatewayConfigGlobalRequest.
 */
export interface GetDatabaseToolsDatabaseApiGatewayConfigGlobalRequest extends common.BaseRequest {
  /**
