...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/databasetoolsruntime/ListUserCredentials.ts.html |here} to see how to use ListUserCredentialsRequest.
 */
export interface ListUserCredentialsRequest extends common.BaseRequest {
  /**
