...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/databasetoolsruntime/GetDatabaseToolsDatabaseApiGatewayConfigContent.ts.html |here} to see how to use GetDatabaseToolsDatabaseApiGatewayConfigContentRequest.
 */
export interface GetDatabaseToolsDatabaseApiGatewayConfigContentRequest extends common.BaseRequest {
  /**
