...
export namespace TextBasedEula {
  export function getJsonObj(obj: TextBasedEula, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj ? obj : (model.Eula.getJsonObj(obj) as TextBasedEula)),
      ...{}
    };
