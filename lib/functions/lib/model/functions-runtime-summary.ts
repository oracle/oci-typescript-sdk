 ...
 */
export interface FunctionsRuntimeSummary {
  /**
...
export namespace FunctionsRuntimeSummary {
  export function getJsonObj(obj: FunctionsRuntimeSummary): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: FunctionsRuntimeSummary): object {
    const jsonObj = { ...obj, ...{} };
