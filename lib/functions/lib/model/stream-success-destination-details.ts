...
export namespace StreamSuccessDestinationDetails {
  export function getJsonObj(
    obj: StreamSuccessDestinationDetails,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.SuccessDestinationDetails.getJsonObj(obj) as StreamSuccessDestinationDetails)),
      ...{}
    };
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ...
        : (model.SuccessDestinationDetails.getDeserializedJsonObj(
            obj
          ) as StreamSuccessDestinationDetails)),
      ...{}
    };
