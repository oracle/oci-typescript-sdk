...
export interface CreateFunctionDetails {
  ...
  "sourceDetails":
    | model.CreatePreBuiltFunctionSourceDetails
    | model.CreateArchiveFunctionSourceDetails
    | model.CreateContainerImageFunctionSourceDetails;
  /**
...
export namespace CreateFunctionDetails {
    ...
    const jsonObj = {
      ...
      ...{
        "sourceDetails": obj.sourceDetails
          ? model.CreateFunctionSourceDetails.getJsonObj(obj.sourceDetails)
          : undefined,
  ...
  export function getDeserializedJsonObj(obj: CreateFunctionDetails): object {
    const jsonObj = {
      ...
      ...{
        "sourceDetails": obj.sourceDetails
          ? model.CreateFunctionSourceDetails.getDeserializedJsonObj(obj.sourceDetails)
          : undefined,
