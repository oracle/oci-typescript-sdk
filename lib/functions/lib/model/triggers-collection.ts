...
export namespace TriggersCollection {
  export function getJsonObj(obj: TriggersCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
  ...
  export function getDeserializedJsonObj(obj: TriggersCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
