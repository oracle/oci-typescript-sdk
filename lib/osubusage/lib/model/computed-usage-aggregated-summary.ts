...
export namespace ComputedUsageAggregatedSummary {
  ...
  export function getJsonObj(obj: ComputedUsageAggregatedSummary): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: ComputedUsageAggregatedSummary): object {
    const jsonObj = {
      ...obj,
      ...{
        "parentProduct": obj.parentProduct
