...
export namespace ComputedUsageSummary {
  export enum Type {
    Promotion = "PROMOTION",
  ...
  export function getJsonObj(obj: ComputedUsageSummary): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: ComputedUsageSummary): object {
    const jsonObj = {
      ...obj,
      ...{
        "parentProduct": obj.parentProduct
