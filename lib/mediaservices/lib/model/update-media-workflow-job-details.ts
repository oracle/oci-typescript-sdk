...
export namespace UpdateMediaWorkflowJobDetails {
  export function getJsonObj(obj: UpdateMediaWorkflowJobDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: UpdateMediaWorkflowJobDetails): object {
    const jsonObj = { ...obj, ...{} };
