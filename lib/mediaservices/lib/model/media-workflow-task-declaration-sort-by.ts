 ...
 **/
export enum MediaWorkflowTaskDeclarationSortBy {
  Name = "name",
  Version = "version"
}

export namespace MediaWorkflowTaskDeclarationSortBy {
  export function getJsonObj(
    obj: MediaWorkflowTaskDeclarationSortBy
  ): MediaWorkflowTaskDeclarationSortBy {
    return obj;
  }
