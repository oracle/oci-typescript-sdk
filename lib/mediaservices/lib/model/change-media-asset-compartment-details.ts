...
export namespace ChangeMediaAssetCompartmentDetails {
  export function getJsonObj(obj: ChangeMediaAssetCompartmentDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: ChangeMediaAssetCompartmentDetails): object {
    const jsonObj = { ...obj, ...{} };
