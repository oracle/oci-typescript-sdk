...
export namespace ChangeStreamDistributionChannelCompartmentDetails {
  export function getJsonObj(obj: ChangeStreamDistributionChannelCompartmentDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(
    obj: ChangeStreamDistributionChannelCompartmentDetails
  ): object {
    const jsonObj = { ...obj, ...{} };
