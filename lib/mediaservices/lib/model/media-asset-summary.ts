...
export namespace MediaAssetSummary {
  export function getJsonObj(obj: MediaAssetSummary): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: MediaAssetSummary): object {
    const jsonObj = { ...obj, ...{} };
