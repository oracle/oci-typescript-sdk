...
export namespace ChangeMediaWorkflowConfigurationCompartmentDetails {
  export function getJsonObj(obj: ChangeMediaWorkflowConfigurationCompartmentDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(
    obj: ChangeMediaWorkflowConfigurationCompartmentDetails
  ): object {
    const jsonObj = { ...obj, ...{} };
