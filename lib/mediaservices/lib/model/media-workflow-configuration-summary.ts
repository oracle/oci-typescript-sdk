...
export namespace MediaWorkflowConfigurationSummary {
  export function getJsonObj(obj: MediaWorkflowConfigurationSummary): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: MediaWorkflowConfigurationSummary): object {
    const jsonObj = { ...obj, ...{} };
