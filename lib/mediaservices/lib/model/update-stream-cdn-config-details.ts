...
export namespace UpdateStreamCdnConfigDetails {
  export function getJsonObj(obj: UpdateStreamCdnConfigDetails): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: UpdateStreamCdnConfigDetails): object {
    const jsonObj = {
      ...obj,
      ...{
        "config": obj.config
