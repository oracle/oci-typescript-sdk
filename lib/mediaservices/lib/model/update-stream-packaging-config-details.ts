...
export namespace UpdateStreamPackagingConfigDetails {
  export function getJsonObj(obj: UpdateStreamPackagingConfigDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: UpdateStreamPackagingConfigDetails): object {
    const jsonObj = { ...obj, ...{} };
