 ...
 **/
export enum MediaAssetDistributionChannelAttachmentSortBy {
...
export namespace MediaAssetDistributionChannelAttachmentSortBy {
  export function getJsonObj(
    obj: MediaAssetDistributionChannelAttachmentSortBy
