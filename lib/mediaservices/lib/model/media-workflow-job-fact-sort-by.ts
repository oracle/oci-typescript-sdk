...
/**
 * Sort by field for the Media Workflow Job Fact.
 **/
export enum MediaWorkflowJobFactSortBy {
  Key = "key"
}

export namespace MediaWorkflowJobFactSortBy {
  export function getJsonObj(obj: MediaWorkflowJobFactSortBy): MediaWorkflowJobFactSortBy {
    return obj;
  }
  export function getDeserializedJsonObj(
    obj: MediaWorkflowJobFactSortBy
  ): MediaWorkflowJobFactSortBy {
    return obj;
  }
}
