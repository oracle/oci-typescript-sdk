...
export namespace UpdateMediaWorkflowDetails {
  export function getJsonObj(obj: UpdateMediaWorkflowDetails): object {
    const jsonObj = {
      ...obj,
      ...{
        "tasks": obj.tasks
  ...
  export function getDeserializedJsonObj(obj: UpdateMediaWorkflowDetails): object {
    const jsonObj = {
      ...obj,
      ...{
        "tasks": obj.tasks
