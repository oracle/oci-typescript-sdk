...
export namespace GenerateSessionTokenDetails {
  export enum Scopes {
    Playlist = "PLAYLIST",
    Edge = "EDGE"
  }

  export function getJsonObj(obj: GenerateSessionTokenDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: GenerateSessionTokenDetails): object {
    const jsonObj = { ...obj, ...{} };
