...
export namespace MediaAssetCollection {
  export function getJsonObj(obj: MediaAssetCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
  ...
  export function getDeserializedJsonObj(obj: MediaAssetCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
