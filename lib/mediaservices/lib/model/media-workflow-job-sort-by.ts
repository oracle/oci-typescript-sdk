 ...
 **/
export enum MediaWorkflowJobSortBy {
  TimeCreated = "timeCreated",
  WorkflowId = "workflowId",
  LifecycleState = "lifecycleState"
}

export namespace MediaWorkflowJobSortBy {
  export function getJsonObj(obj: MediaWorkflowJobSortBy): MediaWorkflowJobSortBy {
    return obj;
  }
  export function getDeserializedJsonObj(obj: MediaWorkflowJobSortBy): MediaWorkflowJobSortBy {
    return obj;
  }
}
