...
export namespace SystemMediaWorkflowCollection {
  export function getJsonObj(obj: SystemMediaWorkflowCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
  ...
  export function getDeserializedJsonObj(obj: SystemMediaWorkflowCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
