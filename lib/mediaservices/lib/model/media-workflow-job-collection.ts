...
export namespace MediaWorkflowJobCollection {
  export function getJsonObj(obj: MediaWorkflowJobCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
  ...
  export function getDeserializedJsonObj(obj: MediaWorkflowJobCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
