...
export namespace StreamDistributionChannelSummary {
  export function getJsonObj(obj: StreamDistributionChannelSummary): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: StreamDistributionChannelSummary): object {
    const jsonObj = { ...obj, ...{} };
