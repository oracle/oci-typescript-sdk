...
export namespace StreamPackagingConfigSummary {
  export function getJsonObj(obj: StreamPackagingConfigSummary): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: StreamPackagingConfigSummary): object {
    const jsonObj = { ...obj, ...{} };
