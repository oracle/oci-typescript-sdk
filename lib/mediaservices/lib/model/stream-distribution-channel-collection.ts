...
export namespace StreamDistributionChannelCollection {
  export function getJsonObj(obj: StreamDistributionChannelCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
  ...
  export function getDeserializedJsonObj(obj: StreamDistributionChannelCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
