...
export namespace ChangeMediaWorkflowJobCompartmentDetails {
  export function getJsonObj(obj: ChangeMediaWorkflowJobCompartmentDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: ChangeMediaWorkflowJobCompartmentDetails): object {
    const jsonObj = { ...obj, ...{} };
