...
export namespace ChangeMediaWorkflowCompartmentDetails {
  export function getJsonObj(obj: ChangeMediaWorkflowCompartmentDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: ChangeMediaWorkflowCompartmentDetails): object {
    const jsonObj = { ...obj, ...{} };
