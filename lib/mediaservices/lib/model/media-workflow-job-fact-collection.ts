 ...
 *
 */
export interface MediaWorkflowJobFactCollection {
  /**
   * List of mediaWorkflowJob items.
   */
  "items": Array<model.MediaWorkflowJobFactSummary>;
}

export namespace MediaWorkflowJobFactCollection {
  export function getJsonObj(obj: MediaWorkflowJobFactCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
          ? obj.items.map(item => {
              return model.MediaWorkflowJobFactSummary.getJsonObj(item);
            })
          : undefined
      }
    };
  ...
  export function getDeserializedJsonObj(obj: MediaWorkflowJobFactCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
          ? obj.items.map(item => {
              return model.MediaWorkflowJobFactSummary.getDeserializedJsonObj(item);
            })
          : undefined
      }
    };
