 ...
 *
 */
export interface MediaWorkflowJobFactSummary {
  /**
...
export namespace MediaWorkflowJobFactSummary {
  export function getJsonObj(obj: MediaWorkflowJobFactSummary): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: MediaWorkflowJobFactSummary): object {
    const jsonObj = { ...obj, ...{} };
