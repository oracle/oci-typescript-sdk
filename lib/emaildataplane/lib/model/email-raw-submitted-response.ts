...
export namespace EmailRawSubmittedResponse {
  export function getJsonObj(obj: EmailRawSubmittedResponse): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: EmailRawSubmittedResponse): object {
    const jsonObj = { ...obj, ...{} };
