...
/**
 * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/dataintegration/ListRuntimePipelines.ts.html |here} to see how to use ListRuntimePipelinesRequest.
 */
...
export namespace ListRuntimePipelinesRequest {
