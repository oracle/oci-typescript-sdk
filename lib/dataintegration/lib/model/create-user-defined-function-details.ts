...
export namespace CreateUserDefinedFunctionDetails {
  export function getJsonObj(obj: CreateUserDefinedFunctionDetails): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: CreateUserDefinedFunctionDetails): object {
    const jsonObj = {
      ...obj,
      ...{
