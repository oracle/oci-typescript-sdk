...
export namespace ConnectionSummaryFromOraclePeopleSoft {
  export function getJsonObj(
    obj: ConnectionSummaryFromOraclePeopleSoft,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.ConnectionSummary.getJsonObj(obj) as ConnectionSummaryFromOraclePeopleSoft)),
      ...{
  ...
  export const modelType = "ORACLE_PEOPLESOFT_CONNECTION";
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ...
        : (model.ConnectionSummary.getDeserializedJsonObj(
            obj
          ) as ConnectionSummaryFromOraclePeopleSoft)),
      ...{
        "passwordSecret": obj.passwordSecret
