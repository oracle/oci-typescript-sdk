...
export namespace FunctionLibrarySummary {
  ...
  export function getJsonObj(obj: FunctionLibrarySummary): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: FunctionLibrarySummary): object {
    const jsonObj = {
      ...obj,
      ...{
