...
export namespace ConnectionFromAmazonS3Details {
  export function getJsonObj(
    obj: ConnectionFromAmazonS3Details,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.ConnectionDetails.getJsonObj(obj) as ConnectionFromAmazonS3Details)),
      ...{
  ...
  export function getDeserializedJsonObj(
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.ConnectionDetails.getDeserializedJsonObj(obj) as ConnectionFromAmazonS3Details)),
      ...{
