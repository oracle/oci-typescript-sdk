...
export namespace CreateTaskFromSQLTask {
  ...
  export function getJsonObj(obj: CreateTaskFromSQLTask, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.CreateTaskDetails.getJsonObj(obj) as CreateTaskFromSQLTask)),
      ...{
  ...
  export function getDeserializedJsonObj(
    obj: CreateTaskFromSQLTask,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.CreateTaskDetails.getDeserializedJsonObj(obj) as CreateTaskFromSQLTask)),
      ...{
