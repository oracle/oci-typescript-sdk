...
export namespace ConnectionSummaryFromRestBasicAuth {
  export function getJsonObj(
    obj: ConnectionSummaryFromRestBasicAuth,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.ConnectionSummary.getJsonObj(obj) as ConnectionSummaryFromRestBasicAuth)),
      ...{
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ...
        : (model.ConnectionSummary.getDeserializedJsonObj(
            obj
          ) as ConnectionSummaryFromRestBasicAuth)),
      ...{
        "passwordSecret": obj.passwordSecret
