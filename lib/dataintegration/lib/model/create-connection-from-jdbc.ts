...
export namespace CreateConnectionFromJdbc {
  export function getJsonObj(obj: CreateConnectionFromJdbc, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
  ...
  export function getDeserializedJsonObj(
    obj: CreateConnectionFromJdbc,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.CreateConnectionDetails.getDeserializedJsonObj(obj) as CreateConnectionFromJdbc)),
      ...{
        "passwordSecret": obj.passwordSecret
