...
export namespace TaskFromRestTaskDetails {
  ...
  export function getJsonObj(obj: TaskFromRestTaskDetails, isParentJsonObj?: boolean): object {
    const jsonObj = {
  ...
  export function getDeserializedJsonObj(
    obj: TaskFromRestTaskDetails,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.Task.getDeserializedJsonObj(obj) as TaskFromRestTaskDetails)),
      ...{
