...
export namespace ConnectionFromAdwcDetails {
  export function getJsonObj(obj: ConnectionFromAdwcDetails, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.ConnectionDetails.getJsonObj(obj) as ConnectionFromAdwcDetails)),
      ...{
  ...
  export function getDeserializedJsonObj(
    obj: ConnectionFromAdwcDetails,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.ConnectionDetails.getDeserializedJsonObj(obj) as ConnectionFromAdwcDetails)),
      ...{
        "passwordSecret": obj.passwordSecret
