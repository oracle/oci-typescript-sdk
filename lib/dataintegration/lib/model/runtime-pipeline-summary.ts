...
export namespace RuntimePipelineSummary {
  export function getJsonObj(obj: RuntimePipelineSummary): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: RuntimePipelineSummary): object {
    const jsonObj = {
      ...obj,
      ...{
