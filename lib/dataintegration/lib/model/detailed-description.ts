...
export namespace DetailedDescription {
  ...
  export function getJsonObj(obj: DetailedDescription): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: DetailedDescription): object {
    const jsonObj = {
      ...obj,
      ...{
