...
export namespace DataAssetFromOraclePeopleSoftDetails {
  export function getJsonObj(
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.DataAsset.getJsonObj(obj) as DataAssetFromOraclePeopleSoftDetails)),
      ...{
  ...
  export function getDeserializedJsonObj(
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.DataAsset.getDeserializedJsonObj(obj) as DataAssetFromOraclePeopleSoftDetails)),
      ...{
        "walletSecret": obj.walletSecret
        ...
        "walletPasswordSecret": obj.walletPasswordSecret
          ...
          : undefined,
        "defaultConnection": obj.defaultConnection
          ? model.ConnectionFromOraclePeopleSoftDetails.getDeserializedJsonObj(
