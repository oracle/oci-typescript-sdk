...
export namespace DisApplicationSummary {
  ...
  export function getJsonObj(obj: DisApplicationSummary): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: DisApplicationSummary): object {
    const jsonObj = {
      ...obj,
      ...{
