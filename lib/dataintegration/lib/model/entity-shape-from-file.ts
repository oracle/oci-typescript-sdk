...
export namespace EntityShapeFromFile {
  ...
  export function getJsonObj(obj: EntityShapeFromFile, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj ? obj : (model.EntityShape.getJsonObj(obj) as EntityShapeFromFile)),
      ...{
  ...
  export function getDeserializedJsonObj(
    obj: EntityShapeFromFile,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.EntityShape.getDeserializedJsonObj(obj) as EntityShapeFromFile)),
      ...{
