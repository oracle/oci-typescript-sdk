...
export namespace ConnectionSummaryFromObjectStorage {
  export function getJsonObj(
    obj: ConnectionSummaryFromObjectStorage,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.ConnectionSummary.getJsonObj(obj) as ConnectionSummaryFromObjectStorage)),
      ...{}
    };
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ...
        : (model.ConnectionSummary.getDeserializedJsonObj(
            obj
          ) as ConnectionSummaryFromObjectStorage)),
      ...{}
    };
