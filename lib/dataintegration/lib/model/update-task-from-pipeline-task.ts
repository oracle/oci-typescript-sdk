...
export namespace UpdateTaskFromPipelineTask {
  export function getJsonObj(obj: UpdateTaskFromPipelineTask, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.UpdateTaskDetails.getJsonObj(obj) as UpdateTaskFromPipelineTask)),
      ...{
  ...
  export function getDeserializedJsonObj(
    obj: UpdateTaskFromPipelineTask,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.UpdateTaskDetails.getDeserializedJsonObj(obj) as UpdateTaskFromPipelineTask)),
      ...{
