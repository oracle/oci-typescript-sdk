...
export namespace UserDefinedFunctionSummary {
  ...
  export function getJsonObj(obj: UserDefinedFunctionSummary): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: UserDefinedFunctionSummary): object {
    const jsonObj = {
      ...obj,
      ...{
