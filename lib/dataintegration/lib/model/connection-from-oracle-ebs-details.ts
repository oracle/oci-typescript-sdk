...
export namespace ConnectionFromOracleEbsDetails {
  export function getJsonObj(
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.ConnectionDetails.getJsonObj(obj) as ConnectionFromOracleEbsDetails)),
      ...{
  ...
  export const modelType = "ORACLE_EBS_CONNECTION";
  export function getDeserializedJsonObj(
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.ConnectionDetails.getDeserializedJsonObj(obj) as ConnectionFromOracleEbsDetails)),
      ...{
        "passwordSecret": obj.passwordSecret
