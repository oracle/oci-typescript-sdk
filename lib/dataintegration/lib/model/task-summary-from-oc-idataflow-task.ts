...
export namespace TaskSummaryFromOCIDataflowTask {
  export function getJsonObj(
    obj: TaskSummaryFromOCIDataflowTask,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.TaskSummary.getJsonObj(obj) as TaskSummaryFromOCIDataflowTask)),
      ...{
  ...
  export function getDeserializedJsonObj(
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.TaskSummary.getDeserializedJsonObj(obj) as TaskSummaryFromOCIDataflowTask)),
      ...{
        "dataflowApplication": obj.dataflowApplication
