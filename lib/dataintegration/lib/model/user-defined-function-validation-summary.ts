...
export namespace UserDefinedFunctionValidationSummary {
  export function getJsonObj(obj: UserDefinedFunctionValidationSummary): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: UserDefinedFunctionValidationSummary): object {
    const jsonObj = {
      ...obj,
      ...{
