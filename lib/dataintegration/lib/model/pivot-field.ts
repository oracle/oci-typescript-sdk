...
export namespace PivotField {
  export function getJsonObj(obj: PivotField, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj ? obj : (model.TypedObject.getJsonObj(obj) as PivotField)),
      ...{
  ...
  export const modelType = "PIVOT_FIELD";
  export function getDeserializedJsonObj(obj: PivotField, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj ? obj : (model.TypedObject.getDeserializedJsonObj(obj) as PivotField)),
      ...{
