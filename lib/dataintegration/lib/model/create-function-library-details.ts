...
export namespace CreateFunctionLibraryDetails {
  export function getJsonObj(obj: CreateFunctionLibraryDetails): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: CreateFunctionLibraryDetails): object {
    const jsonObj = {
      ...obj,
      ...{
        "registryMetadata": obj.registryMetadata
