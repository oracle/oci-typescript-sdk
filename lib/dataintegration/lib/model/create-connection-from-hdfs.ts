...
export namespace CreateConnectionFromHdfs {
  export function getJsonObj(obj: CreateConnectionFromHdfs, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.CreateConnectionDetails.getJsonObj(obj) as CreateConnectionFromHdfs)),
      ...{
  ...
  export function getDeserializedJsonObj(
    obj: CreateConnectionFromHdfs,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.CreateConnectionDetails.getDeserializedJsonObj(obj) as CreateConnectionFromHdfs)),
      ...{
        "keyTabContent": obj.keyTabContent
