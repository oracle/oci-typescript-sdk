...
export namespace DataAssetSummaryFromOracleSiebel {
  export function getJsonObj(
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.DataAssetSummary.getJsonObj(obj) as DataAssetSummaryFromOracleSiebel)),
      ...{
  ...
  export function getDeserializedJsonObj(
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.DataAssetSummary.getDeserializedJsonObj(obj) as DataAssetSummaryFromOracleSiebel)),
      ...{
        "walletSecret": obj.walletSecret
