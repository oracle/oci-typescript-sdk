...
export namespace UserDefinedFunctionValidation {
  export function getJsonObj(obj: UserDefinedFunctionValidation): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: UserDefinedFunctionValidation): object {
    const jsonObj = {
      ...obj,
      ...{
