...
export namespace CreateDataFlowValidationDetails {
  export function getJsonObj(obj: CreateDataFlowValidationDetails): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: CreateDataFlowValidationDetails): object {
    const jsonObj = {
      ...obj,
      ...{
