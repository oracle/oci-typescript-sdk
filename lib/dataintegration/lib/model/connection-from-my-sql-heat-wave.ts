...
export namespace ConnectionFromMySqlHeatWave {
  export function getJsonObj(obj: ConnectionFromMySqlHeatWave, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.Connection.getJsonObj(obj) as ConnectionFromMySqlHeatWave)),
      ...{
  ...
  export function getDeserializedJsonObj(
    obj: ConnectionFromMySqlHeatWave,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.Connection.getDeserializedJsonObj(obj) as ConnectionFromMySqlHeatWave)),
      ...{
        "passwordSecret": obj.passwordSecret
