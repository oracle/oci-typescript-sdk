  ...
  export function getJsonObj(obj: DataEntitySummary): object {
    ...
    if (obj && "modelType" in obj && obj.modelType) {
      switch (obj.modelType) {
        ...
        case "OBJECT_ENTITY":
          return model.DataEntitySummaryFromObject.getJsonObj(
            <model.DataEntitySummaryFromObject>(<object>jsonObj),
            true
          );
        case "TABLE_ENTITY":
  ...
  export function getDeserializedJsonObj(obj: DataEntitySummary): object {
    ...
    if (obj && "modelType" in obj && obj.modelType) {
      switch (obj.modelType) {
        ...
        case "OBJECT_ENTITY":
          return model.DataEntitySummaryFromObject.getDeserializedJsonObj(
            <model.DataEntitySummaryFromObject>(<object>jsonObj),
            true
          );
        case "TABLE_ENTITY":
