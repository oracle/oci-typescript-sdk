...
export namespace FunctionLibraryDetails {
  export enum ModelType {
    FunctionLibrary = "FUNCTION_LIBRARY"
  }

  export function getJsonObj(obj: FunctionLibraryDetails): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: FunctionLibraryDetails): object {
    const jsonObj = {
      ...obj,
      ...{
