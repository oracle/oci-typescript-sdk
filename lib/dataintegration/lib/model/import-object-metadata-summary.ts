...
export namespace ImportObjectMetadataSummary {
  ...
  export function getJsonObj(obj: ImportObjectMetadataSummary): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: ImportObjectMetadataSummary): object {
    const jsonObj = { ...obj, ...{} };
