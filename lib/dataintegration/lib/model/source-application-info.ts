...
export namespace SourceApplicationInfo {
  export function getJsonObj(obj: SourceApplicationInfo): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: SourceApplicationInfo): object {
    const jsonObj = { ...obj, ...{} };
