...
export namespace UpdateDataFlowDetails {
  export function getJsonObj(obj: UpdateDataFlowDetails): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: UpdateDataFlowDetails): object {
    const jsonObj = {
      ...obj,
      ...{
