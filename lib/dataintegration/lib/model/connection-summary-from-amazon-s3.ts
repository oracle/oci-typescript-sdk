...
export namespace ConnectionSummaryFromAmazonS3 {
  export function getJsonObj(
    obj: ConnectionSummaryFromAmazonS3,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.ConnectionSummary.getJsonObj(obj) as ConnectionSummaryFromAmazonS3)),
      ...{
  ...
  export function getDeserializedJsonObj(
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.ConnectionSummary.getDeserializedJsonObj(obj) as ConnectionSummaryFromAmazonS3)),
      ...{
