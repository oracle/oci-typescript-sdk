...
export namespace PipelineValidation {
  export function getJsonObj(obj: PipelineValidation): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: PipelineValidation): object {
    const jsonObj = {
      ...obj,
      ...{
