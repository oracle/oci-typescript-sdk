...
export namespace ImportConflictResolution {
  export enum ImportConflictResolutionType {
    Duplicate = "DUPLICATE",
    Replace = "REPLACE",
    Retain = "RETAIN",
    /**
  ...
  export function getJsonObj(obj: ImportConflictResolution): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: ImportConflictResolution): object {
    const jsonObj = { ...obj, ...{} };
