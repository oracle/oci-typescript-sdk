...
export namespace FunctionLibrary {
  ...
  export function getJsonObj(obj: FunctionLibrary): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: FunctionLibrary): object {
    const jsonObj = {
      ...obj,
      ...{
