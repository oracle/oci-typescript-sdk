...
export namespace ConnectionFromHdfsDetails {
  export function getJsonObj(obj: ConnectionFromHdfsDetails, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.ConnectionDetails.getJsonObj(obj) as ConnectionFromHdfsDetails)),
      ...{
  ...
  export function getDeserializedJsonObj(
    obj: ConnectionFromHdfsDetails,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.ConnectionDetails.getDeserializedJsonObj(obj) as ConnectionFromHdfsDetails)),
      ...{
        "keyTabContent": obj.keyTabContent
