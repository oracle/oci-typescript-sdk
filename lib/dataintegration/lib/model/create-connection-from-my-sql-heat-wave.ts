...
export namespace CreateConnectionFromMySqlHeatWave {
  export function getJsonObj(
    obj: CreateConnectionFromMySqlHeatWave,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.CreateConnectionDetails.getJsonObj(obj) as CreateConnectionFromMySqlHeatWave)),
      ...{
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ...
        : (model.CreateConnectionDetails.getDeserializedJsonObj(
            obj
          ) as CreateConnectionFromMySqlHeatWave)),
      ...{
        "passwordSecret": obj.passwordSecret
