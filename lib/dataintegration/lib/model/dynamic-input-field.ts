...
export namespace DynamicInputField {
  export function getJsonObj(obj: DynamicInputField, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj ? obj : (model.TypedObject.getJsonObj(obj) as DynamicInputField)),
      ...{
