...
export namespace CreateConnectionFromRestBasicAuth {
  export function getJsonObj(
    obj: CreateConnectionFromRestBasicAuth,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.CreateConnectionDetails.getJsonObj(obj) as CreateConnectionFromRestBasicAuth)),
      ...{
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ...
        : (model.CreateConnectionDetails.getDeserializedJsonObj(
            obj
          ) as CreateConnectionFromRestBasicAuth)),
      ...{
        "passwordSecret": obj.passwordSecret
