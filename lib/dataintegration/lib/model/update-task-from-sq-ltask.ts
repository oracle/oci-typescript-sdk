...
export namespace UpdateTaskFromSQLTask {
  export enum SqlScriptType {
    StoredProcedure = "STORED_PROCEDURE",
    SqlCode = "SQL_CODE"
  }

  export function getJsonObj(obj: UpdateTaskFromSQLTask, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.UpdateTaskDetails.getJsonObj(obj) as UpdateTaskFromSQLTask)),
      ...{
  ...
  export function getDeserializedJsonObj(
    obj: UpdateTaskFromSQLTask,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.UpdateTaskDetails.getDeserializedJsonObj(obj) as UpdateTaskFromSQLTask)),
      ...{
