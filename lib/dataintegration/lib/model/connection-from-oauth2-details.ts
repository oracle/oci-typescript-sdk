...
export namespace ConnectionFromOAuth2Details {
  ...
  export function getJsonObj(obj: ConnectionFromOAuth2Details, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.ConnectionDetails.getJsonObj(obj) as ConnectionFromOAuth2Details)),
      ...{
  ...
  export function getDeserializedJsonObj(
    obj: ConnectionFromOAuth2Details,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.ConnectionDetails.getDeserializedJsonObj(obj) as ConnectionFromOAuth2Details)),
      ...{
        "clientSecret": obj.clientSecret
