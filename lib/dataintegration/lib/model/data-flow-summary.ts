...
export namespace DataFlowSummary {
  export function getJsonObj(obj: DataFlowSummary): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: DataFlowSummary): object {
    const jsonObj = {
      ...obj,
      ...{
