...
export namespace TaskSummaryFromPipelineTask {
  export function getJsonObj(obj: TaskSummaryFromPipelineTask, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.TaskSummary.getJsonObj(obj) as TaskSummaryFromPipelineTask)),
      ...{
  ...
  export function getDeserializedJsonObj(
    obj: TaskSummaryFromPipelineTask,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.TaskSummary.getDeserializedJsonObj(obj) as TaskSummaryFromPipelineTask)),
      ...{
