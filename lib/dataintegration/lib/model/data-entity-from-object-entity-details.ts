...
export namespace DataEntityFromObjectEntityDetails {
  ...
  export function getJsonObj(
    obj: DataEntityFromObjectEntityDetails,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.DataEntityDetails.getJsonObj(obj) as DataEntityFromObjectEntityDetails)),
      ...{
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ...
        : (model.DataEntityDetails.getDeserializedJsonObj(
            obj
          ) as DataEntityFromObjectEntityDetails)),
      ...{
