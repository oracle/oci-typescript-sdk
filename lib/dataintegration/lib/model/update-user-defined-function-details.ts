...
export namespace UpdateUserDefinedFunctionDetails {
  export function getJsonObj(obj: UpdateUserDefinedFunctionDetails): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: UpdateUserDefinedFunctionDetails): object {
    const jsonObj = {
      ...obj,
      ...{
