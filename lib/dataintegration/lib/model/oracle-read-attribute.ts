...
export namespace OracleReadAttribute {
  export function getJsonObj(obj: OracleReadAttribute, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.AbstractReadAttribute.getJsonObj(obj) as OracleReadAttribute)),
      ...{}
    };
