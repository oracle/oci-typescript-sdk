...
export namespace UserDefinedFunctionDetails {
  export enum ModelType {
    DisUserDefinedFunction = "DIS_USER_DEFINED_FUNCTION"
  }

  export function getJsonObj(obj: UserDefinedFunctionDetails): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: UserDefinedFunctionDetails): object {
    const jsonObj = {
      ...obj,
      ...{
