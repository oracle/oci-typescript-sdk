...
export namespace ConnectionFromBICCDetails {
  export function getJsonObj(obj: ConnectionFromBICCDetails, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.ConnectionDetails.getJsonObj(obj) as ConnectionFromBICCDetails)),
      ...{
  ...
  export function getDeserializedJsonObj(
    obj: ConnectionFromBICCDetails,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.ConnectionDetails.getDeserializedJsonObj(obj) as ConnectionFromBICCDetails)),
      ...{
        "passwordSecret": obj.passwordSecret
