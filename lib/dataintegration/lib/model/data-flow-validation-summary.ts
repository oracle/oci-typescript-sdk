...
export namespace DataFlowValidationSummary {
  export function getJsonObj(obj: DataFlowValidationSummary): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: DataFlowValidationSummary): object {
    const jsonObj = {
      ...obj,
      ...{
