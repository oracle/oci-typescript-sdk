...
export namespace CreateConnectionFromAdwc {
  export function getJsonObj(obj: CreateConnectionFromAdwc, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.CreateConnectionDetails.getJsonObj(obj) as CreateConnectionFromAdwc)),
      ...{
  ...
  export function getDeserializedJsonObj(
    obj: CreateConnectionFromAdwc,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.CreateConnectionDetails.getDeserializedJsonObj(obj) as CreateConnectionFromAdwc)),
      ...{
        "passwordSecret": obj.passwordSecret
