...
export namespace UpdateDisApplicationDetails {
  ...
  export function getJsonObj(obj: UpdateDisApplicationDetails): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: UpdateDisApplicationDetails): object {
    const jsonObj = {
      ...obj,
      ...{
