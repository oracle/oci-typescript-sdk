...
export namespace CreateConnectionFromObjectStorage {
  export function getJsonObj(
    obj: CreateConnectionFromObjectStorage,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.CreateConnectionDetails.getJsonObj(obj) as CreateConnectionFromObjectStorage)),
      ...{}
    };
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ...
        : (model.CreateConnectionDetails.getDeserializedJsonObj(
            obj
          ) as CreateConnectionFromObjectStorage)),
      ...{}
    };
