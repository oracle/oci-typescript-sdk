...
/**
 * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/networkloadbalancer/ListNetworkLoadBalancerHealths.ts.html |here} to see how to use ListNetworkLoadBalancerHealthsRequest.
 */
...
export namespace ListNetworkLoadBalancerHealthsRequest {
  export enum SortBy {
