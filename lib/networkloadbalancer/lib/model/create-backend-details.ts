...
export namespace CreateBackendDetails {
  export function getJsonObj(obj: CreateBackendDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: CreateBackendDetails): object {
    const jsonObj = { ...obj, ...{} };
