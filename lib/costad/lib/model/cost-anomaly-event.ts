...
export namespace CostAnomalyEvent {
  ...
  export function getJsonObj(obj: CostAnomalyEvent): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: CostAnomalyEvent): object {
    const jsonObj = {
      ...obj,
      ...{
        "targetResourceFilter": obj.targetResourceFilter
