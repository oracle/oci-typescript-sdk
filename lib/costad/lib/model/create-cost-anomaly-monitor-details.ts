...
export namespace CreateCostAnomalyMonitorDetails {
  export function getJsonObj(obj: CreateCostAnomalyMonitorDetails): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: CreateCostAnomalyMonitorDetails): object {
    const jsonObj = {
      ...obj,
      ...{
        "targetResourceFilter": obj.targetResourceFilter
