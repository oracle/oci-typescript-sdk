...
export namespace CostAnomalyEventAnalyticSummary {
  export function getJsonObj(obj: CostAnomalyEventAnalyticSummary): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: CostAnomalyEventAnalyticSummary): object {
    const jsonObj = { ...obj, ...{} };
