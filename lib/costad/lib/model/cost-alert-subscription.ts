...
export namespace CostAlertSubscription {
  ...
  export function getJsonObj(obj: CostAlertSubscription): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: CostAlertSubscription): object {
    const jsonObj = { ...obj, ...{} };
