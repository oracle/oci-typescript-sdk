...
export namespace ChangeEmailDomainCompartmentDetails {
  export function getJsonObj(obj: ChangeEmailDomainCompartmentDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: ChangeEmailDomainCompartmentDetails): object {
    const jsonObj = { ...obj, ...{} };
