...
export namespace UpdateEmailDomainDetails {
  export function getJsonObj(obj: UpdateEmailDomainDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: UpdateEmailDomainDetails): object {
    const jsonObj = { ...obj, ...{} };
