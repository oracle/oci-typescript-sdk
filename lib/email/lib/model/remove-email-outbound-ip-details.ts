...
export namespace RemoveEmailOutboundIpDetails {
  export function getJsonObj(obj: RemoveEmailOutboundIpDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: RemoveEmailOutboundIpDetails): object {
    const jsonObj = { ...obj, ...{} };
