...
export namespace UpdateSenderDetails {
  export function getJsonObj(obj: UpdateSenderDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: UpdateSenderDetails): object {
    const jsonObj = { ...obj, ...{} };
