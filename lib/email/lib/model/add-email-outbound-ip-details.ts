...
export namespace AddEmailOutboundIpDetails {
  export function getJsonObj(obj: AddEmailOutboundIpDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: AddEmailOutboundIpDetails): object {
    const jsonObj = { ...obj, ...{} };
