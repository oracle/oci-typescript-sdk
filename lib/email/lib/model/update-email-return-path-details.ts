...
export namespace UpdateEmailReturnPathDetails {
  export function getJsonObj(obj: UpdateEmailReturnPathDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: UpdateEmailReturnPathDetails): object {
    const jsonObj = { ...obj, ...{} };
