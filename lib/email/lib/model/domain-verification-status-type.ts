 ...
 **/
export enum DomainVerificationStatusType {
  None = "NONE",
  Domainid = "DOMAINID",
  Other = "OTHER",
...
export namespace DomainVerificationStatusType {
  export function getJsonObj(obj: DomainVerificationStatusType): DomainVerificationStatusType {
    return obj;
  }
  export function getDeserializedJsonObj(
    obj: DomainVerificationStatusType
