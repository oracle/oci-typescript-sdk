...
export namespace ChangeShardedDatabaseCompartmentDetails {
  export function getJsonObj(obj: ChangeShardedDatabaseCompartmentDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: ChangeShardedDatabaseCompartmentDetails): object {
    const jsonObj = { ...obj, ...{} };
