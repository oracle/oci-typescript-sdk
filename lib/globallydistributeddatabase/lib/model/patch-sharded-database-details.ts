 ...
 *
 */
export interface PatchShardedDatabaseDetails {
  /**
...
export namespace PatchShardedDatabaseDetails {
  export function getJsonObj(obj: PatchShardedDatabaseDetails): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
  ...
  export function getDeserializedJsonObj(obj: PatchShardedDatabaseDetails): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
