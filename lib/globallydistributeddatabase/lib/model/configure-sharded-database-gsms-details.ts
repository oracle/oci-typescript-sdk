 ...
 *
 */
export interface ConfigureShardedDatabaseGsmsDetails {
  /**
...
export namespace ConfigureShardedDatabaseGsmsDetails {
  export function getJsonObj(obj: ConfigureShardedDatabaseGsmsDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: ConfigureShardedDatabaseGsmsDetails): object {
    const jsonObj = { ...obj, ...{} };
