...
/**
 * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/aianomalydetection/DetectAnomalies.ts.html |here} to see how to use DetectAnomaliesRequest.
 */
export interface DetectAnomaliesRequest extends common.BaseRequest {
  ...
  "detectAnomaliesDetails":
    | model.InlineDetectAnomaliesRequest
    | model.EmbeddedDetectAnomaliesRequest;
  /**
