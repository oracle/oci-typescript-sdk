...
export namespace VideoObjectTrackingFeature {
  export function getJsonObj(obj: VideoObjectTrackingFeature, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.VideoFeature.getJsonObj(obj) as VideoObjectTrackingFeature)),
      ...{}
    };

    return jsonObj;
  }
  export const featureType = "OBJECT_TRACKING";
  export function getDeserializedJsonObj(
    obj: VideoObjectTrackingFeature,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.VideoFeature.getDeserializedJsonObj(obj) as VideoObjectTrackingFeature)),
      ...{}
    };
