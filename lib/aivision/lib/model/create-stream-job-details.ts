...
export namespace CreateStreamJobDetails {
  export function getJsonObj(obj: CreateStreamJobDetails): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: CreateStreamJobDetails): object {
    const jsonObj = {
      ...obj,
      ...{
        "features": obj.features
