...
export namespace StreamGroupSummary {
  export function getJsonObj(obj: StreamGroupSummary): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: StreamGroupSummary): object {
    const jsonObj = {
      ...obj,
      ...{
        "streamOverlaps": obj.streamOverlaps
