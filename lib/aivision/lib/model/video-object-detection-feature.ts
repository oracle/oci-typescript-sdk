...
export namespace VideoObjectDetectionFeature {
  export function getJsonObj(obj: VideoObjectDetectionFeature, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.VideoFeature.getJsonObj(obj) as VideoObjectDetectionFeature)),
      ...{}
    };
  ...
  export function getDeserializedJsonObj(
    obj: VideoObjectDetectionFeature,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.VideoFeature.getDeserializedJsonObj(obj) as VideoObjectDetectionFeature)),
      ...{}
    };
