...
export namespace VideoLabelSegment {
  export function getJsonObj(obj: VideoLabelSegment): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: VideoLabelSegment): object {
    const jsonObj = {
      ...obj,
      ...{
        "videoSegment": obj.videoSegment
