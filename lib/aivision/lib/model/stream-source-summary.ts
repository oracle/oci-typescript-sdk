...
export namespace StreamSourceSummary {
  export function getJsonObj(obj: StreamSourceSummary): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: StreamSourceSummary): object {
    const jsonObj = {
      ...obj,
      ...{
        "streamSourceDetails": obj.streamSourceDetails
