...
export namespace UpdateStreamGroupDetails {
  export function getJsonObj(obj: UpdateStreamGroupDetails): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: UpdateStreamGroupDetails): object {
    const jsonObj = {
      ...obj,
      ...{
        "streamOverlaps": obj.streamOverlaps
