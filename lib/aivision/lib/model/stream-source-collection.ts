...
export namespace StreamSourceCollection {
  export function getJsonObj(obj: StreamSourceCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
  ...
  export function getDeserializedJsonObj(obj: StreamSourceCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
