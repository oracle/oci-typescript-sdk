...
export namespace StreamJobCollection {
  export function getJsonObj(obj: StreamJobCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
  ...
  export function getDeserializedJsonObj(obj: StreamJobCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
