...
export namespace StreamGroupCollection {
  export function getJsonObj(obj: StreamGroupCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
  ...
  export function getDeserializedJsonObj(obj: StreamGroupCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
