...
export namespace CreateStreamSourceDetails {
  export function getJsonObj(obj: CreateStreamSourceDetails): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: CreateStreamSourceDetails): object {
    const jsonObj = {
      ...obj,
      ...{
        "streamSourceDetails": obj.streamSourceDetails
