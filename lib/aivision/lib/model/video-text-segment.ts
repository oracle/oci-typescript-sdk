...
export namespace VideoTextSegment {
  export function getJsonObj(obj: VideoTextSegment): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: VideoTextSegment): object {
    const jsonObj = {
      ...obj,
      ...{
        "videoSegment": obj.videoSegment
