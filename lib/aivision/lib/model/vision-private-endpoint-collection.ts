...
export namespace VisionPrivateEndpointCollection {
  export function getJsonObj(obj: VisionPrivateEndpointCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
  ...
  export function getDeserializedJsonObj(obj: VisionPrivateEndpointCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
