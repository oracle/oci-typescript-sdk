...
export namespace VideoFaceDetectionFeature {
  export function getJsonObj(obj: VideoFaceDetectionFeature, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.VideoFeature.getJsonObj(obj) as VideoFaceDetectionFeature)),
      ...{}
    };
  ...
  export function getDeserializedJsonObj(
    obj: VideoFaceDetectionFeature,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.VideoFeature.getDeserializedJsonObj(obj) as VideoFaceDetectionFeature)),
      ...{}
    };
