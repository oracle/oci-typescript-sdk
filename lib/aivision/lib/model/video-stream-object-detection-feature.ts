...
export namespace VideoStreamObjectDetectionFeature {
  export function getJsonObj(
    obj: VideoStreamObjectDetectionFeature,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.VideoStreamFeature.getJsonObj(obj) as VideoStreamObjectDetectionFeature)),
      ...{}
    };
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ...
        : (model.VideoStreamFeature.getDeserializedJsonObj(
            obj
          ) as VideoStreamObjectDetectionFeature)),
      ...{}
    };
