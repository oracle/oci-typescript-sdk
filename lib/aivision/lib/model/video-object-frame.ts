...
export namespace VideoObjectFrame {
  export function getJsonObj(obj: VideoObjectFrame): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: VideoObjectFrame): object {
    const jsonObj = {
      ...obj,
      ...{
        "boundingPolygon": obj.boundingPolygon
