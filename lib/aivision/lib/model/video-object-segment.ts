...
export namespace VideoObjectSegment {
  export function getJsonObj(obj: VideoObjectSegment): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: VideoObjectSegment): object {
    const jsonObj = {
      ...obj,
      ...{
        "videoSegment": obj.videoSegment
