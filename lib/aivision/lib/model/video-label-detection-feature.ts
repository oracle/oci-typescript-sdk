...
export namespace VideoLabelDetectionFeature {
  export function getJsonObj(obj: VideoLabelDetectionFeature, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.VideoFeature.getJsonObj(obj) as VideoLabelDetectionFeature)),
      ...{}
    };

    return jsonObj;
  }
  export const featureType = "LABEL_DETECTION";
  export function getDeserializedJsonObj(
    obj: VideoLabelDetectionFeature,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.VideoFeature.getDeserializedJsonObj(obj) as VideoLabelDetectionFeature)),
      ...{}
    };
