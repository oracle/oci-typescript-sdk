...
export namespace CreateVisionPrivateEndpointDetails {
  export function getJsonObj(obj: CreateVisionPrivateEndpointDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: CreateVisionPrivateEndpointDetails): object {
    const jsonObj = { ...obj, ...{} };
