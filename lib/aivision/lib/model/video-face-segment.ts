...
export namespace VideoFaceSegment {
  export function getJsonObj(obj: VideoFaceSegment): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: VideoFaceSegment): object {
    const jsonObj = {
      ...obj,
      ...{
        "videoSegment": obj.videoSegment
