...
export namespace VideoStreamObject {
  export function getJsonObj(obj: VideoStreamObject): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: VideoStreamObject): object {
    const jsonObj = {
      ...obj,
      ...{
        "boundingPolygon": obj.boundingPolygon
