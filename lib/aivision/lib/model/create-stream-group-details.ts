...
export namespace CreateStreamGroupDetails {
  export function getJsonObj(obj: CreateStreamGroupDetails): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: CreateStreamGroupDetails): object {
    const jsonObj = {
      ...obj,
      ...{
        "streamOverlaps": obj.streamOverlaps
