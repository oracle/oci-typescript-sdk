...
export namespace CreateMonitoredRegionDetails {
  export function getJsonObj(obj: CreateMonitoredRegionDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: CreateMonitoredRegionDetails): object {
    const jsonObj = { ...obj, ...{} };
