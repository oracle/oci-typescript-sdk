...
export namespace MonitoredRegionSummary {
  export function getJsonObj(obj: MonitoredRegionSummary): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: MonitoredRegionSummary): object {
    const jsonObj = { ...obj, ...{} };
