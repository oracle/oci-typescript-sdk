...
export namespace ResourceAnalyticsInstanceSummary {
  export function getJsonObj(obj: ResourceAnalyticsInstanceSummary): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: ResourceAnalyticsInstanceSummary): object {
    const jsonObj = { ...obj, ...{} };
