...
export namespace UpdatePingMonitorDetails {
  export function getJsonObj(obj: UpdatePingMonitorDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: UpdatePingMonitorDetails): object {
    const jsonObj = { ...obj, ...{} };
