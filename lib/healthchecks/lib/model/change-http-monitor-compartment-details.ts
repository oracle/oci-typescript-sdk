...
export namespace ChangeHttpMonitorCompartmentDetails {
  export function getJsonObj(obj: ChangeHttpMonitorCompartmentDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: ChangeHttpMonitorCompartmentDetails): object {
    const jsonObj = { ...obj, ...{} };
