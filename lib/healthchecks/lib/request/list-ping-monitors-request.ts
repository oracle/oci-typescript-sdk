...
/**
 * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/healthchecks/ListPingMonitors.ts.html |here} to see how to use ListPingMonitorsRequest.
 */
...
export namespace ListPingMonitorsRequest {
  export enum SortBy {
    Id = "id",
