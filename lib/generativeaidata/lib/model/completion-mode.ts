...
export namespace CompletionMode {
  export function getJsonObj(obj: CompletionMode): CompletionMode {
    return obj;
  }
  export function getDeserializedJsonObj(obj: CompletionMode): CompletionMode {
    return obj;
  }
}
