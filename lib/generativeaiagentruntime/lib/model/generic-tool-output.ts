...
export namespace GenericToolOutput {
  export function getJsonObj(obj: GenericToolOutput, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj ? obj : (model.ToolOutput.getJsonObj(obj) as GenericToolOutput)),
      ...{}
    };

    return jsonObj;
  }
  export const toolOutputType = "GENERIC_TOOL_OUTPUT";
  export function getDeserializedJsonObj(
    obj: GenericToolOutput,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.ToolOutput.getDeserializedJsonObj(obj) as GenericToolOutput)),
      ...{}
    };
