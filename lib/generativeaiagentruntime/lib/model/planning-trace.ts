...
export namespace PlanningTrace {
  export function getJsonObj(obj: PlanningTrace, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj ? obj : (model.Trace.getJsonObj(obj) as PlanningTrace)),
      ...{
        "usage": obj.usage
          ? obj.usage.map(item => {
  ...
  export const traceType = "PLANNING_TRACE";
  export function getDeserializedJsonObj(obj: PlanningTrace, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj ? obj : (model.Trace.getDeserializedJsonObj(obj) as PlanningTrace)),
      ...{
        "usage": obj.usage
          ? obj.usage.map(item => {
