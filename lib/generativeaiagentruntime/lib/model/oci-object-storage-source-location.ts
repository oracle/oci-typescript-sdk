...
export namespace OciObjectStorageSourceLocation {
  export function getJsonObj(
    obj: OciObjectStorageSourceLocation,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.SourceLocation.getJsonObj(obj) as OciObjectStorageSourceLocation)),
      ...{}
    };

    return jsonObj;
  }
  export const sourceLocationType = "OCI_OBJECT_STORAGE";
  export function getDeserializedJsonObj(
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.SourceLocation.getDeserializedJsonObj(obj) as OciObjectStorageSourceLocation)),
      ...{}
    };
