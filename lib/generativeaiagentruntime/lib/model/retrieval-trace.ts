...
export namespace RetrievalTrace {
  export function getJsonObj(obj: RetrievalTrace, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj ? obj : (model.Trace.getJsonObj(obj) as RetrievalTrace)),
      ...{
  ...
  export const traceType = "RETRIEVAL_TRACE";
  export function getDeserializedJsonObj(obj: RetrievalTrace, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj ? obj : (model.Trace.getDeserializedJsonObj(obj) as RetrievalTrace)),
      ...{
        "citations": obj.citations
          ? obj.citations.map(item => {
