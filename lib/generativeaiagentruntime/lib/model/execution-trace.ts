...
export namespace ExecutionTrace {
  export function getJsonObj(obj: ExecutionTrace, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj ? obj : (model.Trace.getJsonObj(obj) as ExecutionTrace)),
      ...{}
    };

    return jsonObj;
  }
  export const traceType = "EXECUTION_TRACE";
  export function getDeserializedJsonObj(obj: ExecutionTrace, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj ? obj : (model.Trace.getDeserializedJsonObj(obj) as ExecutionTrace)),
      ...{}
    };
