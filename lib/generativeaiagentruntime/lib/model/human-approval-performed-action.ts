...
export namespace HumanApprovalPerformedAction {
  export enum ChosenOption {
    Approve = "APPROVE",
    Deny = "DENY"
  }

  export function getJsonObj(obj: HumanApprovalPerformedAction, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.PerformedAction.getJsonObj(obj) as HumanApprovalPerformedAction)),
      ...{}
    };

    return jsonObj;
  }
  export const performedActionType = "HUMAN_APPROVAL_PERFORMED_ACTION";
  export function getDeserializedJsonObj(
    obj: HumanApprovalPerformedAction,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.PerformedAction.getDeserializedJsonObj(obj) as HumanApprovalPerformedAction)),
      ...{}
    };
