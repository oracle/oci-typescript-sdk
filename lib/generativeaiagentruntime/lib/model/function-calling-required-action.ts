...
export namespace FunctionCallingRequiredAction {
  export function getJsonObj(
    obj: FunctionCallingRequiredAction,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.RequiredAction.getJsonObj(obj) as FunctionCallingRequiredAction)),
      ...{
  ...
  export const requiredActionType = "FUNCTION_CALLING_REQUIRED_ACTION";
  export function getDeserializedJsonObj(
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.RequiredAction.getDeserializedJsonObj(obj) as FunctionCallingRequiredAction)),
      ...{
        "functionCall": obj.functionCall
