...
export namespace OciOpenSearchSourceLocation {
  export function getJsonObj(obj: OciOpenSearchSourceLocation, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.SourceLocation.getJsonObj(obj) as OciOpenSearchSourceLocation)),
      ...{}
    };

    return jsonObj;
  }
  export const sourceLocationType = "OCI_OPEN_SEARCH";
  export function getDeserializedJsonObj(
    obj: OciOpenSearchSourceLocation,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.SourceLocation.getDeserializedJsonObj(obj) as OciOpenSearchSourceLocation)),
      ...{}
    };
