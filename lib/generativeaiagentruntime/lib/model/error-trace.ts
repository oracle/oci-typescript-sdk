...
export namespace ErrorTrace {
  export function getJsonObj(obj: ErrorTrace, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj ? obj : (model.Trace.getJsonObj(obj) as ErrorTrace)),
      ...{}
    };

    return jsonObj;
  }
  export const traceType = "ERROR_TRACE";
  export function getDeserializedJsonObj(obj: ErrorTrace, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj ? obj : (model.Trace.getDeserializedJsonObj(obj) as ErrorTrace)),
      ...{}
    };
