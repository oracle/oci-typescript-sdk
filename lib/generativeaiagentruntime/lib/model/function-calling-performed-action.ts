...
export namespace FunctionCallingPerformedAction {
  export function getJsonObj(
    obj: FunctionCallingPerformedAction,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.PerformedAction.getJsonObj(obj) as FunctionCallingPerformedAction)),
      ...{}
    };

    return jsonObj;
  }
  export const performedActionType = "FUNCTION_CALLING_PERFORMED_ACTION";
  export function getDeserializedJsonObj(
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.PerformedAction.getDeserializedJsonObj(obj) as FunctionCallingPerformedAction)),
      ...{}
    };
