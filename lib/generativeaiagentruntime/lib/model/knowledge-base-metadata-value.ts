...
export namespace KnowledgeBaseMetadataValue {
  export function getJsonObj(obj: KnowledgeBaseMetadataValue): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: KnowledgeBaseMetadataValue): object {
    const jsonObj = { ...obj, ...{} };
