...
export namespace OciDatabaseSourceLocation {
  export function getJsonObj(obj: OciDatabaseSourceLocation, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.SourceLocation.getJsonObj(obj) as OciDatabaseSourceLocation)),
      ...{}
    };

    return jsonObj;
  }
  export const sourceLocationType = "OCI_DATABASE";
  export function getDeserializedJsonObj(
    obj: OciDatabaseSourceLocation,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.SourceLocation.getDeserializedJsonObj(obj) as OciDatabaseSourceLocation)),
      ...{}
    };
