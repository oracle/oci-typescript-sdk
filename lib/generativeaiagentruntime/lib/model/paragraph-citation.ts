...
export namespace ParagraphCitation {
  export function getJsonObj(obj: ParagraphCitation): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: ParagraphCitation): object {
    const jsonObj = {
      ...obj,
      ...{
