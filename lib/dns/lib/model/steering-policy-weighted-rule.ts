...
export namespace SteeringPolicyWeightedRule {
  export function getJsonObj(obj: SteeringPolicyWeightedRule, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.SteeringPolicyRule.getJsonObj(obj) as SteeringPolicyWeightedRule)),
      ...{
        "cases": obj.cases
          ? obj.cases.map(item => {
