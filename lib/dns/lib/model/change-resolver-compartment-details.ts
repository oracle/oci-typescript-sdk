...
export namespace ChangeResolverCompartmentDetails {
  export function getJsonObj(obj: ChangeResolverCompartmentDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: ChangeResolverCompartmentDetails): object {
    const jsonObj = { ...obj, ...{} };
