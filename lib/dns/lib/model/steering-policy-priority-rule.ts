...
export namespace SteeringPolicyPriorityRule {
  export function getJsonObj(obj: SteeringPolicyPriorityRule, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.SteeringPolicyRule.getJsonObj(obj) as SteeringPolicyPriorityRule)),
      ...{
        "cases": obj.cases
          ? obj.cases.map(item => {
