...
export namespace SteeringPolicyFilterRule {
  export function getJsonObj(obj: SteeringPolicyFilterRule, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.SteeringPolicyRule.getJsonObj(obj) as SteeringPolicyFilterRule)),
      ...{
        "cases": obj.cases
          ? obj.cases.map(item => {
