...
export namespace SteeringPolicyPriorityRuleCase {
  export function getJsonObj(obj: SteeringPolicyPriorityRuleCase): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: SteeringPolicyPriorityRuleCase): object {
    const jsonObj = {
      ...obj,
      ...{
        "answerData": obj.answerData
