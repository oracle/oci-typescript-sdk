...
export namespace KskDnssecKeyVersion {
  export function getJsonObj(obj: KskDnssecKeyVersion): object {
    const jsonObj = {
      ...obj,
      ...{
        "dsData": obj.dsData
  ...
  export function getDeserializedJsonObj(obj: KskDnssecKeyVersion): object {
    const jsonObj = {
      ...obj,
      ...{
        "dsData": obj.dsData
