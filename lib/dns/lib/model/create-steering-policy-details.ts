...
export namespace CreateSteeringPolicyDetails {
  ...
  export function getJsonObj(obj: CreateSteeringPolicyDetails): object {
    const jsonObj = {
      ...obj,
      ...{
        "answers": obj.answers
  ...
  export function getDeserializedJsonObj(obj: CreateSteeringPolicyDetails): object {
    const jsonObj = {
      ...obj,
      ...{
        "answers": obj.answers
