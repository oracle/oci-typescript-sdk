...
export namespace AssignedConnectionDetails {
  export function getJsonObj(obj: AssignedConnectionDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: AssignedConnectionDetails): object {
    const jsonObj = { ...obj, ...{} };
