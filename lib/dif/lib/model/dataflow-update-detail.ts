...
export namespace DataflowUpdateDetail {
  export function getJsonObj(obj: DataflowUpdateDetail): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: DataflowUpdateDetail): object {
    const jsonObj = {
      ...obj,
      ...{
        "driverShapeConfig": obj.driverShapeConfig
