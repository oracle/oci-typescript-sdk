...
export namespace StackTemplate {
  export function getJsonObj(obj: StackTemplate): StackTemplate {
    return obj;
  }
  export function getDeserializedJsonObj(obj: StackTemplate): StackTemplate {
    return obj;
  }
}
