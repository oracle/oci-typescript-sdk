...
export namespace UpdateDataflowConnections {
  export function getJsonObj(obj: UpdateDataflowConnections): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: UpdateDataflowConnections): object {
    const jsonObj = {
      ...obj,
      ...{
        "connectionDetails": obj.connectionDetails
