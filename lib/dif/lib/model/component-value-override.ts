...
export interface ComponentValueOverride {
   ...
   *
   */
  "valueOverrides": { [key: string]: string };
}

export namespace ComponentValueOverride {
  export function getJsonObj(obj: ComponentValueOverride): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: ComponentValueOverride): object {
    const jsonObj = { ...obj, ...{} };
