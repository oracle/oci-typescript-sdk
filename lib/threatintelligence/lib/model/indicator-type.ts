...
export namespace IndicatorType {
  export function getJsonObj(obj: IndicatorType): IndicatorType {
    return obj;
  }
  export function getDeserializedJsonObj(obj: IndicatorType): IndicatorType {
    return obj;
  }
}
