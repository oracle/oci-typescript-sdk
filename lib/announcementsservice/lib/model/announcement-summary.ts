...
export namespace AnnouncementSummary {
  export function getJsonObj(obj: AnnouncementSummary, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj ? obj : (model.BaseAnnouncement.getJsonObj(obj) as AnnouncementSummary)),
      ...{}
    };
