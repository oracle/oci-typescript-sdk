...
export namespace PsaServiceCollection {
  export function getJsonObj(obj: PsaServiceCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
  ...
  export function getDeserializedJsonObj(obj: PsaServiceCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
