...
export namespace PrivateServiceAccessCollection {
  export function getJsonObj(obj: PrivateServiceAccessCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
  ...
  export function getDeserializedJsonObj(obj: PrivateServiceAccessCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
