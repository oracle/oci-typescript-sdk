...
export namespace PrivateServiceAccessSummary {
  export function getJsonObj(obj: PrivateServiceAccessSummary): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: PrivateServiceAccessSummary): object {
    const jsonObj = { ...obj, ...{} };
