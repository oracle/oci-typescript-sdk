...
export namespace CertificateIssuerName {
  export function getJsonObj(obj: CertificateIssuerName): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: CertificateIssuerName): object {
    const jsonObj = { ...obj, ...{} };
