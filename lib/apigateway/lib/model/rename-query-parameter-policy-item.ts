...
export namespace RenameQueryParameterPolicyItem {
  export function getJsonObj(obj: RenameQueryParameterPolicyItem): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: RenameQueryParameterPolicyItem): object {
    const jsonObj = { ...obj, ...{} };
