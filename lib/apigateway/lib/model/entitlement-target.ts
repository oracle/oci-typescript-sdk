...
export namespace EntitlementTarget {
  export function getJsonObj(obj: EntitlementTarget): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: EntitlementTarget): object {
    const jsonObj = { ...obj, ...{} };
