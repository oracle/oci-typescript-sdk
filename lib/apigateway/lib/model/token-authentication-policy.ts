...
export interface TokenAuthenticationPolicy extends model.AuthenticationPolicy {
  ...
  "validationPolicy":
    | model.TokenAuthenticationRemoteJWKSValidationPolicy
    | model.TokenAuthenticationRemoteDiscoveryValidationPolicy
    | model.TokenAuthenticationStaticKeysValidationPolicy;
...
export namespace TokenAuthenticationPolicy {
  export function getJsonObj(obj: TokenAuthenticationPolicy, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.AuthenticationPolicy.getJsonObj(obj) as TokenAuthenticationPolicy)),
      ...{
  ...
  export const type = "TOKEN_AUTHENTICATION";
  export function getDeserializedJsonObj(
    obj: TokenAuthenticationPolicy,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.AuthenticationPolicy.getDeserializedJsonObj(obj) as TokenAuthenticationPolicy)),
      ...{
        "validationPolicy": obj.validationPolicy
