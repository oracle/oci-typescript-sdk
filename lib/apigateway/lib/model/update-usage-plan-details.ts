...
export namespace UpdateUsagePlanDetails {
  export function getJsonObj(obj: UpdateUsagePlanDetails): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: UpdateUsagePlanDetails): object {
    const jsonObj = {
      ...obj,
      ...{
        "entitlements": obj.entitlements
