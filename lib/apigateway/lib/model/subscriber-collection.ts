...
export namespace SubscriberCollection {
  export function getJsonObj(obj: SubscriberCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
  ...
  export function getDeserializedJsonObj(obj: SubscriberCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
