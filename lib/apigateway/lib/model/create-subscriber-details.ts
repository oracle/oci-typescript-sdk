...
export namespace CreateSubscriberDetails {
  export function getJsonObj(obj: CreateSubscriberDetails): object {
    const jsonObj = {
      ...obj,
      ...{
        "clients": obj.clients
  ...
  export function getDeserializedJsonObj(obj: CreateSubscriberDetails): object {
    const jsonObj = {
      ...obj,
      ...{
        "clients": obj.clients
