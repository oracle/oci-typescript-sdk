...
export namespace RemoteJsonWebKeySet {
  export function getJsonObj(obj: RemoteJsonWebKeySet, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj ? obj : (model.PublicKeySet.getJsonObj(obj) as RemoteJsonWebKeySet)),
      ...{}
    };
