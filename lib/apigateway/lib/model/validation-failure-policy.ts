...
export namespace ValidationFailurePolicy {
  export function getJsonObj(obj: ValidationFailurePolicy): object {
    const jsonObj = { ...obj, ...{} };

    if (obj && "type" in obj && obj.type) {
      switch (obj.type) {
        case "MODIFY_RESPONSE":
          return model.ModifyResponseValidationFailurePolicy.getJsonObj(
  ...
  export function getDeserializedJsonObj(obj: ValidationFailurePolicy): object {
    const jsonObj = { ...obj, ...{} };
