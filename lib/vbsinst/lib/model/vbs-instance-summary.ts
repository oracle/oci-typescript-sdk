...
export namespace VbsInstanceSummary {
  export function getJsonObj(obj: VbsInstanceSummary): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: VbsInstanceSummary): object {
    const jsonObj = { ...obj, ...{} };
