...
export namespace ReplicationTargetSummary {
  ...
  export function getJsonObj(obj: ReplicationTargetSummary): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: ReplicationTargetSummary): object {
    const jsonObj = { ...obj, ...{} };
