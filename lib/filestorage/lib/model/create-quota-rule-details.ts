...
export namespace CreateQuotaRuleDetails {
  ...
  export function getJsonObj(obj: CreateQuotaRuleDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: CreateQuotaRuleDetails): object {
    const jsonObj = { ...obj, ...{} };
