...
export namespace CreateReplicationDetails {
  export function getJsonObj(obj: CreateReplicationDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: CreateReplicationDetails): object {
    const jsonObj = { ...obj, ...{} };
