...
export namespace CreateKerberosDetails {
  export function getJsonObj(obj: CreateKerberosDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: CreateKerberosDetails): object {
    const jsonObj = { ...obj, ...{} };
