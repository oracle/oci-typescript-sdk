...
export namespace ToggleQuotaRulesDetails {
  export function getJsonObj(obj: ToggleQuotaRulesDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: ToggleQuotaRulesDetails): object {
    const jsonObj = { ...obj, ...{} };
