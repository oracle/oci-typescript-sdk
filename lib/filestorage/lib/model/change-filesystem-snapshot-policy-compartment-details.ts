...
export namespace ChangeFilesystemSnapshotPolicyCompartmentDetails {
  export function getJsonObj(obj: ChangeFilesystemSnapshotPolicyCompartmentDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(
    obj: ChangeFilesystemSnapshotPolicyCompartmentDetails
  ): object {
    const jsonObj = { ...obj, ...{} };
