...
export namespace KeyTabSecretDetails {
  export function getJsonObj(obj: KeyTabSecretDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: KeyTabSecretDetails): object {
    const jsonObj = { ...obj, ...{} };
