...
export namespace UpgradeShapeMountTargetDetails {
  export function getJsonObj(obj: UpgradeShapeMountTargetDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: UpgradeShapeMountTargetDetails): object {
    const jsonObj = { ...obj, ...{} };
