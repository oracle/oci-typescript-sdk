...
export namespace AiDataPlatformSummary {
  export function getJsonObj(obj: AiDataPlatformSummary): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: AiDataPlatformSummary): object {
    const jsonObj = { ...obj, ...{} };
