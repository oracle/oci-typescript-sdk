...
/**
 * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/osubbillingschedule/ListBillingSchedules.ts.html |here} to see how to use ListBillingSchedulesRequest.
 */
...
export namespace ListBillingSchedulesRequest {
