...
export namespace ChangeOciCacheUserCompartmentDetails {
  export function getJsonObj(obj: ChangeOciCacheUserCompartmentDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: ChangeOciCacheUserCompartmentDetails): object {
    const jsonObj = { ...obj, ...{} };
