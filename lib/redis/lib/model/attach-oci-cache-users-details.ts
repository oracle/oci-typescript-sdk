...
export namespace AttachOciCacheUsersDetails {
  export function getJsonObj(obj: AttachOciCacheUsersDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: AttachOciCacheUsersDetails): object {
    const jsonObj = { ...obj, ...{} };
