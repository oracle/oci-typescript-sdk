...
export namespace DetachOciCacheUsersDetails {
  export function getJsonObj(obj: DetachOciCacheUsersDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: DetachOciCacheUsersDetails): object {
    const jsonObj = { ...obj, ...{} };
