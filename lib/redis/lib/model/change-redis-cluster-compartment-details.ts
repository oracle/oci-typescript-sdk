...
export namespace ChangeRedisClusterCompartmentDetails {
  export function getJsonObj(obj: ChangeRedisClusterCompartmentDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: ChangeRedisClusterCompartmentDetails): object {
    const jsonObj = { ...obj, ...{} };
