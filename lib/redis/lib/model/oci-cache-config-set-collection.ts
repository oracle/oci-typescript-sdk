...
export namespace OciCacheConfigSetCollection {
  export function getJsonObj(obj: OciCacheConfigSetCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
  ...
  export function getDeserializedJsonObj(obj: OciCacheConfigSetCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
