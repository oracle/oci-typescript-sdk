...
export namespace UpdateOciCacheBackupDetails {
  export function getJsonObj(obj: UpdateOciCacheBackupDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: UpdateOciCacheBackupDetails): object {
    const jsonObj = { ...obj, ...{} };
