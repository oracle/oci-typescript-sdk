...
export namespace UpdateOciCacheUserDetails {
  export function getJsonObj(obj: UpdateOciCacheUserDetails): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: UpdateOciCacheUserDetails): object {
    const jsonObj = {
      ...obj,
      ...{
        "authenticationMode": obj.authenticationMode
