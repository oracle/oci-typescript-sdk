...
export namespace AssociatedOciCacheClusterSummary {
  export function getJsonObj(obj: AssociatedOciCacheClusterSummary): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: AssociatedOciCacheClusterSummary): object {
    const jsonObj = { ...obj, ...{} };
