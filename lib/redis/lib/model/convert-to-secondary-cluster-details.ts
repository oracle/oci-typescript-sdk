 ...
 */
export interface ConvertToSecondaryClusterDetails {
  /**
...
export namespace ConvertToSecondaryClusterDetails {
  export function getJsonObj(obj: ConvertToSecondaryClusterDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: ConvertToSecondaryClusterDetails): object {
    const jsonObj = { ...obj, ...{} };
