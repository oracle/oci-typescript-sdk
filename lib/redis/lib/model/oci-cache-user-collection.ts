...
export namespace OciCacheUserCollection {
  export function getJsonObj(obj: OciCacheUserCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
  ...
  export function getDeserializedJsonObj(obj: OciCacheUserCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
