...
export namespace IdentityTokenDetailsResponse {
  export function getJsonObj(obj: IdentityTokenDetailsResponse): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: IdentityTokenDetailsResponse): object {
    const jsonObj = { ...obj, ...{} };
