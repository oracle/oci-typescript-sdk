...
export namespace AttachedOciCacheUser {
  export function getJsonObj(obj: AttachedOciCacheUser): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: AttachedOciCacheUser): object {
    const jsonObj = { ...obj, ...{} };
