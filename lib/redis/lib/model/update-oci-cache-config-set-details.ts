...
export namespace UpdateOciCacheConfigSetDetails {
  export function getJsonObj(obj: UpdateOciCacheConfigSetDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: UpdateOciCacheConfigSetDetails): object {
    const jsonObj = { ...obj, ...{} };
