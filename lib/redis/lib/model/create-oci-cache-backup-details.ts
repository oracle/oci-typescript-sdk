 ...
 */
export interface CreateOciCacheBackupDetails {
  /**
   * Backup display name.
   */
  "displayName": string;
...
export namespace CreateOciCacheBackupDetails {
  export function getJsonObj(obj: CreateOciCacheBackupDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: CreateOciCacheBackupDetails): object {
    const jsonObj = { ...obj, ...{} };
