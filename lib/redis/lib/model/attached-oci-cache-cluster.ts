...
export namespace AttachedOciCacheCluster {
  export function getJsonObj(obj: AttachedOciCacheCluster): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: AttachedOciCacheCluster): object {
    const jsonObj = { ...obj, ...{} };
