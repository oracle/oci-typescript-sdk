...
export enum OciCacheBackupApiKeys {}
/**
 * This service client uses {@link common.CircuitBreaker.DefaultConfiguration} for all the operations by default if no circuit breaker configuration is defined by the user.
 */
export class OciCacheBackupClient {
  ...
  public targetService = "OciCacheBackup";
  ...
  public set endpoint(endpoint: string) {
    ...
    if (this.logger) this.logger.info(`OciCacheBackupClient endpoint set to ${this._endpoint}`);
  }
  ...
  public set useRealmSpecificEndpointTemplate(realmSpecificEndpointTemplateEnabled: boolean) {
    ...
    if (this._lastSetRegionOrRegionId === common.Region.REGION_STRING) {
      this.endpoint = common.EndpointBuilder.createEndpointFromRegion(
        OciCacheBackupClient.serviceEndpointTemplate,
        this._region,
   ...
   */
  public createWaiters(config?: common.WaiterConfiguration): OciCacheBackupWaiter {
    this._waiters = new OciCacheBackupWaiter(this, config);
   ...
   * @return The service waiters.
   */
  public getWaiters(): OciCacheBackupWaiter {
    if (this._waiters) {
      return this._waiters;
    }
   ...
   */
  public async changeOciCacheBackupCompartment(
    changeOciCacheBackupCompartmentRequest: requests.ChangeOciCacheBackupCompartmentRequest
  ): Promise<responses.ChangeOciCacheBackupCompartmentResponse> {
    if (this.logger)
    ...
    const retrier = GenericRetrier.createPreferredRetrier(
      ...
      changeOciCacheBackupCompartmentRequest.retryConfiguration,
    ...
    const request = await composeRequest({
      ...
      bodyContent: common.ObjectSerializer.serialize(
        changeOciCacheBackupCompartmentRequest.changeOciCacheBackupCompartmentDetails,
        "ChangeOciCacheBackupCompartmentDetails",
        model.ChangeOciCacheBackupCompartmentDetails.getJsonObj
      ),
    ...
    try {
      ...
      const sdkResponse = composeResponse({
        responseObject: <responses.ChangeOciCacheBackupCompartmentResponse>{},
        responseHeaders: [
          {
   ...
   */
  public async createOciCacheBackup(
    createOciCacheBackupRequest: requests.CreateOciCacheBackupRequest
  ): Promise<responses.CreateOciCacheBackupResponse> {
    if (this.logger)
    ...
    const retrier = GenericRetrier.createPreferredRetrier(
      this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined,
      createOciCacheBackupRequest.retryConfiguration,
      specRetryConfiguration
    );
    if (this.logger) retrier.logger = this.logger;
    const request = await composeRequest({
      ...
      method: "POST",
      bodyContent: common.ObjectSerializer.serialize(
        createOciCacheBackupRequest.createOciCacheBackupDetails,
        "CreateOciCacheBackupDetails",
        model.CreateOciCacheBackupDetails.getJsonObj
      ),
      pathParams: pathParams,
      headerParams: headerParams,
      queryParams: queryParams
    ...
    try {
      ...
      const sdkResponse = composeResponse({
        responseObject: <responses.CreateOciCacheBackupResponse>{},
   ...
   */
  public async deleteOciCacheBackup(
    deleteOciCacheBackupRequest: requests.DeleteOciCacheBackupRequest
  ): Promise<responses.DeleteOciCacheBackupResponse> {
    if (this.logger)
    ...
    const retrier = GenericRetrier.createPreferredRetrier(
      this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined,
      deleteOciCacheBackupRequest.retryConfiguration,
      specRetryConfiguration
    );
    if (this.logger) retrier.logger = this.logger;
    const request = await composeRequest({
    ...
    try {
      ...
      const sdkResponse = composeResponse({
        responseObject: <responses.DeleteOciCacheBackupResponse>{},
        responseHeaders: [
          {
            value: response.headers.get("opc-work-request-id"),
            key: "opcWorkRequestId",
   ...
   */
  public async exportOciCacheBackupToObjectStorage(
    exportOciCacheBackupToObjectStorageRequest: requests.ExportOciCacheBackupToObjectStorageRequest
  ): Promise<responses.ExportOciCacheBackupToObjectStorageResponse> {
    if (this.logger)
      this.logger.debug(
        "Calling operation OciCacheBackupClient#exportOciCacheBackupToObjectStorage."
      );
    ...
    const retrier = GenericRetrier.createPreferredRetrier(
      this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined,
      exportOciCacheBackupToObjectStorageRequest.retryConfiguration,
      specRetryConfiguration
    );
    if (this.logger) retrier.logger = this.logger;
    const request = await composeRequest({
      ...
      method: "POST",
      bodyContent: common.ObjectSerializer.serialize(
        exportOciCacheBackupToObjectStorageRequest.exportOciCacheBackupToObjectStorageDetails,
        "ExportOciCacheBackupToObjectStorageDetails",
        model.ExportOciCacheBackupToObjectStorageDetails.getJsonObj
      ),
      pathParams: pathParams,
      headerParams: headerParams,
      queryParams: queryParams
    ...
    try {
      ...
      const sdkResponse = composeResponse({
        responseObject: <responses.ExportOciCacheBackupToObjectStorageResponse>{},
        responseHeaders: [
          {
            value: response.headers.get("opc-work-request-id"),
            key: "opcWorkRequestId",
   ...
   */
  public async getOciCacheBackup(
    getOciCacheBackupRequest: requests.GetOciCacheBackupRequest
  ): Promise<responses.GetOciCacheBackupResponse> {
    if (this.logger) this.logger.debug("Calling operation OciCacheBackupClient#getOciCacheBackup.");
    ...
    const retrier = GenericRetrier.createPreferredRetrier(
      this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined,
      getOciCacheBackupRequest.retryConfiguration,
      specRetryConfiguration
    );
    if (this.logger) retrier.logger = this.logger;
    const request = await composeRequest({
    ...
    try {
      ...
      const sdkResponse = composeResponse({
        responseObject: <responses.GetOciCacheBackupResponse>{},
        body: await response.json(),
        bodyKey: "ociCacheBackup",
        bodyModel: model.OciCacheBackup,
        type: "model.OciCacheBackup",
   ...
   */
  public async listOciCacheBackups(
    listOciCacheBackupsRequest: requests.ListOciCacheBackupsRequest
  ): Promise<responses.ListOciCacheBackupsResponse> {
    if (this.logger)
    ...
    const retrier = GenericRetrier.createPreferredRetrier(
      this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined,
      listOciCacheBackupsRequest.retryConfiguration,
      specRetryConfiguration
    );
    if (this.logger) retrier.logger = this.logger;
    const request = await composeRequest({
    ...
    try {
      ...
      const sdkResponse = composeResponse({
        responseObject: <responses.ListOciCacheBackupsResponse>{},
        body: await response.json(),
   ...
   */
  public async updateOciCacheBackup(
    updateOciCacheBackupRequest: requests.UpdateOciCacheBackupRequest
  ): Promise<responses.UpdateOciCacheBackupResponse> {
    if (this.logger)
    ...
    const retrier = GenericRetrier.createPreferredRetrier(
      this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined,
      updateOciCacheBackupRequest.retryConfiguration,
      specRetryConfiguration
    );
    if (this.logger) retrier.logger = this.logger;
    const request = await composeRequest({
      ...
      method: "PUT",
      bodyContent: common.ObjectSerializer.serialize(
        updateOciCacheBackupRequest.updateOciCacheBackupDetails,
        "UpdateOciCacheBackupDetails",
        model.UpdateOciCacheBackupDetails.getJsonObj
      ),
      pathParams: pathParams,
      headerParams: headerParams,
      queryParams: queryParams
    ...
    try {
      ...
      const sdkResponse = composeResponse({
        responseObject: <responses.UpdateOciCacheBackupResponse>{},
        body: await response.json(),
        bodyKey: "ociCacheBackup",
        bodyModel: model.OciCacheBackup,
        type: "model.OciCacheBackup",
...
export enum OciCacheEngineOptionsApiKeys {}
/**
 * This service client uses {@link common.CircuitBreaker.DefaultConfiguration} for all the operations by default if no circuit breaker configuration is defined by the user.
 */
export class OciCacheEngineOptionsClient {
  protected static serviceEndpointTemplate = "https://redis.{region}.oci.{secondLevelDomain}";
  protected static endpointServiceName = "";
  protected "_realmSpecificEndpointTemplateEnabled": boolean | undefined = undefined;
  protected "_endpoint": string = "";
  ...
  protected _httpOptions: any = undefined;
  protected _bodyDuplexMode: any = undefined;
  public targetService = "OciCacheEngineOptions";
  protected _regionId: string = "";
  protected "_region": common.Region;
  protected _lastSetRegionOrRegionId: string = "";
  ...
  public set useRealmSpecificEndpointTemplate(realmSpecificEndpointTemplateEnabled: boolean) {
    ...
    if (this._lastSetRegionOrRegionId === common.Region.REGION_STRING) {
      this.endpoint = common.EndpointBuilder.createEndpointFromRegion(
        OciCacheEngineOptionsClient.serviceEndpointTemplate,
        this._region,
   ...
   */
  public async listOciCacheEngineOptions(
    listOciCacheEngineOptionsRequest: requests.ListOciCacheEngineOptionsRequest
  ): Promise<responses.ListOciCacheEngineOptionsResponse> {
    if (this.logger)
    ...
    const retrier = GenericRetrier.createPreferredRetrier(
      this._clientConfiguration ? this._clientConfiguration.retryConfiguration : undefined,
      listOciCacheEngineOptionsRequest.retryConfiguration,
      specRetryConfiguration
    );
    if (this.logger) retrier.logger = this.logger;
    const request = await composeRequest({
    ...
    try {
      ...
      const sdkResponse = composeResponse({
        responseObject: <responses.ListOciCacheEngineOptionsResponse>{},
        body: await response.json(),
