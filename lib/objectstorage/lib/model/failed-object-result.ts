...
export namespace FailedObjectResult {
  export function getJsonObj(obj: FailedObjectResult): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: FailedObjectResult): object {
    const jsonObj = { ...obj, ...{} };
