 ...
 */
export interface CreateRetentionRuleDetails {
  /**
...
export namespace CreateRetentionRuleDetails {
  export function getJsonObj(obj: CreateRetentionRuleDetails): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: CreateRetentionRuleDetails): object {
    const jsonObj = {
      ...obj,
      ...{
