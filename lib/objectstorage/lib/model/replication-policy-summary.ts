 ...
 */
export interface ReplicationPolicySummary {
  /**
   ...
   *
   */
  "status": ReplicationPolicySummary.Status;
  /**
...
export namespace ReplicationPolicySummary {
  export enum Status {
    Active = "ACTIVE",
  ...
  export function getJsonObj(obj: ReplicationPolicySummary): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: ReplicationPolicySummary): object {
    const jsonObj = { ...obj, ...{} };
