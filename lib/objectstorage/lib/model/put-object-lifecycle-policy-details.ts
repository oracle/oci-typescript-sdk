 ...
 *
 */
export interface PutObjectLifecyclePolicyDetails {
  /**
...
export namespace PutObjectLifecyclePolicyDetails {
  export function getJsonObj(obj: PutObjectLifecyclePolicyDetails): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
