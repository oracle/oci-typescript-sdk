...
export interface RetentionRuleCollection {
   ...
   *
   */
  "items": Array<model.RetentionRuleSummary>;
}

export namespace RetentionRuleCollection {
  export function getJsonObj(obj: RetentionRuleCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
          ? obj.items.map(item => {
              return model.RetentionRuleSummary.getJsonObj(item);
            })
          : undefined
      }
    };
