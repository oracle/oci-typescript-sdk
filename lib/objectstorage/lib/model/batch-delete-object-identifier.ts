...
export namespace BatchDeleteObjectIdentifier {
  export function getJsonObj(obj: BatchDeleteObjectIdentifier): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: BatchDeleteObjectIdentifier): object {
    const jsonObj = { ...obj, ...{} };
