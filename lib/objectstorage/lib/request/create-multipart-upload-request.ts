...
/**
 * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/objectstorage/CreateMultipartUpload.ts.html |here} to see how to use CreateMultipartUploadRequest.
 */
export interface CreateMultipartUploadRequest extends common.BaseRequest {
   ...
   */
  "createMultipartUploadDetails": model.CreateMultipartUploadDetails;
  /**
