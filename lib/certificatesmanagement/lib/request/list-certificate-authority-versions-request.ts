...
/**
 * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/certificatesmanagement/ListCertificateAuthorityVersions.ts.html |here} to see how to use ListCertificateAuthorityVersionsRequest.
 */
...
export namespace ListCertificateAuthorityVersionsRequest {
  export enum SortBy {
