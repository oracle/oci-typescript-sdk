...
export namespace CertificateAuthoritySummary {
  export function getJsonObj(obj: CertificateAuthoritySummary): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: CertificateAuthoritySummary): object {
    const jsonObj = {
      ...obj,
      ...{
        "certificateAuthorityRules": obj.certificateAuthorityRules
          ...
          : undefined,
        "currentVersionSummary": obj.currentVersionSummary
          ? model.CertificateAuthorityVersionSummary.getDeserializedJsonObj(
              obj.currentVersionSummary
            )
          : undefined,
        "subject": obj.subject
