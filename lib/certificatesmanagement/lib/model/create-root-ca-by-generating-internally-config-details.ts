 ...
 */
export interface CreateRootCaByGeneratingInternallyConfigDetails
...
export namespace CreateRootCaByGeneratingInternallyConfigDetails {
  export function getJsonObj(
    obj: CreateRootCaByGeneratingInternallyConfigDetails,
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ...
        : (model.CreateCertificateAuthorityConfigDetails.getJsonObj(
            obj
          ) as CreateRootCaByGeneratingInternallyConfigDetails)),
      ...{
