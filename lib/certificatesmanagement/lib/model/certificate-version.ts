...
export namespace CertificateVersion {
  export function getJsonObj(obj: CertificateVersion): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: CertificateVersion): object {
    const jsonObj = {
      ...obj,
      ...{
        "subjectAlternativeNames": obj.subjectAlternativeNames
