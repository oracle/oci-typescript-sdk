 ...
 */
export interface CreateCertificateByImportingConfigDetails
...
export namespace CreateCertificateByImportingConfigDetails {
  export function getJsonObj(
    obj: CreateCertificateByImportingConfigDetails,
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ...
        : (model.CreateCertificateConfigDetails.getJsonObj(
            obj
          ) as CreateCertificateByImportingConfigDetails)),
      ...{}
    };
