...
export namespace KeyValueDetectionLabelMetricsReport {
  export function getJsonObj(obj: KeyValueDetectionLabelMetricsReport): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: KeyValueDetectionLabelMetricsReport): object {
    const jsonObj = {
      ...obj,
      ...{
        "confidenceEntries": obj.confidenceEntries
