...
export namespace KeyValueDetectionConfidenceEntry {
  export function getJsonObj(obj: KeyValueDetectionConfidenceEntry): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: KeyValueDetectionConfidenceEntry): object {
    const jsonObj = { ...obj, ...{} };
