...
export namespace DocumentClassificationConfidenceEntry {
  export function getJsonObj(obj: DocumentClassificationConfidenceEntry): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: DocumentClassificationConfidenceEntry): object {
    const jsonObj = { ...obj, ...{} };
