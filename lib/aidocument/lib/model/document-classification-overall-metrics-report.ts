...
export namespace DocumentClassificationOverallMetricsReport {
  export function getJsonObj(obj: DocumentClassificationOverallMetricsReport): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: DocumentClassificationOverallMetricsReport): object {
    const jsonObj = {
      ...obj,
      ...{
        "confidenceEntries": obj.confidenceEntries
