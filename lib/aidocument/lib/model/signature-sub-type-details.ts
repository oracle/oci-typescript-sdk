...
export namespace SignatureSubTypeDetails {
  export enum ModelSubType {
    QrBarCode = "QR_BAR_CODE",
    Signature = "SIGNATURE"
  }

  export function getJsonObj(obj: SignatureSubTypeDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: SignatureSubTypeDetails): object {
    const jsonObj = { ...obj, ...{} };
