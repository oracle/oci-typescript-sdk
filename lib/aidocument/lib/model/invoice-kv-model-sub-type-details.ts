...
export namespace InvoiceKvModelSubTypeDetails {
  ...
  export function getJsonObj(obj: InvoiceKvModelSubTypeDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: InvoiceKvModelSubTypeDetails): object {
    const jsonObj = { ...obj, ...{} };
