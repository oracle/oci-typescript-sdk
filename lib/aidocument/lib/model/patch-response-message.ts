...
export namespace PatchResponseMessage {
  export function getJsonObj(obj: PatchResponseMessage): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: PatchResponseMessage): object {
    const jsonObj = { ...obj, ...{} };
