...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/database/ListGiHomes.ts.html |here} to see how to use ListGiHomesRequest.
 */
export interface ListGiHomesRequest extends common.BaseRequest {
  /**
...
export namespace ListGiHomesRequest {
  export enum SortBy {
