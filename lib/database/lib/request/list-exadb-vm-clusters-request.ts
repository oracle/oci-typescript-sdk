...
/**
 * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/database/ListExadbVmClusters.ts.html |here} to see how to use ListExadbVmClustersRequest.
 */
...
export namespace ListExadbVmClustersRequest {
  export enum SortBy {
