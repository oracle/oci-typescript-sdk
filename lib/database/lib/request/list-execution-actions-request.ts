...
/**
 * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/database/ListExecutionActions.ts.html |here} to see how to use ListExecutionActionsRequest.
 */
...
export namespace ListExecutionActionsRequest {
  export enum SortBy {
