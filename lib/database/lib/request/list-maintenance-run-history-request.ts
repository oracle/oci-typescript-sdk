...
/**
 * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/database/ListMaintenanceRunHistory.ts.html |here} to see how to use ListMaintenanceRunHistoryRequest.
 */
...
export namespace ListMaintenanceRunHistoryRequest {
  export enum SortBy {
