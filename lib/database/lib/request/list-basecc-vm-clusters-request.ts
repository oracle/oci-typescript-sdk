...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/database/ListBaseccVmClusters.ts.html |here} to see how to use ListBaseccVmClustersRequest.
 */
export interface ListBaseccVmClustersRequest extends common.BaseRequest {
  /**
...
export namespace ListBaseccVmClustersRequest {
  export enum SortBy {
