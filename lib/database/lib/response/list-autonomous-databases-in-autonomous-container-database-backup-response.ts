...
export interface ListAutonomousDatabasesInAutonomousContainerDatabaseBackupResponse {
  /**
  ...
  "opcNextPage": string;
  /**
   * The returned model.AutonomousDatabaseInBackupCollection instance.
   */
  "autonomousDatabaseInBackupCollection": model.AutonomousDatabaseInBackupCollection;
}
