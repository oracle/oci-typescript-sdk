  ...
  export function getJsonObj(obj: CreateDatabaseBase): object {
    ...
    if (obj && "source" in obj && obj.source) {
      switch (obj.source) {
        ...
        case "DATABASE":
          return model.CreateDatabaseFromDatabase.getJsonObj(
            <model.CreateDatabaseFromDatabase>(<object>jsonObj),
            true
          );
        case "DB_BACKUP":
  ...
  export function getDeserializedJsonObj(obj: CreateDatabaseBase): object {
    ...
    if (obj && "source" in obj && obj.source) {
      switch (obj.source) {
        ...
        case "DATABASE":
          return model.CreateDatabaseFromDatabase.getDeserializedJsonObj(
            <model.CreateDatabaseFromDatabase>(<object>jsonObj),
            true
          );
        case "DB_BACKUP":
