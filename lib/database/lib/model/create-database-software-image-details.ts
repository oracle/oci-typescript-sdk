...
export namespace CreateDatabaseSoftwareImageDetails {
  ...
  export function getJsonObj(obj: CreateDatabaseSoftwareImageDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: CreateDatabaseSoftwareImageDetails): object {
    const jsonObj = { ...obj, ...{} };
