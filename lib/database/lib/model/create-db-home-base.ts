    ...
    if (obj && "source" in obj && obj.source) {
      switch (obj.source) {
        ...
        case "VM_CLUSTER_DATABASE":
          return model.CreateDbHomeWithVmClusterIdFromDatabaseDetails.getJsonObj(
            <model.CreateDbHomeWithVmClusterIdFromDatabaseDetails>(<object>jsonObj),
            true
          );
  ...
  export function getDeserializedJsonObj(obj: CreateDbHomeBase): object {
    ...
    if (obj && "source" in obj && obj.source) {
      switch (obj.source) {
        ...
        case "VM_CLUSTER_DATABASE":
          return model.CreateDbHomeWithVmClusterIdFromDatabaseDetails.getDeserializedJsonObj(
            <model.CreateDbHomeWithVmClusterIdFromDatabaseDetails>(<object>jsonObj),
            true
          );
        case "VM_CLUSTER_BACKUP":
