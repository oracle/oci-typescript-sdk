...
export namespace RotateCloudAutonomousVmClusterSslCertsDetails {
  export enum CertificateGenerationType {
    System = "SYSTEM",
    Byoc = "BYOC"
  }

  export function getJsonObj(obj: RotateCloudAutonomousVmClusterSslCertsDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(
    obj: RotateCloudAutonomousVmClusterSslCertsDetails
  ): object {
    const jsonObj = { ...obj, ...{} };
