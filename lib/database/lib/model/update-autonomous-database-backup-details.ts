...
export namespace UpdateAutonomousDatabaseBackupDetails {
  export function getJsonObj(obj: UpdateAutonomousDatabaseBackupDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: UpdateAutonomousDatabaseBackupDetails): object {
    const jsonObj = { ...obj, ...{} };
