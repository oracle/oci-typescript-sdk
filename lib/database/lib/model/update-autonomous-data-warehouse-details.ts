 ...
 *
 */
export interface UpdateAutonomousDataWarehouseDetails {
  /**
...
export namespace UpdateAutonomousDataWarehouseDetails {
  export function getJsonObj(obj: UpdateAutonomousDataWarehouseDetails): object {
    const jsonObj = { ...obj, ...{} };
