...
export namespace ExecutionAction {
  ...
  export function getJsonObj(obj: ExecutionAction): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: ExecutionAction): object {
    const jsonObj = {
      ...obj,
      ...{
        "actionMembers": obj.actionMembers
