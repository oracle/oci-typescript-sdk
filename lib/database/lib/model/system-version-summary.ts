...
export namespace SystemVersionSummary {
  export function getJsonObj(obj: SystemVersionSummary): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: SystemVersionSummary): object {
    const jsonObj = { ...obj, ...{} };
