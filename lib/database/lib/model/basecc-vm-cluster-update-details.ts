 ...
 *
 */
export interface BaseccVmClusterUpdateDetails {
  /**
   ...
   */
  "updateAction"?: BaseccVmClusterUpdateDetails.UpdateAction;
  /**
...
export namespace BaseccVmClusterUpdateDetails {
  ...
  export function getJsonObj(obj: BaseccVmClusterUpdateDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: BaseccVmClusterUpdateDetails): object {
    const jsonObj = { ...obj, ...{} };
