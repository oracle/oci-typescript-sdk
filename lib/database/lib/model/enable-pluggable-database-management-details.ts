...
export namespace EnablePluggableDatabaseManagementDetails {
  ...
  export function getJsonObj(obj: EnablePluggableDatabaseManagementDetails): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: EnablePluggableDatabaseManagementDetails): object {
    const jsonObj = {
      ...obj,
      ...{
        "credentialDetails": obj.credentialDetails
