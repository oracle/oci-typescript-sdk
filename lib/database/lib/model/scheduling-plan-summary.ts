...
export namespace SchedulingPlanSummary {
  ...
  export function getJsonObj(obj: SchedulingPlanSummary): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: SchedulingPlanSummary): object {
    const jsonObj = { ...obj, ...{} };
