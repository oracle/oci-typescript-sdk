 ...
 *
 */
export interface BaseccVmCluster {
  /**
   ...
   */
  "lifecycleState": BaseccVmCluster.LifecycleState;
  /**
   ...
   *
   */
  "databaseEdition"?: BaseccVmCluster.DatabaseEdition;
  /**
   ...
   *
   */
  "licenseModel"?: BaseccVmCluster.LicenseModel;
  /**
...
* 
   ...
   */
  "vmClusterType"?: BaseccVmCluster.VmClusterType;
  "cloudAutomationUpdateDetails"?: model.CloudAutomationUpdateDetails;
}

export namespace BaseccVmCluster {
  ...
  export function getJsonObj(obj: BaseccVmCluster): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: BaseccVmCluster): object {
    const jsonObj = {
      ...obj,
      ...{
        "dataCollectionOptions": obj.dataCollectionOptions
