...
export namespace ResourcePoolMemberSummary {
  export function getJsonObj(obj: ResourcePoolMemberSummary): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: ResourcePoolMemberSummary): object {
    const jsonObj = { ...obj, ...{} };
