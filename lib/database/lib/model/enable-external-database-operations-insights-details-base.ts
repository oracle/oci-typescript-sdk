...
export namespace EnableExternalDatabaseOperationsInsightsDetailsBase {
  export function getJsonObj(obj: EnableExternalDatabaseOperationsInsightsDetailsBase): object {
    const jsonObj = { ...obj, ...{} };
