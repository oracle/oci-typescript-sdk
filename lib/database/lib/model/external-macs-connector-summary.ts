...
export namespace ExternalMacsConnectorSummary {
  export function getJsonObj(obj: ExternalMacsConnectorSummary, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.ExternalDatabaseConnectorSummary.getJsonObj(obj) as ExternalMacsConnectorSummary)),
      ...{
  ...
  export function getDeserializedJsonObj(
    obj: ExternalMacsConnectorSummary,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.ExternalDatabaseConnectorSummary.getDeserializedJsonObj(
            obj
          ) as ExternalMacsConnectorSummary)),
      ...{
        "connectionString": obj.connectionString
