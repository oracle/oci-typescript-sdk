...
export namespace RotateAutonomousDatabaseEncryptionKeyDetails {
  export function getJsonObj(obj: RotateAutonomousDatabaseEncryptionKeyDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(
    obj: RotateAutonomousDatabaseEncryptionKeyDetails
  ): object {
    const jsonObj = { ...obj, ...{} };
