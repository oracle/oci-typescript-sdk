...
export namespace CreateSchedulingWindowDetails {
  export function getJsonObj(obj: CreateSchedulingWindowDetails): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: CreateSchedulingWindowDetails): object {
    const jsonObj = {
      ...obj,
      ...{
        "windowPreference": obj.windowPreference
