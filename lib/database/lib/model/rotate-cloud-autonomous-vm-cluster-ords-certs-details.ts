...
export namespace RotateCloudAutonomousVmClusterOrdsCertsDetails {
  export enum CertificateGenerationType {
    System = "SYSTEM",
    Byoc = "BYOC"
  }

  export function getJsonObj(obj: RotateCloudAutonomousVmClusterOrdsCertsDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(
    obj: RotateCloudAutonomousVmClusterOrdsCertsDetails
  ): object {
    const jsonObj = { ...obj, ...{} };
