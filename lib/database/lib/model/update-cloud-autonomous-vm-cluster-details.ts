...
export interface UpdateCloudAutonomousVmClusterDetails {
  ...
  /**
   * The new scaled up/down value for exadata storage in TBs for cloud autonomous VM cluster. Note: Numbers greater than Number.MAX_SAFE_INTEGER will result in rounding issues.
   */
  "autonomousDataStorageSizeInTBs"?: number;
  /**
   * The new scaled up/down value for ocpus for cloud autonomous VM cluster per node. Note: Numbers greater than Number.MAX_SAFE_INTEGER will result in rounding issues.
   */
  "cpuCoreCountPerNode"?: number;
  /**
   * The new scaled up/down value for maxACD count for cloud autonomous VM cluster. Note: Numbers greater than Number.MAX_SAFE_INTEGER will result in rounding issues.
   */
