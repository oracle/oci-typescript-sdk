 ...
 *
 */
export interface CreateGiHomeDetails {
  /**
...
export namespace CreateGiHomeDetails {
  export function getJsonObj(obj: CreateGiHomeDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: CreateGiHomeDetails): object {
    const jsonObj = { ...obj, ...{} };
