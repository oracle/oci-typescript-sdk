...
export namespace AcdAvmResourceStats {
  export function getJsonObj(obj: AcdAvmResourceStats): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: AcdAvmResourceStats): object {
    const jsonObj = { ...obj, ...{} };
