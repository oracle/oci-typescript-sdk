...
export namespace CreateSchedulingPolicyDetails {
  export enum Cadence {
  ...
  export function getJsonObj(obj: CreateSchedulingPolicyDetails): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: CreateSchedulingPolicyDetails): object {
    const jsonObj = {
      ...obj,
      ...{
        "cadenceStartMonth": obj.cadenceStartMonth
