...
export namespace RegisterAutonomousDatabaseDataSafeDetails {
  export function getJsonObj(obj: RegisterAutonomousDatabaseDataSafeDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: RegisterAutonomousDatabaseDataSafeDetails): object {
    const jsonObj = { ...obj, ...{} };
