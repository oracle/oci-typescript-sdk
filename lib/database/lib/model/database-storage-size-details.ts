...
export namespace DatabaseStorageSizeDetails {
  export function getJsonObj(obj: DatabaseStorageSizeDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: DatabaseStorageSizeDetails): object {
    const jsonObj = { ...obj, ...{} };
