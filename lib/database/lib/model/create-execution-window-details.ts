...
export namespace CreateExecutionWindowDetails {
  export function getJsonObj(obj: CreateExecutionWindowDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: CreateExecutionWindowDetails): object {
    const jsonObj = { ...obj, ...{} };
