 ...
 *
 */
export interface AutonomousDataWarehouseBackup {
  /**
   ...
   * The type of backup.
   */
  "type": AutonomousDataWarehouseBackup.Type;
  /**
   ...
   */
  "lifecycleState": AutonomousDataWarehouseBackup.LifecycleState;
}

export namespace AutonomousDataWarehouseBackup {
  export enum Type {
  ...
  export function getJsonObj(obj: AutonomousDataWarehouseBackup): object {
    const jsonObj = { ...obj, ...{} };
