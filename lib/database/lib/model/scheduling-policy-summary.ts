...
export namespace SchedulingPolicySummary {
  ...
  export function getJsonObj(obj: SchedulingPolicySummary): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: SchedulingPolicySummary): object {
    const jsonObj = {
      ...obj,
      ...{
        "cadenceStartMonth": obj.cadenceStartMonth
