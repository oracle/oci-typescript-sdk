...
export namespace ExternalPluggableDatabase {
  ...
  export function getJsonObj(obj: ExternalPluggableDatabase): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: ExternalPluggableDatabase): object {
    const jsonObj = {
      ...obj,
      ...{
        "operationsInsightsConfig": obj.operationsInsightsConfig
