 ...
 *
 */
export interface RestoreAutonomousDataWarehouseDetails {
  /**
...
export namespace RestoreAutonomousDataWarehouseDetails {
  export function getJsonObj(obj: RestoreAutonomousDataWarehouseDetails): object {
    const jsonObj = { ...obj, ...{} };
