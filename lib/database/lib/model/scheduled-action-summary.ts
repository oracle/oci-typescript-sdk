...
export namespace ScheduledActionSummary {
  ...
  export function getJsonObj(obj: ScheduledActionSummary): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: ScheduledActionSummary): object {
    const jsonObj = {
      ...obj,
      ...{
        "actionMembers": obj.actionMembers
