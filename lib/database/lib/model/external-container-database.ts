...
export namespace ExternalContainerDatabase {
  ...
  export function getJsonObj(obj: ExternalContainerDatabase): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: ExternalContainerDatabase): object {
    const jsonObj = {
      ...obj,
      ...{
        "databaseManagementConfig": obj.databaseManagementConfig
