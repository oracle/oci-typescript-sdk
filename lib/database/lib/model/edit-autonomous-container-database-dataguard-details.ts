...
export namespace EditAutonomousContainerDatabaseDataguardDetails {
  export enum ProtectionMode {
    MaximumAvailability = "MAXIMUM_AVAILABILITY",
    MaximumPerformance = "MAXIMUM_PERFORMANCE"
  }

  export function getJsonObj(obj: EditAutonomousContainerDatabaseDataguardDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(
    obj: EditAutonomousContainerDatabaseDataguardDetails
  ): object {
    const jsonObj = { ...obj, ...{} };
