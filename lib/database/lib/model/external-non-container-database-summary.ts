...
export namespace ExternalNonContainerDatabaseSummary {
  ...
  export function getJsonObj(obj: ExternalNonContainerDatabaseSummary): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: ExternalNonContainerDatabaseSummary): object {
    const jsonObj = {
      ...obj,
      ...{
        "operationsInsightsConfig": obj.operationsInsightsConfig
