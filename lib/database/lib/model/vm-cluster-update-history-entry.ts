...
export interface VmClusterUpdateHistoryEntry {
   ...
   */
  "updateMode"?: VmClusterUpdateHistoryEntry.UpdateMode;
  /**
...
export namespace VmClusterUpdateHistoryEntry {
  ...
  export function getJsonObj(obj: VmClusterUpdateHistoryEntry): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: VmClusterUpdateHistoryEntry): object {
    const jsonObj = { ...obj, ...{} };
