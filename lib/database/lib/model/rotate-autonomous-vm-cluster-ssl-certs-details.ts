...
export namespace RotateAutonomousVmClusterSslCertsDetails {
  export enum CertificateGenerationType {
    System = "SYSTEM",
    Byoc = "BYOC"
  }

  export function getJsonObj(obj: RotateAutonomousVmClusterSslCertsDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: RotateAutonomousVmClusterSslCertsDetails): object {
    const jsonObj = { ...obj, ...{} };
