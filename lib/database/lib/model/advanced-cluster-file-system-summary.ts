...
export namespace AdvancedClusterFileSystemSummary {
  export function getJsonObj(obj: AdvancedClusterFileSystemSummary): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: AdvancedClusterFileSystemSummary): object {
    const jsonObj = { ...obj, ...{} };
