...
* 
*/
export interface MaintenanceVersionPreferenceDetails {
  /**
...
export namespace MaintenanceVersionPreferenceDetails {
  export function getJsonObj(obj: MaintenanceVersionPreferenceDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: MaintenanceVersionPreferenceDetails): object {
    const jsonObj = { ...obj, ...{} };
