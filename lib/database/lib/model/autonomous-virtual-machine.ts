...
export namespace AutonomousVirtualMachine {
  ...
  export function getJsonObj(obj: AutonomousVirtualMachine): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: AutonomousVirtualMachine): object {
    const jsonObj = { ...obj, ...{} };
