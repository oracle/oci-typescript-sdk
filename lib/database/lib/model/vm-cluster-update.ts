...
export namespace VmClusterUpdate {
  ...
  export function getJsonObj(obj: VmClusterUpdate): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: VmClusterUpdate): object {
    const jsonObj = { ...obj, ...{} };
