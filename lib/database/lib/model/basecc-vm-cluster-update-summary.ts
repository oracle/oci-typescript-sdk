...
* 
*/
export interface BaseccVmClusterUpdateSummary {
  /**
   ...
   */
  "lifecycleState"?: BaseccVmClusterUpdateSummary.LifecycleState;
  /**
...
export namespace BaseccVmClusterUpdateSummary {
  ...
  export function getJsonObj(obj: BaseccVmClusterUpdateSummary): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: BaseccVmClusterUpdateSummary): object {
    const jsonObj = { ...obj, ...{} };
