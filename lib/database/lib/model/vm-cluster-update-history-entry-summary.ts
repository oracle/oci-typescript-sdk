...
export namespace VmClusterUpdateHistoryEntrySummary {
  ...
  export function getJsonObj(obj: VmClusterUpdateHistoryEntrySummary): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: VmClusterUpdateHistoryEntrySummary): object {
    const jsonObj = { ...obj, ...{} };
