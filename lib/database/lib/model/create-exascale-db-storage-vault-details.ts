...
export namespace CreateExascaleDbStorageVaultDetails {
  export function getJsonObj(obj: CreateExascaleDbStorageVaultDetails): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: CreateExascaleDbStorageVaultDetails): object {
    const jsonObj = {
      ...obj,
      ...{
        "highCapacityDatabaseStorage": obj.highCapacityDatabaseStorage
