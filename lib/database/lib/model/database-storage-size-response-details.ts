...
export namespace DatabaseStorageSizeResponseDetails {
  export function getJsonObj(obj: DatabaseStorageSizeResponseDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: DatabaseStorageSizeResponseDetails): object {
    const jsonObj = { ...obj, ...{} };
