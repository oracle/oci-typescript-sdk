...
export namespace CreateVolumeMountDetails {
  export function getJsonObj(obj: CreateVolumeMountDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: CreateVolumeMountDetails): object {
    const jsonObj = { ...obj, ...{} };
