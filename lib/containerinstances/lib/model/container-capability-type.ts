 ...
 **/
export enum ContainerCapabilityType {
  CapChown = "CAP_CHOWN",
...
export namespace ContainerCapabilityType {
  export function getJsonObj(obj: ContainerCapabilityType): ContainerCapabilityType {
    return obj;
  }
  export function getDeserializedJsonObj(obj: ContainerCapabilityType): ContainerCapabilityType {
    return obj;
  }
}
