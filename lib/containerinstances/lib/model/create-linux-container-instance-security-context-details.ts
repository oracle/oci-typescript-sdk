 ...
 */
export interface CreateLinuxContainerInstanceSecurityContextDetails
  extends model.CreateContainerInstanceSecurityContextDetails {
  /**
...
export namespace CreateLinuxContainerInstanceSecurityContextDetails {
  export function getJsonObj(
    obj: CreateLinuxContainerInstanceSecurityContextDetails,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.CreateContainerInstanceSecurityContextDetails.getJsonObj(
            obj
          ) as CreateLinuxContainerInstanceSecurityContextDetails)),
      ...{}
    };
