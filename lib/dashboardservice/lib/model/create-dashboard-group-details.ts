...
export namespace CreateDashboardGroupDetails {
  export function getJsonObj(obj: CreateDashboardGroupDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: CreateDashboardGroupDetails): object {
    const jsonObj = { ...obj, ...{} };
