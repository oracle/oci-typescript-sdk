...
export namespace DashboardGroupSummary {
  export function getJsonObj(obj: DashboardGroupSummary): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: DashboardGroupSummary): object {
    const jsonObj = { ...obj, ...{} };
