...
export namespace ChangeDashboardGroupCompartmentDetails {
  export function getJsonObj(obj: ChangeDashboardGroupCompartmentDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: ChangeDashboardGroupCompartmentDetails): object {
    const jsonObj = { ...obj, ...{} };
