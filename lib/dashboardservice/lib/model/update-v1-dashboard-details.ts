...
export namespace UpdateV1DashboardDetails {
  export function getJsonObj(obj: UpdateV1DashboardDetails, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.UpdateDashboardDetails.getJsonObj(obj) as UpdateV1DashboardDetails)),
      ...{}
    };
  ...
  export function getDeserializedJsonObj(
    obj: UpdateV1DashboardDetails,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.UpdateDashboardDetails.getDeserializedJsonObj(obj) as UpdateV1DashboardDetails)),
      ...{}
    };
