...
/**
 * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/capacitymanagement/ListOccOverviews.ts.html |here} to see how to use ListOccOverviewsRequest.
 */
...
export namespace ListOccOverviewsRequest {
  export enum SortBy {
