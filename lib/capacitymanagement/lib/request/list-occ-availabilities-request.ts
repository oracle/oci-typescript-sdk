...
/**
 * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/capacitymanagement/ListOccAvailabilities.ts.html |here} to see how to use ListOccAvailabilitiesRequest.
 */
...
export namespace ListOccAvailabilitiesRequest {
  export enum SortBy {
