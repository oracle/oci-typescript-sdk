...
/**
 * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/capacitymanagement/ListOccHandoverResourceBlockDetails.ts.html |here} to see how to use ListOccHandoverResourceBlockDetailsRequest.
 */
...
export namespace ListOccHandoverResourceBlockDetailsRequest {
  export enum SortBy {
