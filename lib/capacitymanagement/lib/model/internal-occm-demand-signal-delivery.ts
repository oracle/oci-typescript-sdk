...
export namespace InternalOccmDemandSignalDelivery {
  ...
  export function getJsonObj(obj: InternalOccmDemandSignalDelivery): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: InternalOccmDemandSignalDelivery): object {
    const jsonObj = { ...obj, ...{} };
