...
export namespace OccmDemandSignalItemCollection {
  export function getJsonObj(obj: OccmDemandSignalItemCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
  ...
  export function getDeserializedJsonObj(obj: OccmDemandSignalItemCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
