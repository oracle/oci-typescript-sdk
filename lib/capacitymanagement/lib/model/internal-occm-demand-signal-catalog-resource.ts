...
export namespace InternalOccmDemandSignalCatalogResource {
  ...
  export function getJsonObj(obj: InternalOccmDemandSignalCatalogResource): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: InternalOccmDemandSignalCatalogResource): object {
    const jsonObj = {
      ...obj,
      ...{
        "resourceProperties": obj.resourceProperties
