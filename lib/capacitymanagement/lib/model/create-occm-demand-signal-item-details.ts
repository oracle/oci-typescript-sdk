...
export namespace CreateOccmDemandSignalItemDetails {
  export function getJsonObj(obj: CreateOccmDemandSignalItemDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: CreateOccmDemandSignalItemDetails): object {
    const jsonObj = { ...obj, ...{} };
