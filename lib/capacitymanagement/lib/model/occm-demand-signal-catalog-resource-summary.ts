...
export namespace OccmDemandSignalCatalogResourceSummary {
  export function getJsonObj(obj: OccmDemandSignalCatalogResourceSummary): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: OccmDemandSignalCatalogResourceSummary): object {
    const jsonObj = {
      ...obj,
      ...{
        "resourceProperties": obj.resourceProperties
