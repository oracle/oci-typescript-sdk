...
export namespace OccmDemandSignalCatalog {
  ...
  export function getJsonObj(obj: OccmDemandSignalCatalog): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: OccmDemandSignalCatalog): object {
    const jsonObj = { ...obj, ...{} };
