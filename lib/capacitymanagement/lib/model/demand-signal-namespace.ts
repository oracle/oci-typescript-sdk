 ...
 *
 **/
export enum DemandSignalNamespace {
  Compute = "COMPUTE",
  Network = "NETWORK",
  Gpu = "GPU",
  Storage = "STORAGE",
...
export namespace DemandSignalNamespace {
  export function getJsonObj(obj: DemandSignalNamespace): DemandSignalNamespace {
    return obj;
  }
  export function getDeserializedJsonObj(obj: DemandSignalNamespace): DemandSignalNamespace {
    return obj;
  }
}
