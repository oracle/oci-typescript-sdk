...
export namespace UpdateOccAvailabilityCatalogDetails {
  export function getJsonObj(obj: UpdateOccAvailabilityCatalogDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: UpdateOccAvailabilityCatalogDetails): object {
    const jsonObj = { ...obj, ...{} };
