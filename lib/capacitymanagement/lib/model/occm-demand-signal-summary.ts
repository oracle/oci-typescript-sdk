...
export namespace OccmDemandSignalSummary {
  export function getJsonObj(obj: OccmDemandSignalSummary): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: OccmDemandSignalSummary): object {
    const jsonObj = { ...obj, ...{} };
