...
export namespace OccmDemandSignalItemSummary {
  export function getJsonObj(obj: OccmDemandSignalItemSummary): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: OccmDemandSignalItemSummary): object {
    const jsonObj = { ...obj, ...{} };
