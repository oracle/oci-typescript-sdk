...
export namespace InternalOccmDemandSignalItemSummary {
  export function getJsonObj(obj: InternalOccmDemandSignalItemSummary): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: InternalOccmDemandSignalItemSummary): object {
    const jsonObj = { ...obj, ...{} };
