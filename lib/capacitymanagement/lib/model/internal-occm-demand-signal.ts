...
export namespace InternalOccmDemandSignal {
  export function getJsonObj(obj: InternalOccmDemandSignal): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: InternalOccmDemandSignal): object {
    const jsonObj = { ...obj, ...{} };
