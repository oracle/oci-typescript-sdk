...
export namespace CreateOccmDemandSignalDetails {
  export function getJsonObj(obj: CreateOccmDemandSignalDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: CreateOccmDemandSignalDetails): object {
    const jsonObj = { ...obj, ...{} };
