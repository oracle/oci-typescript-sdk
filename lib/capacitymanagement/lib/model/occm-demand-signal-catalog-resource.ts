...
export namespace OccmDemandSignalCatalogResource {
  ...
  export function getJsonObj(obj: OccmDemandSignalCatalogResource): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: OccmDemandSignalCatalogResource): object {
    const jsonObj = {
      ...obj,
      ...{
        "resourceProperties": obj.resourceProperties
