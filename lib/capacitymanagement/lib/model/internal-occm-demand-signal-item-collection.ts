...
export namespace InternalOccmDemandSignalItemCollection {
  export function getJsonObj(obj: InternalOccmDemandSignalItemCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
  ...
  export function getDeserializedJsonObj(obj: InternalOccmDemandSignalItemCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
