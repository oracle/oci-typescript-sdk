...
/**
 * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/loganalytics/ListRecalledData.ts.html |here} to see how to use ListRecalledDataRequest.
 */
...
export namespace ListRecalledDataRequest {
  export enum SortBy {
