...
/**
 * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/loganalytics/ListOverlappingRecalls.ts.html |here} to see how to use ListOverlappingRecallsRequest.
 */
...
export namespace ListOverlappingRecallsRequest {
  export enum SortBy {
