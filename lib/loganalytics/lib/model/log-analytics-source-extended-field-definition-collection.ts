...
export namespace LogAnalyticsSourceExtendedFieldDefinitionCollection {
  export function getJsonObj(obj: LogAnalyticsSourceExtendedFieldDefinitionCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
