...
export namespace LogAnalyticsTemplate {
  export function getJsonObj(obj: LogAnalyticsTemplate): object {
    const jsonObj = {
      ...obj,
      ...{
        "facets": obj.facets
  ...
  export function getDeserializedJsonObj(obj: LogAnalyticsTemplate): object {
    const jsonObj = {
      ...obj,
      ...{
        "facets": obj.facets
