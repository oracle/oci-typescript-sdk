...
export namespace CreateLogAnalyticsEmBridgeDetails {
  export function getJsonObj(obj: CreateLogAnalyticsEmBridgeDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: CreateLogAnalyticsEmBridgeDetails): object {
    const jsonObj = { ...obj, ...{} };
