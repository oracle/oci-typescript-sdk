...
export namespace ChangeLogAnalyticsLogGroupCompartmentDetails {
  export function getJsonObj(obj: ChangeLogAnalyticsLogGroupCompartmentDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(
    obj: ChangeLogAnalyticsLogGroupCompartmentDetails
  ): object {
    const jsonObj = { ...obj, ...{} };
