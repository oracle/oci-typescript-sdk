...
export namespace ValidateLabelConditionResult {
  export function getJsonObj(obj: ValidateLabelConditionResult): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: ValidateLabelConditionResult): object {
    const jsonObj = {
      ...obj,
      ...{
        "conditionBlock": obj.conditionBlock
