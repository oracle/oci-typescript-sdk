...
export namespace LogAnalyticsAssociationCollection {
  export function getJsonObj(obj: LogAnalyticsAssociationCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
  ...
  export function getDeserializedJsonObj(obj: LogAnalyticsAssociationCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
