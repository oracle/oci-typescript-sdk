...
export namespace RecalledDataInfo {
  export function getJsonObj(obj: RecalledDataInfo): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: RecalledDataInfo): object {
    const jsonObj = { ...obj, ...{} };
