...
export namespace LogAnalyticsFieldUsages {
  export function getJsonObj(obj: LogAnalyticsFieldUsages): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: LogAnalyticsFieldUsages): object {
    const jsonObj = {
      ...obj,
      ...{
        "dependentParsers": obj.dependentParsers
