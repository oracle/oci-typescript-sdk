...
export namespace IngestTimeRuleSummaryCollection {
  export function getJsonObj(obj: IngestTimeRuleSummaryCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
  ...
  export function getDeserializedJsonObj(obj: IngestTimeRuleSummaryCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
