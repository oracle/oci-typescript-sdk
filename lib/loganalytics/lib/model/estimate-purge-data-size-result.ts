...
export namespace EstimatePurgeDataSizeResult {
  export function getJsonObj(obj: EstimatePurgeDataSizeResult): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: EstimatePurgeDataSizeResult): object {
    const jsonObj = { ...obj, ...{} };
