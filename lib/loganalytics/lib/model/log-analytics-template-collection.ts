...
export namespace LogAnalyticsTemplateCollection {
  export function getJsonObj(obj: LogAnalyticsTemplateCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
  ...
  export function getDeserializedJsonObj(obj: LogAnalyticsTemplateCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
