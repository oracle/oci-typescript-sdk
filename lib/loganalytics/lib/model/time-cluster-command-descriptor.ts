...
export namespace TimeClusterCommandDescriptor {
  export function getJsonObj(obj: TimeClusterCommandDescriptor, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.AbstractCommandDescriptor.getJsonObj(obj) as TimeClusterCommandDescriptor)),
      ...{
  ...
  export const name = "TIME_CLUSTER";
  export function getDeserializedJsonObj(
    obj: TimeClusterCommandDescriptor,
    ...
    const jsonObj = {
      ...(isParentJsonObj
        ...
        : (model.AbstractCommandDescriptor.getDeserializedJsonObj(
            obj
          ) as TimeClusterCommandDescriptor)),
      ...{
