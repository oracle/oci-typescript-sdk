...
export namespace ChangeRepositoryCompartmentDetails {
  export function getJsonObj(obj: ChangeRepositoryCompartmentDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: ChangeRepositoryCompartmentDetails): object {
    const jsonObj = { ...obj, ...{} };
