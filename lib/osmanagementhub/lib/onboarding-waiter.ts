...
export class OnboardingWaiter {
  public constructor(
    private client: OnboardingClient,
  ...
  public async forProfile(
    ...
    ...targetStates: models.Profile.LifecycleState[]
    ...
    return genericTerminalConditionWaiter(
      ...
      targetStates.includes(models.Profile.LifecycleState.Deleted)
    );
  }
}
