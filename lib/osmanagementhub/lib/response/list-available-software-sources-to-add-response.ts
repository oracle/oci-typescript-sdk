...
export interface ListAvailableSoftwareSourcesToAddResponse {
  /**
  ...
  /**
   * The returned model.SoftwareSourceRepoCollection instance.
   */
  "softwareSourceRepoCollection": model.SoftwareSourceRepoCollection;
}
