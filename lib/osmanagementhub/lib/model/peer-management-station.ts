...
export namespace PeerManagementStation {
  export function getJsonObj(obj: PeerManagementStation): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: PeerManagementStation): object {
    const jsonObj = { ...obj, ...{} };
