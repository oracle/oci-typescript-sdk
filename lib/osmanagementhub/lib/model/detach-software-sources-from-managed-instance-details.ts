...
export namespace DetachSoftwareSourcesFromManagedInstanceDetails {
  export function getJsonObj(obj: DetachSoftwareSourcesFromManagedInstanceDetails): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(
    obj: DetachSoftwareSourcesFromManagedInstanceDetails
  ): object {
    const jsonObj = {
      ...obj,
      ...{
