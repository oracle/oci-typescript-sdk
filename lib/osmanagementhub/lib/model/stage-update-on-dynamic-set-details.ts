...
/**
 * Provides the information used to stage updates on a dynamic set.
 */
export interface StageUpdateOnDynamicSetDetails {
  /**
   * The types of updates to be applied.
   */
  "updateTypes"?: Array<StageUpdateOnDynamicSetDetails.UpdateTypes>;
  /**
...
export namespace StageUpdateOnDynamicSetDetails {
  ...
  export function getJsonObj(obj: StageUpdateOnDynamicSetDetails): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: StageUpdateOnDynamicSetDetails): object {
    const jsonObj = {
      ...obj,
      ...{
        "workRequestDetails": obj.workRequestDetails
