...
export namespace AttachManagedInstancesToLifecycleStageDetails {
  export function getJsonObj(obj: AttachManagedInstancesToLifecycleStageDetails): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(
    obj: AttachManagedInstancesToLifecycleStageDetails
  ): object {
    const jsonObj = {
      ...obj,
      ...{
