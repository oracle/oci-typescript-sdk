...
export namespace WorkRequestEventDataAdditionalDetails {
  export function getJsonObj(obj: WorkRequestEventDataAdditionalDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: WorkRequestEventDataAdditionalDetails): object {
    const jsonObj = { ...obj, ...{} };
