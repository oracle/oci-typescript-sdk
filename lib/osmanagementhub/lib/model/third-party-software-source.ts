...
export namespace ThirdPartySoftwareSource {
  export function getJsonObj(obj: ThirdPartySoftwareSource, isParentJsonObj?: boolean): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.SoftwareSource.getJsonObj(obj) as ThirdPartySoftwareSource)),
      ...{}
    };
  ...
  export function getDeserializedJsonObj(
    obj: ThirdPartySoftwareSource,
    isParentJsonObj?: boolean
  ): object {
    const jsonObj = {
      ...(isParentJsonObj
        ? obj
        : (model.SoftwareSource.getDeserializedJsonObj(obj) as ThirdPartySoftwareSource)),
      ...{}
    };
