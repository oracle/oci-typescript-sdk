...
export namespace InstallationRequirements {
  export function getJsonObj(obj: InstallationRequirements): InstallationRequirements {
    return obj;
  }
  export function getDeserializedJsonObj(obj: InstallationRequirements): InstallationRequirements {
    return obj;
  }
}
