...
export namespace ModuleStreamDetailsBody {
  export function getJsonObj(obj: ModuleStreamDetailsBody): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: ModuleStreamDetailsBody): object {
    const jsonObj = {
      ...obj,
      ...{
        "workRequestDetails": obj.workRequestDetails
