 ...
 */
export interface SnapSpecDetails {
  /**
...
export namespace SnapSpecDetails {
  export function getJsonObj(obj: SnapSpecDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: SnapSpecDetails): object {
    const jsonObj = { ...obj, ...{} };
