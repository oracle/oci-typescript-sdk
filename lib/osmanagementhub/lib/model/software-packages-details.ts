...
export namespace SoftwarePackagesDetails {
  export function getJsonObj(obj: SoftwarePackagesDetails): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: SoftwarePackagesDetails): object {
    const jsonObj = {
      ...obj,
      ...{
        "workRequestDetails": obj.workRequestDetails
