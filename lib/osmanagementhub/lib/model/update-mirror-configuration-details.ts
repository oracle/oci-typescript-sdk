...
export namespace UpdateMirrorConfigurationDetails {
  export function getJsonObj(obj: UpdateMirrorConfigurationDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: UpdateMirrorConfigurationDetails): object {
    const jsonObj = { ...obj, ...{} };
