 ...
 */
export interface RebootDynamicSetDetails {
  /**
...
export namespace RebootDynamicSetDetails {
  export function getJsonObj(obj: RebootDynamicSetDetails): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: RebootDynamicSetDetails): object {
    const jsonObj = {
      ...obj,
      ...{
        "workRequestDetails": obj.workRequestDetails
