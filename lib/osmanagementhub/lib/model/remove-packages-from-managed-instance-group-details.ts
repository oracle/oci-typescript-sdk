...
export namespace RemovePackagesFromManagedInstanceGroupDetails {
  export function getJsonObj(obj: RemovePackagesFromManagedInstanceGroupDetails): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(
    obj: RemovePackagesFromManagedInstanceGroupDetails
  ): object {
    const jsonObj = {
      ...obj,
      ...{
