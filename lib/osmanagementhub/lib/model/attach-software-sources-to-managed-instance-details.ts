...
export namespace AttachSoftwareSourcesToManagedInstanceDetails {
  export function getJsonObj(obj: AttachSoftwareSourcesToManagedInstanceDetails): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(
    obj: AttachSoftwareSourcesToManagedInstanceDetails
  ): object {
    const jsonObj = {
      ...obj,
      ...{
