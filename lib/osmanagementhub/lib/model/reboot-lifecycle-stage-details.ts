...
export namespace RebootLifecycleStageDetails {
  export function getJsonObj(obj: RebootLifecycleStageDetails): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: RebootLifecycleStageDetails): object {
    const jsonObj = {
      ...obj,
      ...{
        "workRequestDetails": obj.workRequestDetails
