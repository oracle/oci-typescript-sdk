...
export namespace RerunWorkRequestDetails {
  export function getJsonObj(obj: RerunWorkRequestDetails): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: RerunWorkRequestDetails): object {
    const jsonObj = {
      ...obj,
      ...{
        "workRequestDetails": obj.workRequestDetails
