...
export namespace SoftwareSourcesDetails {
  export function getJsonObj(obj: SoftwareSourcesDetails): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: SoftwareSourcesDetails): object {
    const jsonObj = {
      ...obj,
      ...{
        "workRequestDetails": obj.workRequestDetails
