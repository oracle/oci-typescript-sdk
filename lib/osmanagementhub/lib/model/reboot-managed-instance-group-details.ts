...
export namespace RebootManagedInstanceGroupDetails {
  export function getJsonObj(obj: RebootManagedInstanceGroupDetails): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: RebootManagedInstanceGroupDetails): object {
    const jsonObj = {
      ...obj,
      ...{
        "workRequestDetails": obj.workRequestDetails
