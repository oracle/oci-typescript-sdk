 ...
 */
export interface InstallPackagesOnDynamicSetDetails {
  /**
...
export namespace InstallPackagesOnDynamicSetDetails {
  export function getJsonObj(obj: InstallPackagesOnDynamicSetDetails): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: InstallPackagesOnDynamicSetDetails): object {
    const jsonObj = {
      ...obj,
      ...{
        "workRequestDetails": obj.workRequestDetails
