...
export namespace CreateEntitlementDetails {
  export function getJsonObj(obj: CreateEntitlementDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: CreateEntitlementDetails): object {
    const jsonObj = { ...obj, ...{} };
