 ...
 */
export interface UpdatePackagesOnDynamicSetDetails {
  /**
   * The types of updates to be applied.
   */
  "updateTypes"?: Array<UpdatePackagesOnDynamicSetDetails.UpdateTypes>;
  /**
...
export namespace UpdatePackagesOnDynamicSetDetails {
  ...
  export function getJsonObj(obj: UpdatePackagesOnDynamicSetDetails): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: UpdatePackagesOnDynamicSetDetails): object {
    const jsonObj = {
      ...obj,
      ...{
        "workRequestDetails": obj.workRequestDetails
