...
export namespace AttachManagedInstancesToManagedInstanceGroupDetails {
  export function getJsonObj(obj: AttachManagedInstancesToManagedInstanceGroupDetails): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(
    obj: AttachManagedInstancesToManagedInstanceGroupDetails
  ): object {
    const jsonObj = {
      ...obj,
      ...{
