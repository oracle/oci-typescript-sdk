...
export namespace ChangeEventCompartmentDetails {
  export function getJsonObj(obj: ChangeEventCompartmentDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: ChangeEventCompartmentDetails): object {
    const jsonObj = { ...obj, ...{} };
