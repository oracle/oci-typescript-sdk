 ...
 */
export interface DynamicSetSummary {
  /**
...
export namespace DynamicSetSummary {
  export function getJsonObj(obj: DynamicSetSummary): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: DynamicSetSummary): object {
    const jsonObj = { ...obj, ...{} };
