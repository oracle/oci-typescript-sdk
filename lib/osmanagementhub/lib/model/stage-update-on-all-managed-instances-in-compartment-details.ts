 ...
 *
 */
export interface StageUpdateOnAllManagedInstancesInCompartmentDetails {
  /**
   ...
   */
  "updateTypes"?: Array<StageUpdateOnAllManagedInstancesInCompartmentDetails.UpdateTypes>;
  "workRequestDetails"?: model.WorkRequestDetails;
}

export namespace StageUpdateOnAllManagedInstancesInCompartmentDetails {
  ...
  export function getJsonObj(obj: StageUpdateOnAllManagedInstancesInCompartmentDetails): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(
    obj: StageUpdateOnAllManagedInstancesInCompartmentDetails
  ): object {
    const jsonObj = {
      ...obj,
      ...{
