...
export namespace AssociateManagedInstancesWithManagementStationDetails {
  export function getJsonObj(obj: AssociateManagedInstancesWithManagementStationDetails): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(
    obj: AssociateManagedInstancesWithManagementStationDetails
  ): object {
    const jsonObj = {
      ...obj,
      ...{
