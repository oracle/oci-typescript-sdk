...
/**
 * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/osmanagementhub/ListLifecycleEnvironments.ts.html |here} to see how to use ListLifecycleEnvironmentsRequest.
 */
...
export namespace ListLifecycleEnvironmentsRequest {
  export enum SortBy {
