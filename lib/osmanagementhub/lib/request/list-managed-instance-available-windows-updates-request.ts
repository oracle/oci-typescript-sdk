...
/**
 * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/osmanagementhub/ListManagedInstanceAvailableWindowsUpdates.ts.html |here} to see how to use ListManagedInstanceAvailableWindowsUpdatesRequest.
 */
...
export namespace ListManagedInstanceAvailableWindowsUpdatesRequest {
  export enum SortBy {
