...
/**
 * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/osmanagementhub/ListAllSoftwarePackages.ts.html |here} to see how to use ListAllSoftwarePackagesRequest.
 */
...
export namespace ListAllSoftwarePackagesRequest {
  export enum SortBy {
