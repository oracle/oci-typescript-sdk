...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/osmanagementhub/RebootDynamicSet.ts.html |here} to see how to use RebootDynamicSetRequest.
 */
export interface RebootDynamicSetRequest extends common.BaseRequest {
  /**
   ...
   *
   */
  "rebootDynamicSetDetails": model.RebootDynamicSetDetails;
  /**
