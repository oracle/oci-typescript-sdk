...
/**
 * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/osmanagementhub/ListLifecycleStages.ts.html |here} to see how to use ListLifecycleStagesRequest.
 */
...
export namespace ListLifecycleStagesRequest {
  export enum SortBy {
