...
export namespace ImportPreAnnotatedDataDetails {
  export function getJsonObj(obj: ImportPreAnnotatedDataDetails): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: ImportPreAnnotatedDataDetails): object {
    const jsonObj = {
      ...obj,
      ...{
        "importFormat": obj.importFormat
