...
/**
 * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/operatoraccesscontrol/ListOperatorControlAssignments.ts.html |here} to see how to use ListOperatorControlAssignmentsRequest.
 */
...
export namespace ListOperatorControlAssignmentsRequest {
  export enum SortBy {
