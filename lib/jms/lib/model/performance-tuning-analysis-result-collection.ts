...
export namespace PerformanceTuningAnalysisResultCollection {
  export function getJsonObj(obj: PerformanceTuningAnalysisResultCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
  ...
  export function getDeserializedJsonObj(obj: PerformanceTuningAnalysisResultCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
