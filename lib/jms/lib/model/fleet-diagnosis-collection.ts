...
export namespace FleetDiagnosisCollection {
  export function getJsonObj(obj: FleetDiagnosisCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
  ...
  export function getDeserializedJsonObj(obj: FleetDiagnosisCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
