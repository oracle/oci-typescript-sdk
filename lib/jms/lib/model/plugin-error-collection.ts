...
export namespace PluginErrorCollection {
  export function getJsonObj(obj: PluginErrorCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
  ...
  export function getDeserializedJsonObj(obj: PluginErrorCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
