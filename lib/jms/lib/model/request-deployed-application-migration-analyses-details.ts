...
export namespace RequestDeployedApplicationMigrationAnalysesDetails {
  export function getJsonObj(obj: RequestDeployedApplicationMigrationAnalysesDetails): object {
    const jsonObj = {
      ...obj,
      ...{
        "targets": obj.targets
  ...
  export function getDeserializedJsonObj(
    obj: RequestDeployedApplicationMigrationAnalysesDetails
  ): object {
    const jsonObj = {
      ...obj,
      ...{
