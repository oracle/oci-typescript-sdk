...
export namespace PluginErrorAggregation {
  export function getJsonObj(obj: PluginErrorAggregation): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: PluginErrorAggregation): object {
    const jsonObj = { ...obj, ...{} };
