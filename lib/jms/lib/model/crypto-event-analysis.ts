...
export namespace CryptoEventAnalysis {
  export function getJsonObj(obj: CryptoEventAnalysis): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: CryptoEventAnalysis): object {
    const jsonObj = {
      ...obj,
      ...{
        "summarizedEventsLog": obj.summarizedEventsLog
