...
export namespace RequestPerformanceTuningAnalysesDetails {
  export function getJsonObj(obj: RequestPerformanceTuningAnalysesDetails): object {
    const jsonObj = {
      ...obj,
      ...{
        "targets": obj.targets
  ...
  export function getDeserializedJsonObj(obj: RequestPerformanceTuningAnalysesDetails): object {
    const jsonObj = {
      ...obj,
      ...{
        "targets": obj.targets
