...
export namespace UncorrelatedPackageManagedInstanceUsageCollection {
  export function getJsonObj(obj: UncorrelatedPackageManagedInstanceUsageCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
  ...
  export function getDeserializedJsonObj(
    obj: UncorrelatedPackageManagedInstanceUsageCollection
  ): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
          ? obj.items.map(item => {
              return model.UncorrelatedPackageManagedInstanceUsageSummary.getDeserializedJsonObj(
                item
              );
            })
          : undefined
