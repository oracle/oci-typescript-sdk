...
export namespace FleetErrorAggregationCollection {
  export function getJsonObj(obj: FleetErrorAggregationCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
  ...
  export function getDeserializedJsonObj(obj: FleetErrorAggregationCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
