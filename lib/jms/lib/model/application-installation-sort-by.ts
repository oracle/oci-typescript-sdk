 ...
 **/
export enum ApplicationInstallationSortBy {
...
export namespace ApplicationInstallationSortBy {
  export function getJsonObj(obj: ApplicationInstallationSortBy): ApplicationInstallationSortBy {
    return obj;
  }
  export function getDeserializedJsonObj(
    obj: ApplicationInstallationSortBy
