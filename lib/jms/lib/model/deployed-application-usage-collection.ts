...
export namespace DeployedApplicationUsageCollection {
  export function getJsonObj(obj: DeployedApplicationUsageCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
  ...
  export function getDeserializedJsonObj(obj: DeployedApplicationUsageCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
