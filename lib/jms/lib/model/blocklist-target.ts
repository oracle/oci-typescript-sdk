...
export namespace BlocklistTarget {
  export function getJsonObj(obj: BlocklistTarget): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: BlocklistTarget): object {
    const jsonObj = { ...obj, ...{} };
