...
export namespace JmsPluginCollection {
  export function getJsonObj(obj: JmsPluginCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
  ...
  export function getDeserializedJsonObj(obj: JmsPluginCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
