...
export namespace FleetErrorAggregation {
  export function getJsonObj(obj: FleetErrorAggregation): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: FleetErrorAggregation): object {
    const jsonObj = { ...obj, ...{} };
