...
export namespace PerformanceTuningAnalysisResultSummary {
  export function getJsonObj(obj: PerformanceTuningAnalysisResultSummary): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: PerformanceTuningAnalysisResultSummary): object {
    const jsonObj = { ...obj, ...{} };
