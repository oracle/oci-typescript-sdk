...
export namespace SummarizedEventsLog {
  export function getJsonObj(obj: SummarizedEventsLog): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: SummarizedEventsLog): object {
    const jsonObj = { ...obj, ...{} };
