...
export namespace UncorrelatedPackageApplicationUsageSummary {
  export function getJsonObj(obj: UncorrelatedPackageApplicationUsageSummary): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: UncorrelatedPackageApplicationUsageSummary): object {
    const jsonObj = { ...obj, ...{} };
