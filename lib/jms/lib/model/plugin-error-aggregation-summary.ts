...
export namespace PluginErrorAggregationSummary {
  export function getJsonObj(obj: PluginErrorAggregationSummary): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: PluginErrorAggregationSummary): object {
    const jsonObj = {
      ...obj,
      ...{
        "pluginErrorAggregations": obj.pluginErrorAggregations
