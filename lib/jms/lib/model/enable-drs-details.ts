...
export namespace EnableDrsDetails {
  export function getJsonObj(obj: EnableDrsDetails): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: EnableDrsDetails): object {
    const jsonObj = {
      ...obj,
      ...{
        "manageDrsDetails": obj.manageDrsDetails
