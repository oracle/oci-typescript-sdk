...
export namespace FleetErrorCollection {
  export function getJsonObj(obj: FleetErrorCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
  ...
  export function getDeserializedJsonObj(obj: FleetErrorCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
