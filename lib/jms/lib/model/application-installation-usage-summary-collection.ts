...
export namespace ApplicationInstallationUsageSummaryCollection {
  export function getJsonObj(obj: ApplicationInstallationUsageSummaryCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
  ...
  export function getDeserializedJsonObj(
    obj: ApplicationInstallationUsageSummaryCollection
  ): object {
    const jsonObj = {
      ...obj,
      ...{
