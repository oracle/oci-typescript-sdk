...
export namespace FleetErrorAggregationSummary {
  export function getJsonObj(obj: FleetErrorAggregationSummary): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: FleetErrorAggregationSummary): object {
    const jsonObj = {
      ...obj,
      ...{
        "fleetErrorAggregations": obj.fleetErrorAggregations
