...
export namespace PluginErrorAggregationCollection {
  export function getJsonObj(obj: PluginErrorAggregationCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
  ...
  export function getDeserializedJsonObj(obj: PluginErrorAggregationCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
