...
export namespace UpdateJmsPluginDetails {
  export function getJsonObj(obj: UpdateJmsPluginDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: UpdateJmsPluginDetails): object {
    const jsonObj = { ...obj, ...{} };
