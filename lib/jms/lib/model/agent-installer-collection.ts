...
export namespace AgentInstallerCollection {
  export function getJsonObj(obj: AgentInstallerCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
  ...
  export function getDeserializedJsonObj(obj: AgentInstallerCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
