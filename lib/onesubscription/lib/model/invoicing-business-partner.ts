...
export namespace InvoicingBusinessPartner {
  export function getJsonObj(obj: InvoicingBusinessPartner): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: InvoicingBusinessPartner): object {
    const jsonObj = { ...obj, ...{} };
