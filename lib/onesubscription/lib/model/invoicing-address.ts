...
export namespace InvoicingAddress {
  export function getJsonObj(obj: InvoicingAddress): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: InvoicingAddress): object {
    const jsonObj = {
      ...obj,
      ...{
