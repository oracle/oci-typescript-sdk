...
export namespace SubscribedService {
  export function getJsonObj(obj: SubscribedService): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: SubscribedService): object {
    const jsonObj = {
      ...obj,
      ...{
        "product": obj.product
