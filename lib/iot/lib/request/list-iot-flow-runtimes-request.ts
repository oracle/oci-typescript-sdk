...
/**
 * @example Click {@link https://docs.oracle.com/en-us/iaas/tools/typescript-sdk-examples/latest/iot/ListIotFlowRuntimes.ts.html |here} to see how to use ListIotFlowRuntimesRequest.
 */
export interface ListIotFlowRuntimesRequest extends common.BaseRequest {
  /**
...
export namespace ListIotFlowRuntimesRequest {
