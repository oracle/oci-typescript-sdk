...
export namespace UpdateIotDomainGroupDetails {
  export function getJsonObj(obj: UpdateIotDomainGroupDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: UpdateIotDomainGroupDetails): object {
    const jsonObj = { ...obj, ...{} };
