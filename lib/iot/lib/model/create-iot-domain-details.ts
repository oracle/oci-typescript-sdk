...
export namespace CreateIotDomainDetails {
  export function getJsonObj(obj: CreateIotDomainDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: CreateIotDomainDetails): object {
    const jsonObj = { ...obj, ...{} };
