...
export namespace ChangeIotDomainGroupCompartmentDetails {
  export function getJsonObj(obj: ChangeIotDomainGroupCompartmentDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: ChangeIotDomainGroupCompartmentDetails): object {
    const jsonObj = { ...obj, ...{} };
