...
export namespace UpdateDigitalTwinInstanceDetails {
  export function getJsonObj(obj: UpdateDigitalTwinInstanceDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: UpdateDigitalTwinInstanceDetails): object {
    const jsonObj = { ...obj, ...{} };
