...
export namespace DigitalTwinModelSummary {
  export function getJsonObj(obj: DigitalTwinModelSummary): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: DigitalTwinModelSummary): object {
    const jsonObj = { ...obj, ...{} };
