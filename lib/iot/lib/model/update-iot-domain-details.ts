...
export namespace UpdateIotDomainDetails {
  export function getJsonObj(obj: UpdateIotDomainDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: UpdateIotDomainDetails): object {
    const jsonObj = { ...obj, ...{} };
