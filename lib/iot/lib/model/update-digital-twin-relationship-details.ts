...
export namespace UpdateDigitalTwinRelationshipDetails {
  export function getJsonObj(obj: UpdateDigitalTwinRelationshipDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: UpdateDigitalTwinRelationshipDetails): object {
    const jsonObj = { ...obj, ...{} };
