...
export namespace CreateDigitalTwinInstanceDetails {
  export function getJsonObj(obj: CreateDigitalTwinInstanceDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: CreateDigitalTwinInstanceDetails): object {
    const jsonObj = { ...obj, ...{} };
