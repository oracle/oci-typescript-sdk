...
export namespace IotDomainGroupCollection {
  export function getJsonObj(obj: IotDomainGroupCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
  ...
  export function getDeserializedJsonObj(obj: IotDomainGroupCollection): object {
    const jsonObj = {
      ...obj,
      ...{
        "items": obj.items
