...
export namespace DigitalTwinAdapter {
  export function getJsonObj(obj: DigitalTwinAdapter): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: DigitalTwinAdapter): object {
    const jsonObj = {
      ...obj,
      ...{
        "inboundEnvelope": obj.inboundEnvelope
