...
export namespace DigitalTwinInstanceSummary {
  export function getJsonObj(obj: DigitalTwinInstanceSummary): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: DigitalTwinInstanceSummary): object {
    const jsonObj = { ...obj, ...{} };
