 ...
 */
export interface IotFlowRuntimeSummary {
  /**
   ...
   *
   */
  "scale": IotFlowRuntimeSummary.Scale;
  /**
...
export namespace IotFlowRuntimeSummary {
  export enum Scale {
    Lowest = "LOWEST",
    Low = "LOW",
    Medium = "MEDIUM",
  ...
  export function getJsonObj(obj: IotFlowRuntimeSummary): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: IotFlowRuntimeSummary): object {
    const jsonObj = { ...obj, ...{} };
