...
export namespace IotDomainSummary {
  export function getJsonObj(obj: IotDomainSummary): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: IotDomainSummary): object {
    const jsonObj = { ...obj, ...{} };
