...
export namespace DigitalTwinAdapterSummary {
  export function getJsonObj(obj: DigitalTwinAdapterSummary): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: DigitalTwinAdapterSummary): object {
    const jsonObj = { ...obj, ...{} };
