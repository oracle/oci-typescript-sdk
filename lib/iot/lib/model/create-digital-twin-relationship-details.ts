...
export namespace CreateDigitalTwinRelationshipDetails {
  export function getJsonObj(obj: CreateDigitalTwinRelationshipDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: CreateDigitalTwinRelationshipDetails): object {
    const jsonObj = { ...obj, ...{} };
