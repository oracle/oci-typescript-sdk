...
export namespace CreateDigitalTwinModelDetails {
  export function getJsonObj(obj: CreateDigitalTwinModelDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: CreateDigitalTwinModelDetails): object {
    const jsonObj = { ...obj, ...{} };
