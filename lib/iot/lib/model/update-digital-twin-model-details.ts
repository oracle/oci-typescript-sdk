...
export namespace UpdateDigitalTwinModelDetails {
  export function getJsonObj(obj: UpdateDigitalTwinModelDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: UpdateDigitalTwinModelDetails): object {
    const jsonObj = { ...obj, ...{} };
