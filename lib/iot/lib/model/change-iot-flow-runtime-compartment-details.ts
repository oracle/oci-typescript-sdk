 ...
 */
export interface ChangeIotFlowRuntimeCompartmentDetails {
  /**
...
export namespace ChangeIotFlowRuntimeCompartmentDetails {
  export function getJsonObj(obj: ChangeIotFlowRuntimeCompartmentDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: ChangeIotFlowRuntimeCompartmentDetails): object {
    const jsonObj = { ...obj, ...{} };
