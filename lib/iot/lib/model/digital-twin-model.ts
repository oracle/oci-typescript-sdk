...
export namespace DigitalTwinModel {
  export function getJsonObj(obj: DigitalTwinModel): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: DigitalTwinModel): object {
    const jsonObj = { ...obj, ...{} };
