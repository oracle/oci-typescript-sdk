...
export namespace CreateSecurityAttributeNamespaceDetails {
  export function getJsonObj(obj: CreateSecurityAttributeNamespaceDetails): object {
    const jsonObj = { ...obj, ...{} };

    return jsonObj;
  }
  export function getDeserializedJsonObj(obj: CreateSecurityAttributeNamespaceDetails): object {
    const jsonObj = { ...obj, ...{} };
