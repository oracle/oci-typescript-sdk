...
export namespace SecurityAttributeWorkRequestSummary {
  export function getJsonObj(obj: SecurityAttributeWorkRequestSummary): object {
    const jsonObj = {
      ...obj,
      ...{
  ...
  export function getDeserializedJsonObj(obj: SecurityAttributeWorkRequestSummary): object {
    const jsonObj = {
      ...obj,
      ...{
        "resources": obj.resources
