...
export namespace PropertyUnits {
  export function getJsonObj(obj: PropertyUnits): PropertyUnits {
    return obj;
  }
  export function getDeserializedJsonObj(obj: PropertyUnits): PropertyUnits {
    return obj;
  }
}
